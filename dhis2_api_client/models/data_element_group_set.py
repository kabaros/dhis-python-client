...
from ..models.data_element_group_set_aggregation_type import DataElementGroupSetAggregationType
from ..models.data_element_group_set_data_dimension_type import DataElementGroupSetDataDimensionType
from ..models.data_element_group_set_value_type import DataElementGroupSetValueType
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.access import Access
    from ..models.attribute_value import AttributeValue
    from ..models.data_element_group_set_created_by import DataElementGroupSetCreatedBy
    from ..models.data_element_group_set_data_element_groups_item import DataElementGroupSetDataElementGroupsItem
    from ..models.data_element_group_set_items_item import DataElementGroupSetItemsItem
    from ..models.data_element_group_set_last_updated_by import DataElementGroupSetLastUpdatedBy
    from ..models.data_element_group_set_legend_set import DataElementGroupSetLegendSet
    from ..models.data_element_group_set_option_set import DataElementGroupSetOptionSet
    from ..models.data_element_group_set_program import DataElementGroupSetProgram
    from ..models.data_element_group_set_program_stage import DataElementGroupSetProgramStage
    from ..models.data_element_group_set_user import DataElementGroupSetUser
...
T = TypeVar("T", bound="DataElementGroupSet")
...
class DataElementGroupSet:
    """
    Attributes:
        aggregation_type (DataElementGroupSetAggregationType):
        data_dimension_type (DataElementGroupSetDataDimensionType):
        value_type (DataElementGroupSetValueType):
        ...
        created_by (Union[Unset, DataElementGroupSetCreatedBy]): A UID reference to a User
            (Java name `org.hisp.dhis.user.User`)
        data_dimension (Union[Unset, bool]):
        data_element_groups (Union[Unset, list['DataElementGroupSetDataElementGroupsItem']]):
        ...
        id (Union[Unset, str]):
        items (Union[Unset, list['DataElementGroupSetItemsItem']]):
        last_updated (Union[Unset, datetime.datetime]):
        last_updated_by (Union[Unset, DataElementGroupSetLastUpdatedBy]): A UID reference to a User
            (Java name `org.hisp.dhis.user.User`)
        legend_set (Union[Unset, DataElementGroupSetLegendSet]): A UID reference to a LegendSet
            (Java name `org.hisp.dhis.legend.LegendSet`)
        name (Union[Unset, str]):
        option_set (Union[Unset, DataElementGroupSetOptionSet]): A UID reference to a OptionSet
            (Java name `org.hisp.dhis.option.OptionSet`)
        program (Union[Unset, DataElementGroupSetProgram]): A UID reference to a Program
            (Java name `org.hisp.dhis.program.Program`)
        program_stage (Union[Unset, DataElementGroupSetProgramStage]): A UID reference to a ProgramStage
        ...
        user (Union[Unset, DataElementGroupSetUser]): A UID reference to a User
            (Java name `org.hisp.dhis.user.User`)
    """
    ...
    created_by: Union[Unset, "DataElementGroupSetCreatedBy"] = UNSET
    data_dimension: Union[Unset, bool] = UNSET
    data_element_groups: Union[Unset, list["DataElementGroupSetDataElementGroupsItem"]] = UNSET
    ...
    items: Union[Unset, list["DataElementGroupSetItemsItem"]] = UNSET
    last_updated: Union[Unset, datetime.datetime] = UNSET
    last_updated_by: Union[Unset, "DataElementGroupSetLastUpdatedBy"] = UNSET
    legend_set: Union[Unset, "DataElementGroupSetLegendSet"] = UNSET
    name: Union[Unset, str] = UNSET
    option_set: Union[Unset, "DataElementGroupSetOptionSet"] = UNSET
    program: Union[Unset, "DataElementGroupSetProgram"] = UNSET
    program_stage: Union[Unset, "DataElementGroupSetProgramStage"] = UNSET
    repetition: Union[Unset, "EventRepetition"] = UNSET
    sharing: Union[Unset, "Sharing"] = UNSET
    short_name: Union[Unset, str] = UNSET
    translations: Union[Unset, list["Translation"]] = UNSET
    user: Union[Unset, "DataElementGroupSetUser"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        aggregation_type = DataElementGroupSetAggregationType(d.pop("aggregationType"))

        data_dimension_type = DataElementGroupSetDataDimensionType(d.pop("dataDimensionType"))

        value_type = DataElementGroupSetValueType(d.pop("valueType"))
        ...
        created_by: Union[Unset, DataElementGroupSetCreatedBy]
        if isinstance(_created_by, Unset):
            created_by = UNSET
        else:
            created_by = DataElementGroupSetCreatedBy.from_dict(_created_by)
        ...
        for data_element_groups_item_data in _data_element_groups or []:
            data_element_groups_item = DataElementGroupSetDataElementGroupsItem.from_dict(data_element_groups_item_data)
        ...
        for items_item_data in _items or []:
            items_item = DataElementGroupSetItemsItem.from_dict(items_item_data)
        ...
        last_updated_by: Union[Unset, DataElementGroupSetLastUpdatedBy]
        if isinstance(_last_updated_by, Unset):
            last_updated_by = UNSET
        else:
            last_updated_by = DataElementGroupSetLastUpdatedBy.from_dict(_last_updated_by)

        _legend_set = d.pop("legendSet", UNSET)
        legend_set: Union[Unset, DataElementGroupSetLegendSet]
        if isinstance(_legend_set, Unset):
            legend_set = UNSET
        else:
            legend_set = DataElementGroupSetLegendSet.from_dict(_legend_set)

        name = d.pop("name", UNSET)

        _option_set = d.pop("optionSet", UNSET)
        option_set: Union[Unset, DataElementGroupSetOptionSet]
        if isinstance(_option_set, Unset):
            option_set = UNSET
        else:
            option_set = DataElementGroupSetOptionSet.from_dict(_option_set)

        _program = d.pop("program", UNSET)
        program: Union[Unset, DataElementGroupSetProgram]
        if isinstance(_program, Unset):
            program = UNSET
        else:
            program = DataElementGroupSetProgram.from_dict(_program)

        _program_stage = d.pop("programStage", UNSET)
        program_stage: Union[Unset, DataElementGroupSetProgramStage]
        if isinstance(_program_stage, Unset):
            program_stage = UNSET
        else:
            program_stage = DataElementGroupSetProgramStage.from_dict(_program_stage)
        ...
        user: Union[Unset, DataElementGroupSetUser]
        if isinstance(_user, Unset):
            user = UNSET
        else:
            user = DataElementGroupSetUser.from_dict(_user)

        data_element_group_set = cls(
        ...
        data_element_group_set.additional_properties = d
