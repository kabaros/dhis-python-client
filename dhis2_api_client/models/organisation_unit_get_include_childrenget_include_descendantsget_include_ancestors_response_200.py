...
T = TypeVar("T", bound="OrganisationUnitGetIncludeChildrengetIncludeDescendantsgetIncludeAncestorsResponse200")


@_attrs_define
class OrganisationUnitGetIncludeChildrengetIncludeDescendantsgetIncludeAncestorsResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        organisation_unit_get_include_childrenget_include_descendantsget_include_ancestors_response_200 = cls(
            pager=pager,
            organisation_units=organisation_units,
        )

        organisation_unit_get_include_childrenget_include_descendantsget_include_ancestors_response_200.additional_properties = d
        return organisation_unit_get_include_childrenget_include_descendantsget_include_ancestors_response_200
