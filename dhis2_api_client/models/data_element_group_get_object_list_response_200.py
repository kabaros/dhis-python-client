...
T = TypeVar("T", bound="DataElementGroupGetObjectListResponse200")


@_attrs_define
class DataElementGroupGetObjectListResponse200:
    """
    Attributes:
        pager (Union[Unset, Pager]):
        data_element_groups (Union[Unset, list['DataElementGroup']]):
    """

    pager: Union[Unset, "Pager"] = UNSET
    data_element_groups: Union[Unset, list["DataElementGroup"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for data_element_groups_item_data in _data_element_groups or []:
            data_element_groups_item = DataElementGroup.from_dict(data_element_groups_item_data)

            data_element_groups.append(data_element_groups_item)

        data_element_group_get_object_list_response_200 = cls(
            pager=pager,
            data_element_groups=data_element_groups,
        )

        data_element_group_get_object_list_response_200.additional_properties = d
        return data_element_group_get_object_list_response_200
