...
T = TypeVar("T", bound="DataApprovalWorkflowGetObjectListResponse200")


@_attrs_define
class DataApprovalWorkflowGetObjectListResponse200:
    """
    Attributes:
        pager (Union[Unset, Pager]):
        data_approval_workflows (Union[Unset, list['DataApprovalWorkflow']]):
    """

    pager: Union[Unset, "Pager"] = UNSET
    data_approval_workflows: Union[Unset, list["DataApprovalWorkflow"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for data_approval_workflows_item_data in _data_approval_workflows or []:
            data_approval_workflows_item = DataApprovalWorkflow.from_dict(data_approval_workflows_item_data)

            data_approval_workflows.append(data_approval_workflows_item)

        data_approval_workflow_get_object_list_response_200 = cls(
            pager=pager,
            data_approval_workflows=data_approval_workflows,
        )

        data_approval_workflow_get_object_list_response_200.additional_properties = d
        return data_approval_workflow_get_object_list_response_200
