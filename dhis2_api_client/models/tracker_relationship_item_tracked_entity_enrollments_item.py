...
from ..models.tracker_relationship_item_tracked_entity_enrollments_item_status import (
    TrackerRelationshipItemTrackedEntityEnrollmentsItemStatus,
)
...
if TYPE_CHECKING:
    ...
    from ..models.tracker_relationship_item_tracked_entity_enrollments_item_events_item import (
        TrackerRelationshipItemTrackedEntityEnrollmentsItemEventsItem,
    )
    from ..models.tracker_relationship_item_tracked_entity_enrollments_item_geometry import (
        TrackerRelationshipItemTrackedEntityEnrollmentsItemGeometry,
    )
    from ..models.tracker_user import TrackerUser


T = TypeVar("T", bound="TrackerRelationshipItemTrackedEntityEnrollmentsItem")


@_attrs_define
class TrackerRelationshipItemTrackedEntityEnrollmentsItem:
    """
    Attributes:
        status (TrackerRelationshipItemTrackedEntityEnrollmentsItemStatus):
        ...
        enrollment (Union[Unset, str]): A UID for an Enrollment object
            (Java name `org.hisp.dhis.webapi.controller.tracker.view.RelationshipItem$Enrollment`) Example: h9qA2Xb1CV0.
        events (Union[Unset, list['TrackerRelationshipItemTrackedEntityEnrollmentsItemEventsItem']]):
        follow_up (Union[Unset, bool]):
        geometry (Union[Unset, TrackerRelationshipItemTrackedEntityEnrollmentsItemGeometry]):
    ...
    events: Union[Unset, list["TrackerRelationshipItemTrackedEntityEnrollmentsItemEventsItem"]] = UNSET
    follow_up: Union[Unset, bool] = UNSET
    geometry: Union[Unset, "TrackerRelationshipItemTrackedEntityEnrollmentsItemGeometry"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        status = TrackerRelationshipItemTrackedEntityEnrollmentsItemStatus(d.pop("status"))
        ...
        for events_item_data in _events or []:
            events_item = TrackerRelationshipItemTrackedEntityEnrollmentsItemEventsItem.from_dict(events_item_data)
        ...
        if isinstance(_geometry, Unset):
            ...
            geometry = TrackerRelationshipItemTrackedEntityEnrollmentsItemGeometry.from_dict(_geometry)
        ...
        tracker_relationship_item_tracked_entity_enrollments_item = cls(
            status=status,
        ...
        tracker_relationship_item_tracked_entity_enrollments_item.additional_properties = d
        return tracker_relationship_item_tracked_entity_enrollments_item
