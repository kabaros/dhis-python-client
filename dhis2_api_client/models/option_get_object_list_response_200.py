...
T = TypeVar("T", bound="OptionGetObjectListResponse200")


@_attrs_define
class OptionGetObjectListResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        option_get_object_list_response_200 = cls(
            pager=pager,
            options=options,
        )

        option_get_object_list_response_200.additional_properties = d
        return option_get_object_list_response_200
