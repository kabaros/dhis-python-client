...
T = TypeVar("T", bound="UserGroupGetObjectListResponse200")


@_attrs_define
class UserGroupGetObjectListResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        user_group_get_object_list_response_200 = cls(
            pager=pager,
            user_groups=user_groups,
        )

        user_group_get_object_list_response_200.additional_properties = d
        return user_group_get_object_list_response_200
