...
T = TypeVar("T", bound="UserDetailsUserSettings")


@_attrs_define
class UserDetailsUserSettings:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        d = src_dict.copy()
        user_details_user_settings = cls()
        ...
        user_details_user_settings.additional_properties = additional_properties
        return user_details_user_settings
