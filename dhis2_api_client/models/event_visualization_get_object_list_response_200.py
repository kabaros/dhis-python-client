...
T = TypeVar("T", bound="EventVisualizationGetObjectListResponse200")


@_attrs_define
class EventVisualizationGetObjectListResponse200:
    """
    Attributes:
        pager (Union[Unset, Pager]):
        event_visualizations (Union[Unset, list['EventVisualization']]):
    """

    pager: Union[Unset, "Pager"] = UNSET
    event_visualizations: Union[Unset, list["EventVisualization"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for event_visualizations_item_data in _event_visualizations or []:
            event_visualizations_item = EventVisualization.from_dict(event_visualizations_item_data)

            event_visualizations.append(event_visualizations_item)

        event_visualization_get_object_list_response_200 = cls(
            pager=pager,
            event_visualizations=event_visualizations,
        )

        event_visualization_get_object_list_response_200.additional_properties = d
        return event_visualization_get_object_list_response_200
