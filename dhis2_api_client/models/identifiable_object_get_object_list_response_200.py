...
T = TypeVar("T", bound="IdentifiableObjectGetObjectListResponse200")


@_attrs_define
class IdentifiableObjectGetObjectListResponse200:
    """
    Attributes:
        pager (Union[Unset, Pager]):
        identifiable_objects (Union[Unset, list['IdentifiableObject']]):
    """

    pager: Union[Unset, "Pager"] = UNSET
    identifiable_objects: Union[Unset, list["IdentifiableObject"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for identifiable_objects_item_data in _identifiable_objects or []:
            identifiable_objects_item = IdentifiableObject.from_dict(identifiable_objects_item_data)

            identifiable_objects.append(identifiable_objects_item)

        identifiable_object_get_object_list_response_200 = cls(
            pager=pager,
            identifiable_objects=identifiable_objects,
        )

        identifiable_object_get_object_list_response_200.additional_properties = d
        return identifiable_object_get_object_list_response_200
