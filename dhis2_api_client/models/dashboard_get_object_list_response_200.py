...
T = TypeVar("T", bound="DashboardGetObjectListResponse200")


@_attrs_define
class DashboardGetObjectListResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        dashboard_get_object_list_response_200 = cls(
            pager=pager,
            dashboards=dashboards,
        )

        dashboard_get_object_list_response_200.additional_properties = d
        return dashboard_get_object_list_response_200
