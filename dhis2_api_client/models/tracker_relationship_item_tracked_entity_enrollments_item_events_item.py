...
from ..models.tracker_relationship_item_tracked_entity_enrollments_item_events_item_status import (
    TrackerRelationshipItemTrackedEntityEnrollmentsItemEventsItemStatus,
)
...
if TYPE_CHECKING:
    ...
    from ..models.tracker_relationship_item_tracked_entity_enrollments_item_events_item_geometry import (
        TrackerRelationshipItemTrackedEntityEnrollmentsItemEventsItemGeometry,
    )
    from ..models.tracker_user import TrackerUser


T = TypeVar("T", bound="TrackerRelationshipItemTrackedEntityEnrollmentsItemEventsItem")


@_attrs_define
class TrackerRelationshipItemTrackedEntityEnrollmentsItemEventsItem:
    """
    Attributes:
        status (TrackerRelationshipItemTrackedEntityEnrollmentsItemEventsItemStatus):
        ...
        geometry (Union[Unset, TrackerRelationshipItemTrackedEntityEnrollmentsItemEventsItemGeometry]):
    ...
    geometry: Union[Unset, "TrackerRelationshipItemTrackedEntityEnrollmentsItemEventsItemGeometry"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        status = TrackerRelationshipItemTrackedEntityEnrollmentsItemEventsItemStatus(d.pop("status"))
        ...
        if isinstance(_geometry, Unset):
            ...
            geometry = TrackerRelationshipItemTrackedEntityEnrollmentsItemEventsItemGeometry.from_dict(_geometry)
        ...
        tracker_relationship_item_tracked_entity_enrollments_item_events_item = cls(
            status=status,
        ...
        tracker_relationship_item_tracked_entity_enrollments_item_events_item.additional_properties = d
        return tracker_relationship_item_tracked_entity_enrollments_item_events_item
