...
T = TypeVar("T", bound="MapGetObjectListResponse200")


@_attrs_define
class MapGetObjectListResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        map_get_object_list_response_200 = cls(
            pager=pager,
            maps=maps,
        )

        map_get_object_list_response_200.additional_properties = d
        return map_get_object_list_response_200
