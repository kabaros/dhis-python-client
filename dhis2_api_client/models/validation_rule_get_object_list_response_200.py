...
T = TypeVar("T", bound="ValidationRuleGetObjectListResponse200")


@_attrs_define
class ValidationRuleGetObjectListResponse200:
    """
    Attributes:
        pager (Union[Unset, Pager]):
        validation_rules (Union[Unset, list['ValidationRule']]):
    """

    pager: Union[Unset, "Pager"] = UNSET
    validation_rules: Union[Unset, list["ValidationRule"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for validation_rules_item_data in _validation_rules or []:
            validation_rules_item = ValidationRule.from_dict(validation_rules_item_data)

            validation_rules.append(validation_rules_item)

        validation_rule_get_object_list_response_200 = cls(
            pager=pager,
            validation_rules=validation_rules,
        )

        validation_rule_get_object_list_response_200.additional_properties = d
        return validation_rule_get_object_list_response_200
