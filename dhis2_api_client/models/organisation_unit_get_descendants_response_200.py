...
T = TypeVar("T", bound="OrganisationUnitGetDescendantsResponse200")


@_attrs_define
class OrganisationUnitGetDescendantsResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        organisation_unit_get_descendants_response_200 = cls(
            pager=pager,
            organisation_units=organisation_units,
        )

        organisation_unit_get_descendants_response_200.additional_properties = d
        return organisation_unit_get_descendants_response_200
