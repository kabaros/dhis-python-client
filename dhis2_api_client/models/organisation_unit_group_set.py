...
from ..models.organisation_unit_group_set_aggregation_type import OrganisationUnitGroupSetAggregationType
from ..models.organisation_unit_group_set_data_dimension_type import OrganisationUnitGroupSetDataDimensionType
from ..models.organisation_unit_group_set_value_type import OrganisationUnitGroupSetValueType
...
if TYPE_CHECKING:
    ...
    from ..models.organisation_unit_group_set_created_by import OrganisationUnitGroupSetCreatedBy
    from ..models.organisation_unit_group_set_items_item import OrganisationUnitGroupSetItemsItem
    from ..models.organisation_unit_group_set_last_updated_by import OrganisationUnitGroupSetLastUpdatedBy
    from ..models.organisation_unit_group_set_legend_set import OrganisationUnitGroupSetLegendSet
    from ..models.organisation_unit_group_set_option_set import OrganisationUnitGroupSetOptionSet
    from ..models.organisation_unit_group_set_organisation_unit_groups_item import (
        OrganisationUnitGroupSetOrganisationUnitGroupsItem,
    )
    from ..models.organisation_unit_group_set_program import OrganisationUnitGroupSetProgram
    from ..models.organisation_unit_group_set_program_stage import OrganisationUnitGroupSetProgramStage
    from ..models.organisation_unit_group_set_user import OrganisationUnitGroupSetUser
    from ..models.sharing import Sharing
    from ..models.translation import Translation


T = TypeVar("T", bound="OrganisationUnitGroupSet")
...
class OrganisationUnitGroupSet:
    """
    Attributes:
        aggregation_type (OrganisationUnitGroupSetAggregationType):
        data_dimension_type (OrganisationUnitGroupSetDataDimensionType):
        value_type (OrganisationUnitGroupSetValueType):
        ...
        created_by (Union[Unset, OrganisationUnitGroupSetCreatedBy]): A UID reference to a User
        ...
        id (Union[Unset, str]):
        include_subhierarchy_in_analytics (Union[Unset, bool]):
        items (Union[Unset, list['OrganisationUnitGroupSetItemsItem']]):
        last_updated (Union[Unset, datetime.datetime]):
        last_updated_by (Union[Unset, OrganisationUnitGroupSetLastUpdatedBy]): A UID reference to a User
            (Java name `org.hisp.dhis.user.User`)
        legend_set (Union[Unset, OrganisationUnitGroupSetLegendSet]): A UID reference to a LegendSet
            (Java name `org.hisp.dhis.legend.LegendSet`)
        name (Union[Unset, str]):
        option_set (Union[Unset, OrganisationUnitGroupSetOptionSet]): A UID reference to a OptionSet
            (Java name `org.hisp.dhis.option.OptionSet`)
        organisation_unit_groups (Union[Unset, list['OrganisationUnitGroupSetOrganisationUnitGroupsItem']]):
        program (Union[Unset, OrganisationUnitGroupSetProgram]): A UID reference to a Program
            (Java name `org.hisp.dhis.program.Program`)
        program_stage (Union[Unset, OrganisationUnitGroupSetProgramStage]): A UID reference to a ProgramStage
        ...
        user (Union[Unset, OrganisationUnitGroupSetUser]): A UID reference to a User
            (Java name `org.hisp.dhis.user.User`)
    """
    ...
    created_by: Union[Unset, "OrganisationUnitGroupSetCreatedBy"] = UNSET
    ...
    include_subhierarchy_in_analytics: Union[Unset, bool] = UNSET
    items: Union[Unset, list["OrganisationUnitGroupSetItemsItem"]] = UNSET
    last_updated: Union[Unset, datetime.datetime] = UNSET
    last_updated_by: Union[Unset, "OrganisationUnitGroupSetLastUpdatedBy"] = UNSET
    legend_set: Union[Unset, "OrganisationUnitGroupSetLegendSet"] = UNSET
    name: Union[Unset, str] = UNSET
    option_set: Union[Unset, "OrganisationUnitGroupSetOptionSet"] = UNSET
    organisation_unit_groups: Union[Unset, list["OrganisationUnitGroupSetOrganisationUnitGroupsItem"]] = UNSET
    program: Union[Unset, "OrganisationUnitGroupSetProgram"] = UNSET
    program_stage: Union[Unset, "OrganisationUnitGroupSetProgramStage"] = UNSET
    repetition: Union[Unset, "EventRepetition"] = UNSET
    sharing: Union[Unset, "Sharing"] = UNSET
    short_name: Union[Unset, str] = UNSET
    translations: Union[Unset, list["Translation"]] = UNSET
    user: Union[Unset, "OrganisationUnitGroupSetUser"] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        include_subhierarchy_in_analytics = self.include_subhierarchy_in_analytics
        ...
        if id is not UNSET:
            field_dict["id"] = id
        if include_subhierarchy_in_analytics is not UNSET:
            field_dict["includeSubhierarchyInAnalytics"] = include_subhierarchy_in_analytics
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        aggregation_type = OrganisationUnitGroupSetAggregationType(d.pop("aggregationType"))

        data_dimension_type = OrganisationUnitGroupSetDataDimensionType(d.pop("dataDimensionType"))

        value_type = OrganisationUnitGroupSetValueType(d.pop("valueType"))
        ...
        created_by: Union[Unset, OrganisationUnitGroupSetCreatedBy]
        if isinstance(_created_by, Unset):
            created_by = UNSET
        else:
            created_by = OrganisationUnitGroupSetCreatedBy.from_dict(_created_by)
        ...
        include_subhierarchy_in_analytics = d.pop("includeSubhierarchyInAnalytics", UNSET)

        items = []
        _items = d.pop("items", UNSET)
        for items_item_data in _items or []:
            items_item = OrganisationUnitGroupSetItemsItem.from_dict(items_item_data)
        ...
        last_updated_by: Union[Unset, OrganisationUnitGroupSetLastUpdatedBy]
        if isinstance(_last_updated_by, Unset):
            last_updated_by = UNSET
        else:
            last_updated_by = OrganisationUnitGroupSetLastUpdatedBy.from_dict(_last_updated_by)

        _legend_set = d.pop("legendSet", UNSET)
        legend_set: Union[Unset, OrganisationUnitGroupSetLegendSet]
        if isinstance(_legend_set, Unset):
            legend_set = UNSET
        else:
            legend_set = OrganisationUnitGroupSetLegendSet.from_dict(_legend_set)

        name = d.pop("name", UNSET)

        _option_set = d.pop("optionSet", UNSET)
        option_set: Union[Unset, OrganisationUnitGroupSetOptionSet]
        if isinstance(_option_set, Unset):
            option_set = UNSET
        else:
            option_set = OrganisationUnitGroupSetOptionSet.from_dict(_option_set)
        ...
        for organisation_unit_groups_item_data in _organisation_unit_groups or []:
            organisation_unit_groups_item = OrganisationUnitGroupSetOrganisationUnitGroupsItem.from_dict(
        ...
        program: Union[Unset, OrganisationUnitGroupSetProgram]
        if isinstance(_program, Unset):
            program = UNSET
        else:
            program = OrganisationUnitGroupSetProgram.from_dict(_program)

        _program_stage = d.pop("programStage", UNSET)
        program_stage: Union[Unset, OrganisationUnitGroupSetProgramStage]
        if isinstance(_program_stage, Unset):
            program_stage = UNSET
        else:
            program_stage = OrganisationUnitGroupSetProgramStage.from_dict(_program_stage)
        ...
        user: Union[Unset, OrganisationUnitGroupSetUser]
        if isinstance(_user, Unset):
            user = UNSET
        else:
            user = OrganisationUnitGroupSetUser.from_dict(_user)

        organisation_unit_group_set = cls(
            ...
            href=href,
            id=id,
            include_subhierarchy_in_analytics=include_subhierarchy_in_analytics,
            items=items,
        ...
        organisation_unit_group_set.additional_properties = d
