...
from ..models.tracker_event_status import TrackerEventStatus
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.tracker_data_value import TrackerDataValue
    from ..models.tracker_event_geometry import TrackerEventGeometry
...
T = TypeVar("T", bound="TrackerEvent")
...
class TrackerEvent:
    ...
    Attributes:
        ...
        geometry (Union[Unset, TrackerEventGeometry]):
    ...
    geometry: Union[Unset, "TrackerEventGeometry"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        status = TrackerEventStatus(d.pop("status"))
        ...
        if isinstance(_geometry, Unset):
            ...
            geometry = TrackerEventGeometry.from_dict(_geometry)
        ...
        tracker_event.additional_properties = d
