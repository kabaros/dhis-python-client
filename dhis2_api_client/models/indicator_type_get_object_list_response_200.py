...
T = TypeVar("T", bound="IndicatorTypeGetObjectListResponse200")


@_attrs_define
class IndicatorTypeGetObjectListResponse200:
    """
    Attributes:
        pager (Union[Unset, Pager]):
        indicator_types (Union[Unset, list['IndicatorType']]):
    """

    pager: Union[Unset, "Pager"] = UNSET
    indicator_types: Union[Unset, list["IndicatorType"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for indicator_types_item_data in _indicator_types or []:
            indicator_types_item = IndicatorType.from_dict(indicator_types_item_data)

            indicator_types.append(indicator_types_item)

        indicator_type_get_object_list_response_200 = cls(
            pager=pager,
            indicator_types=indicator_types,
        )

        indicator_type_get_object_list_response_200.additional_properties = d
        return indicator_type_get_object_list_response_200
