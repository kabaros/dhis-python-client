...
from ..models.category_option_group_set_aggregation_type import CategoryOptionGroupSetAggregationType
from ..models.category_option_group_set_data_dimension_type import CategoryOptionGroupSetDataDimensionType
from ..models.category_option_group_set_value_type import CategoryOptionGroupSetValueType
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.access import Access
    from ..models.attribute_value import AttributeValue
    from ..models.category_option_group_set_category_option_groups_item import (
        CategoryOptionGroupSetCategoryOptionGroupsItem,
    )
    from ..models.category_option_group_set_created_by import CategoryOptionGroupSetCreatedBy
    from ..models.category_option_group_set_items_item import CategoryOptionGroupSetItemsItem
    from ..models.category_option_group_set_last_updated_by import CategoryOptionGroupSetLastUpdatedBy
    from ..models.category_option_group_set_legend_set import CategoryOptionGroupSetLegendSet
    from ..models.category_option_group_set_option_set import CategoryOptionGroupSetOptionSet
    from ..models.category_option_group_set_program import CategoryOptionGroupSetProgram
    from ..models.category_option_group_set_program_stage import CategoryOptionGroupSetProgramStage
    from ..models.category_option_group_set_user import CategoryOptionGroupSetUser
...
T = TypeVar("T", bound="CategoryOptionGroupSet")
...
class CategoryOptionGroupSet:
    """
    Attributes:
        aggregation_type (CategoryOptionGroupSetAggregationType):
        data_dimension_type (CategoryOptionGroupSetDataDimensionType):
        value_type (CategoryOptionGroupSetValueType):
        access (Union[Unset, Access]):
        all_items (Union[Unset, bool]):
        attribute_values (Union[Unset, list['AttributeValue']]):
        category_option_groups (Union[Unset, list['CategoryOptionGroupSetCategoryOptionGroupsItem']]):
        code (Union[Unset, str]):
        created (Union[Unset, datetime.datetime]):
        created_by (Union[Unset, CategoryOptionGroupSetCreatedBy]): A UID reference to a User
        ...
        id (Union[Unset, str]):
        items (Union[Unset, list['CategoryOptionGroupSetItemsItem']]):
        last_updated (Union[Unset, datetime.datetime]):
        last_updated_by (Union[Unset, CategoryOptionGroupSetLastUpdatedBy]): A UID reference to a User
            (Java name `org.hisp.dhis.user.User`)
        legend_set (Union[Unset, CategoryOptionGroupSetLegendSet]): A UID reference to a LegendSet
            (Java name `org.hisp.dhis.legend.LegendSet`)
        name (Union[Unset, str]):
        option_set (Union[Unset, CategoryOptionGroupSetOptionSet]): A UID reference to a OptionSet
            (Java name `org.hisp.dhis.option.OptionSet`)
        program (Union[Unset, CategoryOptionGroupSetProgram]): A UID reference to a Program
            (Java name `org.hisp.dhis.program.Program`)
        program_stage (Union[Unset, CategoryOptionGroupSetProgramStage]): A UID reference to a ProgramStage
        ...
        user (Union[Unset, CategoryOptionGroupSetUser]): A UID reference to a User
            (Java name `org.hisp.dhis.user.User`)
    """
    ...
    category_option_groups: Union[Unset, list["CategoryOptionGroupSetCategoryOptionGroupsItem"]] = UNSET
    code: Union[Unset, str] = UNSET
    created: Union[Unset, datetime.datetime] = UNSET
    created_by: Union[Unset, "CategoryOptionGroupSetCreatedBy"] = UNSET
    ...
    items: Union[Unset, list["CategoryOptionGroupSetItemsItem"]] = UNSET
    last_updated: Union[Unset, datetime.datetime] = UNSET
    last_updated_by: Union[Unset, "CategoryOptionGroupSetLastUpdatedBy"] = UNSET
    legend_set: Union[Unset, "CategoryOptionGroupSetLegendSet"] = UNSET
    name: Union[Unset, str] = UNSET
    option_set: Union[Unset, "CategoryOptionGroupSetOptionSet"] = UNSET
    program: Union[Unset, "CategoryOptionGroupSetProgram"] = UNSET
    program_stage: Union[Unset, "CategoryOptionGroupSetProgramStage"] = UNSET
    repetition: Union[Unset, "EventRepetition"] = UNSET
    sharing: Union[Unset, "Sharing"] = UNSET
    short_name: Union[Unset, str] = UNSET
    translations: Union[Unset, list["Translation"]] = UNSET
    user: Union[Unset, "CategoryOptionGroupSetUser"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        aggregation_type = CategoryOptionGroupSetAggregationType(d.pop("aggregationType"))

        data_dimension_type = CategoryOptionGroupSetDataDimensionType(d.pop("dataDimensionType"))

        value_type = CategoryOptionGroupSetValueType(d.pop("valueType"))
        ...
        for category_option_groups_item_data in _category_option_groups or []:
            category_option_groups_item = CategoryOptionGroupSetCategoryOptionGroupsItem.from_dict(
        ...
        created_by: Union[Unset, CategoryOptionGroupSetCreatedBy]
        if isinstance(_created_by, Unset):
            created_by = UNSET
        else:
            created_by = CategoryOptionGroupSetCreatedBy.from_dict(_created_by)
        ...
        for items_item_data in _items or []:
            items_item = CategoryOptionGroupSetItemsItem.from_dict(items_item_data)
        ...
        last_updated_by: Union[Unset, CategoryOptionGroupSetLastUpdatedBy]
        if isinstance(_last_updated_by, Unset):
            last_updated_by = UNSET
        else:
            last_updated_by = CategoryOptionGroupSetLastUpdatedBy.from_dict(_last_updated_by)

        _legend_set = d.pop("legendSet", UNSET)
        legend_set: Union[Unset, CategoryOptionGroupSetLegendSet]
        if isinstance(_legend_set, Unset):
            legend_set = UNSET
        else:
            legend_set = CategoryOptionGroupSetLegendSet.from_dict(_legend_set)

        name = d.pop("name", UNSET)

        _option_set = d.pop("optionSet", UNSET)
        option_set: Union[Unset, CategoryOptionGroupSetOptionSet]
        if isinstance(_option_set, Unset):
            option_set = UNSET
        else:
            option_set = CategoryOptionGroupSetOptionSet.from_dict(_option_set)

        _program = d.pop("program", UNSET)
        program: Union[Unset, CategoryOptionGroupSetProgram]
        if isinstance(_program, Unset):
            program = UNSET
        else:
            program = CategoryOptionGroupSetProgram.from_dict(_program)

        _program_stage = d.pop("programStage", UNSET)
        program_stage: Union[Unset, CategoryOptionGroupSetProgramStage]
        if isinstance(_program_stage, Unset):
            program_stage = UNSET
        else:
            program_stage = CategoryOptionGroupSetProgramStage.from_dict(_program_stage)
        ...
        user: Union[Unset, CategoryOptionGroupSetUser]
        if isinstance(_user, Unset):
            user = UNSET
        else:
            user = CategoryOptionGroupSetUser.from_dict(_user)

        category_option_group_set = cls(
        ...
        category_option_group_set.additional_properties = d
