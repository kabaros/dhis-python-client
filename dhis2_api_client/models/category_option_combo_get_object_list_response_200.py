...
T = TypeVar("T", bound="CategoryOptionComboGetObjectListResponse200")


@_attrs_define
class CategoryOptionComboGetObjectListResponse200:
    """
    Attributes:
        pager (Union[Unset, Pager]):
        category_option_combos (Union[Unset, list['CategoryOptionCombo']]):
    """

    pager: Union[Unset, "Pager"] = UNSET
    category_option_combos: Union[Unset, list["CategoryOptionCombo"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for category_option_combos_item_data in _category_option_combos or []:
            category_option_combos_item = CategoryOptionCombo.from_dict(category_option_combos_item_data)

            category_option_combos.append(category_option_combos_item)

        category_option_combo_get_object_list_response_200 = cls(
            pager=pager,
            category_option_combos=category_option_combos,
        )

        category_option_combo_get_object_list_response_200.additional_properties = d
        return category_option_combo_get_object_list_response_200
