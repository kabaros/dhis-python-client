...
T = TypeVar("T", bound="IndicatorGetObjectListResponse200")


@_attrs_define
class IndicatorGetObjectListResponse200:
    """
    Attributes:
        pager (Union[Unset, Pager]):
        indicators (Union[Unset, list['Indicator']]):
    """

    pager: Union[Unset, "Pager"] = UNSET
    indicators: Union[Unset, list["Indicator"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        indicator_get_object_list_response_200 = cls(
            pager=pager,
            indicators=indicators,
        )

        indicator_get_object_list_response_200.additional_properties = d
        return indicator_get_object_list_response_200
