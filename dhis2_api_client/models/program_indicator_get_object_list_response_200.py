...
T = TypeVar("T", bound="ProgramIndicatorGetObjectListResponse200")


@_attrs_define
class ProgramIndicatorGetObjectListResponse200:
    """
    Attributes:
        pager (Union[Unset, Pager]):
        program_indicators (Union[Unset, list['ProgramIndicator']]):
    """

    pager: Union[Unset, "Pager"] = UNSET
    program_indicators: Union[Unset, list["ProgramIndicator"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for program_indicators_item_data in _program_indicators or []:
            program_indicators_item = ProgramIndicator.from_dict(program_indicators_item_data)

            program_indicators.append(program_indicators_item)

        program_indicator_get_object_list_response_200 = cls(
            pager=pager,
            program_indicators=program_indicators,
        )

        program_indicator_get_object_list_response_200.additional_properties = d
        return program_indicator_get_object_list_response_200
