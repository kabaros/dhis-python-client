...
T = TypeVar("T", bound="CategoryOptionGroupGetObjectListResponse200")


@_attrs_define
class CategoryOptionGroupGetObjectListResponse200:
    """
    Attributes:
        pager (Union[Unset, Pager]):
        category_option_groups (Union[Unset, list['CategoryOptionGroup']]):
    """

    pager: Union[Unset, "Pager"] = UNSET
    category_option_groups: Union[Unset, list["CategoryOptionGroup"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for category_option_groups_item_data in _category_option_groups or []:
            category_option_groups_item = CategoryOptionGroup.from_dict(category_option_groups_item_data)

            category_option_groups.append(category_option_groups_item)

        category_option_group_get_object_list_response_200 = cls(
            pager=pager,
            category_option_groups=category_option_groups,
        )

        category_option_group_get_object_list_response_200.additional_properties = d
        return category_option_group_get_object_list_response_200
