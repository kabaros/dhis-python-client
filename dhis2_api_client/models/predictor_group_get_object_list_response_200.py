...
T = TypeVar("T", bound="PredictorGroupGetObjectListResponse200")


@_attrs_define
class PredictorGroupGetObjectListResponse200:
    """
    Attributes:
        pager (Union[Unset, Pager]):
        predictor_groups (Union[Unset, list['PredictorGroup']]):
    """

    pager: Union[Unset, "Pager"] = UNSET
    predictor_groups: Union[Unset, list["PredictorGroup"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for predictor_groups_item_data in _predictor_groups or []:
            predictor_groups_item = PredictorGroup.from_dict(predictor_groups_item_data)

            predictor_groups.append(predictor_groups_item)

        predictor_group_get_object_list_response_200 = cls(
            pager=pager,
            predictor_groups=predictor_groups,
        )

        predictor_group_get_object_list_response_200.additional_properties = d
        return predictor_group_get_object_list_response_200
