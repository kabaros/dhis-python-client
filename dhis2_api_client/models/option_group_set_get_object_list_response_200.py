...
T = TypeVar("T", bound="OptionGroupSetGetObjectListResponse200")


@_attrs_define
class OptionGroupSetGetObjectListResponse200:
    """
    Attributes:
        pager (Union[Unset, Pager]):
        option_group_sets (Union[Unset, list['OptionGroupSet']]):
    """

    pager: Union[Unset, "Pager"] = UNSET
    option_group_sets: Union[Unset, list["OptionGroupSet"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for option_group_sets_item_data in _option_group_sets or []:
            option_group_sets_item = OptionGroupSet.from_dict(option_group_sets_item_data)

            option_group_sets.append(option_group_sets_item)

        option_group_set_get_object_list_response_200 = cls(
            pager=pager,
            option_group_sets=option_group_sets,
        )

        option_group_set_get_object_list_response_200.additional_properties = d
        return option_group_set_get_object_list_response_200
