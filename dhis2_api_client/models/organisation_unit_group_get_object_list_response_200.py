...
T = TypeVar("T", bound="OrganisationUnitGroupGetObjectListResponse200")


@_attrs_define
class OrganisationUnitGroupGetObjectListResponse200:
    """
    Attributes:
        pager (Union[Unset, Pager]):
        organisation_unit_groups (Union[Unset, list['OrganisationUnitGroup']]):
    """

    pager: Union[Unset, "Pager"] = UNSET
    organisation_unit_groups: Union[Unset, list["OrganisationUnitGroup"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for organisation_unit_groups_item_data in _organisation_unit_groups or []:
            organisation_unit_groups_item = OrganisationUnitGroup.from_dict(organisation_unit_groups_item_data)

            organisation_unit_groups.append(organisation_unit_groups_item)

        organisation_unit_group_get_object_list_response_200 = cls(
            pager=pager,
            organisation_unit_groups=organisation_unit_groups,
        )

        organisation_unit_group_get_object_list_response_200.additional_properties = d
        return organisation_unit_group_get_object_list_response_200
