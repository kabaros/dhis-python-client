...
if TYPE_CHECKING:
    ...
    from ..models.tracker_relationship_item_tracked_entity_enrollments_item import (
        TrackerRelationshipItemTrackedEntityEnrollmentsItem,
    )
    from ..models.tracker_relationship_item_tracked_entity_geometry import TrackerRelationshipItemTrackedEntityGeometry
    from ..models.tracker_user import TrackerUser


T = TypeVar("T", bound="TrackerRelationshipItemTrackedEntity")


@_attrs_define
class TrackerRelationshipItemTrackedEntity:
    """
    Attributes:
        ...
        enrollments (Union[Unset, list['TrackerRelationshipItemTrackedEntityEnrollmentsItem']]):
        geometry (Union[Unset, TrackerRelationshipItemTrackedEntityGeometry]):
        ...
        tracked_entity (Union[Unset, str]): A UID for an TrackedEntity object
            (Java name `org.hisp.dhis.webapi.controller.tracker.view.RelationshipItem$TrackedEntity`) Example: zg9rM85NF00.
    ...
    enrollments: Union[Unset, list["TrackerRelationshipItemTrackedEntityEnrollmentsItem"]] = UNSET
    geometry: Union[Unset, "TrackerRelationshipItemTrackedEntityGeometry"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        from ..models.tracker_relationship_item_tracked_entity_geometry import (
            TrackerRelationshipItemTrackedEntityGeometry,
        )
        from ..models.tracker_user import TrackerUser
        ...
        for enrollments_item_data in _enrollments or []:
            enrollments_item = TrackerRelationshipItemTrackedEntityEnrollmentsItem.from_dict(enrollments_item_data)
        ...
        if isinstance(_geometry, Unset):
            ...
            geometry = TrackerRelationshipItemTrackedEntityGeometry.from_dict(_geometry)
        ...
        tracker_relationship_item_tracked_entity = cls(
        ...
        tracker_relationship_item_tracked_entity.additional_properties = d
        return tracker_relationship_item_tracked_entity
