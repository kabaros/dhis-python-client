...
T = TypeVar("T", bound="ApiTokenGetObjectList2Response200")


@_attrs_define
class ApiTokenGetObjectList2Response200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        api_token_get_object_list_2_response_200 = cls(
            pager=pager,
            api_token=api_token,
        )

        api_token_get_object_list_2_response_200.additional_properties = d
        return api_token_get_object_list_2_response_200
