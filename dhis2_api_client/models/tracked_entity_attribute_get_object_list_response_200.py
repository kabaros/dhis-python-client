...
T = TypeVar("T", bound="TrackedEntityAttributeGetObjectListResponse200")


@_attrs_define
class TrackedEntityAttributeGetObjectListResponse200:
    """
    Attributes:
        pager (Union[Unset, Pager]):
        tracked_entity_attributes (Union[Unset, list['TrackedEntityAttribute']]):
    """

    pager: Union[Unset, "Pager"] = UNSET
    tracked_entity_attributes: Union[Unset, list["TrackedEntityAttribute"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for tracked_entity_attributes_item_data in _tracked_entity_attributes or []:
            tracked_entity_attributes_item = TrackedEntityAttribute.from_dict(tracked_entity_attributes_item_data)

            tracked_entity_attributes.append(tracked_entity_attributes_item)

        tracked_entity_attribute_get_object_list_response_200 = cls(
            pager=pager,
            tracked_entity_attributes=tracked_entity_attributes,
        )

        tracked_entity_attribute_get_object_list_response_200.additional_properties = d
        return tracked_entity_attribute_get_object_list_response_200
