...
T = TypeVar("T", bound="IndicatorGroupSetGetObjectListResponse200")


@_attrs_define
class IndicatorGroupSetGetObjectListResponse200:
    """
    Attributes:
        pager (Union[Unset, Pager]):
        indicator_group_sets (Union[Unset, list['IndicatorGroupSet']]):
    """

    pager: Union[Unset, "Pager"] = UNSET
    indicator_group_sets: Union[Unset, list["IndicatorGroupSet"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for indicator_group_sets_item_data in _indicator_group_sets or []:
            indicator_group_sets_item = IndicatorGroupSet.from_dict(indicator_group_sets_item_data)

            indicator_group_sets.append(indicator_group_sets_item)

        indicator_group_set_get_object_list_response_200 = cls(
            pager=pager,
            indicator_group_sets=indicator_group_sets,
        )

        indicator_group_set_get_object_list_response_200.additional_properties = d
        return indicator_group_set_get_object_list_response_200
