...
T = TypeVar("T", bound="SectionGetObjectListResponse200")


@_attrs_define
class SectionGetObjectListResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        section_get_object_list_response_200 = cls(
            pager=pager,
            sections=sections,
        )

        section_get_object_list_response_200.additional_properties = d
        return section_get_object_list_response_200
