...
T = TypeVar("T", bound="DataEntryFormGetObjectListResponse200")


@_attrs_define
class DataEntryFormGetObjectListResponse200:
    """
    Attributes:
        pager (Union[Unset, Pager]):
        data_entry_forms (Union[Unset, list['DataEntryForm']]):
    """

    pager: Union[Unset, "Pager"] = UNSET
    data_entry_forms: Union[Unset, list["DataEntryForm"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for data_entry_forms_item_data in _data_entry_forms or []:
            data_entry_forms_item = DataEntryForm.from_dict(data_entry_forms_item_data)

            data_entry_forms.append(data_entry_forms_item)

        data_entry_form_get_object_list_response_200 = cls(
            pager=pager,
            data_entry_forms=data_entry_forms,
        )

        data_entry_form_get_object_list_response_200.additional_properties = d
        return data_entry_form_get_object_list_response_200
