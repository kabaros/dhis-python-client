...
T = TypeVar("T", bound="ProgramGetObjectListResponse200")


@_attrs_define
class ProgramGetObjectListResponse200:
    """
    Attributes:
        pager (Union[Unset, Pager]):
        programs (Union[Unset, list['Program']]):
    """
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        program_get_object_list_response_200 = cls(
            pager=pager,
            programs=programs,
        )

        program_get_object_list_response_200.additional_properties = d
        return program_get_object_list_response_200
