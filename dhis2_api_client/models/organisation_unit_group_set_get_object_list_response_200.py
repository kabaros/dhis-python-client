...
T = TypeVar("T", bound="OrganisationUnitGroupSetGetObjectListResponse200")


@_attrs_define
class OrganisationUnitGroupSetGetObjectListResponse200:
    """
    Attributes:
        pager (Union[Unset, Pager]):
        organisation_unit_group_sets (Union[Unset, list['OrganisationUnitGroupSet']]):
    """

    pager: Union[Unset, "Pager"] = UNSET
    organisation_unit_group_sets: Union[Unset, list["OrganisationUnitGroupSet"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for organisation_unit_group_sets_item_data in _organisation_unit_group_sets or []:
            organisation_unit_group_sets_item = OrganisationUnitGroupSet.from_dict(
                organisation_unit_group_sets_item_data
            )

            organisation_unit_group_sets.append(organisation_unit_group_sets_item)

        organisation_unit_group_set_get_object_list_response_200 = cls(
            pager=pager,
            organisation_unit_group_sets=organisation_unit_group_sets,
        )

        organisation_unit_group_set_get_object_list_response_200.additional_properties = d
        return organisation_unit_group_set_get_object_list_response_200
