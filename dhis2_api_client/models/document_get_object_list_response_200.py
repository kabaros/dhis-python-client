...
T = TypeVar("T", bound="DocumentGetObjectListResponse200")


@_attrs_define
class DocumentGetObjectListResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        document_get_object_list_response_200 = cls(
            pager=pager,
            documents=documents,
        )

        document_get_object_list_response_200.additional_properties = d
        return document_get_object_list_response_200
