...
if TYPE_CHECKING:
    ...
    from ..models.data_element_group_created_by import DataElementGroupCreatedBy
    from ..models.data_element_group_data_elements_item import DataElementGroupDataElementsItem
    from ..models.data_element_group_group_sets_item import DataElementGroupGroupSetsItem
    from ..models.data_element_group_last_updated_by import DataElementGroupLastUpdatedBy
    from ..models.data_element_group_legend_set import DataElementGroupLegendSet
    from ..models.data_element_group_legend_sets_item import DataElementGroupLegendSetsItem
    from ..models.data_element_group_user import DataElementGroupUser
    from ..models.query_modifiers import QueryModifiers
    from ..models.sharing import Sharing
    from ..models.translation import Translation


T = TypeVar("T", bound="DataElementGroup")
...
class DataElementGroup:
    ...
    Attributes:
        ...
        created_by (Union[Unset, DataElementGroupCreatedBy]): A UID reference to a User
            (Java name `org.hisp.dhis.user.User`)
        data_elements (Union[Unset, list['DataElementGroupDataElementsItem']]):
        ...
        group_sets (Union[Unset, list['DataElementGroupGroupSetsItem']]):
        href (Union[Unset, str]):
        id (Union[Unset, str]):
        last_updated (Union[Unset, datetime.datetime]):
        last_updated_by (Union[Unset, DataElementGroupLastUpdatedBy]): A UID reference to a User
            (Java name `org.hisp.dhis.user.User`)
        legend_set (Union[Unset, DataElementGroupLegendSet]): A UID reference to a LegendSet
            (Java name `org.hisp.dhis.legend.LegendSet`)
        legend_sets (Union[Unset, list['DataElementGroupLegendSetsItem']]):
        name (Union[Unset, str]):
        query_mods (Union[Unset, QueryModifiers]):
        sharing (Union[Unset, Sharing]):
        short_name (Union[Unset, str]):
        translations (Union[Unset, list['Translation']]):
        user (Union[Unset, DataElementGroupUser]): A UID reference to a User
            (Java name `org.hisp.dhis.user.User`)
    """
    ...
    created_by: Union[Unset, "DataElementGroupCreatedBy"] = UNSET
    data_elements: Union[Unset, list["DataElementGroupDataElementsItem"]] = UNSET
    ...
    group_sets: Union[Unset, list["DataElementGroupGroupSetsItem"]] = UNSET
    href: Union[Unset, str] = UNSET
    id: Union[Unset, str] = UNSET
    last_updated: Union[Unset, datetime.datetime] = UNSET
    last_updated_by: Union[Unset, "DataElementGroupLastUpdatedBy"] = UNSET
    legend_set: Union[Unset, "DataElementGroupLegendSet"] = UNSET
    legend_sets: Union[Unset, list["DataElementGroupLegendSetsItem"]] = UNSET
    name: Union[Unset, str] = UNSET
    query_mods: Union[Unset, "QueryModifiers"] = UNSET
    sharing: Union[Unset, "Sharing"] = UNSET
    short_name: Union[Unset, str] = UNSET
    translations: Union[Unset, list["Translation"]] = UNSET
    user: Union[Unset, "DataElementGroupUser"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        created_by: Union[Unset, DataElementGroupCreatedBy]
        if isinstance(_created_by, Unset):
            created_by = UNSET
        else:
            created_by = DataElementGroupCreatedBy.from_dict(_created_by)

        data_elements = []
        _data_elements = d.pop("dataElements", UNSET)
        for data_elements_item_data in _data_elements or []:
            data_elements_item = DataElementGroupDataElementsItem.from_dict(data_elements_item_data)
        ...
        for group_sets_item_data in _group_sets or []:
            group_sets_item = DataElementGroupGroupSetsItem.from_dict(group_sets_item_data)
        ...
        last_updated_by: Union[Unset, DataElementGroupLastUpdatedBy]
        if isinstance(_last_updated_by, Unset):
            last_updated_by = UNSET
        else:
            last_updated_by = DataElementGroupLastUpdatedBy.from_dict(_last_updated_by)

        _legend_set = d.pop("legendSet", UNSET)
        legend_set: Union[Unset, DataElementGroupLegendSet]
        if isinstance(_legend_set, Unset):
            legend_set = UNSET
        else:
            legend_set = DataElementGroupLegendSet.from_dict(_legend_set)

        legend_sets = []
        _legend_sets = d.pop("legendSets", UNSET)
        for legend_sets_item_data in _legend_sets or []:
            legend_sets_item = DataElementGroupLegendSetsItem.from_dict(legend_sets_item_data)
        ...
        user: Union[Unset, DataElementGroupUser]
        if isinstance(_user, Unset):
            user = UNSET
        else:
            user = DataElementGroupUser.from_dict(_user)

        data_element_group = cls(
            access=access,
        ...
        data_element_group.additional_properties = d
