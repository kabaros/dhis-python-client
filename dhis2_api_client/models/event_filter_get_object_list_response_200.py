...
T = TypeVar("T", bound="EventFilterGetObjectListResponse200")


@_attrs_define
class EventFilterGetObjectListResponse200:
    """
    Attributes:
        pager (Union[Unset, Pager]):
        event_filters (Union[Unset, list['EventFilter']]):
    """

    pager: Union[Unset, "Pager"] = UNSET
    event_filters: Union[Unset, list["EventFilter"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for event_filters_item_data in _event_filters or []:
            event_filters_item = EventFilter.from_dict(event_filters_item_data)

            event_filters.append(event_filters_item)

        event_filter_get_object_list_response_200 = cls(
            pager=pager,
            event_filters=event_filters,
        )

        event_filter_get_object_list_response_200.additional_properties = d
        return event_filter_get_object_list_response_200
