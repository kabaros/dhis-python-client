...
T = TypeVar("T", bound="AnalyticsTableHookGetObjectListResponse200")


@_attrs_define
class AnalyticsTableHookGetObjectListResponse200:
    """
    Attributes:
        pager (Union[Unset, Pager]):
        analytics_table_hooks (Union[Unset, list['AnalyticsTableHook']]):
    """

    pager: Union[Unset, "Pager"] = UNSET
    analytics_table_hooks: Union[Unset, list["AnalyticsTableHook"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for analytics_table_hooks_item_data in _analytics_table_hooks or []:
            analytics_table_hooks_item = AnalyticsTableHook.from_dict(analytics_table_hooks_item_data)

            analytics_table_hooks.append(analytics_table_hooks_item)

        analytics_table_hook_get_object_list_response_200 = cls(
            pager=pager,
            analytics_table_hooks=analytics_table_hooks,
        )

        analytics_table_hook_get_object_list_response_200.additional_properties = d
        return analytics_table_hook_get_object_list_response_200
