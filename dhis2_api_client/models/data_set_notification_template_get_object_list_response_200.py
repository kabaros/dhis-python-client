...
T = TypeVar("T", bound="DataSetNotificationTemplateGetObjectListResponse200")


@_attrs_define
class DataSetNotificationTemplateGetObjectListResponse200:
    """
    Attributes:
        pager (Union[Unset, Pager]):
        data_set_notification_templates (Union[Unset, list['DataSetNotificationTemplate']]):
    """

    pager: Union[Unset, "Pager"] = UNSET
    data_set_notification_templates: Union[Unset, list["DataSetNotificationTemplate"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for data_set_notification_templates_item_data in _data_set_notification_templates or []:
            data_set_notification_templates_item = DataSetNotificationTemplate.from_dict(
                data_set_notification_templates_item_data
            )

            data_set_notification_templates.append(data_set_notification_templates_item)

        data_set_notification_template_get_object_list_response_200 = cls(
            pager=pager,
            data_set_notification_templates=data_set_notification_templates,
        )

        data_set_notification_template_get_object_list_response_200.additional_properties = d
        return data_set_notification_template_get_object_list_response_200
