...
from ..models.tracker_relationship_item_enrollment_status import TrackerRelationshipItemEnrollmentStatus
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.tracker_attribute import TrackerAttribute
    from ..models.tracker_note import TrackerNote
    from ..models.tracker_relationship_item_enrollment_events_item import TrackerRelationshipItemEnrollmentEventsItem
    from ..models.tracker_relationship_item_enrollment_geometry import TrackerRelationshipItemEnrollmentGeometry
    from ..models.tracker_user import TrackerUser


T = TypeVar("T", bound="TrackerRelationshipItemEnrollment")


@_attrs_define
class TrackerRelationshipItemEnrollment:
    """
    Attributes:
        status (TrackerRelationshipItemEnrollmentStatus):
        ...
        events (Union[Unset, list['TrackerRelationshipItemEnrollmentEventsItem']]):
        follow_up (Union[Unset, bool]):
        geometry (Union[Unset, TrackerRelationshipItemEnrollmentGeometry]):
    ...
    events: Union[Unset, list["TrackerRelationshipItemEnrollmentEventsItem"]] = UNSET
    follow_up: Union[Unset, bool] = UNSET
    geometry: Union[Unset, "TrackerRelationshipItemEnrollmentGeometry"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        from ..models.tracker_attribute import TrackerAttribute
        from ..models.tracker_note import TrackerNote
        from ..models.tracker_relationship_item_enrollment_events_item import (
            TrackerRelationshipItemEnrollmentEventsItem,
        )
        from ..models.tracker_relationship_item_enrollment_geometry import TrackerRelationshipItemEnrollmentGeometry
        from ..models.tracker_user import TrackerUser

        d = src_dict.copy()
        status = TrackerRelationshipItemEnrollmentStatus(d.pop("status"))
        ...
        for events_item_data in _events or []:
            events_item = TrackerRelationshipItemEnrollmentEventsItem.from_dict(events_item_data)
        ...
        if isinstance(_geometry, Unset):
            ...
            geometry = TrackerRelationshipItemEnrollmentGeometry.from_dict(_geometry)
        ...
        tracker_relationship_item_enrollment = cls(
            status=status,
        ...
        tracker_relationship_item_enrollment.additional_properties = d
        return tracker_relationship_item_enrollment
