...
from ..models.tracker_relationship_item_event_status import TrackerRelationshipItemEventStatus
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.tracker_data_value import TrackerDataValue
    from ..models.tracker_note import TrackerNote
    from ..models.tracker_relationship_item_event_geometry import TrackerRelationshipItemEventGeometry
    from ..models.tracker_user import TrackerUser


T = TypeVar("T", bound="TrackerRelationshipItemEvent")


@_attrs_define
class TrackerRelationshipItemEvent:
    """
    Attributes:
        status (TrackerRelationshipItemEventStatus):
        ...
        geometry (Union[Unset, TrackerRelationshipItemEventGeometry]):
    ...
    geometry: Union[Unset, "TrackerRelationshipItemEventGeometry"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        status = TrackerRelationshipItemEventStatus(d.pop("status"))
        ...
        if isinstance(_geometry, Unset):
            ...
            geometry = TrackerRelationshipItemEventGeometry.from_dict(_geometry)
        ...
        tracker_relationship_item_event = cls(
            status=status,
        ...
        tracker_relationship_item_event.additional_properties = d
        return tracker_relationship_item_event
