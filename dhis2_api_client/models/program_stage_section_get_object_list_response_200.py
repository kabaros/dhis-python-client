...
T = TypeVar("T", bound="ProgramStageSectionGetObjectListResponse200")


@_attrs_define
class ProgramStageSectionGetObjectListResponse200:
    """
    Attributes:
        pager (Union[Unset, Pager]):
        program_stage_sections (Union[Unset, list['ProgramStageSection']]):
    """

    pager: Union[Unset, "Pager"] = UNSET
    program_stage_sections: Union[Unset, list["ProgramStageSection"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for program_stage_sections_item_data in _program_stage_sections or []:
            program_stage_sections_item = ProgramStageSection.from_dict(program_stage_sections_item_data)

            program_stage_sections.append(program_stage_sections_item)

        program_stage_section_get_object_list_response_200 = cls(
            pager=pager,
            program_stage_sections=program_stage_sections,
        )

        program_stage_section_get_object_list_response_200.additional_properties = d
        return program_stage_section_get_object_list_response_200
