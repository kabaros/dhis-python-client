...
T = TypeVar("T", bound="TrackedEntityFilterGetObjectListResponse200")


@_attrs_define
class TrackedEntityFilterGetObjectListResponse200:
    """
    Attributes:
        pager (Union[Unset, Pager]):
        tracked_entity_instance_filters (Union[Unset, list['TrackedEntityFilter']]):
    """

    pager: Union[Unset, "Pager"] = UNSET
    tracked_entity_instance_filters: Union[Unset, list["TrackedEntityFilter"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for tracked_entity_instance_filters_item_data in _tracked_entity_instance_filters or []:
            tracked_entity_instance_filters_item = TrackedEntityFilter.from_dict(
                tracked_entity_instance_filters_item_data
            )

            tracked_entity_instance_filters.append(tracked_entity_instance_filters_item)

        tracked_entity_filter_get_object_list_response_200 = cls(
            pager=pager,
            tracked_entity_instance_filters=tracked_entity_instance_filters,
        )

        tracked_entity_filter_get_object_list_response_200.additional_properties = d
        return tracked_entity_filter_get_object_list_response_200
