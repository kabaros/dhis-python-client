...
from ...models.sms_command_replace_translations_body import SmsCommandReplaceTranslationsBody
...
def _get_kwargs(
    uid: str,
    *,
    body: SmsCommandReplaceTranslationsBody,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": f"/smsCommands/{uid}/translations",
    }
