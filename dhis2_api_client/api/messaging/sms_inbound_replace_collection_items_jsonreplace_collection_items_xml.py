...
from ...models.sms_inbound_replace_collection_items_jsonreplace_collection_items_xml_property import (
    SmsInboundReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: SmsInboundReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
    *,
