...
from ...models.sms_outbound_replace_collection_items_jsonreplace_collection_items_xml_property import (
    SmsOutboundReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: SmsOutboundReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
    *,
