...
from ...models.sms_command_replace_collection_items_jsonreplace_collection_items_xml_property import (
    SmsCommandReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: SmsCommandReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
    *,
