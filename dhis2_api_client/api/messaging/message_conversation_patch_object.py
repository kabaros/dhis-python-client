...
from ...models.message_conversation_patch_object_atomic_mode import MessageConversationPatchObjectAtomicMode
from ...models.message_conversation_patch_object_flush_mode import MessageConversationPatchObjectFlushMode
from ...models.message_conversation_patch_object_identifier import MessageConversationPatchObjectIdentifier
from ...models.message_conversation_patch_object_import_mode import MessageConversationPatchObjectImportMode
from ...models.message_conversation_patch_object_import_report_mode import (
    MessageConversationPatchObjectImportReportMode,
)
from ...models.message_conversation_patch_object_import_strategy import MessageConversationPatchObjectImportStrategy
from ...models.message_conversation_patch_object_preheat_mode import MessageConversationPatchObjectPreheatMode
from ...models.message_conversation_patch_object_root_junction import MessageConversationPatchObjectRootJunction
from ...models.message_conversation_patch_object_user_override_mode import (
    MessageConversationPatchObjectUserOverrideMode,
)
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[Unset, MessageConversationPatchObjectAtomicMode] = MessageConversationPatchObjectAtomicMode.ALL,
    flush_mode: Union[Unset, MessageConversationPatchObjectFlushMode] = MessageConversationPatchObjectFlushMode.AUTO,
    identifier: Union[Unset, MessageConversationPatchObjectIdentifier] = MessageConversationPatchObjectIdentifier.UID,
    import_mode: Union[
        Unset, MessageConversationPatchObjectImportMode
    ] = MessageConversationPatchObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, MessageConversationPatchObjectImportReportMode
    ] = MessageConversationPatchObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, MessageConversationPatchObjectImportStrategy
    ] = MessageConversationPatchObjectImportStrategy.CREATE_AND_UPDATE,
    ...
    preheat_mode: Union[
        Unset, MessageConversationPatchObjectPreheatMode
    ] = MessageConversationPatchObjectPreheatMode.REFERENCE,
    root_junction: Union[Unset, MessageConversationPatchObjectRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, MessageConversationPatchObjectUserOverrideMode
    ] = MessageConversationPatchObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, MessageConversationPatchObjectAtomicMode]):  Default:
            MessageConversationPatchObjectAtomicMode.ALL.
        flush_mode (Union[Unset, MessageConversationPatchObjectFlushMode]):  Default:
            MessageConversationPatchObjectFlushMode.AUTO.
        identifier (Union[Unset, MessageConversationPatchObjectIdentifier]):  Default:
            MessageConversationPatchObjectIdentifier.UID.
        import_mode (Union[Unset, MessageConversationPatchObjectImportMode]):  Default:
            MessageConversationPatchObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, MessageConversationPatchObjectImportReportMode]):
            Default: MessageConversationPatchObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, MessageConversationPatchObjectImportStrategy]):  Default:
            MessageConversationPatchObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, MessageConversationPatchObjectPreheatMode]):  Default:
            MessageConversationPatchObjectPreheatMode.REFERENCE.
        root_junction (Union[Unset, MessageConversationPatchObjectRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, MessageConversationPatchObjectUserOverrideMode]):
            Default: MessageConversationPatchObjectUserOverrideMode.NONE.
        body (JsonPatch):
