...
from ...models.message_conversation_bulk_sharing_atomic_mode import MessageConversationBulkSharingAtomicMode
from ...models.message_conversation_bulk_sharing_flush_mode import MessageConversationBulkSharingFlushMode
from ...models.message_conversation_bulk_sharing_identifier import MessageConversationBulkSharingIdentifier
from ...models.message_conversation_bulk_sharing_import_mode import MessageConversationBulkSharingImportMode
from ...models.message_conversation_bulk_sharing_import_report_mode import (
    MessageConversationBulkSharingImportReportMode,
)
from ...models.message_conversation_bulk_sharing_import_strategy import MessageConversationBulkSharingImportStrategy
from ...models.message_conversation_bulk_sharing_preheat_mode import MessageConversationBulkSharingPreheatMode
from ...models.message_conversation_bulk_sharing_root_junction import MessageConversationBulkSharingRootJunction
from ...models.message_conversation_bulk_sharing_user_override_mode import (
    MessageConversationBulkSharingUserOverrideMode,
)
...
def _get_kwargs(
    *,
    ...
    atomic_mode: Union[Unset, MessageConversationBulkSharingAtomicMode] = MessageConversationBulkSharingAtomicMode.ALL,
    flush_mode: Union[Unset, MessageConversationBulkSharingFlushMode] = MessageConversationBulkSharingFlushMode.AUTO,
    identifier: Union[Unset, MessageConversationBulkSharingIdentifier] = MessageConversationBulkSharingIdentifier.UID,
    import_mode: Union[
        Unset, MessageConversationBulkSharingImportMode
    ] = MessageConversationBulkSharingImportMode.COMMIT,
    import_report_mode: Union[
        Unset, MessageConversationBulkSharingImportReportMode
    ] = MessageConversationBulkSharingImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, MessageConversationBulkSharingImportStrategy
    ] = MessageConversationBulkSharingImportStrategy.CREATE_AND_UPDATE,
    ...
    preheat_mode: Union[
        Unset, MessageConversationBulkSharingPreheatMode
    ] = MessageConversationBulkSharingPreheatMode.REFERENCE,
    root_junction: Union[Unset, MessageConversationBulkSharingRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, MessageConversationBulkSharingUserOverrideMode
    ] = MessageConversationBulkSharingUserOverrideMode.NONE,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/messageConversations/sharing",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, MessageConversationBulkSharingAtomicMode]):  Default:
            MessageConversationBulkSharingAtomicMode.ALL.
        flush_mode (Union[Unset, MessageConversationBulkSharingFlushMode]):  Default:
            MessageConversationBulkSharingFlushMode.AUTO.
        identifier (Union[Unset, MessageConversationBulkSharingIdentifier]):  Default:
            MessageConversationBulkSharingIdentifier.UID.
        import_mode (Union[Unset, MessageConversationBulkSharingImportMode]):  Default:
            MessageConversationBulkSharingImportMode.COMMIT.
        import_report_mode (Union[Unset, MessageConversationBulkSharingImportReportMode]):
            Default: MessageConversationBulkSharingImportReportMode.ERRORS.
        import_strategy (Union[Unset, MessageConversationBulkSharingImportStrategy]):  Default:
            MessageConversationBulkSharingImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, MessageConversationBulkSharingPreheatMode]):  Default:
            MessageConversationBulkSharingPreheatMode.REFERENCE.
        root_junction (Union[Unset, MessageConversationBulkSharingRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, MessageConversationBulkSharingUserOverrideMode]):
            Default: MessageConversationBulkSharingUserOverrideMode.NONE.
        body (BulkJsonPatch):
