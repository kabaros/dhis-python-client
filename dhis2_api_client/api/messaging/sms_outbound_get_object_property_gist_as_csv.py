...
from ...models.sms_outbound_get_object_property_gist_as_csv_auto import SmsOutboundGetObjectPropertyGistAsCsvAuto
from ...models.sms_outbound_get_object_property_gist_as_csv_property import (
    SmsOutboundGetObjectPropertyGistAsCsvProperty,
)
from ...models.sms_outbound_get_object_property_gist_as_csv_root_junction import (
    SmsOutboundGetObjectPropertyGistAsCsvRootJunction,
)
...
def _get_kwargs(
    uid: str,
    property_: SmsOutboundGetObjectPropertyGistAsCsvProperty,
    *,
    absolute_urls: Union[Unset, bool] = False,
    auto: Union[Unset, SmsOutboundGetObjectPropertyGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, SmsOutboundGetObjectPropertyGistAsCsvRootJunction
    ] = SmsOutboundGetObjectPropertyGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/sms/outbound/{uid}/{property_}/gist.csv",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, SmsOutboundGetObjectPropertyGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, SmsOutboundGetObjectPropertyGistAsCsvRootJunction]):  Default:
            SmsOutboundGetObjectPropertyGistAsCsvRootJunction.AND.
