...
from ...models.sms_outbound_delete_collection_item_property import SmsOutboundDeleteCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: SmsOutboundDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/sms/outbound/{uid}/{property_}/{item_id}",
    }
