...
from ...models.sms_outbound_get_object_list_response_200 import SmsOutboundGetObjectListResponse200
from ...models.sms_outbound_get_object_list_root_junction import SmsOutboundGetObjectListRootJunction
...
def _get_kwargs(
    *,
    ...
    root_junction: Union[Unset, SmsOutboundGetObjectListRootJunction] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
) -> Optional[Union[SmsOutboundGetObjectListResponse200, WebMessage]]:
    if response.status_code == 200:
        response_200 = SmsOutboundGetObjectListResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[SmsOutboundGetObjectListResponse200, WebMessage]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, SmsOutboundGetObjectListRootJunction]):
...
def sync(
    *,
    ...
    Returns:
        Union[SmsOutboundGetObjectListResponse200, WebMessage]
    """
