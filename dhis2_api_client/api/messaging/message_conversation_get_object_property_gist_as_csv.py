...
from ...models.message_conversation_get_object_property_gist_as_csv_auto import (
    MessageConversationGetObjectPropertyGistAsCsvAuto,
)
from ...models.message_conversation_get_object_property_gist_as_csv_property import (
    MessageConversationGetObjectPropertyGistAsCsvProperty,
)
from ...models.message_conversation_get_object_property_gist_as_csv_root_junction import (
    MessageConversationGetObjectPropertyGistAsCsvRootJunction,
)
...
def _get_kwargs(
    uid: str,
    property_: MessageConversationGetObjectPropertyGistAsCsvProperty,
    *,
    absolute_urls: Union[Unset, bool] = False,
    auto: Union[Unset, MessageConversationGetObjectPropertyGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, MessageConversationGetObjectPropertyGistAsCsvRootJunction
    ] = MessageConversationGetObjectPropertyGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/messageConversations/{uid}/{property_}/gist.csv",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, MessageConversationGetObjectPropertyGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, MessageConversationGetObjectPropertyGistAsCsvRootJunction]):
            Default: MessageConversationGetObjectPropertyGistAsCsvRootJunction.AND.
