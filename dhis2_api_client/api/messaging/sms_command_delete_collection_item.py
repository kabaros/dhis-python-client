...
from ...models.sms_command_delete_collection_item_property import SmsCommandDeleteCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: SmsCommandDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/smsCommands/{uid}/{property_}/{item_id}",
    }
