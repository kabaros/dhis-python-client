...
from ...models.sms_command_get_object_property_gist_as_csv_auto import SmsCommandGetObjectPropertyGistAsCsvAuto
from ...models.sms_command_get_object_property_gist_as_csv_property import SmsCommandGetObjectPropertyGistAsCsvProperty
from ...models.sms_command_get_object_property_gist_as_csv_root_junction import (
    SmsCommandGetObjectPropertyGistAsCsvRootJunction,
)
...
def _get_kwargs(
    uid: str,
    property_: SmsCommandGetObjectPropertyGistAsCsvProperty,
    *,
    absolute_urls: Union[Unset, bool] = False,
    auto: Union[Unset, SmsCommandGetObjectPropertyGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, SmsCommandGetObjectPropertyGistAsCsvRootJunction
    ] = SmsCommandGetObjectPropertyGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/smsCommands/{uid}/{property_}/gist.csv",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, SmsCommandGetObjectPropertyGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, SmsCommandGetObjectPropertyGistAsCsvRootJunction]):  Default:
            SmsCommandGetObjectPropertyGistAsCsvRootJunction.AND.
