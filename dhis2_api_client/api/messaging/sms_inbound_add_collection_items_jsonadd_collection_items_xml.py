...
from ...models.sms_inbound_add_collection_items_jsonadd_collection_items_xml_property import (
    SmsInboundAddCollectionItemsJsonaddCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: SmsInboundAddCollectionItemsJsonaddCollectionItemsXmlProperty,
    *,
