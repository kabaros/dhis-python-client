...
from ...models.sms_command_get_object_root_junction import SmsCommandGetObjectRootJunction
...
def _get_kwargs(
    ...
    *,
    ...
    root_junction: Union[Unset, SmsCommandGetObjectRootJunction] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
) -> Optional[Union[SMSCommand, WebMessage]]:
    if response.status_code == 200:
        response_200 = SMSCommand.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[SMSCommand, WebMessage]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, SmsCommandGetObjectRootJunction]):
