...
from ...models.sms_command_add_collection_items_jsonadd_collection_items_xml_property import (
    SmsCommandAddCollectionItemsJsonaddCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: SmsCommandAddCollectionItemsJsonaddCollectionItemsXmlProperty,
    *,
