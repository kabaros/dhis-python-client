...
from ...models.sms_inbound_get_object_property_gist_as_csv_auto import SmsInboundGetObjectPropertyGistAsCsvAuto
from ...models.sms_inbound_get_object_property_gist_as_csv_property import SmsInboundGetObjectPropertyGistAsCsvProperty
from ...models.sms_inbound_get_object_property_gist_as_csv_root_junction import (
    SmsInboundGetObjectPropertyGistAsCsvRootJunction,
)
...
def _get_kwargs(
    uid: str,
    property_: SmsInboundGetObjectPropertyGistAsCsvProperty,
    *,
    absolute_urls: Union[Unset, bool] = False,
    auto: Union[Unset, SmsInboundGetObjectPropertyGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, SmsInboundGetObjectPropertyGistAsCsvRootJunction
    ] = SmsInboundGetObjectPropertyGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/sms/inbound/{uid}/{property_}/gist.csv",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, SmsInboundGetObjectPropertyGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, SmsInboundGetObjectPropertyGistAsCsvRootJunction]):  Default:
            SmsInboundGetObjectPropertyGistAsCsvRootJunction.AND.
