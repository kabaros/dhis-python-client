...
from ...models.sms_outbound_get_object_list_csv_root_junction import SmsOutboundGetObjectListCsvRootJunction
...
def _get_kwargs(
    *,
    ...
    root_junction: Union[Unset, SmsOutboundGetObjectListCsvRootJunction] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/sms/outbound/#getObjectListCsv",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, SmsOutboundGetObjectListCsvRootJunction]):
