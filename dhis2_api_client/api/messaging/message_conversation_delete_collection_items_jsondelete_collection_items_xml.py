...
from ...models.message_conversation_delete_collection_items_jsondelete_collection_items_xml_property import (
    MessageConversationDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: MessageConversationDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
    *,
