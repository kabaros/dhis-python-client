...
from ...models.sms_inbound_delete_collection_item_property import SmsInboundDeleteCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: SmsInboundDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/sms/inbound/{uid}/{property_}/{item_id}",
    }
