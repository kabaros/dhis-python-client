...
from ...models.sms_inbound_post_json_object_atomic_mode import SmsInboundPostJsonObjectAtomicMode
from ...models.sms_inbound_post_json_object_flush_mode import SmsInboundPostJsonObjectFlushMode
from ...models.sms_inbound_post_json_object_identifier import SmsInboundPostJsonObjectIdentifier
from ...models.sms_inbound_post_json_object_import_mode import SmsInboundPostJsonObjectImportMode
from ...models.sms_inbound_post_json_object_import_report_mode import SmsInboundPostJsonObjectImportReportMode
from ...models.sms_inbound_post_json_object_import_strategy import SmsInboundPostJsonObjectImportStrategy
from ...models.sms_inbound_post_json_object_preheat_mode import SmsInboundPostJsonObjectPreheatMode
from ...models.sms_inbound_post_json_object_user_override_mode import SmsInboundPostJsonObjectUserOverrideMode
...
def _get_kwargs(
    *,
    ...
    atomic_mode: Union[Unset, SmsInboundPostJsonObjectAtomicMode] = SmsInboundPostJsonObjectAtomicMode.ALL,
    flush_mode: Union[Unset, SmsInboundPostJsonObjectFlushMode] = SmsInboundPostJsonObjectFlushMode.AUTO,
    identifier: Union[Unset, SmsInboundPostJsonObjectIdentifier] = SmsInboundPostJsonObjectIdentifier.UID,
    import_mode: Union[Unset, SmsInboundPostJsonObjectImportMode] = SmsInboundPostJsonObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, SmsInboundPostJsonObjectImportReportMode
    ] = SmsInboundPostJsonObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, SmsInboundPostJsonObjectImportStrategy
    ] = SmsInboundPostJsonObjectImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    preheat_mode: Union[Unset, SmsInboundPostJsonObjectPreheatMode] = SmsInboundPostJsonObjectPreheatMode.REFERENCE,
    ...
    user_override_mode: Union[
        Unset, SmsInboundPostJsonObjectUserOverrideMode
    ] = SmsInboundPostJsonObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/sms/inbound/#postJsonObject",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, SmsInboundPostJsonObjectAtomicMode]):  Default:
            SmsInboundPostJsonObjectAtomicMode.ALL.
        flush_mode (Union[Unset, SmsInboundPostJsonObjectFlushMode]):  Default:
            SmsInboundPostJsonObjectFlushMode.AUTO.
        identifier (Union[Unset, SmsInboundPostJsonObjectIdentifier]):  Default:
            SmsInboundPostJsonObjectIdentifier.UID.
        import_mode (Union[Unset, SmsInboundPostJsonObjectImportMode]):  Default:
            SmsInboundPostJsonObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, SmsInboundPostJsonObjectImportReportMode]):  Default:
            SmsInboundPostJsonObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, SmsInboundPostJsonObjectImportStrategy]):  Default:
            SmsInboundPostJsonObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, SmsInboundPostJsonObjectPreheatMode]):  Default:
            SmsInboundPostJsonObjectPreheatMode.REFERENCE.
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, SmsInboundPostJsonObjectUserOverrideMode]):  Default:
            SmsInboundPostJsonObjectUserOverrideMode.NONE.
        body (IncomingSms):
