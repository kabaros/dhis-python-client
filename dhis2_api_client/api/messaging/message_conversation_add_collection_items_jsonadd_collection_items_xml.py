...
from ...models.message_conversation_add_collection_items_jsonadd_collection_items_xml_property import (
    MessageConversationAddCollectionItemsJsonaddCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: MessageConversationAddCollectionItemsJsonaddCollectionItemsXmlProperty,
    *,
