...
from ...models.message_conversation_replace_collection_items_jsonreplace_collection_items_xml_property import (
    MessageConversationReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: MessageConversationReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
    *,
