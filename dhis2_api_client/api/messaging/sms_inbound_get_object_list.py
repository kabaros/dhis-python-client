...
from ...models.sms_inbound_get_object_list_response_200 import SmsInboundGetObjectListResponse200
from ...models.sms_inbound_get_object_list_root_junction import SmsInboundGetObjectListRootJunction
...
def _get_kwargs(
    *,
    ...
    root_junction: Union[Unset, SmsInboundGetObjectListRootJunction] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
) -> Optional[Union[SmsInboundGetObjectListResponse200, WebMessage]]:
    if response.status_code == 200:
        response_200 = SmsInboundGetObjectListResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[SmsInboundGetObjectListResponse200, WebMessage]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, SmsInboundGetObjectListRootJunction]):
...
def sync(
    *,
    ...
    Returns:
        Union[SmsInboundGetObjectListResponse200, WebMessage]
    """
