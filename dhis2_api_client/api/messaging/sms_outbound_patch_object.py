...
from ...models.sms_outbound_patch_object_atomic_mode import SmsOutboundPatchObjectAtomicMode
from ...models.sms_outbound_patch_object_flush_mode import SmsOutboundPatchObjectFlushMode
from ...models.sms_outbound_patch_object_identifier import SmsOutboundPatchObjectIdentifier
from ...models.sms_outbound_patch_object_import_mode import SmsOutboundPatchObjectImportMode
from ...models.sms_outbound_patch_object_import_report_mode import SmsOutboundPatchObjectImportReportMode
from ...models.sms_outbound_patch_object_import_strategy import SmsOutboundPatchObjectImportStrategy
from ...models.sms_outbound_patch_object_preheat_mode import SmsOutboundPatchObjectPreheatMode
from ...models.sms_outbound_patch_object_root_junction import SmsOutboundPatchObjectRootJunction
from ...models.sms_outbound_patch_object_user_override_mode import SmsOutboundPatchObjectUserOverrideMode
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[Unset, SmsOutboundPatchObjectAtomicMode] = SmsOutboundPatchObjectAtomicMode.ALL,
    flush_mode: Union[Unset, SmsOutboundPatchObjectFlushMode] = SmsOutboundPatchObjectFlushMode.AUTO,
    identifier: Union[Unset, SmsOutboundPatchObjectIdentifier] = SmsOutboundPatchObjectIdentifier.UID,
    import_mode: Union[Unset, SmsOutboundPatchObjectImportMode] = SmsOutboundPatchObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, SmsOutboundPatchObjectImportReportMode
    ] = SmsOutboundPatchObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, SmsOutboundPatchObjectImportStrategy
    ] = SmsOutboundPatchObjectImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, SmsOutboundPatchObjectPreheatMode] = SmsOutboundPatchObjectPreheatMode.REFERENCE,
    root_junction: Union[Unset, SmsOutboundPatchObjectRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, SmsOutboundPatchObjectUserOverrideMode
    ] = SmsOutboundPatchObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, SmsOutboundPatchObjectAtomicMode]):  Default:
            SmsOutboundPatchObjectAtomicMode.ALL.
        flush_mode (Union[Unset, SmsOutboundPatchObjectFlushMode]):  Default:
            SmsOutboundPatchObjectFlushMode.AUTO.
        identifier (Union[Unset, SmsOutboundPatchObjectIdentifier]):  Default:
            SmsOutboundPatchObjectIdentifier.UID.
        import_mode (Union[Unset, SmsOutboundPatchObjectImportMode]):  Default:
            SmsOutboundPatchObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, SmsOutboundPatchObjectImportReportMode]):  Default:
            SmsOutboundPatchObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, SmsOutboundPatchObjectImportStrategy]):  Default:
            SmsOutboundPatchObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, SmsOutboundPatchObjectPreheatMode]):  Default:
            SmsOutboundPatchObjectPreheatMode.REFERENCE.
        root_junction (Union[Unset, SmsOutboundPatchObjectRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, SmsOutboundPatchObjectUserOverrideMode]):  Default:
            SmsOutboundPatchObjectUserOverrideMode.NONE.
        body (JsonPatch):
