...
from ...models.sms_outbound_post_json_object_atomic_mode import SmsOutboundPostJsonObjectAtomicMode
from ...models.sms_outbound_post_json_object_flush_mode import SmsOutboundPostJsonObjectFlushMode
from ...models.sms_outbound_post_json_object_identifier import SmsOutboundPostJsonObjectIdentifier
from ...models.sms_outbound_post_json_object_import_mode import SmsOutboundPostJsonObjectImportMode
from ...models.sms_outbound_post_json_object_import_report_mode import SmsOutboundPostJsonObjectImportReportMode
from ...models.sms_outbound_post_json_object_import_strategy import SmsOutboundPostJsonObjectImportStrategy
from ...models.sms_outbound_post_json_object_preheat_mode import SmsOutboundPostJsonObjectPreheatMode
from ...models.sms_outbound_post_json_object_user_override_mode import SmsOutboundPostJsonObjectUserOverrideMode
...
def _get_kwargs(
    *,
    ...
    atomic_mode: Union[Unset, SmsOutboundPostJsonObjectAtomicMode] = SmsOutboundPostJsonObjectAtomicMode.ALL,
    flush_mode: Union[Unset, SmsOutboundPostJsonObjectFlushMode] = SmsOutboundPostJsonObjectFlushMode.AUTO,
    identifier: Union[Unset, SmsOutboundPostJsonObjectIdentifier] = SmsOutboundPostJsonObjectIdentifier.UID,
    import_mode: Union[Unset, SmsOutboundPostJsonObjectImportMode] = SmsOutboundPostJsonObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, SmsOutboundPostJsonObjectImportReportMode
    ] = SmsOutboundPostJsonObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, SmsOutboundPostJsonObjectImportStrategy
    ] = SmsOutboundPostJsonObjectImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    preheat_mode: Union[Unset, SmsOutboundPostJsonObjectPreheatMode] = SmsOutboundPostJsonObjectPreheatMode.REFERENCE,
    ...
    user_override_mode: Union[
        Unset, SmsOutboundPostJsonObjectUserOverrideMode
    ] = SmsOutboundPostJsonObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/sms/outbound/#postJsonObject",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, SmsOutboundPostJsonObjectAtomicMode]):  Default:
            SmsOutboundPostJsonObjectAtomicMode.ALL.
        flush_mode (Union[Unset, SmsOutboundPostJsonObjectFlushMode]):  Default:
            SmsOutboundPostJsonObjectFlushMode.AUTO.
        identifier (Union[Unset, SmsOutboundPostJsonObjectIdentifier]):  Default:
            SmsOutboundPostJsonObjectIdentifier.UID.
        import_mode (Union[Unset, SmsOutboundPostJsonObjectImportMode]):  Default:
            SmsOutboundPostJsonObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, SmsOutboundPostJsonObjectImportReportMode]):  Default:
            SmsOutboundPostJsonObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, SmsOutboundPostJsonObjectImportStrategy]):  Default:
            SmsOutboundPostJsonObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, SmsOutboundPostJsonObjectPreheatMode]):  Default:
            SmsOutboundPostJsonObjectPreheatMode.REFERENCE.
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, SmsOutboundPostJsonObjectUserOverrideMode]):  Default:
            SmsOutboundPostJsonObjectUserOverrideMode.NONE.
        body (OutboundSms):
