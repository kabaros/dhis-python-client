...
from ...models.sms_command_delete_collection_items_jsondelete_collection_items_xml_property import (
    SmsCommandDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: SmsCommandDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
    *,
