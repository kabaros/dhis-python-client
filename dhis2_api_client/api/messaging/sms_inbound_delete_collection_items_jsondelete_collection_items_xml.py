...
from ...models.sms_inbound_delete_collection_items_jsondelete_collection_items_xml_property import (
    SmsInboundDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: SmsInboundDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
    *,
