...
from ...models.sms_inbound_patch_object_atomic_mode import SmsInboundPatchObjectAtomicMode
from ...models.sms_inbound_patch_object_flush_mode import SmsInboundPatchObjectFlushMode
from ...models.sms_inbound_patch_object_identifier import SmsInboundPatchObjectIdentifier
from ...models.sms_inbound_patch_object_import_mode import SmsInboundPatchObjectImportMode
from ...models.sms_inbound_patch_object_import_report_mode import SmsInboundPatchObjectImportReportMode
from ...models.sms_inbound_patch_object_import_strategy import SmsInboundPatchObjectImportStrategy
from ...models.sms_inbound_patch_object_preheat_mode import SmsInboundPatchObjectPreheatMode
from ...models.sms_inbound_patch_object_root_junction import SmsInboundPatchObjectRootJunction
from ...models.sms_inbound_patch_object_user_override_mode import SmsInboundPatchObjectUserOverrideMode
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[Unset, SmsInboundPatchObjectAtomicMode] = SmsInboundPatchObjectAtomicMode.ALL,
    flush_mode: Union[Unset, SmsInboundPatchObjectFlushMode] = SmsInboundPatchObjectFlushMode.AUTO,
    identifier: Union[Unset, SmsInboundPatchObjectIdentifier] = SmsInboundPatchObjectIdentifier.UID,
    import_mode: Union[Unset, SmsInboundPatchObjectImportMode] = SmsInboundPatchObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, SmsInboundPatchObjectImportReportMode
    ] = SmsInboundPatchObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, SmsInboundPatchObjectImportStrategy
    ] = SmsInboundPatchObjectImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, SmsInboundPatchObjectPreheatMode] = SmsInboundPatchObjectPreheatMode.REFERENCE,
    root_junction: Union[Unset, SmsInboundPatchObjectRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, SmsInboundPatchObjectUserOverrideMode
    ] = SmsInboundPatchObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, SmsInboundPatchObjectAtomicMode]):  Default:
            SmsInboundPatchObjectAtomicMode.ALL.
        flush_mode (Union[Unset, SmsInboundPatchObjectFlushMode]):  Default:
            SmsInboundPatchObjectFlushMode.AUTO.
        identifier (Union[Unset, SmsInboundPatchObjectIdentifier]):  Default:
            SmsInboundPatchObjectIdentifier.UID.
        import_mode (Union[Unset, SmsInboundPatchObjectImportMode]):  Default:
            SmsInboundPatchObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, SmsInboundPatchObjectImportReportMode]):  Default:
            SmsInboundPatchObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, SmsInboundPatchObjectImportStrategy]):  Default:
            SmsInboundPatchObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, SmsInboundPatchObjectPreheatMode]):  Default:
            SmsInboundPatchObjectPreheatMode.REFERENCE.
        root_junction (Union[Unset, SmsInboundPatchObjectRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, SmsInboundPatchObjectUserOverrideMode]):  Default:
            SmsInboundPatchObjectUserOverrideMode.NONE.
        body (JsonPatch):
