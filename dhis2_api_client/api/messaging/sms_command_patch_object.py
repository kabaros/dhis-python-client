...
from ...models.sms_command_patch_object_atomic_mode import SmsCommandPatchObjectAtomicMode
from ...models.sms_command_patch_object_flush_mode import SmsCommandPatchObjectFlushMode
from ...models.sms_command_patch_object_identifier import SmsCommandPatchObjectIdentifier
from ...models.sms_command_patch_object_import_mode import SmsCommandPatchObjectImportMode
from ...models.sms_command_patch_object_import_report_mode import SmsCommandPatchObjectImportReportMode
from ...models.sms_command_patch_object_import_strategy import SmsCommandPatchObjectImportStrategy
from ...models.sms_command_patch_object_preheat_mode import SmsCommandPatchObjectPreheatMode
from ...models.sms_command_patch_object_root_junction import SmsCommandPatchObjectRootJunction
from ...models.sms_command_patch_object_user_override_mode import SmsCommandPatchObjectUserOverrideMode
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[Unset, SmsCommandPatchObjectAtomicMode] = SmsCommandPatchObjectAtomicMode.ALL,
    flush_mode: Union[Unset, SmsCommandPatchObjectFlushMode] = SmsCommandPatchObjectFlushMode.AUTO,
    identifier: Union[Unset, SmsCommandPatchObjectIdentifier] = SmsCommandPatchObjectIdentifier.UID,
    import_mode: Union[Unset, SmsCommandPatchObjectImportMode] = SmsCommandPatchObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, SmsCommandPatchObjectImportReportMode
    ] = SmsCommandPatchObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, SmsCommandPatchObjectImportStrategy
    ] = SmsCommandPatchObjectImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, SmsCommandPatchObjectPreheatMode] = SmsCommandPatchObjectPreheatMode.REFERENCE,
    root_junction: Union[Unset, SmsCommandPatchObjectRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, SmsCommandPatchObjectUserOverrideMode
    ] = SmsCommandPatchObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, SmsCommandPatchObjectAtomicMode]):  Default:
            SmsCommandPatchObjectAtomicMode.ALL.
        flush_mode (Union[Unset, SmsCommandPatchObjectFlushMode]):  Default:
            SmsCommandPatchObjectFlushMode.AUTO.
        identifier (Union[Unset, SmsCommandPatchObjectIdentifier]):  Default:
            SmsCommandPatchObjectIdentifier.UID.
        import_mode (Union[Unset, SmsCommandPatchObjectImportMode]):  Default:
            SmsCommandPatchObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, SmsCommandPatchObjectImportReportMode]):  Default:
            SmsCommandPatchObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, SmsCommandPatchObjectImportStrategy]):  Default:
            SmsCommandPatchObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, SmsCommandPatchObjectPreheatMode]):  Default:
            SmsCommandPatchObjectPreheatMode.REFERENCE.
        root_junction (Union[Unset, SmsCommandPatchObjectRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, SmsCommandPatchObjectUserOverrideMode]):  Default:
            SmsCommandPatchObjectUserOverrideMode.NONE.
        body (JsonPatch):
