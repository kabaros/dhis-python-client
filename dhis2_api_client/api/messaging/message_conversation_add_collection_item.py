...
from ...models.message_conversation_add_collection_item_property import MessageConversationAddCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: MessageConversationAddCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
