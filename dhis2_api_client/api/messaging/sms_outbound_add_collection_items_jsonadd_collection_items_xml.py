...
from ...models.sms_outbound_add_collection_items_jsonadd_collection_items_xml_property import (
    SmsOutboundAddCollectionItemsJsonaddCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: SmsOutboundAddCollectionItemsJsonaddCollectionItemsXmlProperty,
    *,
