...
from ...models.message_conversation_delete_collection_item_property import (
    MessageConversationDeleteCollectionItemProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: MessageConversationDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/messageConversations/{uid}/{property_}/{item_id}",
    }
