...
from ...models.sms_outbound_bulk_sharing_atomic_mode import SmsOutboundBulkSharingAtomicMode
from ...models.sms_outbound_bulk_sharing_flush_mode import SmsOutboundBulkSharingFlushMode
from ...models.sms_outbound_bulk_sharing_identifier import SmsOutboundBulkSharingIdentifier
from ...models.sms_outbound_bulk_sharing_import_mode import SmsOutboundBulkSharingImportMode
from ...models.sms_outbound_bulk_sharing_import_report_mode import SmsOutboundBulkSharingImportReportMode
from ...models.sms_outbound_bulk_sharing_import_strategy import SmsOutboundBulkSharingImportStrategy
from ...models.sms_outbound_bulk_sharing_preheat_mode import SmsOutboundBulkSharingPreheatMode
from ...models.sms_outbound_bulk_sharing_root_junction import SmsOutboundBulkSharingRootJunction
from ...models.sms_outbound_bulk_sharing_user_override_mode import SmsOutboundBulkSharingUserOverrideMode
...
def _get_kwargs(
    *,
    ...
    atomic_mode: Union[Unset, SmsOutboundBulkSharingAtomicMode] = SmsOutboundBulkSharingAtomicMode.ALL,
    flush_mode: Union[Unset, SmsOutboundBulkSharingFlushMode] = SmsOutboundBulkSharingFlushMode.AUTO,
    identifier: Union[Unset, SmsOutboundBulkSharingIdentifier] = SmsOutboundBulkSharingIdentifier.UID,
    import_mode: Union[Unset, SmsOutboundBulkSharingImportMode] = SmsOutboundBulkSharingImportMode.COMMIT,
    import_report_mode: Union[
        Unset, SmsOutboundBulkSharingImportReportMode
    ] = SmsOutboundBulkSharingImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, SmsOutboundBulkSharingImportStrategy
    ] = SmsOutboundBulkSharingImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, SmsOutboundBulkSharingPreheatMode] = SmsOutboundBulkSharingPreheatMode.REFERENCE,
    root_junction: Union[Unset, SmsOutboundBulkSharingRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, SmsOutboundBulkSharingUserOverrideMode
    ] = SmsOutboundBulkSharingUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, SmsOutboundBulkSharingAtomicMode]):  Default:
            SmsOutboundBulkSharingAtomicMode.ALL.
        flush_mode (Union[Unset, SmsOutboundBulkSharingFlushMode]):  Default:
            SmsOutboundBulkSharingFlushMode.AUTO.
        identifier (Union[Unset, SmsOutboundBulkSharingIdentifier]):  Default:
            SmsOutboundBulkSharingIdentifier.UID.
        import_mode (Union[Unset, SmsOutboundBulkSharingImportMode]):  Default:
            SmsOutboundBulkSharingImportMode.COMMIT.
        import_report_mode (Union[Unset, SmsOutboundBulkSharingImportReportMode]):  Default:
            SmsOutboundBulkSharingImportReportMode.ERRORS.
        import_strategy (Union[Unset, SmsOutboundBulkSharingImportStrategy]):  Default:
            SmsOutboundBulkSharingImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, SmsOutboundBulkSharingPreheatMode]):  Default:
            SmsOutboundBulkSharingPreheatMode.REFERENCE.
        root_junction (Union[Unset, SmsOutboundBulkSharingRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, SmsOutboundBulkSharingUserOverrideMode]):  Default:
            SmsOutboundBulkSharingUserOverrideMode.NONE.
        body (BulkJsonPatch):
