...
from ...models.sms_command_get_object_gistget_object_gist_as_csv_auto import (
    SmsCommandGetObjectGistgetObjectGistAsCsvAuto,
)
from ...models.sms_command_get_object_gistget_object_gist_as_csv_response_200 import (
    SmsCommandGetObjectGistgetObjectGistAsCsvResponse200,
)
from ...models.sms_command_get_object_gistget_object_gist_as_csv_root_junction import (
    SmsCommandGetObjectGistgetObjectGistAsCsvRootJunction,
)
...
def _get_kwargs(
    ...
    *,
    ...
    auto: Union[Unset, SmsCommandGetObjectGistgetObjectGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, SmsCommandGetObjectGistgetObjectGistAsCsvRootJunction
    ] = SmsCommandGetObjectGistgetObjectGistAsCsvRootJunction.AND,
...
) -> Optional[Union[SmsCommandGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]]:
    if response.status_code == 200:
        response_200 = SmsCommandGetObjectGistgetObjectGistAsCsvResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[SmsCommandGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, SmsCommandGetObjectGistgetObjectGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, SmsCommandGetObjectGistgetObjectGistAsCsvRootJunction]):
            Default: SmsCommandGetObjectGistgetObjectGistAsCsvRootJunction.AND.
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[SmsCommandGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]
    """
