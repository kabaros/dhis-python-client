...
from ...models.sms_outbound_delete_collection_items_jsondelete_collection_items_xml_property import (
    SmsOutboundDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: SmsOutboundDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
    *,
