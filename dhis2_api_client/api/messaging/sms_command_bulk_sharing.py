...
from ...models.sms_command_bulk_sharing_atomic_mode import SmsCommandBulkSharingAtomicMode
from ...models.sms_command_bulk_sharing_flush_mode import SmsCommandBulkSharingFlushMode
from ...models.sms_command_bulk_sharing_identifier import SmsCommandBulkSharingIdentifier
from ...models.sms_command_bulk_sharing_import_mode import SmsCommandBulkSharingImportMode
from ...models.sms_command_bulk_sharing_import_report_mode import SmsCommandBulkSharingImportReportMode
from ...models.sms_command_bulk_sharing_import_strategy import SmsCommandBulkSharingImportStrategy
from ...models.sms_command_bulk_sharing_preheat_mode import SmsCommandBulkSharingPreheatMode
from ...models.sms_command_bulk_sharing_root_junction import SmsCommandBulkSharingRootJunction
from ...models.sms_command_bulk_sharing_user_override_mode import SmsCommandBulkSharingUserOverrideMode
...
def _get_kwargs(
    *,
    ...
    atomic_mode: Union[Unset, SmsCommandBulkSharingAtomicMode] = SmsCommandBulkSharingAtomicMode.ALL,
    flush_mode: Union[Unset, SmsCommandBulkSharingFlushMode] = SmsCommandBulkSharingFlushMode.AUTO,
    identifier: Union[Unset, SmsCommandBulkSharingIdentifier] = SmsCommandBulkSharingIdentifier.UID,
    import_mode: Union[Unset, SmsCommandBulkSharingImportMode] = SmsCommandBulkSharingImportMode.COMMIT,
    import_report_mode: Union[
        Unset, SmsCommandBulkSharingImportReportMode
    ] = SmsCommandBulkSharingImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, SmsCommandBulkSharingImportStrategy
    ] = SmsCommandBulkSharingImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, SmsCommandBulkSharingPreheatMode] = SmsCommandBulkSharingPreheatMode.REFERENCE,
    root_junction: Union[Unset, SmsCommandBulkSharingRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, SmsCommandBulkSharingUserOverrideMode
    ] = SmsCommandBulkSharingUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, SmsCommandBulkSharingAtomicMode]):  Default:
            SmsCommandBulkSharingAtomicMode.ALL.
        flush_mode (Union[Unset, SmsCommandBulkSharingFlushMode]):  Default:
            SmsCommandBulkSharingFlushMode.AUTO.
        identifier (Union[Unset, SmsCommandBulkSharingIdentifier]):  Default:
            SmsCommandBulkSharingIdentifier.UID.
        import_mode (Union[Unset, SmsCommandBulkSharingImportMode]):  Default:
            SmsCommandBulkSharingImportMode.COMMIT.
        import_report_mode (Union[Unset, SmsCommandBulkSharingImportReportMode]):  Default:
            SmsCommandBulkSharingImportReportMode.ERRORS.
        import_strategy (Union[Unset, SmsCommandBulkSharingImportStrategy]):  Default:
            SmsCommandBulkSharingImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, SmsCommandBulkSharingPreheatMode]):  Default:
            SmsCommandBulkSharingPreheatMode.REFERENCE.
        root_junction (Union[Unset, SmsCommandBulkSharingRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, SmsCommandBulkSharingUserOverrideMode]):  Default:
            SmsCommandBulkSharingUserOverrideMode.NONE.
        body (BulkJsonPatch):
