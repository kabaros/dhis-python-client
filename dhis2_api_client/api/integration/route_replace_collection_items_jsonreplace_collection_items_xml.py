...
from ...models.route_replace_collection_items_jsonreplace_collection_items_xml_property import (
    RouteReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: RouteReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
    *,
