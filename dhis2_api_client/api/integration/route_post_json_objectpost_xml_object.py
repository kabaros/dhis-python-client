...
from ...models.route_post_json_objectpost_xml_object_atomic_mode import RoutePostJsonObjectpostXmlObjectAtomicMode
from ...models.route_post_json_objectpost_xml_object_flush_mode import RoutePostJsonObjectpostXmlObjectFlushMode
from ...models.route_post_json_objectpost_xml_object_identifier import RoutePostJsonObjectpostXmlObjectIdentifier
from ...models.route_post_json_objectpost_xml_object_import_mode import RoutePostJsonObjectpostXmlObjectImportMode
from ...models.route_post_json_objectpost_xml_object_import_report_mode import (
    RoutePostJsonObjectpostXmlObjectImportReportMode,
)
from ...models.route_post_json_objectpost_xml_object_import_strategy import (
    RoutePostJsonObjectpostXmlObjectImportStrategy,
)
from ...models.route_post_json_objectpost_xml_object_preheat_mode import RoutePostJsonObjectpostXmlObjectPreheatMode
from ...models.route_post_json_objectpost_xml_object_user_override_mode import (
    RoutePostJsonObjectpostXmlObjectUserOverrideMode,
)
...
def _get_kwargs(
    *,
    ...
    atomic_mode: Union[
        Unset, RoutePostJsonObjectpostXmlObjectAtomicMode
    ] = RoutePostJsonObjectpostXmlObjectAtomicMode.ALL,
    flush_mode: Union[
        Unset, RoutePostJsonObjectpostXmlObjectFlushMode
    ] = RoutePostJsonObjectpostXmlObjectFlushMode.AUTO,
    identifier: Union[
        Unset, RoutePostJsonObjectpostXmlObjectIdentifier
    ] = RoutePostJsonObjectpostXmlObjectIdentifier.UID,
    import_mode: Union[
        Unset, RoutePostJsonObjectpostXmlObjectImportMode
    ] = RoutePostJsonObjectpostXmlObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, RoutePostJsonObjectpostXmlObjectImportReportMode
    ] = RoutePostJsonObjectpostXmlObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, RoutePostJsonObjectpostXmlObjectImportStrategy
    ] = RoutePostJsonObjectpostXmlObjectImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    preheat_mode: Union[
        Unset, RoutePostJsonObjectpostXmlObjectPreheatMode
    ] = RoutePostJsonObjectpostXmlObjectPreheatMode.REFERENCE,
    ...
    user_override_mode: Union[
        Unset, RoutePostJsonObjectpostXmlObjectUserOverrideMode
    ] = RoutePostJsonObjectpostXmlObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, RoutePostJsonObjectpostXmlObjectAtomicMode]):  Default:
            RoutePostJsonObjectpostXmlObjectAtomicMode.ALL.
        flush_mode (Union[Unset, RoutePostJsonObjectpostXmlObjectFlushMode]):  Default:
            RoutePostJsonObjectpostXmlObjectFlushMode.AUTO.
        identifier (Union[Unset, RoutePostJsonObjectpostXmlObjectIdentifier]):  Default:
            RoutePostJsonObjectpostXmlObjectIdentifier.UID.
        import_mode (Union[Unset, RoutePostJsonObjectpostXmlObjectImportMode]):  Default:
            RoutePostJsonObjectpostXmlObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, RoutePostJsonObjectpostXmlObjectImportReportMode]):
            Default: RoutePostJsonObjectpostXmlObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, RoutePostJsonObjectpostXmlObjectImportStrategy]):  Default:
            RoutePostJsonObjectpostXmlObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, RoutePostJsonObjectpostXmlObjectPreheatMode]):  Default:
            RoutePostJsonObjectpostXmlObjectPreheatMode.REFERENCE.
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, RoutePostJsonObjectpostXmlObjectUserOverrideMode]):
            Default: RoutePostJsonObjectpostXmlObjectUserOverrideMode.NONE.
        body (Route):
