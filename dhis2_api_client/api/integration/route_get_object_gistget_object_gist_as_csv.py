...
from ...models.route_get_object_gistget_object_gist_as_csv_auto import RouteGetObjectGistgetObjectGistAsCsvAuto
from ...models.route_get_object_gistget_object_gist_as_csv_response_200 import (
    RouteGetObjectGistgetObjectGistAsCsvResponse200,
)
from ...models.route_get_object_gistget_object_gist_as_csv_root_junction import (
    RouteGetObjectGistgetObjectGistAsCsvRootJunction,
)
...
def _get_kwargs(
    ...
    *,
    ...
    auto: Union[Unset, RouteGetObjectGistgetObjectGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, RouteGetObjectGistgetObjectGistAsCsvRootJunction
    ] = RouteGetObjectGistgetObjectGistAsCsvRootJunction.AND,
...
) -> Optional[Union[RouteGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]]:
    if response.status_code == 200:
        response_200 = RouteGetObjectGistgetObjectGistAsCsvResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RouteGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, RouteGetObjectGistgetObjectGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, RouteGetObjectGistgetObjectGistAsCsvRootJunction]):  Default:
            RouteGetObjectGistgetObjectGistAsCsvRootJunction.AND.
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[RouteGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]
    """
