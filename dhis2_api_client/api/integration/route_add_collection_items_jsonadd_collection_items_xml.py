...
from ...models.route_add_collection_items_jsonadd_collection_items_xml_property import (
    RouteAddCollectionItemsJsonaddCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: RouteAddCollectionItemsJsonaddCollectionItemsXmlProperty,
    *,
