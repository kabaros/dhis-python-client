...
from ...models.route_patch_object_atomic_mode import RoutePatchObjectAtomicMode
from ...models.route_patch_object_flush_mode import RoutePatchObjectFlushMode
from ...models.route_patch_object_identifier import RoutePatchObjectIdentifier
from ...models.route_patch_object_import_mode import RoutePatchObjectImportMode
from ...models.route_patch_object_import_report_mode import RoutePatchObjectImportReportMode
from ...models.route_patch_object_import_strategy import RoutePatchObjectImportStrategy
from ...models.route_patch_object_preheat_mode import RoutePatchObjectPreheatMode
from ...models.route_patch_object_root_junction import RoutePatchObjectRootJunction
from ...models.route_patch_object_user_override_mode import RoutePatchObjectUserOverrideMode
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[Unset, RoutePatchObjectAtomicMode] = RoutePatchObjectAtomicMode.ALL,
    flush_mode: Union[Unset, RoutePatchObjectFlushMode] = RoutePatchObjectFlushMode.AUTO,
    identifier: Union[Unset, RoutePatchObjectIdentifier] = RoutePatchObjectIdentifier.UID,
    import_mode: Union[Unset, RoutePatchObjectImportMode] = RoutePatchObjectImportMode.COMMIT,
    import_report_mode: Union[Unset, RoutePatchObjectImportReportMode] = RoutePatchObjectImportReportMode.ERRORS,
    import_strategy: Union[Unset, RoutePatchObjectImportStrategy] = RoutePatchObjectImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, RoutePatchObjectPreheatMode] = RoutePatchObjectPreheatMode.REFERENCE,
    root_junction: Union[Unset, RoutePatchObjectRootJunction] = UNSET,
    skip_sharing: Union[Unset, bool] = False,
    skip_translation: Union[Unset, bool] = False,
    skip_validation: Union[Unset, bool] = False,
    user: Union[Unset, str] = UNSET,
    user_override_mode: Union[Unset, RoutePatchObjectUserOverrideMode] = RoutePatchObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, RoutePatchObjectAtomicMode]):  Default:
            RoutePatchObjectAtomicMode.ALL.
        flush_mode (Union[Unset, RoutePatchObjectFlushMode]):  Default:
            RoutePatchObjectFlushMode.AUTO.
        identifier (Union[Unset, RoutePatchObjectIdentifier]):  Default:
            RoutePatchObjectIdentifier.UID.
        import_mode (Union[Unset, RoutePatchObjectImportMode]):  Default:
            RoutePatchObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, RoutePatchObjectImportReportMode]):  Default:
            RoutePatchObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, RoutePatchObjectImportStrategy]):  Default:
            RoutePatchObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, RoutePatchObjectPreheatMode]):  Default:
            RoutePatchObjectPreheatMode.REFERENCE.
        root_junction (Union[Unset, RoutePatchObjectRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, RoutePatchObjectUserOverrideMode]):  Default:
            RoutePatchObjectUserOverrideMode.NONE.
        body (JsonPatch):
