...
from ...models.route_bulk_sharing_atomic_mode import RouteBulkSharingAtomicMode
from ...models.route_bulk_sharing_flush_mode import RouteBulkSharingFlushMode
from ...models.route_bulk_sharing_identifier import RouteBulkSharingIdentifier
from ...models.route_bulk_sharing_import_mode import RouteBulkSharingImportMode
from ...models.route_bulk_sharing_import_report_mode import RouteBulkSharingImportReportMode
from ...models.route_bulk_sharing_import_strategy import RouteBulkSharingImportStrategy
from ...models.route_bulk_sharing_preheat_mode import RouteBulkSharingPreheatMode
from ...models.route_bulk_sharing_root_junction import RouteBulkSharingRootJunction
from ...models.route_bulk_sharing_user_override_mode import RouteBulkSharingUserOverrideMode
...
def _get_kwargs(
    *,
    ...
    atomic_mode: Union[Unset, RouteBulkSharingAtomicMode] = RouteBulkSharingAtomicMode.ALL,
    flush_mode: Union[Unset, RouteBulkSharingFlushMode] = RouteBulkSharingFlushMode.AUTO,
    identifier: Union[Unset, RouteBulkSharingIdentifier] = RouteBulkSharingIdentifier.UID,
    import_mode: Union[Unset, RouteBulkSharingImportMode] = RouteBulkSharingImportMode.COMMIT,
    import_report_mode: Union[Unset, RouteBulkSharingImportReportMode] = RouteBulkSharingImportReportMode.ERRORS,
    import_strategy: Union[Unset, RouteBulkSharingImportStrategy] = RouteBulkSharingImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, RouteBulkSharingPreheatMode] = RouteBulkSharingPreheatMode.REFERENCE,
    root_junction: Union[Unset, RouteBulkSharingRootJunction] = UNSET,
    skip_sharing: Union[Unset, bool] = False,
    skip_translation: Union[Unset, bool] = False,
    skip_validation: Union[Unset, bool] = False,
    user: Union[Unset, str] = UNSET,
    user_override_mode: Union[Unset, RouteBulkSharingUserOverrideMode] = RouteBulkSharingUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, RouteBulkSharingAtomicMode]):  Default:
            RouteBulkSharingAtomicMode.ALL.
        flush_mode (Union[Unset, RouteBulkSharingFlushMode]):  Default:
            RouteBulkSharingFlushMode.AUTO.
        identifier (Union[Unset, RouteBulkSharingIdentifier]):  Default:
            RouteBulkSharingIdentifier.UID.
        import_mode (Union[Unset, RouteBulkSharingImportMode]):  Default:
            RouteBulkSharingImportMode.COMMIT.
        import_report_mode (Union[Unset, RouteBulkSharingImportReportMode]):  Default:
            RouteBulkSharingImportReportMode.ERRORS.
        import_strategy (Union[Unset, RouteBulkSharingImportStrategy]):  Default:
            RouteBulkSharingImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, RouteBulkSharingPreheatMode]):  Default:
            RouteBulkSharingPreheatMode.REFERENCE.
        root_junction (Union[Unset, RouteBulkSharingRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, RouteBulkSharingUserOverrideMode]):  Default:
            RouteBulkSharingUserOverrideMode.NONE.
        body (BulkJsonPatch):
