...
from ...models.route_delete_collection_item_2_property import RouteDeleteCollectionItem2Property
...
def _get_kwargs(
    uid: str,
    property_: RouteDeleteCollectionItem2Property,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/routes/{uid}/{property_}/{item_id}",
    }
