...
from ...models.route_get_object_list_csv_root_junction import RouteGetObjectListCsvRootJunction
...
def _get_kwargs(
    *,
    ...
    root_junction: Union[Unset, RouteGetObjectListCsvRootJunction] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, RouteGetObjectListCsvRootJunction]):
