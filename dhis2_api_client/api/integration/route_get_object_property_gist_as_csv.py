...
from ...models.route_get_object_property_gist_as_csv_auto import RouteGetObjectPropertyGistAsCsvAuto
from ...models.route_get_object_property_gist_as_csv_property import RouteGetObjectPropertyGistAsCsvProperty
from ...models.route_get_object_property_gist_as_csv_root_junction import RouteGetObjectPropertyGistAsCsvRootJunction
...
def _get_kwargs(
    uid: str,
    property_: RouteGetObjectPropertyGistAsCsvProperty,
    *,
    absolute_urls: Union[Unset, bool] = False,
    auto: Union[Unset, RouteGetObjectPropertyGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, RouteGetObjectPropertyGistAsCsvRootJunction
    ] = RouteGetObjectPropertyGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/routes/{uid}/{property_}/gist.csv",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, RouteGetObjectPropertyGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, RouteGetObjectPropertyGistAsCsvRootJunction]):  Default:
            RouteGetObjectPropertyGistAsCsvRootJunction.AND.
