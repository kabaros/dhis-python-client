...
from ...models.route_delete_collection_items_jsondelete_collection_items_xml_property import (
    RouteDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: RouteDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
    *,
