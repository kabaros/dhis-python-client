...
from ...models.route_get_object_list_response_200 import RouteGetObjectListResponse200
from ...models.route_get_object_list_root_junction import RouteGetObjectListRootJunction
...
def _get_kwargs(
    *,
    ...
    root_junction: Union[Unset, RouteGetObjectListRootJunction] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
) -> Optional[Union[RouteGetObjectListResponse200, WebMessage]]:
    if response.status_code == 200:
        response_200 = RouteGetObjectListResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RouteGetObjectListResponse200, WebMessage]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, RouteGetObjectListRootJunction]):
...
def sync(
    *,
    ...
    Returns:
        Union[RouteGetObjectListResponse200, WebMessage]
    """
