...
from ...models.event_visualization_delete_collection_item_property import EventVisualizationDeleteCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: EventVisualizationDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/eventVisualizations/{uid}/{property_}/{item_id}",
    }
