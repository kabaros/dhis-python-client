...
from ...models.enrollment_analytics_get_query_html_data_id_scheme import EnrollmentAnalyticsGetQueryHtmlDataIdScheme
from ...models.enrollment_analytics_get_query_html_display_property import (
    EnrollmentAnalyticsGetQueryHtmlDisplayProperty,
)
from ...models.enrollment_analytics_get_query_html_endpoint_action import EnrollmentAnalyticsGetQueryHtmlEndpointAction
from ...models.enrollment_analytics_get_query_html_endpoint_item import EnrollmentAnalyticsGetQueryHtmlEndpointItem
from ...models.enrollment_analytics_get_query_html_ou_mode import EnrollmentAnalyticsGetQueryHtmlOuMode
from ...models.enrollment_analytics_get_query_html_output_id_scheme import EnrollmentAnalyticsGetQueryHtmlOutputIdScheme
from ...models.enrollment_analytics_get_query_html_program_status_item import (
    EnrollmentAnalyticsGetQueryHtmlProgramStatusItem,
)
from ...models.enrollment_analytics_get_query_html_sort_order import EnrollmentAnalyticsGetQueryHtmlSortOrder
...
def _get_kwargs(
    ...
    *,
    ...
    data_id_scheme: Union[Unset, EnrollmentAnalyticsGetQueryHtmlDataIdScheme] = UNSET,
    desc: Union[Unset, list[str]] = UNSET,
    dimension: Union[Unset, list[str]] = UNSET,
    display_property: Union[Unset, EnrollmentAnalyticsGetQueryHtmlDisplayProperty] = UNSET,
    end_date: Union[Unset, datetime.datetime] = UNSET,
    endpoint_action: Union[
        Unset, EnrollmentAnalyticsGetQueryHtmlEndpointAction
    ] = EnrollmentAnalyticsGetQueryHtmlEndpointAction.OTHER,
    endpoint_item: Union[Unset, EnrollmentAnalyticsGetQueryHtmlEndpointItem] = UNSET,
    ...
    ou_mode: Union[Unset, EnrollmentAnalyticsGetQueryHtmlOuMode] = UNSET,
    output_id_scheme: Union[Unset, EnrollmentAnalyticsGetQueryHtmlOutputIdScheme] = UNSET,
    page: Union[Unset, int] = 1,
    page_size: Union[Unset, int] = 50,
    paging: Union[Unset, bool] = True,
    program_status: Union[Unset, list[EnrollmentAnalyticsGetQueryHtmlProgramStatusItem]] = UNSET,
    ...
    sort_order: Union[Unset, EnrollmentAnalyticsGetQueryHtmlSortOrder] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/analytics/enrollments/query/{program}.html",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        data_id_scheme (Union[Unset, EnrollmentAnalyticsGetQueryHtmlDataIdScheme]):
        desc (Union[Unset, list[str]]):
        dimension (Union[Unset, list[str]]):
        display_property (Union[Unset, EnrollmentAnalyticsGetQueryHtmlDisplayProperty]):
        end_date (Union[Unset, datetime.datetime]):
        endpoint_action (Union[Unset, EnrollmentAnalyticsGetQueryHtmlEndpointAction]):  Default:
            EnrollmentAnalyticsGetQueryHtmlEndpointAction.OTHER.
        endpoint_item (Union[Unset, EnrollmentAnalyticsGetQueryHtmlEndpointItem]):
        ...
        ou_mode (Union[Unset, EnrollmentAnalyticsGetQueryHtmlOuMode]):
        output_id_scheme (Union[Unset, EnrollmentAnalyticsGetQueryHtmlOutputIdScheme]):
        page (Union[Unset, int]):  Default: 1.
        page_size (Union[Unset, int]):  Default: 50.
        paging (Union[Unset, bool]):  Default: True.
        program_status (Union[Unset, list[EnrollmentAnalyticsGetQueryHtmlProgramStatusItem]]):
        ...
        sort_order (Union[Unset, EnrollmentAnalyticsGetQueryHtmlSortOrder]):
