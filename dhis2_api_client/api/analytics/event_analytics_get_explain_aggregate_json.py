...
from ...models.event_analytics_get_explain_aggregate_json_aggregation_type import (
    EventAnalyticsGetExplainAggregateJsonAggregationType,
)
from ...models.event_analytics_get_explain_aggregate_json_data_id_scheme import (
    EventAnalyticsGetExplainAggregateJsonDataIdScheme,
)
from ...models.event_analytics_get_explain_aggregate_json_display_property import (
    EventAnalyticsGetExplainAggregateJsonDisplayProperty,
)
from ...models.event_analytics_get_explain_aggregate_json_endpoint_action import (
    EventAnalyticsGetExplainAggregateJsonEndpointAction,
)
from ...models.event_analytics_get_explain_aggregate_json_endpoint_item import (
    EventAnalyticsGetExplainAggregateJsonEndpointItem,
)
from ...models.event_analytics_get_explain_aggregate_json_event_status_item import (
    EventAnalyticsGetExplainAggregateJsonEventStatusItem,
)
from ...models.event_analytics_get_explain_aggregate_json_ou_mode import EventAnalyticsGetExplainAggregateJsonOuMode
from ...models.event_analytics_get_explain_aggregate_json_output_id_scheme import (
    EventAnalyticsGetExplainAggregateJsonOutputIdScheme,
)
from ...models.event_analytics_get_explain_aggregate_json_output_type import (
    EventAnalyticsGetExplainAggregateJsonOutputType,
)
from ...models.event_analytics_get_explain_aggregate_json_program_status_item import (
    EventAnalyticsGetExplainAggregateJsonProgramStatusItem,
)
from ...models.event_analytics_get_explain_aggregate_json_sort_order import (
    EventAnalyticsGetExplainAggregateJsonSortOrder,
)
...
def _get_kwargs(
    ...
    *,
    ...
    aggregation_type: Union[Unset, EventAnalyticsGetExplainAggregateJsonAggregationType] = UNSET,
    ...
    data_id_scheme: Union[Unset, EventAnalyticsGetExplainAggregateJsonDataIdScheme] = UNSET,
    default_coordinate_fallback: Union[Unset, bool] = False,
    desc: Union[Unset, list[str]] = UNSET,
    dimension: Union[Unset, list[str]] = UNSET,
    display_property: Union[Unset, EventAnalyticsGetExplainAggregateJsonDisplayProperty] = UNSET,
    end_date: Union[Unset, datetime.datetime] = UNSET,
    endpoint_action: Union[
        Unset, EventAnalyticsGetExplainAggregateJsonEndpointAction
    ] = EventAnalyticsGetExplainAggregateJsonEndpointAction.OTHER,
    endpoint_item: Union[Unset, EventAnalyticsGetExplainAggregateJsonEndpointItem] = UNSET,
    ...
    event_status: Union[Unset, list[EventAnalyticsGetExplainAggregateJsonEventStatusItem]] = UNSET,
    ...
    ou_mode: Union[
        Unset, EventAnalyticsGetExplainAggregateJsonOuMode
    ] = EventAnalyticsGetExplainAggregateJsonOuMode.DESCENDANTS,
    output_id_scheme: Union[Unset, EventAnalyticsGetExplainAggregateJsonOutputIdScheme] = UNSET,
    output_type: Union[
        Unset, EventAnalyticsGetExplainAggregateJsonOutputType
    ] = EventAnalyticsGetExplainAggregateJsonOutputType.EVENT,
    page: Union[Unset, int] = 1,
    page_size: Union[Unset, int] = 50,
    paging: Union[Unset, bool] = True,
    program_status: Union[Unset, list[EventAnalyticsGetExplainAggregateJsonProgramStatusItem]] = UNSET,
    ...
    sort_order: Union[Unset, EventAnalyticsGetExplainAggregateJsonSortOrder] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/analytics/events/aggregate/{program}/explain",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        aggregation_type (Union[Unset, EventAnalyticsGetExplainAggregateJsonAggregationType]):
        ...
        data_id_scheme (Union[Unset, EventAnalyticsGetExplainAggregateJsonDataIdScheme]):
        default_coordinate_fallback (Union[Unset, bool]):  Default: False.
        desc (Union[Unset, list[str]]):
        dimension (Union[Unset, list[str]]):
        display_property (Union[Unset, EventAnalyticsGetExplainAggregateJsonDisplayProperty]):
        end_date (Union[Unset, datetime.datetime]):
        endpoint_action (Union[Unset, EventAnalyticsGetExplainAggregateJsonEndpointAction]):
            Default: EventAnalyticsGetExplainAggregateJsonEndpointAction.OTHER.
        endpoint_item (Union[Unset, EventAnalyticsGetExplainAggregateJsonEndpointItem]):
        ...
        event_status (Union[Unset, list[EventAnalyticsGetExplainAggregateJsonEventStatusItem]]):
        ...
        ou_mode (Union[Unset, EventAnalyticsGetExplainAggregateJsonOuMode]):  Default:
            EventAnalyticsGetExplainAggregateJsonOuMode.DESCENDANTS.
        output_id_scheme (Union[Unset, EventAnalyticsGetExplainAggregateJsonOutputIdScheme]):
        output_type (Union[Unset, EventAnalyticsGetExplainAggregateJsonOutputType]):  Default:
            EventAnalyticsGetExplainAggregateJsonOutputType.EVENT.
        page (Union[Unset, int]):  Default: 1.
        page_size (Union[Unset, int]):  Default: 50.
        paging (Union[Unset, bool]):  Default: True.
        program_status (Union[Unset,
            list[EventAnalyticsGetExplainAggregateJsonProgramStatusItem]]):
        ...
        sort_order (Union[Unset, EventAnalyticsGetExplainAggregateJsonSortOrder]):
