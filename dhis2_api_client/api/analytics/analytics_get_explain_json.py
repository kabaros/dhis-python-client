...
from ...models.analytics_get_explain_json_aggregation_type import AnalyticsGetExplainJsonAggregationType
from ...models.analytics_get_explain_json_display_property import AnalyticsGetExplainJsonDisplayProperty
from ...models.analytics_get_explain_json_input_id_scheme import AnalyticsGetExplainJsonInputIdScheme
from ...models.analytics_get_explain_json_order import AnalyticsGetExplainJsonOrder
from ...models.analytics_get_explain_json_output_data_element_id_scheme import (
    AnalyticsGetExplainJsonOutputDataElementIdScheme,
)
from ...models.analytics_get_explain_json_output_data_item_id_scheme import (
    AnalyticsGetExplainJsonOutputDataItemIdScheme,
)
from ...models.analytics_get_explain_json_output_id_scheme import AnalyticsGetExplainJsonOutputIdScheme
from ...models.analytics_get_explain_json_output_org_unit_id_scheme import AnalyticsGetExplainJsonOutputOrgUnitIdScheme
from ...models.analytics_get_explain_json_user_org_unit_type import AnalyticsGetExplainJsonUserOrgUnitType
...
def _get_kwargs(
    *,
    aggregation_type: Union[Unset, AnalyticsGetExplainJsonAggregationType] = UNSET,
    ...
    display_property: Union[Unset, AnalyticsGetExplainJsonDisplayProperty] = UNSET,
    ...
    input_id_scheme: Union[Unset, AnalyticsGetExplainJsonInputIdScheme] = UNSET,
    measure_criteria: Union[Unset, str] = UNSET,
    order: Union[Unset, AnalyticsGetExplainJsonOrder] = UNSET,
    org_unit_field: Union[Unset, str] = UNSET,
    output_data_element_id_scheme: Union[Unset, AnalyticsGetExplainJsonOutputDataElementIdScheme] = UNSET,
    output_data_item_id_scheme: Union[Unset, AnalyticsGetExplainJsonOutputDataItemIdScheme] = UNSET,
    output_id_scheme: Union[Unset, AnalyticsGetExplainJsonOutputIdScheme] = UNSET,
    output_org_unit_id_scheme: Union[Unset, AnalyticsGetExplainJsonOutputOrgUnitIdScheme] = UNSET,
    ...
    user_org_unit_type: Union[Unset, AnalyticsGetExplainJsonUserOrgUnitType] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
def sync_detailed(
    *,
    ...
    Args:
        aggregation_type (Union[Unset, AnalyticsGetExplainJsonAggregationType]):
        ...
        display_property (Union[Unset, AnalyticsGetExplainJsonDisplayProperty]):
        ...
        input_id_scheme (Union[Unset, AnalyticsGetExplainJsonInputIdScheme]):
        measure_criteria (Union[Unset, str]):
        order (Union[Unset, AnalyticsGetExplainJsonOrder]):
        org_unit_field (Union[Unset, str]):
        output_data_element_id_scheme (Union[Unset,
            AnalyticsGetExplainJsonOutputDataElementIdScheme]):
        output_data_item_id_scheme (Union[Unset, AnalyticsGetExplainJsonOutputDataItemIdScheme]):
        output_id_scheme (Union[Unset, AnalyticsGetExplainJsonOutputIdScheme]):
        output_org_unit_id_scheme (Union[Unset, AnalyticsGetExplainJsonOutputOrgUnitIdScheme]):
        ...
        user_org_unit_type (Union[Unset, AnalyticsGetExplainJsonUserOrgUnitType]):
