...
from ...models.analytics_get_raw_data_json_aggregation_type import AnalyticsGetRawDataJsonAggregationType
from ...models.analytics_get_raw_data_json_display_property import AnalyticsGetRawDataJsonDisplayProperty
from ...models.analytics_get_raw_data_json_input_id_scheme import AnalyticsGetRawDataJsonInputIdScheme
from ...models.analytics_get_raw_data_json_order import AnalyticsGetRawDataJsonOrder
from ...models.analytics_get_raw_data_json_output_data_element_id_scheme import (
    AnalyticsGetRawDataJsonOutputDataElementIdScheme,
)
from ...models.analytics_get_raw_data_json_output_data_item_id_scheme import (
    AnalyticsGetRawDataJsonOutputDataItemIdScheme,
)
from ...models.analytics_get_raw_data_json_output_id_scheme import AnalyticsGetRawDataJsonOutputIdScheme
from ...models.analytics_get_raw_data_json_output_org_unit_id_scheme import AnalyticsGetRawDataJsonOutputOrgUnitIdScheme
from ...models.analytics_get_raw_data_json_user_org_unit_type import AnalyticsGetRawDataJsonUserOrgUnitType
...
def _get_kwargs(
    *,
    aggregation_type: Union[Unset, AnalyticsGetRawDataJsonAggregationType] = UNSET,
    ...
    display_property: Union[Unset, AnalyticsGetRawDataJsonDisplayProperty] = UNSET,
    ...
    input_id_scheme: Union[Unset, AnalyticsGetRawDataJsonInputIdScheme] = UNSET,
    measure_criteria: Union[Unset, str] = UNSET,
    order: Union[Unset, AnalyticsGetRawDataJsonOrder] = UNSET,
    org_unit_field: Union[Unset, str] = UNSET,
    output_data_element_id_scheme: Union[Unset, AnalyticsGetRawDataJsonOutputDataElementIdScheme] = UNSET,
    output_data_item_id_scheme: Union[Unset, AnalyticsGetRawDataJsonOutputDataItemIdScheme] = UNSET,
    output_id_scheme: Union[Unset, AnalyticsGetRawDataJsonOutputIdScheme] = UNSET,
    output_org_unit_id_scheme: Union[Unset, AnalyticsGetRawDataJsonOutputOrgUnitIdScheme] = UNSET,
    ...
    user_org_unit_type: Union[Unset, AnalyticsGetRawDataJsonUserOrgUnitType] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
def sync_detailed(
    *,
    ...
    Args:
        aggregation_type (Union[Unset, AnalyticsGetRawDataJsonAggregationType]):
        ...
        display_property (Union[Unset, AnalyticsGetRawDataJsonDisplayProperty]):
        ...
        input_id_scheme (Union[Unset, AnalyticsGetRawDataJsonInputIdScheme]):
        measure_criteria (Union[Unset, str]):
        order (Union[Unset, AnalyticsGetRawDataJsonOrder]):
        org_unit_field (Union[Unset, str]):
        output_data_element_id_scheme (Union[Unset,
            AnalyticsGetRawDataJsonOutputDataElementIdScheme]):
        output_data_item_id_scheme (Union[Unset, AnalyticsGetRawDataJsonOutputDataItemIdScheme]):
        output_id_scheme (Union[Unset, AnalyticsGetRawDataJsonOutputIdScheme]):
        output_org_unit_id_scheme (Union[Unset, AnalyticsGetRawDataJsonOutputOrgUnitIdScheme]):
        ...
        user_org_unit_type (Union[Unset, AnalyticsGetRawDataJsonUserOrgUnitType]):
