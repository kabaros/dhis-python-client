...
from ...models.analytics_get_data_value_set_json_aggregation_type import AnalyticsGetDataValueSetJsonAggregationType
from ...models.analytics_get_data_value_set_json_display_property import AnalyticsGetDataValueSetJsonDisplayProperty
from ...models.analytics_get_data_value_set_json_input_id_scheme import AnalyticsGetDataValueSetJsonInputIdScheme
from ...models.analytics_get_data_value_set_json_order import AnalyticsGetDataValueSetJsonOrder
from ...models.analytics_get_data_value_set_json_output_data_element_id_scheme import (
    AnalyticsGetDataValueSetJsonOutputDataElementIdScheme,
)
from ...models.analytics_get_data_value_set_json_output_data_item_id_scheme import (
    AnalyticsGetDataValueSetJsonOutputDataItemIdScheme,
)
from ...models.analytics_get_data_value_set_json_output_id_scheme import AnalyticsGetDataValueSetJsonOutputIdScheme
from ...models.analytics_get_data_value_set_json_output_org_unit_id_scheme import (
    AnalyticsGetDataValueSetJsonOutputOrgUnitIdScheme,
)
from ...models.analytics_get_data_value_set_json_user_org_unit_type import AnalyticsGetDataValueSetJsonUserOrgUnitType
...
def _get_kwargs(
    *,
    aggregation_type: Union[Unset, AnalyticsGetDataValueSetJsonAggregationType] = UNSET,
    ...
    display_property: Union[Unset, AnalyticsGetDataValueSetJsonDisplayProperty] = UNSET,
    ...
    input_id_scheme: Union[Unset, AnalyticsGetDataValueSetJsonInputIdScheme] = UNSET,
    measure_criteria: Union[Unset, str] = UNSET,
    order: Union[Unset, AnalyticsGetDataValueSetJsonOrder] = UNSET,
    org_unit_field: Union[Unset, str] = UNSET,
    output_data_element_id_scheme: Union[Unset, AnalyticsGetDataValueSetJsonOutputDataElementIdScheme] = UNSET,
    output_data_item_id_scheme: Union[Unset, AnalyticsGetDataValueSetJsonOutputDataItemIdScheme] = UNSET,
    output_id_scheme: Union[Unset, AnalyticsGetDataValueSetJsonOutputIdScheme] = UNSET,
    output_org_unit_id_scheme: Union[Unset, AnalyticsGetDataValueSetJsonOutputOrgUnitIdScheme] = UNSET,
    ...
    user_org_unit_type: Union[Unset, AnalyticsGetDataValueSetJsonUserOrgUnitType] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
def sync_detailed(
    *,
    ...
    Args:
        aggregation_type (Union[Unset, AnalyticsGetDataValueSetJsonAggregationType]):
        ...
        display_property (Union[Unset, AnalyticsGetDataValueSetJsonDisplayProperty]):
        ...
        input_id_scheme (Union[Unset, AnalyticsGetDataValueSetJsonInputIdScheme]):
        measure_criteria (Union[Unset, str]):
        order (Union[Unset, AnalyticsGetDataValueSetJsonOrder]):
        org_unit_field (Union[Unset, str]):
        output_data_element_id_scheme (Union[Unset,
            AnalyticsGetDataValueSetJsonOutputDataElementIdScheme]):
        output_data_item_id_scheme (Union[Unset,
            AnalyticsGetDataValueSetJsonOutputDataItemIdScheme]):
        output_id_scheme (Union[Unset, AnalyticsGetDataValueSetJsonOutputIdScheme]):
        output_org_unit_id_scheme (Union[Unset,
            AnalyticsGetDataValueSetJsonOutputOrgUnitIdScheme]):
        ...
        user_org_unit_type (Union[Unset, AnalyticsGetDataValueSetJsonUserOrgUnitType]):
