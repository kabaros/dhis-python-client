...
from ...models.enrollment_analytics_get_explain_query_json_data_id_scheme import (
    EnrollmentAnalyticsGetExplainQueryJsonDataIdScheme,
)
from ...models.enrollment_analytics_get_explain_query_json_display_property import (
    EnrollmentAnalyticsGetExplainQueryJsonDisplayProperty,
)
from ...models.enrollment_analytics_get_explain_query_json_endpoint_action import (
    EnrollmentAnalyticsGetExplainQueryJsonEndpointAction,
)
from ...models.enrollment_analytics_get_explain_query_json_endpoint_item import (
    EnrollmentAnalyticsGetExplainQueryJsonEndpointItem,
)
from ...models.enrollment_analytics_get_explain_query_json_ou_mode import EnrollmentAnalyticsGetExplainQueryJsonOuMode
from ...models.enrollment_analytics_get_explain_query_json_output_id_scheme import (
    EnrollmentAnalyticsGetExplainQueryJsonOutputIdScheme,
)
from ...models.enrollment_analytics_get_explain_query_json_program_status_item import (
    EnrollmentAnalyticsGetExplainQueryJsonProgramStatusItem,
)
from ...models.enrollment_analytics_get_explain_query_json_sort_order import (
    EnrollmentAnalyticsGetExplainQueryJsonSortOrder,
)
...
def _get_kwargs(
    ...
    *,
    ...
    data_id_scheme: Union[Unset, EnrollmentAnalyticsGetExplainQueryJsonDataIdScheme] = UNSET,
    desc: Union[Unset, list[str]] = UNSET,
    dimension: Union[Unset, list[str]] = UNSET,
    display_property: Union[Unset, EnrollmentAnalyticsGetExplainQueryJsonDisplayProperty] = UNSET,
    end_date: Union[Unset, datetime.datetime] = UNSET,
    endpoint_action: Union[
        Unset, EnrollmentAnalyticsGetExplainQueryJsonEndpointAction
    ] = EnrollmentAnalyticsGetExplainQueryJsonEndpointAction.OTHER,
    endpoint_item: Union[Unset, EnrollmentAnalyticsGetExplainQueryJsonEndpointItem] = UNSET,
    ...
    ou_mode: Union[Unset, EnrollmentAnalyticsGetExplainQueryJsonOuMode] = UNSET,
    output_id_scheme: Union[Unset, EnrollmentAnalyticsGetExplainQueryJsonOutputIdScheme] = UNSET,
    page: Union[Unset, int] = 1,
    page_size: Union[Unset, int] = 50,
    paging: Union[Unset, bool] = True,
    program_status: Union[Unset, list[EnrollmentAnalyticsGetExplainQueryJsonProgramStatusItem]] = UNSET,
    ...
    sort_order: Union[Unset, EnrollmentAnalyticsGetExplainQueryJsonSortOrder] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/analytics/enrollments/query/{program}/explain",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        data_id_scheme (Union[Unset, EnrollmentAnalyticsGetExplainQueryJsonDataIdScheme]):
        desc (Union[Unset, list[str]]):
        dimension (Union[Unset, list[str]]):
        display_property (Union[Unset, EnrollmentAnalyticsGetExplainQueryJsonDisplayProperty]):
        end_date (Union[Unset, datetime.datetime]):
        endpoint_action (Union[Unset, EnrollmentAnalyticsGetExplainQueryJsonEndpointAction]):
            Default: EnrollmentAnalyticsGetExplainQueryJsonEndpointAction.OTHER.
        endpoint_item (Union[Unset, EnrollmentAnalyticsGetExplainQueryJsonEndpointItem]):
        ...
        ou_mode (Union[Unset, EnrollmentAnalyticsGetExplainQueryJsonOuMode]):
        output_id_scheme (Union[Unset, EnrollmentAnalyticsGetExplainQueryJsonOutputIdScheme]):
        page (Union[Unset, int]):  Default: 1.
        page_size (Union[Unset, int]):  Default: 50.
        paging (Union[Unset, bool]):  Default: True.
        program_status (Union[Unset,
            list[EnrollmentAnalyticsGetExplainQueryJsonProgramStatusItem]]):
        ...
        sort_order (Union[Unset, EnrollmentAnalyticsGetExplainQueryJsonSortOrder]):
