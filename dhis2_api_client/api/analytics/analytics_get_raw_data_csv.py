...
from ...models.analytics_get_raw_data_csv_aggregation_type import AnalyticsGetRawDataCsvAggregationType
from ...models.analytics_get_raw_data_csv_display_property import AnalyticsGetRawDataCsvDisplayProperty
from ...models.analytics_get_raw_data_csv_input_id_scheme import AnalyticsGetRawDataCsvInputIdScheme
from ...models.analytics_get_raw_data_csv_order import AnalyticsGetRawDataCsvOrder
from ...models.analytics_get_raw_data_csv_output_data_element_id_scheme import (
    AnalyticsGetRawDataCsvOutputDataElementIdScheme,
)
from ...models.analytics_get_raw_data_csv_output_data_item_id_scheme import AnalyticsGetRawDataCsvOutputDataItemIdScheme
from ...models.analytics_get_raw_data_csv_output_id_scheme import AnalyticsGetRawDataCsvOutputIdScheme
from ...models.analytics_get_raw_data_csv_output_org_unit_id_scheme import AnalyticsGetRawDataCsvOutputOrgUnitIdScheme
from ...models.analytics_get_raw_data_csv_user_org_unit_type import AnalyticsGetRawDataCsvUserOrgUnitType
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    aggregation_type: Union[Unset, AnalyticsGetRawDataCsvAggregationType] = UNSET,
    ...
    display_property: Union[Unset, AnalyticsGetRawDataCsvDisplayProperty] = UNSET,
    ...
    input_id_scheme: Union[Unset, AnalyticsGetRawDataCsvInputIdScheme] = UNSET,
    measure_criteria: Union[Unset, str] = UNSET,
    order: Union[Unset, AnalyticsGetRawDataCsvOrder] = UNSET,
    org_unit_field: Union[Unset, str] = UNSET,
    output_data_element_id_scheme: Union[Unset, AnalyticsGetRawDataCsvOutputDataElementIdScheme] = UNSET,
    output_data_item_id_scheme: Union[Unset, AnalyticsGetRawDataCsvOutputDataItemIdScheme] = UNSET,
    output_id_scheme: Union[Unset, AnalyticsGetRawDataCsvOutputIdScheme] = UNSET,
    output_org_unit_id_scheme: Union[Unset, AnalyticsGetRawDataCsvOutputOrgUnitIdScheme] = UNSET,
    ...
    user_org_unit_type: Union[Unset, AnalyticsGetRawDataCsvUserOrgUnitType] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
def sync_detailed(
    *,
    ...
    Args:
        aggregation_type (Union[Unset, AnalyticsGetRawDataCsvAggregationType]):
        ...
        display_property (Union[Unset, AnalyticsGetRawDataCsvDisplayProperty]):
        ...
        input_id_scheme (Union[Unset, AnalyticsGetRawDataCsvInputIdScheme]):
        measure_criteria (Union[Unset, str]):
        order (Union[Unset, AnalyticsGetRawDataCsvOrder]):
        org_unit_field (Union[Unset, str]):
        output_data_element_id_scheme (Union[Unset,
            AnalyticsGetRawDataCsvOutputDataElementIdScheme]):
        output_data_item_id_scheme (Union[Unset, AnalyticsGetRawDataCsvOutputDataItemIdScheme]):
        output_id_scheme (Union[Unset, AnalyticsGetRawDataCsvOutputIdScheme]):
        output_org_unit_id_scheme (Union[Unset, AnalyticsGetRawDataCsvOutputOrgUnitIdScheme]):
        ...
        user_org_unit_type (Union[Unset, AnalyticsGetRawDataCsvUserOrgUnitType]):
