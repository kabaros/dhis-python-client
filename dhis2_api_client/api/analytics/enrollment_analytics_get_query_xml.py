...
from ...models.enrollment_analytics_get_query_xml_data_id_scheme import EnrollmentAnalyticsGetQueryXmlDataIdScheme
from ...models.enrollment_analytics_get_query_xml_display_property import EnrollmentAnalyticsGetQueryXmlDisplayProperty
from ...models.enrollment_analytics_get_query_xml_endpoint_action import EnrollmentAnalyticsGetQueryXmlEndpointAction
from ...models.enrollment_analytics_get_query_xml_endpoint_item import EnrollmentAnalyticsGetQueryXmlEndpointItem
from ...models.enrollment_analytics_get_query_xml_ou_mode import EnrollmentAnalyticsGetQueryXmlOuMode
from ...models.enrollment_analytics_get_query_xml_output_id_scheme import EnrollmentAnalyticsGetQueryXmlOutputIdScheme
from ...models.enrollment_analytics_get_query_xml_program_status_item import (
    EnrollmentAnalyticsGetQueryXmlProgramStatusItem,
)
from ...models.enrollment_analytics_get_query_xml_sort_order import EnrollmentAnalyticsGetQueryXmlSortOrder
...
def _get_kwargs(
    ...
    *,
    ...
    data_id_scheme: Union[Unset, EnrollmentAnalyticsGetQueryXmlDataIdScheme] = UNSET,
    desc: Union[Unset, list[str]] = UNSET,
    dimension: Union[Unset, list[str]] = UNSET,
    display_property: Union[Unset, EnrollmentAnalyticsGetQueryXmlDisplayProperty] = UNSET,
    end_date: Union[Unset, datetime.datetime] = UNSET,
    endpoint_action: Union[
        Unset, EnrollmentAnalyticsGetQueryXmlEndpointAction
    ] = EnrollmentAnalyticsGetQueryXmlEndpointAction.OTHER,
    endpoint_item: Union[Unset, EnrollmentAnalyticsGetQueryXmlEndpointItem] = UNSET,
    ...
    ou_mode: Union[Unset, EnrollmentAnalyticsGetQueryXmlOuMode] = UNSET,
    output_id_scheme: Union[Unset, EnrollmentAnalyticsGetQueryXmlOutputIdScheme] = UNSET,
    page: Union[Unset, int] = 1,
    page_size: Union[Unset, int] = 50,
    paging: Union[Unset, bool] = True,
    program_status: Union[Unset, list[EnrollmentAnalyticsGetQueryXmlProgramStatusItem]] = UNSET,
    ...
    sort_order: Union[Unset, EnrollmentAnalyticsGetQueryXmlSortOrder] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/analytics/enrollments/query/{program}.xml",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        data_id_scheme (Union[Unset, EnrollmentAnalyticsGetQueryXmlDataIdScheme]):
        desc (Union[Unset, list[str]]):
        dimension (Union[Unset, list[str]]):
        display_property (Union[Unset, EnrollmentAnalyticsGetQueryXmlDisplayProperty]):
        end_date (Union[Unset, datetime.datetime]):
        endpoint_action (Union[Unset, EnrollmentAnalyticsGetQueryXmlEndpointAction]):  Default:
            EnrollmentAnalyticsGetQueryXmlEndpointAction.OTHER.
        endpoint_item (Union[Unset, EnrollmentAnalyticsGetQueryXmlEndpointItem]):
        ...
        ou_mode (Union[Unset, EnrollmentAnalyticsGetQueryXmlOuMode]):
        output_id_scheme (Union[Unset, EnrollmentAnalyticsGetQueryXmlOutputIdScheme]):
        page (Union[Unset, int]):  Default: 1.
        page_size (Union[Unset, int]):  Default: 50.
        paging (Union[Unset, bool]):  Default: True.
        program_status (Union[Unset, list[EnrollmentAnalyticsGetQueryXmlProgramStatusItem]]):
        ...
        sort_order (Union[Unset, EnrollmentAnalyticsGetQueryXmlSortOrder]):
