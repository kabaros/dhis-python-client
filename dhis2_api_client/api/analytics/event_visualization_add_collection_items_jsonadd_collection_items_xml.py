...
from ...models.event_visualization_add_collection_items_jsonadd_collection_items_xml_property import (
    EventVisualizationAddCollectionItemsJsonaddCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: EventVisualizationAddCollectionItemsJsonaddCollectionItemsXmlProperty,
    *,
