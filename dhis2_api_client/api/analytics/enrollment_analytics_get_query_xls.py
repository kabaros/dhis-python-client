...
from ...models.enrollment_analytics_get_query_xls_data_id_scheme import EnrollmentAnalyticsGetQueryXlsDataIdScheme
from ...models.enrollment_analytics_get_query_xls_display_property import EnrollmentAnalyticsGetQueryXlsDisplayProperty
from ...models.enrollment_analytics_get_query_xls_endpoint_action import EnrollmentAnalyticsGetQueryXlsEndpointAction
from ...models.enrollment_analytics_get_query_xls_endpoint_item import EnrollmentAnalyticsGetQueryXlsEndpointItem
from ...models.enrollment_analytics_get_query_xls_ou_mode import EnrollmentAnalyticsGetQueryXlsOuMode
from ...models.enrollment_analytics_get_query_xls_output_id_scheme import EnrollmentAnalyticsGetQueryXlsOutputIdScheme
from ...models.enrollment_analytics_get_query_xls_program_status_item import (
    EnrollmentAnalyticsGetQueryXlsProgramStatusItem,
)
from ...models.enrollment_analytics_get_query_xls_sort_order import EnrollmentAnalyticsGetQueryXlsSortOrder
...
def _get_kwargs(
    ...
    *,
    ...
    data_id_scheme: Union[Unset, EnrollmentAnalyticsGetQueryXlsDataIdScheme] = UNSET,
    desc: Union[Unset, list[str]] = UNSET,
    dimension: Union[Unset, list[str]] = UNSET,
    display_property: Union[Unset, EnrollmentAnalyticsGetQueryXlsDisplayProperty] = UNSET,
    end_date: Union[Unset, datetime.datetime] = UNSET,
    endpoint_action: Union[
        Unset, EnrollmentAnalyticsGetQueryXlsEndpointAction
    ] = EnrollmentAnalyticsGetQueryXlsEndpointAction.OTHER,
    endpoint_item: Union[Unset, EnrollmentAnalyticsGetQueryXlsEndpointItem] = UNSET,
    ...
    ou_mode: Union[Unset, EnrollmentAnalyticsGetQueryXlsOuMode] = UNSET,
    output_id_scheme: Union[Unset, EnrollmentAnalyticsGetQueryXlsOutputIdScheme] = UNSET,
    page: Union[Unset, int] = 1,
    page_size: Union[Unset, int] = 50,
    paging: Union[Unset, bool] = True,
    program_status: Union[Unset, list[EnrollmentAnalyticsGetQueryXlsProgramStatusItem]] = UNSET,
    ...
    sort_order: Union[Unset, EnrollmentAnalyticsGetQueryXlsSortOrder] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/analytics/enrollments/query/{program}.xls",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        data_id_scheme (Union[Unset, EnrollmentAnalyticsGetQueryXlsDataIdScheme]):
        desc (Union[Unset, list[str]]):
        dimension (Union[Unset, list[str]]):
        display_property (Union[Unset, EnrollmentAnalyticsGetQueryXlsDisplayProperty]):
        end_date (Union[Unset, datetime.datetime]):
        endpoint_action (Union[Unset, EnrollmentAnalyticsGetQueryXlsEndpointAction]):  Default:
            EnrollmentAnalyticsGetQueryXlsEndpointAction.OTHER.
        endpoint_item (Union[Unset, EnrollmentAnalyticsGetQueryXlsEndpointItem]):
        ...
        ou_mode (Union[Unset, EnrollmentAnalyticsGetQueryXlsOuMode]):
        output_id_scheme (Union[Unset, EnrollmentAnalyticsGetQueryXlsOutputIdScheme]):
        page (Union[Unset, int]):  Default: 1.
        page_size (Union[Unset, int]):  Default: 50.
        paging (Union[Unset, bool]):  Default: True.
        program_status (Union[Unset, list[EnrollmentAnalyticsGetQueryXlsProgramStatusItem]]):
        ...
        sort_order (Union[Unset, EnrollmentAnalyticsGetQueryXlsSortOrder]):
