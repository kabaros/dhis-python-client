...
from ...models.enrollment_analytics_get_query_html_css_data_id_scheme import (
    EnrollmentAnalyticsGetQueryHtmlCssDataIdScheme,
)
from ...models.enrollment_analytics_get_query_html_css_display_property import (
    EnrollmentAnalyticsGetQueryHtmlCssDisplayProperty,
)
from ...models.enrollment_analytics_get_query_html_css_endpoint_action import (
    EnrollmentAnalyticsGetQueryHtmlCssEndpointAction,
)
from ...models.enrollment_analytics_get_query_html_css_endpoint_item import (
    EnrollmentAnalyticsGetQueryHtmlCssEndpointItem,
)
from ...models.enrollment_analytics_get_query_html_css_ou_mode import EnrollmentAnalyticsGetQueryHtmlCssOuMode
from ...models.enrollment_analytics_get_query_html_css_output_id_scheme import (
    EnrollmentAnalyticsGetQueryHtmlCssOutputIdScheme,
)
from ...models.enrollment_analytics_get_query_html_css_program_status_item import (
    EnrollmentAnalyticsGetQueryHtmlCssProgramStatusItem,
)
from ...models.enrollment_analytics_get_query_html_css_sort_order import EnrollmentAnalyticsGetQueryHtmlCssSortOrder
...
def _get_kwargs(
    ...
    *,
    ...
    data_id_scheme: Union[Unset, EnrollmentAnalyticsGetQueryHtmlCssDataIdScheme] = UNSET,
    desc: Union[Unset, list[str]] = UNSET,
    dimension: Union[Unset, list[str]] = UNSET,
    display_property: Union[Unset, EnrollmentAnalyticsGetQueryHtmlCssDisplayProperty] = UNSET,
    end_date: Union[Unset, datetime.datetime] = UNSET,
    endpoint_action: Union[
        Unset, EnrollmentAnalyticsGetQueryHtmlCssEndpointAction
    ] = EnrollmentAnalyticsGetQueryHtmlCssEndpointAction.OTHER,
    endpoint_item: Union[Unset, EnrollmentAnalyticsGetQueryHtmlCssEndpointItem] = UNSET,
    ...
    ou_mode: Union[Unset, EnrollmentAnalyticsGetQueryHtmlCssOuMode] = UNSET,
    output_id_scheme: Union[Unset, EnrollmentAnalyticsGetQueryHtmlCssOutputIdScheme] = UNSET,
    page: Union[Unset, int] = 1,
    page_size: Union[Unset, int] = 50,
    paging: Union[Unset, bool] = True,
    program_status: Union[Unset, list[EnrollmentAnalyticsGetQueryHtmlCssProgramStatusItem]] = UNSET,
    ...
    sort_order: Union[Unset, EnrollmentAnalyticsGetQueryHtmlCssSortOrder] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/analytics/enrollments/query/{program}.html+css",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        data_id_scheme (Union[Unset, EnrollmentAnalyticsGetQueryHtmlCssDataIdScheme]):
        desc (Union[Unset, list[str]]):
        dimension (Union[Unset, list[str]]):
        display_property (Union[Unset, EnrollmentAnalyticsGetQueryHtmlCssDisplayProperty]):
        end_date (Union[Unset, datetime.datetime]):
        endpoint_action (Union[Unset, EnrollmentAnalyticsGetQueryHtmlCssEndpointAction]):
            Default: EnrollmentAnalyticsGetQueryHtmlCssEndpointAction.OTHER.
        endpoint_item (Union[Unset, EnrollmentAnalyticsGetQueryHtmlCssEndpointItem]):
        ...
        ou_mode (Union[Unset, EnrollmentAnalyticsGetQueryHtmlCssOuMode]):
        output_id_scheme (Union[Unset, EnrollmentAnalyticsGetQueryHtmlCssOutputIdScheme]):
        page (Union[Unset, int]):  Default: 1.
        page_size (Union[Unset, int]):  Default: 50.
        paging (Union[Unset, bool]):  Default: True.
        program_status (Union[Unset, list[EnrollmentAnalyticsGetQueryHtmlCssProgramStatusItem]]):
        ...
        sort_order (Union[Unset, EnrollmentAnalyticsGetQueryHtmlCssSortOrder]):
