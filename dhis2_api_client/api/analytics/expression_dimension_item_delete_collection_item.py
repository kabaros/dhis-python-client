...
from ...models.expression_dimension_item_delete_collection_item_property import (
    ExpressionDimensionItemDeleteCollectionItemProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: ExpressionDimensionItemDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/expressionDimensionItems/{uid}/{property_}/{item_id}",
    }
