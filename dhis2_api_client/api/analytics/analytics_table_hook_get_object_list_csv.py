...
from ...models.analytics_table_hook_get_object_list_csv_root_junction import (
    AnalyticsTableHookGetObjectListCsvRootJunction,
)
...
def _get_kwargs(
    *,
    ...
    root_junction: Union[Unset, AnalyticsTableHookGetObjectListCsvRootJunction] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/analyticsTableHooks/#getObjectListCsv",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, AnalyticsTableHookGetObjectListCsvRootJunction]):
