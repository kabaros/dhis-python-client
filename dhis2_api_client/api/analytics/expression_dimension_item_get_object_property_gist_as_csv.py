...
from ...models.expression_dimension_item_get_object_property_gist_as_csv_auto import (
    ExpressionDimensionItemGetObjectPropertyGistAsCsvAuto,
)
from ...models.expression_dimension_item_get_object_property_gist_as_csv_property import (
    ExpressionDimensionItemGetObjectPropertyGistAsCsvProperty,
)
from ...models.expression_dimension_item_get_object_property_gist_as_csv_root_junction import (
    ExpressionDimensionItemGetObjectPropertyGistAsCsvRootJunction,
)
...
def _get_kwargs(
    uid: str,
    property_: ExpressionDimensionItemGetObjectPropertyGistAsCsvProperty,
    *,
    absolute_urls: Union[Unset, bool] = False,
    auto: Union[Unset, ExpressionDimensionItemGetObjectPropertyGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, ExpressionDimensionItemGetObjectPropertyGistAsCsvRootJunction
    ] = ExpressionDimensionItemGetObjectPropertyGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/expressionDimensionItems/{uid}/{property_}/gist.csv",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, ExpressionDimensionItemGetObjectPropertyGistAsCsvAuto]):
        ...
        root_junction (Union[Unset,
            ExpressionDimensionItemGetObjectPropertyGistAsCsvRootJunction]):  Default:
            ExpressionDimensionItemGetObjectPropertyGistAsCsvRootJunction.AND.
