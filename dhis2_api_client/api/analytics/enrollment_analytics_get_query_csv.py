...
from ...models.enrollment_analytics_get_query_csv_data_id_scheme import EnrollmentAnalyticsGetQueryCsvDataIdScheme
from ...models.enrollment_analytics_get_query_csv_display_property import EnrollmentAnalyticsGetQueryCsvDisplayProperty
from ...models.enrollment_analytics_get_query_csv_endpoint_action import EnrollmentAnalyticsGetQueryCsvEndpointAction
from ...models.enrollment_analytics_get_query_csv_endpoint_item import EnrollmentAnalyticsGetQueryCsvEndpointItem
from ...models.enrollment_analytics_get_query_csv_ou_mode import EnrollmentAnalyticsGetQueryCsvOuMode
from ...models.enrollment_analytics_get_query_csv_output_id_scheme import EnrollmentAnalyticsGetQueryCsvOutputIdScheme
from ...models.enrollment_analytics_get_query_csv_program_status_item import (
    EnrollmentAnalyticsGetQueryCsvProgramStatusItem,
)
from ...models.enrollment_analytics_get_query_csv_sort_order import EnrollmentAnalyticsGetQueryCsvSortOrder
...
def _get_kwargs(
    ...
    *,
    ...
    data_id_scheme: Union[Unset, EnrollmentAnalyticsGetQueryCsvDataIdScheme] = UNSET,
    desc: Union[Unset, list[str]] = UNSET,
    dimension: Union[Unset, list[str]] = UNSET,
    display_property: Union[Unset, EnrollmentAnalyticsGetQueryCsvDisplayProperty] = UNSET,
    end_date: Union[Unset, datetime.datetime] = UNSET,
    endpoint_action: Union[
        Unset, EnrollmentAnalyticsGetQueryCsvEndpointAction
    ] = EnrollmentAnalyticsGetQueryCsvEndpointAction.OTHER,
    endpoint_item: Union[Unset, EnrollmentAnalyticsGetQueryCsvEndpointItem] = UNSET,
    ...
    ou_mode: Union[Unset, EnrollmentAnalyticsGetQueryCsvOuMode] = UNSET,
    output_id_scheme: Union[Unset, EnrollmentAnalyticsGetQueryCsvOutputIdScheme] = UNSET,
    page: Union[Unset, int] = 1,
    page_size: Union[Unset, int] = 50,
    paging: Union[Unset, bool] = True,
    program_status: Union[Unset, list[EnrollmentAnalyticsGetQueryCsvProgramStatusItem]] = UNSET,
    ...
    sort_order: Union[Unset, EnrollmentAnalyticsGetQueryCsvSortOrder] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/analytics/enrollments/query/{program}.csv",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        data_id_scheme (Union[Unset, EnrollmentAnalyticsGetQueryCsvDataIdScheme]):
        desc (Union[Unset, list[str]]):
        dimension (Union[Unset, list[str]]):
        display_property (Union[Unset, EnrollmentAnalyticsGetQueryCsvDisplayProperty]):
        end_date (Union[Unset, datetime.datetime]):
        endpoint_action (Union[Unset, EnrollmentAnalyticsGetQueryCsvEndpointAction]):  Default:
            EnrollmentAnalyticsGetQueryCsvEndpointAction.OTHER.
        endpoint_item (Union[Unset, EnrollmentAnalyticsGetQueryCsvEndpointItem]):
        ...
        ou_mode (Union[Unset, EnrollmentAnalyticsGetQueryCsvOuMode]):
        output_id_scheme (Union[Unset, EnrollmentAnalyticsGetQueryCsvOutputIdScheme]):
        page (Union[Unset, int]):  Default: 1.
        page_size (Union[Unset, int]):  Default: 50.
        paging (Union[Unset, bool]):  Default: True.
        program_status (Union[Unset, list[EnrollmentAnalyticsGetQueryCsvProgramStatusItem]]):
        ...
        sort_order (Union[Unset, EnrollmentAnalyticsGetQueryCsvSortOrder]):
