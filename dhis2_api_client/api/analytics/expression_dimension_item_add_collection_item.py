...
from ...models.expression_dimension_item_add_collection_item_property import (
    ExpressionDimensionItemAddCollectionItemProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: ExpressionDimensionItemAddCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
