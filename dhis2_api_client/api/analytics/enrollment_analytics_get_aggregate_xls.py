...
from ...models.enrollment_analytics_get_aggregate_xls_data_id_scheme import (
    EnrollmentAnalyticsGetAggregateXlsDataIdScheme,
)
from ...models.enrollment_analytics_get_aggregate_xls_display_property import (
    EnrollmentAnalyticsGetAggregateXlsDisplayProperty,
)
from ...models.enrollment_analytics_get_aggregate_xls_endpoint_action import (
    EnrollmentAnalyticsGetAggregateXlsEndpointAction,
)
from ...models.enrollment_analytics_get_aggregate_xls_endpoint_item import (
    EnrollmentAnalyticsGetAggregateXlsEndpointItem,
)
from ...models.enrollment_analytics_get_aggregate_xls_ou_mode import EnrollmentAnalyticsGetAggregateXlsOuMode
from ...models.enrollment_analytics_get_aggregate_xls_output_id_scheme import (
    EnrollmentAnalyticsGetAggregateXlsOutputIdScheme,
)
from ...models.enrollment_analytics_get_aggregate_xls_program_status_item import (
    EnrollmentAnalyticsGetAggregateXlsProgramStatusItem,
)
from ...models.enrollment_analytics_get_aggregate_xls_sort_order import EnrollmentAnalyticsGetAggregateXlsSortOrder
...
def _get_kwargs(
    ...
    *,
    ...
    data_id_scheme: Union[Unset, EnrollmentAnalyticsGetAggregateXlsDataIdScheme] = UNSET,
    desc: Union[Unset, list[str]] = UNSET,
    dimension: Union[Unset, list[str]] = UNSET,
    display_property: Union[Unset, EnrollmentAnalyticsGetAggregateXlsDisplayProperty] = UNSET,
    end_date: Union[Unset, datetime.datetime] = UNSET,
    endpoint_action: Union[
        Unset, EnrollmentAnalyticsGetAggregateXlsEndpointAction
    ] = EnrollmentAnalyticsGetAggregateXlsEndpointAction.OTHER,
    endpoint_item: Union[Unset, EnrollmentAnalyticsGetAggregateXlsEndpointItem] = UNSET,
    ...
    ou_mode: Union[Unset, EnrollmentAnalyticsGetAggregateXlsOuMode] = UNSET,
    output_id_scheme: Union[Unset, EnrollmentAnalyticsGetAggregateXlsOutputIdScheme] = UNSET,
    page: Union[Unset, int] = 1,
    page_size: Union[Unset, int] = 50,
    paging: Union[Unset, bool] = True,
    program_status: Union[Unset, list[EnrollmentAnalyticsGetAggregateXlsProgramStatusItem]] = UNSET,
    ...
    sort_order: Union[Unset, EnrollmentAnalyticsGetAggregateXlsSortOrder] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/analytics/enrollments/aggregate/{program}.xls",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        data_id_scheme (Union[Unset, EnrollmentAnalyticsGetAggregateXlsDataIdScheme]):
        desc (Union[Unset, list[str]]):
        dimension (Union[Unset, list[str]]):
        display_property (Union[Unset, EnrollmentAnalyticsGetAggregateXlsDisplayProperty]):
        end_date (Union[Unset, datetime.datetime]):
        endpoint_action (Union[Unset, EnrollmentAnalyticsGetAggregateXlsEndpointAction]):
            Default: EnrollmentAnalyticsGetAggregateXlsEndpointAction.OTHER.
        endpoint_item (Union[Unset, EnrollmentAnalyticsGetAggregateXlsEndpointItem]):
        ...
        ou_mode (Union[Unset, EnrollmentAnalyticsGetAggregateXlsOuMode]):
        output_id_scheme (Union[Unset, EnrollmentAnalyticsGetAggregateXlsOutputIdScheme]):
        page (Union[Unset, int]):  Default: 1.
        page_size (Union[Unset, int]):  Default: 50.
        paging (Union[Unset, bool]):  Default: True.
        program_status (Union[Unset, list[EnrollmentAnalyticsGetAggregateXlsProgramStatusItem]]):
        ...
        sort_order (Union[Unset, EnrollmentAnalyticsGetAggregateXlsSortOrder]):
