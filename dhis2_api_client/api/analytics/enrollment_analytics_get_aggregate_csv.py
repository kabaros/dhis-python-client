...
from ...models.enrollment_analytics_get_aggregate_csv_data_id_scheme import (
    EnrollmentAnalyticsGetAggregateCsvDataIdScheme,
)
from ...models.enrollment_analytics_get_aggregate_csv_display_property import (
    EnrollmentAnalyticsGetAggregateCsvDisplayProperty,
)
from ...models.enrollment_analytics_get_aggregate_csv_endpoint_action import (
    EnrollmentAnalyticsGetAggregateCsvEndpointAction,
)
from ...models.enrollment_analytics_get_aggregate_csv_endpoint_item import (
    EnrollmentAnalyticsGetAggregateCsvEndpointItem,
)
from ...models.enrollment_analytics_get_aggregate_csv_ou_mode import EnrollmentAnalyticsGetAggregateCsvOuMode
from ...models.enrollment_analytics_get_aggregate_csv_output_id_scheme import (
    EnrollmentAnalyticsGetAggregateCsvOutputIdScheme,
)
from ...models.enrollment_analytics_get_aggregate_csv_program_status_item import (
    EnrollmentAnalyticsGetAggregateCsvProgramStatusItem,
)
from ...models.enrollment_analytics_get_aggregate_csv_sort_order import EnrollmentAnalyticsGetAggregateCsvSortOrder
...
def _get_kwargs(
    ...
    *,
    ...
    data_id_scheme: Union[Unset, EnrollmentAnalyticsGetAggregateCsvDataIdScheme] = UNSET,
    desc: Union[Unset, list[str]] = UNSET,
    dimension: Union[Unset, list[str]] = UNSET,
    display_property: Union[Unset, EnrollmentAnalyticsGetAggregateCsvDisplayProperty] = UNSET,
    end_date: Union[Unset, datetime.datetime] = UNSET,
    endpoint_action: Union[
        Unset, EnrollmentAnalyticsGetAggregateCsvEndpointAction
    ] = EnrollmentAnalyticsGetAggregateCsvEndpointAction.OTHER,
    endpoint_item: Union[Unset, EnrollmentAnalyticsGetAggregateCsvEndpointItem] = UNSET,
    ...
    ou_mode: Union[Unset, EnrollmentAnalyticsGetAggregateCsvOuMode] = UNSET,
    output_id_scheme: Union[Unset, EnrollmentAnalyticsGetAggregateCsvOutputIdScheme] = UNSET,
    page: Union[Unset, int] = 1,
    page_size: Union[Unset, int] = 50,
    paging: Union[Unset, bool] = True,
    program_status: Union[Unset, list[EnrollmentAnalyticsGetAggregateCsvProgramStatusItem]] = UNSET,
    ...
    sort_order: Union[Unset, EnrollmentAnalyticsGetAggregateCsvSortOrder] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/analytics/enrollments/aggregate/{program}.csv",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        data_id_scheme (Union[Unset, EnrollmentAnalyticsGetAggregateCsvDataIdScheme]):
        desc (Union[Unset, list[str]]):
        dimension (Union[Unset, list[str]]):
        display_property (Union[Unset, EnrollmentAnalyticsGetAggregateCsvDisplayProperty]):
        end_date (Union[Unset, datetime.datetime]):
        endpoint_action (Union[Unset, EnrollmentAnalyticsGetAggregateCsvEndpointAction]):
            Default: EnrollmentAnalyticsGetAggregateCsvEndpointAction.OTHER.
        endpoint_item (Union[Unset, EnrollmentAnalyticsGetAggregateCsvEndpointItem]):
        ...
        ou_mode (Union[Unset, EnrollmentAnalyticsGetAggregateCsvOuMode]):
        output_id_scheme (Union[Unset, EnrollmentAnalyticsGetAggregateCsvOutputIdScheme]):
        page (Union[Unset, int]):  Default: 1.
        page_size (Union[Unset, int]):  Default: 50.
        paging (Union[Unset, bool]):  Default: True.
        program_status (Union[Unset, list[EnrollmentAnalyticsGetAggregateCsvProgramStatusItem]]):
        ...
        sort_order (Union[Unset, EnrollmentAnalyticsGetAggregateCsvSortOrder]):
