...
from ...models.event_analytics_get_query_xls_aggregation_type import EventAnalyticsGetQueryXlsAggregationType
from ...models.event_analytics_get_query_xls_data_id_scheme import EventAnalyticsGetQueryXlsDataIdScheme
from ...models.event_analytics_get_query_xls_display_property import EventAnalyticsGetQueryXlsDisplayProperty
from ...models.event_analytics_get_query_xls_endpoint_action import EventAnalyticsGetQueryXlsEndpointAction
from ...models.event_analytics_get_query_xls_endpoint_item import EventAnalyticsGetQueryXlsEndpointItem
from ...models.event_analytics_get_query_xls_event_status_item import EventAnalyticsGetQueryXlsEventStatusItem
from ...models.event_analytics_get_query_xls_ou_mode import EventAnalyticsGetQueryXlsOuMode
from ...models.event_analytics_get_query_xls_output_id_scheme import EventAnalyticsGetQueryXlsOutputIdScheme
from ...models.event_analytics_get_query_xls_output_type import EventAnalyticsGetQueryXlsOutputType
from ...models.event_analytics_get_query_xls_program_status_item import EventAnalyticsGetQueryXlsProgramStatusItem
from ...models.event_analytics_get_query_xls_sort_order import EventAnalyticsGetQueryXlsSortOrder
...
def _get_kwargs(
    ...
    *,
    ...
    aggregation_type: Union[Unset, EventAnalyticsGetQueryXlsAggregationType] = UNSET,
    ...
    data_id_scheme: Union[Unset, EventAnalyticsGetQueryXlsDataIdScheme] = UNSET,
    default_coordinate_fallback: Union[Unset, bool] = False,
    desc: Union[Unset, list[str]] = UNSET,
    dimension: Union[Unset, list[str]] = UNSET,
    display_property: Union[Unset, EventAnalyticsGetQueryXlsDisplayProperty] = UNSET,
    end_date: Union[Unset, datetime.datetime] = UNSET,
    endpoint_action: Union[
        Unset, EventAnalyticsGetQueryXlsEndpointAction
    ] = EventAnalyticsGetQueryXlsEndpointAction.OTHER,
    endpoint_item: Union[Unset, EventAnalyticsGetQueryXlsEndpointItem] = UNSET,
    ...
    event_status: Union[Unset, list[EventAnalyticsGetQueryXlsEventStatusItem]] = UNSET,
    ...
    ou_mode: Union[Unset, EventAnalyticsGetQueryXlsOuMode] = EventAnalyticsGetQueryXlsOuMode.DESCENDANTS,
    output_id_scheme: Union[Unset, EventAnalyticsGetQueryXlsOutputIdScheme] = UNSET,
    output_type: Union[Unset, EventAnalyticsGetQueryXlsOutputType] = EventAnalyticsGetQueryXlsOutputType.EVENT,
    page: Union[Unset, int] = 1,
    page_size: Union[Unset, int] = 50,
    paging: Union[Unset, bool] = True,
    program_status: Union[Unset, list[EventAnalyticsGetQueryXlsProgramStatusItem]] = UNSET,
    ...
    sort_order: Union[Unset, EventAnalyticsGetQueryXlsSortOrder] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/analytics/events/query/{program}.xls",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        aggregation_type (Union[Unset, EventAnalyticsGetQueryXlsAggregationType]):
        ...
        data_id_scheme (Union[Unset, EventAnalyticsGetQueryXlsDataIdScheme]):
        default_coordinate_fallback (Union[Unset, bool]):  Default: False.
        desc (Union[Unset, list[str]]):
        dimension (Union[Unset, list[str]]):
        display_property (Union[Unset, EventAnalyticsGetQueryXlsDisplayProperty]):
        end_date (Union[Unset, datetime.datetime]):
        endpoint_action (Union[Unset, EventAnalyticsGetQueryXlsEndpointAction]):  Default:
            EventAnalyticsGetQueryXlsEndpointAction.OTHER.
        endpoint_item (Union[Unset, EventAnalyticsGetQueryXlsEndpointItem]):
        ...
        event_status (Union[Unset, list[EventAnalyticsGetQueryXlsEventStatusItem]]):
        ...
        ou_mode (Union[Unset, EventAnalyticsGetQueryXlsOuMode]):  Default:
            EventAnalyticsGetQueryXlsOuMode.DESCENDANTS.
        output_id_scheme (Union[Unset, EventAnalyticsGetQueryXlsOutputIdScheme]):
        output_type (Union[Unset, EventAnalyticsGetQueryXlsOutputType]):  Default:
            EventAnalyticsGetQueryXlsOutputType.EVENT.
        page (Union[Unset, int]):  Default: 1.
        page_size (Union[Unset, int]):  Default: 50.
        paging (Union[Unset, bool]):  Default: True.
        program_status (Union[Unset, list[EventAnalyticsGetQueryXlsProgramStatusItem]]):
        ...
        sort_order (Union[Unset, EventAnalyticsGetQueryXlsSortOrder]):
