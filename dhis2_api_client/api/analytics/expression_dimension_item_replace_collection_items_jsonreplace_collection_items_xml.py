...
from ...models.expression_dimension_item_replace_collection_items_jsonreplace_collection_items_xml_property import (
    ExpressionDimensionItemReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: ExpressionDimensionItemReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
    *,
