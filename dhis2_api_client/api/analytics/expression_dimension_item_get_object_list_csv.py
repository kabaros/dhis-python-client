...
from ...models.expression_dimension_item_get_object_list_csv_root_junction import (
    ExpressionDimensionItemGetObjectListCsvRootJunction,
)
...
def _get_kwargs(
    *,
    ...
    root_junction: Union[Unset, ExpressionDimensionItemGetObjectListCsvRootJunction] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/expressionDimensionItems/#getObjectListCsv",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, ExpressionDimensionItemGetObjectListCsvRootJunction]):
