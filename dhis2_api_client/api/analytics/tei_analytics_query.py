...
from ...models.tei_analytics_query_data_id_scheme import TeiAnalyticsQueryDataIdScheme
from ...models.tei_analytics_query_display_property import TeiAnalyticsQueryDisplayProperty
from ...models.tei_analytics_query_ou_mode import TeiAnalyticsQueryOuMode
from ...models.tei_analytics_query_output_data_element_id_scheme import TeiAnalyticsQueryOutputDataElementIdScheme
from ...models.tei_analytics_query_output_id_scheme import TeiAnalyticsQueryOutputIdScheme
from ...models.tei_analytics_query_output_org_unit_id_scheme import TeiAnalyticsQueryOutputOrgUnitIdScheme
...
def _get_kwargs(
    ...
    *,
    ...
    data_id_scheme: Union[Unset, TeiAnalyticsQueryDataIdScheme] = UNSET,
    desc: Union[Unset, list[str]] = UNSET,
    dimension: Union[Unset, list[str]] = UNSET,
    display_property: Union[Unset, TeiAnalyticsQueryDisplayProperty] = UNSET,
    ...
    ou_mode: Union[Unset, TeiAnalyticsQueryOuMode] = TeiAnalyticsQueryOuMode.DESCENDANTS,
    output_data_element_id_scheme: Union[Unset, TeiAnalyticsQueryOutputDataElementIdScheme] = UNSET,
    output_id_scheme: Union[Unset, TeiAnalyticsQueryOutputIdScheme] = UNSET,
    output_org_unit_id_scheme: Union[Unset, TeiAnalyticsQueryOutputOrgUnitIdScheme] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/analytics/trackedEntities/query/{tracked_entity_type}",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        data_id_scheme (Union[Unset, TeiAnalyticsQueryDataIdScheme]):
        desc (Union[Unset, list[str]]):
        dimension (Union[Unset, list[str]]):
        display_property (Union[Unset, TeiAnalyticsQueryDisplayProperty]):
        ...
        ou_mode (Union[Unset, TeiAnalyticsQueryOuMode]):  Default:
            TeiAnalyticsQueryOuMode.DESCENDANTS.
        output_data_element_id_scheme (Union[Unset, TeiAnalyticsQueryOutputDataElementIdScheme]):
        output_id_scheme (Union[Unset, TeiAnalyticsQueryOutputIdScheme]):
        output_org_unit_id_scheme (Union[Unset, TeiAnalyticsQueryOutputOrgUnitIdScheme]):
