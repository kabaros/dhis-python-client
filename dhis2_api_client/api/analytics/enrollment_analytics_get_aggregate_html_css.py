...
from ...models.enrollment_analytics_get_aggregate_html_css_data_id_scheme import (
    EnrollmentAnalyticsGetAggregateHtmlCssDataIdScheme,
)
from ...models.enrollment_analytics_get_aggregate_html_css_display_property import (
    EnrollmentAnalyticsGetAggregateHtmlCssDisplayProperty,
)
from ...models.enrollment_analytics_get_aggregate_html_css_endpoint_action import (
    EnrollmentAnalyticsGetAggregateHtmlCssEndpointAction,
)
from ...models.enrollment_analytics_get_aggregate_html_css_endpoint_item import (
    EnrollmentAnalyticsGetAggregateHtmlCssEndpointItem,
)
from ...models.enrollment_analytics_get_aggregate_html_css_ou_mode import EnrollmentAnalyticsGetAggregateHtmlCssOuMode
from ...models.enrollment_analytics_get_aggregate_html_css_output_id_scheme import (
    EnrollmentAnalyticsGetAggregateHtmlCssOutputIdScheme,
)
from ...models.enrollment_analytics_get_aggregate_html_css_program_status_item import (
    EnrollmentAnalyticsGetAggregateHtmlCssProgramStatusItem,
)
from ...models.enrollment_analytics_get_aggregate_html_css_sort_order import (
    EnrollmentAnalyticsGetAggregateHtmlCssSortOrder,
)
...
def _get_kwargs(
    ...
    *,
    ...
    data_id_scheme: Union[Unset, EnrollmentAnalyticsGetAggregateHtmlCssDataIdScheme] = UNSET,
    desc: Union[Unset, list[str]] = UNSET,
    dimension: Union[Unset, list[str]] = UNSET,
    display_property: Union[Unset, EnrollmentAnalyticsGetAggregateHtmlCssDisplayProperty] = UNSET,
    end_date: Union[Unset, datetime.datetime] = UNSET,
    endpoint_action: Union[
        Unset, EnrollmentAnalyticsGetAggregateHtmlCssEndpointAction
    ] = EnrollmentAnalyticsGetAggregateHtmlCssEndpointAction.OTHER,
    endpoint_item: Union[Unset, EnrollmentAnalyticsGetAggregateHtmlCssEndpointItem] = UNSET,
    ...
    ou_mode: Union[Unset, EnrollmentAnalyticsGetAggregateHtmlCssOuMode] = UNSET,
    output_id_scheme: Union[Unset, EnrollmentAnalyticsGetAggregateHtmlCssOutputIdScheme] = UNSET,
    page: Union[Unset, int] = 1,
    page_size: Union[Unset, int] = 50,
    paging: Union[Unset, bool] = True,
    program_status: Union[Unset, list[EnrollmentAnalyticsGetAggregateHtmlCssProgramStatusItem]] = UNSET,
    ...
    sort_order: Union[Unset, EnrollmentAnalyticsGetAggregateHtmlCssSortOrder] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/analytics/enrollments/aggregate/{program}.html+css",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        data_id_scheme (Union[Unset, EnrollmentAnalyticsGetAggregateHtmlCssDataIdScheme]):
        desc (Union[Unset, list[str]]):
        dimension (Union[Unset, list[str]]):
        display_property (Union[Unset, EnrollmentAnalyticsGetAggregateHtmlCssDisplayProperty]):
        end_date (Union[Unset, datetime.datetime]):
        endpoint_action (Union[Unset, EnrollmentAnalyticsGetAggregateHtmlCssEndpointAction]):
            Default: EnrollmentAnalyticsGetAggregateHtmlCssEndpointAction.OTHER.
        endpoint_item (Union[Unset, EnrollmentAnalyticsGetAggregateHtmlCssEndpointItem]):
        ...
        ou_mode (Union[Unset, EnrollmentAnalyticsGetAggregateHtmlCssOuMode]):
        output_id_scheme (Union[Unset, EnrollmentAnalyticsGetAggregateHtmlCssOutputIdScheme]):
        page (Union[Unset, int]):  Default: 1.
        page_size (Union[Unset, int]):  Default: 50.
        paging (Union[Unset, bool]):  Default: True.
        program_status (Union[Unset,
            list[EnrollmentAnalyticsGetAggregateHtmlCssProgramStatusItem]]):
        ...
        sort_order (Union[Unset, EnrollmentAnalyticsGetAggregateHtmlCssSortOrder]):
