...
from ...models.event_analytics_get_query_html_css_aggregation_type import EventAnalyticsGetQueryHtmlCssAggregationType
from ...models.event_analytics_get_query_html_css_data_id_scheme import EventAnalyticsGetQueryHtmlCssDataIdScheme
from ...models.event_analytics_get_query_html_css_display_property import EventAnalyticsGetQueryHtmlCssDisplayProperty
from ...models.event_analytics_get_query_html_css_endpoint_action import EventAnalyticsGetQueryHtmlCssEndpointAction
from ...models.event_analytics_get_query_html_css_endpoint_item import EventAnalyticsGetQueryHtmlCssEndpointItem
from ...models.event_analytics_get_query_html_css_event_status_item import EventAnalyticsGetQueryHtmlCssEventStatusItem
from ...models.event_analytics_get_query_html_css_ou_mode import EventAnalyticsGetQueryHtmlCssOuMode
from ...models.event_analytics_get_query_html_css_output_id_scheme import EventAnalyticsGetQueryHtmlCssOutputIdScheme
from ...models.event_analytics_get_query_html_css_output_type import EventAnalyticsGetQueryHtmlCssOutputType
from ...models.event_analytics_get_query_html_css_program_status_item import (
    EventAnalyticsGetQueryHtmlCssProgramStatusItem,
)
from ...models.event_analytics_get_query_html_css_sort_order import EventAnalyticsGetQueryHtmlCssSortOrder
...
def _get_kwargs(
    ...
    *,
    ...
    aggregation_type: Union[Unset, EventAnalyticsGetQueryHtmlCssAggregationType] = UNSET,
    ...
    data_id_scheme: Union[Unset, EventAnalyticsGetQueryHtmlCssDataIdScheme] = UNSET,
    default_coordinate_fallback: Union[Unset, bool] = False,
    desc: Union[Unset, list[str]] = UNSET,
    dimension: Union[Unset, list[str]] = UNSET,
    display_property: Union[Unset, EventAnalyticsGetQueryHtmlCssDisplayProperty] = UNSET,
    end_date: Union[Unset, datetime.datetime] = UNSET,
    endpoint_action: Union[
        Unset, EventAnalyticsGetQueryHtmlCssEndpointAction
    ] = EventAnalyticsGetQueryHtmlCssEndpointAction.OTHER,
    endpoint_item: Union[Unset, EventAnalyticsGetQueryHtmlCssEndpointItem] = UNSET,
    ...
    event_status: Union[Unset, list[EventAnalyticsGetQueryHtmlCssEventStatusItem]] = UNSET,
    ...
    ou_mode: Union[Unset, EventAnalyticsGetQueryHtmlCssOuMode] = EventAnalyticsGetQueryHtmlCssOuMode.DESCENDANTS,
    output_id_scheme: Union[Unset, EventAnalyticsGetQueryHtmlCssOutputIdScheme] = UNSET,
    output_type: Union[Unset, EventAnalyticsGetQueryHtmlCssOutputType] = EventAnalyticsGetQueryHtmlCssOutputType.EVENT,
    page: Union[Unset, int] = 1,
    page_size: Union[Unset, int] = 50,
    paging: Union[Unset, bool] = True,
    program_status: Union[Unset, list[EventAnalyticsGetQueryHtmlCssProgramStatusItem]] = UNSET,
    ...
    sort_order: Union[Unset, EventAnalyticsGetQueryHtmlCssSortOrder] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/analytics/events/query/{program}.html+css",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        aggregation_type (Union[Unset, EventAnalyticsGetQueryHtmlCssAggregationType]):
        ...
        data_id_scheme (Union[Unset, EventAnalyticsGetQueryHtmlCssDataIdScheme]):
        default_coordinate_fallback (Union[Unset, bool]):  Default: False.
        desc (Union[Unset, list[str]]):
        dimension (Union[Unset, list[str]]):
        display_property (Union[Unset, EventAnalyticsGetQueryHtmlCssDisplayProperty]):
        end_date (Union[Unset, datetime.datetime]):
        endpoint_action (Union[Unset, EventAnalyticsGetQueryHtmlCssEndpointAction]):  Default:
            EventAnalyticsGetQueryHtmlCssEndpointAction.OTHER.
        endpoint_item (Union[Unset, EventAnalyticsGetQueryHtmlCssEndpointItem]):
        ...
        event_status (Union[Unset, list[EventAnalyticsGetQueryHtmlCssEventStatusItem]]):
        ...
        ou_mode (Union[Unset, EventAnalyticsGetQueryHtmlCssOuMode]):  Default:
            EventAnalyticsGetQueryHtmlCssOuMode.DESCENDANTS.
        output_id_scheme (Union[Unset, EventAnalyticsGetQueryHtmlCssOutputIdScheme]):
        output_type (Union[Unset, EventAnalyticsGetQueryHtmlCssOutputType]):  Default:
            EventAnalyticsGetQueryHtmlCssOutputType.EVENT.
        page (Union[Unset, int]):  Default: 1.
        page_size (Union[Unset, int]):  Default: 50.
        paging (Union[Unset, bool]):  Default: True.
        program_status (Union[Unset, list[EventAnalyticsGetQueryHtmlCssProgramStatusItem]]):
        ...
        sort_order (Union[Unset, EventAnalyticsGetQueryHtmlCssSortOrder]):
