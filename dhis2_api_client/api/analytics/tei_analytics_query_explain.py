...
from ...models.tei_analytics_query_explain_data_id_scheme import TeiAnalyticsQueryExplainDataIdScheme
from ...models.tei_analytics_query_explain_display_property import TeiAnalyticsQueryExplainDisplayProperty
from ...models.tei_analytics_query_explain_ou_mode import TeiAnalyticsQueryExplainOuMode
from ...models.tei_analytics_query_explain_output_data_element_id_scheme import (
    TeiAnalyticsQueryExplainOutputDataElementIdScheme,
)
from ...models.tei_analytics_query_explain_output_id_scheme import TeiAnalyticsQueryExplainOutputIdScheme
from ...models.tei_analytics_query_explain_output_org_unit_id_scheme import (
    TeiAnalyticsQueryExplainOutputOrgUnitIdScheme,
)
...
def _get_kwargs(
    ...
    *,
    ...
    data_id_scheme: Union[Unset, TeiAnalyticsQueryExplainDataIdScheme] = UNSET,
    desc: Union[Unset, list[str]] = UNSET,
    dimension: Union[Unset, list[str]] = UNSET,
    display_property: Union[Unset, TeiAnalyticsQueryExplainDisplayProperty] = UNSET,
    ...
    ou_mode: Union[Unset, TeiAnalyticsQueryExplainOuMode] = TeiAnalyticsQueryExplainOuMode.DESCENDANTS,
    output_data_element_id_scheme: Union[Unset, TeiAnalyticsQueryExplainOutputDataElementIdScheme] = UNSET,
    output_id_scheme: Union[Unset, TeiAnalyticsQueryExplainOutputIdScheme] = UNSET,
    output_org_unit_id_scheme: Union[Unset, TeiAnalyticsQueryExplainOutputOrgUnitIdScheme] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/analytics/trackedEntities/query/{tracked_entity_type}/explain",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        data_id_scheme (Union[Unset, TeiAnalyticsQueryExplainDataIdScheme]):
        desc (Union[Unset, list[str]]):
        dimension (Union[Unset, list[str]]):
        display_property (Union[Unset, TeiAnalyticsQueryExplainDisplayProperty]):
        ...
        ou_mode (Union[Unset, TeiAnalyticsQueryExplainOuMode]):  Default:
            TeiAnalyticsQueryExplainOuMode.DESCENDANTS.
        output_data_element_id_scheme (Union[Unset,
            TeiAnalyticsQueryExplainOutputDataElementIdScheme]):
        output_id_scheme (Union[Unset, TeiAnalyticsQueryExplainOutputIdScheme]):
        output_org_unit_id_scheme (Union[Unset, TeiAnalyticsQueryExplainOutputOrgUnitIdScheme]):
