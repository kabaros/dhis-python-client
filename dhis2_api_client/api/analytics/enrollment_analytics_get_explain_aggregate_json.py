...
from ...models.enrollment_analytics_get_explain_aggregate_json_data_id_scheme import (
    EnrollmentAnalyticsGetExplainAggregateJsonDataIdScheme,
)
from ...models.enrollment_analytics_get_explain_aggregate_json_display_property import (
    EnrollmentAnalyticsGetExplainAggregateJsonDisplayProperty,
)
from ...models.enrollment_analytics_get_explain_aggregate_json_endpoint_action import (
    EnrollmentAnalyticsGetExplainAggregateJsonEndpointAction,
)
from ...models.enrollment_analytics_get_explain_aggregate_json_endpoint_item import (
    EnrollmentAnalyticsGetExplainAggregateJsonEndpointItem,
)
from ...models.enrollment_analytics_get_explain_aggregate_json_ou_mode import (
    EnrollmentAnalyticsGetExplainAggregateJsonOuMode,
)
from ...models.enrollment_analytics_get_explain_aggregate_json_output_id_scheme import (
    EnrollmentAnalyticsGetExplainAggregateJsonOutputIdScheme,
)
from ...models.enrollment_analytics_get_explain_aggregate_json_program_status_item import (
    EnrollmentAnalyticsGetExplainAggregateJsonProgramStatusItem,
)
from ...models.enrollment_analytics_get_explain_aggregate_json_sort_order import (
    EnrollmentAnalyticsGetExplainAggregateJsonSortOrder,
)
...
def _get_kwargs(
    ...
    *,
    ...
    data_id_scheme: Union[Unset, EnrollmentAnalyticsGetExplainAggregateJsonDataIdScheme] = UNSET,
    desc: Union[Unset, list[str]] = UNSET,
    dimension: Union[Unset, list[str]] = UNSET,
    display_property: Union[Unset, EnrollmentAnalyticsGetExplainAggregateJsonDisplayProperty] = UNSET,
    end_date: Union[Unset, datetime.datetime] = UNSET,
    endpoint_action: Union[
        Unset, EnrollmentAnalyticsGetExplainAggregateJsonEndpointAction
    ] = EnrollmentAnalyticsGetExplainAggregateJsonEndpointAction.OTHER,
    endpoint_item: Union[Unset, EnrollmentAnalyticsGetExplainAggregateJsonEndpointItem] = UNSET,
    ...
    ou_mode: Union[Unset, EnrollmentAnalyticsGetExplainAggregateJsonOuMode] = UNSET,
    output_id_scheme: Union[Unset, EnrollmentAnalyticsGetExplainAggregateJsonOutputIdScheme] = UNSET,
    page: Union[Unset, int] = 1,
    page_size: Union[Unset, int] = 50,
    paging: Union[Unset, bool] = True,
    program_status: Union[Unset, list[EnrollmentAnalyticsGetExplainAggregateJsonProgramStatusItem]] = UNSET,
    ...
    sort_order: Union[Unset, EnrollmentAnalyticsGetExplainAggregateJsonSortOrder] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/analytics/enrollments/aggregate/{program}/explain",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        data_id_scheme (Union[Unset, EnrollmentAnalyticsGetExplainAggregateJsonDataIdScheme]):
        desc (Union[Unset, list[str]]):
        dimension (Union[Unset, list[str]]):
        display_property (Union[Unset,
            EnrollmentAnalyticsGetExplainAggregateJsonDisplayProperty]):
        end_date (Union[Unset, datetime.datetime]):
        endpoint_action (Union[Unset, EnrollmentAnalyticsGetExplainAggregateJsonEndpointAction]):
            Default: EnrollmentAnalyticsGetExplainAggregateJsonEndpointAction.OTHER.
        endpoint_item (Union[Unset, EnrollmentAnalyticsGetExplainAggregateJsonEndpointItem]):
        ...
        ou_mode (Union[Unset, EnrollmentAnalyticsGetExplainAggregateJsonOuMode]):
        output_id_scheme (Union[Unset, EnrollmentAnalyticsGetExplainAggregateJsonOutputIdScheme]):
        page (Union[Unset, int]):  Default: 1.
        page_size (Union[Unset, int]):  Default: 50.
        paging (Union[Unset, bool]):  Default: True.
        program_status (Union[Unset,
            list[EnrollmentAnalyticsGetExplainAggregateJsonProgramStatusItem]]):
        ...
        sort_order (Union[Unset, EnrollmentAnalyticsGetExplainAggregateJsonSortOrder]):
