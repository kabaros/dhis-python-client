...
from ...models.analytics_get_xml_aggregation_type import AnalyticsGetXmlAggregationType
from ...models.analytics_get_xml_display_property import AnalyticsGetXmlDisplayProperty
from ...models.analytics_get_xml_input_id_scheme import AnalyticsGetXmlInputIdScheme
from ...models.analytics_get_xml_order import AnalyticsGetXmlOrder
from ...models.analytics_get_xml_output_data_element_id_scheme import AnalyticsGetXmlOutputDataElementIdScheme
from ...models.analytics_get_xml_output_data_item_id_scheme import AnalyticsGetXmlOutputDataItemIdScheme
from ...models.analytics_get_xml_output_id_scheme import AnalyticsGetXmlOutputIdScheme
from ...models.analytics_get_xml_output_org_unit_id_scheme import AnalyticsGetXmlOutputOrgUnitIdScheme
from ...models.analytics_get_xml_user_org_unit_type import AnalyticsGetXmlUserOrgUnitType
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    aggregation_type: Union[Unset, AnalyticsGetXmlAggregationType] = UNSET,
    ...
    display_property: Union[Unset, AnalyticsGetXmlDisplayProperty] = UNSET,
    ...
    input_id_scheme: Union[Unset, AnalyticsGetXmlInputIdScheme] = UNSET,
    measure_criteria: Union[Unset, str] = UNSET,
    order: Union[Unset, AnalyticsGetXmlOrder] = UNSET,
    org_unit_field: Union[Unset, str] = UNSET,
    output_data_element_id_scheme: Union[Unset, AnalyticsGetXmlOutputDataElementIdScheme] = UNSET,
    output_data_item_id_scheme: Union[Unset, AnalyticsGetXmlOutputDataItemIdScheme] = UNSET,
    output_id_scheme: Union[Unset, AnalyticsGetXmlOutputIdScheme] = UNSET,
    output_org_unit_id_scheme: Union[Unset, AnalyticsGetXmlOutputOrgUnitIdScheme] = UNSET,
    ...
    user_org_unit_type: Union[Unset, AnalyticsGetXmlUserOrgUnitType] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
def sync_detailed(
    *,
    ...
    Args:
        aggregation_type (Union[Unset, AnalyticsGetXmlAggregationType]):
        ...
        display_property (Union[Unset, AnalyticsGetXmlDisplayProperty]):
        ...
        input_id_scheme (Union[Unset, AnalyticsGetXmlInputIdScheme]):
        measure_criteria (Union[Unset, str]):
        order (Union[Unset, AnalyticsGetXmlOrder]):
        org_unit_field (Union[Unset, str]):
        output_data_element_id_scheme (Union[Unset, AnalyticsGetXmlOutputDataElementIdScheme]):
        output_data_item_id_scheme (Union[Unset, AnalyticsGetXmlOutputDataItemIdScheme]):
        output_id_scheme (Union[Unset, AnalyticsGetXmlOutputIdScheme]):
        output_org_unit_id_scheme (Union[Unset, AnalyticsGetXmlOutputOrgUnitIdScheme]):
        ...
        user_org_unit_type (Union[Unset, AnalyticsGetXmlUserOrgUnitType]):
