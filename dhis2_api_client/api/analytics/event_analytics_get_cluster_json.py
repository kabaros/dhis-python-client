...
from ...models.event_analytics_get_cluster_json_aggregation_type import EventAnalyticsGetClusterJsonAggregationType
from ...models.event_analytics_get_cluster_json_data_id_scheme import EventAnalyticsGetClusterJsonDataIdScheme
from ...models.event_analytics_get_cluster_json_display_property import EventAnalyticsGetClusterJsonDisplayProperty
from ...models.event_analytics_get_cluster_json_endpoint_action import EventAnalyticsGetClusterJsonEndpointAction
from ...models.event_analytics_get_cluster_json_endpoint_item import EventAnalyticsGetClusterJsonEndpointItem
from ...models.event_analytics_get_cluster_json_event_status_item import EventAnalyticsGetClusterJsonEventStatusItem
from ...models.event_analytics_get_cluster_json_ou_mode import EventAnalyticsGetClusterJsonOuMode
from ...models.event_analytics_get_cluster_json_output_id_scheme import EventAnalyticsGetClusterJsonOutputIdScheme
from ...models.event_analytics_get_cluster_json_output_type import EventAnalyticsGetClusterJsonOutputType
from ...models.event_analytics_get_cluster_json_program_status_item import EventAnalyticsGetClusterJsonProgramStatusItem
from ...models.event_analytics_get_cluster_json_sort_order import EventAnalyticsGetClusterJsonSortOrder
...
def _get_kwargs(
    ...
    *,
    ...
    aggregation_type: Union[Unset, EventAnalyticsGetClusterJsonAggregationType] = UNSET,
    ...
    data_id_scheme: Union[Unset, EventAnalyticsGetClusterJsonDataIdScheme] = UNSET,
    default_coordinate_fallback: Union[Unset, bool] = False,
    desc: Union[Unset, list[str]] = UNSET,
    dimension: Union[Unset, list[str]] = UNSET,
    display_property: Union[Unset, EventAnalyticsGetClusterJsonDisplayProperty] = UNSET,
    end_date: Union[Unset, datetime.datetime] = UNSET,
    endpoint_action: Union[
        Unset, EventAnalyticsGetClusterJsonEndpointAction
    ] = EventAnalyticsGetClusterJsonEndpointAction.OTHER,
    endpoint_item: Union[Unset, EventAnalyticsGetClusterJsonEndpointItem] = UNSET,
    ...
    event_status: Union[Unset, list[EventAnalyticsGetClusterJsonEventStatusItem]] = UNSET,
    ...
    include_cluster_points: Union[Unset, bool] = UNSET,
    include_metadata_details: Union[Unset, bool] = False,
    last_updated: Union[Unset, str] = UNSET,
    limit: Union[Unset, int] = UNSET,
    org_unit_field: Union[Unset, str] = UNSET,
    ou_mode: Union[Unset, EventAnalyticsGetClusterJsonOuMode] = EventAnalyticsGetClusterJsonOuMode.DESCENDANTS,
    output_id_scheme: Union[Unset, EventAnalyticsGetClusterJsonOutputIdScheme] = UNSET,
    output_type: Union[Unset, EventAnalyticsGetClusterJsonOutputType] = EventAnalyticsGetClusterJsonOutputType.EVENT,
    page: Union[Unset, int] = 1,
    page_size: Union[Unset, int] = 50,
    paging: Union[Unset, bool] = True,
    program_status: Union[Unset, list[EventAnalyticsGetClusterJsonProgramStatusItem]] = UNSET,
    ...
    sort_order: Union[Unset, EventAnalyticsGetClusterJsonSortOrder] = UNSET,
    ...
    params["includeClusterPoints"] = include_cluster_points
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/analytics/events/cluster/{program}",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        aggregation_type (Union[Unset, EventAnalyticsGetClusterJsonAggregationType]):
        ...
        data_id_scheme (Union[Unset, EventAnalyticsGetClusterJsonDataIdScheme]):
        default_coordinate_fallback (Union[Unset, bool]):  Default: False.
        desc (Union[Unset, list[str]]):
        dimension (Union[Unset, list[str]]):
        display_property (Union[Unset, EventAnalyticsGetClusterJsonDisplayProperty]):
        end_date (Union[Unset, datetime.datetime]):
        endpoint_action (Union[Unset, EventAnalyticsGetClusterJsonEndpointAction]):  Default:
            EventAnalyticsGetClusterJsonEndpointAction.OTHER.
        endpoint_item (Union[Unset, EventAnalyticsGetClusterJsonEndpointItem]):
        ...
        event_status (Union[Unset, list[EventAnalyticsGetClusterJsonEventStatusItem]]):
        ...
        include_cluster_points (Union[Unset, bool]):
        include_metadata_details (Union[Unset, bool]):  Default: False.
        last_updated (Union[Unset, str]):
        limit (Union[Unset, int]):
        org_unit_field (Union[Unset, str]):
        ou_mode (Union[Unset, EventAnalyticsGetClusterJsonOuMode]):  Default:
            EventAnalyticsGetClusterJsonOuMode.DESCENDANTS.
        output_id_scheme (Union[Unset, EventAnalyticsGetClusterJsonOutputIdScheme]):
        output_type (Union[Unset, EventAnalyticsGetClusterJsonOutputType]):  Default:
            EventAnalyticsGetClusterJsonOutputType.EVENT.
        page (Union[Unset, int]):  Default: 1.
        page_size (Union[Unset, int]):  Default: 50.
        paging (Union[Unset, bool]):  Default: True.
        program_status (Union[Unset, list[EventAnalyticsGetClusterJsonProgramStatusItem]]):
        ...
        sort_order (Union[Unset, EventAnalyticsGetClusterJsonSortOrder]):
    ...
    kwargs = _get_kwargs(
        ...
        include_cluster_points=include_cluster_points,
