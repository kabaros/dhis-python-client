...
from ...models.expression_dimension_item_delete_collection_items_jsondelete_collection_items_xml_property import (
    ExpressionDimensionItemDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: ExpressionDimensionItemDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
    *,
