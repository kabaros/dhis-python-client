...
from ...models.tei_analytics_query_xls_data_id_scheme import TeiAnalyticsQueryXlsDataIdScheme
from ...models.tei_analytics_query_xls_display_property import TeiAnalyticsQueryXlsDisplayProperty
from ...models.tei_analytics_query_xls_ou_mode import TeiAnalyticsQueryXlsOuMode
from ...models.tei_analytics_query_xls_output_data_element_id_scheme import (
    TeiAnalyticsQueryXlsOutputDataElementIdScheme,
)
from ...models.tei_analytics_query_xls_output_id_scheme import TeiAnalyticsQueryXlsOutputIdScheme
from ...models.tei_analytics_query_xls_output_org_unit_id_scheme import TeiAnalyticsQueryXlsOutputOrgUnitIdScheme
...
def _get_kwargs(
    ...
    *,
    ...
    data_id_scheme: Union[Unset, TeiAnalyticsQueryXlsDataIdScheme] = UNSET,
    desc: Union[Unset, list[str]] = UNSET,
    dimension: Union[Unset, list[str]] = UNSET,
    display_property: Union[Unset, TeiAnalyticsQueryXlsDisplayProperty] = UNSET,
    ...
    ou_mode: Union[Unset, TeiAnalyticsQueryXlsOuMode] = TeiAnalyticsQueryXlsOuMode.DESCENDANTS,
    output_data_element_id_scheme: Union[Unset, TeiAnalyticsQueryXlsOutputDataElementIdScheme] = UNSET,
    output_id_scheme: Union[Unset, TeiAnalyticsQueryXlsOutputIdScheme] = UNSET,
    output_org_unit_id_scheme: Union[Unset, TeiAnalyticsQueryXlsOutputOrgUnitIdScheme] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/analytics/trackedEntities/query/{tracked_entity_type}.xls",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        data_id_scheme (Union[Unset, TeiAnalyticsQueryXlsDataIdScheme]):
        desc (Union[Unset, list[str]]):
        dimension (Union[Unset, list[str]]):
        display_property (Union[Unset, TeiAnalyticsQueryXlsDisplayProperty]):
        ...
        ou_mode (Union[Unset, TeiAnalyticsQueryXlsOuMode]):  Default:
            TeiAnalyticsQueryXlsOuMode.DESCENDANTS.
        output_data_element_id_scheme (Union[Unset,
            TeiAnalyticsQueryXlsOutputDataElementIdScheme]):
        output_id_scheme (Union[Unset, TeiAnalyticsQueryXlsOutputIdScheme]):
        output_org_unit_id_scheme (Union[Unset, TeiAnalyticsQueryXlsOutputOrgUnitIdScheme]):
