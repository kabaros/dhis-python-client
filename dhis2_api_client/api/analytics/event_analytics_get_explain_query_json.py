...
from ...models.event_analytics_get_explain_query_json_aggregation_type import (
    EventAnalyticsGetExplainQueryJsonAggregationType,
)
from ...models.event_analytics_get_explain_query_json_data_id_scheme import (
    EventAnalyticsGetExplainQueryJsonDataIdScheme,
)
from ...models.event_analytics_get_explain_query_json_display_property import (
    EventAnalyticsGetExplainQueryJsonDisplayProperty,
)
from ...models.event_analytics_get_explain_query_json_endpoint_action import (
    EventAnalyticsGetExplainQueryJsonEndpointAction,
)
from ...models.event_analytics_get_explain_query_json_endpoint_item import EventAnalyticsGetExplainQueryJsonEndpointItem
from ...models.event_analytics_get_explain_query_json_event_status_item import (
    EventAnalyticsGetExplainQueryJsonEventStatusItem,
)
from ...models.event_analytics_get_explain_query_json_ou_mode import EventAnalyticsGetExplainQueryJsonOuMode
from ...models.event_analytics_get_explain_query_json_output_id_scheme import (
    EventAnalyticsGetExplainQueryJsonOutputIdScheme,
)
from ...models.event_analytics_get_explain_query_json_output_type import EventAnalyticsGetExplainQueryJsonOutputType
from ...models.event_analytics_get_explain_query_json_program_status_item import (
    EventAnalyticsGetExplainQueryJsonProgramStatusItem,
)
from ...models.event_analytics_get_explain_query_json_sort_order import EventAnalyticsGetExplainQueryJsonSortOrder
...
def _get_kwargs(
    ...
    *,
    ...
    aggregation_type: Union[Unset, EventAnalyticsGetExplainQueryJsonAggregationType] = UNSET,
    ...
    data_id_scheme: Union[Unset, EventAnalyticsGetExplainQueryJsonDataIdScheme] = UNSET,
    default_coordinate_fallback: Union[Unset, bool] = False,
    desc: Union[Unset, list[str]] = UNSET,
    dimension: Union[Unset, list[str]] = UNSET,
    display_property: Union[Unset, EventAnalyticsGetExplainQueryJsonDisplayProperty] = UNSET,
    end_date: Union[Unset, datetime.datetime] = UNSET,
    endpoint_action: Union[
        Unset, EventAnalyticsGetExplainQueryJsonEndpointAction
    ] = EventAnalyticsGetExplainQueryJsonEndpointAction.OTHER,
    endpoint_item: Union[Unset, EventAnalyticsGetExplainQueryJsonEndpointItem] = UNSET,
    ...
    event_status: Union[Unset, list[EventAnalyticsGetExplainQueryJsonEventStatusItem]] = UNSET,
    ...
    ou_mode: Union[
        Unset, EventAnalyticsGetExplainQueryJsonOuMode
    ] = EventAnalyticsGetExplainQueryJsonOuMode.DESCENDANTS,
    output_id_scheme: Union[Unset, EventAnalyticsGetExplainQueryJsonOutputIdScheme] = UNSET,
    output_type: Union[
        Unset, EventAnalyticsGetExplainQueryJsonOutputType
    ] = EventAnalyticsGetExplainQueryJsonOutputType.EVENT,
    page: Union[Unset, int] = 1,
    page_size: Union[Unset, int] = 50,
    paging: Union[Unset, bool] = True,
    program_status: Union[Unset, list[EventAnalyticsGetExplainQueryJsonProgramStatusItem]] = UNSET,
    ...
    sort_order: Union[Unset, EventAnalyticsGetExplainQueryJsonSortOrder] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/analytics/events/query/{program}/explain",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        aggregation_type (Union[Unset, EventAnalyticsGetExplainQueryJsonAggregationType]):
        ...
        data_id_scheme (Union[Unset, EventAnalyticsGetExplainQueryJsonDataIdScheme]):
        default_coordinate_fallback (Union[Unset, bool]):  Default: False.
        desc (Union[Unset, list[str]]):
        dimension (Union[Unset, list[str]]):
        display_property (Union[Unset, EventAnalyticsGetExplainQueryJsonDisplayProperty]):
        end_date (Union[Unset, datetime.datetime]):
        endpoint_action (Union[Unset, EventAnalyticsGetExplainQueryJsonEndpointAction]):  Default:
            EventAnalyticsGetExplainQueryJsonEndpointAction.OTHER.
        endpoint_item (Union[Unset, EventAnalyticsGetExplainQueryJsonEndpointItem]):
        ...
        event_status (Union[Unset, list[EventAnalyticsGetExplainQueryJsonEventStatusItem]]):
        ...
        ou_mode (Union[Unset, EventAnalyticsGetExplainQueryJsonOuMode]):  Default:
            EventAnalyticsGetExplainQueryJsonOuMode.DESCENDANTS.
        output_id_scheme (Union[Unset, EventAnalyticsGetExplainQueryJsonOutputIdScheme]):
        output_type (Union[Unset, EventAnalyticsGetExplainQueryJsonOutputType]):  Default:
            EventAnalyticsGetExplainQueryJsonOutputType.EVENT.
        page (Union[Unset, int]):  Default: 1.
        page_size (Union[Unset, int]):  Default: 50.
        paging (Union[Unset, bool]):  Default: True.
        program_status (Union[Unset, list[EventAnalyticsGetExplainQueryJsonProgramStatusItem]]):
        ...
        sort_order (Union[Unset, EventAnalyticsGetExplainQueryJsonSortOrder]):
