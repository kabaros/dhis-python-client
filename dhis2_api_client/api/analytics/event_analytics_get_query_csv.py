...
from ...models.event_analytics_get_query_csv_aggregation_type import EventAnalyticsGetQueryCsvAggregationType
from ...models.event_analytics_get_query_csv_data_id_scheme import EventAnalyticsGetQueryCsvDataIdScheme
from ...models.event_analytics_get_query_csv_display_property import EventAnalyticsGetQueryCsvDisplayProperty
from ...models.event_analytics_get_query_csv_endpoint_action import EventAnalyticsGetQueryCsvEndpointAction
from ...models.event_analytics_get_query_csv_endpoint_item import EventAnalyticsGetQueryCsvEndpointItem
from ...models.event_analytics_get_query_csv_event_status_item import EventAnalyticsGetQueryCsvEventStatusItem
from ...models.event_analytics_get_query_csv_ou_mode import EventAnalyticsGetQueryCsvOuMode
from ...models.event_analytics_get_query_csv_output_id_scheme import EventAnalyticsGetQueryCsvOutputIdScheme
from ...models.event_analytics_get_query_csv_output_type import EventAnalyticsGetQueryCsvOutputType
from ...models.event_analytics_get_query_csv_program_status_item import EventAnalyticsGetQueryCsvProgramStatusItem
from ...models.event_analytics_get_query_csv_sort_order import EventAnalyticsGetQueryCsvSortOrder
...
def _get_kwargs(
    ...
    *,
    ...
    aggregation_type: Union[Unset, EventAnalyticsGetQueryCsvAggregationType] = UNSET,
    ...
    data_id_scheme: Union[Unset, EventAnalyticsGetQueryCsvDataIdScheme] = UNSET,
    default_coordinate_fallback: Union[Unset, bool] = False,
    desc: Union[Unset, list[str]] = UNSET,
    dimension: Union[Unset, list[str]] = UNSET,
    display_property: Union[Unset, EventAnalyticsGetQueryCsvDisplayProperty] = UNSET,
    end_date: Union[Unset, datetime.datetime] = UNSET,
    endpoint_action: Union[
        Unset, EventAnalyticsGetQueryCsvEndpointAction
    ] = EventAnalyticsGetQueryCsvEndpointAction.OTHER,
    endpoint_item: Union[Unset, EventAnalyticsGetQueryCsvEndpointItem] = UNSET,
    ...
    event_status: Union[Unset, list[EventAnalyticsGetQueryCsvEventStatusItem]] = UNSET,
    ...
    ou_mode: Union[Unset, EventAnalyticsGetQueryCsvOuMode] = EventAnalyticsGetQueryCsvOuMode.DESCENDANTS,
    output_id_scheme: Union[Unset, EventAnalyticsGetQueryCsvOutputIdScheme] = UNSET,
    output_type: Union[Unset, EventAnalyticsGetQueryCsvOutputType] = EventAnalyticsGetQueryCsvOutputType.EVENT,
    page: Union[Unset, int] = 1,
    page_size: Union[Unset, int] = 50,
    paging: Union[Unset, bool] = True,
    program_status: Union[Unset, list[EventAnalyticsGetQueryCsvProgramStatusItem]] = UNSET,
    ...
    sort_order: Union[Unset, EventAnalyticsGetQueryCsvSortOrder] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/analytics/events/query/{program}.csv",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        aggregation_type (Union[Unset, EventAnalyticsGetQueryCsvAggregationType]):
        ...
        data_id_scheme (Union[Unset, EventAnalyticsGetQueryCsvDataIdScheme]):
        default_coordinate_fallback (Union[Unset, bool]):  Default: False.
        desc (Union[Unset, list[str]]):
        dimension (Union[Unset, list[str]]):
        display_property (Union[Unset, EventAnalyticsGetQueryCsvDisplayProperty]):
        end_date (Union[Unset, datetime.datetime]):
        endpoint_action (Union[Unset, EventAnalyticsGetQueryCsvEndpointAction]):  Default:
            EventAnalyticsGetQueryCsvEndpointAction.OTHER.
        endpoint_item (Union[Unset, EventAnalyticsGetQueryCsvEndpointItem]):
        ...
        event_status (Union[Unset, list[EventAnalyticsGetQueryCsvEventStatusItem]]):
        ...
        ou_mode (Union[Unset, EventAnalyticsGetQueryCsvOuMode]):  Default:
            EventAnalyticsGetQueryCsvOuMode.DESCENDANTS.
        output_id_scheme (Union[Unset, EventAnalyticsGetQueryCsvOutputIdScheme]):
        output_type (Union[Unset, EventAnalyticsGetQueryCsvOutputType]):  Default:
            EventAnalyticsGetQueryCsvOutputType.EVENT.
        page (Union[Unset, int]):  Default: 1.
        page_size (Union[Unset, int]):  Default: 50.
        paging (Union[Unset, bool]):  Default: True.
        program_status (Union[Unset, list[EventAnalyticsGetQueryCsvProgramStatusItem]]):
        ...
        sort_order (Union[Unset, EventAnalyticsGetQueryCsvSortOrder]):
