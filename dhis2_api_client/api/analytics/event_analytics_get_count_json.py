...
from ...models.event_analytics_get_count_json_aggregation_type import EventAnalyticsGetCountJsonAggregationType
from ...models.event_analytics_get_count_json_data_id_scheme import EventAnalyticsGetCountJsonDataIdScheme
from ...models.event_analytics_get_count_json_display_property import EventAnalyticsGetCountJsonDisplayProperty
from ...models.event_analytics_get_count_json_endpoint_action import EventAnalyticsGetCountJsonEndpointAction
from ...models.event_analytics_get_count_json_endpoint_item import EventAnalyticsGetCountJsonEndpointItem
from ...models.event_analytics_get_count_json_event_status_item import EventAnalyticsGetCountJsonEventStatusItem
from ...models.event_analytics_get_count_json_ou_mode import EventAnalyticsGetCountJsonOuMode
from ...models.event_analytics_get_count_json_output_id_scheme import EventAnalyticsGetCountJsonOutputIdScheme
from ...models.event_analytics_get_count_json_output_type import EventAnalyticsGetCountJsonOutputType
from ...models.event_analytics_get_count_json_program_status_item import EventAnalyticsGetCountJsonProgramStatusItem
from ...models.event_analytics_get_count_json_sort_order import EventAnalyticsGetCountJsonSortOrder
...
def _get_kwargs(
    ...
    *,
    ...
    aggregation_type: Union[Unset, EventAnalyticsGetCountJsonAggregationType] = UNSET,
    ...
    data_id_scheme: Union[Unset, EventAnalyticsGetCountJsonDataIdScheme] = UNSET,
    default_coordinate_fallback: Union[Unset, bool] = False,
    desc: Union[Unset, list[str]] = UNSET,
    dimension: Union[Unset, list[str]] = UNSET,
    display_property: Union[Unset, EventAnalyticsGetCountJsonDisplayProperty] = UNSET,
    end_date: Union[Unset, datetime.datetime] = UNSET,
    endpoint_action: Union[
        Unset, EventAnalyticsGetCountJsonEndpointAction
    ] = EventAnalyticsGetCountJsonEndpointAction.OTHER,
    endpoint_item: Union[Unset, EventAnalyticsGetCountJsonEndpointItem] = UNSET,
    ...
    event_status: Union[Unset, list[EventAnalyticsGetCountJsonEventStatusItem]] = UNSET,
    ...
    ou_mode: Union[Unset, EventAnalyticsGetCountJsonOuMode] = EventAnalyticsGetCountJsonOuMode.DESCENDANTS,
    output_id_scheme: Union[Unset, EventAnalyticsGetCountJsonOutputIdScheme] = UNSET,
    output_type: Union[Unset, EventAnalyticsGetCountJsonOutputType] = EventAnalyticsGetCountJsonOutputType.EVENT,
    page: Union[Unset, int] = 1,
    page_size: Union[Unset, int] = 50,
    paging: Union[Unset, bool] = True,
    program_status: Union[Unset, list[EventAnalyticsGetCountJsonProgramStatusItem]] = UNSET,
    ...
    sort_order: Union[Unset, EventAnalyticsGetCountJsonSortOrder] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/analytics/events/count/{program}",
        "params": params,
    }
...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Optional[Rectangle]:
    if response.status_code == 200:
        response_200 = Rectangle.from_dict(response.json())
...
def _build_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Response[Rectangle]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        aggregation_type (Union[Unset, EventAnalyticsGetCountJsonAggregationType]):
        ...
        data_id_scheme (Union[Unset, EventAnalyticsGetCountJsonDataIdScheme]):
        default_coordinate_fallback (Union[Unset, bool]):  Default: False.
        desc (Union[Unset, list[str]]):
        dimension (Union[Unset, list[str]]):
        display_property (Union[Unset, EventAnalyticsGetCountJsonDisplayProperty]):
        end_date (Union[Unset, datetime.datetime]):
        endpoint_action (Union[Unset, EventAnalyticsGetCountJsonEndpointAction]):  Default:
            EventAnalyticsGetCountJsonEndpointAction.OTHER.
        endpoint_item (Union[Unset, EventAnalyticsGetCountJsonEndpointItem]):
        ...
        event_status (Union[Unset, list[EventAnalyticsGetCountJsonEventStatusItem]]):
        ...
        ou_mode (Union[Unset, EventAnalyticsGetCountJsonOuMode]):  Default:
            EventAnalyticsGetCountJsonOuMode.DESCENDANTS.
        output_id_scheme (Union[Unset, EventAnalyticsGetCountJsonOutputIdScheme]):
        output_type (Union[Unset, EventAnalyticsGetCountJsonOutputType]):  Default:
            EventAnalyticsGetCountJsonOutputType.EVENT.
        page (Union[Unset, int]):  Default: 1.
        page_size (Union[Unset, int]):  Default: 50.
        paging (Union[Unset, bool]):  Default: True.
        program_status (Union[Unset, list[EventAnalyticsGetCountJsonProgramStatusItem]]):
        ...
        sort_order (Union[Unset, EventAnalyticsGetCountJsonSortOrder]):
