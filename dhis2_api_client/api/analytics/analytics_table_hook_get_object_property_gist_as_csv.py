...
from ...models.analytics_table_hook_get_object_property_gist_as_csv_auto import (
    AnalyticsTableHookGetObjectPropertyGistAsCsvAuto,
)
from ...models.analytics_table_hook_get_object_property_gist_as_csv_property import (
    AnalyticsTableHookGetObjectPropertyGistAsCsvProperty,
)
from ...models.analytics_table_hook_get_object_property_gist_as_csv_root_junction import (
    AnalyticsTableHookGetObjectPropertyGistAsCsvRootJunction,
)
...
def _get_kwargs(
    uid: str,
    property_: AnalyticsTableHookGetObjectPropertyGistAsCsvProperty,
    *,
    absolute_urls: Union[Unset, bool] = False,
    auto: Union[Unset, AnalyticsTableHookGetObjectPropertyGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, AnalyticsTableHookGetObjectPropertyGistAsCsvRootJunction
    ] = AnalyticsTableHookGetObjectPropertyGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/analyticsTableHooks/{uid}/{property_}/gist.csv",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, AnalyticsTableHookGetObjectPropertyGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, AnalyticsTableHookGetObjectPropertyGistAsCsvRootJunction]):
            Default: AnalyticsTableHookGetObjectPropertyGistAsCsvRootJunction.AND.
