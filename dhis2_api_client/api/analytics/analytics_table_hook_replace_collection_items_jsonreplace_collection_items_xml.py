...
from ...models.analytics_table_hook_replace_collection_items_jsonreplace_collection_items_xml_property import (
    AnalyticsTableHookReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: AnalyticsTableHookReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
    *,
