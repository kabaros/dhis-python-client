...
from ...models.enrollment_analytics_get_aggregate_json_data_id_scheme import (
    EnrollmentAnalyticsGetAggregateJsonDataIdScheme,
)
from ...models.enrollment_analytics_get_aggregate_json_display_property import (
    EnrollmentAnalyticsGetAggregateJsonDisplayProperty,
)
from ...models.enrollment_analytics_get_aggregate_json_endpoint_action import (
    EnrollmentAnalyticsGetAggregateJsonEndpointAction,
)
from ...models.enrollment_analytics_get_aggregate_json_endpoint_item import (
    EnrollmentAnalyticsGetAggregateJsonEndpointItem,
)
from ...models.enrollment_analytics_get_aggregate_json_ou_mode import EnrollmentAnalyticsGetAggregateJsonOuMode
from ...models.enrollment_analytics_get_aggregate_json_output_id_scheme import (
    EnrollmentAnalyticsGetAggregateJsonOutputIdScheme,
)
from ...models.enrollment_analytics_get_aggregate_json_program_status_item import (
    EnrollmentAnalyticsGetAggregateJsonProgramStatusItem,
)
from ...models.enrollment_analytics_get_aggregate_json_sort_order import EnrollmentAnalyticsGetAggregateJsonSortOrder
...
def _get_kwargs(
    ...
    *,
    ...
    data_id_scheme: Union[Unset, EnrollmentAnalyticsGetAggregateJsonDataIdScheme] = UNSET,
    desc: Union[Unset, list[str]] = UNSET,
    dimension: Union[Unset, list[str]] = UNSET,
    display_property: Union[Unset, EnrollmentAnalyticsGetAggregateJsonDisplayProperty] = UNSET,
    end_date: Union[Unset, datetime.datetime] = UNSET,
    endpoint_action: Union[
        Unset, EnrollmentAnalyticsGetAggregateJsonEndpointAction
    ] = EnrollmentAnalyticsGetAggregateJsonEndpointAction.OTHER,
    endpoint_item: Union[Unset, EnrollmentAnalyticsGetAggregateJsonEndpointItem] = UNSET,
    ...
    ou_mode: Union[Unset, EnrollmentAnalyticsGetAggregateJsonOuMode] = UNSET,
    output_id_scheme: Union[Unset, EnrollmentAnalyticsGetAggregateJsonOutputIdScheme] = UNSET,
    page: Union[Unset, int] = 1,
    page_size: Union[Unset, int] = 50,
    paging: Union[Unset, bool] = True,
    program_status: Union[Unset, list[EnrollmentAnalyticsGetAggregateJsonProgramStatusItem]] = UNSET,
    ...
    sort_order: Union[Unset, EnrollmentAnalyticsGetAggregateJsonSortOrder] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/analytics/enrollments/aggregate/{program}",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        data_id_scheme (Union[Unset, EnrollmentAnalyticsGetAggregateJsonDataIdScheme]):
        desc (Union[Unset, list[str]]):
        dimension (Union[Unset, list[str]]):
        display_property (Union[Unset, EnrollmentAnalyticsGetAggregateJsonDisplayProperty]):
        end_date (Union[Unset, datetime.datetime]):
        endpoint_action (Union[Unset, EnrollmentAnalyticsGetAggregateJsonEndpointAction]):
            Default: EnrollmentAnalyticsGetAggregateJsonEndpointAction.OTHER.
        endpoint_item (Union[Unset, EnrollmentAnalyticsGetAggregateJsonEndpointItem]):
        ...
        ou_mode (Union[Unset, EnrollmentAnalyticsGetAggregateJsonOuMode]):
        output_id_scheme (Union[Unset, EnrollmentAnalyticsGetAggregateJsonOutputIdScheme]):
        page (Union[Unset, int]):  Default: 1.
        page_size (Union[Unset, int]):  Default: 50.
        paging (Union[Unset, bool]):  Default: True.
        program_status (Union[Unset, list[EnrollmentAnalyticsGetAggregateJsonProgramStatusItem]]):
        ...
        sort_order (Union[Unset, EnrollmentAnalyticsGetAggregateJsonSortOrder]):
