...
from ...models.expression_dimension_item_add_collection_items_jsonadd_collection_items_xml_property import (
    ExpressionDimensionItemAddCollectionItemsJsonaddCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: ExpressionDimensionItemAddCollectionItemsJsonaddCollectionItemsXmlProperty,
    *,
