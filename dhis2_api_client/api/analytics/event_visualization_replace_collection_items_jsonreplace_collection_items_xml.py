...
from ...models.event_visualization_replace_collection_items_jsonreplace_collection_items_xml_property import (
    EventVisualizationReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: EventVisualizationReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
    *,
