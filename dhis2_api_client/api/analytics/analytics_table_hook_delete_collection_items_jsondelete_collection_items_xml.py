...
from ...models.analytics_table_hook_delete_collection_items_jsondelete_collection_items_xml_property import (
    AnalyticsTableHookDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: AnalyticsTableHookDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
    *,
