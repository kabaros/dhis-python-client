...
from ...models.analytics_table_hook_delete_collection_item_property import (
    AnalyticsTableHookDeleteCollectionItemProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: AnalyticsTableHookDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/analyticsTableHooks/{uid}/{property_}/{item_id}",
    }
