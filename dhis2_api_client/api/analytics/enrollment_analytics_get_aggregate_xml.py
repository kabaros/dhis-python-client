...
from ...models.enrollment_analytics_get_aggregate_xml_data_id_scheme import (
    EnrollmentAnalyticsGetAggregateXmlDataIdScheme,
)
from ...models.enrollment_analytics_get_aggregate_xml_display_property import (
    EnrollmentAnalyticsGetAggregateXmlDisplayProperty,
)
from ...models.enrollment_analytics_get_aggregate_xml_endpoint_action import (
    EnrollmentAnalyticsGetAggregateXmlEndpointAction,
)
from ...models.enrollment_analytics_get_aggregate_xml_endpoint_item import (
    EnrollmentAnalyticsGetAggregateXmlEndpointItem,
)
from ...models.enrollment_analytics_get_aggregate_xml_ou_mode import EnrollmentAnalyticsGetAggregateXmlOuMode
from ...models.enrollment_analytics_get_aggregate_xml_output_id_scheme import (
    EnrollmentAnalyticsGetAggregateXmlOutputIdScheme,
)
from ...models.enrollment_analytics_get_aggregate_xml_program_status_item import (
    EnrollmentAnalyticsGetAggregateXmlProgramStatusItem,
)
from ...models.enrollment_analytics_get_aggregate_xml_sort_order import EnrollmentAnalyticsGetAggregateXmlSortOrder
...
def _get_kwargs(
    ...
    *,
    ...
    data_id_scheme: Union[Unset, EnrollmentAnalyticsGetAggregateXmlDataIdScheme] = UNSET,
    desc: Union[Unset, list[str]] = UNSET,
    dimension: Union[Unset, list[str]] = UNSET,
    display_property: Union[Unset, EnrollmentAnalyticsGetAggregateXmlDisplayProperty] = UNSET,
    end_date: Union[Unset, datetime.datetime] = UNSET,
    endpoint_action: Union[
        Unset, EnrollmentAnalyticsGetAggregateXmlEndpointAction
    ] = EnrollmentAnalyticsGetAggregateXmlEndpointAction.OTHER,
    endpoint_item: Union[Unset, EnrollmentAnalyticsGetAggregateXmlEndpointItem] = UNSET,
    ...
    ou_mode: Union[Unset, EnrollmentAnalyticsGetAggregateXmlOuMode] = UNSET,
    output_id_scheme: Union[Unset, EnrollmentAnalyticsGetAggregateXmlOutputIdScheme] = UNSET,
    page: Union[Unset, int] = 1,
    page_size: Union[Unset, int] = 50,
    paging: Union[Unset, bool] = True,
    program_status: Union[Unset, list[EnrollmentAnalyticsGetAggregateXmlProgramStatusItem]] = UNSET,
    ...
    sort_order: Union[Unset, EnrollmentAnalyticsGetAggregateXmlSortOrder] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/analytics/enrollments/aggregate/{program}.xml",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        data_id_scheme (Union[Unset, EnrollmentAnalyticsGetAggregateXmlDataIdScheme]):
        desc (Union[Unset, list[str]]):
        dimension (Union[Unset, list[str]]):
        display_property (Union[Unset, EnrollmentAnalyticsGetAggregateXmlDisplayProperty]):
        end_date (Union[Unset, datetime.datetime]):
        endpoint_action (Union[Unset, EnrollmentAnalyticsGetAggregateXmlEndpointAction]):
            Default: EnrollmentAnalyticsGetAggregateXmlEndpointAction.OTHER.
        endpoint_item (Union[Unset, EnrollmentAnalyticsGetAggregateXmlEndpointItem]):
        ...
        ou_mode (Union[Unset, EnrollmentAnalyticsGetAggregateXmlOuMode]):
        output_id_scheme (Union[Unset, EnrollmentAnalyticsGetAggregateXmlOutputIdScheme]):
        page (Union[Unset, int]):  Default: 1.
        page_size (Union[Unset, int]):  Default: 50.
        paging (Union[Unset, bool]):  Default: True.
        program_status (Union[Unset, list[EnrollmentAnalyticsGetAggregateXmlProgramStatusItem]]):
        ...
        sort_order (Union[Unset, EnrollmentAnalyticsGetAggregateXmlSortOrder]):
