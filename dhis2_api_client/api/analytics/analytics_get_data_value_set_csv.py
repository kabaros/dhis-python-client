...
from ...models.analytics_get_data_value_set_csv_aggregation_type import AnalyticsGetDataValueSetCsvAggregationType
from ...models.analytics_get_data_value_set_csv_display_property import AnalyticsGetDataValueSetCsvDisplayProperty
from ...models.analytics_get_data_value_set_csv_input_id_scheme import AnalyticsGetDataValueSetCsvInputIdScheme
from ...models.analytics_get_data_value_set_csv_order import AnalyticsGetDataValueSetCsvOrder
from ...models.analytics_get_data_value_set_csv_output_data_element_id_scheme import (
    AnalyticsGetDataValueSetCsvOutputDataElementIdScheme,
)
from ...models.analytics_get_data_value_set_csv_output_data_item_id_scheme import (
    AnalyticsGetDataValueSetCsvOutputDataItemIdScheme,
)
from ...models.analytics_get_data_value_set_csv_output_id_scheme import AnalyticsGetDataValueSetCsvOutputIdScheme
from ...models.analytics_get_data_value_set_csv_output_org_unit_id_scheme import (
    AnalyticsGetDataValueSetCsvOutputOrgUnitIdScheme,
)
from ...models.analytics_get_data_value_set_csv_user_org_unit_type import AnalyticsGetDataValueSetCsvUserOrgUnitType
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    aggregation_type: Union[Unset, AnalyticsGetDataValueSetCsvAggregationType] = UNSET,
    ...
    display_property: Union[Unset, AnalyticsGetDataValueSetCsvDisplayProperty] = UNSET,
    ...
    input_id_scheme: Union[Unset, AnalyticsGetDataValueSetCsvInputIdScheme] = UNSET,
    measure_criteria: Union[Unset, str] = UNSET,
    order: Union[Unset, AnalyticsGetDataValueSetCsvOrder] = UNSET,
    org_unit_field: Union[Unset, str] = UNSET,
    output_data_element_id_scheme: Union[Unset, AnalyticsGetDataValueSetCsvOutputDataElementIdScheme] = UNSET,
    output_data_item_id_scheme: Union[Unset, AnalyticsGetDataValueSetCsvOutputDataItemIdScheme] = UNSET,
    output_id_scheme: Union[Unset, AnalyticsGetDataValueSetCsvOutputIdScheme] = UNSET,
    output_org_unit_id_scheme: Union[Unset, AnalyticsGetDataValueSetCsvOutputOrgUnitIdScheme] = UNSET,
    ...
    user_org_unit_type: Union[Unset, AnalyticsGetDataValueSetCsvUserOrgUnitType] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/analytics/dataValueSet.csv",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        aggregation_type (Union[Unset, AnalyticsGetDataValueSetCsvAggregationType]):
        ...
        display_property (Union[Unset, AnalyticsGetDataValueSetCsvDisplayProperty]):
        ...
        input_id_scheme (Union[Unset, AnalyticsGetDataValueSetCsvInputIdScheme]):
        measure_criteria (Union[Unset, str]):
        order (Union[Unset, AnalyticsGetDataValueSetCsvOrder]):
        org_unit_field (Union[Unset, str]):
        output_data_element_id_scheme (Union[Unset,
            AnalyticsGetDataValueSetCsvOutputDataElementIdScheme]):
        output_data_item_id_scheme (Union[Unset,
            AnalyticsGetDataValueSetCsvOutputDataItemIdScheme]):
        output_id_scheme (Union[Unset, AnalyticsGetDataValueSetCsvOutputIdScheme]):
        ...
        user_org_unit_type (Union[Unset, AnalyticsGetDataValueSetCsvUserOrgUnitType]):
