...
from ...models.tei_analytics_query_xml_data_id_scheme import TeiAnalyticsQueryXmlDataIdScheme
from ...models.tei_analytics_query_xml_display_property import TeiAnalyticsQueryXmlDisplayProperty
from ...models.tei_analytics_query_xml_ou_mode import TeiAnalyticsQueryXmlOuMode
from ...models.tei_analytics_query_xml_output_data_element_id_scheme import (
    TeiAnalyticsQueryXmlOutputDataElementIdScheme,
)
from ...models.tei_analytics_query_xml_output_id_scheme import TeiAnalyticsQueryXmlOutputIdScheme
from ...models.tei_analytics_query_xml_output_org_unit_id_scheme import TeiAnalyticsQueryXmlOutputOrgUnitIdScheme
...
def _get_kwargs(
    ...
    *,
    ...
    data_id_scheme: Union[Unset, TeiAnalyticsQueryXmlDataIdScheme] = UNSET,
    desc: Union[Unset, list[str]] = UNSET,
    dimension: Union[Unset, list[str]] = UNSET,
    display_property: Union[Unset, TeiAnalyticsQueryXmlDisplayProperty] = UNSET,
    ...
    ou_mode: Union[Unset, TeiAnalyticsQueryXmlOuMode] = TeiAnalyticsQueryXmlOuMode.DESCENDANTS,
    output_data_element_id_scheme: Union[Unset, TeiAnalyticsQueryXmlOutputDataElementIdScheme] = UNSET,
    output_id_scheme: Union[Unset, TeiAnalyticsQueryXmlOutputIdScheme] = UNSET,
    output_org_unit_id_scheme: Union[Unset, TeiAnalyticsQueryXmlOutputOrgUnitIdScheme] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/analytics/trackedEntities/query/{tracked_entity_type}.xml",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        data_id_scheme (Union[Unset, TeiAnalyticsQueryXmlDataIdScheme]):
        desc (Union[Unset, list[str]]):
        dimension (Union[Unset, list[str]]):
        display_property (Union[Unset, TeiAnalyticsQueryXmlDisplayProperty]):
        ...
        ou_mode (Union[Unset, TeiAnalyticsQueryXmlOuMode]):  Default:
            TeiAnalyticsQueryXmlOuMode.DESCENDANTS.
        output_data_element_id_scheme (Union[Unset,
            TeiAnalyticsQueryXmlOutputDataElementIdScheme]):
        output_id_scheme (Union[Unset, TeiAnalyticsQueryXmlOutputIdScheme]):
        output_org_unit_id_scheme (Union[Unset, TeiAnalyticsQueryXmlOutputOrgUnitIdScheme]):
