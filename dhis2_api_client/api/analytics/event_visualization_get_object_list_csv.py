...
from ...models.event_visualization_get_object_list_csv_root_junction import (
    EventVisualizationGetObjectListCsvRootJunction,
)
...
def _get_kwargs(
    *,
    ...
    root_junction: Union[Unset, EventVisualizationGetObjectListCsvRootJunction] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/eventVisualizations/#getObjectListCsv",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, EventVisualizationGetObjectListCsvRootJunction]):
