...
from ...models.enrollment_analytics_get_aggregate_html_data_id_scheme import (
    EnrollmentAnalyticsGetAggregateHtmlDataIdScheme,
)
from ...models.enrollment_analytics_get_aggregate_html_display_property import (
    EnrollmentAnalyticsGetAggregateHtmlDisplayProperty,
)
from ...models.enrollment_analytics_get_aggregate_html_endpoint_action import (
    EnrollmentAnalyticsGetAggregateHtmlEndpointAction,
)
from ...models.enrollment_analytics_get_aggregate_html_endpoint_item import (
    EnrollmentAnalyticsGetAggregateHtmlEndpointItem,
)
from ...models.enrollment_analytics_get_aggregate_html_ou_mode import EnrollmentAnalyticsGetAggregateHtmlOuMode
from ...models.enrollment_analytics_get_aggregate_html_output_id_scheme import (
    EnrollmentAnalyticsGetAggregateHtmlOutputIdScheme,
)
from ...models.enrollment_analytics_get_aggregate_html_program_status_item import (
    EnrollmentAnalyticsGetAggregateHtmlProgramStatusItem,
)
from ...models.enrollment_analytics_get_aggregate_html_sort_order import EnrollmentAnalyticsGetAggregateHtmlSortOrder
...
def _get_kwargs(
    ...
    *,
    ...
    data_id_scheme: Union[Unset, EnrollmentAnalyticsGetAggregateHtmlDataIdScheme] = UNSET,
    desc: Union[Unset, list[str]] = UNSET,
    dimension: Union[Unset, list[str]] = UNSET,
    display_property: Union[Unset, EnrollmentAnalyticsGetAggregateHtmlDisplayProperty] = UNSET,
    end_date: Union[Unset, datetime.datetime] = UNSET,
    endpoint_action: Union[
        Unset, EnrollmentAnalyticsGetAggregateHtmlEndpointAction
    ] = EnrollmentAnalyticsGetAggregateHtmlEndpointAction.OTHER,
    endpoint_item: Union[Unset, EnrollmentAnalyticsGetAggregateHtmlEndpointItem] = UNSET,
    ...
    ou_mode: Union[Unset, EnrollmentAnalyticsGetAggregateHtmlOuMode] = UNSET,
    output_id_scheme: Union[Unset, EnrollmentAnalyticsGetAggregateHtmlOutputIdScheme] = UNSET,
    page: Union[Unset, int] = 1,
    page_size: Union[Unset, int] = 50,
    paging: Union[Unset, bool] = True,
    program_status: Union[Unset, list[EnrollmentAnalyticsGetAggregateHtmlProgramStatusItem]] = UNSET,
    ...
    sort_order: Union[Unset, EnrollmentAnalyticsGetAggregateHtmlSortOrder] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/analytics/enrollments/aggregate/{program}.html",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        data_id_scheme (Union[Unset, EnrollmentAnalyticsGetAggregateHtmlDataIdScheme]):
        desc (Union[Unset, list[str]]):
        dimension (Union[Unset, list[str]]):
        display_property (Union[Unset, EnrollmentAnalyticsGetAggregateHtmlDisplayProperty]):
        end_date (Union[Unset, datetime.datetime]):
        endpoint_action (Union[Unset, EnrollmentAnalyticsGetAggregateHtmlEndpointAction]):
            Default: EnrollmentAnalyticsGetAggregateHtmlEndpointAction.OTHER.
        endpoint_item (Union[Unset, EnrollmentAnalyticsGetAggregateHtmlEndpointItem]):
        ...
        ou_mode (Union[Unset, EnrollmentAnalyticsGetAggregateHtmlOuMode]):
        output_id_scheme (Union[Unset, EnrollmentAnalyticsGetAggregateHtmlOutputIdScheme]):
        page (Union[Unset, int]):  Default: 1.
        page_size (Union[Unset, int]):  Default: 50.
        paging (Union[Unset, bool]):  Default: True.
        program_status (Union[Unset, list[EnrollmentAnalyticsGetAggregateHtmlProgramStatusItem]]):
        ...
        sort_order (Union[Unset, EnrollmentAnalyticsGetAggregateHtmlSortOrder]):
