...
from ...models.event_visualization_delete_collection_items_jsondelete_collection_items_xml_property import (
    EventVisualizationDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: EventVisualizationDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
    *,
