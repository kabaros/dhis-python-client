...
from ...models.tei_analytics_query_html_css_data_id_scheme import TeiAnalyticsQueryHtmlCssDataIdScheme
from ...models.tei_analytics_query_html_css_display_property import TeiAnalyticsQueryHtmlCssDisplayProperty
from ...models.tei_analytics_query_html_css_ou_mode import TeiAnalyticsQueryHtmlCssOuMode
from ...models.tei_analytics_query_html_css_output_data_element_id_scheme import (
    TeiAnalyticsQueryHtmlCssOutputDataElementIdScheme,
)
from ...models.tei_analytics_query_html_css_output_id_scheme import TeiAnalyticsQueryHtmlCssOutputIdScheme
from ...models.tei_analytics_query_html_css_output_org_unit_id_scheme import (
    TeiAnalyticsQueryHtmlCssOutputOrgUnitIdScheme,
)
...
def _get_kwargs(
    ...
    *,
    ...
    data_id_scheme: Union[Unset, TeiAnalyticsQueryHtmlCssDataIdScheme] = UNSET,
    desc: Union[Unset, list[str]] = UNSET,
    dimension: Union[Unset, list[str]] = UNSET,
    display_property: Union[Unset, TeiAnalyticsQueryHtmlCssDisplayProperty] = UNSET,
    ...
    ou_mode: Union[Unset, TeiAnalyticsQueryHtmlCssOuMode] = TeiAnalyticsQueryHtmlCssOuMode.DESCENDANTS,
    output_data_element_id_scheme: Union[Unset, TeiAnalyticsQueryHtmlCssOutputDataElementIdScheme] = UNSET,
    output_id_scheme: Union[Unset, TeiAnalyticsQueryHtmlCssOutputIdScheme] = UNSET,
    output_org_unit_id_scheme: Union[Unset, TeiAnalyticsQueryHtmlCssOutputOrgUnitIdScheme] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/analytics/trackedEntities/query/{tracked_entity_type}.html+css",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        data_id_scheme (Union[Unset, TeiAnalyticsQueryHtmlCssDataIdScheme]):
        desc (Union[Unset, list[str]]):
        dimension (Union[Unset, list[str]]):
        display_property (Union[Unset, TeiAnalyticsQueryHtmlCssDisplayProperty]):
        ...
        ou_mode (Union[Unset, TeiAnalyticsQueryHtmlCssOuMode]):  Default:
            TeiAnalyticsQueryHtmlCssOuMode.DESCENDANTS.
        output_data_element_id_scheme (Union[Unset,
            TeiAnalyticsQueryHtmlCssOutputDataElementIdScheme]):
        output_id_scheme (Union[Unset, TeiAnalyticsQueryHtmlCssOutputIdScheme]):
        output_org_unit_id_scheme (Union[Unset, TeiAnalyticsQueryHtmlCssOutputOrgUnitIdScheme]):
