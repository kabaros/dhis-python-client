...
from ...models.event_visualization_add_collection_item_property import EventVisualizationAddCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: EventVisualizationAddCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
