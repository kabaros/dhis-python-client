...
from ...models.event_analytics_get_aggregate_html_css_aggregation_type import (
    EventAnalyticsGetAggregateHtmlCssAggregationType,
)
from ...models.event_analytics_get_aggregate_html_css_data_id_scheme import (
    EventAnalyticsGetAggregateHtmlCssDataIdScheme,
)
from ...models.event_analytics_get_aggregate_html_css_display_property import (
    EventAnalyticsGetAggregateHtmlCssDisplayProperty,
)
from ...models.event_analytics_get_aggregate_html_css_endpoint_action import (
    EventAnalyticsGetAggregateHtmlCssEndpointAction,
)
from ...models.event_analytics_get_aggregate_html_css_endpoint_item import EventAnalyticsGetAggregateHtmlCssEndpointItem
from ...models.event_analytics_get_aggregate_html_css_event_status_item import (
    EventAnalyticsGetAggregateHtmlCssEventStatusItem,
)
from ...models.event_analytics_get_aggregate_html_css_ou_mode import EventAnalyticsGetAggregateHtmlCssOuMode
from ...models.event_analytics_get_aggregate_html_css_output_id_scheme import (
    EventAnalyticsGetAggregateHtmlCssOutputIdScheme,
)
from ...models.event_analytics_get_aggregate_html_css_output_type import EventAnalyticsGetAggregateHtmlCssOutputType
from ...models.event_analytics_get_aggregate_html_css_program_status_item import (
    EventAnalyticsGetAggregateHtmlCssProgramStatusItem,
)
from ...models.event_analytics_get_aggregate_html_css_sort_order import EventAnalyticsGetAggregateHtmlCssSortOrder
...
def _get_kwargs(
    ...
    *,
    ...
    aggregation_type: Union[Unset, EventAnalyticsGetAggregateHtmlCssAggregationType] = UNSET,
    ...
    data_id_scheme: Union[Unset, EventAnalyticsGetAggregateHtmlCssDataIdScheme] = UNSET,
    default_coordinate_fallback: Union[Unset, bool] = False,
    desc: Union[Unset, list[str]] = UNSET,
    dimension: Union[Unset, list[str]] = UNSET,
    display_property: Union[Unset, EventAnalyticsGetAggregateHtmlCssDisplayProperty] = UNSET,
    end_date: Union[Unset, datetime.datetime] = UNSET,
    endpoint_action: Union[
        Unset, EventAnalyticsGetAggregateHtmlCssEndpointAction
    ] = EventAnalyticsGetAggregateHtmlCssEndpointAction.OTHER,
    endpoint_item: Union[Unset, EventAnalyticsGetAggregateHtmlCssEndpointItem] = UNSET,
    ...
    event_status: Union[Unset, list[EventAnalyticsGetAggregateHtmlCssEventStatusItem]] = UNSET,
    ...
    ou_mode: Union[
        Unset, EventAnalyticsGetAggregateHtmlCssOuMode
    ] = EventAnalyticsGetAggregateHtmlCssOuMode.DESCENDANTS,
    output_id_scheme: Union[Unset, EventAnalyticsGetAggregateHtmlCssOutputIdScheme] = UNSET,
    output_type: Union[
        Unset, EventAnalyticsGetAggregateHtmlCssOutputType
    ] = EventAnalyticsGetAggregateHtmlCssOutputType.EVENT,
    page: Union[Unset, int] = 1,
    page_size: Union[Unset, int] = 50,
    paging: Union[Unset, bool] = True,
    program_status: Union[Unset, list[EventAnalyticsGetAggregateHtmlCssProgramStatusItem]] = UNSET,
    ...
    sort_order: Union[Unset, EventAnalyticsGetAggregateHtmlCssSortOrder] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/analytics/events/aggregate/{program}.html+css",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        aggregation_type (Union[Unset, EventAnalyticsGetAggregateHtmlCssAggregationType]):
        ...
        data_id_scheme (Union[Unset, EventAnalyticsGetAggregateHtmlCssDataIdScheme]):
        default_coordinate_fallback (Union[Unset, bool]):  Default: False.
        desc (Union[Unset, list[str]]):
        dimension (Union[Unset, list[str]]):
        display_property (Union[Unset, EventAnalyticsGetAggregateHtmlCssDisplayProperty]):
        end_date (Union[Unset, datetime.datetime]):
        endpoint_action (Union[Unset, EventAnalyticsGetAggregateHtmlCssEndpointAction]):  Default:
            EventAnalyticsGetAggregateHtmlCssEndpointAction.OTHER.
        endpoint_item (Union[Unset, EventAnalyticsGetAggregateHtmlCssEndpointItem]):
        ...
        event_status (Union[Unset, list[EventAnalyticsGetAggregateHtmlCssEventStatusItem]]):
        ...
        ou_mode (Union[Unset, EventAnalyticsGetAggregateHtmlCssOuMode]):  Default:
            EventAnalyticsGetAggregateHtmlCssOuMode.DESCENDANTS.
        output_id_scheme (Union[Unset, EventAnalyticsGetAggregateHtmlCssOutputIdScheme]):
        output_type (Union[Unset, EventAnalyticsGetAggregateHtmlCssOutputType]):  Default:
            EventAnalyticsGetAggregateHtmlCssOutputType.EVENT.
        page (Union[Unset, int]):  Default: 1.
        page_size (Union[Unset, int]):  Default: 50.
        paging (Union[Unset, bool]):  Default: True.
        program_status (Union[Unset, list[EventAnalyticsGetAggregateHtmlCssProgramStatusItem]]):
        ...
        sort_order (Union[Unset, EventAnalyticsGetAggregateHtmlCssSortOrder]):
