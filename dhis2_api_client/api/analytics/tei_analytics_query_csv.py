...
from ...models.tei_analytics_query_csv_data_id_scheme import TeiAnalyticsQueryCsvDataIdScheme
from ...models.tei_analytics_query_csv_display_property import TeiAnalyticsQueryCsvDisplayProperty
from ...models.tei_analytics_query_csv_ou_mode import TeiAnalyticsQueryCsvOuMode
from ...models.tei_analytics_query_csv_output_data_element_id_scheme import (
    TeiAnalyticsQueryCsvOutputDataElementIdScheme,
)
from ...models.tei_analytics_query_csv_output_id_scheme import TeiAnalyticsQueryCsvOutputIdScheme
from ...models.tei_analytics_query_csv_output_org_unit_id_scheme import TeiAnalyticsQueryCsvOutputOrgUnitIdScheme
...
def _get_kwargs(
    ...
    *,
    ...
    data_id_scheme: Union[Unset, TeiAnalyticsQueryCsvDataIdScheme] = UNSET,
    desc: Union[Unset, list[str]] = UNSET,
    dimension: Union[Unset, list[str]] = UNSET,
    display_property: Union[Unset, TeiAnalyticsQueryCsvDisplayProperty] = UNSET,
    ...
    ou_mode: Union[Unset, TeiAnalyticsQueryCsvOuMode] = TeiAnalyticsQueryCsvOuMode.DESCENDANTS,
    output_data_element_id_scheme: Union[Unset, TeiAnalyticsQueryCsvOutputDataElementIdScheme] = UNSET,
    output_id_scheme: Union[Unset, TeiAnalyticsQueryCsvOutputIdScheme] = UNSET,
    output_org_unit_id_scheme: Union[Unset, TeiAnalyticsQueryCsvOutputOrgUnitIdScheme] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/analytics/trackedEntities/query/{tracked_entity_type}.csv",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        data_id_scheme (Union[Unset, TeiAnalyticsQueryCsvDataIdScheme]):
        desc (Union[Unset, list[str]]):
        dimension (Union[Unset, list[str]]):
        display_property (Union[Unset, TeiAnalyticsQueryCsvDisplayProperty]):
        ...
        ou_mode (Union[Unset, TeiAnalyticsQueryCsvOuMode]):  Default:
            TeiAnalyticsQueryCsvOuMode.DESCENDANTS.
        output_data_element_id_scheme (Union[Unset,
            TeiAnalyticsQueryCsvOutputDataElementIdScheme]):
        output_id_scheme (Union[Unset, TeiAnalyticsQueryCsvOutputIdScheme]):
        output_org_unit_id_scheme (Union[Unset, TeiAnalyticsQueryCsvOutputOrgUnitIdScheme]):
