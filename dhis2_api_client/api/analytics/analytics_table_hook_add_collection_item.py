...
from ...models.analytics_table_hook_add_collection_item_property import AnalyticsTableHookAddCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: AnalyticsTableHookAddCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
