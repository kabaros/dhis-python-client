...
from ...models.analytics_get_data_value_set_xml_aggregation_type import AnalyticsGetDataValueSetXmlAggregationType
from ...models.analytics_get_data_value_set_xml_display_property import AnalyticsGetDataValueSetXmlDisplayProperty
from ...models.analytics_get_data_value_set_xml_input_id_scheme import AnalyticsGetDataValueSetXmlInputIdScheme
from ...models.analytics_get_data_value_set_xml_order import AnalyticsGetDataValueSetXmlOrder
from ...models.analytics_get_data_value_set_xml_output_data_element_id_scheme import (
    AnalyticsGetDataValueSetXmlOutputDataElementIdScheme,
)
from ...models.analytics_get_data_value_set_xml_output_data_item_id_scheme import (
    AnalyticsGetDataValueSetXmlOutputDataItemIdScheme,
)
from ...models.analytics_get_data_value_set_xml_output_id_scheme import AnalyticsGetDataValueSetXmlOutputIdScheme
from ...models.analytics_get_data_value_set_xml_output_org_unit_id_scheme import (
    AnalyticsGetDataValueSetXmlOutputOrgUnitIdScheme,
)
from ...models.analytics_get_data_value_set_xml_user_org_unit_type import AnalyticsGetDataValueSetXmlUserOrgUnitType
...
def _get_kwargs(
    *,
    aggregation_type: Union[Unset, AnalyticsGetDataValueSetXmlAggregationType] = UNSET,
    ...
    display_property: Union[Unset, AnalyticsGetDataValueSetXmlDisplayProperty] = UNSET,
    ...
    input_id_scheme: Union[Unset, AnalyticsGetDataValueSetXmlInputIdScheme] = UNSET,
    measure_criteria: Union[Unset, str] = UNSET,
    order: Union[Unset, AnalyticsGetDataValueSetXmlOrder] = UNSET,
    org_unit_field: Union[Unset, str] = UNSET,
    output_data_element_id_scheme: Union[Unset, AnalyticsGetDataValueSetXmlOutputDataElementIdScheme] = UNSET,
    output_data_item_id_scheme: Union[Unset, AnalyticsGetDataValueSetXmlOutputDataItemIdScheme] = UNSET,
    output_id_scheme: Union[Unset, AnalyticsGetDataValueSetXmlOutputIdScheme] = UNSET,
    output_org_unit_id_scheme: Union[Unset, AnalyticsGetDataValueSetXmlOutputOrgUnitIdScheme] = UNSET,
    ...
    user_org_unit_type: Union[Unset, AnalyticsGetDataValueSetXmlUserOrgUnitType] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/analytics/dataValueSet.xml",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        aggregation_type (Union[Unset, AnalyticsGetDataValueSetXmlAggregationType]):
        ...
        display_property (Union[Unset, AnalyticsGetDataValueSetXmlDisplayProperty]):
        ...
        input_id_scheme (Union[Unset, AnalyticsGetDataValueSetXmlInputIdScheme]):
        measure_criteria (Union[Unset, str]):
        order (Union[Unset, AnalyticsGetDataValueSetXmlOrder]):
        org_unit_field (Union[Unset, str]):
        output_data_element_id_scheme (Union[Unset,
            AnalyticsGetDataValueSetXmlOutputDataElementIdScheme]):
        output_data_item_id_scheme (Union[Unset,
            AnalyticsGetDataValueSetXmlOutputDataItemIdScheme]):
        output_id_scheme (Union[Unset, AnalyticsGetDataValueSetXmlOutputIdScheme]):
        ...
        user_org_unit_type (Union[Unset, AnalyticsGetDataValueSetXmlUserOrgUnitType]):
