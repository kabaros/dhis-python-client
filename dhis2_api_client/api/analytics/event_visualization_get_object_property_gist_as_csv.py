...
from ...models.event_visualization_get_object_property_gist_as_csv_auto import (
    EventVisualizationGetObjectPropertyGistAsCsvAuto,
)
from ...models.event_visualization_get_object_property_gist_as_csv_property import (
    EventVisualizationGetObjectPropertyGistAsCsvProperty,
)
from ...models.event_visualization_get_object_property_gist_as_csv_root_junction import (
    EventVisualizationGetObjectPropertyGistAsCsvRootJunction,
)
...
def _get_kwargs(
    uid: str,
    property_: EventVisualizationGetObjectPropertyGistAsCsvProperty,
    *,
    absolute_urls: Union[Unset, bool] = False,
    auto: Union[Unset, EventVisualizationGetObjectPropertyGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, EventVisualizationGetObjectPropertyGistAsCsvRootJunction
    ] = EventVisualizationGetObjectPropertyGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/eventVisualizations/{uid}/{property_}/gist.csv",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, EventVisualizationGetObjectPropertyGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, EventVisualizationGetObjectPropertyGistAsCsvRootJunction]):
            Default: EventVisualizationGetObjectPropertyGistAsCsvRootJunction.AND.
