...
from ...models.event_analytics_get_query_xml_aggregation_type import EventAnalyticsGetQueryXmlAggregationType
from ...models.event_analytics_get_query_xml_data_id_scheme import EventAnalyticsGetQueryXmlDataIdScheme
from ...models.event_analytics_get_query_xml_display_property import EventAnalyticsGetQueryXmlDisplayProperty
from ...models.event_analytics_get_query_xml_endpoint_action import EventAnalyticsGetQueryXmlEndpointAction
from ...models.event_analytics_get_query_xml_endpoint_item import EventAnalyticsGetQueryXmlEndpointItem
from ...models.event_analytics_get_query_xml_event_status_item import EventAnalyticsGetQueryXmlEventStatusItem
from ...models.event_analytics_get_query_xml_ou_mode import EventAnalyticsGetQueryXmlOuMode
from ...models.event_analytics_get_query_xml_output_id_scheme import EventAnalyticsGetQueryXmlOutputIdScheme
from ...models.event_analytics_get_query_xml_output_type import EventAnalyticsGetQueryXmlOutputType
from ...models.event_analytics_get_query_xml_program_status_item import EventAnalyticsGetQueryXmlProgramStatusItem
from ...models.event_analytics_get_query_xml_sort_order import EventAnalyticsGetQueryXmlSortOrder
...
def _get_kwargs(
    ...
    *,
    ...
    aggregation_type: Union[Unset, EventAnalyticsGetQueryXmlAggregationType] = UNSET,
    ...
    data_id_scheme: Union[Unset, EventAnalyticsGetQueryXmlDataIdScheme] = UNSET,
    default_coordinate_fallback: Union[Unset, bool] = False,
    desc: Union[Unset, list[str]] = UNSET,
    dimension: Union[Unset, list[str]] = UNSET,
    display_property: Union[Unset, EventAnalyticsGetQueryXmlDisplayProperty] = UNSET,
    end_date: Union[Unset, datetime.datetime] = UNSET,
    endpoint_action: Union[
        Unset, EventAnalyticsGetQueryXmlEndpointAction
    ] = EventAnalyticsGetQueryXmlEndpointAction.OTHER,
    endpoint_item: Union[Unset, EventAnalyticsGetQueryXmlEndpointItem] = UNSET,
    ...
    event_status: Union[Unset, list[EventAnalyticsGetQueryXmlEventStatusItem]] = UNSET,
    ...
    ou_mode: Union[Unset, EventAnalyticsGetQueryXmlOuMode] = EventAnalyticsGetQueryXmlOuMode.DESCENDANTS,
    output_id_scheme: Union[Unset, EventAnalyticsGetQueryXmlOutputIdScheme] = UNSET,
    output_type: Union[Unset, EventAnalyticsGetQueryXmlOutputType] = EventAnalyticsGetQueryXmlOutputType.EVENT,
    page: Union[Unset, int] = 1,
    page_size: Union[Unset, int] = 50,
    paging: Union[Unset, bool] = True,
    program_status: Union[Unset, list[EventAnalyticsGetQueryXmlProgramStatusItem]] = UNSET,
    ...
    sort_order: Union[Unset, EventAnalyticsGetQueryXmlSortOrder] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/analytics/events/query/{program}.xml",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        aggregation_type (Union[Unset, EventAnalyticsGetQueryXmlAggregationType]):
        ...
        data_id_scheme (Union[Unset, EventAnalyticsGetQueryXmlDataIdScheme]):
        default_coordinate_fallback (Union[Unset, bool]):  Default: False.
        desc (Union[Unset, list[str]]):
        dimension (Union[Unset, list[str]]):
        display_property (Union[Unset, EventAnalyticsGetQueryXmlDisplayProperty]):
        end_date (Union[Unset, datetime.datetime]):
        endpoint_action (Union[Unset, EventAnalyticsGetQueryXmlEndpointAction]):  Default:
            EventAnalyticsGetQueryXmlEndpointAction.OTHER.
        endpoint_item (Union[Unset, EventAnalyticsGetQueryXmlEndpointItem]):
        ...
        event_status (Union[Unset, list[EventAnalyticsGetQueryXmlEventStatusItem]]):
        ...
        ou_mode (Union[Unset, EventAnalyticsGetQueryXmlOuMode]):  Default:
            EventAnalyticsGetQueryXmlOuMode.DESCENDANTS.
        output_id_scheme (Union[Unset, EventAnalyticsGetQueryXmlOutputIdScheme]):
        output_type (Union[Unset, EventAnalyticsGetQueryXmlOutputType]):  Default:
            EventAnalyticsGetQueryXmlOutputType.EVENT.
        page (Union[Unset, int]):  Default: 1.
        page_size (Union[Unset, int]):  Default: 50.
        paging (Union[Unset, bool]):  Default: True.
        program_status (Union[Unset, list[EventAnalyticsGetQueryXmlProgramStatusItem]]):
        ...
        sort_order (Union[Unset, EventAnalyticsGetQueryXmlSortOrder]):
