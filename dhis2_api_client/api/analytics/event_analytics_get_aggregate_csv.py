...
from ...models.event_analytics_get_aggregate_csv_aggregation_type import EventAnalyticsGetAggregateCsvAggregationType
from ...models.event_analytics_get_aggregate_csv_data_id_scheme import EventAnalyticsGetAggregateCsvDataIdScheme
from ...models.event_analytics_get_aggregate_csv_display_property import EventAnalyticsGetAggregateCsvDisplayProperty
from ...models.event_analytics_get_aggregate_csv_endpoint_action import EventAnalyticsGetAggregateCsvEndpointAction
from ...models.event_analytics_get_aggregate_csv_endpoint_item import EventAnalyticsGetAggregateCsvEndpointItem
from ...models.event_analytics_get_aggregate_csv_event_status_item import EventAnalyticsGetAggregateCsvEventStatusItem
from ...models.event_analytics_get_aggregate_csv_ou_mode import EventAnalyticsGetAggregateCsvOuMode
from ...models.event_analytics_get_aggregate_csv_output_id_scheme import EventAnalyticsGetAggregateCsvOutputIdScheme
from ...models.event_analytics_get_aggregate_csv_output_type import EventAnalyticsGetAggregateCsvOutputType
from ...models.event_analytics_get_aggregate_csv_program_status_item import (
    EventAnalyticsGetAggregateCsvProgramStatusItem,
)
from ...models.event_analytics_get_aggregate_csv_sort_order import EventAnalyticsGetAggregateCsvSortOrder
...
def _get_kwargs(
    ...
    *,
    ...
    aggregation_type: Union[Unset, EventAnalyticsGetAggregateCsvAggregationType] = UNSET,
    ...
    data_id_scheme: Union[Unset, EventAnalyticsGetAggregateCsvDataIdScheme] = UNSET,
    default_coordinate_fallback: Union[Unset, bool] = False,
    desc: Union[Unset, list[str]] = UNSET,
    dimension: Union[Unset, list[str]] = UNSET,
    display_property: Union[Unset, EventAnalyticsGetAggregateCsvDisplayProperty] = UNSET,
    end_date: Union[Unset, datetime.datetime] = UNSET,
    endpoint_action: Union[
        Unset, EventAnalyticsGetAggregateCsvEndpointAction
    ] = EventAnalyticsGetAggregateCsvEndpointAction.OTHER,
    endpoint_item: Union[Unset, EventAnalyticsGetAggregateCsvEndpointItem] = UNSET,
    ...
    event_status: Union[Unset, list[EventAnalyticsGetAggregateCsvEventStatusItem]] = UNSET,
    ...
    ou_mode: Union[Unset, EventAnalyticsGetAggregateCsvOuMode] = EventAnalyticsGetAggregateCsvOuMode.DESCENDANTS,
    output_id_scheme: Union[Unset, EventAnalyticsGetAggregateCsvOutputIdScheme] = UNSET,
    output_type: Union[Unset, EventAnalyticsGetAggregateCsvOutputType] = EventAnalyticsGetAggregateCsvOutputType.EVENT,
    page: Union[Unset, int] = 1,
    page_size: Union[Unset, int] = 50,
    paging: Union[Unset, bool] = True,
    program_status: Union[Unset, list[EventAnalyticsGetAggregateCsvProgramStatusItem]] = UNSET,
    ...
    sort_order: Union[Unset, EventAnalyticsGetAggregateCsvSortOrder] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/analytics/events/aggregate/{program}.csv",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        aggregation_type (Union[Unset, EventAnalyticsGetAggregateCsvAggregationType]):
        ...
        data_id_scheme (Union[Unset, EventAnalyticsGetAggregateCsvDataIdScheme]):
        default_coordinate_fallback (Union[Unset, bool]):  Default: False.
        desc (Union[Unset, list[str]]):
        dimension (Union[Unset, list[str]]):
        display_property (Union[Unset, EventAnalyticsGetAggregateCsvDisplayProperty]):
        end_date (Union[Unset, datetime.datetime]):
        endpoint_action (Union[Unset, EventAnalyticsGetAggregateCsvEndpointAction]):  Default:
            EventAnalyticsGetAggregateCsvEndpointAction.OTHER.
        endpoint_item (Union[Unset, EventAnalyticsGetAggregateCsvEndpointItem]):
        ...
        event_status (Union[Unset, list[EventAnalyticsGetAggregateCsvEventStatusItem]]):
        ...
        ou_mode (Union[Unset, EventAnalyticsGetAggregateCsvOuMode]):  Default:
            EventAnalyticsGetAggregateCsvOuMode.DESCENDANTS.
        output_id_scheme (Union[Unset, EventAnalyticsGetAggregateCsvOutputIdScheme]):
        output_type (Union[Unset, EventAnalyticsGetAggregateCsvOutputType]):  Default:
            EventAnalyticsGetAggregateCsvOutputType.EVENT.
        page (Union[Unset, int]):  Default: 1.
        page_size (Union[Unset, int]):  Default: 50.
        paging (Union[Unset, bool]):  Default: True.
        program_status (Union[Unset, list[EventAnalyticsGetAggregateCsvProgramStatusItem]]):
        ...
        sort_order (Union[Unset, EventAnalyticsGetAggregateCsvSortOrder]):
