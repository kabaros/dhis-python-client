...
from ...models.indicator_replace_collection_items_jsonreplace_collection_items_xml_property import (
    IndicatorReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: IndicatorReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
    *,
