...
from ...models.predictor_patch_object_atomic_mode import PredictorPatchObjectAtomicMode
from ...models.predictor_patch_object_flush_mode import PredictorPatchObjectFlushMode
from ...models.predictor_patch_object_identifier import PredictorPatchObjectIdentifier
from ...models.predictor_patch_object_import_mode import PredictorPatchObjectImportMode
from ...models.predictor_patch_object_import_report_mode import PredictorPatchObjectImportReportMode
from ...models.predictor_patch_object_import_strategy import PredictorPatchObjectImportStrategy
from ...models.predictor_patch_object_preheat_mode import PredictorPatchObjectPreheatMode
from ...models.predictor_patch_object_root_junction import PredictorPatchObjectRootJunction
from ...models.predictor_patch_object_user_override_mode import PredictorPatchObjectUserOverrideMode
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[Unset, PredictorPatchObjectAtomicMode] = PredictorPatchObjectAtomicMode.ALL,
    flush_mode: Union[Unset, PredictorPatchObjectFlushMode] = PredictorPatchObjectFlushMode.AUTO,
    identifier: Union[Unset, PredictorPatchObjectIdentifier] = PredictorPatchObjectIdentifier.UID,
    import_mode: Union[Unset, PredictorPatchObjectImportMode] = PredictorPatchObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, PredictorPatchObjectImportReportMode
    ] = PredictorPatchObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, PredictorPatchObjectImportStrategy
    ] = PredictorPatchObjectImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, PredictorPatchObjectPreheatMode] = PredictorPatchObjectPreheatMode.REFERENCE,
    root_junction: Union[Unset, PredictorPatchObjectRootJunction] = UNSET,
    skip_sharing: Union[Unset, bool] = False,
    skip_translation: Union[Unset, bool] = False,
    skip_validation: Union[Unset, bool] = False,
    user: Union[Unset, str] = UNSET,
    user_override_mode: Union[Unset, PredictorPatchObjectUserOverrideMode] = PredictorPatchObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, PredictorPatchObjectAtomicMode]):  Default:
            PredictorPatchObjectAtomicMode.ALL.
        flush_mode (Union[Unset, PredictorPatchObjectFlushMode]):  Default:
            PredictorPatchObjectFlushMode.AUTO.
        identifier (Union[Unset, PredictorPatchObjectIdentifier]):  Default:
            PredictorPatchObjectIdentifier.UID.
        import_mode (Union[Unset, PredictorPatchObjectImportMode]):  Default:
            PredictorPatchObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, PredictorPatchObjectImportReportMode]):  Default:
            PredictorPatchObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, PredictorPatchObjectImportStrategy]):  Default:
            PredictorPatchObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, PredictorPatchObjectPreheatMode]):  Default:
            PredictorPatchObjectPreheatMode.REFERENCE.
        root_junction (Union[Unset, PredictorPatchObjectRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, PredictorPatchObjectUserOverrideMode]):  Default:
            PredictorPatchObjectUserOverrideMode.NONE.
        body (JsonPatch):
