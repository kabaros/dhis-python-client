...
from ...models.organisation_unit_level_get_object_list_csv_root_junction import (
    OrganisationUnitLevelGetObjectListCsvRootJunction,
)
...
def _get_kwargs(
    *,
    ...
    root_junction: Union[Unset, OrganisationUnitLevelGetObjectListCsvRootJunction] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/organisationUnitLevels/#getObjectListCsv",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, OrganisationUnitLevelGetObjectListCsvRootJunction]):
