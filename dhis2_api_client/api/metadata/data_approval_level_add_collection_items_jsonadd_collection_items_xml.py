...
from ...models.data_approval_level_add_collection_items_jsonadd_collection_items_xml_property import (
    DataApprovalLevelAddCollectionItemsJsonaddCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: DataApprovalLevelAddCollectionItemsJsonaddCollectionItemsXmlProperty,
    *,
