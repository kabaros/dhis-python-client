...
from ...models.push_analysis_bulk_sharing_atomic_mode import PushAnalysisBulkSharingAtomicMode
from ...models.push_analysis_bulk_sharing_flush_mode import PushAnalysisBulkSharingFlushMode
from ...models.push_analysis_bulk_sharing_identifier import PushAnalysisBulkSharingIdentifier
from ...models.push_analysis_bulk_sharing_import_mode import PushAnalysisBulkSharingImportMode
from ...models.push_analysis_bulk_sharing_import_report_mode import PushAnalysisBulkSharingImportReportMode
from ...models.push_analysis_bulk_sharing_import_strategy import PushAnalysisBulkSharingImportStrategy
from ...models.push_analysis_bulk_sharing_preheat_mode import PushAnalysisBulkSharingPreheatMode
from ...models.push_analysis_bulk_sharing_root_junction import PushAnalysisBulkSharingRootJunction
from ...models.push_analysis_bulk_sharing_user_override_mode import PushAnalysisBulkSharingUserOverrideMode
...
def _get_kwargs(
    *,
    ...
    atomic_mode: Union[Unset, PushAnalysisBulkSharingAtomicMode] = PushAnalysisBulkSharingAtomicMode.ALL,
    flush_mode: Union[Unset, PushAnalysisBulkSharingFlushMode] = PushAnalysisBulkSharingFlushMode.AUTO,
    identifier: Union[Unset, PushAnalysisBulkSharingIdentifier] = PushAnalysisBulkSharingIdentifier.UID,
    import_mode: Union[Unset, PushAnalysisBulkSharingImportMode] = PushAnalysisBulkSharingImportMode.COMMIT,
    import_report_mode: Union[
        Unset, PushAnalysisBulkSharingImportReportMode
    ] = PushAnalysisBulkSharingImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, PushAnalysisBulkSharingImportStrategy
    ] = PushAnalysisBulkSharingImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, PushAnalysisBulkSharingPreheatMode] = PushAnalysisBulkSharingPreheatMode.REFERENCE,
    root_junction: Union[Unset, PushAnalysisBulkSharingRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, PushAnalysisBulkSharingUserOverrideMode
    ] = PushAnalysisBulkSharingUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, PushAnalysisBulkSharingAtomicMode]):  Default:
            PushAnalysisBulkSharingAtomicMode.ALL.
        flush_mode (Union[Unset, PushAnalysisBulkSharingFlushMode]):  Default:
            PushAnalysisBulkSharingFlushMode.AUTO.
        identifier (Union[Unset, PushAnalysisBulkSharingIdentifier]):  Default:
            PushAnalysisBulkSharingIdentifier.UID.
        import_mode (Union[Unset, PushAnalysisBulkSharingImportMode]):  Default:
            PushAnalysisBulkSharingImportMode.COMMIT.
        import_report_mode (Union[Unset, PushAnalysisBulkSharingImportReportMode]):  Default:
            PushAnalysisBulkSharingImportReportMode.ERRORS.
        import_strategy (Union[Unset, PushAnalysisBulkSharingImportStrategy]):  Default:
            PushAnalysisBulkSharingImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, PushAnalysisBulkSharingPreheatMode]):  Default:
            PushAnalysisBulkSharingPreheatMode.REFERENCE.
        root_junction (Union[Unset, PushAnalysisBulkSharingRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, PushAnalysisBulkSharingUserOverrideMode]):  Default:
            PushAnalysisBulkSharingUserOverrideMode.NONE.
        body (BulkJsonPatch):
