...
from ...models.indicator_type_bulk_sharing_atomic_mode import IndicatorTypeBulkSharingAtomicMode
from ...models.indicator_type_bulk_sharing_flush_mode import IndicatorTypeBulkSharingFlushMode
from ...models.indicator_type_bulk_sharing_identifier import IndicatorTypeBulkSharingIdentifier
from ...models.indicator_type_bulk_sharing_import_mode import IndicatorTypeBulkSharingImportMode
from ...models.indicator_type_bulk_sharing_import_report_mode import IndicatorTypeBulkSharingImportReportMode
from ...models.indicator_type_bulk_sharing_import_strategy import IndicatorTypeBulkSharingImportStrategy
from ...models.indicator_type_bulk_sharing_preheat_mode import IndicatorTypeBulkSharingPreheatMode
from ...models.indicator_type_bulk_sharing_root_junction import IndicatorTypeBulkSharingRootJunction
from ...models.indicator_type_bulk_sharing_user_override_mode import IndicatorTypeBulkSharingUserOverrideMode
...
def _get_kwargs(
    *,
    ...
    atomic_mode: Union[Unset, IndicatorTypeBulkSharingAtomicMode] = IndicatorTypeBulkSharingAtomicMode.ALL,
    flush_mode: Union[Unset, IndicatorTypeBulkSharingFlushMode] = IndicatorTypeBulkSharingFlushMode.AUTO,
    identifier: Union[Unset, IndicatorTypeBulkSharingIdentifier] = IndicatorTypeBulkSharingIdentifier.UID,
    import_mode: Union[Unset, IndicatorTypeBulkSharingImportMode] = IndicatorTypeBulkSharingImportMode.COMMIT,
    import_report_mode: Union[
        Unset, IndicatorTypeBulkSharingImportReportMode
    ] = IndicatorTypeBulkSharingImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, IndicatorTypeBulkSharingImportStrategy
    ] = IndicatorTypeBulkSharingImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, IndicatorTypeBulkSharingPreheatMode] = IndicatorTypeBulkSharingPreheatMode.REFERENCE,
    root_junction: Union[Unset, IndicatorTypeBulkSharingRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, IndicatorTypeBulkSharingUserOverrideMode
    ] = IndicatorTypeBulkSharingUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, IndicatorTypeBulkSharingAtomicMode]):  Default:
            IndicatorTypeBulkSharingAtomicMode.ALL.
        flush_mode (Union[Unset, IndicatorTypeBulkSharingFlushMode]):  Default:
            IndicatorTypeBulkSharingFlushMode.AUTO.
        identifier (Union[Unset, IndicatorTypeBulkSharingIdentifier]):  Default:
            IndicatorTypeBulkSharingIdentifier.UID.
        import_mode (Union[Unset, IndicatorTypeBulkSharingImportMode]):  Default:
            IndicatorTypeBulkSharingImportMode.COMMIT.
        import_report_mode (Union[Unset, IndicatorTypeBulkSharingImportReportMode]):  Default:
            IndicatorTypeBulkSharingImportReportMode.ERRORS.
        import_strategy (Union[Unset, IndicatorTypeBulkSharingImportStrategy]):  Default:
            IndicatorTypeBulkSharingImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, IndicatorTypeBulkSharingPreheatMode]):  Default:
            IndicatorTypeBulkSharingPreheatMode.REFERENCE.
        root_junction (Union[Unset, IndicatorTypeBulkSharingRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, IndicatorTypeBulkSharingUserOverrideMode]):  Default:
            IndicatorTypeBulkSharingUserOverrideMode.NONE.
        body (BulkJsonPatch):
