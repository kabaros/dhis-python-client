...
from ...models.identifiable_object_add_collection_items_jsonadd_collection_items_xml_property import (
    IdentifiableObjectAddCollectionItemsJsonaddCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: IdentifiableObjectAddCollectionItemsJsonaddCollectionItemsXmlProperty,
    *,
