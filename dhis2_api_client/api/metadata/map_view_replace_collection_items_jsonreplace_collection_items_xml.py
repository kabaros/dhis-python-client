...
from ...models.map_view_replace_collection_items_jsonreplace_collection_items_xml_property import (
    MapViewReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: MapViewReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
    *,
