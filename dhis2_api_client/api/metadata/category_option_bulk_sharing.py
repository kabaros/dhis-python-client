...
from ...models.category_option_bulk_sharing_atomic_mode import CategoryOptionBulkSharingAtomicMode
from ...models.category_option_bulk_sharing_flush_mode import CategoryOptionBulkSharingFlushMode
from ...models.category_option_bulk_sharing_identifier import CategoryOptionBulkSharingIdentifier
from ...models.category_option_bulk_sharing_import_mode import CategoryOptionBulkSharingImportMode
from ...models.category_option_bulk_sharing_import_report_mode import CategoryOptionBulkSharingImportReportMode
from ...models.category_option_bulk_sharing_import_strategy import CategoryOptionBulkSharingImportStrategy
from ...models.category_option_bulk_sharing_preheat_mode import CategoryOptionBulkSharingPreheatMode
from ...models.category_option_bulk_sharing_root_junction import CategoryOptionBulkSharingRootJunction
from ...models.category_option_bulk_sharing_user_override_mode import CategoryOptionBulkSharingUserOverrideMode
...
def _get_kwargs(
    *,
    ...
    atomic_mode: Union[Unset, CategoryOptionBulkSharingAtomicMode] = CategoryOptionBulkSharingAtomicMode.ALL,
    flush_mode: Union[Unset, CategoryOptionBulkSharingFlushMode] = CategoryOptionBulkSharingFlushMode.AUTO,
    identifier: Union[Unset, CategoryOptionBulkSharingIdentifier] = CategoryOptionBulkSharingIdentifier.UID,
    import_mode: Union[Unset, CategoryOptionBulkSharingImportMode] = CategoryOptionBulkSharingImportMode.COMMIT,
    import_report_mode: Union[
        Unset, CategoryOptionBulkSharingImportReportMode
    ] = CategoryOptionBulkSharingImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, CategoryOptionBulkSharingImportStrategy
    ] = CategoryOptionBulkSharingImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, CategoryOptionBulkSharingPreheatMode] = CategoryOptionBulkSharingPreheatMode.REFERENCE,
    root_junction: Union[Unset, CategoryOptionBulkSharingRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, CategoryOptionBulkSharingUserOverrideMode
    ] = CategoryOptionBulkSharingUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, CategoryOptionBulkSharingAtomicMode]):  Default:
            CategoryOptionBulkSharingAtomicMode.ALL.
        flush_mode (Union[Unset, CategoryOptionBulkSharingFlushMode]):  Default:
            CategoryOptionBulkSharingFlushMode.AUTO.
        identifier (Union[Unset, CategoryOptionBulkSharingIdentifier]):  Default:
            CategoryOptionBulkSharingIdentifier.UID.
        import_mode (Union[Unset, CategoryOptionBulkSharingImportMode]):  Default:
            CategoryOptionBulkSharingImportMode.COMMIT.
        import_report_mode (Union[Unset, CategoryOptionBulkSharingImportReportMode]):  Default:
            CategoryOptionBulkSharingImportReportMode.ERRORS.
        import_strategy (Union[Unset, CategoryOptionBulkSharingImportStrategy]):  Default:
            CategoryOptionBulkSharingImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, CategoryOptionBulkSharingPreheatMode]):  Default:
            CategoryOptionBulkSharingPreheatMode.REFERENCE.
        root_junction (Union[Unset, CategoryOptionBulkSharingRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, CategoryOptionBulkSharingUserOverrideMode]):  Default:
            CategoryOptionBulkSharingUserOverrideMode.NONE.
        body (BulkJsonPatch):
