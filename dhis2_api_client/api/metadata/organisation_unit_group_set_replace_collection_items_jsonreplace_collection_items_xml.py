...
from ...models.organisation_unit_group_set_replace_collection_items_jsonreplace_collection_items_xml_property import (
    OrganisationUnitGroupSetReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: OrganisationUnitGroupSetReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
    *,
