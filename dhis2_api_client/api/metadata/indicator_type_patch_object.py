...
from ...models.indicator_type_patch_object_atomic_mode import IndicatorTypePatchObjectAtomicMode
from ...models.indicator_type_patch_object_flush_mode import IndicatorTypePatchObjectFlushMode
from ...models.indicator_type_patch_object_identifier import IndicatorTypePatchObjectIdentifier
from ...models.indicator_type_patch_object_import_mode import IndicatorTypePatchObjectImportMode
from ...models.indicator_type_patch_object_import_report_mode import IndicatorTypePatchObjectImportReportMode
from ...models.indicator_type_patch_object_import_strategy import IndicatorTypePatchObjectImportStrategy
from ...models.indicator_type_patch_object_preheat_mode import IndicatorTypePatchObjectPreheatMode
from ...models.indicator_type_patch_object_root_junction import IndicatorTypePatchObjectRootJunction
from ...models.indicator_type_patch_object_user_override_mode import IndicatorTypePatchObjectUserOverrideMode
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[Unset, IndicatorTypePatchObjectAtomicMode] = IndicatorTypePatchObjectAtomicMode.ALL,
    flush_mode: Union[Unset, IndicatorTypePatchObjectFlushMode] = IndicatorTypePatchObjectFlushMode.AUTO,
    identifier: Union[Unset, IndicatorTypePatchObjectIdentifier] = IndicatorTypePatchObjectIdentifier.UID,
    import_mode: Union[Unset, IndicatorTypePatchObjectImportMode] = IndicatorTypePatchObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, IndicatorTypePatchObjectImportReportMode
    ] = IndicatorTypePatchObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, IndicatorTypePatchObjectImportStrategy
    ] = IndicatorTypePatchObjectImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, IndicatorTypePatchObjectPreheatMode] = IndicatorTypePatchObjectPreheatMode.REFERENCE,
    root_junction: Union[Unset, IndicatorTypePatchObjectRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, IndicatorTypePatchObjectUserOverrideMode
    ] = IndicatorTypePatchObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, IndicatorTypePatchObjectAtomicMode]):  Default:
            IndicatorTypePatchObjectAtomicMode.ALL.
        flush_mode (Union[Unset, IndicatorTypePatchObjectFlushMode]):  Default:
            IndicatorTypePatchObjectFlushMode.AUTO.
        identifier (Union[Unset, IndicatorTypePatchObjectIdentifier]):  Default:
            IndicatorTypePatchObjectIdentifier.UID.
        import_mode (Union[Unset, IndicatorTypePatchObjectImportMode]):  Default:
            IndicatorTypePatchObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, IndicatorTypePatchObjectImportReportMode]):  Default:
            IndicatorTypePatchObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, IndicatorTypePatchObjectImportStrategy]):  Default:
            IndicatorTypePatchObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, IndicatorTypePatchObjectPreheatMode]):  Default:
            IndicatorTypePatchObjectPreheatMode.REFERENCE.
        root_junction (Union[Unset, IndicatorTypePatchObjectRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, IndicatorTypePatchObjectUserOverrideMode]):  Default:
            IndicatorTypePatchObjectUserOverrideMode.NONE.
        body (JsonPatch):
