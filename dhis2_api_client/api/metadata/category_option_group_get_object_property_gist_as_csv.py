...
from ...models.category_option_group_get_object_property_gist_as_csv_auto import (
    CategoryOptionGroupGetObjectPropertyGistAsCsvAuto,
)
from ...models.category_option_group_get_object_property_gist_as_csv_property import (
    CategoryOptionGroupGetObjectPropertyGistAsCsvProperty,
)
from ...models.category_option_group_get_object_property_gist_as_csv_root_junction import (
    CategoryOptionGroupGetObjectPropertyGistAsCsvRootJunction,
)
...
def _get_kwargs(
    uid: str,
    property_: CategoryOptionGroupGetObjectPropertyGistAsCsvProperty,
    *,
    absolute_urls: Union[Unset, bool] = False,
    auto: Union[Unset, CategoryOptionGroupGetObjectPropertyGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, CategoryOptionGroupGetObjectPropertyGistAsCsvRootJunction
    ] = CategoryOptionGroupGetObjectPropertyGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/categoryOptionGroups/{uid}/{property_}/gist.csv",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, CategoryOptionGroupGetObjectPropertyGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, CategoryOptionGroupGetObjectPropertyGistAsCsvRootJunction]):
            Default: CategoryOptionGroupGetObjectPropertyGistAsCsvRootJunction.AND.
