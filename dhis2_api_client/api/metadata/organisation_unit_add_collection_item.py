...
from ...models.organisation_unit_add_collection_item_property import OrganisationUnitAddCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: OrganisationUnitAddCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
