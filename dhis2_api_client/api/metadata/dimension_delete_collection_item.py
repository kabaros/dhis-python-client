...
from ...models.dimension_delete_collection_item_property import DimensionDeleteCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: DimensionDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/dimensions/{uid}/{property_}/{item_id}",
    }
