...
from ...models.data_approval_level_add_collection_item_property import DataApprovalLevelAddCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: DataApprovalLevelAddCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
