...
from ...models.push_analysis_get_object_root_junction import PushAnalysisGetObjectRootJunction
...
def _get_kwargs(
    ...
    *,
    ...
    root_junction: Union[Unset, PushAnalysisGetObjectRootJunction] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
) -> Optional[Union[PushAnalysis, WebMessage]]:
    if response.status_code == 200:
        response_200 = PushAnalysis.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[PushAnalysis, WebMessage]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, PushAnalysisGetObjectRootJunction]):
