...
from ...models.indicator_group_set_bulk_sharing_atomic_mode import IndicatorGroupSetBulkSharingAtomicMode
from ...models.indicator_group_set_bulk_sharing_flush_mode import IndicatorGroupSetBulkSharingFlushMode
from ...models.indicator_group_set_bulk_sharing_identifier import IndicatorGroupSetBulkSharingIdentifier
from ...models.indicator_group_set_bulk_sharing_import_mode import IndicatorGroupSetBulkSharingImportMode
from ...models.indicator_group_set_bulk_sharing_import_report_mode import IndicatorGroupSetBulkSharingImportReportMode
from ...models.indicator_group_set_bulk_sharing_import_strategy import IndicatorGroupSetBulkSharingImportStrategy
from ...models.indicator_group_set_bulk_sharing_preheat_mode import IndicatorGroupSetBulkSharingPreheatMode
from ...models.indicator_group_set_bulk_sharing_root_junction import IndicatorGroupSetBulkSharingRootJunction
from ...models.indicator_group_set_bulk_sharing_user_override_mode import IndicatorGroupSetBulkSharingUserOverrideMode
...
def _get_kwargs(
    *,
    ...
    atomic_mode: Union[Unset, IndicatorGroupSetBulkSharingAtomicMode] = IndicatorGroupSetBulkSharingAtomicMode.ALL,
    flush_mode: Union[Unset, IndicatorGroupSetBulkSharingFlushMode] = IndicatorGroupSetBulkSharingFlushMode.AUTO,
    identifier: Union[Unset, IndicatorGroupSetBulkSharingIdentifier] = IndicatorGroupSetBulkSharingIdentifier.UID,
    import_mode: Union[Unset, IndicatorGroupSetBulkSharingImportMode] = IndicatorGroupSetBulkSharingImportMode.COMMIT,
    import_report_mode: Union[
        Unset, IndicatorGroupSetBulkSharingImportReportMode
    ] = IndicatorGroupSetBulkSharingImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, IndicatorGroupSetBulkSharingImportStrategy
    ] = IndicatorGroupSetBulkSharingImportStrategy.CREATE_AND_UPDATE,
    ...
    preheat_mode: Union[
        Unset, IndicatorGroupSetBulkSharingPreheatMode
    ] = IndicatorGroupSetBulkSharingPreheatMode.REFERENCE,
    root_junction: Union[Unset, IndicatorGroupSetBulkSharingRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, IndicatorGroupSetBulkSharingUserOverrideMode
    ] = IndicatorGroupSetBulkSharingUserOverrideMode.NONE,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/indicatorGroupSets/sharing",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, IndicatorGroupSetBulkSharingAtomicMode]):  Default:
            IndicatorGroupSetBulkSharingAtomicMode.ALL.
        flush_mode (Union[Unset, IndicatorGroupSetBulkSharingFlushMode]):  Default:
            IndicatorGroupSetBulkSharingFlushMode.AUTO.
        identifier (Union[Unset, IndicatorGroupSetBulkSharingIdentifier]):  Default:
            IndicatorGroupSetBulkSharingIdentifier.UID.
        import_mode (Union[Unset, IndicatorGroupSetBulkSharingImportMode]):  Default:
            IndicatorGroupSetBulkSharingImportMode.COMMIT.
        import_report_mode (Union[Unset, IndicatorGroupSetBulkSharingImportReportMode]):  Default:
            IndicatorGroupSetBulkSharingImportReportMode.ERRORS.
        import_strategy (Union[Unset, IndicatorGroupSetBulkSharingImportStrategy]):  Default:
            IndicatorGroupSetBulkSharingImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, IndicatorGroupSetBulkSharingPreheatMode]):  Default:
            IndicatorGroupSetBulkSharingPreheatMode.REFERENCE.
        root_junction (Union[Unset, IndicatorGroupSetBulkSharingRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, IndicatorGroupSetBulkSharingUserOverrideMode]):  Default:
            IndicatorGroupSetBulkSharingUserOverrideMode.NONE.
        body (BulkJsonPatch):
