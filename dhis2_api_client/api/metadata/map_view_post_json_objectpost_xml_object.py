...
from ...models.map_view_post_json_objectpost_xml_object_atomic_mode import MapViewPostJsonObjectpostXmlObjectAtomicMode
from ...models.map_view_post_json_objectpost_xml_object_flush_mode import MapViewPostJsonObjectpostXmlObjectFlushMode
from ...models.map_view_post_json_objectpost_xml_object_identifier import MapViewPostJsonObjectpostXmlObjectIdentifier
from ...models.map_view_post_json_objectpost_xml_object_import_mode import MapViewPostJsonObjectpostXmlObjectImportMode
from ...models.map_view_post_json_objectpost_xml_object_import_report_mode import (
    MapViewPostJsonObjectpostXmlObjectImportReportMode,
)
from ...models.map_view_post_json_objectpost_xml_object_import_strategy import (
    MapViewPostJsonObjectpostXmlObjectImportStrategy,
)
from ...models.map_view_post_json_objectpost_xml_object_preheat_mode import (
    MapViewPostJsonObjectpostXmlObjectPreheatMode,
)
from ...models.map_view_post_json_objectpost_xml_object_user_override_mode import (
    MapViewPostJsonObjectpostXmlObjectUserOverrideMode,
)
...
def _get_kwargs(
    *,
    ...
    atomic_mode: Union[
        Unset, MapViewPostJsonObjectpostXmlObjectAtomicMode
    ] = MapViewPostJsonObjectpostXmlObjectAtomicMode.ALL,
    flush_mode: Union[
        Unset, MapViewPostJsonObjectpostXmlObjectFlushMode
    ] = MapViewPostJsonObjectpostXmlObjectFlushMode.AUTO,
    identifier: Union[
        Unset, MapViewPostJsonObjectpostXmlObjectIdentifier
    ] = MapViewPostJsonObjectpostXmlObjectIdentifier.UID,
    import_mode: Union[
        Unset, MapViewPostJsonObjectpostXmlObjectImportMode
    ] = MapViewPostJsonObjectpostXmlObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, MapViewPostJsonObjectpostXmlObjectImportReportMode
    ] = MapViewPostJsonObjectpostXmlObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, MapViewPostJsonObjectpostXmlObjectImportStrategy
    ] = MapViewPostJsonObjectpostXmlObjectImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    preheat_mode: Union[
        Unset, MapViewPostJsonObjectpostXmlObjectPreheatMode
    ] = MapViewPostJsonObjectpostXmlObjectPreheatMode.REFERENCE,
    ...
    user_override_mode: Union[
        Unset, MapViewPostJsonObjectpostXmlObjectUserOverrideMode
    ] = MapViewPostJsonObjectpostXmlObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, MapViewPostJsonObjectpostXmlObjectAtomicMode]):  Default:
            MapViewPostJsonObjectpostXmlObjectAtomicMode.ALL.
        flush_mode (Union[Unset, MapViewPostJsonObjectpostXmlObjectFlushMode]):  Default:
            MapViewPostJsonObjectpostXmlObjectFlushMode.AUTO.
        identifier (Union[Unset, MapViewPostJsonObjectpostXmlObjectIdentifier]):  Default:
            MapViewPostJsonObjectpostXmlObjectIdentifier.UID.
        import_mode (Union[Unset, MapViewPostJsonObjectpostXmlObjectImportMode]):  Default:
            MapViewPostJsonObjectpostXmlObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, MapViewPostJsonObjectpostXmlObjectImportReportMode]):
            Default: MapViewPostJsonObjectpostXmlObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, MapViewPostJsonObjectpostXmlObjectImportStrategy]):
            Default: MapViewPostJsonObjectpostXmlObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, MapViewPostJsonObjectpostXmlObjectPreheatMode]):  Default:
            MapViewPostJsonObjectpostXmlObjectPreheatMode.REFERENCE.
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, MapViewPostJsonObjectpostXmlObjectUserOverrideMode]):
            Default: MapViewPostJsonObjectpostXmlObjectUserOverrideMode.NONE.
        body (MapView):
