...
from ...models.organisation_unit_get_object_root_junction import OrganisationUnitGetObjectRootJunction
...
def _get_kwargs(
    ...
    *,
    ...
    root_junction: Union[Unset, OrganisationUnitGetObjectRootJunction] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/organisationUnits/{uid}#getObject",
        "params": params,
    }
...
) -> Optional[Union[OrganisationUnit, WebMessage]]:
    if response.status_code == 200:
        response_200 = OrganisationUnit.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[OrganisationUnit, WebMessage]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, OrganisationUnitGetObjectRootJunction]):
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[OrganisationUnit, WebMessage]
    """
