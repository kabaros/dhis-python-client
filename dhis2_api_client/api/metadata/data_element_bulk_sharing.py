...
from ...models.data_element_bulk_sharing_atomic_mode import DataElementBulkSharingAtomicMode
from ...models.data_element_bulk_sharing_flush_mode import DataElementBulkSharingFlushMode
from ...models.data_element_bulk_sharing_identifier import DataElementBulkSharingIdentifier
from ...models.data_element_bulk_sharing_import_mode import DataElementBulkSharingImportMode
from ...models.data_element_bulk_sharing_import_report_mode import DataElementBulkSharingImportReportMode
from ...models.data_element_bulk_sharing_import_strategy import DataElementBulkSharingImportStrategy
from ...models.data_element_bulk_sharing_preheat_mode import DataElementBulkSharingPreheatMode
from ...models.data_element_bulk_sharing_root_junction import DataElementBulkSharingRootJunction
from ...models.data_element_bulk_sharing_user_override_mode import DataElementBulkSharingUserOverrideMode
...
def _get_kwargs(
    *,
    ...
    atomic_mode: Union[Unset, DataElementBulkSharingAtomicMode] = DataElementBulkSharingAtomicMode.ALL,
    flush_mode: Union[Unset, DataElementBulkSharingFlushMode] = DataElementBulkSharingFlushMode.AUTO,
    identifier: Union[Unset, DataElementBulkSharingIdentifier] = DataElementBulkSharingIdentifier.UID,
    import_mode: Union[Unset, DataElementBulkSharingImportMode] = DataElementBulkSharingImportMode.COMMIT,
    import_report_mode: Union[
        Unset, DataElementBulkSharingImportReportMode
    ] = DataElementBulkSharingImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, DataElementBulkSharingImportStrategy
    ] = DataElementBulkSharingImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, DataElementBulkSharingPreheatMode] = DataElementBulkSharingPreheatMode.REFERENCE,
    root_junction: Union[Unset, DataElementBulkSharingRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, DataElementBulkSharingUserOverrideMode
    ] = DataElementBulkSharingUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, DataElementBulkSharingAtomicMode]):  Default:
            DataElementBulkSharingAtomicMode.ALL.
        flush_mode (Union[Unset, DataElementBulkSharingFlushMode]):  Default:
            DataElementBulkSharingFlushMode.AUTO.
        identifier (Union[Unset, DataElementBulkSharingIdentifier]):  Default:
            DataElementBulkSharingIdentifier.UID.
        import_mode (Union[Unset, DataElementBulkSharingImportMode]):  Default:
            DataElementBulkSharingImportMode.COMMIT.
        import_report_mode (Union[Unset, DataElementBulkSharingImportReportMode]):  Default:
            DataElementBulkSharingImportReportMode.ERRORS.
        import_strategy (Union[Unset, DataElementBulkSharingImportStrategy]):  Default:
            DataElementBulkSharingImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, DataElementBulkSharingPreheatMode]):  Default:
            DataElementBulkSharingPreheatMode.REFERENCE.
        root_junction (Union[Unset, DataElementBulkSharingRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, DataElementBulkSharingUserOverrideMode]):  Default:
            DataElementBulkSharingUserOverrideMode.NONE.
        body (BulkJsonPatch):
