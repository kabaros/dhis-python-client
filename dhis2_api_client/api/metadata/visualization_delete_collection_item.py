...
from ...models.visualization_delete_collection_item_property import VisualizationDeleteCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: VisualizationDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/visualizations/{uid}/{property_}/{item_id}",
    }
