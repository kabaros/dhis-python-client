...
from ...models.option_get_object_property_gist_as_csv_auto import OptionGetObjectPropertyGistAsCsvAuto
from ...models.option_get_object_property_gist_as_csv_property import OptionGetObjectPropertyGistAsCsvProperty
from ...models.option_get_object_property_gist_as_csv_root_junction import OptionGetObjectPropertyGistAsCsvRootJunction
...
def _get_kwargs(
    uid: str,
    property_: OptionGetObjectPropertyGistAsCsvProperty,
    *,
    absolute_urls: Union[Unset, bool] = False,
    auto: Union[Unset, OptionGetObjectPropertyGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, OptionGetObjectPropertyGistAsCsvRootJunction
    ] = OptionGetObjectPropertyGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/options/{uid}/{property_}/gist.csv",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, OptionGetObjectPropertyGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, OptionGetObjectPropertyGistAsCsvRootJunction]):  Default:
            OptionGetObjectPropertyGistAsCsvRootJunction.AND.
