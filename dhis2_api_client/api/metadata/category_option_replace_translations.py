...
from ...models.category_option_replace_translations_body import CategoryOptionReplaceTranslationsBody
...
def _get_kwargs(
    uid: str,
    *,
    body: CategoryOptionReplaceTranslationsBody,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": f"/categoryOptions/{uid}/translations",
    }
