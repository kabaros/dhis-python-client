...
from ...models.indicator_group_set_add_collection_item_property import IndicatorGroupSetAddCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: IndicatorGroupSetAddCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
