...
from ...models.constant_get_object_list_response_200 import ConstantGetObjectListResponse200
from ...models.constant_get_object_list_root_junction import ConstantGetObjectListRootJunction
...
def _get_kwargs(
    *,
    ...
    root_junction: Union[Unset, ConstantGetObjectListRootJunction] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
) -> Optional[Union[ConstantGetObjectListResponse200, WebMessage]]:
    if response.status_code == 200:
        response_200 = ConstantGetObjectListResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ConstantGetObjectListResponse200, WebMessage]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, ConstantGetObjectListRootJunction]):
...
def sync(
    *,
    ...
    Returns:
        Union[ConstantGetObjectListResponse200, WebMessage]
    """
