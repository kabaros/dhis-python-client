...
from ...models.organisation_unit_delete_collection_item_property import OrganisationUnitDeleteCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: OrganisationUnitDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/organisationUnits/{uid}/{property_}/{item_id}",
    }
