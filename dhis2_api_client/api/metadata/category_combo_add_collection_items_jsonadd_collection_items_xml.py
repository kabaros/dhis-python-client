...
from ...models.category_combo_add_collection_items_jsonadd_collection_items_xml_property import (
    CategoryComboAddCollectionItemsJsonaddCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: CategoryComboAddCollectionItemsJsonaddCollectionItemsXmlProperty,
    *,
