...
from ...models.external_map_layer_add_collection_items_jsonadd_collection_items_xml_property import (
    ExternalMapLayerAddCollectionItemsJsonaddCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: ExternalMapLayerAddCollectionItemsJsonaddCollectionItemsXmlProperty,
    *,
