...
from ...models.indicator_group_set_delete_collection_item_property import IndicatorGroupSetDeleteCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: IndicatorGroupSetDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/indicatorGroupSets/{uid}/{property_}/{item_id}",
    }
