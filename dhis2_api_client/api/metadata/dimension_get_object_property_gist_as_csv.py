...
from ...models.dimension_get_object_property_gist_as_csv_auto import DimensionGetObjectPropertyGistAsCsvAuto
from ...models.dimension_get_object_property_gist_as_csv_property import DimensionGetObjectPropertyGistAsCsvProperty
from ...models.dimension_get_object_property_gist_as_csv_root_junction import (
    DimensionGetObjectPropertyGistAsCsvRootJunction,
)
...
def _get_kwargs(
    uid: str,
    property_: DimensionGetObjectPropertyGistAsCsvProperty,
    *,
    absolute_urls: Union[Unset, bool] = False,
    auto: Union[Unset, DimensionGetObjectPropertyGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, DimensionGetObjectPropertyGistAsCsvRootJunction
    ] = DimensionGetObjectPropertyGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/dimensions/{uid}/{property_}/gist.csv",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, DimensionGetObjectPropertyGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, DimensionGetObjectPropertyGistAsCsvRootJunction]):  Default:
            DimensionGetObjectPropertyGistAsCsvRootJunction.AND.
