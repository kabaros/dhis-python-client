...
from ...models.external_map_layer_patch_object_atomic_mode import ExternalMapLayerPatchObjectAtomicMode
from ...models.external_map_layer_patch_object_flush_mode import ExternalMapLayerPatchObjectFlushMode
from ...models.external_map_layer_patch_object_identifier import ExternalMapLayerPatchObjectIdentifier
from ...models.external_map_layer_patch_object_import_mode import ExternalMapLayerPatchObjectImportMode
from ...models.external_map_layer_patch_object_import_report_mode import ExternalMapLayerPatchObjectImportReportMode
from ...models.external_map_layer_patch_object_import_strategy import ExternalMapLayerPatchObjectImportStrategy
from ...models.external_map_layer_patch_object_preheat_mode import ExternalMapLayerPatchObjectPreheatMode
from ...models.external_map_layer_patch_object_root_junction import ExternalMapLayerPatchObjectRootJunction
from ...models.external_map_layer_patch_object_user_override_mode import ExternalMapLayerPatchObjectUserOverrideMode
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[Unset, ExternalMapLayerPatchObjectAtomicMode] = ExternalMapLayerPatchObjectAtomicMode.ALL,
    flush_mode: Union[Unset, ExternalMapLayerPatchObjectFlushMode] = ExternalMapLayerPatchObjectFlushMode.AUTO,
    identifier: Union[Unset, ExternalMapLayerPatchObjectIdentifier] = ExternalMapLayerPatchObjectIdentifier.UID,
    import_mode: Union[Unset, ExternalMapLayerPatchObjectImportMode] = ExternalMapLayerPatchObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, ExternalMapLayerPatchObjectImportReportMode
    ] = ExternalMapLayerPatchObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, ExternalMapLayerPatchObjectImportStrategy
    ] = ExternalMapLayerPatchObjectImportStrategy.CREATE_AND_UPDATE,
    ...
    preheat_mode: Union[
        Unset, ExternalMapLayerPatchObjectPreheatMode
    ] = ExternalMapLayerPatchObjectPreheatMode.REFERENCE,
    root_junction: Union[Unset, ExternalMapLayerPatchObjectRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, ExternalMapLayerPatchObjectUserOverrideMode
    ] = ExternalMapLayerPatchObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, ExternalMapLayerPatchObjectAtomicMode]):  Default:
            ExternalMapLayerPatchObjectAtomicMode.ALL.
        flush_mode (Union[Unset, ExternalMapLayerPatchObjectFlushMode]):  Default:
            ExternalMapLayerPatchObjectFlushMode.AUTO.
        identifier (Union[Unset, ExternalMapLayerPatchObjectIdentifier]):  Default:
            ExternalMapLayerPatchObjectIdentifier.UID.
        import_mode (Union[Unset, ExternalMapLayerPatchObjectImportMode]):  Default:
            ExternalMapLayerPatchObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, ExternalMapLayerPatchObjectImportReportMode]):  Default:
            ExternalMapLayerPatchObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, ExternalMapLayerPatchObjectImportStrategy]):  Default:
            ExternalMapLayerPatchObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, ExternalMapLayerPatchObjectPreheatMode]):  Default:
            ExternalMapLayerPatchObjectPreheatMode.REFERENCE.
        root_junction (Union[Unset, ExternalMapLayerPatchObjectRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, ExternalMapLayerPatchObjectUserOverrideMode]):  Default:
            ExternalMapLayerPatchObjectUserOverrideMode.NONE.
        body (JsonPatch):
