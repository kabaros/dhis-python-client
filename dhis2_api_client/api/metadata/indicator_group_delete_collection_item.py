...
from ...models.indicator_group_delete_collection_item_property import IndicatorGroupDeleteCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: IndicatorGroupDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/indicatorGroups/{uid}/{property_}/{item_id}",
    }
