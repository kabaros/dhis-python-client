...
from ...models.organisation_unit_get_object_gistget_object_gist_as_csv_auto import (
    OrganisationUnitGetObjectGistgetObjectGistAsCsvAuto,
)
from ...models.organisation_unit_get_object_gistget_object_gist_as_csv_response_200 import (
    OrganisationUnitGetObjectGistgetObjectGistAsCsvResponse200,
)
from ...models.organisation_unit_get_object_gistget_object_gist_as_csv_root_junction import (
    OrganisationUnitGetObjectGistgetObjectGistAsCsvRootJunction,
)
...
def _get_kwargs(
    ...
    *,
    ...
    auto: Union[Unset, OrganisationUnitGetObjectGistgetObjectGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, OrganisationUnitGetObjectGistgetObjectGistAsCsvRootJunction
    ] = OrganisationUnitGetObjectGistgetObjectGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/organisationUnits/{uid}/gist",
        "params": params,
    }
...
) -> Optional[Union[OrganisationUnitGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]]:
    if response.status_code == 200:
        response_200 = OrganisationUnitGetObjectGistgetObjectGistAsCsvResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[OrganisationUnitGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, OrganisationUnitGetObjectGistgetObjectGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, OrganisationUnitGetObjectGistgetObjectGistAsCsvRootJunction]):
            Default: OrganisationUnitGetObjectGistgetObjectGistAsCsvRootJunction.AND.
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[OrganisationUnitGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]
    """
