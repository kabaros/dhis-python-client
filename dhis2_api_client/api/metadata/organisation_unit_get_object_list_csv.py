...
from ...models.organisation_unit_get_object_list_csv_root_junction import OrganisationUnitGetObjectListCsvRootJunction
...
def _get_kwargs(
    *,
    ...
    root_junction: Union[Unset, OrganisationUnitGetObjectListCsvRootJunction] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/organisationUnits/#getObjectListCsv",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, OrganisationUnitGetObjectListCsvRootJunction]):
