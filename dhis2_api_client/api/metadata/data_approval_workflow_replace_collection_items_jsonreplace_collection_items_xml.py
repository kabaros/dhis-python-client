...
from ...models.data_approval_workflow_replace_collection_items_jsonreplace_collection_items_xml_property import (
    DataApprovalWorkflowReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: DataApprovalWorkflowReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
    *,
