...
from ...models.map_put_json_objectput_xml_object_atomic_mode import MapPutJsonObjectputXmlObjectAtomicMode
from ...models.map_put_json_objectput_xml_object_flush_mode import MapPutJsonObjectputXmlObjectFlushMode
from ...models.map_put_json_objectput_xml_object_identifier import MapPutJsonObjectputXmlObjectIdentifier
from ...models.map_put_json_objectput_xml_object_import_mode import MapPutJsonObjectputXmlObjectImportMode
from ...models.map_put_json_objectput_xml_object_import_report_mode import MapPutJsonObjectputXmlObjectImportReportMode
from ...models.map_put_json_objectput_xml_object_import_strategy import MapPutJsonObjectputXmlObjectImportStrategy
from ...models.map_put_json_objectput_xml_object_preheat_mode import MapPutJsonObjectputXmlObjectPreheatMode
from ...models.map_put_json_objectput_xml_object_user_override_mode import MapPutJsonObjectputXmlObjectUserOverrideMode
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[Unset, MapPutJsonObjectputXmlObjectAtomicMode] = MapPutJsonObjectputXmlObjectAtomicMode.ALL,
    flush_mode: Union[Unset, MapPutJsonObjectputXmlObjectFlushMode] = MapPutJsonObjectputXmlObjectFlushMode.AUTO,
    identifier: Union[Unset, MapPutJsonObjectputXmlObjectIdentifier] = MapPutJsonObjectputXmlObjectIdentifier.UID,
    import_mode: Union[Unset, MapPutJsonObjectputXmlObjectImportMode] = MapPutJsonObjectputXmlObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, MapPutJsonObjectputXmlObjectImportReportMode
    ] = MapPutJsonObjectputXmlObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, MapPutJsonObjectputXmlObjectImportStrategy
    ] = MapPutJsonObjectputXmlObjectImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    preheat_mode: Union[
        Unset, MapPutJsonObjectputXmlObjectPreheatMode
    ] = MapPutJsonObjectputXmlObjectPreheatMode.REFERENCE,
    ...
    user_override_mode: Union[
        Unset, MapPutJsonObjectputXmlObjectUserOverrideMode
    ] = MapPutJsonObjectputXmlObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = WebMessage.from_dict(response.text)
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, MapPutJsonObjectputXmlObjectAtomicMode]):  Default:
            MapPutJsonObjectputXmlObjectAtomicMode.ALL.
        flush_mode (Union[Unset, MapPutJsonObjectputXmlObjectFlushMode]):  Default:
            MapPutJsonObjectputXmlObjectFlushMode.AUTO.
        identifier (Union[Unset, MapPutJsonObjectputXmlObjectIdentifier]):  Default:
            MapPutJsonObjectputXmlObjectIdentifier.UID.
        import_mode (Union[Unset, MapPutJsonObjectputXmlObjectImportMode]):  Default:
            MapPutJsonObjectputXmlObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, MapPutJsonObjectputXmlObjectImportReportMode]):  Default:
            MapPutJsonObjectputXmlObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, MapPutJsonObjectputXmlObjectImportStrategy]):  Default:
            MapPutJsonObjectputXmlObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, MapPutJsonObjectputXmlObjectPreheatMode]):  Default:
            MapPutJsonObjectputXmlObjectPreheatMode.REFERENCE.
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, MapPutJsonObjectputXmlObjectUserOverrideMode]):  Default:
            MapPutJsonObjectputXmlObjectUserOverrideMode.NONE.
        body (Map):
