...
from ...models.category_option_get_object_list_gist_as_csv_auto import CategoryOptionGetObjectListGistAsCsvAuto
from ...models.category_option_get_object_list_gist_as_csv_root_junction import (
    CategoryOptionGetObjectListGistAsCsvRootJunction,
)
...
def _get_kwargs(
    *,
    ...
    auto: Union[Unset, CategoryOptionGetObjectListGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, CategoryOptionGetObjectListGistAsCsvRootJunction
    ] = CategoryOptionGetObjectListGistAsCsvRootJunction.AND,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        auto (Union[Unset, CategoryOptionGetObjectListGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, CategoryOptionGetObjectListGistAsCsvRootJunction]):  Default:
            CategoryOptionGetObjectListGistAsCsvRootJunction.AND.
