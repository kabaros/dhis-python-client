...
from ...models.organisation_unit_replace_translations_body import OrganisationUnitReplaceTranslationsBody
...
def _get_kwargs(
    uid: str,
    *,
    body: OrganisationUnitReplaceTranslationsBody,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": f"/organisationUnits/{uid}/translations",
    }
