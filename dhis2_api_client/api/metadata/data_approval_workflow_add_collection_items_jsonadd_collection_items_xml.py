...
from ...models.data_approval_workflow_add_collection_items_jsonadd_collection_items_xml_property import (
    DataApprovalWorkflowAddCollectionItemsJsonaddCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: DataApprovalWorkflowAddCollectionItemsJsonaddCollectionItemsXmlProperty,
    *,
