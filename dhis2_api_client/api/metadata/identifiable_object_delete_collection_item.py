...
from ...models.identifiable_object_delete_collection_item_property import IdentifiableObjectDeleteCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: IdentifiableObjectDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/identifiableObjects/{uid}/{property_}/{item_id}",
    }
