...
from ...models.organisation_unit_group_add_collection_items_jsonadd_collection_items_xml_property import (
    OrganisationUnitGroupAddCollectionItemsJsonaddCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: OrganisationUnitGroupAddCollectionItemsJsonaddCollectionItemsXmlProperty,
    *,
