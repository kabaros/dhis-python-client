...
from ...models.indicator_get_object_list_response_200 import IndicatorGetObjectListResponse200
from ...models.indicator_get_object_list_root_junction import IndicatorGetObjectListRootJunction
...
def _get_kwargs(
    *,
    ...
    root_junction: Union[Unset, IndicatorGetObjectListRootJunction] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
) -> Optional[Union[IndicatorGetObjectListResponse200, WebMessage]]:
    if response.status_code == 200:
        response_200 = IndicatorGetObjectListResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[IndicatorGetObjectListResponse200, WebMessage]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, IndicatorGetObjectListRootJunction]):
...
def sync(
    *,
    ...
    Returns:
        Union[IndicatorGetObjectListResponse200, WebMessage]
    """
