...
from ...models.indicator_group_patch_object_atomic_mode import IndicatorGroupPatchObjectAtomicMode
from ...models.indicator_group_patch_object_flush_mode import IndicatorGroupPatchObjectFlushMode
from ...models.indicator_group_patch_object_identifier import IndicatorGroupPatchObjectIdentifier
from ...models.indicator_group_patch_object_import_mode import IndicatorGroupPatchObjectImportMode
from ...models.indicator_group_patch_object_import_report_mode import IndicatorGroupPatchObjectImportReportMode
from ...models.indicator_group_patch_object_import_strategy import IndicatorGroupPatchObjectImportStrategy
from ...models.indicator_group_patch_object_preheat_mode import IndicatorGroupPatchObjectPreheatMode
from ...models.indicator_group_patch_object_root_junction import IndicatorGroupPatchObjectRootJunction
from ...models.indicator_group_patch_object_user_override_mode import IndicatorGroupPatchObjectUserOverrideMode
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[Unset, IndicatorGroupPatchObjectAtomicMode] = IndicatorGroupPatchObjectAtomicMode.ALL,
    flush_mode: Union[Unset, IndicatorGroupPatchObjectFlushMode] = IndicatorGroupPatchObjectFlushMode.AUTO,
    identifier: Union[Unset, IndicatorGroupPatchObjectIdentifier] = IndicatorGroupPatchObjectIdentifier.UID,
    import_mode: Union[Unset, IndicatorGroupPatchObjectImportMode] = IndicatorGroupPatchObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, IndicatorGroupPatchObjectImportReportMode
    ] = IndicatorGroupPatchObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, IndicatorGroupPatchObjectImportStrategy
    ] = IndicatorGroupPatchObjectImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, IndicatorGroupPatchObjectPreheatMode] = IndicatorGroupPatchObjectPreheatMode.REFERENCE,
    root_junction: Union[Unset, IndicatorGroupPatchObjectRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, IndicatorGroupPatchObjectUserOverrideMode
    ] = IndicatorGroupPatchObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, IndicatorGroupPatchObjectAtomicMode]):  Default:
            IndicatorGroupPatchObjectAtomicMode.ALL.
        flush_mode (Union[Unset, IndicatorGroupPatchObjectFlushMode]):  Default:
            IndicatorGroupPatchObjectFlushMode.AUTO.
        identifier (Union[Unset, IndicatorGroupPatchObjectIdentifier]):  Default:
            IndicatorGroupPatchObjectIdentifier.UID.
        import_mode (Union[Unset, IndicatorGroupPatchObjectImportMode]):  Default:
            IndicatorGroupPatchObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, IndicatorGroupPatchObjectImportReportMode]):  Default:
            IndicatorGroupPatchObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, IndicatorGroupPatchObjectImportStrategy]):  Default:
            IndicatorGroupPatchObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, IndicatorGroupPatchObjectPreheatMode]):  Default:
            IndicatorGroupPatchObjectPreheatMode.REFERENCE.
        root_junction (Union[Unset, IndicatorGroupPatchObjectRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, IndicatorGroupPatchObjectUserOverrideMode]):  Default:
            IndicatorGroupPatchObjectUserOverrideMode.NONE.
        body (JsonPatch):
