...
from ...models.category_option_group_get_object_list_csv_root_junction import (
    CategoryOptionGroupGetObjectListCsvRootJunction,
)
...
def _get_kwargs(
    *,
    ...
    root_junction: Union[Unset, CategoryOptionGroupGetObjectListCsvRootJunction] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/categoryOptionGroups/#getObjectListCsv",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, CategoryOptionGroupGetObjectListCsvRootJunction]):
