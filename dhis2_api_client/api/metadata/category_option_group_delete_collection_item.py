...
from ...models.category_option_group_delete_collection_item_property import (
    CategoryOptionGroupDeleteCollectionItemProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: CategoryOptionGroupDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/categoryOptionGroups/{uid}/{property_}/{item_id}",
    }
