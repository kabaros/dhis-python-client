...
from ...models.category_option_add_collection_items_jsonadd_collection_items_xml_property import (
    CategoryOptionAddCollectionItemsJsonaddCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: CategoryOptionAddCollectionItemsJsonaddCollectionItemsXmlProperty,
    *,
