...
from ...models.organisation_unit_group_set_get_object_property_gist_as_csv_auto import (
    OrganisationUnitGroupSetGetObjectPropertyGistAsCsvAuto,
)
from ...models.organisation_unit_group_set_get_object_property_gist_as_csv_property import (
    OrganisationUnitGroupSetGetObjectPropertyGistAsCsvProperty,
)
from ...models.organisation_unit_group_set_get_object_property_gist_as_csv_root_junction import (
    OrganisationUnitGroupSetGetObjectPropertyGistAsCsvRootJunction,
)
...
def _get_kwargs(
    uid: str,
    property_: OrganisationUnitGroupSetGetObjectPropertyGistAsCsvProperty,
    *,
    absolute_urls: Union[Unset, bool] = False,
    auto: Union[Unset, OrganisationUnitGroupSetGetObjectPropertyGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, OrganisationUnitGroupSetGetObjectPropertyGistAsCsvRootJunction
    ] = OrganisationUnitGroupSetGetObjectPropertyGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/organisationUnitGroupSets/{uid}/{property_}/gist.csv",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, OrganisationUnitGroupSetGetObjectPropertyGistAsCsvAuto]):
        ...
        root_junction (Union[Unset,
            OrganisationUnitGroupSetGetObjectPropertyGistAsCsvRootJunction]):  Default:
            OrganisationUnitGroupSetGetObjectPropertyGistAsCsvRootJunction.AND.
