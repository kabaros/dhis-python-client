...
from ...models.category_option_combo_delete_collection_item_property import (
    CategoryOptionComboDeleteCollectionItemProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: CategoryOptionComboDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/categoryOptionCombos/{uid}/{property_}/{item_id}",
    }
