...
from ...models.identifiable_object_get_object_list_csv_root_junction import (
    IdentifiableObjectGetObjectListCsvRootJunction,
)
...
def _get_kwargs(
    *,
    ...
    root_junction: Union[Unset, IdentifiableObjectGetObjectListCsvRootJunction] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/identifiableObjects/#getObjectListCsv",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, IdentifiableObjectGetObjectListCsvRootJunction]):
