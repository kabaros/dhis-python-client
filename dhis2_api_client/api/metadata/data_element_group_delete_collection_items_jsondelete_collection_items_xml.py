...
from ...models.data_element_group_delete_collection_items_jsondelete_collection_items_xml_property import (
    DataElementGroupDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: DataElementGroupDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
    *,
