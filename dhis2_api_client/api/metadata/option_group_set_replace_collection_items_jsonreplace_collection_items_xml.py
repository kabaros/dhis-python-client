...
from ...models.option_group_set_replace_collection_items_jsonreplace_collection_items_xml_property import (
    OptionGroupSetReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: OptionGroupSetReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
    *,
