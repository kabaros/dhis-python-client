...
from ...models.data_entry_form_bulk_sharing_atomic_mode import DataEntryFormBulkSharingAtomicMode
from ...models.data_entry_form_bulk_sharing_flush_mode import DataEntryFormBulkSharingFlushMode
from ...models.data_entry_form_bulk_sharing_identifier import DataEntryFormBulkSharingIdentifier
from ...models.data_entry_form_bulk_sharing_import_mode import DataEntryFormBulkSharingImportMode
from ...models.data_entry_form_bulk_sharing_import_report_mode import DataEntryFormBulkSharingImportReportMode
from ...models.data_entry_form_bulk_sharing_import_strategy import DataEntryFormBulkSharingImportStrategy
from ...models.data_entry_form_bulk_sharing_preheat_mode import DataEntryFormBulkSharingPreheatMode
from ...models.data_entry_form_bulk_sharing_root_junction import DataEntryFormBulkSharingRootJunction
from ...models.data_entry_form_bulk_sharing_user_override_mode import DataEntryFormBulkSharingUserOverrideMode
...
def _get_kwargs(
    *,
    ...
    atomic_mode: Union[Unset, DataEntryFormBulkSharingAtomicMode] = DataEntryFormBulkSharingAtomicMode.ALL,
    flush_mode: Union[Unset, DataEntryFormBulkSharingFlushMode] = DataEntryFormBulkSharingFlushMode.AUTO,
    identifier: Union[Unset, DataEntryFormBulkSharingIdentifier] = DataEntryFormBulkSharingIdentifier.UID,
    import_mode: Union[Unset, DataEntryFormBulkSharingImportMode] = DataEntryFormBulkSharingImportMode.COMMIT,
    import_report_mode: Union[
        Unset, DataEntryFormBulkSharingImportReportMode
    ] = DataEntryFormBulkSharingImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, DataEntryFormBulkSharingImportStrategy
    ] = DataEntryFormBulkSharingImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, DataEntryFormBulkSharingPreheatMode] = DataEntryFormBulkSharingPreheatMode.REFERENCE,
    root_junction: Union[Unset, DataEntryFormBulkSharingRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, DataEntryFormBulkSharingUserOverrideMode
    ] = DataEntryFormBulkSharingUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, DataEntryFormBulkSharingAtomicMode]):  Default:
            DataEntryFormBulkSharingAtomicMode.ALL.
        flush_mode (Union[Unset, DataEntryFormBulkSharingFlushMode]):  Default:
            DataEntryFormBulkSharingFlushMode.AUTO.
        identifier (Union[Unset, DataEntryFormBulkSharingIdentifier]):  Default:
            DataEntryFormBulkSharingIdentifier.UID.
        import_mode (Union[Unset, DataEntryFormBulkSharingImportMode]):  Default:
            DataEntryFormBulkSharingImportMode.COMMIT.
        import_report_mode (Union[Unset, DataEntryFormBulkSharingImportReportMode]):  Default:
            DataEntryFormBulkSharingImportReportMode.ERRORS.
        import_strategy (Union[Unset, DataEntryFormBulkSharingImportStrategy]):  Default:
            DataEntryFormBulkSharingImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, DataEntryFormBulkSharingPreheatMode]):  Default:
            DataEntryFormBulkSharingPreheatMode.REFERENCE.
        root_junction (Union[Unset, DataEntryFormBulkSharingRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, DataEntryFormBulkSharingUserOverrideMode]):  Default:
            DataEntryFormBulkSharingUserOverrideMode.NONE.
        body (BulkJsonPatch):
