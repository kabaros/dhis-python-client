...
from ...models.attribute_get_object_list_response_200 import AttributeGetObjectListResponse200
from ...models.attribute_get_object_list_root_junction import AttributeGetObjectListRootJunction
...
def _get_kwargs(
    *,
    ...
    root_junction: Union[Unset, AttributeGetObjectListRootJunction] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
) -> Optional[Union[AttributeGetObjectListResponse200, WebMessage]]:
    if response.status_code == 200:
        response_200 = AttributeGetObjectListResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[AttributeGetObjectListResponse200, WebMessage]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, AttributeGetObjectListRootJunction]):
...
def sync(
    *,
    ...
    Returns:
        Union[AttributeGetObjectListResponse200, WebMessage]
    """
