...
from ...models.constant_delete_collection_items_jsondelete_collection_items_xml_property import (
    ConstantDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: ConstantDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
    *,
