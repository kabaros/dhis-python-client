...
from ...models.category_combo_get_object_root_junction import CategoryComboGetObjectRootJunction
...
def _get_kwargs(
    ...
    *,
    ...
    root_junction: Union[Unset, CategoryComboGetObjectRootJunction] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
) -> Optional[Union[CategoryCombo, WebMessage]]:
    if response.status_code == 200:
        response_200 = CategoryCombo.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[CategoryCombo, WebMessage]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, CategoryComboGetObjectRootJunction]):
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[CategoryCombo, WebMessage]
    """
