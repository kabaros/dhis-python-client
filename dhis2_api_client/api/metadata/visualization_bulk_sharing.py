...
from ...models.visualization_bulk_sharing_atomic_mode import VisualizationBulkSharingAtomicMode
from ...models.visualization_bulk_sharing_flush_mode import VisualizationBulkSharingFlushMode
from ...models.visualization_bulk_sharing_identifier import VisualizationBulkSharingIdentifier
from ...models.visualization_bulk_sharing_import_mode import VisualizationBulkSharingImportMode
from ...models.visualization_bulk_sharing_import_report_mode import VisualizationBulkSharingImportReportMode
from ...models.visualization_bulk_sharing_import_strategy import VisualizationBulkSharingImportStrategy
from ...models.visualization_bulk_sharing_preheat_mode import VisualizationBulkSharingPreheatMode
from ...models.visualization_bulk_sharing_root_junction import VisualizationBulkSharingRootJunction
from ...models.visualization_bulk_sharing_user_override_mode import VisualizationBulkSharingUserOverrideMode
...
def _get_kwargs(
    *,
    ...
    atomic_mode: Union[Unset, VisualizationBulkSharingAtomicMode] = VisualizationBulkSharingAtomicMode.ALL,
    flush_mode: Union[Unset, VisualizationBulkSharingFlushMode] = VisualizationBulkSharingFlushMode.AUTO,
    identifier: Union[Unset, VisualizationBulkSharingIdentifier] = VisualizationBulkSharingIdentifier.UID,
    import_mode: Union[Unset, VisualizationBulkSharingImportMode] = VisualizationBulkSharingImportMode.COMMIT,
    import_report_mode: Union[
        Unset, VisualizationBulkSharingImportReportMode
    ] = VisualizationBulkSharingImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, VisualizationBulkSharingImportStrategy
    ] = VisualizationBulkSharingImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, VisualizationBulkSharingPreheatMode] = VisualizationBulkSharingPreheatMode.REFERENCE,
    root_junction: Union[Unset, VisualizationBulkSharingRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, VisualizationBulkSharingUserOverrideMode
    ] = VisualizationBulkSharingUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, VisualizationBulkSharingAtomicMode]):  Default:
            VisualizationBulkSharingAtomicMode.ALL.
        flush_mode (Union[Unset, VisualizationBulkSharingFlushMode]):  Default:
            VisualizationBulkSharingFlushMode.AUTO.
        identifier (Union[Unset, VisualizationBulkSharingIdentifier]):  Default:
            VisualizationBulkSharingIdentifier.UID.
        import_mode (Union[Unset, VisualizationBulkSharingImportMode]):  Default:
            VisualizationBulkSharingImportMode.COMMIT.
        import_report_mode (Union[Unset, VisualizationBulkSharingImportReportMode]):  Default:
            VisualizationBulkSharingImportReportMode.ERRORS.
        import_strategy (Union[Unset, VisualizationBulkSharingImportStrategy]):  Default:
            VisualizationBulkSharingImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, VisualizationBulkSharingPreheatMode]):  Default:
            VisualizationBulkSharingPreheatMode.REFERENCE.
        root_junction (Union[Unset, VisualizationBulkSharingRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, VisualizationBulkSharingUserOverrideMode]):  Default:
            VisualizationBulkSharingUserOverrideMode.NONE.
        body (BulkJsonPatch):
