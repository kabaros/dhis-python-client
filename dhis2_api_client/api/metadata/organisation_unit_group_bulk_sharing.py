...
from ...models.organisation_unit_group_bulk_sharing_atomic_mode import OrganisationUnitGroupBulkSharingAtomicMode
from ...models.organisation_unit_group_bulk_sharing_flush_mode import OrganisationUnitGroupBulkSharingFlushMode
from ...models.organisation_unit_group_bulk_sharing_identifier import OrganisationUnitGroupBulkSharingIdentifier
from ...models.organisation_unit_group_bulk_sharing_import_mode import OrganisationUnitGroupBulkSharingImportMode
from ...models.organisation_unit_group_bulk_sharing_import_report_mode import (
    OrganisationUnitGroupBulkSharingImportReportMode,
)
from ...models.organisation_unit_group_bulk_sharing_import_strategy import (
    OrganisationUnitGroupBulkSharingImportStrategy,
)
from ...models.organisation_unit_group_bulk_sharing_preheat_mode import OrganisationUnitGroupBulkSharingPreheatMode
from ...models.organisation_unit_group_bulk_sharing_root_junction import OrganisationUnitGroupBulkSharingRootJunction
from ...models.organisation_unit_group_bulk_sharing_user_override_mode import (
    OrganisationUnitGroupBulkSharingUserOverrideMode,
)
...
def _get_kwargs(
    *,
    ...
    atomic_mode: Union[
        Unset, OrganisationUnitGroupBulkSharingAtomicMode
    ] = OrganisationUnitGroupBulkSharingAtomicMode.ALL,
    flush_mode: Union[
        Unset, OrganisationUnitGroupBulkSharingFlushMode
    ] = OrganisationUnitGroupBulkSharingFlushMode.AUTO,
    identifier: Union[
        Unset, OrganisationUnitGroupBulkSharingIdentifier
    ] = OrganisationUnitGroupBulkSharingIdentifier.UID,
    import_mode: Union[
        Unset, OrganisationUnitGroupBulkSharingImportMode
    ] = OrganisationUnitGroupBulkSharingImportMode.COMMIT,
    import_report_mode: Union[
        Unset, OrganisationUnitGroupBulkSharingImportReportMode
    ] = OrganisationUnitGroupBulkSharingImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, OrganisationUnitGroupBulkSharingImportStrategy
    ] = OrganisationUnitGroupBulkSharingImportStrategy.CREATE_AND_UPDATE,
    ...
    preheat_mode: Union[
        Unset, OrganisationUnitGroupBulkSharingPreheatMode
    ] = OrganisationUnitGroupBulkSharingPreheatMode.REFERENCE,
    root_junction: Union[Unset, OrganisationUnitGroupBulkSharingRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, OrganisationUnitGroupBulkSharingUserOverrideMode
    ] = OrganisationUnitGroupBulkSharingUserOverrideMode.NONE,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/organisationUnitGroups/sharing",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, OrganisationUnitGroupBulkSharingAtomicMode]):  Default:
            OrganisationUnitGroupBulkSharingAtomicMode.ALL.
        flush_mode (Union[Unset, OrganisationUnitGroupBulkSharingFlushMode]):  Default:
            OrganisationUnitGroupBulkSharingFlushMode.AUTO.
        identifier (Union[Unset, OrganisationUnitGroupBulkSharingIdentifier]):  Default:
            OrganisationUnitGroupBulkSharingIdentifier.UID.
        import_mode (Union[Unset, OrganisationUnitGroupBulkSharingImportMode]):  Default:
            OrganisationUnitGroupBulkSharingImportMode.COMMIT.
        import_report_mode (Union[Unset, OrganisationUnitGroupBulkSharingImportReportMode]):
            Default: OrganisationUnitGroupBulkSharingImportReportMode.ERRORS.
        import_strategy (Union[Unset, OrganisationUnitGroupBulkSharingImportStrategy]):  Default:
            OrganisationUnitGroupBulkSharingImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, OrganisationUnitGroupBulkSharingPreheatMode]):  Default:
            OrganisationUnitGroupBulkSharingPreheatMode.REFERENCE.
        root_junction (Union[Unset, OrganisationUnitGroupBulkSharingRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, OrganisationUnitGroupBulkSharingUserOverrideMode]):
            Default: OrganisationUnitGroupBulkSharingUserOverrideMode.NONE.
        body (BulkJsonPatch):
