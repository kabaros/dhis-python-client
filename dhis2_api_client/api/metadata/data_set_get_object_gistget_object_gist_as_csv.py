...
from ...models.data_set_get_object_gistget_object_gist_as_csv_auto import DataSetGetObjectGistgetObjectGistAsCsvAuto
from ...models.data_set_get_object_gistget_object_gist_as_csv_response_200 import (
    DataSetGetObjectGistgetObjectGistAsCsvResponse200,
)
from ...models.data_set_get_object_gistget_object_gist_as_csv_root_junction import (
    DataSetGetObjectGistgetObjectGistAsCsvRootJunction,
)
...
def _get_kwargs(
    ...
    *,
    ...
    auto: Union[Unset, DataSetGetObjectGistgetObjectGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, DataSetGetObjectGistgetObjectGistAsCsvRootJunction
    ] = DataSetGetObjectGistgetObjectGistAsCsvRootJunction.AND,
...
) -> Optional[Union[DataSetGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]]:
    if response.status_code == 200:
        response_200 = DataSetGetObjectGistgetObjectGistAsCsvResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DataSetGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, DataSetGetObjectGistgetObjectGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, DataSetGetObjectGistgetObjectGistAsCsvRootJunction]):
            Default: DataSetGetObjectGistgetObjectGistAsCsvRootJunction.AND.
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[DataSetGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]
    """
