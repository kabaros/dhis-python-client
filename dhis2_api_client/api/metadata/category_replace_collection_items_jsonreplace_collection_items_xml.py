...
from ...models.category_replace_collection_items_jsonreplace_collection_items_xml_property import (
    CategoryReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: CategoryReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
    *,
