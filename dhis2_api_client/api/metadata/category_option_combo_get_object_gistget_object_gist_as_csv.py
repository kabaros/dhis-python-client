...
from ...models.category_option_combo_get_object_gistget_object_gist_as_csv_auto import (
    CategoryOptionComboGetObjectGistgetObjectGistAsCsvAuto,
)
from ...models.category_option_combo_get_object_gistget_object_gist_as_csv_response_200 import (
    CategoryOptionComboGetObjectGistgetObjectGistAsCsvResponse200,
)
from ...models.category_option_combo_get_object_gistget_object_gist_as_csv_root_junction import (
    CategoryOptionComboGetObjectGistgetObjectGistAsCsvRootJunction,
)
...
def _get_kwargs(
    ...
    *,
    ...
    auto: Union[Unset, CategoryOptionComboGetObjectGistgetObjectGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, CategoryOptionComboGetObjectGistgetObjectGistAsCsvRootJunction
    ] = CategoryOptionComboGetObjectGistgetObjectGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/categoryOptionCombos/{uid}/gist",
        "params": params,
    }
...
) -> Optional[Union[CategoryOptionComboGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]]:
    if response.status_code == 200:
        response_200 = CategoryOptionComboGetObjectGistgetObjectGistAsCsvResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[CategoryOptionComboGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, CategoryOptionComboGetObjectGistgetObjectGistAsCsvAuto]):
        ...
        root_junction (Union[Unset,
            CategoryOptionComboGetObjectGistgetObjectGistAsCsvRootJunction]):  Default:
            CategoryOptionComboGetObjectGistgetObjectGistAsCsvRootJunction.AND.
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[CategoryOptionComboGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]
    """
