...
from ...models.predictor_delete_collection_item_property import PredictorDeleteCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: PredictorDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/predictors/{uid}/{property_}/{item_id}",
    }
