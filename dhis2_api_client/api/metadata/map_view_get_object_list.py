...
from ...models.map_view_get_object_list_response_200 import MapViewGetObjectListResponse200
from ...models.map_view_get_object_list_root_junction import MapViewGetObjectListRootJunction
...
def _get_kwargs(
    *,
    ...
    root_junction: Union[Unset, MapViewGetObjectListRootJunction] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
) -> Optional[Union[MapViewGetObjectListResponse200, WebMessage]]:
    if response.status_code == 200:
        response_200 = MapViewGetObjectListResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[MapViewGetObjectListResponse200, WebMessage]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, MapViewGetObjectListRootJunction]):
...
def sync(
    *,
    ...
    Returns:
        Union[MapViewGetObjectListResponse200, WebMessage]
    """
