...
from ...models.data_approval_workflow_get_object_gistget_object_gist_as_csv_auto import (
    DataApprovalWorkflowGetObjectGistgetObjectGistAsCsvAuto,
)
from ...models.data_approval_workflow_get_object_gistget_object_gist_as_csv_response_200 import (
    DataApprovalWorkflowGetObjectGistgetObjectGistAsCsvResponse200,
)
from ...models.data_approval_workflow_get_object_gistget_object_gist_as_csv_root_junction import (
    DataApprovalWorkflowGetObjectGistgetObjectGistAsCsvRootJunction,
)
...
def _get_kwargs(
    ...
    *,
    ...
    auto: Union[Unset, DataApprovalWorkflowGetObjectGistgetObjectGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, DataApprovalWorkflowGetObjectGistgetObjectGistAsCsvRootJunction
    ] = DataApprovalWorkflowGetObjectGistgetObjectGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/dataApprovalWorkflows/{uid}/gist",
        "params": params,
    }
...
) -> Optional[Union[DataApprovalWorkflowGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]]:
    if response.status_code == 200:
        response_200 = DataApprovalWorkflowGetObjectGistgetObjectGistAsCsvResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DataApprovalWorkflowGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, DataApprovalWorkflowGetObjectGistgetObjectGistAsCsvAuto]):
        ...
        root_junction (Union[Unset,
            DataApprovalWorkflowGetObjectGistgetObjectGistAsCsvRootJunction]):  Default:
            DataApprovalWorkflowGetObjectGistgetObjectGistAsCsvRootJunction.AND.
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[DataApprovalWorkflowGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]
    """
