...
from ...models.predictor_group_delete_collection_item_property import PredictorGroupDeleteCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: PredictorGroupDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/predictorGroups/{uid}/{property_}/{item_id}",
    }
