...
from ...models.push_analysis_delete_collection_item_property import PushAnalysisDeleteCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: PushAnalysisDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/pushAnalysis/{uid}/{property_}/{item_id}",
    }
