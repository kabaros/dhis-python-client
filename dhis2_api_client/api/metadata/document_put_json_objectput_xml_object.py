...
from ...models.document_put_json_objectput_xml_object_atomic_mode import DocumentPutJsonObjectputXmlObjectAtomicMode
from ...models.document_put_json_objectput_xml_object_flush_mode import DocumentPutJsonObjectputXmlObjectFlushMode
from ...models.document_put_json_objectput_xml_object_identifier import DocumentPutJsonObjectputXmlObjectIdentifier
from ...models.document_put_json_objectput_xml_object_import_mode import DocumentPutJsonObjectputXmlObjectImportMode
from ...models.document_put_json_objectput_xml_object_import_report_mode import (
    DocumentPutJsonObjectputXmlObjectImportReportMode,
)
from ...models.document_put_json_objectput_xml_object_import_strategy import (
    DocumentPutJsonObjectputXmlObjectImportStrategy,
)
from ...models.document_put_json_objectput_xml_object_preheat_mode import DocumentPutJsonObjectputXmlObjectPreheatMode
from ...models.document_put_json_objectput_xml_object_user_override_mode import (
    DocumentPutJsonObjectputXmlObjectUserOverrideMode,
)
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[
        Unset, DocumentPutJsonObjectputXmlObjectAtomicMode
    ] = DocumentPutJsonObjectputXmlObjectAtomicMode.ALL,
    flush_mode: Union[
        Unset, DocumentPutJsonObjectputXmlObjectFlushMode
    ] = DocumentPutJsonObjectputXmlObjectFlushMode.AUTO,
    identifier: Union[
        Unset, DocumentPutJsonObjectputXmlObjectIdentifier
    ] = DocumentPutJsonObjectputXmlObjectIdentifier.UID,
    import_mode: Union[
        Unset, DocumentPutJsonObjectputXmlObjectImportMode
    ] = DocumentPutJsonObjectputXmlObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, DocumentPutJsonObjectputXmlObjectImportReportMode
    ] = DocumentPutJsonObjectputXmlObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, DocumentPutJsonObjectputXmlObjectImportStrategy
    ] = DocumentPutJsonObjectputXmlObjectImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    preheat_mode: Union[
        Unset, DocumentPutJsonObjectputXmlObjectPreheatMode
    ] = DocumentPutJsonObjectputXmlObjectPreheatMode.REFERENCE,
    ...
    user_override_mode: Union[
        Unset, DocumentPutJsonObjectputXmlObjectUserOverrideMode
    ] = DocumentPutJsonObjectputXmlObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        uid (str): A UID for an Document object
            (Java name `org.hisp.dhis.document.Document`) Example: e89EJ3at2OP.
        async_ (Union[Unset, bool]):  Default: False.
        atomic_mode (Union[Unset, DocumentPutJsonObjectputXmlObjectAtomicMode]):  Default:
            DocumentPutJsonObjectputXmlObjectAtomicMode.ALL.
        flush_mode (Union[Unset, DocumentPutJsonObjectputXmlObjectFlushMode]):  Default:
            DocumentPutJsonObjectputXmlObjectFlushMode.AUTO.
        identifier (Union[Unset, DocumentPutJsonObjectputXmlObjectIdentifier]):  Default:
            DocumentPutJsonObjectputXmlObjectIdentifier.UID.
        import_mode (Union[Unset, DocumentPutJsonObjectputXmlObjectImportMode]):  Default:
            DocumentPutJsonObjectputXmlObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, DocumentPutJsonObjectputXmlObjectImportReportMode]):
            Default: DocumentPutJsonObjectputXmlObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, DocumentPutJsonObjectputXmlObjectImportStrategy]):  Default:
            DocumentPutJsonObjectputXmlObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, DocumentPutJsonObjectputXmlObjectPreheatMode]):  Default:
            DocumentPutJsonObjectputXmlObjectPreheatMode.REFERENCE.
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, DocumentPutJsonObjectputXmlObjectUserOverrideMode]):
            Default: DocumentPutJsonObjectputXmlObjectUserOverrideMode.NONE.
        body (Document):
