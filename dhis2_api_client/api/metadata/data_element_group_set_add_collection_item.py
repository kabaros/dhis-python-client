...
from ...models.data_element_group_set_add_collection_item_property import DataElementGroupSetAddCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: DataElementGroupSetAddCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
