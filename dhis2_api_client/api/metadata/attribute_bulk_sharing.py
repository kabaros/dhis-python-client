...
from ...models.attribute_bulk_sharing_atomic_mode import AttributeBulkSharingAtomicMode
from ...models.attribute_bulk_sharing_flush_mode import AttributeBulkSharingFlushMode
from ...models.attribute_bulk_sharing_identifier import AttributeBulkSharingIdentifier
from ...models.attribute_bulk_sharing_import_mode import AttributeBulkSharingImportMode
from ...models.attribute_bulk_sharing_import_report_mode import AttributeBulkSharingImportReportMode
from ...models.attribute_bulk_sharing_import_strategy import AttributeBulkSharingImportStrategy
from ...models.attribute_bulk_sharing_preheat_mode import AttributeBulkSharingPreheatMode
from ...models.attribute_bulk_sharing_root_junction import AttributeBulkSharingRootJunction
from ...models.attribute_bulk_sharing_user_override_mode import AttributeBulkSharingUserOverrideMode
...
def _get_kwargs(
    *,
    ...
    atomic_mode: Union[Unset, AttributeBulkSharingAtomicMode] = AttributeBulkSharingAtomicMode.ALL,
    flush_mode: Union[Unset, AttributeBulkSharingFlushMode] = AttributeBulkSharingFlushMode.AUTO,
    identifier: Union[Unset, AttributeBulkSharingIdentifier] = AttributeBulkSharingIdentifier.UID,
    import_mode: Union[Unset, AttributeBulkSharingImportMode] = AttributeBulkSharingImportMode.COMMIT,
    import_report_mode: Union[
        Unset, AttributeBulkSharingImportReportMode
    ] = AttributeBulkSharingImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, AttributeBulkSharingImportStrategy
    ] = AttributeBulkSharingImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, AttributeBulkSharingPreheatMode] = AttributeBulkSharingPreheatMode.REFERENCE,
    root_junction: Union[Unset, AttributeBulkSharingRootJunction] = UNSET,
    skip_sharing: Union[Unset, bool] = False,
    skip_translation: Union[Unset, bool] = False,
    skip_validation: Union[Unset, bool] = False,
    user: Union[Unset, str] = UNSET,
    user_override_mode: Union[Unset, AttributeBulkSharingUserOverrideMode] = AttributeBulkSharingUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, AttributeBulkSharingAtomicMode]):  Default:
            AttributeBulkSharingAtomicMode.ALL.
        flush_mode (Union[Unset, AttributeBulkSharingFlushMode]):  Default:
            AttributeBulkSharingFlushMode.AUTO.
        identifier (Union[Unset, AttributeBulkSharingIdentifier]):  Default:
            AttributeBulkSharingIdentifier.UID.
        import_mode (Union[Unset, AttributeBulkSharingImportMode]):  Default:
            AttributeBulkSharingImportMode.COMMIT.
        import_report_mode (Union[Unset, AttributeBulkSharingImportReportMode]):  Default:
            AttributeBulkSharingImportReportMode.ERRORS.
        import_strategy (Union[Unset, AttributeBulkSharingImportStrategy]):  Default:
            AttributeBulkSharingImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, AttributeBulkSharingPreheatMode]):  Default:
            AttributeBulkSharingPreheatMode.REFERENCE.
        root_junction (Union[Unset, AttributeBulkSharingRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, AttributeBulkSharingUserOverrideMode]):  Default:
            AttributeBulkSharingUserOverrideMode.NONE.
        body (BulkJsonPatch):
