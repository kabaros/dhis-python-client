...
from ...models.document_add_collection_items_jsonadd_collection_items_xml_property import (
    DocumentAddCollectionItemsJsonaddCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: DocumentAddCollectionItemsJsonaddCollectionItemsXmlProperty,
    *,
