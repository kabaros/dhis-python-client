...
from ...models.option_set_get_object_gistget_object_gist_as_csv_auto import OptionSetGetObjectGistgetObjectGistAsCsvAuto
from ...models.option_set_get_object_gistget_object_gist_as_csv_response_200 import (
    OptionSetGetObjectGistgetObjectGistAsCsvResponse200,
)
from ...models.option_set_get_object_gistget_object_gist_as_csv_root_junction import (
    OptionSetGetObjectGistgetObjectGistAsCsvRootJunction,
)
...
def _get_kwargs(
    ...
    *,
    ...
    auto: Union[Unset, OptionSetGetObjectGistgetObjectGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, OptionSetGetObjectGistgetObjectGistAsCsvRootJunction
    ] = OptionSetGetObjectGistgetObjectGistAsCsvRootJunction.AND,
...
) -> Optional[Union[OptionSetGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]]:
    if response.status_code == 200:
        response_200 = OptionSetGetObjectGistgetObjectGistAsCsvResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[OptionSetGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, OptionSetGetObjectGistgetObjectGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, OptionSetGetObjectGistgetObjectGistAsCsvRootJunction]):
            Default: OptionSetGetObjectGistgetObjectGistAsCsvRootJunction.AND.
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[OptionSetGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]
    """
