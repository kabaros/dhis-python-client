...
from ...models.category_option_combo_delete_collection_items_jsondelete_collection_items_xml_property import (
    CategoryOptionComboDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: CategoryOptionComboDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
    *,
