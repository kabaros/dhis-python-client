...
from ...models.external_map_layer_delete_collection_items_jsondelete_collection_items_xml_property import (
    ExternalMapLayerDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: ExternalMapLayerDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
    *,
