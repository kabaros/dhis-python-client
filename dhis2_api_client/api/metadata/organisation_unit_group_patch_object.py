...
from ...models.organisation_unit_group_patch_object_atomic_mode import OrganisationUnitGroupPatchObjectAtomicMode
from ...models.organisation_unit_group_patch_object_flush_mode import OrganisationUnitGroupPatchObjectFlushMode
from ...models.organisation_unit_group_patch_object_identifier import OrganisationUnitGroupPatchObjectIdentifier
from ...models.organisation_unit_group_patch_object_import_mode import OrganisationUnitGroupPatchObjectImportMode
from ...models.organisation_unit_group_patch_object_import_report_mode import (
    OrganisationUnitGroupPatchObjectImportReportMode,
)
from ...models.organisation_unit_group_patch_object_import_strategy import (
    OrganisationUnitGroupPatchObjectImportStrategy,
)
from ...models.organisation_unit_group_patch_object_preheat_mode import OrganisationUnitGroupPatchObjectPreheatMode
from ...models.organisation_unit_group_patch_object_root_junction import OrganisationUnitGroupPatchObjectRootJunction
from ...models.organisation_unit_group_patch_object_user_override_mode import (
    OrganisationUnitGroupPatchObjectUserOverrideMode,
)
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[
        Unset, OrganisationUnitGroupPatchObjectAtomicMode
    ] = OrganisationUnitGroupPatchObjectAtomicMode.ALL,
    flush_mode: Union[
        Unset, OrganisationUnitGroupPatchObjectFlushMode
    ] = OrganisationUnitGroupPatchObjectFlushMode.AUTO,
    identifier: Union[
        Unset, OrganisationUnitGroupPatchObjectIdentifier
    ] = OrganisationUnitGroupPatchObjectIdentifier.UID,
    import_mode: Union[
        Unset, OrganisationUnitGroupPatchObjectImportMode
    ] = OrganisationUnitGroupPatchObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, OrganisationUnitGroupPatchObjectImportReportMode
    ] = OrganisationUnitGroupPatchObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, OrganisationUnitGroupPatchObjectImportStrategy
    ] = OrganisationUnitGroupPatchObjectImportStrategy.CREATE_AND_UPDATE,
    ...
    preheat_mode: Union[
        Unset, OrganisationUnitGroupPatchObjectPreheatMode
    ] = OrganisationUnitGroupPatchObjectPreheatMode.REFERENCE,
    root_junction: Union[Unset, OrganisationUnitGroupPatchObjectRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, OrganisationUnitGroupPatchObjectUserOverrideMode
    ] = OrganisationUnitGroupPatchObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, OrganisationUnitGroupPatchObjectAtomicMode]):  Default:
            OrganisationUnitGroupPatchObjectAtomicMode.ALL.
        flush_mode (Union[Unset, OrganisationUnitGroupPatchObjectFlushMode]):  Default:
            OrganisationUnitGroupPatchObjectFlushMode.AUTO.
        identifier (Union[Unset, OrganisationUnitGroupPatchObjectIdentifier]):  Default:
            OrganisationUnitGroupPatchObjectIdentifier.UID.
        import_mode (Union[Unset, OrganisationUnitGroupPatchObjectImportMode]):  Default:
            OrganisationUnitGroupPatchObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, OrganisationUnitGroupPatchObjectImportReportMode]):
            Default: OrganisationUnitGroupPatchObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, OrganisationUnitGroupPatchObjectImportStrategy]):  Default:
            OrganisationUnitGroupPatchObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, OrganisationUnitGroupPatchObjectPreheatMode]):  Default:
            OrganisationUnitGroupPatchObjectPreheatMode.REFERENCE.
        root_junction (Union[Unset, OrganisationUnitGroupPatchObjectRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, OrganisationUnitGroupPatchObjectUserOverrideMode]):
            Default: OrganisationUnitGroupPatchObjectUserOverrideMode.NONE.
        body (JsonPatch):
