...
from ...models.organisation_unit_level_delete_collection_items_jsondelete_collection_items_xml_property import (
    OrganisationUnitLevelDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: OrganisationUnitLevelDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
    *,
