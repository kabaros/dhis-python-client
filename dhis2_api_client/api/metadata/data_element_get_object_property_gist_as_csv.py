...
from ...models.data_element_get_object_property_gist_as_csv_auto import DataElementGetObjectPropertyGistAsCsvAuto
from ...models.data_element_get_object_property_gist_as_csv_property import (
    DataElementGetObjectPropertyGistAsCsvProperty,
)
from ...models.data_element_get_object_property_gist_as_csv_root_junction import (
    DataElementGetObjectPropertyGistAsCsvRootJunction,
)
...
def _get_kwargs(
    uid: str,
    property_: DataElementGetObjectPropertyGistAsCsvProperty,
    *,
    absolute_urls: Union[Unset, bool] = False,
    auto: Union[Unset, DataElementGetObjectPropertyGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, DataElementGetObjectPropertyGistAsCsvRootJunction
    ] = DataElementGetObjectPropertyGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/dataElements/{uid}/{property_}/gist.csv",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, DataElementGetObjectPropertyGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, DataElementGetObjectPropertyGistAsCsvRootJunction]):  Default:
            DataElementGetObjectPropertyGistAsCsvRootJunction.AND.
