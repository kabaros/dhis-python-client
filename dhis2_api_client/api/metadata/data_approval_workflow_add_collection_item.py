...
from ...models.data_approval_workflow_add_collection_item_property import DataApprovalWorkflowAddCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: DataApprovalWorkflowAddCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
