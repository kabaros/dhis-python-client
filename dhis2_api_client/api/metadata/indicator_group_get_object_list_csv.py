...
from ...models.indicator_group_get_object_list_csv_root_junction import IndicatorGroupGetObjectListCsvRootJunction
...
def _get_kwargs(
    *,
    ...
    root_junction: Union[Unset, IndicatorGroupGetObjectListCsvRootJunction] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/indicatorGroups/#getObjectListCsv",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, IndicatorGroupGetObjectListCsvRootJunction]):
