...
from ...models.indicator_add_collection_items_jsonadd_collection_items_xml_property import (
    IndicatorAddCollectionItemsJsonaddCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: IndicatorAddCollectionItemsJsonaddCollectionItemsXmlProperty,
    *,
