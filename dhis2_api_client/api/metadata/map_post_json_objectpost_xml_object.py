...
from ...models.map_post_json_objectpost_xml_object_atomic_mode import MapPostJsonObjectpostXmlObjectAtomicMode
from ...models.map_post_json_objectpost_xml_object_flush_mode import MapPostJsonObjectpostXmlObjectFlushMode
from ...models.map_post_json_objectpost_xml_object_identifier import MapPostJsonObjectpostXmlObjectIdentifier
from ...models.map_post_json_objectpost_xml_object_import_mode import MapPostJsonObjectpostXmlObjectImportMode
from ...models.map_post_json_objectpost_xml_object_import_report_mode import (
    MapPostJsonObjectpostXmlObjectImportReportMode,
)
from ...models.map_post_json_objectpost_xml_object_import_strategy import MapPostJsonObjectpostXmlObjectImportStrategy
from ...models.map_post_json_objectpost_xml_object_preheat_mode import MapPostJsonObjectpostXmlObjectPreheatMode
from ...models.map_post_json_objectpost_xml_object_user_override_mode import (
    MapPostJsonObjectpostXmlObjectUserOverrideMode,
)
...
def _get_kwargs(
    *,
    ...
    atomic_mode: Union[Unset, MapPostJsonObjectpostXmlObjectAtomicMode] = MapPostJsonObjectpostXmlObjectAtomicMode.ALL,
    flush_mode: Union[Unset, MapPostJsonObjectpostXmlObjectFlushMode] = MapPostJsonObjectpostXmlObjectFlushMode.AUTO,
    identifier: Union[Unset, MapPostJsonObjectpostXmlObjectIdentifier] = MapPostJsonObjectpostXmlObjectIdentifier.UID,
    import_mode: Union[
        Unset, MapPostJsonObjectpostXmlObjectImportMode
    ] = MapPostJsonObjectpostXmlObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, MapPostJsonObjectpostXmlObjectImportReportMode
    ] = MapPostJsonObjectpostXmlObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, MapPostJsonObjectpostXmlObjectImportStrategy
    ] = MapPostJsonObjectpostXmlObjectImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    preheat_mode: Union[
        Unset, MapPostJsonObjectpostXmlObjectPreheatMode
    ] = MapPostJsonObjectpostXmlObjectPreheatMode.REFERENCE,
    ...
    user_override_mode: Union[
        Unset, MapPostJsonObjectpostXmlObjectUserOverrideMode
    ] = MapPostJsonObjectpostXmlObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, MapPostJsonObjectpostXmlObjectAtomicMode]):  Default:
            MapPostJsonObjectpostXmlObjectAtomicMode.ALL.
        flush_mode (Union[Unset, MapPostJsonObjectpostXmlObjectFlushMode]):  Default:
            MapPostJsonObjectpostXmlObjectFlushMode.AUTO.
        identifier (Union[Unset, MapPostJsonObjectpostXmlObjectIdentifier]):  Default:
            MapPostJsonObjectpostXmlObjectIdentifier.UID.
        import_mode (Union[Unset, MapPostJsonObjectpostXmlObjectImportMode]):  Default:
            MapPostJsonObjectpostXmlObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, MapPostJsonObjectpostXmlObjectImportReportMode]):
            Default: MapPostJsonObjectpostXmlObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, MapPostJsonObjectpostXmlObjectImportStrategy]):  Default:
            MapPostJsonObjectpostXmlObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, MapPostJsonObjectpostXmlObjectPreheatMode]):  Default:
            MapPostJsonObjectpostXmlObjectPreheatMode.REFERENCE.
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, MapPostJsonObjectpostXmlObjectUserOverrideMode]):
            Default: MapPostJsonObjectpostXmlObjectUserOverrideMode.NONE.
        body (Map):
