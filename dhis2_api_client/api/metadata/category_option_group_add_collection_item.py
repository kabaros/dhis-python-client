...
from ...models.category_option_group_add_collection_item_property import CategoryOptionGroupAddCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: CategoryOptionGroupAddCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
