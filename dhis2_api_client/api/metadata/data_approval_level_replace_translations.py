...
from ...models.data_approval_level_replace_translations_body import DataApprovalLevelReplaceTranslationsBody
...
def _get_kwargs(
    uid: str,
    *,
    body: DataApprovalLevelReplaceTranslationsBody,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": f"/dataApprovalLevels/{uid}/translations",
    }
