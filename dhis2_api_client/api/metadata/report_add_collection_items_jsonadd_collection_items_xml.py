...
from ...models.report_add_collection_items_jsonadd_collection_items_xml_property import (
    ReportAddCollectionItemsJsonaddCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: ReportAddCollectionItemsJsonaddCollectionItemsXmlProperty,
    *,
