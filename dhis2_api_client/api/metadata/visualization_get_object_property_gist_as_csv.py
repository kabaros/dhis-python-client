...
from ...models.visualization_get_object_property_gist_as_csv_auto import VisualizationGetObjectPropertyGistAsCsvAuto
from ...models.visualization_get_object_property_gist_as_csv_property import (
    VisualizationGetObjectPropertyGistAsCsvProperty,
)
from ...models.visualization_get_object_property_gist_as_csv_root_junction import (
    VisualizationGetObjectPropertyGistAsCsvRootJunction,
)
...
def _get_kwargs(
    uid: str,
    property_: VisualizationGetObjectPropertyGistAsCsvProperty,
    *,
    absolute_urls: Union[Unset, bool] = False,
    auto: Union[Unset, VisualizationGetObjectPropertyGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, VisualizationGetObjectPropertyGistAsCsvRootJunction
    ] = VisualizationGetObjectPropertyGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/visualizations/{uid}/{property_}/gist.csv",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, VisualizationGetObjectPropertyGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, VisualizationGetObjectPropertyGistAsCsvRootJunction]):
            Default: VisualizationGetObjectPropertyGistAsCsvRootJunction.AND.
