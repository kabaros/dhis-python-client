...
from ...models.indicator_patch_object_atomic_mode import IndicatorPatchObjectAtomicMode
from ...models.indicator_patch_object_flush_mode import IndicatorPatchObjectFlushMode
from ...models.indicator_patch_object_identifier import IndicatorPatchObjectIdentifier
from ...models.indicator_patch_object_import_mode import IndicatorPatchObjectImportMode
from ...models.indicator_patch_object_import_report_mode import IndicatorPatchObjectImportReportMode
from ...models.indicator_patch_object_import_strategy import IndicatorPatchObjectImportStrategy
from ...models.indicator_patch_object_preheat_mode import IndicatorPatchObjectPreheatMode
from ...models.indicator_patch_object_root_junction import IndicatorPatchObjectRootJunction
from ...models.indicator_patch_object_user_override_mode import IndicatorPatchObjectUserOverrideMode
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[Unset, IndicatorPatchObjectAtomicMode] = IndicatorPatchObjectAtomicMode.ALL,
    flush_mode: Union[Unset, IndicatorPatchObjectFlushMode] = IndicatorPatchObjectFlushMode.AUTO,
    identifier: Union[Unset, IndicatorPatchObjectIdentifier] = IndicatorPatchObjectIdentifier.UID,
    import_mode: Union[Unset, IndicatorPatchObjectImportMode] = IndicatorPatchObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, IndicatorPatchObjectImportReportMode
    ] = IndicatorPatchObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, IndicatorPatchObjectImportStrategy
    ] = IndicatorPatchObjectImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, IndicatorPatchObjectPreheatMode] = IndicatorPatchObjectPreheatMode.REFERENCE,
    root_junction: Union[Unset, IndicatorPatchObjectRootJunction] = UNSET,
    skip_sharing: Union[Unset, bool] = False,
    skip_translation: Union[Unset, bool] = False,
    skip_validation: Union[Unset, bool] = False,
    user: Union[Unset, str] = UNSET,
    user_override_mode: Union[Unset, IndicatorPatchObjectUserOverrideMode] = IndicatorPatchObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, IndicatorPatchObjectAtomicMode]):  Default:
            IndicatorPatchObjectAtomicMode.ALL.
        flush_mode (Union[Unset, IndicatorPatchObjectFlushMode]):  Default:
            IndicatorPatchObjectFlushMode.AUTO.
        identifier (Union[Unset, IndicatorPatchObjectIdentifier]):  Default:
            IndicatorPatchObjectIdentifier.UID.
        import_mode (Union[Unset, IndicatorPatchObjectImportMode]):  Default:
            IndicatorPatchObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, IndicatorPatchObjectImportReportMode]):  Default:
            IndicatorPatchObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, IndicatorPatchObjectImportStrategy]):  Default:
            IndicatorPatchObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, IndicatorPatchObjectPreheatMode]):  Default:
            IndicatorPatchObjectPreheatMode.REFERENCE.
        root_junction (Union[Unset, IndicatorPatchObjectRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, IndicatorPatchObjectUserOverrideMode]):  Default:
            IndicatorPatchObjectUserOverrideMode.NONE.
        body (JsonPatch):
