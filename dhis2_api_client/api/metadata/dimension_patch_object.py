...
from ...models.dimension_patch_object_atomic_mode import DimensionPatchObjectAtomicMode
from ...models.dimension_patch_object_flush_mode import DimensionPatchObjectFlushMode
from ...models.dimension_patch_object_identifier import DimensionPatchObjectIdentifier
from ...models.dimension_patch_object_import_mode import DimensionPatchObjectImportMode
from ...models.dimension_patch_object_import_report_mode import DimensionPatchObjectImportReportMode
from ...models.dimension_patch_object_import_strategy import DimensionPatchObjectImportStrategy
from ...models.dimension_patch_object_preheat_mode import DimensionPatchObjectPreheatMode
from ...models.dimension_patch_object_root_junction import DimensionPatchObjectRootJunction
from ...models.dimension_patch_object_user_override_mode import DimensionPatchObjectUserOverrideMode
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[Unset, DimensionPatchObjectAtomicMode] = DimensionPatchObjectAtomicMode.ALL,
    flush_mode: Union[Unset, DimensionPatchObjectFlushMode] = DimensionPatchObjectFlushMode.AUTO,
    identifier: Union[Unset, DimensionPatchObjectIdentifier] = DimensionPatchObjectIdentifier.UID,
    import_mode: Union[Unset, DimensionPatchObjectImportMode] = DimensionPatchObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, DimensionPatchObjectImportReportMode
    ] = DimensionPatchObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, DimensionPatchObjectImportStrategy
    ] = DimensionPatchObjectImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, DimensionPatchObjectPreheatMode] = DimensionPatchObjectPreheatMode.REFERENCE,
    root_junction: Union[Unset, DimensionPatchObjectRootJunction] = UNSET,
    skip_sharing: Union[Unset, bool] = False,
    skip_translation: Union[Unset, bool] = False,
    skip_validation: Union[Unset, bool] = False,
    user: Union[Unset, str] = UNSET,
    user_override_mode: Union[Unset, DimensionPatchObjectUserOverrideMode] = DimensionPatchObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, DimensionPatchObjectAtomicMode]):  Default:
            DimensionPatchObjectAtomicMode.ALL.
        flush_mode (Union[Unset, DimensionPatchObjectFlushMode]):  Default:
            DimensionPatchObjectFlushMode.AUTO.
        identifier (Union[Unset, DimensionPatchObjectIdentifier]):  Default:
            DimensionPatchObjectIdentifier.UID.
        import_mode (Union[Unset, DimensionPatchObjectImportMode]):  Default:
            DimensionPatchObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, DimensionPatchObjectImportReportMode]):  Default:
            DimensionPatchObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, DimensionPatchObjectImportStrategy]):  Default:
            DimensionPatchObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, DimensionPatchObjectPreheatMode]):  Default:
            DimensionPatchObjectPreheatMode.REFERENCE.
        root_junction (Union[Unset, DimensionPatchObjectRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, DimensionPatchObjectUserOverrideMode]):  Default:
            DimensionPatchObjectUserOverrideMode.NONE.
        body (JsonPatch):
