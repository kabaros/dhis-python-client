...
from ...models.option_set_replace_collection_items_jsonreplace_collection_items_xml_property import (
    OptionSetReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: OptionSetReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
    *,
