...
from ...models.organisation_unit_group_replace_translations_body import OrganisationUnitGroupReplaceTranslationsBody
...
def _get_kwargs(
    uid: str,
    *,
    body: OrganisationUnitGroupReplaceTranslationsBody,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": f"/organisationUnitGroups/{uid}/translations",
    }
