...
from ...models.organisation_unit_group_get_object_root_junction import OrganisationUnitGroupGetObjectRootJunction
...
def _get_kwargs(
    ...
    *,
    ...
    root_junction: Union[Unset, OrganisationUnitGroupGetObjectRootJunction] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
) -> Optional[Union[OrganisationUnitGroup, WebMessage]]:
    if response.status_code == 200:
        response_200 = OrganisationUnitGroup.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[OrganisationUnitGroup, WebMessage]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, OrganisationUnitGroupGetObjectRootJunction]):
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[OrganisationUnitGroup, WebMessage]
    """
