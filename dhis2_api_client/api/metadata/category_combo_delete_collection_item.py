...
from ...models.category_combo_delete_collection_item_property import CategoryComboDeleteCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: CategoryComboDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/categoryCombos/{uid}/{property_}/{item_id}",
    }
