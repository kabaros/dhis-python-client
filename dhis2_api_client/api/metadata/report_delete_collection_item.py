...
from ...models.report_delete_collection_item_property import ReportDeleteCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: ReportDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/reports/{uid}/{property_}/{item_id}",
    }
