...
from ...models.category_combo_replace_collection_items_jsonreplace_collection_items_xml_property import (
    CategoryComboReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: CategoryComboReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
    *,
