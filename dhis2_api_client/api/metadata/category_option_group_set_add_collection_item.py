...
from ...models.category_option_group_set_add_collection_item_property import (
    CategoryOptionGroupSetAddCollectionItemProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: CategoryOptionGroupSetAddCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
