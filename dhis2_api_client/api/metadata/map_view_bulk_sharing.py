...
from ...models.map_view_bulk_sharing_atomic_mode import MapViewBulkSharingAtomicMode
from ...models.map_view_bulk_sharing_flush_mode import MapViewBulkSharingFlushMode
from ...models.map_view_bulk_sharing_identifier import MapViewBulkSharingIdentifier
from ...models.map_view_bulk_sharing_import_mode import MapViewBulkSharingImportMode
from ...models.map_view_bulk_sharing_import_report_mode import MapViewBulkSharingImportReportMode
from ...models.map_view_bulk_sharing_import_strategy import MapViewBulkSharingImportStrategy
from ...models.map_view_bulk_sharing_preheat_mode import MapViewBulkSharingPreheatMode
from ...models.map_view_bulk_sharing_root_junction import MapViewBulkSharingRootJunction
from ...models.map_view_bulk_sharing_user_override_mode import MapViewBulkSharingUserOverrideMode
...
def _get_kwargs(
    *,
    ...
    atomic_mode: Union[Unset, MapViewBulkSharingAtomicMode] = MapViewBulkSharingAtomicMode.ALL,
    flush_mode: Union[Unset, MapViewBulkSharingFlushMode] = MapViewBulkSharingFlushMode.AUTO,
    identifier: Union[Unset, MapViewBulkSharingIdentifier] = MapViewBulkSharingIdentifier.UID,
    import_mode: Union[Unset, MapViewBulkSharingImportMode] = MapViewBulkSharingImportMode.COMMIT,
    import_report_mode: Union[Unset, MapViewBulkSharingImportReportMode] = MapViewBulkSharingImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, MapViewBulkSharingImportStrategy
    ] = MapViewBulkSharingImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, MapViewBulkSharingPreheatMode] = MapViewBulkSharingPreheatMode.REFERENCE,
    root_junction: Union[Unset, MapViewBulkSharingRootJunction] = UNSET,
    skip_sharing: Union[Unset, bool] = False,
    skip_translation: Union[Unset, bool] = False,
    skip_validation: Union[Unset, bool] = False,
    user: Union[Unset, str] = UNSET,
    user_override_mode: Union[Unset, MapViewBulkSharingUserOverrideMode] = MapViewBulkSharingUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, MapViewBulkSharingAtomicMode]):  Default:
            MapViewBulkSharingAtomicMode.ALL.
        flush_mode (Union[Unset, MapViewBulkSharingFlushMode]):  Default:
            MapViewBulkSharingFlushMode.AUTO.
        identifier (Union[Unset, MapViewBulkSharingIdentifier]):  Default:
            MapViewBulkSharingIdentifier.UID.
        import_mode (Union[Unset, MapViewBulkSharingImportMode]):  Default:
            MapViewBulkSharingImportMode.COMMIT.
        import_report_mode (Union[Unset, MapViewBulkSharingImportReportMode]):  Default:
            MapViewBulkSharingImportReportMode.ERRORS.
        import_strategy (Union[Unset, MapViewBulkSharingImportStrategy]):  Default:
            MapViewBulkSharingImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, MapViewBulkSharingPreheatMode]):  Default:
            MapViewBulkSharingPreheatMode.REFERENCE.
        root_junction (Union[Unset, MapViewBulkSharingRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, MapViewBulkSharingUserOverrideMode]):  Default:
            MapViewBulkSharingUserOverrideMode.NONE.
        body (BulkJsonPatch):
