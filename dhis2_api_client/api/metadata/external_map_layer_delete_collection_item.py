...
from ...models.external_map_layer_delete_collection_item_property import ExternalMapLayerDeleteCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: ExternalMapLayerDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/externalMapLayers/{uid}/{property_}/{item_id}",
    }
