...
from ...models.option_bulk_sharing_atomic_mode import OptionBulkSharingAtomicMode
from ...models.option_bulk_sharing_flush_mode import OptionBulkSharingFlushMode
from ...models.option_bulk_sharing_identifier import OptionBulkSharingIdentifier
from ...models.option_bulk_sharing_import_mode import OptionBulkSharingImportMode
from ...models.option_bulk_sharing_import_report_mode import OptionBulkSharingImportReportMode
from ...models.option_bulk_sharing_import_strategy import OptionBulkSharingImportStrategy
from ...models.option_bulk_sharing_preheat_mode import OptionBulkSharingPreheatMode
from ...models.option_bulk_sharing_root_junction import OptionBulkSharingRootJunction
from ...models.option_bulk_sharing_user_override_mode import OptionBulkSharingUserOverrideMode
...
def _get_kwargs(
    *,
    ...
    atomic_mode: Union[Unset, OptionBulkSharingAtomicMode] = OptionBulkSharingAtomicMode.ALL,
    flush_mode: Union[Unset, OptionBulkSharingFlushMode] = OptionBulkSharingFlushMode.AUTO,
    identifier: Union[Unset, OptionBulkSharingIdentifier] = OptionBulkSharingIdentifier.UID,
    import_mode: Union[Unset, OptionBulkSharingImportMode] = OptionBulkSharingImportMode.COMMIT,
    import_report_mode: Union[Unset, OptionBulkSharingImportReportMode] = OptionBulkSharingImportReportMode.ERRORS,
    import_strategy: Union[Unset, OptionBulkSharingImportStrategy] = OptionBulkSharingImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, OptionBulkSharingPreheatMode] = OptionBulkSharingPreheatMode.REFERENCE,
    root_junction: Union[Unset, OptionBulkSharingRootJunction] = UNSET,
    skip_sharing: Union[Unset, bool] = False,
    skip_translation: Union[Unset, bool] = False,
    skip_validation: Union[Unset, bool] = False,
    user: Union[Unset, str] = UNSET,
    user_override_mode: Union[Unset, OptionBulkSharingUserOverrideMode] = OptionBulkSharingUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, OptionBulkSharingAtomicMode]):  Default:
            OptionBulkSharingAtomicMode.ALL.
        flush_mode (Union[Unset, OptionBulkSharingFlushMode]):  Default:
            OptionBulkSharingFlushMode.AUTO.
        identifier (Union[Unset, OptionBulkSharingIdentifier]):  Default:
            OptionBulkSharingIdentifier.UID.
        import_mode (Union[Unset, OptionBulkSharingImportMode]):  Default:
            OptionBulkSharingImportMode.COMMIT.
        import_report_mode (Union[Unset, OptionBulkSharingImportReportMode]):  Default:
            OptionBulkSharingImportReportMode.ERRORS.
        import_strategy (Union[Unset, OptionBulkSharingImportStrategy]):  Default:
            OptionBulkSharingImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, OptionBulkSharingPreheatMode]):  Default:
            OptionBulkSharingPreheatMode.REFERENCE.
        root_junction (Union[Unset, OptionBulkSharingRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, OptionBulkSharingUserOverrideMode]):  Default:
            OptionBulkSharingUserOverrideMode.NONE.
        body (BulkJsonPatch):
