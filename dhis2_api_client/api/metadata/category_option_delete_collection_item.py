...
from ...models.category_option_delete_collection_item_property import CategoryOptionDeleteCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: CategoryOptionDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/categoryOptions/{uid}/{property_}/{item_id}",
    }
