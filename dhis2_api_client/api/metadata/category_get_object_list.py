...
from ...models.category_get_object_list_response_200 import CategoryGetObjectListResponse200
from ...models.category_get_object_list_root_junction import CategoryGetObjectListRootJunction
...
def _get_kwargs(
    *,
    ...
    root_junction: Union[Unset, CategoryGetObjectListRootJunction] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
) -> Optional[Union[CategoryGetObjectListResponse200, WebMessage]]:
    if response.status_code == 200:
        response_200 = CategoryGetObjectListResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[CategoryGetObjectListResponse200, WebMessage]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, CategoryGetObjectListRootJunction]):
...
def sync(
    *,
    ...
    Returns:
        Union[CategoryGetObjectListResponse200, WebMessage]
    """
