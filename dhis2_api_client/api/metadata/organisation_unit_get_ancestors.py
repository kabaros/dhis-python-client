...
from ...models.organisation_unit_get_ancestors_response_200 import OrganisationUnitGetAncestorsResponse200
from ...models.organisation_unit_get_ancestors_root_junction import OrganisationUnitGetAncestorsRootJunction
...
def _get_kwargs(
    ...
    *,
    ...
    root_junction: Union[Unset, OrganisationUnitGetAncestorsRootJunction] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/organisationUnits/{uid}/ancestors",
        "params": params,
    }
...
) -> Optional[Union[OrganisationUnitGetAncestorsResponse200, WebMessage]]:
    if response.status_code == 200:
        response_200 = OrganisationUnitGetAncestorsResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[OrganisationUnitGetAncestorsResponse200, WebMessage]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, OrganisationUnitGetAncestorsRootJunction]):
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[OrganisationUnitGetAncestorsResponse200, WebMessage]
    """
