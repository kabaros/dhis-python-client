...
from ...models.push_analysis_get_object_list_gist_as_csv_auto import PushAnalysisGetObjectListGistAsCsvAuto
from ...models.push_analysis_get_object_list_gist_as_csv_root_junction import (
    PushAnalysisGetObjectListGistAsCsvRootJunction,
)
...
def _get_kwargs(
    *,
    ...
    auto: Union[Unset, PushAnalysisGetObjectListGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, PushAnalysisGetObjectListGistAsCsvRootJunction
    ] = PushAnalysisGetObjectListGistAsCsvRootJunction.AND,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        auto (Union[Unset, PushAnalysisGetObjectListGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, PushAnalysisGetObjectListGistAsCsvRootJunction]):  Default:
            PushAnalysisGetObjectListGistAsCsvRootJunction.AND.
