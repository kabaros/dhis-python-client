...
from ...models.data_approval_workflow_bulk_sharing_atomic_mode import DataApprovalWorkflowBulkSharingAtomicMode
from ...models.data_approval_workflow_bulk_sharing_flush_mode import DataApprovalWorkflowBulkSharingFlushMode
from ...models.data_approval_workflow_bulk_sharing_identifier import DataApprovalWorkflowBulkSharingIdentifier
from ...models.data_approval_workflow_bulk_sharing_import_mode import DataApprovalWorkflowBulkSharingImportMode
from ...models.data_approval_workflow_bulk_sharing_import_report_mode import (
    DataApprovalWorkflowBulkSharingImportReportMode,
)
from ...models.data_approval_workflow_bulk_sharing_import_strategy import DataApprovalWorkflowBulkSharingImportStrategy
from ...models.data_approval_workflow_bulk_sharing_preheat_mode import DataApprovalWorkflowBulkSharingPreheatMode
from ...models.data_approval_workflow_bulk_sharing_root_junction import DataApprovalWorkflowBulkSharingRootJunction
from ...models.data_approval_workflow_bulk_sharing_user_override_mode import (
    DataApprovalWorkflowBulkSharingUserOverrideMode,
)
...
def _get_kwargs(
    *,
    ...
    atomic_mode: Union[
        Unset, DataApprovalWorkflowBulkSharingAtomicMode
    ] = DataApprovalWorkflowBulkSharingAtomicMode.ALL,
    flush_mode: Union[Unset, DataApprovalWorkflowBulkSharingFlushMode] = DataApprovalWorkflowBulkSharingFlushMode.AUTO,
    identifier: Union[Unset, DataApprovalWorkflowBulkSharingIdentifier] = DataApprovalWorkflowBulkSharingIdentifier.UID,
    import_mode: Union[
        Unset, DataApprovalWorkflowBulkSharingImportMode
    ] = DataApprovalWorkflowBulkSharingImportMode.COMMIT,
    import_report_mode: Union[
        Unset, DataApprovalWorkflowBulkSharingImportReportMode
    ] = DataApprovalWorkflowBulkSharingImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, DataApprovalWorkflowBulkSharingImportStrategy
    ] = DataApprovalWorkflowBulkSharingImportStrategy.CREATE_AND_UPDATE,
    ...
    preheat_mode: Union[
        Unset, DataApprovalWorkflowBulkSharingPreheatMode
    ] = DataApprovalWorkflowBulkSharingPreheatMode.REFERENCE,
    root_junction: Union[Unset, DataApprovalWorkflowBulkSharingRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, DataApprovalWorkflowBulkSharingUserOverrideMode
    ] = DataApprovalWorkflowBulkSharingUserOverrideMode.NONE,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/dataApprovalWorkflows/sharing",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, DataApprovalWorkflowBulkSharingAtomicMode]):  Default:
            DataApprovalWorkflowBulkSharingAtomicMode.ALL.
        flush_mode (Union[Unset, DataApprovalWorkflowBulkSharingFlushMode]):  Default:
            DataApprovalWorkflowBulkSharingFlushMode.AUTO.
        identifier (Union[Unset, DataApprovalWorkflowBulkSharingIdentifier]):  Default:
            DataApprovalWorkflowBulkSharingIdentifier.UID.
        import_mode (Union[Unset, DataApprovalWorkflowBulkSharingImportMode]):  Default:
            DataApprovalWorkflowBulkSharingImportMode.COMMIT.
        import_report_mode (Union[Unset, DataApprovalWorkflowBulkSharingImportReportMode]):
            Default: DataApprovalWorkflowBulkSharingImportReportMode.ERRORS.
        import_strategy (Union[Unset, DataApprovalWorkflowBulkSharingImportStrategy]):  Default:
            DataApprovalWorkflowBulkSharingImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, DataApprovalWorkflowBulkSharingPreheatMode]):  Default:
            DataApprovalWorkflowBulkSharingPreheatMode.REFERENCE.
        root_junction (Union[Unset, DataApprovalWorkflowBulkSharingRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, DataApprovalWorkflowBulkSharingUserOverrideMode]):
            Default: DataApprovalWorkflowBulkSharingUserOverrideMode.NONE.
        body (BulkJsonPatch):
