...
from ...models.organisation_unit_group_set_get_object_list_csv_root_junction import (
    OrganisationUnitGroupSetGetObjectListCsvRootJunction,
)
...
def _get_kwargs(
    *,
    ...
    root_junction: Union[Unset, OrganisationUnitGroupSetGetObjectListCsvRootJunction] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/organisationUnitGroupSets/#getObjectListCsv",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, OrganisationUnitGroupSetGetObjectListCsvRootJunction]):
