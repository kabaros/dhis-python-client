...
from ...models.category_get_object_gistget_object_gist_as_csv_auto import CategoryGetObjectGistgetObjectGistAsCsvAuto
from ...models.category_get_object_gistget_object_gist_as_csv_response_200 import (
    CategoryGetObjectGistgetObjectGistAsCsvResponse200,
)
from ...models.category_get_object_gistget_object_gist_as_csv_root_junction import (
    CategoryGetObjectGistgetObjectGistAsCsvRootJunction,
)
...
def _get_kwargs(
    ...
    *,
    ...
    auto: Union[Unset, CategoryGetObjectGistgetObjectGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, CategoryGetObjectGistgetObjectGistAsCsvRootJunction
    ] = CategoryGetObjectGistgetObjectGistAsCsvRootJunction.AND,
...
) -> Optional[Union[CategoryGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]]:
    if response.status_code == 200:
        response_200 = CategoryGetObjectGistgetObjectGistAsCsvResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[CategoryGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, CategoryGetObjectGistgetObjectGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, CategoryGetObjectGistgetObjectGistAsCsvRootJunction]):
            Default: CategoryGetObjectGistgetObjectGistAsCsvRootJunction.AND.
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[CategoryGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]
    """
