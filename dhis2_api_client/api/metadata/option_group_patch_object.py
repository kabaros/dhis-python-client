...
from ...models.option_group_patch_object_atomic_mode import OptionGroupPatchObjectAtomicMode
from ...models.option_group_patch_object_flush_mode import OptionGroupPatchObjectFlushMode
from ...models.option_group_patch_object_identifier import OptionGroupPatchObjectIdentifier
from ...models.option_group_patch_object_import_mode import OptionGroupPatchObjectImportMode
from ...models.option_group_patch_object_import_report_mode import OptionGroupPatchObjectImportReportMode
from ...models.option_group_patch_object_import_strategy import OptionGroupPatchObjectImportStrategy
from ...models.option_group_patch_object_preheat_mode import OptionGroupPatchObjectPreheatMode
from ...models.option_group_patch_object_root_junction import OptionGroupPatchObjectRootJunction
from ...models.option_group_patch_object_user_override_mode import OptionGroupPatchObjectUserOverrideMode
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[Unset, OptionGroupPatchObjectAtomicMode] = OptionGroupPatchObjectAtomicMode.ALL,
    flush_mode: Union[Unset, OptionGroupPatchObjectFlushMode] = OptionGroupPatchObjectFlushMode.AUTO,
    identifier: Union[Unset, OptionGroupPatchObjectIdentifier] = OptionGroupPatchObjectIdentifier.UID,
    import_mode: Union[Unset, OptionGroupPatchObjectImportMode] = OptionGroupPatchObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, OptionGroupPatchObjectImportReportMode
    ] = OptionGroupPatchObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, OptionGroupPatchObjectImportStrategy
    ] = OptionGroupPatchObjectImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, OptionGroupPatchObjectPreheatMode] = OptionGroupPatchObjectPreheatMode.REFERENCE,
    root_junction: Union[Unset, OptionGroupPatchObjectRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, OptionGroupPatchObjectUserOverrideMode
    ] = OptionGroupPatchObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, OptionGroupPatchObjectAtomicMode]):  Default:
            OptionGroupPatchObjectAtomicMode.ALL.
        flush_mode (Union[Unset, OptionGroupPatchObjectFlushMode]):  Default:
            OptionGroupPatchObjectFlushMode.AUTO.
        identifier (Union[Unset, OptionGroupPatchObjectIdentifier]):  Default:
            OptionGroupPatchObjectIdentifier.UID.
        import_mode (Union[Unset, OptionGroupPatchObjectImportMode]):  Default:
            OptionGroupPatchObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, OptionGroupPatchObjectImportReportMode]):  Default:
            OptionGroupPatchObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, OptionGroupPatchObjectImportStrategy]):  Default:
            OptionGroupPatchObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, OptionGroupPatchObjectPreheatMode]):  Default:
            OptionGroupPatchObjectPreheatMode.REFERENCE.
        root_junction (Union[Unset, OptionGroupPatchObjectRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, OptionGroupPatchObjectUserOverrideMode]):  Default:
            OptionGroupPatchObjectUserOverrideMode.NONE.
        body (JsonPatch):
