...
from ...models.data_set_replace_translations_body import DataSetReplaceTranslationsBody
...
def _get_kwargs(
    uid: str,
    *,
    body: DataSetReplaceTranslationsBody,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": f"/dataSets/{uid}/translations",
    }
