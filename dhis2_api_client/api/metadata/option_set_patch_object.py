...
from ...models.option_set_patch_object_atomic_mode import OptionSetPatchObjectAtomicMode
from ...models.option_set_patch_object_flush_mode import OptionSetPatchObjectFlushMode
from ...models.option_set_patch_object_identifier import OptionSetPatchObjectIdentifier
from ...models.option_set_patch_object_import_mode import OptionSetPatchObjectImportMode
from ...models.option_set_patch_object_import_report_mode import OptionSetPatchObjectImportReportMode
from ...models.option_set_patch_object_import_strategy import OptionSetPatchObjectImportStrategy
from ...models.option_set_patch_object_preheat_mode import OptionSetPatchObjectPreheatMode
from ...models.option_set_patch_object_root_junction import OptionSetPatchObjectRootJunction
from ...models.option_set_patch_object_user_override_mode import OptionSetPatchObjectUserOverrideMode
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[Unset, OptionSetPatchObjectAtomicMode] = OptionSetPatchObjectAtomicMode.ALL,
    flush_mode: Union[Unset, OptionSetPatchObjectFlushMode] = OptionSetPatchObjectFlushMode.AUTO,
    identifier: Union[Unset, OptionSetPatchObjectIdentifier] = OptionSetPatchObjectIdentifier.UID,
    import_mode: Union[Unset, OptionSetPatchObjectImportMode] = OptionSetPatchObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, OptionSetPatchObjectImportReportMode
    ] = OptionSetPatchObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, OptionSetPatchObjectImportStrategy
    ] = OptionSetPatchObjectImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, OptionSetPatchObjectPreheatMode] = OptionSetPatchObjectPreheatMode.REFERENCE,
    root_junction: Union[Unset, OptionSetPatchObjectRootJunction] = UNSET,
    skip_sharing: Union[Unset, bool] = False,
    skip_translation: Union[Unset, bool] = False,
    skip_validation: Union[Unset, bool] = False,
    user: Union[Unset, str] = UNSET,
    user_override_mode: Union[Unset, OptionSetPatchObjectUserOverrideMode] = OptionSetPatchObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, OptionSetPatchObjectAtomicMode]):  Default:
            OptionSetPatchObjectAtomicMode.ALL.
        flush_mode (Union[Unset, OptionSetPatchObjectFlushMode]):  Default:
            OptionSetPatchObjectFlushMode.AUTO.
        identifier (Union[Unset, OptionSetPatchObjectIdentifier]):  Default:
            OptionSetPatchObjectIdentifier.UID.
        import_mode (Union[Unset, OptionSetPatchObjectImportMode]):  Default:
            OptionSetPatchObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, OptionSetPatchObjectImportReportMode]):  Default:
            OptionSetPatchObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, OptionSetPatchObjectImportStrategy]):  Default:
            OptionSetPatchObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, OptionSetPatchObjectPreheatMode]):  Default:
            OptionSetPatchObjectPreheatMode.REFERENCE.
        root_junction (Union[Unset, OptionSetPatchObjectRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, OptionSetPatchObjectUserOverrideMode]):  Default:
            OptionSetPatchObjectUserOverrideMode.NONE.
        body (JsonPatch):
