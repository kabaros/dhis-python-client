...
from ...models.document_get_object_property_gist_as_csv_auto import DocumentGetObjectPropertyGistAsCsvAuto
from ...models.document_get_object_property_gist_as_csv_property import DocumentGetObjectPropertyGistAsCsvProperty
from ...models.document_get_object_property_gist_as_csv_root_junction import (
    DocumentGetObjectPropertyGistAsCsvRootJunction,
)
...
def _get_kwargs(
    uid: str,
    property_: DocumentGetObjectPropertyGistAsCsvProperty,
    *,
    absolute_urls: Union[Unset, bool] = False,
    auto: Union[Unset, DocumentGetObjectPropertyGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, DocumentGetObjectPropertyGistAsCsvRootJunction
    ] = DocumentGetObjectPropertyGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/documents/{uid}/{property_}/gist.csv",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, DocumentGetObjectPropertyGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, DocumentGetObjectPropertyGistAsCsvRootJunction]):  Default:
            DocumentGetObjectPropertyGistAsCsvRootJunction.AND.
