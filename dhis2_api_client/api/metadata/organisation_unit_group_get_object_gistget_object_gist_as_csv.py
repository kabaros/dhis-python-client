...
from ...models.organisation_unit_group_get_object_gistget_object_gist_as_csv_auto import (
    OrganisationUnitGroupGetObjectGistgetObjectGistAsCsvAuto,
)
from ...models.organisation_unit_group_get_object_gistget_object_gist_as_csv_response_200 import (
    OrganisationUnitGroupGetObjectGistgetObjectGistAsCsvResponse200,
)
from ...models.organisation_unit_group_get_object_gistget_object_gist_as_csv_root_junction import (
    OrganisationUnitGroupGetObjectGistgetObjectGistAsCsvRootJunction,
)
...
def _get_kwargs(
    ...
    *,
    ...
    auto: Union[Unset, OrganisationUnitGroupGetObjectGistgetObjectGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, OrganisationUnitGroupGetObjectGistgetObjectGistAsCsvRootJunction
    ] = OrganisationUnitGroupGetObjectGistgetObjectGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/organisationUnitGroups/{uid}/gist",
        "params": params,
    }
...
) -> Optional[Union[OrganisationUnitGroupGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]]:
    if response.status_code == 200:
        response_200 = OrganisationUnitGroupGetObjectGistgetObjectGistAsCsvResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[OrganisationUnitGroupGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, OrganisationUnitGroupGetObjectGistgetObjectGistAsCsvAuto]):
        ...
        root_junction (Union[Unset,
            OrganisationUnitGroupGetObjectGistgetObjectGistAsCsvRootJunction]):  Default:
            OrganisationUnitGroupGetObjectGistgetObjectGistAsCsvRootJunction.AND.
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[OrganisationUnitGroupGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]
    """
