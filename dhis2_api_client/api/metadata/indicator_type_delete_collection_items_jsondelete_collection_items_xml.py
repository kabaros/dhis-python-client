...
from ...models.indicator_type_delete_collection_items_jsondelete_collection_items_xml_property import (
    IndicatorTypeDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: IndicatorTypeDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
    *,
