...
from ...models.map_view_get_object_property_gist_as_csv_auto import MapViewGetObjectPropertyGistAsCsvAuto
from ...models.map_view_get_object_property_gist_as_csv_property import MapViewGetObjectPropertyGistAsCsvProperty
from ...models.map_view_get_object_property_gist_as_csv_root_junction import (
    MapViewGetObjectPropertyGistAsCsvRootJunction,
)
...
def _get_kwargs(
    uid: str,
    property_: MapViewGetObjectPropertyGistAsCsvProperty,
    *,
    absolute_urls: Union[Unset, bool] = False,
    auto: Union[Unset, MapViewGetObjectPropertyGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, MapViewGetObjectPropertyGistAsCsvRootJunction
    ] = MapViewGetObjectPropertyGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/mapViews/{uid}/{property_}/gist.csv",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, MapViewGetObjectPropertyGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, MapViewGetObjectPropertyGistAsCsvRootJunction]):  Default:
            MapViewGetObjectPropertyGistAsCsvRootJunction.AND.
