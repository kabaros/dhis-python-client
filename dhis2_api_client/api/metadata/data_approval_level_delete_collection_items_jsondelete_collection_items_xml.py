...
from ...models.data_approval_level_delete_collection_items_jsondelete_collection_items_xml_property import (
    DataApprovalLevelDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: DataApprovalLevelDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
    *,
