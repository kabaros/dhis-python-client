...
from ...models.category_option_group_set_replace_collection_items_jsonreplace_collection_items_xml_property import (
    CategoryOptionGroupSetReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: CategoryOptionGroupSetReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
    *,
