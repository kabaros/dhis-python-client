...
from ...models.data_approval_level_get_object_list_csv_root_junction import (
    DataApprovalLevelGetObjectListCsvRootJunction,
)
...
def _get_kwargs(
    *,
    ...
    root_junction: Union[Unset, DataApprovalLevelGetObjectListCsvRootJunction] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/dataApprovalLevels/#getObjectListCsv",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, DataApprovalLevelGetObjectListCsvRootJunction]):
