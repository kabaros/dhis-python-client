...
from ...models.map_get_object_gistget_object_gist_as_csv_auto import MapGetObjectGistgetObjectGistAsCsvAuto
from ...models.map_get_object_gistget_object_gist_as_csv_response_200 import (
    MapGetObjectGistgetObjectGistAsCsvResponse200,
)
from ...models.map_get_object_gistget_object_gist_as_csv_root_junction import (
    MapGetObjectGistgetObjectGistAsCsvRootJunction,
)
...
def _get_kwargs(
    ...
    *,
    ...
    auto: Union[Unset, MapGetObjectGistgetObjectGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, MapGetObjectGistgetObjectGistAsCsvRootJunction
    ] = MapGetObjectGistgetObjectGistAsCsvRootJunction.AND,
...
) -> Optional[Union[MapGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]]:
    if response.status_code == 200:
        response_200 = MapGetObjectGistgetObjectGistAsCsvResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[MapGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, MapGetObjectGistgetObjectGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, MapGetObjectGistgetObjectGistAsCsvRootJunction]):  Default:
            MapGetObjectGistgetObjectGistAsCsvRootJunction.AND.
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[MapGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]
    """
