...
from ...models.push_analysis_replace_collection_items_jsonreplace_collection_items_xml_property import (
    PushAnalysisReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: PushAnalysisReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
    *,
