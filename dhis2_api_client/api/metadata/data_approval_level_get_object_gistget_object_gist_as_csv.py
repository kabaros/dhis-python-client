...
from ...models.data_approval_level_get_object_gistget_object_gist_as_csv_auto import (
    DataApprovalLevelGetObjectGistgetObjectGistAsCsvAuto,
)
from ...models.data_approval_level_get_object_gistget_object_gist_as_csv_response_200 import (
    DataApprovalLevelGetObjectGistgetObjectGistAsCsvResponse200,
)
from ...models.data_approval_level_get_object_gistget_object_gist_as_csv_root_junction import (
    DataApprovalLevelGetObjectGistgetObjectGistAsCsvRootJunction,
)
...
def _get_kwargs(
    ...
    *,
    ...
    auto: Union[Unset, DataApprovalLevelGetObjectGistgetObjectGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, DataApprovalLevelGetObjectGistgetObjectGistAsCsvRootJunction
    ] = DataApprovalLevelGetObjectGistgetObjectGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/dataApprovalLevels/{uid}/gist",
        "params": params,
    }
...
) -> Optional[Union[DataApprovalLevelGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]]:
    if response.status_code == 200:
        response_200 = DataApprovalLevelGetObjectGistgetObjectGistAsCsvResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DataApprovalLevelGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, DataApprovalLevelGetObjectGistgetObjectGistAsCsvAuto]):
        ...
        root_junction (Union[Unset,
            DataApprovalLevelGetObjectGistgetObjectGistAsCsvRootJunction]):  Default:
            DataApprovalLevelGetObjectGistgetObjectGistAsCsvRootJunction.AND.
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[DataApprovalLevelGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]
    """
