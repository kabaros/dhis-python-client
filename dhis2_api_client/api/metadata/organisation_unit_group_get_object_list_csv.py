...
from ...models.organisation_unit_group_get_object_list_csv_root_junction import (
    OrganisationUnitGroupGetObjectListCsvRootJunction,
)
...
def _get_kwargs(
    *,
    ...
    root_junction: Union[Unset, OrganisationUnitGroupGetObjectListCsvRootJunction] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/organisationUnitGroups/#getObjectListCsv",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, OrganisationUnitGroupGetObjectListCsvRootJunction]):
