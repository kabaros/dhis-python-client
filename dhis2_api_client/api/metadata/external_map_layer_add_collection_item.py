...
from ...models.external_map_layer_add_collection_item_property import ExternalMapLayerAddCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: ExternalMapLayerAddCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
