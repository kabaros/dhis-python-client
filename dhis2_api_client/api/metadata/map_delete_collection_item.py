...
from ...models.map_delete_collection_item_property import MapDeleteCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: MapDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/maps/{uid}/{property_}/{item_id}",
    }
