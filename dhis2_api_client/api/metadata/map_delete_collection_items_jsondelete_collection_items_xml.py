...
from ...models.map_delete_collection_items_jsondelete_collection_items_xml_property import (
    MapDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: MapDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
    *,
