...
from ...models.category_combo_get_object_gistget_object_gist_as_csv_auto import (
    CategoryComboGetObjectGistgetObjectGistAsCsvAuto,
)
from ...models.category_combo_get_object_gistget_object_gist_as_csv_response_200 import (
    CategoryComboGetObjectGistgetObjectGistAsCsvResponse200,
)
from ...models.category_combo_get_object_gistget_object_gist_as_csv_root_junction import (
    CategoryComboGetObjectGistgetObjectGistAsCsvRootJunction,
)
...
def _get_kwargs(
    ...
    *,
    ...
    auto: Union[Unset, CategoryComboGetObjectGistgetObjectGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, CategoryComboGetObjectGistgetObjectGistAsCsvRootJunction
    ] = CategoryComboGetObjectGistgetObjectGistAsCsvRootJunction.AND,
...
) -> Optional[Union[CategoryComboGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]]:
    if response.status_code == 200:
        response_200 = CategoryComboGetObjectGistgetObjectGistAsCsvResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[CategoryComboGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, CategoryComboGetObjectGistgetObjectGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, CategoryComboGetObjectGistgetObjectGistAsCsvRootJunction]):
            Default: CategoryComboGetObjectGistgetObjectGistAsCsvRootJunction.AND.
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[CategoryComboGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]
    """
