...
from ...models.data_set_get_object_list_csv_root_junction import DataSetGetObjectListCsvRootJunction
...
def _get_kwargs(
    *,
    ...
    root_junction: Union[Unset, DataSetGetObjectListCsvRootJunction] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, DataSetGetObjectListCsvRootJunction]):
