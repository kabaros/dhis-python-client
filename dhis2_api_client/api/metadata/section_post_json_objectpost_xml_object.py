...
from ...models.section_post_json_objectpost_xml_object_atomic_mode import SectionPostJsonObjectpostXmlObjectAtomicMode
from ...models.section_post_json_objectpost_xml_object_flush_mode import SectionPostJsonObjectpostXmlObjectFlushMode
from ...models.section_post_json_objectpost_xml_object_identifier import SectionPostJsonObjectpostXmlObjectIdentifier
from ...models.section_post_json_objectpost_xml_object_import_mode import SectionPostJsonObjectpostXmlObjectImportMode
from ...models.section_post_json_objectpost_xml_object_import_report_mode import (
    SectionPostJsonObjectpostXmlObjectImportReportMode,
)
from ...models.section_post_json_objectpost_xml_object_import_strategy import (
    SectionPostJsonObjectpostXmlObjectImportStrategy,
)
from ...models.section_post_json_objectpost_xml_object_preheat_mode import SectionPostJsonObjectpostXmlObjectPreheatMode
from ...models.section_post_json_objectpost_xml_object_user_override_mode import (
    SectionPostJsonObjectpostXmlObjectUserOverrideMode,
)
...
def _get_kwargs(
    *,
    ...
    atomic_mode: Union[
        Unset, SectionPostJsonObjectpostXmlObjectAtomicMode
    ] = SectionPostJsonObjectpostXmlObjectAtomicMode.ALL,
    flush_mode: Union[
        Unset, SectionPostJsonObjectpostXmlObjectFlushMode
    ] = SectionPostJsonObjectpostXmlObjectFlushMode.AUTO,
    identifier: Union[
        Unset, SectionPostJsonObjectpostXmlObjectIdentifier
    ] = SectionPostJsonObjectpostXmlObjectIdentifier.UID,
    import_mode: Union[
        Unset, SectionPostJsonObjectpostXmlObjectImportMode
    ] = SectionPostJsonObjectpostXmlObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, SectionPostJsonObjectpostXmlObjectImportReportMode
    ] = SectionPostJsonObjectpostXmlObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, SectionPostJsonObjectpostXmlObjectImportStrategy
    ] = SectionPostJsonObjectpostXmlObjectImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    preheat_mode: Union[
        Unset, SectionPostJsonObjectpostXmlObjectPreheatMode
    ] = SectionPostJsonObjectpostXmlObjectPreheatMode.REFERENCE,
    ...
    user_override_mode: Union[
        Unset, SectionPostJsonObjectpostXmlObjectUserOverrideMode
    ] = SectionPostJsonObjectpostXmlObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, SectionPostJsonObjectpostXmlObjectAtomicMode]):  Default:
            SectionPostJsonObjectpostXmlObjectAtomicMode.ALL.
        flush_mode (Union[Unset, SectionPostJsonObjectpostXmlObjectFlushMode]):  Default:
            SectionPostJsonObjectpostXmlObjectFlushMode.AUTO.
        identifier (Union[Unset, SectionPostJsonObjectpostXmlObjectIdentifier]):  Default:
            SectionPostJsonObjectpostXmlObjectIdentifier.UID.
        import_mode (Union[Unset, SectionPostJsonObjectpostXmlObjectImportMode]):  Default:
            SectionPostJsonObjectpostXmlObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, SectionPostJsonObjectpostXmlObjectImportReportMode]):
            Default: SectionPostJsonObjectpostXmlObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, SectionPostJsonObjectpostXmlObjectImportStrategy]):
            Default: SectionPostJsonObjectpostXmlObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, SectionPostJsonObjectpostXmlObjectPreheatMode]):  Default:
            SectionPostJsonObjectpostXmlObjectPreheatMode.REFERENCE.
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, SectionPostJsonObjectpostXmlObjectUserOverrideMode]):
            Default: SectionPostJsonObjectpostXmlObjectUserOverrideMode.NONE.
        body (Section):
