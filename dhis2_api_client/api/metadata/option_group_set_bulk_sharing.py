...
from ...models.option_group_set_bulk_sharing_atomic_mode import OptionGroupSetBulkSharingAtomicMode
from ...models.option_group_set_bulk_sharing_flush_mode import OptionGroupSetBulkSharingFlushMode
from ...models.option_group_set_bulk_sharing_identifier import OptionGroupSetBulkSharingIdentifier
from ...models.option_group_set_bulk_sharing_import_mode import OptionGroupSetBulkSharingImportMode
from ...models.option_group_set_bulk_sharing_import_report_mode import OptionGroupSetBulkSharingImportReportMode
from ...models.option_group_set_bulk_sharing_import_strategy import OptionGroupSetBulkSharingImportStrategy
from ...models.option_group_set_bulk_sharing_preheat_mode import OptionGroupSetBulkSharingPreheatMode
from ...models.option_group_set_bulk_sharing_root_junction import OptionGroupSetBulkSharingRootJunction
from ...models.option_group_set_bulk_sharing_user_override_mode import OptionGroupSetBulkSharingUserOverrideMode
...
def _get_kwargs(
    *,
    ...
    atomic_mode: Union[Unset, OptionGroupSetBulkSharingAtomicMode] = OptionGroupSetBulkSharingAtomicMode.ALL,
    flush_mode: Union[Unset, OptionGroupSetBulkSharingFlushMode] = OptionGroupSetBulkSharingFlushMode.AUTO,
    identifier: Union[Unset, OptionGroupSetBulkSharingIdentifier] = OptionGroupSetBulkSharingIdentifier.UID,
    import_mode: Union[Unset, OptionGroupSetBulkSharingImportMode] = OptionGroupSetBulkSharingImportMode.COMMIT,
    import_report_mode: Union[
        Unset, OptionGroupSetBulkSharingImportReportMode
    ] = OptionGroupSetBulkSharingImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, OptionGroupSetBulkSharingImportStrategy
    ] = OptionGroupSetBulkSharingImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, OptionGroupSetBulkSharingPreheatMode] = OptionGroupSetBulkSharingPreheatMode.REFERENCE,
    root_junction: Union[Unset, OptionGroupSetBulkSharingRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, OptionGroupSetBulkSharingUserOverrideMode
    ] = OptionGroupSetBulkSharingUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, OptionGroupSetBulkSharingAtomicMode]):  Default:
            OptionGroupSetBulkSharingAtomicMode.ALL.
        flush_mode (Union[Unset, OptionGroupSetBulkSharingFlushMode]):  Default:
            OptionGroupSetBulkSharingFlushMode.AUTO.
        identifier (Union[Unset, OptionGroupSetBulkSharingIdentifier]):  Default:
            OptionGroupSetBulkSharingIdentifier.UID.
        import_mode (Union[Unset, OptionGroupSetBulkSharingImportMode]):  Default:
            OptionGroupSetBulkSharingImportMode.COMMIT.
        import_report_mode (Union[Unset, OptionGroupSetBulkSharingImportReportMode]):  Default:
            OptionGroupSetBulkSharingImportReportMode.ERRORS.
        import_strategy (Union[Unset, OptionGroupSetBulkSharingImportStrategy]):  Default:
            OptionGroupSetBulkSharingImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, OptionGroupSetBulkSharingPreheatMode]):  Default:
            OptionGroupSetBulkSharingPreheatMode.REFERENCE.
        root_junction (Union[Unset, OptionGroupSetBulkSharingRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, OptionGroupSetBulkSharingUserOverrideMode]):  Default:
            OptionGroupSetBulkSharingUserOverrideMode.NONE.
        body (BulkJsonPatch):
