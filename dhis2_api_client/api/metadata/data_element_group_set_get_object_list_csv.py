...
from ...models.data_element_group_set_get_object_list_csv_root_junction import (
    DataElementGroupSetGetObjectListCsvRootJunction,
)
...
def _get_kwargs(
    *,
    ...
    root_junction: Union[Unset, DataElementGroupSetGetObjectListCsvRootJunction] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/dataElementGroupSets/#getObjectListCsv",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, DataElementGroupSetGetObjectListCsvRootJunction]):
