...
from ...models.data_set_bulk_sharing_atomic_mode import DataSetBulkSharingAtomicMode
from ...models.data_set_bulk_sharing_flush_mode import DataSetBulkSharingFlushMode
from ...models.data_set_bulk_sharing_identifier import DataSetBulkSharingIdentifier
from ...models.data_set_bulk_sharing_import_mode import DataSetBulkSharingImportMode
from ...models.data_set_bulk_sharing_import_report_mode import DataSetBulkSharingImportReportMode
from ...models.data_set_bulk_sharing_import_strategy import DataSetBulkSharingImportStrategy
from ...models.data_set_bulk_sharing_preheat_mode import DataSetBulkSharingPreheatMode
from ...models.data_set_bulk_sharing_root_junction import DataSetBulkSharingRootJunction
from ...models.data_set_bulk_sharing_user_override_mode import DataSetBulkSharingUserOverrideMode
...
def _get_kwargs(
    *,
    ...
    atomic_mode: Union[Unset, DataSetBulkSharingAtomicMode] = DataSetBulkSharingAtomicMode.ALL,
    flush_mode: Union[Unset, DataSetBulkSharingFlushMode] = DataSetBulkSharingFlushMode.AUTO,
    identifier: Union[Unset, DataSetBulkSharingIdentifier] = DataSetBulkSharingIdentifier.UID,
    import_mode: Union[Unset, DataSetBulkSharingImportMode] = DataSetBulkSharingImportMode.COMMIT,
    import_report_mode: Union[Unset, DataSetBulkSharingImportReportMode] = DataSetBulkSharingImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, DataSetBulkSharingImportStrategy
    ] = DataSetBulkSharingImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, DataSetBulkSharingPreheatMode] = DataSetBulkSharingPreheatMode.REFERENCE,
    root_junction: Union[Unset, DataSetBulkSharingRootJunction] = UNSET,
    skip_sharing: Union[Unset, bool] = False,
    skip_translation: Union[Unset, bool] = False,
    skip_validation: Union[Unset, bool] = False,
    user: Union[Unset, str] = UNSET,
    user_override_mode: Union[Unset, DataSetBulkSharingUserOverrideMode] = DataSetBulkSharingUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, DataSetBulkSharingAtomicMode]):  Default:
            DataSetBulkSharingAtomicMode.ALL.
        flush_mode (Union[Unset, DataSetBulkSharingFlushMode]):  Default:
            DataSetBulkSharingFlushMode.AUTO.
        identifier (Union[Unset, DataSetBulkSharingIdentifier]):  Default:
            DataSetBulkSharingIdentifier.UID.
        import_mode (Union[Unset, DataSetBulkSharingImportMode]):  Default:
            DataSetBulkSharingImportMode.COMMIT.
        import_report_mode (Union[Unset, DataSetBulkSharingImportReportMode]):  Default:
            DataSetBulkSharingImportReportMode.ERRORS.
        import_strategy (Union[Unset, DataSetBulkSharingImportStrategy]):  Default:
            DataSetBulkSharingImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, DataSetBulkSharingPreheatMode]):  Default:
            DataSetBulkSharingPreheatMode.REFERENCE.
        root_junction (Union[Unset, DataSetBulkSharingRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, DataSetBulkSharingUserOverrideMode]):  Default:
            DataSetBulkSharingUserOverrideMode.NONE.
        body (BulkJsonPatch):
