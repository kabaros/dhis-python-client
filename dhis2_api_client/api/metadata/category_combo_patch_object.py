...
from ...models.category_combo_patch_object_atomic_mode import CategoryComboPatchObjectAtomicMode
from ...models.category_combo_patch_object_flush_mode import CategoryComboPatchObjectFlushMode
from ...models.category_combo_patch_object_identifier import CategoryComboPatchObjectIdentifier
from ...models.category_combo_patch_object_import_mode import CategoryComboPatchObjectImportMode
from ...models.category_combo_patch_object_import_report_mode import CategoryComboPatchObjectImportReportMode
from ...models.category_combo_patch_object_import_strategy import CategoryComboPatchObjectImportStrategy
from ...models.category_combo_patch_object_preheat_mode import CategoryComboPatchObjectPreheatMode
from ...models.category_combo_patch_object_root_junction import CategoryComboPatchObjectRootJunction
from ...models.category_combo_patch_object_user_override_mode import CategoryComboPatchObjectUserOverrideMode
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[Unset, CategoryComboPatchObjectAtomicMode] = CategoryComboPatchObjectAtomicMode.ALL,
    flush_mode: Union[Unset, CategoryComboPatchObjectFlushMode] = CategoryComboPatchObjectFlushMode.AUTO,
    identifier: Union[Unset, CategoryComboPatchObjectIdentifier] = CategoryComboPatchObjectIdentifier.UID,
    import_mode: Union[Unset, CategoryComboPatchObjectImportMode] = CategoryComboPatchObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, CategoryComboPatchObjectImportReportMode
    ] = CategoryComboPatchObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, CategoryComboPatchObjectImportStrategy
    ] = CategoryComboPatchObjectImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, CategoryComboPatchObjectPreheatMode] = CategoryComboPatchObjectPreheatMode.REFERENCE,
    root_junction: Union[Unset, CategoryComboPatchObjectRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, CategoryComboPatchObjectUserOverrideMode
    ] = CategoryComboPatchObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, CategoryComboPatchObjectAtomicMode]):  Default:
            CategoryComboPatchObjectAtomicMode.ALL.
        flush_mode (Union[Unset, CategoryComboPatchObjectFlushMode]):  Default:
            CategoryComboPatchObjectFlushMode.AUTO.
        identifier (Union[Unset, CategoryComboPatchObjectIdentifier]):  Default:
            CategoryComboPatchObjectIdentifier.UID.
        import_mode (Union[Unset, CategoryComboPatchObjectImportMode]):  Default:
            CategoryComboPatchObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, CategoryComboPatchObjectImportReportMode]):  Default:
            CategoryComboPatchObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, CategoryComboPatchObjectImportStrategy]):  Default:
            CategoryComboPatchObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, CategoryComboPatchObjectPreheatMode]):  Default:
            CategoryComboPatchObjectPreheatMode.REFERENCE.
        root_junction (Union[Unset, CategoryComboPatchObjectRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, CategoryComboPatchObjectUserOverrideMode]):  Default:
            CategoryComboPatchObjectUserOverrideMode.NONE.
        body (JsonPatch):
