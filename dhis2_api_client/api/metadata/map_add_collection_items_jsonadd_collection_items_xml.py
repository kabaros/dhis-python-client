...
from ...models.map_add_collection_items_jsonadd_collection_items_xml_property import (
    MapAddCollectionItemsJsonaddCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: MapAddCollectionItemsJsonaddCollectionItemsXmlProperty,
    *,
