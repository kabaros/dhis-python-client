...
from ...models.map_patch_object_atomic_mode import MapPatchObjectAtomicMode
from ...models.map_patch_object_flush_mode import MapPatchObjectFlushMode
from ...models.map_patch_object_identifier import MapPatchObjectIdentifier
from ...models.map_patch_object_import_mode import MapPatchObjectImportMode
from ...models.map_patch_object_import_report_mode import MapPatchObjectImportReportMode
from ...models.map_patch_object_import_strategy import MapPatchObjectImportStrategy
from ...models.map_patch_object_preheat_mode import MapPatchObjectPreheatMode
from ...models.map_patch_object_root_junction import MapPatchObjectRootJunction
from ...models.map_patch_object_user_override_mode import MapPatchObjectUserOverrideMode
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[Unset, MapPatchObjectAtomicMode] = MapPatchObjectAtomicMode.ALL,
    flush_mode: Union[Unset, MapPatchObjectFlushMode] = MapPatchObjectFlushMode.AUTO,
    identifier: Union[Unset, MapPatchObjectIdentifier] = MapPatchObjectIdentifier.UID,
    import_mode: Union[Unset, MapPatchObjectImportMode] = MapPatchObjectImportMode.COMMIT,
    import_report_mode: Union[Unset, MapPatchObjectImportReportMode] = MapPatchObjectImportReportMode.ERRORS,
    import_strategy: Union[Unset, MapPatchObjectImportStrategy] = MapPatchObjectImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, MapPatchObjectPreheatMode] = MapPatchObjectPreheatMode.REFERENCE,
    root_junction: Union[Unset, MapPatchObjectRootJunction] = UNSET,
    skip_sharing: Union[Unset, bool] = False,
    skip_translation: Union[Unset, bool] = False,
    skip_validation: Union[Unset, bool] = False,
    user: Union[Unset, str] = UNSET,
    user_override_mode: Union[Unset, MapPatchObjectUserOverrideMode] = MapPatchObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        uid (str): A UID for an Map object
            (Java name `org.hisp.dhis.mapping.Map`) Example: iP9Vs8y5xb3.
        async_ (Union[Unset, bool]):  Default: False.
        atomic_mode (Union[Unset, MapPatchObjectAtomicMode]):  Default:
            MapPatchObjectAtomicMode.ALL.
        flush_mode (Union[Unset, MapPatchObjectFlushMode]):  Default:
            MapPatchObjectFlushMode.AUTO.
        identifier (Union[Unset, MapPatchObjectIdentifier]):  Default:
            MapPatchObjectIdentifier.UID.
        import_mode (Union[Unset, MapPatchObjectImportMode]):  Default:
            MapPatchObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, MapPatchObjectImportReportMode]):  Default:
            MapPatchObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, MapPatchObjectImportStrategy]):  Default:
            MapPatchObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, MapPatchObjectPreheatMode]):  Default:
            MapPatchObjectPreheatMode.REFERENCE.
        root_junction (Union[Unset, MapPatchObjectRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, MapPatchObjectUserOverrideMode]):  Default:
            MapPatchObjectUserOverrideMode.NONE.
        body (JsonPatch):
