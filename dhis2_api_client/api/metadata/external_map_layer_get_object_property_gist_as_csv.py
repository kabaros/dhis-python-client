...
from ...models.external_map_layer_get_object_property_gist_as_csv_auto import (
    ExternalMapLayerGetObjectPropertyGistAsCsvAuto,
)
from ...models.external_map_layer_get_object_property_gist_as_csv_property import (
    ExternalMapLayerGetObjectPropertyGistAsCsvProperty,
)
from ...models.external_map_layer_get_object_property_gist_as_csv_root_junction import (
    ExternalMapLayerGetObjectPropertyGistAsCsvRootJunction,
)
...
def _get_kwargs(
    uid: str,
    property_: ExternalMapLayerGetObjectPropertyGistAsCsvProperty,
    *,
    absolute_urls: Union[Unset, bool] = False,
    auto: Union[Unset, ExternalMapLayerGetObjectPropertyGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, ExternalMapLayerGetObjectPropertyGistAsCsvRootJunction
    ] = ExternalMapLayerGetObjectPropertyGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/externalMapLayers/{uid}/{property_}/gist.csv",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, ExternalMapLayerGetObjectPropertyGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, ExternalMapLayerGetObjectPropertyGistAsCsvRootJunction]):
            Default: ExternalMapLayerGetObjectPropertyGistAsCsvRootJunction.AND.
