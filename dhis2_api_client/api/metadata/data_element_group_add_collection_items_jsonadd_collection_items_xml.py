...
from ...models.data_element_group_add_collection_items_jsonadd_collection_items_xml_property import (
    DataElementGroupAddCollectionItemsJsonaddCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: DataElementGroupAddCollectionItemsJsonaddCollectionItemsXmlProperty,
    *,
