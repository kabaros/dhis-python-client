...
from ...models.external_map_layer_get_object_list_csv_root_junction import ExternalMapLayerGetObjectListCsvRootJunction
...
def _get_kwargs(
    *,
    ...
    root_junction: Union[Unset, ExternalMapLayerGetObjectListCsvRootJunction] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/externalMapLayers/#getObjectListCsv",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, ExternalMapLayerGetObjectListCsvRootJunction]):
