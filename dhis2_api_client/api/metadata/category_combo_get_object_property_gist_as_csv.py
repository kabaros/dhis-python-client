...
from ...models.category_combo_get_object_property_gist_as_csv_auto import CategoryComboGetObjectPropertyGistAsCsvAuto
from ...models.category_combo_get_object_property_gist_as_csv_property import (
    CategoryComboGetObjectPropertyGistAsCsvProperty,
)
from ...models.category_combo_get_object_property_gist_as_csv_root_junction import (
    CategoryComboGetObjectPropertyGistAsCsvRootJunction,
)
...
def _get_kwargs(
    uid: str,
    property_: CategoryComboGetObjectPropertyGistAsCsvProperty,
    *,
    absolute_urls: Union[Unset, bool] = False,
    auto: Union[Unset, CategoryComboGetObjectPropertyGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, CategoryComboGetObjectPropertyGistAsCsvRootJunction
    ] = CategoryComboGetObjectPropertyGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/categoryCombos/{uid}/{property_}/gist.csv",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, CategoryComboGetObjectPropertyGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, CategoryComboGetObjectPropertyGistAsCsvRootJunction]):
            Default: CategoryComboGetObjectPropertyGistAsCsvRootJunction.AND.
