...
from ...models.category_combo_delete_collection_items_jsondelete_collection_items_xml_property import (
    CategoryComboDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: CategoryComboDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
    *,
