...
from ...models.data_element_group_set_delete_collection_item_property import (
    DataElementGroupSetDeleteCollectionItemProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: DataElementGroupSetDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/dataElementGroupSets/{uid}/{property_}/{item_id}",
    }
