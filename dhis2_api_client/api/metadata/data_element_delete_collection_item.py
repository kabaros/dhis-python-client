...
from ...models.data_element_delete_collection_item_property import DataElementDeleteCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: DataElementDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/dataElements/{uid}/{property_}/{item_id}",
    }
