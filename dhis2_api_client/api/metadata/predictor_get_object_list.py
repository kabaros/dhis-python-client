...
from ...models.predictor_get_object_list_response_200 import PredictorGetObjectListResponse200
from ...models.predictor_get_object_list_root_junction import PredictorGetObjectListRootJunction
...
def _get_kwargs(
    *,
    ...
    root_junction: Union[Unset, PredictorGetObjectListRootJunction] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
) -> Optional[Union[PredictorGetObjectListResponse200, WebMessage]]:
    if response.status_code == 200:
        response_200 = PredictorGetObjectListResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[PredictorGetObjectListResponse200, WebMessage]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, PredictorGetObjectListRootJunction]):
...
def sync(
    *,
    ...
    Returns:
        Union[PredictorGetObjectListResponse200, WebMessage]
    """
