...
from ...models.indicator_delete_collection_item_property import IndicatorDeleteCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: IndicatorDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/indicators/{uid}/{property_}/{item_id}",
    }
