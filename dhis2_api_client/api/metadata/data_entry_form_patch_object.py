...
from ...models.data_entry_form_patch_object_atomic_mode import DataEntryFormPatchObjectAtomicMode
from ...models.data_entry_form_patch_object_flush_mode import DataEntryFormPatchObjectFlushMode
from ...models.data_entry_form_patch_object_identifier import DataEntryFormPatchObjectIdentifier
from ...models.data_entry_form_patch_object_import_mode import DataEntryFormPatchObjectImportMode
from ...models.data_entry_form_patch_object_import_report_mode import DataEntryFormPatchObjectImportReportMode
from ...models.data_entry_form_patch_object_import_strategy import DataEntryFormPatchObjectImportStrategy
from ...models.data_entry_form_patch_object_preheat_mode import DataEntryFormPatchObjectPreheatMode
from ...models.data_entry_form_patch_object_root_junction import DataEntryFormPatchObjectRootJunction
from ...models.data_entry_form_patch_object_user_override_mode import DataEntryFormPatchObjectUserOverrideMode
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[Unset, DataEntryFormPatchObjectAtomicMode] = DataEntryFormPatchObjectAtomicMode.ALL,
    flush_mode: Union[Unset, DataEntryFormPatchObjectFlushMode] = DataEntryFormPatchObjectFlushMode.AUTO,
    identifier: Union[Unset, DataEntryFormPatchObjectIdentifier] = DataEntryFormPatchObjectIdentifier.UID,
    import_mode: Union[Unset, DataEntryFormPatchObjectImportMode] = DataEntryFormPatchObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, DataEntryFormPatchObjectImportReportMode
    ] = DataEntryFormPatchObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, DataEntryFormPatchObjectImportStrategy
    ] = DataEntryFormPatchObjectImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, DataEntryFormPatchObjectPreheatMode] = DataEntryFormPatchObjectPreheatMode.REFERENCE,
    root_junction: Union[Unset, DataEntryFormPatchObjectRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, DataEntryFormPatchObjectUserOverrideMode
    ] = DataEntryFormPatchObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, DataEntryFormPatchObjectAtomicMode]):  Default:
            DataEntryFormPatchObjectAtomicMode.ALL.
        flush_mode (Union[Unset, DataEntryFormPatchObjectFlushMode]):  Default:
            DataEntryFormPatchObjectFlushMode.AUTO.
        identifier (Union[Unset, DataEntryFormPatchObjectIdentifier]):  Default:
            DataEntryFormPatchObjectIdentifier.UID.
        import_mode (Union[Unset, DataEntryFormPatchObjectImportMode]):  Default:
            DataEntryFormPatchObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, DataEntryFormPatchObjectImportReportMode]):  Default:
            DataEntryFormPatchObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, DataEntryFormPatchObjectImportStrategy]):  Default:
            DataEntryFormPatchObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, DataEntryFormPatchObjectPreheatMode]):  Default:
            DataEntryFormPatchObjectPreheatMode.REFERENCE.
        root_junction (Union[Unset, DataEntryFormPatchObjectRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, DataEntryFormPatchObjectUserOverrideMode]):  Default:
            DataEntryFormPatchObjectUserOverrideMode.NONE.
        body (JsonPatch):
