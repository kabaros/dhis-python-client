...
from ...models.indicator_type_delete_collection_item_property import IndicatorTypeDeleteCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: IndicatorTypeDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/indicatorTypes/{uid}/{property_}/{item_id}",
    }
