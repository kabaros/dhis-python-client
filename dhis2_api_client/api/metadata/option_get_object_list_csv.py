...
from ...models.option_get_object_list_csv_root_junction import OptionGetObjectListCsvRootJunction
...
def _get_kwargs(
    *,
    ...
    root_junction: Union[Unset, OptionGetObjectListCsvRootJunction] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, OptionGetObjectListCsvRootJunction]):
