...
from ...models.external_map_layer_bulk_sharing_atomic_mode import ExternalMapLayerBulkSharingAtomicMode
from ...models.external_map_layer_bulk_sharing_flush_mode import ExternalMapLayerBulkSharingFlushMode
from ...models.external_map_layer_bulk_sharing_identifier import ExternalMapLayerBulkSharingIdentifier
from ...models.external_map_layer_bulk_sharing_import_mode import ExternalMapLayerBulkSharingImportMode
from ...models.external_map_layer_bulk_sharing_import_report_mode import ExternalMapLayerBulkSharingImportReportMode
from ...models.external_map_layer_bulk_sharing_import_strategy import ExternalMapLayerBulkSharingImportStrategy
from ...models.external_map_layer_bulk_sharing_preheat_mode import ExternalMapLayerBulkSharingPreheatMode
from ...models.external_map_layer_bulk_sharing_root_junction import ExternalMapLayerBulkSharingRootJunction
from ...models.external_map_layer_bulk_sharing_user_override_mode import ExternalMapLayerBulkSharingUserOverrideMode
...
def _get_kwargs(
    *,
    ...
    atomic_mode: Union[Unset, ExternalMapLayerBulkSharingAtomicMode] = ExternalMapLayerBulkSharingAtomicMode.ALL,
    flush_mode: Union[Unset, ExternalMapLayerBulkSharingFlushMode] = ExternalMapLayerBulkSharingFlushMode.AUTO,
    identifier: Union[Unset, ExternalMapLayerBulkSharingIdentifier] = ExternalMapLayerBulkSharingIdentifier.UID,
    import_mode: Union[Unset, ExternalMapLayerBulkSharingImportMode] = ExternalMapLayerBulkSharingImportMode.COMMIT,
    import_report_mode: Union[
        Unset, ExternalMapLayerBulkSharingImportReportMode
    ] = ExternalMapLayerBulkSharingImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, ExternalMapLayerBulkSharingImportStrategy
    ] = ExternalMapLayerBulkSharingImportStrategy.CREATE_AND_UPDATE,
    ...
    preheat_mode: Union[
        Unset, ExternalMapLayerBulkSharingPreheatMode
    ] = ExternalMapLayerBulkSharingPreheatMode.REFERENCE,
    root_junction: Union[Unset, ExternalMapLayerBulkSharingRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, ExternalMapLayerBulkSharingUserOverrideMode
    ] = ExternalMapLayerBulkSharingUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, ExternalMapLayerBulkSharingAtomicMode]):  Default:
            ExternalMapLayerBulkSharingAtomicMode.ALL.
        flush_mode (Union[Unset, ExternalMapLayerBulkSharingFlushMode]):  Default:
            ExternalMapLayerBulkSharingFlushMode.AUTO.
        identifier (Union[Unset, ExternalMapLayerBulkSharingIdentifier]):  Default:
            ExternalMapLayerBulkSharingIdentifier.UID.
        import_mode (Union[Unset, ExternalMapLayerBulkSharingImportMode]):  Default:
            ExternalMapLayerBulkSharingImportMode.COMMIT.
        import_report_mode (Union[Unset, ExternalMapLayerBulkSharingImportReportMode]):  Default:
            ExternalMapLayerBulkSharingImportReportMode.ERRORS.
        import_strategy (Union[Unset, ExternalMapLayerBulkSharingImportStrategy]):  Default:
            ExternalMapLayerBulkSharingImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, ExternalMapLayerBulkSharingPreheatMode]):  Default:
            ExternalMapLayerBulkSharingPreheatMode.REFERENCE.
        root_junction (Union[Unset, ExternalMapLayerBulkSharingRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, ExternalMapLayerBulkSharingUserOverrideMode]):  Default:
            ExternalMapLayerBulkSharingUserOverrideMode.NONE.
        body (BulkJsonPatch):
