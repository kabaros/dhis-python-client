...
from ...models.data_entry_form_add_collection_items_jsonadd_collection_items_xml_property import (
    DataEntryFormAddCollectionItemsJsonaddCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: DataEntryFormAddCollectionItemsJsonaddCollectionItemsXmlProperty,
    *,
