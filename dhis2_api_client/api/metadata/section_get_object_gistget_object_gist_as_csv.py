...
from ...models.section_get_object_gistget_object_gist_as_csv_auto import SectionGetObjectGistgetObjectGistAsCsvAuto
from ...models.section_get_object_gistget_object_gist_as_csv_response_200 import (
    SectionGetObjectGistgetObjectGistAsCsvResponse200,
)
from ...models.section_get_object_gistget_object_gist_as_csv_root_junction import (
    SectionGetObjectGistgetObjectGistAsCsvRootJunction,
)
...
def _get_kwargs(
    ...
    *,
    ...
    auto: Union[Unset, SectionGetObjectGistgetObjectGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, SectionGetObjectGistgetObjectGistAsCsvRootJunction
    ] = SectionGetObjectGistgetObjectGistAsCsvRootJunction.AND,
...
) -> Optional[Union[SectionGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]]:
    if response.status_code == 200:
        response_200 = SectionGetObjectGistgetObjectGistAsCsvResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[SectionGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, SectionGetObjectGistgetObjectGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, SectionGetObjectGistgetObjectGistAsCsvRootJunction]):
            Default: SectionGetObjectGistgetObjectGistAsCsvRootJunction.AND.
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[SectionGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]
    """
