...
from ...models.indicator_type_get_object_property_gist_as_csv_auto import IndicatorTypeGetObjectPropertyGistAsCsvAuto
from ...models.indicator_type_get_object_property_gist_as_csv_property import (
    IndicatorTypeGetObjectPropertyGistAsCsvProperty,
)
from ...models.indicator_type_get_object_property_gist_as_csv_root_junction import (
    IndicatorTypeGetObjectPropertyGistAsCsvRootJunction,
)
...
def _get_kwargs(
    uid: str,
    property_: IndicatorTypeGetObjectPropertyGistAsCsvProperty,
    *,
    absolute_urls: Union[Unset, bool] = False,
    auto: Union[Unset, IndicatorTypeGetObjectPropertyGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, IndicatorTypeGetObjectPropertyGistAsCsvRootJunction
    ] = IndicatorTypeGetObjectPropertyGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/indicatorTypes/{uid}/{property_}/gist.csv",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, IndicatorTypeGetObjectPropertyGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, IndicatorTypeGetObjectPropertyGistAsCsvRootJunction]):
            Default: IndicatorTypeGetObjectPropertyGistAsCsvRootJunction.AND.
