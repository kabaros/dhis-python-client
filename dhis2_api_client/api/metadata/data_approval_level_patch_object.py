...
from ...models.data_approval_level_patch_object_atomic_mode import DataApprovalLevelPatchObjectAtomicMode
from ...models.data_approval_level_patch_object_flush_mode import DataApprovalLevelPatchObjectFlushMode
from ...models.data_approval_level_patch_object_identifier import DataApprovalLevelPatchObjectIdentifier
from ...models.data_approval_level_patch_object_import_mode import DataApprovalLevelPatchObjectImportMode
from ...models.data_approval_level_patch_object_import_report_mode import DataApprovalLevelPatchObjectImportReportMode
from ...models.data_approval_level_patch_object_import_strategy import DataApprovalLevelPatchObjectImportStrategy
from ...models.data_approval_level_patch_object_preheat_mode import DataApprovalLevelPatchObjectPreheatMode
from ...models.data_approval_level_patch_object_root_junction import DataApprovalLevelPatchObjectRootJunction
from ...models.data_approval_level_patch_object_user_override_mode import DataApprovalLevelPatchObjectUserOverrideMode
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[Unset, DataApprovalLevelPatchObjectAtomicMode] = DataApprovalLevelPatchObjectAtomicMode.ALL,
    flush_mode: Union[Unset, DataApprovalLevelPatchObjectFlushMode] = DataApprovalLevelPatchObjectFlushMode.AUTO,
    identifier: Union[Unset, DataApprovalLevelPatchObjectIdentifier] = DataApprovalLevelPatchObjectIdentifier.UID,
    import_mode: Union[Unset, DataApprovalLevelPatchObjectImportMode] = DataApprovalLevelPatchObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, DataApprovalLevelPatchObjectImportReportMode
    ] = DataApprovalLevelPatchObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, DataApprovalLevelPatchObjectImportStrategy
    ] = DataApprovalLevelPatchObjectImportStrategy.CREATE_AND_UPDATE,
    ...
    preheat_mode: Union[
        Unset, DataApprovalLevelPatchObjectPreheatMode
    ] = DataApprovalLevelPatchObjectPreheatMode.REFERENCE,
    root_junction: Union[Unset, DataApprovalLevelPatchObjectRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, DataApprovalLevelPatchObjectUserOverrideMode
    ] = DataApprovalLevelPatchObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, DataApprovalLevelPatchObjectAtomicMode]):  Default:
            DataApprovalLevelPatchObjectAtomicMode.ALL.
        flush_mode (Union[Unset, DataApprovalLevelPatchObjectFlushMode]):  Default:
            DataApprovalLevelPatchObjectFlushMode.AUTO.
        identifier (Union[Unset, DataApprovalLevelPatchObjectIdentifier]):  Default:
            DataApprovalLevelPatchObjectIdentifier.UID.
        import_mode (Union[Unset, DataApprovalLevelPatchObjectImportMode]):  Default:
            DataApprovalLevelPatchObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, DataApprovalLevelPatchObjectImportReportMode]):  Default:
            DataApprovalLevelPatchObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, DataApprovalLevelPatchObjectImportStrategy]):  Default:
            DataApprovalLevelPatchObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, DataApprovalLevelPatchObjectPreheatMode]):  Default:
            DataApprovalLevelPatchObjectPreheatMode.REFERENCE.
        root_junction (Union[Unset, DataApprovalLevelPatchObjectRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, DataApprovalLevelPatchObjectUserOverrideMode]):  Default:
            DataApprovalLevelPatchObjectUserOverrideMode.NONE.
        body (JsonPatch):
