...
from ...models.organisation_unit_level_add_collection_items_jsonadd_collection_items_xml_property import (
    OrganisationUnitLevelAddCollectionItemsJsonaddCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: OrganisationUnitLevelAddCollectionItemsJsonaddCollectionItemsXmlProperty,
    *,
