...
from ...models.constant_bulk_sharing_atomic_mode import ConstantBulkSharingAtomicMode
from ...models.constant_bulk_sharing_flush_mode import ConstantBulkSharingFlushMode
from ...models.constant_bulk_sharing_identifier import ConstantBulkSharingIdentifier
from ...models.constant_bulk_sharing_import_mode import ConstantBulkSharingImportMode
from ...models.constant_bulk_sharing_import_report_mode import ConstantBulkSharingImportReportMode
from ...models.constant_bulk_sharing_import_strategy import ConstantBulkSharingImportStrategy
from ...models.constant_bulk_sharing_preheat_mode import ConstantBulkSharingPreheatMode
from ...models.constant_bulk_sharing_root_junction import ConstantBulkSharingRootJunction
from ...models.constant_bulk_sharing_user_override_mode import ConstantBulkSharingUserOverrideMode
...
def _get_kwargs(
    *,
    ...
    atomic_mode: Union[Unset, ConstantBulkSharingAtomicMode] = ConstantBulkSharingAtomicMode.ALL,
    flush_mode: Union[Unset, ConstantBulkSharingFlushMode] = ConstantBulkSharingFlushMode.AUTO,
    identifier: Union[Unset, ConstantBulkSharingIdentifier] = ConstantBulkSharingIdentifier.UID,
    import_mode: Union[Unset, ConstantBulkSharingImportMode] = ConstantBulkSharingImportMode.COMMIT,
    import_report_mode: Union[Unset, ConstantBulkSharingImportReportMode] = ConstantBulkSharingImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, ConstantBulkSharingImportStrategy
    ] = ConstantBulkSharingImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, ConstantBulkSharingPreheatMode] = ConstantBulkSharingPreheatMode.REFERENCE,
    root_junction: Union[Unset, ConstantBulkSharingRootJunction] = UNSET,
    skip_sharing: Union[Unset, bool] = False,
    skip_translation: Union[Unset, bool] = False,
    skip_validation: Union[Unset, bool] = False,
    user: Union[Unset, str] = UNSET,
    user_override_mode: Union[Unset, ConstantBulkSharingUserOverrideMode] = ConstantBulkSharingUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, ConstantBulkSharingAtomicMode]):  Default:
            ConstantBulkSharingAtomicMode.ALL.
        flush_mode (Union[Unset, ConstantBulkSharingFlushMode]):  Default:
            ConstantBulkSharingFlushMode.AUTO.
        identifier (Union[Unset, ConstantBulkSharingIdentifier]):  Default:
            ConstantBulkSharingIdentifier.UID.
        import_mode (Union[Unset, ConstantBulkSharingImportMode]):  Default:
            ConstantBulkSharingImportMode.COMMIT.
        import_report_mode (Union[Unset, ConstantBulkSharingImportReportMode]):  Default:
            ConstantBulkSharingImportReportMode.ERRORS.
        import_strategy (Union[Unset, ConstantBulkSharingImportStrategy]):  Default:
            ConstantBulkSharingImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, ConstantBulkSharingPreheatMode]):  Default:
            ConstantBulkSharingPreheatMode.REFERENCE.
        root_junction (Union[Unset, ConstantBulkSharingRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, ConstantBulkSharingUserOverrideMode]):  Default:
            ConstantBulkSharingUserOverrideMode.NONE.
        body (BulkJsonPatch):
