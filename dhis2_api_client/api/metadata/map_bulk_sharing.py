...
from ...models.map_bulk_sharing_atomic_mode import MapBulkSharingAtomicMode
from ...models.map_bulk_sharing_flush_mode import MapBulkSharingFlushMode
from ...models.map_bulk_sharing_identifier import MapBulkSharingIdentifier
from ...models.map_bulk_sharing_import_mode import MapBulkSharingImportMode
from ...models.map_bulk_sharing_import_report_mode import MapBulkSharingImportReportMode
from ...models.map_bulk_sharing_import_strategy import MapBulkSharingImportStrategy
from ...models.map_bulk_sharing_preheat_mode import MapBulkSharingPreheatMode
from ...models.map_bulk_sharing_root_junction import MapBulkSharingRootJunction
from ...models.map_bulk_sharing_user_override_mode import MapBulkSharingUserOverrideMode
...
def _get_kwargs(
    *,
    ...
    atomic_mode: Union[Unset, MapBulkSharingAtomicMode] = MapBulkSharingAtomicMode.ALL,
    flush_mode: Union[Unset, MapBulkSharingFlushMode] = MapBulkSharingFlushMode.AUTO,
    identifier: Union[Unset, MapBulkSharingIdentifier] = MapBulkSharingIdentifier.UID,
    import_mode: Union[Unset, MapBulkSharingImportMode] = MapBulkSharingImportMode.COMMIT,
    import_report_mode: Union[Unset, MapBulkSharingImportReportMode] = MapBulkSharingImportReportMode.ERRORS,
    import_strategy: Union[Unset, MapBulkSharingImportStrategy] = MapBulkSharingImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, MapBulkSharingPreheatMode] = MapBulkSharingPreheatMode.REFERENCE,
    root_junction: Union[Unset, MapBulkSharingRootJunction] = UNSET,
    skip_sharing: Union[Unset, bool] = False,
    skip_translation: Union[Unset, bool] = False,
    skip_validation: Union[Unset, bool] = False,
    user: Union[Unset, str] = UNSET,
    user_override_mode: Union[Unset, MapBulkSharingUserOverrideMode] = MapBulkSharingUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, MapBulkSharingAtomicMode]):  Default:
            MapBulkSharingAtomicMode.ALL.
        flush_mode (Union[Unset, MapBulkSharingFlushMode]):  Default:
            MapBulkSharingFlushMode.AUTO.
        identifier (Union[Unset, MapBulkSharingIdentifier]):  Default:
            MapBulkSharingIdentifier.UID.
        import_mode (Union[Unset, MapBulkSharingImportMode]):  Default:
            MapBulkSharingImportMode.COMMIT.
        import_report_mode (Union[Unset, MapBulkSharingImportReportMode]):  Default:
            MapBulkSharingImportReportMode.ERRORS.
        import_strategy (Union[Unset, MapBulkSharingImportStrategy]):  Default:
            MapBulkSharingImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, MapBulkSharingPreheatMode]):  Default:
            MapBulkSharingPreheatMode.REFERENCE.
        root_junction (Union[Unset, MapBulkSharingRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, MapBulkSharingUserOverrideMode]):  Default:
            MapBulkSharingUserOverrideMode.NONE.
        body (BulkJsonPatch):
