...
from ...models.option_set_add_collection_items_jsonadd_collection_items_xml_property import (
    OptionSetAddCollectionItemsJsonaddCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: OptionSetAddCollectionItemsJsonaddCollectionItemsXmlProperty,
    *,
