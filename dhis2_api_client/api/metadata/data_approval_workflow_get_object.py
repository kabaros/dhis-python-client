...
from ...models.data_approval_workflow_get_object_root_junction import DataApprovalWorkflowGetObjectRootJunction
...
def _get_kwargs(
    ...
    *,
    ...
    root_junction: Union[Unset, DataApprovalWorkflowGetObjectRootJunction] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
) -> Optional[Union[DataApprovalWorkflow, WebMessage]]:
    if response.status_code == 200:
        response_200 = DataApprovalWorkflow.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DataApprovalWorkflow, WebMessage]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, DataApprovalWorkflowGetObjectRootJunction]):
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[DataApprovalWorkflow, WebMessage]
    """
