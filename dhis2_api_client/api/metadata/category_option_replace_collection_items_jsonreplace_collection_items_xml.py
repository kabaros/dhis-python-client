...
from ...models.category_option_replace_collection_items_jsonreplace_collection_items_xml_property import (
    CategoryOptionReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: CategoryOptionReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
    *,
