...
from ...models.data_approval_level_delete_collection_item_property import DataApprovalLevelDeleteCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: DataApprovalLevelDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/dataApprovalLevels/{uid}/{property_}/{item_id}",
    }
