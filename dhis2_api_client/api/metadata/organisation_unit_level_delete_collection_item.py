...
from ...models.organisation_unit_level_delete_collection_item_property import (
    OrganisationUnitLevelDeleteCollectionItemProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: OrganisationUnitLevelDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/organisationUnitLevels/{uid}/{property_}/{item_id}",
    }
