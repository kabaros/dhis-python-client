...
from ...models.category_delete_collection_items_jsondelete_collection_items_xml_property import (
    CategoryDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: CategoryDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
    *,
