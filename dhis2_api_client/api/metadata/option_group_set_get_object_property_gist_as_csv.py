...
from ...models.option_group_set_get_object_property_gist_as_csv_auto import OptionGroupSetGetObjectPropertyGistAsCsvAuto
from ...models.option_group_set_get_object_property_gist_as_csv_property import (
    OptionGroupSetGetObjectPropertyGistAsCsvProperty,
)
from ...models.option_group_set_get_object_property_gist_as_csv_root_junction import (
    OptionGroupSetGetObjectPropertyGistAsCsvRootJunction,
)
...
def _get_kwargs(
    uid: str,
    property_: OptionGroupSetGetObjectPropertyGistAsCsvProperty,
    *,
    absolute_urls: Union[Unset, bool] = False,
    auto: Union[Unset, OptionGroupSetGetObjectPropertyGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, OptionGroupSetGetObjectPropertyGistAsCsvRootJunction
    ] = OptionGroupSetGetObjectPropertyGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/optionGroupSets/{uid}/{property_}/gist.csv",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, OptionGroupSetGetObjectPropertyGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, OptionGroupSetGetObjectPropertyGistAsCsvRootJunction]):
            Default: OptionGroupSetGetObjectPropertyGistAsCsvRootJunction.AND.
