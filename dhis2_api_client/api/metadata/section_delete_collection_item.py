...
from ...models.section_delete_collection_item_property import SectionDeleteCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: SectionDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/sections/{uid}/{property_}/{item_id}",
    }
