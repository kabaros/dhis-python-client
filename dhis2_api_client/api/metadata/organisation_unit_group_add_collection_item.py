...
from ...models.organisation_unit_group_add_collection_item_property import (
    OrganisationUnitGroupAddCollectionItemProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: OrganisationUnitGroupAddCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
