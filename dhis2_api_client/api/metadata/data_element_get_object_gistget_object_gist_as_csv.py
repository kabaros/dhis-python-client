...
from ...models.data_element_get_object_gistget_object_gist_as_csv_auto import (
    DataElementGetObjectGistgetObjectGistAsCsvAuto,
)
from ...models.data_element_get_object_gistget_object_gist_as_csv_response_200 import (
    DataElementGetObjectGistgetObjectGistAsCsvResponse200,
)
from ...models.data_element_get_object_gistget_object_gist_as_csv_root_junction import (
    DataElementGetObjectGistgetObjectGistAsCsvRootJunction,
)
...
def _get_kwargs(
    ...
    *,
    ...
    auto: Union[Unset, DataElementGetObjectGistgetObjectGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, DataElementGetObjectGistgetObjectGistAsCsvRootJunction
    ] = DataElementGetObjectGistgetObjectGistAsCsvRootJunction.AND,
...
) -> Optional[Union[DataElementGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]]:
    if response.status_code == 200:
        response_200 = DataElementGetObjectGistgetObjectGistAsCsvResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DataElementGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, DataElementGetObjectGistgetObjectGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, DataElementGetObjectGistgetObjectGistAsCsvRootJunction]):
            Default: DataElementGetObjectGistgetObjectGistAsCsvRootJunction.AND.
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[DataElementGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]
    """
