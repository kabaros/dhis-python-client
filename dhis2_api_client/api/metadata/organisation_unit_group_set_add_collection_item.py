...
from ...models.organisation_unit_group_set_add_collection_item_property import (
    OrganisationUnitGroupSetAddCollectionItemProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: OrganisationUnitGroupSetAddCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
