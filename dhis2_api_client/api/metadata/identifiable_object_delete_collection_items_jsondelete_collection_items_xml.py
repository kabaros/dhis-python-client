...
from ...models.identifiable_object_delete_collection_items_jsondelete_collection_items_xml_property import (
    IdentifiableObjectDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: IdentifiableObjectDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
    *,
