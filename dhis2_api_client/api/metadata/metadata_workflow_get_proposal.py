...
from ...models.metadata_workflow_get_proposal_auto import MetadataWorkflowGetProposalAuto
from ...models.metadata_workflow_get_proposal_response_200 import MetadataWorkflowGetProposalResponse200
from ...models.metadata_workflow_get_proposal_root_junction import MetadataWorkflowGetProposalRootJunction
...
def _get_kwargs(
    ...
    *,
    ...
    auto: Union[Unset, MetadataWorkflowGetProposalAuto] = UNSET,
    ...
    root_junction: Union[Unset, MetadataWorkflowGetProposalRootJunction] = MetadataWorkflowGetProposalRootJunction.AND,
...
) -> Optional[Union[MetadataWorkflowGetProposalResponse200, WebMessage]]:
    if response.status_code == 200:
        response_200 = MetadataWorkflowGetProposalResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[MetadataWorkflowGetProposalResponse200, WebMessage]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, MetadataWorkflowGetProposalAuto]):
        ...
        root_junction (Union[Unset, MetadataWorkflowGetProposalRootJunction]):  Default:
            MetadataWorkflowGetProposalRootJunction.AND.
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[MetadataWorkflowGetProposalResponse200, WebMessage]
    """
