...
from ...models.attribute_patch_object_atomic_mode import AttributePatchObjectAtomicMode
from ...models.attribute_patch_object_flush_mode import AttributePatchObjectFlushMode
from ...models.attribute_patch_object_identifier import AttributePatchObjectIdentifier
from ...models.attribute_patch_object_import_mode import AttributePatchObjectImportMode
from ...models.attribute_patch_object_import_report_mode import AttributePatchObjectImportReportMode
from ...models.attribute_patch_object_import_strategy import AttributePatchObjectImportStrategy
from ...models.attribute_patch_object_preheat_mode import AttributePatchObjectPreheatMode
from ...models.attribute_patch_object_root_junction import AttributePatchObjectRootJunction
from ...models.attribute_patch_object_user_override_mode import AttributePatchObjectUserOverrideMode
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[Unset, AttributePatchObjectAtomicMode] = AttributePatchObjectAtomicMode.ALL,
    flush_mode: Union[Unset, AttributePatchObjectFlushMode] = AttributePatchObjectFlushMode.AUTO,
    identifier: Union[Unset, AttributePatchObjectIdentifier] = AttributePatchObjectIdentifier.UID,
    import_mode: Union[Unset, AttributePatchObjectImportMode] = AttributePatchObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, AttributePatchObjectImportReportMode
    ] = AttributePatchObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, AttributePatchObjectImportStrategy
    ] = AttributePatchObjectImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, AttributePatchObjectPreheatMode] = AttributePatchObjectPreheatMode.REFERENCE,
    root_junction: Union[Unset, AttributePatchObjectRootJunction] = UNSET,
    skip_sharing: Union[Unset, bool] = False,
    skip_translation: Union[Unset, bool] = False,
    skip_validation: Union[Unset, bool] = False,
    user: Union[Unset, str] = UNSET,
    user_override_mode: Union[Unset, AttributePatchObjectUserOverrideMode] = AttributePatchObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, AttributePatchObjectAtomicMode]):  Default:
            AttributePatchObjectAtomicMode.ALL.
        flush_mode (Union[Unset, AttributePatchObjectFlushMode]):  Default:
            AttributePatchObjectFlushMode.AUTO.
        identifier (Union[Unset, AttributePatchObjectIdentifier]):  Default:
            AttributePatchObjectIdentifier.UID.
        import_mode (Union[Unset, AttributePatchObjectImportMode]):  Default:
            AttributePatchObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, AttributePatchObjectImportReportMode]):  Default:
            AttributePatchObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, AttributePatchObjectImportStrategy]):  Default:
            AttributePatchObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, AttributePatchObjectPreheatMode]):  Default:
            AttributePatchObjectPreheatMode.REFERENCE.
        root_junction (Union[Unset, AttributePatchObjectRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, AttributePatchObjectUserOverrideMode]):  Default:
            AttributePatchObjectUserOverrideMode.NONE.
        body (JsonPatch):
