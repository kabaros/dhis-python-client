...
from ...models.section_get_object_property_gist_as_csv_auto import SectionGetObjectPropertyGistAsCsvAuto
from ...models.section_get_object_property_gist_as_csv_property import SectionGetObjectPropertyGistAsCsvProperty
from ...models.section_get_object_property_gist_as_csv_root_junction import (
    SectionGetObjectPropertyGistAsCsvRootJunction,
)
...
def _get_kwargs(
    uid: str,
    property_: SectionGetObjectPropertyGistAsCsvProperty,
    *,
    absolute_urls: Union[Unset, bool] = False,
    auto: Union[Unset, SectionGetObjectPropertyGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, SectionGetObjectPropertyGistAsCsvRootJunction
    ] = SectionGetObjectPropertyGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/sections/{uid}/{property_}/gist.csv",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, SectionGetObjectPropertyGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, SectionGetObjectPropertyGistAsCsvRootJunction]):  Default:
            SectionGetObjectPropertyGistAsCsvRootJunction.AND.
