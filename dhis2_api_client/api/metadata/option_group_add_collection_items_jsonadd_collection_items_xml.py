...
from ...models.option_group_add_collection_items_jsonadd_collection_items_xml_property import (
    OptionGroupAddCollectionItemsJsonaddCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: OptionGroupAddCollectionItemsJsonaddCollectionItemsXmlProperty,
    *,
