...
from ...models.constant_patch_object_atomic_mode import ConstantPatchObjectAtomicMode
from ...models.constant_patch_object_flush_mode import ConstantPatchObjectFlushMode
from ...models.constant_patch_object_identifier import ConstantPatchObjectIdentifier
from ...models.constant_patch_object_import_mode import ConstantPatchObjectImportMode
from ...models.constant_patch_object_import_report_mode import ConstantPatchObjectImportReportMode
from ...models.constant_patch_object_import_strategy import ConstantPatchObjectImportStrategy
from ...models.constant_patch_object_preheat_mode import ConstantPatchObjectPreheatMode
from ...models.constant_patch_object_root_junction import ConstantPatchObjectRootJunction
from ...models.constant_patch_object_user_override_mode import ConstantPatchObjectUserOverrideMode
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[Unset, ConstantPatchObjectAtomicMode] = ConstantPatchObjectAtomicMode.ALL,
    flush_mode: Union[Unset, ConstantPatchObjectFlushMode] = ConstantPatchObjectFlushMode.AUTO,
    identifier: Union[Unset, ConstantPatchObjectIdentifier] = ConstantPatchObjectIdentifier.UID,
    import_mode: Union[Unset, ConstantPatchObjectImportMode] = ConstantPatchObjectImportMode.COMMIT,
    import_report_mode: Union[Unset, ConstantPatchObjectImportReportMode] = ConstantPatchObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, ConstantPatchObjectImportStrategy
    ] = ConstantPatchObjectImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, ConstantPatchObjectPreheatMode] = ConstantPatchObjectPreheatMode.REFERENCE,
    root_junction: Union[Unset, ConstantPatchObjectRootJunction] = UNSET,
    skip_sharing: Union[Unset, bool] = False,
    skip_translation: Union[Unset, bool] = False,
    skip_validation: Union[Unset, bool] = False,
    user: Union[Unset, str] = UNSET,
    user_override_mode: Union[Unset, ConstantPatchObjectUserOverrideMode] = ConstantPatchObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, ConstantPatchObjectAtomicMode]):  Default:
            ConstantPatchObjectAtomicMode.ALL.
        flush_mode (Union[Unset, ConstantPatchObjectFlushMode]):  Default:
            ConstantPatchObjectFlushMode.AUTO.
        identifier (Union[Unset, ConstantPatchObjectIdentifier]):  Default:
            ConstantPatchObjectIdentifier.UID.
        import_mode (Union[Unset, ConstantPatchObjectImportMode]):  Default:
            ConstantPatchObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, ConstantPatchObjectImportReportMode]):  Default:
            ConstantPatchObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, ConstantPatchObjectImportStrategy]):  Default:
            ConstantPatchObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, ConstantPatchObjectPreheatMode]):  Default:
            ConstantPatchObjectPreheatMode.REFERENCE.
        root_junction (Union[Unset, ConstantPatchObjectRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, ConstantPatchObjectUserOverrideMode]):  Default:
            ConstantPatchObjectUserOverrideMode.NONE.
        body (JsonPatch):
