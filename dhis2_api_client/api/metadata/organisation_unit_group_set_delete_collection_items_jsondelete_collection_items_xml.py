...
from ...models.organisation_unit_group_set_delete_collection_items_jsondelete_collection_items_xml_property import (
    OrganisationUnitGroupSetDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: OrganisationUnitGroupSetDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
    *,
