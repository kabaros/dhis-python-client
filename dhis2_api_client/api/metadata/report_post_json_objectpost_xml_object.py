...
from ...models.report_post_json_objectpost_xml_object_atomic_mode import ReportPostJsonObjectpostXmlObjectAtomicMode
from ...models.report_post_json_objectpost_xml_object_flush_mode import ReportPostJsonObjectpostXmlObjectFlushMode
from ...models.report_post_json_objectpost_xml_object_identifier import ReportPostJsonObjectpostXmlObjectIdentifier
from ...models.report_post_json_objectpost_xml_object_import_mode import ReportPostJsonObjectpostXmlObjectImportMode
from ...models.report_post_json_objectpost_xml_object_import_report_mode import (
    ReportPostJsonObjectpostXmlObjectImportReportMode,
)
from ...models.report_post_json_objectpost_xml_object_import_strategy import (
    ReportPostJsonObjectpostXmlObjectImportStrategy,
)
from ...models.report_post_json_objectpost_xml_object_preheat_mode import ReportPostJsonObjectpostXmlObjectPreheatMode
from ...models.report_post_json_objectpost_xml_object_user_override_mode import (
    ReportPostJsonObjectpostXmlObjectUserOverrideMode,
)
...
def _get_kwargs(
    *,
    ...
    atomic_mode: Union[
        Unset, ReportPostJsonObjectpostXmlObjectAtomicMode
    ] = ReportPostJsonObjectpostXmlObjectAtomicMode.ALL,
    flush_mode: Union[
        Unset, ReportPostJsonObjectpostXmlObjectFlushMode
    ] = ReportPostJsonObjectpostXmlObjectFlushMode.AUTO,
    identifier: Union[
        Unset, ReportPostJsonObjectpostXmlObjectIdentifier
    ] = ReportPostJsonObjectpostXmlObjectIdentifier.UID,
    import_mode: Union[
        Unset, ReportPostJsonObjectpostXmlObjectImportMode
    ] = ReportPostJsonObjectpostXmlObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, ReportPostJsonObjectpostXmlObjectImportReportMode
    ] = ReportPostJsonObjectpostXmlObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, ReportPostJsonObjectpostXmlObjectImportStrategy
    ] = ReportPostJsonObjectpostXmlObjectImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    preheat_mode: Union[
        Unset, ReportPostJsonObjectpostXmlObjectPreheatMode
    ] = ReportPostJsonObjectpostXmlObjectPreheatMode.REFERENCE,
    ...
    user_override_mode: Union[
        Unset, ReportPostJsonObjectpostXmlObjectUserOverrideMode
    ] = ReportPostJsonObjectpostXmlObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, ReportPostJsonObjectpostXmlObjectAtomicMode]):  Default:
            ReportPostJsonObjectpostXmlObjectAtomicMode.ALL.
        flush_mode (Union[Unset, ReportPostJsonObjectpostXmlObjectFlushMode]):  Default:
            ReportPostJsonObjectpostXmlObjectFlushMode.AUTO.
        identifier (Union[Unset, ReportPostJsonObjectpostXmlObjectIdentifier]):  Default:
            ReportPostJsonObjectpostXmlObjectIdentifier.UID.
        import_mode (Union[Unset, ReportPostJsonObjectpostXmlObjectImportMode]):  Default:
            ReportPostJsonObjectpostXmlObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, ReportPostJsonObjectpostXmlObjectImportReportMode]):
            Default: ReportPostJsonObjectpostXmlObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, ReportPostJsonObjectpostXmlObjectImportStrategy]):  Default:
            ReportPostJsonObjectpostXmlObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, ReportPostJsonObjectpostXmlObjectPreheatMode]):  Default:
            ReportPostJsonObjectpostXmlObjectPreheatMode.REFERENCE.
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, ReportPostJsonObjectpostXmlObjectUserOverrideMode]):
            Default: ReportPostJsonObjectpostXmlObjectUserOverrideMode.NONE.
        body (Report):
