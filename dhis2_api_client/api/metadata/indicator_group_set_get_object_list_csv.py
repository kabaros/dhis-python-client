...
from ...models.indicator_group_set_get_object_list_csv_root_junction import (
    IndicatorGroupSetGetObjectListCsvRootJunction,
)
...
def _get_kwargs(
    *,
    ...
    root_junction: Union[Unset, IndicatorGroupSetGetObjectListCsvRootJunction] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/indicatorGroupSets/#getObjectListCsv",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, IndicatorGroupSetGetObjectListCsvRootJunction]):
