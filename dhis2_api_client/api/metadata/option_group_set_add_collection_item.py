...
from ...models.option_group_set_add_collection_item_property import OptionGroupSetAddCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: OptionGroupSetAddCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
