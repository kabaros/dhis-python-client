...
from ...models.attribute_get_object_property_gist_as_csv_auto import AttributeGetObjectPropertyGistAsCsvAuto
from ...models.attribute_get_object_property_gist_as_csv_property import AttributeGetObjectPropertyGistAsCsvProperty
from ...models.attribute_get_object_property_gist_as_csv_root_junction import (
    AttributeGetObjectPropertyGistAsCsvRootJunction,
)
...
def _get_kwargs(
    uid: str,
    property_: AttributeGetObjectPropertyGistAsCsvProperty,
    *,
    absolute_urls: Union[Unset, bool] = False,
    auto: Union[Unset, AttributeGetObjectPropertyGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, AttributeGetObjectPropertyGistAsCsvRootJunction
    ] = AttributeGetObjectPropertyGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/attributes/{uid}/{property_}/gist.csv",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, AttributeGetObjectPropertyGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, AttributeGetObjectPropertyGistAsCsvRootJunction]):  Default:
            AttributeGetObjectPropertyGistAsCsvRootJunction.AND.
