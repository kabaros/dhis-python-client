...
from ...models.option_set_replace_translations_body import OptionSetReplaceTranslationsBody
...
def _get_kwargs(
    uid: str,
    *,
    body: OptionSetReplaceTranslationsBody,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": f"/optionSets/{uid}/translations",
    }
