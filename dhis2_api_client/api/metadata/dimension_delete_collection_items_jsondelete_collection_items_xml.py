...
from ...models.dimension_delete_collection_items_jsondelete_collection_items_xml_property import (
    DimensionDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: DimensionDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
    *,
