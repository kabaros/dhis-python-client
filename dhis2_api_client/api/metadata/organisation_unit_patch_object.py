...
from ...models.organisation_unit_patch_object_atomic_mode import OrganisationUnitPatchObjectAtomicMode
from ...models.organisation_unit_patch_object_flush_mode import OrganisationUnitPatchObjectFlushMode
from ...models.organisation_unit_patch_object_identifier import OrganisationUnitPatchObjectIdentifier
from ...models.organisation_unit_patch_object_import_mode import OrganisationUnitPatchObjectImportMode
from ...models.organisation_unit_patch_object_import_report_mode import OrganisationUnitPatchObjectImportReportMode
from ...models.organisation_unit_patch_object_import_strategy import OrganisationUnitPatchObjectImportStrategy
from ...models.organisation_unit_patch_object_preheat_mode import OrganisationUnitPatchObjectPreheatMode
from ...models.organisation_unit_patch_object_root_junction import OrganisationUnitPatchObjectRootJunction
from ...models.organisation_unit_patch_object_user_override_mode import OrganisationUnitPatchObjectUserOverrideMode
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[Unset, OrganisationUnitPatchObjectAtomicMode] = OrganisationUnitPatchObjectAtomicMode.ALL,
    flush_mode: Union[Unset, OrganisationUnitPatchObjectFlushMode] = OrganisationUnitPatchObjectFlushMode.AUTO,
    identifier: Union[Unset, OrganisationUnitPatchObjectIdentifier] = OrganisationUnitPatchObjectIdentifier.UID,
    import_mode: Union[Unset, OrganisationUnitPatchObjectImportMode] = OrganisationUnitPatchObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, OrganisationUnitPatchObjectImportReportMode
    ] = OrganisationUnitPatchObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, OrganisationUnitPatchObjectImportStrategy
    ] = OrganisationUnitPatchObjectImportStrategy.CREATE_AND_UPDATE,
    ...
    preheat_mode: Union[
        Unset, OrganisationUnitPatchObjectPreheatMode
    ] = OrganisationUnitPatchObjectPreheatMode.REFERENCE,
    root_junction: Union[Unset, OrganisationUnitPatchObjectRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, OrganisationUnitPatchObjectUserOverrideMode
    ] = OrganisationUnitPatchObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, OrganisationUnitPatchObjectAtomicMode]):  Default:
            OrganisationUnitPatchObjectAtomicMode.ALL.
        flush_mode (Union[Unset, OrganisationUnitPatchObjectFlushMode]):  Default:
            OrganisationUnitPatchObjectFlushMode.AUTO.
        identifier (Union[Unset, OrganisationUnitPatchObjectIdentifier]):  Default:
            OrganisationUnitPatchObjectIdentifier.UID.
        import_mode (Union[Unset, OrganisationUnitPatchObjectImportMode]):  Default:
            OrganisationUnitPatchObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, OrganisationUnitPatchObjectImportReportMode]):  Default:
            OrganisationUnitPatchObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, OrganisationUnitPatchObjectImportStrategy]):  Default:
            OrganisationUnitPatchObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, OrganisationUnitPatchObjectPreheatMode]):  Default:
            OrganisationUnitPatchObjectPreheatMode.REFERENCE.
        root_junction (Union[Unset, OrganisationUnitPatchObjectRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, OrganisationUnitPatchObjectUserOverrideMode]):  Default:
            OrganisationUnitPatchObjectUserOverrideMode.NONE.
        body (JsonPatch):
