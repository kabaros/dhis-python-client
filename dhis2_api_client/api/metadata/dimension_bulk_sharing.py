...
from ...models.dimension_bulk_sharing_atomic_mode import DimensionBulkSharingAtomicMode
from ...models.dimension_bulk_sharing_flush_mode import DimensionBulkSharingFlushMode
from ...models.dimension_bulk_sharing_identifier import DimensionBulkSharingIdentifier
from ...models.dimension_bulk_sharing_import_mode import DimensionBulkSharingImportMode
from ...models.dimension_bulk_sharing_import_report_mode import DimensionBulkSharingImportReportMode
from ...models.dimension_bulk_sharing_import_strategy import DimensionBulkSharingImportStrategy
from ...models.dimension_bulk_sharing_preheat_mode import DimensionBulkSharingPreheatMode
from ...models.dimension_bulk_sharing_root_junction import DimensionBulkSharingRootJunction
from ...models.dimension_bulk_sharing_user_override_mode import DimensionBulkSharingUserOverrideMode
...
def _get_kwargs(
    *,
    ...
    atomic_mode: Union[Unset, DimensionBulkSharingAtomicMode] = DimensionBulkSharingAtomicMode.ALL,
    flush_mode: Union[Unset, DimensionBulkSharingFlushMode] = DimensionBulkSharingFlushMode.AUTO,
    identifier: Union[Unset, DimensionBulkSharingIdentifier] = DimensionBulkSharingIdentifier.UID,
    import_mode: Union[Unset, DimensionBulkSharingImportMode] = DimensionBulkSharingImportMode.COMMIT,
    import_report_mode: Union[
        Unset, DimensionBulkSharingImportReportMode
    ] = DimensionBulkSharingImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, DimensionBulkSharingImportStrategy
    ] = DimensionBulkSharingImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, DimensionBulkSharingPreheatMode] = DimensionBulkSharingPreheatMode.REFERENCE,
    root_junction: Union[Unset, DimensionBulkSharingRootJunction] = UNSET,
    skip_sharing: Union[Unset, bool] = False,
    skip_translation: Union[Unset, bool] = False,
    skip_validation: Union[Unset, bool] = False,
    user: Union[Unset, str] = UNSET,
    user_override_mode: Union[Unset, DimensionBulkSharingUserOverrideMode] = DimensionBulkSharingUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, DimensionBulkSharingAtomicMode]):  Default:
            DimensionBulkSharingAtomicMode.ALL.
        flush_mode (Union[Unset, DimensionBulkSharingFlushMode]):  Default:
            DimensionBulkSharingFlushMode.AUTO.
        identifier (Union[Unset, DimensionBulkSharingIdentifier]):  Default:
            DimensionBulkSharingIdentifier.UID.
        import_mode (Union[Unset, DimensionBulkSharingImportMode]):  Default:
            DimensionBulkSharingImportMode.COMMIT.
        import_report_mode (Union[Unset, DimensionBulkSharingImportReportMode]):  Default:
            DimensionBulkSharingImportReportMode.ERRORS.
        import_strategy (Union[Unset, DimensionBulkSharingImportStrategy]):  Default:
            DimensionBulkSharingImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, DimensionBulkSharingPreheatMode]):  Default:
            DimensionBulkSharingPreheatMode.REFERENCE.
        root_junction (Union[Unset, DimensionBulkSharingRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, DimensionBulkSharingUserOverrideMode]):  Default:
            DimensionBulkSharingUserOverrideMode.NONE.
        body (BulkJsonPatch):
