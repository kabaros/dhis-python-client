...
from ...models.data_element_group_replace_collection_items_jsonreplace_collection_items_xml_property import (
    DataElementGroupReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: DataElementGroupReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
    *,
