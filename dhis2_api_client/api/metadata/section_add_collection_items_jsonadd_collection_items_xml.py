...
from ...models.section_add_collection_items_jsonadd_collection_items_xml_property import (
    SectionAddCollectionItemsJsonaddCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: SectionAddCollectionItemsJsonaddCollectionItemsXmlProperty,
    *,
