...
from ...models.indicator_type_add_collection_items_jsonadd_collection_items_xml_property import (
    IndicatorTypeAddCollectionItemsJsonaddCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: IndicatorTypeAddCollectionItemsJsonaddCollectionItemsXmlProperty,
    *,
