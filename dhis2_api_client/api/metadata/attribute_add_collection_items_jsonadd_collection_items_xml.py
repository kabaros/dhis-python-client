...
from ...models.attribute_add_collection_items_jsonadd_collection_items_xml_property import (
    AttributeAddCollectionItemsJsonaddCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: AttributeAddCollectionItemsJsonaddCollectionItemsXmlProperty,
    *,
