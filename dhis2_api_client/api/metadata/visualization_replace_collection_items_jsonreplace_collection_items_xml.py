...
from ...models.visualization_replace_collection_items_jsonreplace_collection_items_xml_property import (
    VisualizationReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: VisualizationReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
    *,
