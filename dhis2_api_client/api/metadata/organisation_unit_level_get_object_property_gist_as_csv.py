...
from ...models.organisation_unit_level_get_object_property_gist_as_csv_auto import (
    OrganisationUnitLevelGetObjectPropertyGistAsCsvAuto,
)
from ...models.organisation_unit_level_get_object_property_gist_as_csv_property import (
    OrganisationUnitLevelGetObjectPropertyGistAsCsvProperty,
)
from ...models.organisation_unit_level_get_object_property_gist_as_csv_root_junction import (
    OrganisationUnitLevelGetObjectPropertyGistAsCsvRootJunction,
)
...
def _get_kwargs(
    uid: str,
    property_: OrganisationUnitLevelGetObjectPropertyGistAsCsvProperty,
    *,
    absolute_urls: Union[Unset, bool] = False,
    auto: Union[Unset, OrganisationUnitLevelGetObjectPropertyGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, OrganisationUnitLevelGetObjectPropertyGistAsCsvRootJunction
    ] = OrganisationUnitLevelGetObjectPropertyGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/organisationUnitLevels/{uid}/{property_}/gist.csv",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, OrganisationUnitLevelGetObjectPropertyGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, OrganisationUnitLevelGetObjectPropertyGistAsCsvRootJunction]):
            Default: OrganisationUnitLevelGetObjectPropertyGistAsCsvRootJunction.AND.
