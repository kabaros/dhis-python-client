...
from ...models.data_set_patch_object_atomic_mode import DataSetPatchObjectAtomicMode
from ...models.data_set_patch_object_flush_mode import DataSetPatchObjectFlushMode
from ...models.data_set_patch_object_identifier import DataSetPatchObjectIdentifier
from ...models.data_set_patch_object_import_mode import DataSetPatchObjectImportMode
from ...models.data_set_patch_object_import_report_mode import DataSetPatchObjectImportReportMode
from ...models.data_set_patch_object_import_strategy import DataSetPatchObjectImportStrategy
from ...models.data_set_patch_object_preheat_mode import DataSetPatchObjectPreheatMode
from ...models.data_set_patch_object_root_junction import DataSetPatchObjectRootJunction
from ...models.data_set_patch_object_user_override_mode import DataSetPatchObjectUserOverrideMode
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[Unset, DataSetPatchObjectAtomicMode] = DataSetPatchObjectAtomicMode.ALL,
    flush_mode: Union[Unset, DataSetPatchObjectFlushMode] = DataSetPatchObjectFlushMode.AUTO,
    identifier: Union[Unset, DataSetPatchObjectIdentifier] = DataSetPatchObjectIdentifier.UID,
    import_mode: Union[Unset, DataSetPatchObjectImportMode] = DataSetPatchObjectImportMode.COMMIT,
    import_report_mode: Union[Unset, DataSetPatchObjectImportReportMode] = DataSetPatchObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, DataSetPatchObjectImportStrategy
    ] = DataSetPatchObjectImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, DataSetPatchObjectPreheatMode] = DataSetPatchObjectPreheatMode.REFERENCE,
    root_junction: Union[Unset, DataSetPatchObjectRootJunction] = UNSET,
    skip_sharing: Union[Unset, bool] = False,
    skip_translation: Union[Unset, bool] = False,
    skip_validation: Union[Unset, bool] = False,
    user: Union[Unset, str] = UNSET,
    user_override_mode: Union[Unset, DataSetPatchObjectUserOverrideMode] = DataSetPatchObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, DataSetPatchObjectAtomicMode]):  Default:
            DataSetPatchObjectAtomicMode.ALL.
        flush_mode (Union[Unset, DataSetPatchObjectFlushMode]):  Default:
            DataSetPatchObjectFlushMode.AUTO.
        identifier (Union[Unset, DataSetPatchObjectIdentifier]):  Default:
            DataSetPatchObjectIdentifier.UID.
        import_mode (Union[Unset, DataSetPatchObjectImportMode]):  Default:
            DataSetPatchObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, DataSetPatchObjectImportReportMode]):  Default:
            DataSetPatchObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, DataSetPatchObjectImportStrategy]):  Default:
            DataSetPatchObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, DataSetPatchObjectPreheatMode]):  Default:
            DataSetPatchObjectPreheatMode.REFERENCE.
        root_junction (Union[Unset, DataSetPatchObjectRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, DataSetPatchObjectUserOverrideMode]):  Default:
            DataSetPatchObjectUserOverrideMode.NONE.
        body (JsonPatch):
