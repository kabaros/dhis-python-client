...
from ...models.organisation_unit_level_replace_collection_items_jsonreplace_collection_items_xml_property import (
    OrganisationUnitLevelReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: OrganisationUnitLevelReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
    *,
