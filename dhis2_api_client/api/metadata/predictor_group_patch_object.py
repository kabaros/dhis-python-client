...
from ...models.predictor_group_patch_object_atomic_mode import PredictorGroupPatchObjectAtomicMode
from ...models.predictor_group_patch_object_flush_mode import PredictorGroupPatchObjectFlushMode
from ...models.predictor_group_patch_object_identifier import PredictorGroupPatchObjectIdentifier
from ...models.predictor_group_patch_object_import_mode import PredictorGroupPatchObjectImportMode
from ...models.predictor_group_patch_object_import_report_mode import PredictorGroupPatchObjectImportReportMode
from ...models.predictor_group_patch_object_import_strategy import PredictorGroupPatchObjectImportStrategy
from ...models.predictor_group_patch_object_preheat_mode import PredictorGroupPatchObjectPreheatMode
from ...models.predictor_group_patch_object_root_junction import PredictorGroupPatchObjectRootJunction
from ...models.predictor_group_patch_object_user_override_mode import PredictorGroupPatchObjectUserOverrideMode
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[Unset, PredictorGroupPatchObjectAtomicMode] = PredictorGroupPatchObjectAtomicMode.ALL,
    flush_mode: Union[Unset, PredictorGroupPatchObjectFlushMode] = PredictorGroupPatchObjectFlushMode.AUTO,
    identifier: Union[Unset, PredictorGroupPatchObjectIdentifier] = PredictorGroupPatchObjectIdentifier.UID,
    import_mode: Union[Unset, PredictorGroupPatchObjectImportMode] = PredictorGroupPatchObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, PredictorGroupPatchObjectImportReportMode
    ] = PredictorGroupPatchObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, PredictorGroupPatchObjectImportStrategy
    ] = PredictorGroupPatchObjectImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, PredictorGroupPatchObjectPreheatMode] = PredictorGroupPatchObjectPreheatMode.REFERENCE,
    root_junction: Union[Unset, PredictorGroupPatchObjectRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, PredictorGroupPatchObjectUserOverrideMode
    ] = PredictorGroupPatchObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, PredictorGroupPatchObjectAtomicMode]):  Default:
            PredictorGroupPatchObjectAtomicMode.ALL.
        flush_mode (Union[Unset, PredictorGroupPatchObjectFlushMode]):  Default:
            PredictorGroupPatchObjectFlushMode.AUTO.
        identifier (Union[Unset, PredictorGroupPatchObjectIdentifier]):  Default:
            PredictorGroupPatchObjectIdentifier.UID.
        import_mode (Union[Unset, PredictorGroupPatchObjectImportMode]):  Default:
            PredictorGroupPatchObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, PredictorGroupPatchObjectImportReportMode]):  Default:
            PredictorGroupPatchObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, PredictorGroupPatchObjectImportStrategy]):  Default:
            PredictorGroupPatchObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, PredictorGroupPatchObjectPreheatMode]):  Default:
            PredictorGroupPatchObjectPreheatMode.REFERENCE.
        root_junction (Union[Unset, PredictorGroupPatchObjectRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, PredictorGroupPatchObjectUserOverrideMode]):  Default:
            PredictorGroupPatchObjectUserOverrideMode.NONE.
        body (JsonPatch):
