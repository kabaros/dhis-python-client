...
from ...models.document_get_object_gistget_object_gist_as_csv_auto import DocumentGetObjectGistgetObjectGistAsCsvAuto
from ...models.document_get_object_gistget_object_gist_as_csv_response_200 import (
    DocumentGetObjectGistgetObjectGistAsCsvResponse200,
)
from ...models.document_get_object_gistget_object_gist_as_csv_root_junction import (
    DocumentGetObjectGistgetObjectGistAsCsvRootJunction,
)
...
def _get_kwargs(
    ...
    *,
    ...
    auto: Union[Unset, DocumentGetObjectGistgetObjectGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, DocumentGetObjectGistgetObjectGistAsCsvRootJunction
    ] = DocumentGetObjectGistgetObjectGistAsCsvRootJunction.AND,
...
) -> Optional[Union[DocumentGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]]:
    if response.status_code == 200:
        response_200 = DocumentGetObjectGistgetObjectGistAsCsvResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DocumentGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, DocumentGetObjectGistgetObjectGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, DocumentGetObjectGistgetObjectGistAsCsvRootJunction]):
            Default: DocumentGetObjectGistgetObjectGistAsCsvRootJunction.AND.
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[DocumentGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]
    """
