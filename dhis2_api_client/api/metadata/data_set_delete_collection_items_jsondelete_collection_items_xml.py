...
from ...models.data_set_delete_collection_items_jsondelete_collection_items_xml_property import (
    DataSetDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: DataSetDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
    *,
