...
from ...models.data_approval_level_replace_collection_items_jsonreplace_collection_items_xml_property import (
    DataApprovalLevelReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: DataApprovalLevelReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
    *,
