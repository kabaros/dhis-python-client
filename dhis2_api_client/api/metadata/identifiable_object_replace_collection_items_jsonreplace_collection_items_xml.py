...
from ...models.identifiable_object_replace_collection_items_jsonreplace_collection_items_xml_property import (
    IdentifiableObjectReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: IdentifiableObjectReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
    *,
