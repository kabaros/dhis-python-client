...
from ...models.indicator_delete_collection_items_jsondelete_collection_items_xml_property import (
    IndicatorDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: IndicatorDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
    *,
