...
from ...models.section_delete_collection_items_jsondelete_collection_items_xml_property import (
    SectionDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: SectionDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
    *,
