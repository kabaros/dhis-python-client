...
from ...models.organisation_unit_get_children_response_200 import OrganisationUnitGetChildrenResponse200
from ...models.organisation_unit_get_children_root_junction import OrganisationUnitGetChildrenRootJunction
...
def _get_kwargs(
    ...
    *,
    ...
    root_junction: Union[Unset, OrganisationUnitGetChildrenRootJunction] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/organisationUnits/{uid}/children",
        "params": params,
    }
...
) -> Optional[Union[OrganisationUnitGetChildrenResponse200, WebMessage]]:
    if response.status_code == 200:
        response_200 = OrganisationUnitGetChildrenResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[OrganisationUnitGetChildrenResponse200, WebMessage]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, OrganisationUnitGetChildrenRootJunction]):
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[OrganisationUnitGetChildrenResponse200, WebMessage]
    """
