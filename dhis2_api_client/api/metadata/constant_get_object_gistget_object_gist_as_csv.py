...
from ...models.constant_get_object_gistget_object_gist_as_csv_auto import ConstantGetObjectGistgetObjectGistAsCsvAuto
from ...models.constant_get_object_gistget_object_gist_as_csv_response_200 import (
    ConstantGetObjectGistgetObjectGistAsCsvResponse200,
)
from ...models.constant_get_object_gistget_object_gist_as_csv_root_junction import (
    ConstantGetObjectGistgetObjectGistAsCsvRootJunction,
)
...
def _get_kwargs(
    ...
    *,
    ...
    auto: Union[Unset, ConstantGetObjectGistgetObjectGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, ConstantGetObjectGistgetObjectGistAsCsvRootJunction
    ] = ConstantGetObjectGistgetObjectGistAsCsvRootJunction.AND,
...
) -> Optional[Union[ConstantGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]]:
    if response.status_code == 200:
        response_200 = ConstantGetObjectGistgetObjectGistAsCsvResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ConstantGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, ConstantGetObjectGistgetObjectGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, ConstantGetObjectGistgetObjectGistAsCsvRootJunction]):
            Default: ConstantGetObjectGistgetObjectGistAsCsvRootJunction.AND.
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ConstantGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]
    """
