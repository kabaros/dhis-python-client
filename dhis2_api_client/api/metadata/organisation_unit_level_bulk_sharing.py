...
from ...models.organisation_unit_level_bulk_sharing_atomic_mode import OrganisationUnitLevelBulkSharingAtomicMode
from ...models.organisation_unit_level_bulk_sharing_flush_mode import OrganisationUnitLevelBulkSharingFlushMode
from ...models.organisation_unit_level_bulk_sharing_identifier import OrganisationUnitLevelBulkSharingIdentifier
from ...models.organisation_unit_level_bulk_sharing_import_mode import OrganisationUnitLevelBulkSharingImportMode
from ...models.organisation_unit_level_bulk_sharing_import_report_mode import (
    OrganisationUnitLevelBulkSharingImportReportMode,
)
from ...models.organisation_unit_level_bulk_sharing_import_strategy import (
    OrganisationUnitLevelBulkSharingImportStrategy,
)
from ...models.organisation_unit_level_bulk_sharing_preheat_mode import OrganisationUnitLevelBulkSharingPreheatMode
from ...models.organisation_unit_level_bulk_sharing_root_junction import OrganisationUnitLevelBulkSharingRootJunction
from ...models.organisation_unit_level_bulk_sharing_user_override_mode import (
    OrganisationUnitLevelBulkSharingUserOverrideMode,
)
...
def _get_kwargs(
    *,
    ...
    atomic_mode: Union[
        Unset, OrganisationUnitLevelBulkSharingAtomicMode
    ] = OrganisationUnitLevelBulkSharingAtomicMode.ALL,
    flush_mode: Union[
        Unset, OrganisationUnitLevelBulkSharingFlushMode
    ] = OrganisationUnitLevelBulkSharingFlushMode.AUTO,
    identifier: Union[
        Unset, OrganisationUnitLevelBulkSharingIdentifier
    ] = OrganisationUnitLevelBulkSharingIdentifier.UID,
    import_mode: Union[
        Unset, OrganisationUnitLevelBulkSharingImportMode
    ] = OrganisationUnitLevelBulkSharingImportMode.COMMIT,
    import_report_mode: Union[
        Unset, OrganisationUnitLevelBulkSharingImportReportMode
    ] = OrganisationUnitLevelBulkSharingImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, OrganisationUnitLevelBulkSharingImportStrategy
    ] = OrganisationUnitLevelBulkSharingImportStrategy.CREATE_AND_UPDATE,
    ...
    preheat_mode: Union[
        Unset, OrganisationUnitLevelBulkSharingPreheatMode
    ] = OrganisationUnitLevelBulkSharingPreheatMode.REFERENCE,
    root_junction: Union[Unset, OrganisationUnitLevelBulkSharingRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, OrganisationUnitLevelBulkSharingUserOverrideMode
    ] = OrganisationUnitLevelBulkSharingUserOverrideMode.NONE,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/organisationUnitLevels/sharing",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, OrganisationUnitLevelBulkSharingAtomicMode]):  Default:
            OrganisationUnitLevelBulkSharingAtomicMode.ALL.
        flush_mode (Union[Unset, OrganisationUnitLevelBulkSharingFlushMode]):  Default:
            OrganisationUnitLevelBulkSharingFlushMode.AUTO.
        identifier (Union[Unset, OrganisationUnitLevelBulkSharingIdentifier]):  Default:
            OrganisationUnitLevelBulkSharingIdentifier.UID.
        import_mode (Union[Unset, OrganisationUnitLevelBulkSharingImportMode]):  Default:
            OrganisationUnitLevelBulkSharingImportMode.COMMIT.
        import_report_mode (Union[Unset, OrganisationUnitLevelBulkSharingImportReportMode]):
            Default: OrganisationUnitLevelBulkSharingImportReportMode.ERRORS.
        import_strategy (Union[Unset, OrganisationUnitLevelBulkSharingImportStrategy]):  Default:
            OrganisationUnitLevelBulkSharingImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, OrganisationUnitLevelBulkSharingPreheatMode]):  Default:
            OrganisationUnitLevelBulkSharingPreheatMode.REFERENCE.
        root_junction (Union[Unset, OrganisationUnitLevelBulkSharingRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, OrganisationUnitLevelBulkSharingUserOverrideMode]):
            Default: OrganisationUnitLevelBulkSharingUserOverrideMode.NONE.
        body (BulkJsonPatch):
