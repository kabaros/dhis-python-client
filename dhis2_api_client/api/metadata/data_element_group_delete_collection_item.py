...
from ...models.data_element_group_delete_collection_item_property import DataElementGroupDeleteCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: DataElementGroupDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/dataElementGroups/{uid}/{property_}/{item_id}",
    }
