...
from ...models.organisation_unit_group_set_delete_collection_item_property import (
    OrganisationUnitGroupSetDeleteCollectionItemProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: OrganisationUnitGroupSetDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/organisationUnitGroupSets/{uid}/{property_}/{item_id}",
    }
