...
from ...models.dimension_replace_collection_items_jsonreplace_collection_items_xml_property import (
    DimensionReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: DimensionReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
    *,
