...
from ...models.map_view_get_object_gistget_object_gist_as_csv_auto import MapViewGetObjectGistgetObjectGistAsCsvAuto
from ...models.map_view_get_object_gistget_object_gist_as_csv_response_200 import (
    MapViewGetObjectGistgetObjectGistAsCsvResponse200,
)
from ...models.map_view_get_object_gistget_object_gist_as_csv_root_junction import (
    MapViewGetObjectGistgetObjectGistAsCsvRootJunction,
)
...
def _get_kwargs(
    ...
    *,
    ...
    auto: Union[Unset, MapViewGetObjectGistgetObjectGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, MapViewGetObjectGistgetObjectGistAsCsvRootJunction
    ] = MapViewGetObjectGistgetObjectGistAsCsvRootJunction.AND,
...
) -> Optional[Union[MapViewGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]]:
    if response.status_code == 200:
        response_200 = MapViewGetObjectGistgetObjectGistAsCsvResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[MapViewGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, MapViewGetObjectGistgetObjectGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, MapViewGetObjectGistgetObjectGistAsCsvRootJunction]):
            Default: MapViewGetObjectGistgetObjectGistAsCsvRootJunction.AND.
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[MapViewGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]
    """
