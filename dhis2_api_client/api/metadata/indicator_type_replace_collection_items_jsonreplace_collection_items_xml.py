...
from ...models.indicator_type_replace_collection_items_jsonreplace_collection_items_xml_property import (
    IndicatorTypeReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: IndicatorTypeReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
    *,
