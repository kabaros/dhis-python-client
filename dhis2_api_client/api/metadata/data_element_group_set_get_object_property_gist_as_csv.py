...
from ...models.data_element_group_set_get_object_property_gist_as_csv_auto import (
    DataElementGroupSetGetObjectPropertyGistAsCsvAuto,
)
from ...models.data_element_group_set_get_object_property_gist_as_csv_property import (
    DataElementGroupSetGetObjectPropertyGistAsCsvProperty,
)
from ...models.data_element_group_set_get_object_property_gist_as_csv_root_junction import (
    DataElementGroupSetGetObjectPropertyGistAsCsvRootJunction,
)
...
def _get_kwargs(
    uid: str,
    property_: DataElementGroupSetGetObjectPropertyGistAsCsvProperty,
    *,
    absolute_urls: Union[Unset, bool] = False,
    auto: Union[Unset, DataElementGroupSetGetObjectPropertyGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, DataElementGroupSetGetObjectPropertyGistAsCsvRootJunction
    ] = DataElementGroupSetGetObjectPropertyGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/dataElementGroupSets/{uid}/{property_}/gist.csv",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, DataElementGroupSetGetObjectPropertyGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, DataElementGroupSetGetObjectPropertyGistAsCsvRootJunction]):
            Default: DataElementGroupSetGetObjectPropertyGistAsCsvRootJunction.AND.
