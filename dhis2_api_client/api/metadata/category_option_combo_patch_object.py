...
from ...models.category_option_combo_patch_object_atomic_mode import CategoryOptionComboPatchObjectAtomicMode
from ...models.category_option_combo_patch_object_flush_mode import CategoryOptionComboPatchObjectFlushMode
from ...models.category_option_combo_patch_object_identifier import CategoryOptionComboPatchObjectIdentifier
from ...models.category_option_combo_patch_object_import_mode import CategoryOptionComboPatchObjectImportMode
from ...models.category_option_combo_patch_object_import_report_mode import (
    CategoryOptionComboPatchObjectImportReportMode,
)
from ...models.category_option_combo_patch_object_import_strategy import CategoryOptionComboPatchObjectImportStrategy
from ...models.category_option_combo_patch_object_preheat_mode import CategoryOptionComboPatchObjectPreheatMode
from ...models.category_option_combo_patch_object_root_junction import CategoryOptionComboPatchObjectRootJunction
from ...models.category_option_combo_patch_object_user_override_mode import (
    CategoryOptionComboPatchObjectUserOverrideMode,
)
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[Unset, CategoryOptionComboPatchObjectAtomicMode] = CategoryOptionComboPatchObjectAtomicMode.ALL,
    flush_mode: Union[Unset, CategoryOptionComboPatchObjectFlushMode] = CategoryOptionComboPatchObjectFlushMode.AUTO,
    identifier: Union[Unset, CategoryOptionComboPatchObjectIdentifier] = CategoryOptionComboPatchObjectIdentifier.UID,
    import_mode: Union[
        Unset, CategoryOptionComboPatchObjectImportMode
    ] = CategoryOptionComboPatchObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, CategoryOptionComboPatchObjectImportReportMode
    ] = CategoryOptionComboPatchObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, CategoryOptionComboPatchObjectImportStrategy
    ] = CategoryOptionComboPatchObjectImportStrategy.CREATE_AND_UPDATE,
    ...
    preheat_mode: Union[
        Unset, CategoryOptionComboPatchObjectPreheatMode
    ] = CategoryOptionComboPatchObjectPreheatMode.REFERENCE,
    root_junction: Union[Unset, CategoryOptionComboPatchObjectRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, CategoryOptionComboPatchObjectUserOverrideMode
    ] = CategoryOptionComboPatchObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, CategoryOptionComboPatchObjectAtomicMode]):  Default:
            CategoryOptionComboPatchObjectAtomicMode.ALL.
        flush_mode (Union[Unset, CategoryOptionComboPatchObjectFlushMode]):  Default:
            CategoryOptionComboPatchObjectFlushMode.AUTO.
        identifier (Union[Unset, CategoryOptionComboPatchObjectIdentifier]):  Default:
            CategoryOptionComboPatchObjectIdentifier.UID.
        import_mode (Union[Unset, CategoryOptionComboPatchObjectImportMode]):  Default:
            CategoryOptionComboPatchObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, CategoryOptionComboPatchObjectImportReportMode]):
            Default: CategoryOptionComboPatchObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, CategoryOptionComboPatchObjectImportStrategy]):  Default:
            CategoryOptionComboPatchObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, CategoryOptionComboPatchObjectPreheatMode]):  Default:
            CategoryOptionComboPatchObjectPreheatMode.REFERENCE.
        root_junction (Union[Unset, CategoryOptionComboPatchObjectRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, CategoryOptionComboPatchObjectUserOverrideMode]):
            Default: CategoryOptionComboPatchObjectUserOverrideMode.NONE.
        body (JsonPatch):
