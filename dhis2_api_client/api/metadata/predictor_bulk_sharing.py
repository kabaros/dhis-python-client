...
from ...models.predictor_bulk_sharing_atomic_mode import PredictorBulkSharingAtomicMode
from ...models.predictor_bulk_sharing_flush_mode import PredictorBulkSharingFlushMode
from ...models.predictor_bulk_sharing_identifier import PredictorBulkSharingIdentifier
from ...models.predictor_bulk_sharing_import_mode import PredictorBulkSharingImportMode
from ...models.predictor_bulk_sharing_import_report_mode import PredictorBulkSharingImportReportMode
from ...models.predictor_bulk_sharing_import_strategy import PredictorBulkSharingImportStrategy
from ...models.predictor_bulk_sharing_preheat_mode import PredictorBulkSharingPreheatMode
from ...models.predictor_bulk_sharing_root_junction import PredictorBulkSharingRootJunction
from ...models.predictor_bulk_sharing_user_override_mode import PredictorBulkSharingUserOverrideMode
...
def _get_kwargs(
    *,
    ...
    atomic_mode: Union[Unset, PredictorBulkSharingAtomicMode] = PredictorBulkSharingAtomicMode.ALL,
    flush_mode: Union[Unset, PredictorBulkSharingFlushMode] = PredictorBulkSharingFlushMode.AUTO,
    identifier: Union[Unset, PredictorBulkSharingIdentifier] = PredictorBulkSharingIdentifier.UID,
    import_mode: Union[Unset, PredictorBulkSharingImportMode] = PredictorBulkSharingImportMode.COMMIT,
    import_report_mode: Union[
        Unset, PredictorBulkSharingImportReportMode
    ] = PredictorBulkSharingImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, PredictorBulkSharingImportStrategy
    ] = PredictorBulkSharingImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, PredictorBulkSharingPreheatMode] = PredictorBulkSharingPreheatMode.REFERENCE,
    root_junction: Union[Unset, PredictorBulkSharingRootJunction] = UNSET,
    skip_sharing: Union[Unset, bool] = False,
    skip_translation: Union[Unset, bool] = False,
    skip_validation: Union[Unset, bool] = False,
    user: Union[Unset, str] = UNSET,
    user_override_mode: Union[Unset, PredictorBulkSharingUserOverrideMode] = PredictorBulkSharingUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, PredictorBulkSharingAtomicMode]):  Default:
            PredictorBulkSharingAtomicMode.ALL.
        flush_mode (Union[Unset, PredictorBulkSharingFlushMode]):  Default:
            PredictorBulkSharingFlushMode.AUTO.
        identifier (Union[Unset, PredictorBulkSharingIdentifier]):  Default:
            PredictorBulkSharingIdentifier.UID.
        import_mode (Union[Unset, PredictorBulkSharingImportMode]):  Default:
            PredictorBulkSharingImportMode.COMMIT.
        import_report_mode (Union[Unset, PredictorBulkSharingImportReportMode]):  Default:
            PredictorBulkSharingImportReportMode.ERRORS.
        import_strategy (Union[Unset, PredictorBulkSharingImportStrategy]):  Default:
            PredictorBulkSharingImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, PredictorBulkSharingPreheatMode]):  Default:
            PredictorBulkSharingPreheatMode.REFERENCE.
        root_junction (Union[Unset, PredictorBulkSharingRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, PredictorBulkSharingUserOverrideMode]):  Default:
            PredictorBulkSharingUserOverrideMode.NONE.
        body (BulkJsonPatch):
