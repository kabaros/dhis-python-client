...
from ...models.option_delete_collection_item_property import OptionDeleteCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: OptionDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/options/{uid}/{property_}/{item_id}",
    }
