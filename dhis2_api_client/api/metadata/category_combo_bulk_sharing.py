...
from ...models.category_combo_bulk_sharing_atomic_mode import CategoryComboBulkSharingAtomicMode
from ...models.category_combo_bulk_sharing_flush_mode import CategoryComboBulkSharingFlushMode
from ...models.category_combo_bulk_sharing_identifier import CategoryComboBulkSharingIdentifier
from ...models.category_combo_bulk_sharing_import_mode import CategoryComboBulkSharingImportMode
from ...models.category_combo_bulk_sharing_import_report_mode import CategoryComboBulkSharingImportReportMode
from ...models.category_combo_bulk_sharing_import_strategy import CategoryComboBulkSharingImportStrategy
from ...models.category_combo_bulk_sharing_preheat_mode import CategoryComboBulkSharingPreheatMode
from ...models.category_combo_bulk_sharing_root_junction import CategoryComboBulkSharingRootJunction
from ...models.category_combo_bulk_sharing_user_override_mode import CategoryComboBulkSharingUserOverrideMode
...
def _get_kwargs(
    *,
    ...
    atomic_mode: Union[Unset, CategoryComboBulkSharingAtomicMode] = CategoryComboBulkSharingAtomicMode.ALL,
    flush_mode: Union[Unset, CategoryComboBulkSharingFlushMode] = CategoryComboBulkSharingFlushMode.AUTO,
    identifier: Union[Unset, CategoryComboBulkSharingIdentifier] = CategoryComboBulkSharingIdentifier.UID,
    import_mode: Union[Unset, CategoryComboBulkSharingImportMode] = CategoryComboBulkSharingImportMode.COMMIT,
    import_report_mode: Union[
        Unset, CategoryComboBulkSharingImportReportMode
    ] = CategoryComboBulkSharingImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, CategoryComboBulkSharingImportStrategy
    ] = CategoryComboBulkSharingImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, CategoryComboBulkSharingPreheatMode] = CategoryComboBulkSharingPreheatMode.REFERENCE,
    root_junction: Union[Unset, CategoryComboBulkSharingRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, CategoryComboBulkSharingUserOverrideMode
    ] = CategoryComboBulkSharingUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, CategoryComboBulkSharingAtomicMode]):  Default:
            CategoryComboBulkSharingAtomicMode.ALL.
        flush_mode (Union[Unset, CategoryComboBulkSharingFlushMode]):  Default:
            CategoryComboBulkSharingFlushMode.AUTO.
        identifier (Union[Unset, CategoryComboBulkSharingIdentifier]):  Default:
            CategoryComboBulkSharingIdentifier.UID.
        import_mode (Union[Unset, CategoryComboBulkSharingImportMode]):  Default:
            CategoryComboBulkSharingImportMode.COMMIT.
        import_report_mode (Union[Unset, CategoryComboBulkSharingImportReportMode]):  Default:
            CategoryComboBulkSharingImportReportMode.ERRORS.
        import_strategy (Union[Unset, CategoryComboBulkSharingImportStrategy]):  Default:
            CategoryComboBulkSharingImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, CategoryComboBulkSharingPreheatMode]):  Default:
            CategoryComboBulkSharingPreheatMode.REFERENCE.
        root_junction (Union[Unset, CategoryComboBulkSharingRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, CategoryComboBulkSharingUserOverrideMode]):  Default:
            CategoryComboBulkSharingUserOverrideMode.NONE.
        body (BulkJsonPatch):
