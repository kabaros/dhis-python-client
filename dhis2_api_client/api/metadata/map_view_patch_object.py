...
from ...models.map_view_patch_object_atomic_mode import MapViewPatchObjectAtomicMode
from ...models.map_view_patch_object_flush_mode import MapViewPatchObjectFlushMode
from ...models.map_view_patch_object_identifier import MapViewPatchObjectIdentifier
from ...models.map_view_patch_object_import_mode import MapViewPatchObjectImportMode
from ...models.map_view_patch_object_import_report_mode import MapViewPatchObjectImportReportMode
from ...models.map_view_patch_object_import_strategy import MapViewPatchObjectImportStrategy
from ...models.map_view_patch_object_preheat_mode import MapViewPatchObjectPreheatMode
from ...models.map_view_patch_object_root_junction import MapViewPatchObjectRootJunction
from ...models.map_view_patch_object_user_override_mode import MapViewPatchObjectUserOverrideMode
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[Unset, MapViewPatchObjectAtomicMode] = MapViewPatchObjectAtomicMode.ALL,
    flush_mode: Union[Unset, MapViewPatchObjectFlushMode] = MapViewPatchObjectFlushMode.AUTO,
    identifier: Union[Unset, MapViewPatchObjectIdentifier] = MapViewPatchObjectIdentifier.UID,
    import_mode: Union[Unset, MapViewPatchObjectImportMode] = MapViewPatchObjectImportMode.COMMIT,
    import_report_mode: Union[Unset, MapViewPatchObjectImportReportMode] = MapViewPatchObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, MapViewPatchObjectImportStrategy
    ] = MapViewPatchObjectImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, MapViewPatchObjectPreheatMode] = MapViewPatchObjectPreheatMode.REFERENCE,
    root_junction: Union[Unset, MapViewPatchObjectRootJunction] = UNSET,
    skip_sharing: Union[Unset, bool] = False,
    skip_translation: Union[Unset, bool] = False,
    skip_validation: Union[Unset, bool] = False,
    user: Union[Unset, str] = UNSET,
    user_override_mode: Union[Unset, MapViewPatchObjectUserOverrideMode] = MapViewPatchObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, MapViewPatchObjectAtomicMode]):  Default:
            MapViewPatchObjectAtomicMode.ALL.
        flush_mode (Union[Unset, MapViewPatchObjectFlushMode]):  Default:
            MapViewPatchObjectFlushMode.AUTO.
        identifier (Union[Unset, MapViewPatchObjectIdentifier]):  Default:
            MapViewPatchObjectIdentifier.UID.
        import_mode (Union[Unset, MapViewPatchObjectImportMode]):  Default:
            MapViewPatchObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, MapViewPatchObjectImportReportMode]):  Default:
            MapViewPatchObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, MapViewPatchObjectImportStrategy]):  Default:
            MapViewPatchObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, MapViewPatchObjectPreheatMode]):  Default:
            MapViewPatchObjectPreheatMode.REFERENCE.
        root_junction (Union[Unset, MapViewPatchObjectRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, MapViewPatchObjectUserOverrideMode]):  Default:
            MapViewPatchObjectUserOverrideMode.NONE.
        body (JsonPatch):
