...
from ...models.data_set_replace_collection_items_jsonreplace_collection_items_xml_property import (
    DataSetReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: DataSetReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
    *,
