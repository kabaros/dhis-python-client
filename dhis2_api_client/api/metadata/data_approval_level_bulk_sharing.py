...
from ...models.data_approval_level_bulk_sharing_atomic_mode import DataApprovalLevelBulkSharingAtomicMode
from ...models.data_approval_level_bulk_sharing_flush_mode import DataApprovalLevelBulkSharingFlushMode
from ...models.data_approval_level_bulk_sharing_identifier import DataApprovalLevelBulkSharingIdentifier
from ...models.data_approval_level_bulk_sharing_import_mode import DataApprovalLevelBulkSharingImportMode
from ...models.data_approval_level_bulk_sharing_import_report_mode import DataApprovalLevelBulkSharingImportReportMode
from ...models.data_approval_level_bulk_sharing_import_strategy import DataApprovalLevelBulkSharingImportStrategy
from ...models.data_approval_level_bulk_sharing_preheat_mode import DataApprovalLevelBulkSharingPreheatMode
from ...models.data_approval_level_bulk_sharing_root_junction import DataApprovalLevelBulkSharingRootJunction
from ...models.data_approval_level_bulk_sharing_user_override_mode import DataApprovalLevelBulkSharingUserOverrideMode
...
def _get_kwargs(
    *,
    ...
    atomic_mode: Union[Unset, DataApprovalLevelBulkSharingAtomicMode] = DataApprovalLevelBulkSharingAtomicMode.ALL,
    flush_mode: Union[Unset, DataApprovalLevelBulkSharingFlushMode] = DataApprovalLevelBulkSharingFlushMode.AUTO,
    identifier: Union[Unset, DataApprovalLevelBulkSharingIdentifier] = DataApprovalLevelBulkSharingIdentifier.UID,
    import_mode: Union[Unset, DataApprovalLevelBulkSharingImportMode] = DataApprovalLevelBulkSharingImportMode.COMMIT,
    import_report_mode: Union[
        Unset, DataApprovalLevelBulkSharingImportReportMode
    ] = DataApprovalLevelBulkSharingImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, DataApprovalLevelBulkSharingImportStrategy
    ] = DataApprovalLevelBulkSharingImportStrategy.CREATE_AND_UPDATE,
    ...
    preheat_mode: Union[
        Unset, DataApprovalLevelBulkSharingPreheatMode
    ] = DataApprovalLevelBulkSharingPreheatMode.REFERENCE,
    root_junction: Union[Unset, DataApprovalLevelBulkSharingRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, DataApprovalLevelBulkSharingUserOverrideMode
    ] = DataApprovalLevelBulkSharingUserOverrideMode.NONE,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/dataApprovalLevels/sharing",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, DataApprovalLevelBulkSharingAtomicMode]):  Default:
            DataApprovalLevelBulkSharingAtomicMode.ALL.
        flush_mode (Union[Unset, DataApprovalLevelBulkSharingFlushMode]):  Default:
            DataApprovalLevelBulkSharingFlushMode.AUTO.
        identifier (Union[Unset, DataApprovalLevelBulkSharingIdentifier]):  Default:
            DataApprovalLevelBulkSharingIdentifier.UID.
        import_mode (Union[Unset, DataApprovalLevelBulkSharingImportMode]):  Default:
            DataApprovalLevelBulkSharingImportMode.COMMIT.
        import_report_mode (Union[Unset, DataApprovalLevelBulkSharingImportReportMode]):  Default:
            DataApprovalLevelBulkSharingImportReportMode.ERRORS.
        import_strategy (Union[Unset, DataApprovalLevelBulkSharingImportStrategy]):  Default:
            DataApprovalLevelBulkSharingImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, DataApprovalLevelBulkSharingPreheatMode]):  Default:
            DataApprovalLevelBulkSharingPreheatMode.REFERENCE.
        root_junction (Union[Unset, DataApprovalLevelBulkSharingRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, DataApprovalLevelBulkSharingUserOverrideMode]):  Default:
            DataApprovalLevelBulkSharingUserOverrideMode.NONE.
        body (BulkJsonPatch):
