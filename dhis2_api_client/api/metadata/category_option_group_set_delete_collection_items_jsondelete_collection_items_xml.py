...
from ...models.category_option_group_set_delete_collection_items_jsondelete_collection_items_xml_property import (
    CategoryOptionGroupSetDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: CategoryOptionGroupSetDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
    *,
