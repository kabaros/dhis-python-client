...
from ...models.organisation_unit_group_get_object_property_gist_as_csv_auto import (
    OrganisationUnitGroupGetObjectPropertyGistAsCsvAuto,
)
from ...models.organisation_unit_group_get_object_property_gist_as_csv_property import (
    OrganisationUnitGroupGetObjectPropertyGistAsCsvProperty,
)
from ...models.organisation_unit_group_get_object_property_gist_as_csv_root_junction import (
    OrganisationUnitGroupGetObjectPropertyGistAsCsvRootJunction,
)
...
def _get_kwargs(
    uid: str,
    property_: OrganisationUnitGroupGetObjectPropertyGistAsCsvProperty,
    *,
    absolute_urls: Union[Unset, bool] = False,
    auto: Union[Unset, OrganisationUnitGroupGetObjectPropertyGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, OrganisationUnitGroupGetObjectPropertyGistAsCsvRootJunction
    ] = OrganisationUnitGroupGetObjectPropertyGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/organisationUnitGroups/{uid}/{property_}/gist.csv",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, OrganisationUnitGroupGetObjectPropertyGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, OrganisationUnitGroupGetObjectPropertyGistAsCsvRootJunction]):
            Default: OrganisationUnitGroupGetObjectPropertyGistAsCsvRootJunction.AND.
