...
from ...models.section_bulk_sharing_atomic_mode import SectionBulkSharingAtomicMode
from ...models.section_bulk_sharing_flush_mode import SectionBulkSharingFlushMode
from ...models.section_bulk_sharing_identifier import SectionBulkSharingIdentifier
from ...models.section_bulk_sharing_import_mode import SectionBulkSharingImportMode
from ...models.section_bulk_sharing_import_report_mode import SectionBulkSharingImportReportMode
from ...models.section_bulk_sharing_import_strategy import SectionBulkSharingImportStrategy
from ...models.section_bulk_sharing_preheat_mode import SectionBulkSharingPreheatMode
from ...models.section_bulk_sharing_root_junction import SectionBulkSharingRootJunction
from ...models.section_bulk_sharing_user_override_mode import SectionBulkSharingUserOverrideMode
...
def _get_kwargs(
    *,
    ...
    atomic_mode: Union[Unset, SectionBulkSharingAtomicMode] = SectionBulkSharingAtomicMode.ALL,
    flush_mode: Union[Unset, SectionBulkSharingFlushMode] = SectionBulkSharingFlushMode.AUTO,
    identifier: Union[Unset, SectionBulkSharingIdentifier] = SectionBulkSharingIdentifier.UID,
    import_mode: Union[Unset, SectionBulkSharingImportMode] = SectionBulkSharingImportMode.COMMIT,
    import_report_mode: Union[Unset, SectionBulkSharingImportReportMode] = SectionBulkSharingImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, SectionBulkSharingImportStrategy
    ] = SectionBulkSharingImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, SectionBulkSharingPreheatMode] = SectionBulkSharingPreheatMode.REFERENCE,
    root_junction: Union[Unset, SectionBulkSharingRootJunction] = UNSET,
    skip_sharing: Union[Unset, bool] = False,
    skip_translation: Union[Unset, bool] = False,
    skip_validation: Union[Unset, bool] = False,
    user: Union[Unset, str] = UNSET,
    user_override_mode: Union[Unset, SectionBulkSharingUserOverrideMode] = SectionBulkSharingUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, SectionBulkSharingAtomicMode]):  Default:
            SectionBulkSharingAtomicMode.ALL.
        flush_mode (Union[Unset, SectionBulkSharingFlushMode]):  Default:
            SectionBulkSharingFlushMode.AUTO.
        identifier (Union[Unset, SectionBulkSharingIdentifier]):  Default:
            SectionBulkSharingIdentifier.UID.
        import_mode (Union[Unset, SectionBulkSharingImportMode]):  Default:
            SectionBulkSharingImportMode.COMMIT.
        import_report_mode (Union[Unset, SectionBulkSharingImportReportMode]):  Default:
            SectionBulkSharingImportReportMode.ERRORS.
        import_strategy (Union[Unset, SectionBulkSharingImportStrategy]):  Default:
            SectionBulkSharingImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, SectionBulkSharingPreheatMode]):  Default:
            SectionBulkSharingPreheatMode.REFERENCE.
        root_junction (Union[Unset, SectionBulkSharingRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, SectionBulkSharingUserOverrideMode]):  Default:
            SectionBulkSharingUserOverrideMode.NONE.
        body (BulkJsonPatch):
