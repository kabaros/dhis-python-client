...
from ...models.category_option_get_object_gistget_object_gist_as_csv_auto import (
    CategoryOptionGetObjectGistgetObjectGistAsCsvAuto,
)
from ...models.category_option_get_object_gistget_object_gist_as_csv_response_200 import (
    CategoryOptionGetObjectGistgetObjectGistAsCsvResponse200,
)
from ...models.category_option_get_object_gistget_object_gist_as_csv_root_junction import (
    CategoryOptionGetObjectGistgetObjectGistAsCsvRootJunction,
)
...
def _get_kwargs(
    ...
    *,
    ...
    auto: Union[Unset, CategoryOptionGetObjectGistgetObjectGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, CategoryOptionGetObjectGistgetObjectGistAsCsvRootJunction
    ] = CategoryOptionGetObjectGistgetObjectGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/categoryOptions/{uid}/gist",
        "params": params,
    }
...
) -> Optional[Union[CategoryOptionGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]]:
    if response.status_code == 200:
        response_200 = CategoryOptionGetObjectGistgetObjectGistAsCsvResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[CategoryOptionGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, CategoryOptionGetObjectGistgetObjectGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, CategoryOptionGetObjectGistgetObjectGistAsCsvRootJunction]):
            Default: CategoryOptionGetObjectGistgetObjectGistAsCsvRootJunction.AND.
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[CategoryOptionGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]
    """
