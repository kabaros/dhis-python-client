...
from ...models.category_option_group_set_get_object_list_csv_root_junction import (
    CategoryOptionGroupSetGetObjectListCsvRootJunction,
)
...
def _get_kwargs(
    *,
    ...
    root_junction: Union[Unset, CategoryOptionGroupSetGetObjectListCsvRootJunction] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/categoryOptionGroupSets/#getObjectListCsv",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, CategoryOptionGroupSetGetObjectListCsvRootJunction]):
