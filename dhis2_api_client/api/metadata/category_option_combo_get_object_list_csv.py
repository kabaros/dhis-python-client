...
from ...models.category_option_combo_get_object_list_csv_root_junction import (
    CategoryOptionComboGetObjectListCsvRootJunction,
)
...
def _get_kwargs(
    *,
    ...
    root_junction: Union[Unset, CategoryOptionComboGetObjectListCsvRootJunction] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/categoryOptionCombos/#getObjectListCsv",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, CategoryOptionComboGetObjectListCsvRootJunction]):
