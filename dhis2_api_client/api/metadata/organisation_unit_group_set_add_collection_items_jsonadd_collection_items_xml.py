...
from ...models.organisation_unit_group_set_add_collection_items_jsonadd_collection_items_xml_property import (
    OrganisationUnitGroupSetAddCollectionItemsJsonaddCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: OrganisationUnitGroupSetAddCollectionItemsJsonaddCollectionItemsXmlProperty,
    *,
