...
from ...models.category_patch_object_atomic_mode import CategoryPatchObjectAtomicMode
from ...models.category_patch_object_flush_mode import CategoryPatchObjectFlushMode
from ...models.category_patch_object_identifier import CategoryPatchObjectIdentifier
from ...models.category_patch_object_import_mode import CategoryPatchObjectImportMode
from ...models.category_patch_object_import_report_mode import CategoryPatchObjectImportReportMode
from ...models.category_patch_object_import_strategy import CategoryPatchObjectImportStrategy
from ...models.category_patch_object_preheat_mode import CategoryPatchObjectPreheatMode
from ...models.category_patch_object_root_junction import CategoryPatchObjectRootJunction
from ...models.category_patch_object_user_override_mode import CategoryPatchObjectUserOverrideMode
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[Unset, CategoryPatchObjectAtomicMode] = CategoryPatchObjectAtomicMode.ALL,
    flush_mode: Union[Unset, CategoryPatchObjectFlushMode] = CategoryPatchObjectFlushMode.AUTO,
    identifier: Union[Unset, CategoryPatchObjectIdentifier] = CategoryPatchObjectIdentifier.UID,
    import_mode: Union[Unset, CategoryPatchObjectImportMode] = CategoryPatchObjectImportMode.COMMIT,
    import_report_mode: Union[Unset, CategoryPatchObjectImportReportMode] = CategoryPatchObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, CategoryPatchObjectImportStrategy
    ] = CategoryPatchObjectImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, CategoryPatchObjectPreheatMode] = CategoryPatchObjectPreheatMode.REFERENCE,
    root_junction: Union[Unset, CategoryPatchObjectRootJunction] = UNSET,
    skip_sharing: Union[Unset, bool] = False,
    skip_translation: Union[Unset, bool] = False,
    skip_validation: Union[Unset, bool] = False,
    user: Union[Unset, str] = UNSET,
    user_override_mode: Union[Unset, CategoryPatchObjectUserOverrideMode] = CategoryPatchObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, CategoryPatchObjectAtomicMode]):  Default:
            CategoryPatchObjectAtomicMode.ALL.
        flush_mode (Union[Unset, CategoryPatchObjectFlushMode]):  Default:
            CategoryPatchObjectFlushMode.AUTO.
        identifier (Union[Unset, CategoryPatchObjectIdentifier]):  Default:
            CategoryPatchObjectIdentifier.UID.
        import_mode (Union[Unset, CategoryPatchObjectImportMode]):  Default:
            CategoryPatchObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, CategoryPatchObjectImportReportMode]):  Default:
            CategoryPatchObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, CategoryPatchObjectImportStrategy]):  Default:
            CategoryPatchObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, CategoryPatchObjectPreheatMode]):  Default:
            CategoryPatchObjectPreheatMode.REFERENCE.
        root_junction (Union[Unset, CategoryPatchObjectRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, CategoryPatchObjectUserOverrideMode]):  Default:
            CategoryPatchObjectUserOverrideMode.NONE.
        body (JsonPatch):
