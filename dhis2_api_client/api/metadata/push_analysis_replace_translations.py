...
from ...models.push_analysis_replace_translations_body import PushAnalysisReplaceTranslationsBody
...
def _get_kwargs(
    uid: str,
    *,
    body: PushAnalysisReplaceTranslationsBody,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": f"/pushAnalysis/{uid}/translations",
    }
