...
from ...models.constant_add_collection_items_jsonadd_collection_items_xml_property import (
    ConstantAddCollectionItemsJsonaddCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: ConstantAddCollectionItemsJsonaddCollectionItemsXmlProperty,
    *,
