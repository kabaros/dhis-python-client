...
from ...models.category_option_group_add_collection_items_jsonadd_collection_items_xml_property import (
    CategoryOptionGroupAddCollectionItemsJsonaddCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: CategoryOptionGroupAddCollectionItemsJsonaddCollectionItemsXmlProperty,
    *,
