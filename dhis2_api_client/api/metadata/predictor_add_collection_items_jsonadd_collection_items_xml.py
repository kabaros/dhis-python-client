...
from ...models.predictor_add_collection_items_jsonadd_collection_items_xml_property import (
    PredictorAddCollectionItemsJsonaddCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: PredictorAddCollectionItemsJsonaddCollectionItemsXmlProperty,
    *,
