...
from ...models.category_option_group_set_bulk_sharing_atomic_mode import CategoryOptionGroupSetBulkSharingAtomicMode
from ...models.category_option_group_set_bulk_sharing_flush_mode import CategoryOptionGroupSetBulkSharingFlushMode
from ...models.category_option_group_set_bulk_sharing_identifier import CategoryOptionGroupSetBulkSharingIdentifier
from ...models.category_option_group_set_bulk_sharing_import_mode import CategoryOptionGroupSetBulkSharingImportMode
from ...models.category_option_group_set_bulk_sharing_import_report_mode import (
    CategoryOptionGroupSetBulkSharingImportReportMode,
)
from ...models.category_option_group_set_bulk_sharing_import_strategy import (
    CategoryOptionGroupSetBulkSharingImportStrategy,
)
from ...models.category_option_group_set_bulk_sharing_preheat_mode import CategoryOptionGroupSetBulkSharingPreheatMode
from ...models.category_option_group_set_bulk_sharing_root_junction import CategoryOptionGroupSetBulkSharingRootJunction
from ...models.category_option_group_set_bulk_sharing_user_override_mode import (
    CategoryOptionGroupSetBulkSharingUserOverrideMode,
)
...
def _get_kwargs(
    *,
    ...
    atomic_mode: Union[
        Unset, CategoryOptionGroupSetBulkSharingAtomicMode
    ] = CategoryOptionGroupSetBulkSharingAtomicMode.ALL,
    flush_mode: Union[
        Unset, CategoryOptionGroupSetBulkSharingFlushMode
    ] = CategoryOptionGroupSetBulkSharingFlushMode.AUTO,
    identifier: Union[
        Unset, CategoryOptionGroupSetBulkSharingIdentifier
    ] = CategoryOptionGroupSetBulkSharingIdentifier.UID,
    import_mode: Union[
        Unset, CategoryOptionGroupSetBulkSharingImportMode
    ] = CategoryOptionGroupSetBulkSharingImportMode.COMMIT,
    import_report_mode: Union[
        Unset, CategoryOptionGroupSetBulkSharingImportReportMode
    ] = CategoryOptionGroupSetBulkSharingImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, CategoryOptionGroupSetBulkSharingImportStrategy
    ] = CategoryOptionGroupSetBulkSharingImportStrategy.CREATE_AND_UPDATE,
    ...
    preheat_mode: Union[
        Unset, CategoryOptionGroupSetBulkSharingPreheatMode
    ] = CategoryOptionGroupSetBulkSharingPreheatMode.REFERENCE,
    root_junction: Union[Unset, CategoryOptionGroupSetBulkSharingRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, CategoryOptionGroupSetBulkSharingUserOverrideMode
    ] = CategoryOptionGroupSetBulkSharingUserOverrideMode.NONE,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/categoryOptionGroupSets/sharing",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, CategoryOptionGroupSetBulkSharingAtomicMode]):  Default:
            CategoryOptionGroupSetBulkSharingAtomicMode.ALL.
        flush_mode (Union[Unset, CategoryOptionGroupSetBulkSharingFlushMode]):  Default:
            CategoryOptionGroupSetBulkSharingFlushMode.AUTO.
        identifier (Union[Unset, CategoryOptionGroupSetBulkSharingIdentifier]):  Default:
            CategoryOptionGroupSetBulkSharingIdentifier.UID.
        import_mode (Union[Unset, CategoryOptionGroupSetBulkSharingImportMode]):  Default:
            CategoryOptionGroupSetBulkSharingImportMode.COMMIT.
        import_report_mode (Union[Unset, CategoryOptionGroupSetBulkSharingImportReportMode]):
            Default: CategoryOptionGroupSetBulkSharingImportReportMode.ERRORS.
        import_strategy (Union[Unset, CategoryOptionGroupSetBulkSharingImportStrategy]):  Default:
            CategoryOptionGroupSetBulkSharingImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, CategoryOptionGroupSetBulkSharingPreheatMode]):  Default:
            CategoryOptionGroupSetBulkSharingPreheatMode.REFERENCE.
        root_junction (Union[Unset, CategoryOptionGroupSetBulkSharingRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, CategoryOptionGroupSetBulkSharingUserOverrideMode]):
            Default: CategoryOptionGroupSetBulkSharingUserOverrideMode.NONE.
        body (BulkJsonPatch):
