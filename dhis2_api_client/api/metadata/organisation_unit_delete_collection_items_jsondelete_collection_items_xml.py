...
from ...models.organisation_unit_delete_collection_items_jsondelete_collection_items_xml_property import (
    OrganisationUnitDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: OrganisationUnitDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
    *,
