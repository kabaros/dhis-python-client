...
from ...models.data_entry_form_delete_collection_item_property import DataEntryFormDeleteCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: DataEntryFormDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/dataEntryForms/{uid}/{property_}/{item_id}",
    }
