...
from ...models.data_set_get_object_list_response_200 import DataSetGetObjectListResponse200
from ...models.data_set_get_object_list_root_junction import DataSetGetObjectListRootJunction
...
def _get_kwargs(
    *,
    ...
    root_junction: Union[Unset, DataSetGetObjectListRootJunction] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
) -> Optional[Union[DataSetGetObjectListResponse200, WebMessage]]:
    if response.status_code == 200:
        response_200 = DataSetGetObjectListResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DataSetGetObjectListResponse200, WebMessage]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, DataSetGetObjectListRootJunction]):
...
def sync(
    *,
    ...
    Returns:
        Union[DataSetGetObjectListResponse200, WebMessage]
    """
