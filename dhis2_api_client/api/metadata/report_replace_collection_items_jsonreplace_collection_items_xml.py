...
from ...models.report_replace_collection_items_jsonreplace_collection_items_xml_property import (
    ReportReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: ReportReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
    *,
