...
from ...models.option_group_get_object_property_gist_as_csv_auto import OptionGroupGetObjectPropertyGistAsCsvAuto
from ...models.option_group_get_object_property_gist_as_csv_property import (
    OptionGroupGetObjectPropertyGistAsCsvProperty,
)
from ...models.option_group_get_object_property_gist_as_csv_root_junction import (
    OptionGroupGetObjectPropertyGistAsCsvRootJunction,
)
...
def _get_kwargs(
    uid: str,
    property_: OptionGroupGetObjectPropertyGistAsCsvProperty,
    *,
    absolute_urls: Union[Unset, bool] = False,
    auto: Union[Unset, OptionGroupGetObjectPropertyGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, OptionGroupGetObjectPropertyGistAsCsvRootJunction
    ] = OptionGroupGetObjectPropertyGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/optionGroups/{uid}/{property_}/gist.csv",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, OptionGroupGetObjectPropertyGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, OptionGroupGetObjectPropertyGistAsCsvRootJunction]):  Default:
            OptionGroupGetObjectPropertyGistAsCsvRootJunction.AND.
