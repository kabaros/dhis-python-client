...
from ...models.data_element_get_object_list_response_200 import DataElementGetObjectListResponse200
from ...models.data_element_get_object_list_root_junction import DataElementGetObjectListRootJunction
...
def _get_kwargs(
    *,
    ...
    root_junction: Union[Unset, DataElementGetObjectListRootJunction] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
) -> Optional[Union[DataElementGetObjectListResponse200, WebMessage]]:
    if response.status_code == 200:
        response_200 = DataElementGetObjectListResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DataElementGetObjectListResponse200, WebMessage]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, DataElementGetObjectListRootJunction]):
...
def sync(
    *,
    ...
    Returns:
        Union[DataElementGetObjectListResponse200, WebMessage]
    """
