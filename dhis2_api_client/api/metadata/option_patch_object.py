...
from ...models.option_patch_object_atomic_mode import OptionPatchObjectAtomicMode
from ...models.option_patch_object_flush_mode import OptionPatchObjectFlushMode
from ...models.option_patch_object_identifier import OptionPatchObjectIdentifier
from ...models.option_patch_object_import_mode import OptionPatchObjectImportMode
from ...models.option_patch_object_import_report_mode import OptionPatchObjectImportReportMode
from ...models.option_patch_object_import_strategy import OptionPatchObjectImportStrategy
from ...models.option_patch_object_preheat_mode import OptionPatchObjectPreheatMode
from ...models.option_patch_object_root_junction import OptionPatchObjectRootJunction
from ...models.option_patch_object_user_override_mode import OptionPatchObjectUserOverrideMode
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[Unset, OptionPatchObjectAtomicMode] = OptionPatchObjectAtomicMode.ALL,
    flush_mode: Union[Unset, OptionPatchObjectFlushMode] = OptionPatchObjectFlushMode.AUTO,
    identifier: Union[Unset, OptionPatchObjectIdentifier] = OptionPatchObjectIdentifier.UID,
    import_mode: Union[Unset, OptionPatchObjectImportMode] = OptionPatchObjectImportMode.COMMIT,
    import_report_mode: Union[Unset, OptionPatchObjectImportReportMode] = OptionPatchObjectImportReportMode.ERRORS,
    import_strategy: Union[Unset, OptionPatchObjectImportStrategy] = OptionPatchObjectImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, OptionPatchObjectPreheatMode] = OptionPatchObjectPreheatMode.REFERENCE,
    root_junction: Union[Unset, OptionPatchObjectRootJunction] = UNSET,
    skip_sharing: Union[Unset, bool] = False,
    skip_translation: Union[Unset, bool] = False,
    skip_validation: Union[Unset, bool] = False,
    user: Union[Unset, str] = UNSET,
    user_override_mode: Union[Unset, OptionPatchObjectUserOverrideMode] = OptionPatchObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, OptionPatchObjectAtomicMode]):  Default:
            OptionPatchObjectAtomicMode.ALL.
        flush_mode (Union[Unset, OptionPatchObjectFlushMode]):  Default:
            OptionPatchObjectFlushMode.AUTO.
        identifier (Union[Unset, OptionPatchObjectIdentifier]):  Default:
            OptionPatchObjectIdentifier.UID.
        import_mode (Union[Unset, OptionPatchObjectImportMode]):  Default:
            OptionPatchObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, OptionPatchObjectImportReportMode]):  Default:
            OptionPatchObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, OptionPatchObjectImportStrategy]):  Default:
            OptionPatchObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, OptionPatchObjectPreheatMode]):  Default:
            OptionPatchObjectPreheatMode.REFERENCE.
        root_junction (Union[Unset, OptionPatchObjectRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, OptionPatchObjectUserOverrideMode]):  Default:
            OptionPatchObjectUserOverrideMode.NONE.
        body (JsonPatch):
