...
from ...models.option_get_object_gistget_object_gist_as_csv_auto import OptionGetObjectGistgetObjectGistAsCsvAuto
from ...models.option_get_object_gistget_object_gist_as_csv_response_200 import (
    OptionGetObjectGistgetObjectGistAsCsvResponse200,
)
from ...models.option_get_object_gistget_object_gist_as_csv_root_junction import (
    OptionGetObjectGistgetObjectGistAsCsvRootJunction,
)
...
def _get_kwargs(
    ...
    *,
    ...
    auto: Union[Unset, OptionGetObjectGistgetObjectGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, OptionGetObjectGistgetObjectGistAsCsvRootJunction
    ] = OptionGetObjectGistgetObjectGistAsCsvRootJunction.AND,
...
) -> Optional[Union[OptionGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]]:
    if response.status_code == 200:
        response_200 = OptionGetObjectGistgetObjectGistAsCsvResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[OptionGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, OptionGetObjectGistgetObjectGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, OptionGetObjectGistgetObjectGistAsCsvRootJunction]):  Default:
            OptionGetObjectGistgetObjectGistAsCsvRootJunction.AND.
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[OptionGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]
    """
