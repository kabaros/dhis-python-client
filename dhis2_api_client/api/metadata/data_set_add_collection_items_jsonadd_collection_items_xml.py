...
from ...models.data_set_add_collection_items_jsonadd_collection_items_xml_property import (
    DataSetAddCollectionItemsJsonaddCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: DataSetAddCollectionItemsJsonaddCollectionItemsXmlProperty,
    *,
