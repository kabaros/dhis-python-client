...
from ...models.category_option_group_set_patch_object_atomic_mode import CategoryOptionGroupSetPatchObjectAtomicMode
from ...models.category_option_group_set_patch_object_flush_mode import CategoryOptionGroupSetPatchObjectFlushMode
from ...models.category_option_group_set_patch_object_identifier import CategoryOptionGroupSetPatchObjectIdentifier
from ...models.category_option_group_set_patch_object_import_mode import CategoryOptionGroupSetPatchObjectImportMode
from ...models.category_option_group_set_patch_object_import_report_mode import (
    CategoryOptionGroupSetPatchObjectImportReportMode,
)
from ...models.category_option_group_set_patch_object_import_strategy import (
    CategoryOptionGroupSetPatchObjectImportStrategy,
)
from ...models.category_option_group_set_patch_object_preheat_mode import CategoryOptionGroupSetPatchObjectPreheatMode
from ...models.category_option_group_set_patch_object_root_junction import CategoryOptionGroupSetPatchObjectRootJunction
from ...models.category_option_group_set_patch_object_user_override_mode import (
    CategoryOptionGroupSetPatchObjectUserOverrideMode,
)
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[
        Unset, CategoryOptionGroupSetPatchObjectAtomicMode
    ] = CategoryOptionGroupSetPatchObjectAtomicMode.ALL,
    flush_mode: Union[
        Unset, CategoryOptionGroupSetPatchObjectFlushMode
    ] = CategoryOptionGroupSetPatchObjectFlushMode.AUTO,
    identifier: Union[
        Unset, CategoryOptionGroupSetPatchObjectIdentifier
    ] = CategoryOptionGroupSetPatchObjectIdentifier.UID,
    import_mode: Union[
        Unset, CategoryOptionGroupSetPatchObjectImportMode
    ] = CategoryOptionGroupSetPatchObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, CategoryOptionGroupSetPatchObjectImportReportMode
    ] = CategoryOptionGroupSetPatchObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, CategoryOptionGroupSetPatchObjectImportStrategy
    ] = CategoryOptionGroupSetPatchObjectImportStrategy.CREATE_AND_UPDATE,
    ...
    preheat_mode: Union[
        Unset, CategoryOptionGroupSetPatchObjectPreheatMode
    ] = CategoryOptionGroupSetPatchObjectPreheatMode.REFERENCE,
    root_junction: Union[Unset, CategoryOptionGroupSetPatchObjectRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, CategoryOptionGroupSetPatchObjectUserOverrideMode
    ] = CategoryOptionGroupSetPatchObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, CategoryOptionGroupSetPatchObjectAtomicMode]):  Default:
            CategoryOptionGroupSetPatchObjectAtomicMode.ALL.
        flush_mode (Union[Unset, CategoryOptionGroupSetPatchObjectFlushMode]):  Default:
            CategoryOptionGroupSetPatchObjectFlushMode.AUTO.
        identifier (Union[Unset, CategoryOptionGroupSetPatchObjectIdentifier]):  Default:
            CategoryOptionGroupSetPatchObjectIdentifier.UID.
        import_mode (Union[Unset, CategoryOptionGroupSetPatchObjectImportMode]):  Default:
            CategoryOptionGroupSetPatchObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, CategoryOptionGroupSetPatchObjectImportReportMode]):
            Default: CategoryOptionGroupSetPatchObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, CategoryOptionGroupSetPatchObjectImportStrategy]):  Default:
            CategoryOptionGroupSetPatchObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, CategoryOptionGroupSetPatchObjectPreheatMode]):  Default:
            CategoryOptionGroupSetPatchObjectPreheatMode.REFERENCE.
        root_junction (Union[Unset, CategoryOptionGroupSetPatchObjectRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, CategoryOptionGroupSetPatchObjectUserOverrideMode]):
            Default: CategoryOptionGroupSetPatchObjectUserOverrideMode.NONE.
        body (JsonPatch):
