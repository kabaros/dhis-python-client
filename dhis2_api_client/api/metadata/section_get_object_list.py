...
from ...models.section_get_object_list_response_200 import SectionGetObjectListResponse200
from ...models.section_get_object_list_root_junction import SectionGetObjectListRootJunction
...
def _get_kwargs(
    *,
    ...
    root_junction: Union[Unset, SectionGetObjectListRootJunction] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
) -> Optional[Union[SectionGetObjectListResponse200, WebMessage]]:
    if response.status_code == 200:
        response_200 = SectionGetObjectListResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[SectionGetObjectListResponse200, WebMessage]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, SectionGetObjectListRootJunction]):
...
def sync(
    *,
    ...
    Returns:
        Union[SectionGetObjectListResponse200, WebMessage]
    """
