...
from ...models.category_combo_replace_translations_body import CategoryComboReplaceTranslationsBody
...
def _get_kwargs(
    uid: str,
    *,
    body: CategoryComboReplaceTranslationsBody,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": f"/categoryCombos/{uid}/translations",
    }
