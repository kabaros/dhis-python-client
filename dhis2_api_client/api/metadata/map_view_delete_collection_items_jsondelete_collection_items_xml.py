...
from ...models.map_view_delete_collection_items_jsondelete_collection_items_xml_property import (
    MapViewDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: MapViewDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
    *,
