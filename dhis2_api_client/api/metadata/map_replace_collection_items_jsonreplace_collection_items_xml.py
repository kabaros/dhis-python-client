...
from ...models.map_replace_collection_items_jsonreplace_collection_items_xml_property import (
    MapReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: MapReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
    *,
