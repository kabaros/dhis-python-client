...
from ...models.data_approval_workflow_delete_collection_items_jsondelete_collection_items_xml_property import (
    DataApprovalWorkflowDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: DataApprovalWorkflowDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
    *,
