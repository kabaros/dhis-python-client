...
from ...models.option_get_object_list_gist_as_csv_auto import OptionGetObjectListGistAsCsvAuto
from ...models.option_get_object_list_gist_as_csv_root_junction import OptionGetObjectListGistAsCsvRootJunction
...
def _get_kwargs(
    *,
    ...
    auto: Union[Unset, OptionGetObjectListGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, OptionGetObjectListGistAsCsvRootJunction
    ] = OptionGetObjectListGistAsCsvRootJunction.AND,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        auto (Union[Unset, OptionGetObjectListGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, OptionGetObjectListGistAsCsvRootJunction]):  Default:
            OptionGetObjectListGistAsCsvRootJunction.AND.
