...
from ...models.option_delete_collection_items_jsondelete_collection_items_xml_property import (
    OptionDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: OptionDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
    *,
