...
from ...models.predictor_get_object_property_gist_as_csv_auto import PredictorGetObjectPropertyGistAsCsvAuto
from ...models.predictor_get_object_property_gist_as_csv_property import PredictorGetObjectPropertyGistAsCsvProperty
from ...models.predictor_get_object_property_gist_as_csv_root_junction import (
    PredictorGetObjectPropertyGistAsCsvRootJunction,
)
...
def _get_kwargs(
    uid: str,
    property_: PredictorGetObjectPropertyGistAsCsvProperty,
    *,
    absolute_urls: Union[Unset, bool] = False,
    auto: Union[Unset, PredictorGetObjectPropertyGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, PredictorGetObjectPropertyGistAsCsvRootJunction
    ] = PredictorGetObjectPropertyGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/predictors/{uid}/{property_}/gist.csv",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, PredictorGetObjectPropertyGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, PredictorGetObjectPropertyGistAsCsvRootJunction]):  Default:
            PredictorGetObjectPropertyGistAsCsvRootJunction.AND.
