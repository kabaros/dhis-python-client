...
from ...models.visualization_patch_object_atomic_mode import VisualizationPatchObjectAtomicMode
from ...models.visualization_patch_object_flush_mode import VisualizationPatchObjectFlushMode
from ...models.visualization_patch_object_identifier import VisualizationPatchObjectIdentifier
from ...models.visualization_patch_object_import_mode import VisualizationPatchObjectImportMode
from ...models.visualization_patch_object_import_report_mode import VisualizationPatchObjectImportReportMode
from ...models.visualization_patch_object_import_strategy import VisualizationPatchObjectImportStrategy
from ...models.visualization_patch_object_preheat_mode import VisualizationPatchObjectPreheatMode
from ...models.visualization_patch_object_root_junction import VisualizationPatchObjectRootJunction
from ...models.visualization_patch_object_user_override_mode import VisualizationPatchObjectUserOverrideMode
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[Unset, VisualizationPatchObjectAtomicMode] = VisualizationPatchObjectAtomicMode.ALL,
    flush_mode: Union[Unset, VisualizationPatchObjectFlushMode] = VisualizationPatchObjectFlushMode.AUTO,
    identifier: Union[Unset, VisualizationPatchObjectIdentifier] = VisualizationPatchObjectIdentifier.UID,
    import_mode: Union[Unset, VisualizationPatchObjectImportMode] = VisualizationPatchObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, VisualizationPatchObjectImportReportMode
    ] = VisualizationPatchObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, VisualizationPatchObjectImportStrategy
    ] = VisualizationPatchObjectImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, VisualizationPatchObjectPreheatMode] = VisualizationPatchObjectPreheatMode.REFERENCE,
    root_junction: Union[Unset, VisualizationPatchObjectRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, VisualizationPatchObjectUserOverrideMode
    ] = VisualizationPatchObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, VisualizationPatchObjectAtomicMode]):  Default:
            VisualizationPatchObjectAtomicMode.ALL.
        flush_mode (Union[Unset, VisualizationPatchObjectFlushMode]):  Default:
            VisualizationPatchObjectFlushMode.AUTO.
        identifier (Union[Unset, VisualizationPatchObjectIdentifier]):  Default:
            VisualizationPatchObjectIdentifier.UID.
        import_mode (Union[Unset, VisualizationPatchObjectImportMode]):  Default:
            VisualizationPatchObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, VisualizationPatchObjectImportReportMode]):  Default:
            VisualizationPatchObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, VisualizationPatchObjectImportStrategy]):  Default:
            VisualizationPatchObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, VisualizationPatchObjectPreheatMode]):  Default:
            VisualizationPatchObjectPreheatMode.REFERENCE.
        root_junction (Union[Unset, VisualizationPatchObjectRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, VisualizationPatchObjectUserOverrideMode]):  Default:
            VisualizationPatchObjectUserOverrideMode.NONE.
        body (JsonPatch):
