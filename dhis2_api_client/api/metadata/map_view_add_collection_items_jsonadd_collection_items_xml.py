...
from ...models.map_view_add_collection_items_jsonadd_collection_items_xml_property import (
    MapViewAddCollectionItemsJsonaddCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: MapViewAddCollectionItemsJsonaddCollectionItemsXmlProperty,
    *,
