...
from ...models.data_entry_form_add_collection_item_property import DataEntryFormAddCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: DataEntryFormAddCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
