...
from ...models.indicator_group_replace_collection_items_jsonreplace_collection_items_xml_property import (
    IndicatorGroupReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: IndicatorGroupReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
    *,
