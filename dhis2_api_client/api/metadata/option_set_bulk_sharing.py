...
from ...models.option_set_bulk_sharing_atomic_mode import OptionSetBulkSharingAtomicMode
from ...models.option_set_bulk_sharing_flush_mode import OptionSetBulkSharingFlushMode
from ...models.option_set_bulk_sharing_identifier import OptionSetBulkSharingIdentifier
from ...models.option_set_bulk_sharing_import_mode import OptionSetBulkSharingImportMode
from ...models.option_set_bulk_sharing_import_report_mode import OptionSetBulkSharingImportReportMode
from ...models.option_set_bulk_sharing_import_strategy import OptionSetBulkSharingImportStrategy
from ...models.option_set_bulk_sharing_preheat_mode import OptionSetBulkSharingPreheatMode
from ...models.option_set_bulk_sharing_root_junction import OptionSetBulkSharingRootJunction
from ...models.option_set_bulk_sharing_user_override_mode import OptionSetBulkSharingUserOverrideMode
...
def _get_kwargs(
    *,
    ...
    atomic_mode: Union[Unset, OptionSetBulkSharingAtomicMode] = OptionSetBulkSharingAtomicMode.ALL,
    flush_mode: Union[Unset, OptionSetBulkSharingFlushMode] = OptionSetBulkSharingFlushMode.AUTO,
    identifier: Union[Unset, OptionSetBulkSharingIdentifier] = OptionSetBulkSharingIdentifier.UID,
    import_mode: Union[Unset, OptionSetBulkSharingImportMode] = OptionSetBulkSharingImportMode.COMMIT,
    import_report_mode: Union[
        Unset, OptionSetBulkSharingImportReportMode
    ] = OptionSetBulkSharingImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, OptionSetBulkSharingImportStrategy
    ] = OptionSetBulkSharingImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, OptionSetBulkSharingPreheatMode] = OptionSetBulkSharingPreheatMode.REFERENCE,
    root_junction: Union[Unset, OptionSetBulkSharingRootJunction] = UNSET,
    skip_sharing: Union[Unset, bool] = False,
    skip_translation: Union[Unset, bool] = False,
    skip_validation: Union[Unset, bool] = False,
    user: Union[Unset, str] = UNSET,
    user_override_mode: Union[Unset, OptionSetBulkSharingUserOverrideMode] = OptionSetBulkSharingUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, OptionSetBulkSharingAtomicMode]):  Default:
            OptionSetBulkSharingAtomicMode.ALL.
        flush_mode (Union[Unset, OptionSetBulkSharingFlushMode]):  Default:
            OptionSetBulkSharingFlushMode.AUTO.
        identifier (Union[Unset, OptionSetBulkSharingIdentifier]):  Default:
            OptionSetBulkSharingIdentifier.UID.
        import_mode (Union[Unset, OptionSetBulkSharingImportMode]):  Default:
            OptionSetBulkSharingImportMode.COMMIT.
        import_report_mode (Union[Unset, OptionSetBulkSharingImportReportMode]):  Default:
            OptionSetBulkSharingImportReportMode.ERRORS.
        import_strategy (Union[Unset, OptionSetBulkSharingImportStrategy]):  Default:
            OptionSetBulkSharingImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, OptionSetBulkSharingPreheatMode]):  Default:
            OptionSetBulkSharingPreheatMode.REFERENCE.
        root_junction (Union[Unset, OptionSetBulkSharingRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, OptionSetBulkSharingUserOverrideMode]):  Default:
            OptionSetBulkSharingUserOverrideMode.NONE.
        body (BulkJsonPatch):
