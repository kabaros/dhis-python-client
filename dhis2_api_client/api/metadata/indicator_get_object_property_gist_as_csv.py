...
from ...models.indicator_get_object_property_gist_as_csv_auto import IndicatorGetObjectPropertyGistAsCsvAuto
from ...models.indicator_get_object_property_gist_as_csv_property import IndicatorGetObjectPropertyGistAsCsvProperty
from ...models.indicator_get_object_property_gist_as_csv_root_junction import (
    IndicatorGetObjectPropertyGistAsCsvRootJunction,
)
...
def _get_kwargs(
    uid: str,
    property_: IndicatorGetObjectPropertyGistAsCsvProperty,
    *,
    absolute_urls: Union[Unset, bool] = False,
    auto: Union[Unset, IndicatorGetObjectPropertyGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, IndicatorGetObjectPropertyGistAsCsvRootJunction
    ] = IndicatorGetObjectPropertyGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/indicators/{uid}/{property_}/gist.csv",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, IndicatorGetObjectPropertyGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, IndicatorGetObjectPropertyGistAsCsvRootJunction]):  Default:
            IndicatorGetObjectPropertyGistAsCsvRootJunction.AND.
