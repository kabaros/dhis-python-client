...
from ...models.data_element_group_add_collection_item_property import DataElementGroupAddCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: DataElementGroupAddCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
