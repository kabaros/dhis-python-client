...
from ...models.option_post_json_objectpost_xml_object_atomic_mode import OptionPostJsonObjectpostXmlObjectAtomicMode
from ...models.option_post_json_objectpost_xml_object_flush_mode import OptionPostJsonObjectpostXmlObjectFlushMode
from ...models.option_post_json_objectpost_xml_object_identifier import OptionPostJsonObjectpostXmlObjectIdentifier
from ...models.option_post_json_objectpost_xml_object_import_mode import OptionPostJsonObjectpostXmlObjectImportMode
from ...models.option_post_json_objectpost_xml_object_import_report_mode import (
    OptionPostJsonObjectpostXmlObjectImportReportMode,
)
from ...models.option_post_json_objectpost_xml_object_import_strategy import (
    OptionPostJsonObjectpostXmlObjectImportStrategy,
)
from ...models.option_post_json_objectpost_xml_object_preheat_mode import OptionPostJsonObjectpostXmlObjectPreheatMode
from ...models.option_post_json_objectpost_xml_object_user_override_mode import (
    OptionPostJsonObjectpostXmlObjectUserOverrideMode,
)
...
def _get_kwargs(
    *,
    ...
    atomic_mode: Union[
        Unset, OptionPostJsonObjectpostXmlObjectAtomicMode
    ] = OptionPostJsonObjectpostXmlObjectAtomicMode.ALL,
    flush_mode: Union[
        Unset, OptionPostJsonObjectpostXmlObjectFlushMode
    ] = OptionPostJsonObjectpostXmlObjectFlushMode.AUTO,
    identifier: Union[
        Unset, OptionPostJsonObjectpostXmlObjectIdentifier
    ] = OptionPostJsonObjectpostXmlObjectIdentifier.UID,
    import_mode: Union[
        Unset, OptionPostJsonObjectpostXmlObjectImportMode
    ] = OptionPostJsonObjectpostXmlObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, OptionPostJsonObjectpostXmlObjectImportReportMode
    ] = OptionPostJsonObjectpostXmlObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, OptionPostJsonObjectpostXmlObjectImportStrategy
    ] = OptionPostJsonObjectpostXmlObjectImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    preheat_mode: Union[
        Unset, OptionPostJsonObjectpostXmlObjectPreheatMode
    ] = OptionPostJsonObjectpostXmlObjectPreheatMode.REFERENCE,
    ...
    user_override_mode: Union[
        Unset, OptionPostJsonObjectpostXmlObjectUserOverrideMode
    ] = OptionPostJsonObjectpostXmlObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, OptionPostJsonObjectpostXmlObjectAtomicMode]):  Default:
            OptionPostJsonObjectpostXmlObjectAtomicMode.ALL.
        flush_mode (Union[Unset, OptionPostJsonObjectpostXmlObjectFlushMode]):  Default:
            OptionPostJsonObjectpostXmlObjectFlushMode.AUTO.
        identifier (Union[Unset, OptionPostJsonObjectpostXmlObjectIdentifier]):  Default:
            OptionPostJsonObjectpostXmlObjectIdentifier.UID.
        import_mode (Union[Unset, OptionPostJsonObjectpostXmlObjectImportMode]):  Default:
            OptionPostJsonObjectpostXmlObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, OptionPostJsonObjectpostXmlObjectImportReportMode]):
            Default: OptionPostJsonObjectpostXmlObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, OptionPostJsonObjectpostXmlObjectImportStrategy]):  Default:
            OptionPostJsonObjectpostXmlObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, OptionPostJsonObjectpostXmlObjectPreheatMode]):  Default:
            OptionPostJsonObjectpostXmlObjectPreheatMode.REFERENCE.
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, OptionPostJsonObjectpostXmlObjectUserOverrideMode]):
            Default: OptionPostJsonObjectpostXmlObjectUserOverrideMode.NONE.
        body (Option):
