...
from ...models.option_group_delete_collection_item_property import OptionGroupDeleteCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: OptionGroupDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/optionGroups/{uid}/{property_}/{item_id}",
    }
