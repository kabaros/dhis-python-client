...
from ...models.category_put_json_objectput_xml_object_atomic_mode import CategoryPutJsonObjectputXmlObjectAtomicMode
from ...models.category_put_json_objectput_xml_object_flush_mode import CategoryPutJsonObjectputXmlObjectFlushMode
from ...models.category_put_json_objectput_xml_object_identifier import CategoryPutJsonObjectputXmlObjectIdentifier
from ...models.category_put_json_objectput_xml_object_import_mode import CategoryPutJsonObjectputXmlObjectImportMode
from ...models.category_put_json_objectput_xml_object_import_report_mode import (
    CategoryPutJsonObjectputXmlObjectImportReportMode,
)
from ...models.category_put_json_objectput_xml_object_import_strategy import (
    CategoryPutJsonObjectputXmlObjectImportStrategy,
)
from ...models.category_put_json_objectput_xml_object_preheat_mode import CategoryPutJsonObjectputXmlObjectPreheatMode
from ...models.category_put_json_objectput_xml_object_user_override_mode import (
    CategoryPutJsonObjectputXmlObjectUserOverrideMode,
)
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[
        Unset, CategoryPutJsonObjectputXmlObjectAtomicMode
    ] = CategoryPutJsonObjectputXmlObjectAtomicMode.ALL,
    flush_mode: Union[
        Unset, CategoryPutJsonObjectputXmlObjectFlushMode
    ] = CategoryPutJsonObjectputXmlObjectFlushMode.AUTO,
    identifier: Union[
        Unset, CategoryPutJsonObjectputXmlObjectIdentifier
    ] = CategoryPutJsonObjectputXmlObjectIdentifier.UID,
    import_mode: Union[
        Unset, CategoryPutJsonObjectputXmlObjectImportMode
    ] = CategoryPutJsonObjectputXmlObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, CategoryPutJsonObjectputXmlObjectImportReportMode
    ] = CategoryPutJsonObjectputXmlObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, CategoryPutJsonObjectputXmlObjectImportStrategy
    ] = CategoryPutJsonObjectputXmlObjectImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    preheat_mode: Union[
        Unset, CategoryPutJsonObjectputXmlObjectPreheatMode
    ] = CategoryPutJsonObjectputXmlObjectPreheatMode.REFERENCE,
    ...
    user_override_mode: Union[
        Unset, CategoryPutJsonObjectputXmlObjectUserOverrideMode
    ] = CategoryPutJsonObjectputXmlObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        uid (str): A UID for an Category object
            (Java name `org.hisp.dhis.category.Category`) Example: dU4oD3ey2A6.
        async_ (Union[Unset, bool]):  Default: False.
        atomic_mode (Union[Unset, CategoryPutJsonObjectputXmlObjectAtomicMode]):  Default:
            CategoryPutJsonObjectputXmlObjectAtomicMode.ALL.
        flush_mode (Union[Unset, CategoryPutJsonObjectputXmlObjectFlushMode]):  Default:
            CategoryPutJsonObjectputXmlObjectFlushMode.AUTO.
        identifier (Union[Unset, CategoryPutJsonObjectputXmlObjectIdentifier]):  Default:
            CategoryPutJsonObjectputXmlObjectIdentifier.UID.
        import_mode (Union[Unset, CategoryPutJsonObjectputXmlObjectImportMode]):  Default:
            CategoryPutJsonObjectputXmlObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, CategoryPutJsonObjectputXmlObjectImportReportMode]):
            Default: CategoryPutJsonObjectputXmlObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, CategoryPutJsonObjectputXmlObjectImportStrategy]):  Default:
            CategoryPutJsonObjectputXmlObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, CategoryPutJsonObjectputXmlObjectPreheatMode]):  Default:
            CategoryPutJsonObjectputXmlObjectPreheatMode.REFERENCE.
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, CategoryPutJsonObjectputXmlObjectUserOverrideMode]):
            Default: CategoryPutJsonObjectputXmlObjectUserOverrideMode.NONE.
        body (Category):
