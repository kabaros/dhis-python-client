...
from ...models.push_analysis_get_object_list_csv_root_junction import PushAnalysisGetObjectListCsvRootJunction
...
def _get_kwargs(
    *,
    ...
    root_junction: Union[Unset, PushAnalysisGetObjectListCsvRootJunction] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/pushAnalysis/#getObjectListCsv",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, PushAnalysisGetObjectListCsvRootJunction]):
