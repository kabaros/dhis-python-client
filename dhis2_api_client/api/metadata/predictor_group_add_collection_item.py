...
from ...models.predictor_group_add_collection_item_property import PredictorGroupAddCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: PredictorGroupAddCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
