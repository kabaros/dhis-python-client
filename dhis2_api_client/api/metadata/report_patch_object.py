...
from ...models.report_patch_object_atomic_mode import ReportPatchObjectAtomicMode
from ...models.report_patch_object_flush_mode import ReportPatchObjectFlushMode
from ...models.report_patch_object_identifier import ReportPatchObjectIdentifier
from ...models.report_patch_object_import_mode import ReportPatchObjectImportMode
from ...models.report_patch_object_import_report_mode import ReportPatchObjectImportReportMode
from ...models.report_patch_object_import_strategy import ReportPatchObjectImportStrategy
from ...models.report_patch_object_preheat_mode import ReportPatchObjectPreheatMode
from ...models.report_patch_object_root_junction import ReportPatchObjectRootJunction
from ...models.report_patch_object_user_override_mode import ReportPatchObjectUserOverrideMode
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[Unset, ReportPatchObjectAtomicMode] = ReportPatchObjectAtomicMode.ALL,
    flush_mode: Union[Unset, ReportPatchObjectFlushMode] = ReportPatchObjectFlushMode.AUTO,
    identifier: Union[Unset, ReportPatchObjectIdentifier] = ReportPatchObjectIdentifier.UID,
    import_mode: Union[Unset, ReportPatchObjectImportMode] = ReportPatchObjectImportMode.COMMIT,
    import_report_mode: Union[Unset, ReportPatchObjectImportReportMode] = ReportPatchObjectImportReportMode.ERRORS,
    import_strategy: Union[Unset, ReportPatchObjectImportStrategy] = ReportPatchObjectImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, ReportPatchObjectPreheatMode] = ReportPatchObjectPreheatMode.REFERENCE,
    root_junction: Union[Unset, ReportPatchObjectRootJunction] = UNSET,
    skip_sharing: Union[Unset, bool] = False,
    skip_translation: Union[Unset, bool] = False,
    skip_validation: Union[Unset, bool] = False,
    user: Union[Unset, str] = UNSET,
    user_override_mode: Union[Unset, ReportPatchObjectUserOverrideMode] = ReportPatchObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, ReportPatchObjectAtomicMode]):  Default:
            ReportPatchObjectAtomicMode.ALL.
        flush_mode (Union[Unset, ReportPatchObjectFlushMode]):  Default:
            ReportPatchObjectFlushMode.AUTO.
        identifier (Union[Unset, ReportPatchObjectIdentifier]):  Default:
            ReportPatchObjectIdentifier.UID.
        import_mode (Union[Unset, ReportPatchObjectImportMode]):  Default:
            ReportPatchObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, ReportPatchObjectImportReportMode]):  Default:
            ReportPatchObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, ReportPatchObjectImportStrategy]):  Default:
            ReportPatchObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, ReportPatchObjectPreheatMode]):  Default:
            ReportPatchObjectPreheatMode.REFERENCE.
        root_junction (Union[Unset, ReportPatchObjectRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, ReportPatchObjectUserOverrideMode]):  Default:
            ReportPatchObjectUserOverrideMode.NONE.
        body (JsonPatch):
