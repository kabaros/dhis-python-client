...
from ...models.category_option_delete_collection_items_jsondelete_collection_items_xml_property import (
    CategoryOptionDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: CategoryOptionDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
    *,
