...
from ...models.document_get_object_list_response_200 import DocumentGetObjectListResponse200
from ...models.document_get_object_list_root_junction import DocumentGetObjectListRootJunction
...
def _get_kwargs(
    *,
    ...
    root_junction: Union[Unset, DocumentGetObjectListRootJunction] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
) -> Optional[Union[DocumentGetObjectListResponse200, WebMessage]]:
    if response.status_code == 200:
        response_200 = DocumentGetObjectListResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DocumentGetObjectListResponse200, WebMessage]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, DocumentGetObjectListRootJunction]):
...
def sync(
    *,
    ...
    Returns:
        Union[DocumentGetObjectListResponse200, WebMessage]
    """
