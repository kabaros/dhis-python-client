...
from ...models.option_add_collection_items_jsonadd_collection_items_xml_property import (
    OptionAddCollectionItemsJsonaddCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: OptionAddCollectionItemsJsonaddCollectionItemsXmlProperty,
    *,
