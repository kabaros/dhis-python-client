...
from ...models.data_entry_form_delete_collection_items_jsondelete_collection_items_xml_property import (
    DataEntryFormDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: DataEntryFormDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
    *,
