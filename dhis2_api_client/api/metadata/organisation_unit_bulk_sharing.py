...
from ...models.organisation_unit_bulk_sharing_atomic_mode import OrganisationUnitBulkSharingAtomicMode
from ...models.organisation_unit_bulk_sharing_flush_mode import OrganisationUnitBulkSharingFlushMode
from ...models.organisation_unit_bulk_sharing_identifier import OrganisationUnitBulkSharingIdentifier
from ...models.organisation_unit_bulk_sharing_import_mode import OrganisationUnitBulkSharingImportMode
from ...models.organisation_unit_bulk_sharing_import_report_mode import OrganisationUnitBulkSharingImportReportMode
from ...models.organisation_unit_bulk_sharing_import_strategy import OrganisationUnitBulkSharingImportStrategy
from ...models.organisation_unit_bulk_sharing_preheat_mode import OrganisationUnitBulkSharingPreheatMode
from ...models.organisation_unit_bulk_sharing_root_junction import OrganisationUnitBulkSharingRootJunction
from ...models.organisation_unit_bulk_sharing_user_override_mode import OrganisationUnitBulkSharingUserOverrideMode
...
def _get_kwargs(
    *,
    ...
    atomic_mode: Union[Unset, OrganisationUnitBulkSharingAtomicMode] = OrganisationUnitBulkSharingAtomicMode.ALL,
    flush_mode: Union[Unset, OrganisationUnitBulkSharingFlushMode] = OrganisationUnitBulkSharingFlushMode.AUTO,
    identifier: Union[Unset, OrganisationUnitBulkSharingIdentifier] = OrganisationUnitBulkSharingIdentifier.UID,
    import_mode: Union[Unset, OrganisationUnitBulkSharingImportMode] = OrganisationUnitBulkSharingImportMode.COMMIT,
    import_report_mode: Union[
        Unset, OrganisationUnitBulkSharingImportReportMode
    ] = OrganisationUnitBulkSharingImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, OrganisationUnitBulkSharingImportStrategy
    ] = OrganisationUnitBulkSharingImportStrategy.CREATE_AND_UPDATE,
    ...
    preheat_mode: Union[
        Unset, OrganisationUnitBulkSharingPreheatMode
    ] = OrganisationUnitBulkSharingPreheatMode.REFERENCE,
    root_junction: Union[Unset, OrganisationUnitBulkSharingRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, OrganisationUnitBulkSharingUserOverrideMode
    ] = OrganisationUnitBulkSharingUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, OrganisationUnitBulkSharingAtomicMode]):  Default:
            OrganisationUnitBulkSharingAtomicMode.ALL.
        flush_mode (Union[Unset, OrganisationUnitBulkSharingFlushMode]):  Default:
            OrganisationUnitBulkSharingFlushMode.AUTO.
        identifier (Union[Unset, OrganisationUnitBulkSharingIdentifier]):  Default:
            OrganisationUnitBulkSharingIdentifier.UID.
        import_mode (Union[Unset, OrganisationUnitBulkSharingImportMode]):  Default:
            OrganisationUnitBulkSharingImportMode.COMMIT.
        import_report_mode (Union[Unset, OrganisationUnitBulkSharingImportReportMode]):  Default:
            OrganisationUnitBulkSharingImportReportMode.ERRORS.
        import_strategy (Union[Unset, OrganisationUnitBulkSharingImportStrategy]):  Default:
            OrganisationUnitBulkSharingImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, OrganisationUnitBulkSharingPreheatMode]):  Default:
            OrganisationUnitBulkSharingPreheatMode.REFERENCE.
        root_junction (Union[Unset, OrganisationUnitBulkSharingRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, OrganisationUnitBulkSharingUserOverrideMode]):  Default:
            OrganisationUnitBulkSharingUserOverrideMode.NONE.
        body (BulkJsonPatch):
