...
from ...models.data_set_post_json_objectpost_xml_object_atomic_mode import DataSetPostJsonObjectpostXmlObjectAtomicMode
from ...models.data_set_post_json_objectpost_xml_object_flush_mode import DataSetPostJsonObjectpostXmlObjectFlushMode
from ...models.data_set_post_json_objectpost_xml_object_identifier import DataSetPostJsonObjectpostXmlObjectIdentifier
from ...models.data_set_post_json_objectpost_xml_object_import_mode import DataSetPostJsonObjectpostXmlObjectImportMode
from ...models.data_set_post_json_objectpost_xml_object_import_report_mode import (
    DataSetPostJsonObjectpostXmlObjectImportReportMode,
)
from ...models.data_set_post_json_objectpost_xml_object_import_strategy import (
    DataSetPostJsonObjectpostXmlObjectImportStrategy,
)
from ...models.data_set_post_json_objectpost_xml_object_preheat_mode import (
    DataSetPostJsonObjectpostXmlObjectPreheatMode,
)
from ...models.data_set_post_json_objectpost_xml_object_user_override_mode import (
    DataSetPostJsonObjectpostXmlObjectUserOverrideMode,
)
...
def _get_kwargs(
    *,
    ...
    atomic_mode: Union[
        Unset, DataSetPostJsonObjectpostXmlObjectAtomicMode
    ] = DataSetPostJsonObjectpostXmlObjectAtomicMode.ALL,
    flush_mode: Union[
        Unset, DataSetPostJsonObjectpostXmlObjectFlushMode
    ] = DataSetPostJsonObjectpostXmlObjectFlushMode.AUTO,
    identifier: Union[
        Unset, DataSetPostJsonObjectpostXmlObjectIdentifier
    ] = DataSetPostJsonObjectpostXmlObjectIdentifier.UID,
    import_mode: Union[
        Unset, DataSetPostJsonObjectpostXmlObjectImportMode
    ] = DataSetPostJsonObjectpostXmlObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, DataSetPostJsonObjectpostXmlObjectImportReportMode
    ] = DataSetPostJsonObjectpostXmlObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, DataSetPostJsonObjectpostXmlObjectImportStrategy
    ] = DataSetPostJsonObjectpostXmlObjectImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    preheat_mode: Union[
        Unset, DataSetPostJsonObjectpostXmlObjectPreheatMode
    ] = DataSetPostJsonObjectpostXmlObjectPreheatMode.REFERENCE,
    ...
    user_override_mode: Union[
        Unset, DataSetPostJsonObjectpostXmlObjectUserOverrideMode
    ] = DataSetPostJsonObjectpostXmlObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, DataSetPostJsonObjectpostXmlObjectAtomicMode]):  Default:
            DataSetPostJsonObjectpostXmlObjectAtomicMode.ALL.
        flush_mode (Union[Unset, DataSetPostJsonObjectpostXmlObjectFlushMode]):  Default:
            DataSetPostJsonObjectpostXmlObjectFlushMode.AUTO.
        identifier (Union[Unset, DataSetPostJsonObjectpostXmlObjectIdentifier]):  Default:
            DataSetPostJsonObjectpostXmlObjectIdentifier.UID.
        import_mode (Union[Unset, DataSetPostJsonObjectpostXmlObjectImportMode]):  Default:
            DataSetPostJsonObjectpostXmlObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, DataSetPostJsonObjectpostXmlObjectImportReportMode]):
            Default: DataSetPostJsonObjectpostXmlObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, DataSetPostJsonObjectpostXmlObjectImportStrategy]):
            Default: DataSetPostJsonObjectpostXmlObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, DataSetPostJsonObjectpostXmlObjectPreheatMode]):  Default:
            DataSetPostJsonObjectpostXmlObjectPreheatMode.REFERENCE.
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, DataSetPostJsonObjectpostXmlObjectUserOverrideMode]):
            Default: DataSetPostJsonObjectpostXmlObjectUserOverrideMode.NONE.
        body (DataSet):
