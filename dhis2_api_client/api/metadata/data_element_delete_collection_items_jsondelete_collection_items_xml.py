...
from ...models.data_element_delete_collection_items_jsondelete_collection_items_xml_property import (
    DataElementDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: DataElementDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
    *,
