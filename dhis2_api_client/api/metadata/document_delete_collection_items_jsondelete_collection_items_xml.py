...
from ...models.document_delete_collection_items_jsondelete_collection_items_xml_property import (
    DocumentDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: DocumentDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
    *,
