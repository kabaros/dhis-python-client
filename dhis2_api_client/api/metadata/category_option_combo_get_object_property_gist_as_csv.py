...
from ...models.category_option_combo_get_object_property_gist_as_csv_auto import (
    CategoryOptionComboGetObjectPropertyGistAsCsvAuto,
)
from ...models.category_option_combo_get_object_property_gist_as_csv_property import (
    CategoryOptionComboGetObjectPropertyGistAsCsvProperty,
)
from ...models.category_option_combo_get_object_property_gist_as_csv_root_junction import (
    CategoryOptionComboGetObjectPropertyGistAsCsvRootJunction,
)
...
def _get_kwargs(
    uid: str,
    property_: CategoryOptionComboGetObjectPropertyGistAsCsvProperty,
    *,
    absolute_urls: Union[Unset, bool] = False,
    auto: Union[Unset, CategoryOptionComboGetObjectPropertyGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, CategoryOptionComboGetObjectPropertyGistAsCsvRootJunction
    ] = CategoryOptionComboGetObjectPropertyGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/categoryOptionCombos/{uid}/{property_}/gist.csv",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, CategoryOptionComboGetObjectPropertyGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, CategoryOptionComboGetObjectPropertyGistAsCsvRootJunction]):
            Default: CategoryOptionComboGetObjectPropertyGistAsCsvRootJunction.AND.
