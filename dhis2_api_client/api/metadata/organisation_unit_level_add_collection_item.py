...
from ...models.organisation_unit_level_add_collection_item_property import (
    OrganisationUnitLevelAddCollectionItemProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: OrganisationUnitLevelAddCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
