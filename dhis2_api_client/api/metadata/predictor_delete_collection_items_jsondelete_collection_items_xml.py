...
from ...models.predictor_delete_collection_items_jsondelete_collection_items_xml_property import (
    PredictorDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: PredictorDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
    *,
