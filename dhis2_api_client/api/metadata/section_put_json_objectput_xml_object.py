...
from ...models.section_put_json_objectput_xml_object_atomic_mode import SectionPutJsonObjectputXmlObjectAtomicMode
from ...models.section_put_json_objectput_xml_object_flush_mode import SectionPutJsonObjectputXmlObjectFlushMode
from ...models.section_put_json_objectput_xml_object_identifier import SectionPutJsonObjectputXmlObjectIdentifier
from ...models.section_put_json_objectput_xml_object_import_mode import SectionPutJsonObjectputXmlObjectImportMode
from ...models.section_put_json_objectput_xml_object_import_report_mode import (
    SectionPutJsonObjectputXmlObjectImportReportMode,
)
from ...models.section_put_json_objectput_xml_object_import_strategy import (
    SectionPutJsonObjectputXmlObjectImportStrategy,
)
from ...models.section_put_json_objectput_xml_object_preheat_mode import SectionPutJsonObjectputXmlObjectPreheatMode
from ...models.section_put_json_objectput_xml_object_user_override_mode import (
    SectionPutJsonObjectputXmlObjectUserOverrideMode,
)
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[
        Unset, SectionPutJsonObjectputXmlObjectAtomicMode
    ] = SectionPutJsonObjectputXmlObjectAtomicMode.ALL,
    flush_mode: Union[
        Unset, SectionPutJsonObjectputXmlObjectFlushMode
    ] = SectionPutJsonObjectputXmlObjectFlushMode.AUTO,
    identifier: Union[
        Unset, SectionPutJsonObjectputXmlObjectIdentifier
    ] = SectionPutJsonObjectputXmlObjectIdentifier.UID,
    import_mode: Union[
        Unset, SectionPutJsonObjectputXmlObjectImportMode
    ] = SectionPutJsonObjectputXmlObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, SectionPutJsonObjectputXmlObjectImportReportMode
    ] = SectionPutJsonObjectputXmlObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, SectionPutJsonObjectputXmlObjectImportStrategy
    ] = SectionPutJsonObjectputXmlObjectImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    preheat_mode: Union[
        Unset, SectionPutJsonObjectputXmlObjectPreheatMode
    ] = SectionPutJsonObjectputXmlObjectPreheatMode.REFERENCE,
    ...
    user_override_mode: Union[
        Unset, SectionPutJsonObjectputXmlObjectUserOverrideMode
    ] = SectionPutJsonObjectputXmlObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        uid (str): A UID for an Section object
            (Java name `org.hisp.dhis.dataset.Section`) Example: sX3CE29Vq45.
        async_ (Union[Unset, bool]):  Default: False.
        atomic_mode (Union[Unset, SectionPutJsonObjectputXmlObjectAtomicMode]):  Default:
            SectionPutJsonObjectputXmlObjectAtomicMode.ALL.
        flush_mode (Union[Unset, SectionPutJsonObjectputXmlObjectFlushMode]):  Default:
            SectionPutJsonObjectputXmlObjectFlushMode.AUTO.
        identifier (Union[Unset, SectionPutJsonObjectputXmlObjectIdentifier]):  Default:
            SectionPutJsonObjectputXmlObjectIdentifier.UID.
        import_mode (Union[Unset, SectionPutJsonObjectputXmlObjectImportMode]):  Default:
            SectionPutJsonObjectputXmlObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, SectionPutJsonObjectputXmlObjectImportReportMode]):
            Default: SectionPutJsonObjectputXmlObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, SectionPutJsonObjectputXmlObjectImportStrategy]):  Default:
            SectionPutJsonObjectputXmlObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, SectionPutJsonObjectputXmlObjectPreheatMode]):  Default:
            SectionPutJsonObjectputXmlObjectPreheatMode.REFERENCE.
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, SectionPutJsonObjectputXmlObjectUserOverrideMode]):
            Default: SectionPutJsonObjectputXmlObjectUserOverrideMode.NONE.
        body (Section):
