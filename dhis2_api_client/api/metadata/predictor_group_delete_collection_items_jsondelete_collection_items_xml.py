...
from ...models.predictor_group_delete_collection_items_jsondelete_collection_items_xml_property import (
    PredictorGroupDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: PredictorGroupDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
    *,
