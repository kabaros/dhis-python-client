...
from ...models.organisation_unit_level_patch_object_atomic_mode import OrganisationUnitLevelPatchObjectAtomicMode
from ...models.organisation_unit_level_patch_object_flush_mode import OrganisationUnitLevelPatchObjectFlushMode
from ...models.organisation_unit_level_patch_object_identifier import OrganisationUnitLevelPatchObjectIdentifier
from ...models.organisation_unit_level_patch_object_import_mode import OrganisationUnitLevelPatchObjectImportMode
from ...models.organisation_unit_level_patch_object_import_report_mode import (
    OrganisationUnitLevelPatchObjectImportReportMode,
)
from ...models.organisation_unit_level_patch_object_import_strategy import (
    OrganisationUnitLevelPatchObjectImportStrategy,
)
from ...models.organisation_unit_level_patch_object_preheat_mode import OrganisationUnitLevelPatchObjectPreheatMode
from ...models.organisation_unit_level_patch_object_root_junction import OrganisationUnitLevelPatchObjectRootJunction
from ...models.organisation_unit_level_patch_object_user_override_mode import (
    OrganisationUnitLevelPatchObjectUserOverrideMode,
)
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[
        Unset, OrganisationUnitLevelPatchObjectAtomicMode
    ] = OrganisationUnitLevelPatchObjectAtomicMode.ALL,
    flush_mode: Union[
        Unset, OrganisationUnitLevelPatchObjectFlushMode
    ] = OrganisationUnitLevelPatchObjectFlushMode.AUTO,
    identifier: Union[
        Unset, OrganisationUnitLevelPatchObjectIdentifier
    ] = OrganisationUnitLevelPatchObjectIdentifier.UID,
    import_mode: Union[
        Unset, OrganisationUnitLevelPatchObjectImportMode
    ] = OrganisationUnitLevelPatchObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, OrganisationUnitLevelPatchObjectImportReportMode
    ] = OrganisationUnitLevelPatchObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, OrganisationUnitLevelPatchObjectImportStrategy
    ] = OrganisationUnitLevelPatchObjectImportStrategy.CREATE_AND_UPDATE,
    ...
    preheat_mode: Union[
        Unset, OrganisationUnitLevelPatchObjectPreheatMode
    ] = OrganisationUnitLevelPatchObjectPreheatMode.REFERENCE,
    root_junction: Union[Unset, OrganisationUnitLevelPatchObjectRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, OrganisationUnitLevelPatchObjectUserOverrideMode
    ] = OrganisationUnitLevelPatchObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, OrganisationUnitLevelPatchObjectAtomicMode]):  Default:
            OrganisationUnitLevelPatchObjectAtomicMode.ALL.
        flush_mode (Union[Unset, OrganisationUnitLevelPatchObjectFlushMode]):  Default:
            OrganisationUnitLevelPatchObjectFlushMode.AUTO.
        identifier (Union[Unset, OrganisationUnitLevelPatchObjectIdentifier]):  Default:
            OrganisationUnitLevelPatchObjectIdentifier.UID.
        import_mode (Union[Unset, OrganisationUnitLevelPatchObjectImportMode]):  Default:
            OrganisationUnitLevelPatchObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, OrganisationUnitLevelPatchObjectImportReportMode]):
            Default: OrganisationUnitLevelPatchObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, OrganisationUnitLevelPatchObjectImportStrategy]):  Default:
            OrganisationUnitLevelPatchObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, OrganisationUnitLevelPatchObjectPreheatMode]):  Default:
            OrganisationUnitLevelPatchObjectPreheatMode.REFERENCE.
        root_junction (Union[Unset, OrganisationUnitLevelPatchObjectRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, OrganisationUnitLevelPatchObjectUserOverrideMode]):
            Default: OrganisationUnitLevelPatchObjectUserOverrideMode.NONE.
        body (JsonPatch):
