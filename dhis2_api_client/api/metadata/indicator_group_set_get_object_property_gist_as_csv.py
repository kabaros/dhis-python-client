...
from ...models.indicator_group_set_get_object_property_gist_as_csv_auto import (
    IndicatorGroupSetGetObjectPropertyGistAsCsvAuto,
)
from ...models.indicator_group_set_get_object_property_gist_as_csv_property import (
    IndicatorGroupSetGetObjectPropertyGistAsCsvProperty,
)
from ...models.indicator_group_set_get_object_property_gist_as_csv_root_junction import (
    IndicatorGroupSetGetObjectPropertyGistAsCsvRootJunction,
)
...
def _get_kwargs(
    uid: str,
    property_: IndicatorGroupSetGetObjectPropertyGistAsCsvProperty,
    *,
    absolute_urls: Union[Unset, bool] = False,
    auto: Union[Unset, IndicatorGroupSetGetObjectPropertyGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, IndicatorGroupSetGetObjectPropertyGistAsCsvRootJunction
    ] = IndicatorGroupSetGetObjectPropertyGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/indicatorGroupSets/{uid}/{property_}/gist.csv",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, IndicatorGroupSetGetObjectPropertyGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, IndicatorGroupSetGetObjectPropertyGistAsCsvRootJunction]):
            Default: IndicatorGroupSetGetObjectPropertyGistAsCsvRootJunction.AND.
