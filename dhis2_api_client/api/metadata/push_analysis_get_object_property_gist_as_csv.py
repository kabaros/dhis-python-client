...
from ...models.push_analysis_get_object_property_gist_as_csv_auto import PushAnalysisGetObjectPropertyGistAsCsvAuto
from ...models.push_analysis_get_object_property_gist_as_csv_property import (
    PushAnalysisGetObjectPropertyGistAsCsvProperty,
)
from ...models.push_analysis_get_object_property_gist_as_csv_root_junction import (
    PushAnalysisGetObjectPropertyGistAsCsvRootJunction,
)
...
def _get_kwargs(
    uid: str,
    property_: PushAnalysisGetObjectPropertyGistAsCsvProperty,
    *,
    absolute_urls: Union[Unset, bool] = False,
    auto: Union[Unset, PushAnalysisGetObjectPropertyGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, PushAnalysisGetObjectPropertyGistAsCsvRootJunction
    ] = PushAnalysisGetObjectPropertyGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/pushAnalysis/{uid}/{property_}/gist.csv",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, PushAnalysisGetObjectPropertyGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, PushAnalysisGetObjectPropertyGistAsCsvRootJunction]):
            Default: PushAnalysisGetObjectPropertyGistAsCsvRootJunction.AND.
