...
from ...models.organisation_unit_get_parents_response_200 import OrganisationUnitGetParentsResponse200
from ...models.organisation_unit_get_parents_root_junction import OrganisationUnitGetParentsRootJunction
...
def _get_kwargs(
    ...
    *,
    ...
    root_junction: Union[Unset, OrganisationUnitGetParentsRootJunction] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/organisationUnits/{uid}/parents",
        "params": params,
    }
...
) -> Optional[Union[OrganisationUnitGetParentsResponse200, WebMessage]]:
    if response.status_code == 200:
        response_200 = OrganisationUnitGetParentsResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[OrganisationUnitGetParentsResponse200, WebMessage]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, OrganisationUnitGetParentsRootJunction]):
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[OrganisationUnitGetParentsResponse200, WebMessage]
    """
