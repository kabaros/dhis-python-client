...
from ...models.metadata_workflow_get_proposals_auto import MetadataWorkflowGetProposalsAuto
from ...models.metadata_workflow_get_proposals_response_200 import MetadataWorkflowGetProposalsResponse200
from ...models.metadata_workflow_get_proposals_root_junction import MetadataWorkflowGetProposalsRootJunction
...
def _get_kwargs(
    *,
    ...
    auto: Union[Unset, MetadataWorkflowGetProposalsAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, MetadataWorkflowGetProposalsRootJunction
    ] = MetadataWorkflowGetProposalsRootJunction.AND,
...
) -> Optional[Union[MetadataWorkflowGetProposalsResponse200, WebMessage]]:
    if response.status_code == 200:
        response_200 = MetadataWorkflowGetProposalsResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[MetadataWorkflowGetProposalsResponse200, WebMessage]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        auto (Union[Unset, MetadataWorkflowGetProposalsAuto]):
        ...
        root_junction (Union[Unset, MetadataWorkflowGetProposalsRootJunction]):  Default:
            MetadataWorkflowGetProposalsRootJunction.AND.
...
def sync(
    *,
    ...
    Returns:
        Union[MetadataWorkflowGetProposalsResponse200, WebMessage]
    """
