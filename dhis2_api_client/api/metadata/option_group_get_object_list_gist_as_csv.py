...
from ...models.option_group_get_object_list_gist_as_csv_auto import OptionGroupGetObjectListGistAsCsvAuto
from ...models.option_group_get_object_list_gist_as_csv_root_junction import (
    OptionGroupGetObjectListGistAsCsvRootJunction,
)
...
def _get_kwargs(
    *,
    ...
    auto: Union[Unset, OptionGroupGetObjectListGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, OptionGroupGetObjectListGistAsCsvRootJunction
    ] = OptionGroupGetObjectListGistAsCsvRootJunction.AND,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        auto (Union[Unset, OptionGroupGetObjectListGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, OptionGroupGetObjectListGistAsCsvRootJunction]):  Default:
            OptionGroupGetObjectListGistAsCsvRootJunction.AND.
