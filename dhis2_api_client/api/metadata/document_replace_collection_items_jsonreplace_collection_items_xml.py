...
from ...models.document_replace_collection_items_jsonreplace_collection_items_xml_property import (
    DocumentReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: DocumentReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
    *,
