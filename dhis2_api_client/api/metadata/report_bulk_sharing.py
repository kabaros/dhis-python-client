...
from ...models.report_bulk_sharing_atomic_mode import ReportBulkSharingAtomicMode
from ...models.report_bulk_sharing_flush_mode import ReportBulkSharingFlushMode
from ...models.report_bulk_sharing_identifier import ReportBulkSharingIdentifier
from ...models.report_bulk_sharing_import_mode import ReportBulkSharingImportMode
from ...models.report_bulk_sharing_import_report_mode import ReportBulkSharingImportReportMode
from ...models.report_bulk_sharing_import_strategy import ReportBulkSharingImportStrategy
from ...models.report_bulk_sharing_preheat_mode import ReportBulkSharingPreheatMode
from ...models.report_bulk_sharing_root_junction import ReportBulkSharingRootJunction
from ...models.report_bulk_sharing_user_override_mode import ReportBulkSharingUserOverrideMode
...
def _get_kwargs(
    *,
    ...
    atomic_mode: Union[Unset, ReportBulkSharingAtomicMode] = ReportBulkSharingAtomicMode.ALL,
    flush_mode: Union[Unset, ReportBulkSharingFlushMode] = ReportBulkSharingFlushMode.AUTO,
    identifier: Union[Unset, ReportBulkSharingIdentifier] = ReportBulkSharingIdentifier.UID,
    import_mode: Union[Unset, ReportBulkSharingImportMode] = ReportBulkSharingImportMode.COMMIT,
    import_report_mode: Union[Unset, ReportBulkSharingImportReportMode] = ReportBulkSharingImportReportMode.ERRORS,
    import_strategy: Union[Unset, ReportBulkSharingImportStrategy] = ReportBulkSharingImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, ReportBulkSharingPreheatMode] = ReportBulkSharingPreheatMode.REFERENCE,
    root_junction: Union[Unset, ReportBulkSharingRootJunction] = UNSET,
    skip_sharing: Union[Unset, bool] = False,
    skip_translation: Union[Unset, bool] = False,
    skip_validation: Union[Unset, bool] = False,
    user: Union[Unset, str] = UNSET,
    user_override_mode: Union[Unset, ReportBulkSharingUserOverrideMode] = ReportBulkSharingUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, ReportBulkSharingAtomicMode]):  Default:
            ReportBulkSharingAtomicMode.ALL.
        flush_mode (Union[Unset, ReportBulkSharingFlushMode]):  Default:
            ReportBulkSharingFlushMode.AUTO.
        identifier (Union[Unset, ReportBulkSharingIdentifier]):  Default:
            ReportBulkSharingIdentifier.UID.
        import_mode (Union[Unset, ReportBulkSharingImportMode]):  Default:
            ReportBulkSharingImportMode.COMMIT.
        import_report_mode (Union[Unset, ReportBulkSharingImportReportMode]):  Default:
            ReportBulkSharingImportReportMode.ERRORS.
        import_strategy (Union[Unset, ReportBulkSharingImportStrategy]):  Default:
            ReportBulkSharingImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, ReportBulkSharingPreheatMode]):  Default:
            ReportBulkSharingPreheatMode.REFERENCE.
        root_junction (Union[Unset, ReportBulkSharingRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, ReportBulkSharingUserOverrideMode]):  Default:
            ReportBulkSharingUserOverrideMode.NONE.
        body (BulkJsonPatch):
