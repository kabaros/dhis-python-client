...
from ...models.option_group_set_delete_collection_item_property import OptionGroupSetDeleteCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: OptionGroupSetDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/optionGroupSets/{uid}/{property_}/{item_id}",
    }
