...
from ...models.category_option_get_object_property_gist_as_csv_auto import CategoryOptionGetObjectPropertyGistAsCsvAuto
from ...models.category_option_get_object_property_gist_as_csv_property import (
    CategoryOptionGetObjectPropertyGistAsCsvProperty,
)
from ...models.category_option_get_object_property_gist_as_csv_root_junction import (
    CategoryOptionGetObjectPropertyGistAsCsvRootJunction,
)
...
def _get_kwargs(
    uid: str,
    property_: CategoryOptionGetObjectPropertyGistAsCsvProperty,
    *,
    absolute_urls: Union[Unset, bool] = False,
    auto: Union[Unset, CategoryOptionGetObjectPropertyGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, CategoryOptionGetObjectPropertyGistAsCsvRootJunction
    ] = CategoryOptionGetObjectPropertyGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/categoryOptions/{uid}/{property_}/gist.csv",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, CategoryOptionGetObjectPropertyGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, CategoryOptionGetObjectPropertyGistAsCsvRootJunction]):
            Default: CategoryOptionGetObjectPropertyGistAsCsvRootJunction.AND.
