...
from ...models.constant_put_json_objectput_xml_object_atomic_mode import ConstantPutJsonObjectputXmlObjectAtomicMode
from ...models.constant_put_json_objectput_xml_object_flush_mode import ConstantPutJsonObjectputXmlObjectFlushMode
from ...models.constant_put_json_objectput_xml_object_identifier import ConstantPutJsonObjectputXmlObjectIdentifier
from ...models.constant_put_json_objectput_xml_object_import_mode import ConstantPutJsonObjectputXmlObjectImportMode
from ...models.constant_put_json_objectput_xml_object_import_report_mode import (
    ConstantPutJsonObjectputXmlObjectImportReportMode,
)
from ...models.constant_put_json_objectput_xml_object_import_strategy import (
    ConstantPutJsonObjectputXmlObjectImportStrategy,
)
from ...models.constant_put_json_objectput_xml_object_preheat_mode import ConstantPutJsonObjectputXmlObjectPreheatMode
from ...models.constant_put_json_objectput_xml_object_user_override_mode import (
    ConstantPutJsonObjectputXmlObjectUserOverrideMode,
)
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[
        Unset, ConstantPutJsonObjectputXmlObjectAtomicMode
    ] = ConstantPutJsonObjectputXmlObjectAtomicMode.ALL,
    flush_mode: Union[
        Unset, ConstantPutJsonObjectputXmlObjectFlushMode
    ] = ConstantPutJsonObjectputXmlObjectFlushMode.AUTO,
    identifier: Union[
        Unset, ConstantPutJsonObjectputXmlObjectIdentifier
    ] = ConstantPutJsonObjectputXmlObjectIdentifier.UID,
    import_mode: Union[
        Unset, ConstantPutJsonObjectputXmlObjectImportMode
    ] = ConstantPutJsonObjectputXmlObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, ConstantPutJsonObjectputXmlObjectImportReportMode
    ] = ConstantPutJsonObjectputXmlObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, ConstantPutJsonObjectputXmlObjectImportStrategy
    ] = ConstantPutJsonObjectputXmlObjectImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    preheat_mode: Union[
        Unset, ConstantPutJsonObjectputXmlObjectPreheatMode
    ] = ConstantPutJsonObjectputXmlObjectPreheatMode.REFERENCE,
    ...
    user_override_mode: Union[
        Unset, ConstantPutJsonObjectputXmlObjectUserOverrideMode
    ] = ConstantPutJsonObjectputXmlObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        uid (str): A UID for an Constant object
            (Java name `org.hisp.dhis.constant.Constant`) Example: d8kC0Ka9TO8.
        async_ (Union[Unset, bool]):  Default: False.
        atomic_mode (Union[Unset, ConstantPutJsonObjectputXmlObjectAtomicMode]):  Default:
            ConstantPutJsonObjectputXmlObjectAtomicMode.ALL.
        flush_mode (Union[Unset, ConstantPutJsonObjectputXmlObjectFlushMode]):  Default:
            ConstantPutJsonObjectputXmlObjectFlushMode.AUTO.
        identifier (Union[Unset, ConstantPutJsonObjectputXmlObjectIdentifier]):  Default:
            ConstantPutJsonObjectputXmlObjectIdentifier.UID.
        import_mode (Union[Unset, ConstantPutJsonObjectputXmlObjectImportMode]):  Default:
            ConstantPutJsonObjectputXmlObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, ConstantPutJsonObjectputXmlObjectImportReportMode]):
            Default: ConstantPutJsonObjectputXmlObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, ConstantPutJsonObjectputXmlObjectImportStrategy]):  Default:
            ConstantPutJsonObjectputXmlObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, ConstantPutJsonObjectputXmlObjectPreheatMode]):  Default:
            ConstantPutJsonObjectputXmlObjectPreheatMode.REFERENCE.
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, ConstantPutJsonObjectputXmlObjectUserOverrideMode]):
            Default: ConstantPutJsonObjectputXmlObjectUserOverrideMode.NONE.
        body (Constant):
