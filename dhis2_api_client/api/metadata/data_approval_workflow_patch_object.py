...
from ...models.data_approval_workflow_patch_object_atomic_mode import DataApprovalWorkflowPatchObjectAtomicMode
from ...models.data_approval_workflow_patch_object_flush_mode import DataApprovalWorkflowPatchObjectFlushMode
from ...models.data_approval_workflow_patch_object_identifier import DataApprovalWorkflowPatchObjectIdentifier
from ...models.data_approval_workflow_patch_object_import_mode import DataApprovalWorkflowPatchObjectImportMode
from ...models.data_approval_workflow_patch_object_import_report_mode import (
    DataApprovalWorkflowPatchObjectImportReportMode,
)
from ...models.data_approval_workflow_patch_object_import_strategy import DataApprovalWorkflowPatchObjectImportStrategy
from ...models.data_approval_workflow_patch_object_preheat_mode import DataApprovalWorkflowPatchObjectPreheatMode
from ...models.data_approval_workflow_patch_object_root_junction import DataApprovalWorkflowPatchObjectRootJunction
from ...models.data_approval_workflow_patch_object_user_override_mode import (
    DataApprovalWorkflowPatchObjectUserOverrideMode,
)
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[
        Unset, DataApprovalWorkflowPatchObjectAtomicMode
    ] = DataApprovalWorkflowPatchObjectAtomicMode.ALL,
    flush_mode: Union[Unset, DataApprovalWorkflowPatchObjectFlushMode] = DataApprovalWorkflowPatchObjectFlushMode.AUTO,
    identifier: Union[Unset, DataApprovalWorkflowPatchObjectIdentifier] = DataApprovalWorkflowPatchObjectIdentifier.UID,
    import_mode: Union[
        Unset, DataApprovalWorkflowPatchObjectImportMode
    ] = DataApprovalWorkflowPatchObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, DataApprovalWorkflowPatchObjectImportReportMode
    ] = DataApprovalWorkflowPatchObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, DataApprovalWorkflowPatchObjectImportStrategy
    ] = DataApprovalWorkflowPatchObjectImportStrategy.CREATE_AND_UPDATE,
    ...
    preheat_mode: Union[
        Unset, DataApprovalWorkflowPatchObjectPreheatMode
    ] = DataApprovalWorkflowPatchObjectPreheatMode.REFERENCE,
    root_junction: Union[Unset, DataApprovalWorkflowPatchObjectRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, DataApprovalWorkflowPatchObjectUserOverrideMode
    ] = DataApprovalWorkflowPatchObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, DataApprovalWorkflowPatchObjectAtomicMode]):  Default:
            DataApprovalWorkflowPatchObjectAtomicMode.ALL.
        flush_mode (Union[Unset, DataApprovalWorkflowPatchObjectFlushMode]):  Default:
            DataApprovalWorkflowPatchObjectFlushMode.AUTO.
        identifier (Union[Unset, DataApprovalWorkflowPatchObjectIdentifier]):  Default:
            DataApprovalWorkflowPatchObjectIdentifier.UID.
        import_mode (Union[Unset, DataApprovalWorkflowPatchObjectImportMode]):  Default:
            DataApprovalWorkflowPatchObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, DataApprovalWorkflowPatchObjectImportReportMode]):
            Default: DataApprovalWorkflowPatchObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, DataApprovalWorkflowPatchObjectImportStrategy]):  Default:
            DataApprovalWorkflowPatchObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, DataApprovalWorkflowPatchObjectPreheatMode]):  Default:
            DataApprovalWorkflowPatchObjectPreheatMode.REFERENCE.
        root_junction (Union[Unset, DataApprovalWorkflowPatchObjectRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, DataApprovalWorkflowPatchObjectUserOverrideMode]):
            Default: DataApprovalWorkflowPatchObjectUserOverrideMode.NONE.
        body (JsonPatch):
