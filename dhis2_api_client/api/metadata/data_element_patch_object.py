...
from ...models.data_element_patch_object_atomic_mode import DataElementPatchObjectAtomicMode
from ...models.data_element_patch_object_flush_mode import DataElementPatchObjectFlushMode
from ...models.data_element_patch_object_identifier import DataElementPatchObjectIdentifier
from ...models.data_element_patch_object_import_mode import DataElementPatchObjectImportMode
from ...models.data_element_patch_object_import_report_mode import DataElementPatchObjectImportReportMode
from ...models.data_element_patch_object_import_strategy import DataElementPatchObjectImportStrategy
from ...models.data_element_patch_object_preheat_mode import DataElementPatchObjectPreheatMode
from ...models.data_element_patch_object_root_junction import DataElementPatchObjectRootJunction
from ...models.data_element_patch_object_user_override_mode import DataElementPatchObjectUserOverrideMode
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[Unset, DataElementPatchObjectAtomicMode] = DataElementPatchObjectAtomicMode.ALL,
    flush_mode: Union[Unset, DataElementPatchObjectFlushMode] = DataElementPatchObjectFlushMode.AUTO,
    identifier: Union[Unset, DataElementPatchObjectIdentifier] = DataElementPatchObjectIdentifier.UID,
    import_mode: Union[Unset, DataElementPatchObjectImportMode] = DataElementPatchObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, DataElementPatchObjectImportReportMode
    ] = DataElementPatchObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, DataElementPatchObjectImportStrategy
    ] = DataElementPatchObjectImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, DataElementPatchObjectPreheatMode] = DataElementPatchObjectPreheatMode.REFERENCE,
    root_junction: Union[Unset, DataElementPatchObjectRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, DataElementPatchObjectUserOverrideMode
    ] = DataElementPatchObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, DataElementPatchObjectAtomicMode]):  Default:
            DataElementPatchObjectAtomicMode.ALL.
        flush_mode (Union[Unset, DataElementPatchObjectFlushMode]):  Default:
            DataElementPatchObjectFlushMode.AUTO.
        identifier (Union[Unset, DataElementPatchObjectIdentifier]):  Default:
            DataElementPatchObjectIdentifier.UID.
        import_mode (Union[Unset, DataElementPatchObjectImportMode]):  Default:
            DataElementPatchObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, DataElementPatchObjectImportReportMode]):  Default:
            DataElementPatchObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, DataElementPatchObjectImportStrategy]):  Default:
            DataElementPatchObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, DataElementPatchObjectPreheatMode]):  Default:
            DataElementPatchObjectPreheatMode.REFERENCE.
        root_junction (Union[Unset, DataElementPatchObjectRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, DataElementPatchObjectUserOverrideMode]):  Default:
            DataElementPatchObjectUserOverrideMode.NONE.
        body (JsonPatch):
