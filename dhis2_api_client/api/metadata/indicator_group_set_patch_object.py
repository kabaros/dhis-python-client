...
from ...models.indicator_group_set_patch_object_atomic_mode import IndicatorGroupSetPatchObjectAtomicMode
from ...models.indicator_group_set_patch_object_flush_mode import IndicatorGroupSetPatchObjectFlushMode
from ...models.indicator_group_set_patch_object_identifier import IndicatorGroupSetPatchObjectIdentifier
from ...models.indicator_group_set_patch_object_import_mode import IndicatorGroupSetPatchObjectImportMode
from ...models.indicator_group_set_patch_object_import_report_mode import IndicatorGroupSetPatchObjectImportReportMode
from ...models.indicator_group_set_patch_object_import_strategy import IndicatorGroupSetPatchObjectImportStrategy
from ...models.indicator_group_set_patch_object_preheat_mode import IndicatorGroupSetPatchObjectPreheatMode
from ...models.indicator_group_set_patch_object_root_junction import IndicatorGroupSetPatchObjectRootJunction
from ...models.indicator_group_set_patch_object_user_override_mode import IndicatorGroupSetPatchObjectUserOverrideMode
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[Unset, IndicatorGroupSetPatchObjectAtomicMode] = IndicatorGroupSetPatchObjectAtomicMode.ALL,
    flush_mode: Union[Unset, IndicatorGroupSetPatchObjectFlushMode] = IndicatorGroupSetPatchObjectFlushMode.AUTO,
    identifier: Union[Unset, IndicatorGroupSetPatchObjectIdentifier] = IndicatorGroupSetPatchObjectIdentifier.UID,
    import_mode: Union[Unset, IndicatorGroupSetPatchObjectImportMode] = IndicatorGroupSetPatchObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, IndicatorGroupSetPatchObjectImportReportMode
    ] = IndicatorGroupSetPatchObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, IndicatorGroupSetPatchObjectImportStrategy
    ] = IndicatorGroupSetPatchObjectImportStrategy.CREATE_AND_UPDATE,
    ...
    preheat_mode: Union[
        Unset, IndicatorGroupSetPatchObjectPreheatMode
    ] = IndicatorGroupSetPatchObjectPreheatMode.REFERENCE,
    root_junction: Union[Unset, IndicatorGroupSetPatchObjectRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, IndicatorGroupSetPatchObjectUserOverrideMode
    ] = IndicatorGroupSetPatchObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, IndicatorGroupSetPatchObjectAtomicMode]):  Default:
            IndicatorGroupSetPatchObjectAtomicMode.ALL.
        flush_mode (Union[Unset, IndicatorGroupSetPatchObjectFlushMode]):  Default:
            IndicatorGroupSetPatchObjectFlushMode.AUTO.
        identifier (Union[Unset, IndicatorGroupSetPatchObjectIdentifier]):  Default:
            IndicatorGroupSetPatchObjectIdentifier.UID.
        import_mode (Union[Unset, IndicatorGroupSetPatchObjectImportMode]):  Default:
            IndicatorGroupSetPatchObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, IndicatorGroupSetPatchObjectImportReportMode]):  Default:
            IndicatorGroupSetPatchObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, IndicatorGroupSetPatchObjectImportStrategy]):  Default:
            IndicatorGroupSetPatchObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, IndicatorGroupSetPatchObjectPreheatMode]):  Default:
            IndicatorGroupSetPatchObjectPreheatMode.REFERENCE.
        root_junction (Union[Unset, IndicatorGroupSetPatchObjectRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, IndicatorGroupSetPatchObjectUserOverrideMode]):  Default:
            IndicatorGroupSetPatchObjectUserOverrideMode.NONE.
        body (JsonPatch):
