...
from ...models.document_delete_collection_item_property import DocumentDeleteCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: DocumentDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/documents/{uid}/{property_}/{item_id}",
    }
