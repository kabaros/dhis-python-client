...
from ...models.indicator_type_get_object_list_csv_root_junction import IndicatorTypeGetObjectListCsvRootJunction
...
def _get_kwargs(
    *,
    ...
    root_junction: Union[Unset, IndicatorTypeGetObjectListCsvRootJunction] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/indicatorTypes/#getObjectListCsv",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, IndicatorTypeGetObjectListCsvRootJunction]):
