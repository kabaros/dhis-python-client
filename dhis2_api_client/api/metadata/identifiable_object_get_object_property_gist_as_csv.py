...
from ...models.identifiable_object_get_object_property_gist_as_csv_auto import (
    IdentifiableObjectGetObjectPropertyGistAsCsvAuto,
)
from ...models.identifiable_object_get_object_property_gist_as_csv_property import (
    IdentifiableObjectGetObjectPropertyGistAsCsvProperty,
)
from ...models.identifiable_object_get_object_property_gist_as_csv_root_junction import (
    IdentifiableObjectGetObjectPropertyGistAsCsvRootJunction,
)
...
def _get_kwargs(
    uid: str,
    property_: IdentifiableObjectGetObjectPropertyGistAsCsvProperty,
    *,
    absolute_urls: Union[Unset, bool] = False,
    auto: Union[Unset, IdentifiableObjectGetObjectPropertyGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, IdentifiableObjectGetObjectPropertyGistAsCsvRootJunction
    ] = IdentifiableObjectGetObjectPropertyGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/identifiableObjects/{uid}/{property_}/gist.csv",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, IdentifiableObjectGetObjectPropertyGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, IdentifiableObjectGetObjectPropertyGistAsCsvRootJunction]):
            Default: IdentifiableObjectGetObjectPropertyGistAsCsvRootJunction.AND.
