...
from ...models.push_analysis_patch_object_atomic_mode import PushAnalysisPatchObjectAtomicMode
from ...models.push_analysis_patch_object_flush_mode import PushAnalysisPatchObjectFlushMode
from ...models.push_analysis_patch_object_identifier import PushAnalysisPatchObjectIdentifier
from ...models.push_analysis_patch_object_import_mode import PushAnalysisPatchObjectImportMode
from ...models.push_analysis_patch_object_import_report_mode import PushAnalysisPatchObjectImportReportMode
from ...models.push_analysis_patch_object_import_strategy import PushAnalysisPatchObjectImportStrategy
from ...models.push_analysis_patch_object_preheat_mode import PushAnalysisPatchObjectPreheatMode
from ...models.push_analysis_patch_object_root_junction import PushAnalysisPatchObjectRootJunction
from ...models.push_analysis_patch_object_user_override_mode import PushAnalysisPatchObjectUserOverrideMode
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[Unset, PushAnalysisPatchObjectAtomicMode] = PushAnalysisPatchObjectAtomicMode.ALL,
    flush_mode: Union[Unset, PushAnalysisPatchObjectFlushMode] = PushAnalysisPatchObjectFlushMode.AUTO,
    identifier: Union[Unset, PushAnalysisPatchObjectIdentifier] = PushAnalysisPatchObjectIdentifier.UID,
    import_mode: Union[Unset, PushAnalysisPatchObjectImportMode] = PushAnalysisPatchObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, PushAnalysisPatchObjectImportReportMode
    ] = PushAnalysisPatchObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, PushAnalysisPatchObjectImportStrategy
    ] = PushAnalysisPatchObjectImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, PushAnalysisPatchObjectPreheatMode] = PushAnalysisPatchObjectPreheatMode.REFERENCE,
    root_junction: Union[Unset, PushAnalysisPatchObjectRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, PushAnalysisPatchObjectUserOverrideMode
    ] = PushAnalysisPatchObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, PushAnalysisPatchObjectAtomicMode]):  Default:
            PushAnalysisPatchObjectAtomicMode.ALL.
        flush_mode (Union[Unset, PushAnalysisPatchObjectFlushMode]):  Default:
            PushAnalysisPatchObjectFlushMode.AUTO.
        identifier (Union[Unset, PushAnalysisPatchObjectIdentifier]):  Default:
            PushAnalysisPatchObjectIdentifier.UID.
        import_mode (Union[Unset, PushAnalysisPatchObjectImportMode]):  Default:
            PushAnalysisPatchObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, PushAnalysisPatchObjectImportReportMode]):  Default:
            PushAnalysisPatchObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, PushAnalysisPatchObjectImportStrategy]):  Default:
            PushAnalysisPatchObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, PushAnalysisPatchObjectPreheatMode]):  Default:
            PushAnalysisPatchObjectPreheatMode.REFERENCE.
        root_junction (Union[Unset, PushAnalysisPatchObjectRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, PushAnalysisPatchObjectUserOverrideMode]):  Default:
            PushAnalysisPatchObjectUserOverrideMode.NONE.
        body (JsonPatch):
