...
from ...models.data_set_put_json_objectput_xml_object_atomic_mode import DataSetPutJsonObjectputXmlObjectAtomicMode
from ...models.data_set_put_json_objectput_xml_object_flush_mode import DataSetPutJsonObjectputXmlObjectFlushMode
from ...models.data_set_put_json_objectput_xml_object_identifier import DataSetPutJsonObjectputXmlObjectIdentifier
from ...models.data_set_put_json_objectput_xml_object_import_mode import DataSetPutJsonObjectputXmlObjectImportMode
from ...models.data_set_put_json_objectput_xml_object_import_report_mode import (
    DataSetPutJsonObjectputXmlObjectImportReportMode,
)
from ...models.data_set_put_json_objectput_xml_object_import_strategy import (
    DataSetPutJsonObjectputXmlObjectImportStrategy,
)
from ...models.data_set_put_json_objectput_xml_object_preheat_mode import DataSetPutJsonObjectputXmlObjectPreheatMode
from ...models.data_set_put_json_objectput_xml_object_user_override_mode import (
    DataSetPutJsonObjectputXmlObjectUserOverrideMode,
)
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[
        Unset, DataSetPutJsonObjectputXmlObjectAtomicMode
    ] = DataSetPutJsonObjectputXmlObjectAtomicMode.ALL,
    flush_mode: Union[
        Unset, DataSetPutJsonObjectputXmlObjectFlushMode
    ] = DataSetPutJsonObjectputXmlObjectFlushMode.AUTO,
    identifier: Union[
        Unset, DataSetPutJsonObjectputXmlObjectIdentifier
    ] = DataSetPutJsonObjectputXmlObjectIdentifier.UID,
    import_mode: Union[
        Unset, DataSetPutJsonObjectputXmlObjectImportMode
    ] = DataSetPutJsonObjectputXmlObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, DataSetPutJsonObjectputXmlObjectImportReportMode
    ] = DataSetPutJsonObjectputXmlObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, DataSetPutJsonObjectputXmlObjectImportStrategy
    ] = DataSetPutJsonObjectputXmlObjectImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    preheat_mode: Union[
        Unset, DataSetPutJsonObjectputXmlObjectPreheatMode
    ] = DataSetPutJsonObjectputXmlObjectPreheatMode.REFERENCE,
    ...
    user_override_mode: Union[
        Unset, DataSetPutJsonObjectputXmlObjectUserOverrideMode
    ] = DataSetPutJsonObjectputXmlObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        uid (str): A UID for an DataSet object
            (Java name `org.hisp.dhis.dataset.DataSet`) Example: dT3ji2fG1SM.
        async_ (Union[Unset, bool]):  Default: False.
        atomic_mode (Union[Unset, DataSetPutJsonObjectputXmlObjectAtomicMode]):  Default:
            DataSetPutJsonObjectputXmlObjectAtomicMode.ALL.
        flush_mode (Union[Unset, DataSetPutJsonObjectputXmlObjectFlushMode]):  Default:
            DataSetPutJsonObjectputXmlObjectFlushMode.AUTO.
        identifier (Union[Unset, DataSetPutJsonObjectputXmlObjectIdentifier]):  Default:
            DataSetPutJsonObjectputXmlObjectIdentifier.UID.
        import_mode (Union[Unset, DataSetPutJsonObjectputXmlObjectImportMode]):  Default:
            DataSetPutJsonObjectputXmlObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, DataSetPutJsonObjectputXmlObjectImportReportMode]):
            Default: DataSetPutJsonObjectputXmlObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, DataSetPutJsonObjectputXmlObjectImportStrategy]):  Default:
            DataSetPutJsonObjectputXmlObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, DataSetPutJsonObjectputXmlObjectPreheatMode]):  Default:
            DataSetPutJsonObjectputXmlObjectPreheatMode.REFERENCE.
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, DataSetPutJsonObjectputXmlObjectUserOverrideMode]):
            Default: DataSetPutJsonObjectputXmlObjectUserOverrideMode.NONE.
        body (DataSet):
