...
from ...models.map_get_object_property_gist_as_csv_auto import MapGetObjectPropertyGistAsCsvAuto
from ...models.map_get_object_property_gist_as_csv_property import MapGetObjectPropertyGistAsCsvProperty
from ...models.map_get_object_property_gist_as_csv_root_junction import MapGetObjectPropertyGistAsCsvRootJunction
...
def _get_kwargs(
    uid: str,
    property_: MapGetObjectPropertyGistAsCsvProperty,
    *,
    absolute_urls: Union[Unset, bool] = False,
    auto: Union[Unset, MapGetObjectPropertyGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, MapGetObjectPropertyGistAsCsvRootJunction
    ] = MapGetObjectPropertyGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/maps/{uid}/{property_}/gist.csv",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, MapGetObjectPropertyGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, MapGetObjectPropertyGistAsCsvRootJunction]):  Default:
            MapGetObjectPropertyGistAsCsvRootJunction.AND.
