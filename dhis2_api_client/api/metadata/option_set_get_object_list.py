...
from ...models.option_set_get_object_list_response_200 import OptionSetGetObjectListResponse200
from ...models.option_set_get_object_list_root_junction import OptionSetGetObjectListRootJunction
...
def _get_kwargs(
    *,
    ...
    root_junction: Union[Unset, OptionSetGetObjectListRootJunction] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
) -> Optional[Union[OptionSetGetObjectListResponse200, WebMessage]]:
    if response.status_code == 200:
        response_200 = OptionSetGetObjectListResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[OptionSetGetObjectListResponse200, WebMessage]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, OptionSetGetObjectListRootJunction]):
...
def sync(
    *,
    ...
    Returns:
        Union[OptionSetGetObjectListResponse200, WebMessage]
    """
