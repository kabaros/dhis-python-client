...
from ...models.indicator_group_bulk_sharing_atomic_mode import IndicatorGroupBulkSharingAtomicMode
from ...models.indicator_group_bulk_sharing_flush_mode import IndicatorGroupBulkSharingFlushMode
from ...models.indicator_group_bulk_sharing_identifier import IndicatorGroupBulkSharingIdentifier
from ...models.indicator_group_bulk_sharing_import_mode import IndicatorGroupBulkSharingImportMode
from ...models.indicator_group_bulk_sharing_import_report_mode import IndicatorGroupBulkSharingImportReportMode
from ...models.indicator_group_bulk_sharing_import_strategy import IndicatorGroupBulkSharingImportStrategy
from ...models.indicator_group_bulk_sharing_preheat_mode import IndicatorGroupBulkSharingPreheatMode
from ...models.indicator_group_bulk_sharing_root_junction import IndicatorGroupBulkSharingRootJunction
from ...models.indicator_group_bulk_sharing_user_override_mode import IndicatorGroupBulkSharingUserOverrideMode
...
def _get_kwargs(
    *,
    ...
    atomic_mode: Union[Unset, IndicatorGroupBulkSharingAtomicMode] = IndicatorGroupBulkSharingAtomicMode.ALL,
    flush_mode: Union[Unset, IndicatorGroupBulkSharingFlushMode] = IndicatorGroupBulkSharingFlushMode.AUTO,
    identifier: Union[Unset, IndicatorGroupBulkSharingIdentifier] = IndicatorGroupBulkSharingIdentifier.UID,
    import_mode: Union[Unset, IndicatorGroupBulkSharingImportMode] = IndicatorGroupBulkSharingImportMode.COMMIT,
    import_report_mode: Union[
        Unset, IndicatorGroupBulkSharingImportReportMode
    ] = IndicatorGroupBulkSharingImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, IndicatorGroupBulkSharingImportStrategy
    ] = IndicatorGroupBulkSharingImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, IndicatorGroupBulkSharingPreheatMode] = IndicatorGroupBulkSharingPreheatMode.REFERENCE,
    root_junction: Union[Unset, IndicatorGroupBulkSharingRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, IndicatorGroupBulkSharingUserOverrideMode
    ] = IndicatorGroupBulkSharingUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, IndicatorGroupBulkSharingAtomicMode]):  Default:
            IndicatorGroupBulkSharingAtomicMode.ALL.
        flush_mode (Union[Unset, IndicatorGroupBulkSharingFlushMode]):  Default:
            IndicatorGroupBulkSharingFlushMode.AUTO.
        identifier (Union[Unset, IndicatorGroupBulkSharingIdentifier]):  Default:
            IndicatorGroupBulkSharingIdentifier.UID.
        import_mode (Union[Unset, IndicatorGroupBulkSharingImportMode]):  Default:
            IndicatorGroupBulkSharingImportMode.COMMIT.
        import_report_mode (Union[Unset, IndicatorGroupBulkSharingImportReportMode]):  Default:
            IndicatorGroupBulkSharingImportReportMode.ERRORS.
        import_strategy (Union[Unset, IndicatorGroupBulkSharingImportStrategy]):  Default:
            IndicatorGroupBulkSharingImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, IndicatorGroupBulkSharingPreheatMode]):  Default:
            IndicatorGroupBulkSharingPreheatMode.REFERENCE.
        root_junction (Union[Unset, IndicatorGroupBulkSharingRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, IndicatorGroupBulkSharingUserOverrideMode]):  Default:
            IndicatorGroupBulkSharingUserOverrideMode.NONE.
        body (BulkJsonPatch):
