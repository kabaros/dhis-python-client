...
from ...models.report_delete_collection_items_jsondelete_collection_items_xml_property import (
    ReportDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: ReportDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
    *,
