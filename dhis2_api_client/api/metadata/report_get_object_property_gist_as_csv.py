...
from ...models.report_get_object_property_gist_as_csv_auto import ReportGetObjectPropertyGistAsCsvAuto
from ...models.report_get_object_property_gist_as_csv_property import ReportGetObjectPropertyGistAsCsvProperty
from ...models.report_get_object_property_gist_as_csv_root_junction import ReportGetObjectPropertyGistAsCsvRootJunction
...
def _get_kwargs(
    uid: str,
    property_: ReportGetObjectPropertyGistAsCsvProperty,
    *,
    absolute_urls: Union[Unset, bool] = False,
    auto: Union[Unset, ReportGetObjectPropertyGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, ReportGetObjectPropertyGistAsCsvRootJunction
    ] = ReportGetObjectPropertyGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/reports/{uid}/{property_}/gist.csv",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, ReportGetObjectPropertyGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, ReportGetObjectPropertyGistAsCsvRootJunction]):  Default:
            ReportGetObjectPropertyGistAsCsvRootJunction.AND.
