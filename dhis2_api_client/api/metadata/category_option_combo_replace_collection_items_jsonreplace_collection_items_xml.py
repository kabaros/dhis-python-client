...
from ...models.category_option_combo_replace_collection_items_jsonreplace_collection_items_xml_property import (
    CategoryOptionComboReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: CategoryOptionComboReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
    *,
