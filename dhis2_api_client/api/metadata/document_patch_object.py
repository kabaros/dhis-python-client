...
from ...models.document_patch_object_atomic_mode import DocumentPatchObjectAtomicMode
from ...models.document_patch_object_flush_mode import DocumentPatchObjectFlushMode
from ...models.document_patch_object_identifier import DocumentPatchObjectIdentifier
from ...models.document_patch_object_import_mode import DocumentPatchObjectImportMode
from ...models.document_patch_object_import_report_mode import DocumentPatchObjectImportReportMode
from ...models.document_patch_object_import_strategy import DocumentPatchObjectImportStrategy
from ...models.document_patch_object_preheat_mode import DocumentPatchObjectPreheatMode
from ...models.document_patch_object_root_junction import DocumentPatchObjectRootJunction
from ...models.document_patch_object_user_override_mode import DocumentPatchObjectUserOverrideMode
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[Unset, DocumentPatchObjectAtomicMode] = DocumentPatchObjectAtomicMode.ALL,
    flush_mode: Union[Unset, DocumentPatchObjectFlushMode] = DocumentPatchObjectFlushMode.AUTO,
    identifier: Union[Unset, DocumentPatchObjectIdentifier] = DocumentPatchObjectIdentifier.UID,
    import_mode: Union[Unset, DocumentPatchObjectImportMode] = DocumentPatchObjectImportMode.COMMIT,
    import_report_mode: Union[Unset, DocumentPatchObjectImportReportMode] = DocumentPatchObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, DocumentPatchObjectImportStrategy
    ] = DocumentPatchObjectImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, DocumentPatchObjectPreheatMode] = DocumentPatchObjectPreheatMode.REFERENCE,
    root_junction: Union[Unset, DocumentPatchObjectRootJunction] = UNSET,
    skip_sharing: Union[Unset, bool] = False,
    skip_translation: Union[Unset, bool] = False,
    skip_validation: Union[Unset, bool] = False,
    user: Union[Unset, str] = UNSET,
    user_override_mode: Union[Unset, DocumentPatchObjectUserOverrideMode] = DocumentPatchObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, DocumentPatchObjectAtomicMode]):  Default:
            DocumentPatchObjectAtomicMode.ALL.
        flush_mode (Union[Unset, DocumentPatchObjectFlushMode]):  Default:
            DocumentPatchObjectFlushMode.AUTO.
        identifier (Union[Unset, DocumentPatchObjectIdentifier]):  Default:
            DocumentPatchObjectIdentifier.UID.
        import_mode (Union[Unset, DocumentPatchObjectImportMode]):  Default:
            DocumentPatchObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, DocumentPatchObjectImportReportMode]):  Default:
            DocumentPatchObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, DocumentPatchObjectImportStrategy]):  Default:
            DocumentPatchObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, DocumentPatchObjectPreheatMode]):  Default:
            DocumentPatchObjectPreheatMode.REFERENCE.
        root_junction (Union[Unset, DocumentPatchObjectRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, DocumentPatchObjectUserOverrideMode]):  Default:
            DocumentPatchObjectUserOverrideMode.NONE.
        body (JsonPatch):
