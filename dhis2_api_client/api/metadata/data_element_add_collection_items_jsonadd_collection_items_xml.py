...
from ...models.data_element_add_collection_items_jsonadd_collection_items_xml_property import (
    DataElementAddCollectionItemsJsonaddCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: DataElementAddCollectionItemsJsonaddCollectionItemsXmlProperty,
    *,
