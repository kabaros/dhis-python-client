...
from ...models.constant_get_object_property_gist_as_csv_auto import ConstantGetObjectPropertyGistAsCsvAuto
from ...models.constant_get_object_property_gist_as_csv_property import ConstantGetObjectPropertyGistAsCsvProperty
from ...models.constant_get_object_property_gist_as_csv_root_junction import (
    ConstantGetObjectPropertyGistAsCsvRootJunction,
)
...
def _get_kwargs(
    uid: str,
    property_: ConstantGetObjectPropertyGistAsCsvProperty,
    *,
    absolute_urls: Union[Unset, bool] = False,
    auto: Union[Unset, ConstantGetObjectPropertyGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, ConstantGetObjectPropertyGistAsCsvRootJunction
    ] = ConstantGetObjectPropertyGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/constants/{uid}/{property_}/gist.csv",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, ConstantGetObjectPropertyGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, ConstantGetObjectPropertyGistAsCsvRootJunction]):  Default:
            ConstantGetObjectPropertyGistAsCsvRootJunction.AND.
