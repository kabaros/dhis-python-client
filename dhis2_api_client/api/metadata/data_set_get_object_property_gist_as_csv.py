...
from ...models.data_set_get_object_property_gist_as_csv_auto import DataSetGetObjectPropertyGistAsCsvAuto
from ...models.data_set_get_object_property_gist_as_csv_property import DataSetGetObjectPropertyGistAsCsvProperty
from ...models.data_set_get_object_property_gist_as_csv_root_junction import (
    DataSetGetObjectPropertyGistAsCsvRootJunction,
)
...
def _get_kwargs(
    uid: str,
    property_: DataSetGetObjectPropertyGistAsCsvProperty,
    *,
    absolute_urls: Union[Unset, bool] = False,
    auto: Union[Unset, DataSetGetObjectPropertyGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, DataSetGetObjectPropertyGistAsCsvRootJunction
    ] = DataSetGetObjectPropertyGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/dataSets/{uid}/{property_}/gist.csv",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, DataSetGetObjectPropertyGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, DataSetGetObjectPropertyGistAsCsvRootJunction]):  Default:
            DataSetGetObjectPropertyGistAsCsvRootJunction.AND.
