...
from ...models.predictor_group_bulk_sharing_atomic_mode import PredictorGroupBulkSharingAtomicMode
from ...models.predictor_group_bulk_sharing_flush_mode import PredictorGroupBulkSharingFlushMode
from ...models.predictor_group_bulk_sharing_identifier import PredictorGroupBulkSharingIdentifier
from ...models.predictor_group_bulk_sharing_import_mode import PredictorGroupBulkSharingImportMode
from ...models.predictor_group_bulk_sharing_import_report_mode import PredictorGroupBulkSharingImportReportMode
from ...models.predictor_group_bulk_sharing_import_strategy import PredictorGroupBulkSharingImportStrategy
from ...models.predictor_group_bulk_sharing_preheat_mode import PredictorGroupBulkSharingPreheatMode
from ...models.predictor_group_bulk_sharing_root_junction import PredictorGroupBulkSharingRootJunction
from ...models.predictor_group_bulk_sharing_user_override_mode import PredictorGroupBulkSharingUserOverrideMode
...
def _get_kwargs(
    *,
    ...
    atomic_mode: Union[Unset, PredictorGroupBulkSharingAtomicMode] = PredictorGroupBulkSharingAtomicMode.ALL,
    flush_mode: Union[Unset, PredictorGroupBulkSharingFlushMode] = PredictorGroupBulkSharingFlushMode.AUTO,
    identifier: Union[Unset, PredictorGroupBulkSharingIdentifier] = PredictorGroupBulkSharingIdentifier.UID,
    import_mode: Union[Unset, PredictorGroupBulkSharingImportMode] = PredictorGroupBulkSharingImportMode.COMMIT,
    import_report_mode: Union[
        Unset, PredictorGroupBulkSharingImportReportMode
    ] = PredictorGroupBulkSharingImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, PredictorGroupBulkSharingImportStrategy
    ] = PredictorGroupBulkSharingImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, PredictorGroupBulkSharingPreheatMode] = PredictorGroupBulkSharingPreheatMode.REFERENCE,
    root_junction: Union[Unset, PredictorGroupBulkSharingRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, PredictorGroupBulkSharingUserOverrideMode
    ] = PredictorGroupBulkSharingUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, PredictorGroupBulkSharingAtomicMode]):  Default:
            PredictorGroupBulkSharingAtomicMode.ALL.
        flush_mode (Union[Unset, PredictorGroupBulkSharingFlushMode]):  Default:
            PredictorGroupBulkSharingFlushMode.AUTO.
        identifier (Union[Unset, PredictorGroupBulkSharingIdentifier]):  Default:
            PredictorGroupBulkSharingIdentifier.UID.
        import_mode (Union[Unset, PredictorGroupBulkSharingImportMode]):  Default:
            PredictorGroupBulkSharingImportMode.COMMIT.
        import_report_mode (Union[Unset, PredictorGroupBulkSharingImportReportMode]):  Default:
            PredictorGroupBulkSharingImportReportMode.ERRORS.
        import_strategy (Union[Unset, PredictorGroupBulkSharingImportStrategy]):  Default:
            PredictorGroupBulkSharingImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, PredictorGroupBulkSharingPreheatMode]):  Default:
            PredictorGroupBulkSharingPreheatMode.REFERENCE.
        root_junction (Union[Unset, PredictorGroupBulkSharingRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, PredictorGroupBulkSharingUserOverrideMode]):  Default:
            PredictorGroupBulkSharingUserOverrideMode.NONE.
        body (BulkJsonPatch):
