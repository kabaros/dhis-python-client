...
from ...models.organisation_unit_add_collection_items_jsonadd_collection_items_xml_property import (
    OrganisationUnitAddCollectionItemsJsonaddCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: OrganisationUnitAddCollectionItemsJsonaddCollectionItemsXmlProperty,
    *,
