...
from ...models.category_option_group_set_delete_collection_item_property import (
    CategoryOptionGroupSetDeleteCollectionItemProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: CategoryOptionGroupSetDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/categoryOptionGroupSets/{uid}/{property_}/{item_id}",
    }
