...
from ...models.category_option_group_set_add_collection_items_jsonadd_collection_items_xml_property import (
    CategoryOptionGroupSetAddCollectionItemsJsonaddCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: CategoryOptionGroupSetAddCollectionItemsJsonaddCollectionItemsXmlProperty,
    *,
