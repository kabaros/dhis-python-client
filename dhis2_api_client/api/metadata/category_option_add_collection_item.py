...
from ...models.category_option_add_collection_item_property import CategoryOptionAddCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: CategoryOptionAddCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
