...
from ...models.option_set_delete_collection_item_property import OptionSetDeleteCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: OptionSetDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/optionSets/{uid}/{property_}/{item_id}",
    }
