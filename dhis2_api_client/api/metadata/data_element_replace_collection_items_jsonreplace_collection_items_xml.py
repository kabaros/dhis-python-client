...
from ...models.data_element_replace_collection_items_jsonreplace_collection_items_xml_property import (
    DataElementReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: DataElementReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
    *,
