...
from ...models.indicator_group_add_collection_item_property import IndicatorGroupAddCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: IndicatorGroupAddCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
