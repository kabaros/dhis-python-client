...
from ...models.option_get_object_list_response_200 import OptionGetObjectListResponse200
from ...models.option_get_object_list_root_junction import OptionGetObjectListRootJunction
...
def _get_kwargs(
    *,
    ...
    root_junction: Union[Unset, OptionGetObjectListRootJunction] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
) -> Optional[Union[OptionGetObjectListResponse200, WebMessage]]:
    if response.status_code == 200:
        response_200 = OptionGetObjectListResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[OptionGetObjectListResponse200, WebMessage]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, OptionGetObjectListRootJunction]):
...
def sync(
    *,
    ...
    Returns:
        Union[OptionGetObjectListResponse200, WebMessage]
    """
