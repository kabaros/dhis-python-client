...
from ...models.identifiable_object_add_collection_item_property import IdentifiableObjectAddCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: IdentifiableObjectAddCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
