...
from ...models.document_bulk_sharing_atomic_mode import DocumentBulkSharingAtomicMode
from ...models.document_bulk_sharing_flush_mode import DocumentBulkSharingFlushMode
from ...models.document_bulk_sharing_identifier import DocumentBulkSharingIdentifier
from ...models.document_bulk_sharing_import_mode import DocumentBulkSharingImportMode
from ...models.document_bulk_sharing_import_report_mode import DocumentBulkSharingImportReportMode
from ...models.document_bulk_sharing_import_strategy import DocumentBulkSharingImportStrategy
from ...models.document_bulk_sharing_preheat_mode import DocumentBulkSharingPreheatMode
from ...models.document_bulk_sharing_root_junction import DocumentBulkSharingRootJunction
from ...models.document_bulk_sharing_user_override_mode import DocumentBulkSharingUserOverrideMode
...
def _get_kwargs(
    *,
    ...
    atomic_mode: Union[Unset, DocumentBulkSharingAtomicMode] = DocumentBulkSharingAtomicMode.ALL,
    flush_mode: Union[Unset, DocumentBulkSharingFlushMode] = DocumentBulkSharingFlushMode.AUTO,
    identifier: Union[Unset, DocumentBulkSharingIdentifier] = DocumentBulkSharingIdentifier.UID,
    import_mode: Union[Unset, DocumentBulkSharingImportMode] = DocumentBulkSharingImportMode.COMMIT,
    import_report_mode: Union[Unset, DocumentBulkSharingImportReportMode] = DocumentBulkSharingImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, DocumentBulkSharingImportStrategy
    ] = DocumentBulkSharingImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, DocumentBulkSharingPreheatMode] = DocumentBulkSharingPreheatMode.REFERENCE,
    root_junction: Union[Unset, DocumentBulkSharingRootJunction] = UNSET,
    skip_sharing: Union[Unset, bool] = False,
    skip_translation: Union[Unset, bool] = False,
    skip_validation: Union[Unset, bool] = False,
    user: Union[Unset, str] = UNSET,
    user_override_mode: Union[Unset, DocumentBulkSharingUserOverrideMode] = DocumentBulkSharingUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, DocumentBulkSharingAtomicMode]):  Default:
            DocumentBulkSharingAtomicMode.ALL.
        flush_mode (Union[Unset, DocumentBulkSharingFlushMode]):  Default:
            DocumentBulkSharingFlushMode.AUTO.
        identifier (Union[Unset, DocumentBulkSharingIdentifier]):  Default:
            DocumentBulkSharingIdentifier.UID.
        import_mode (Union[Unset, DocumentBulkSharingImportMode]):  Default:
            DocumentBulkSharingImportMode.COMMIT.
        import_report_mode (Union[Unset, DocumentBulkSharingImportReportMode]):  Default:
            DocumentBulkSharingImportReportMode.ERRORS.
        import_strategy (Union[Unset, DocumentBulkSharingImportStrategy]):  Default:
            DocumentBulkSharingImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, DocumentBulkSharingPreheatMode]):  Default:
            DocumentBulkSharingPreheatMode.REFERENCE.
        root_junction (Union[Unset, DocumentBulkSharingRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, DocumentBulkSharingUserOverrideMode]):  Default:
            DocumentBulkSharingUserOverrideMode.NONE.
        body (BulkJsonPatch):
