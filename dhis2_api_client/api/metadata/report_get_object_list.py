...
from ...models.report_get_object_list_response_200 import ReportGetObjectListResponse200
from ...models.report_get_object_list_root_junction import ReportGetObjectListRootJunction
...
def _get_kwargs(
    *,
    ...
    root_junction: Union[Unset, ReportGetObjectListRootJunction] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
) -> Optional[Union[ReportGetObjectListResponse200, WebMessage]]:
    if response.status_code == 200:
        response_200 = ReportGetObjectListResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ReportGetObjectListResponse200, WebMessage]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, ReportGetObjectListRootJunction]):
...
def sync(
    *,
    ...
    Returns:
        Union[ReportGetObjectListResponse200, WebMessage]
    """
