...
from ...models.section_replace_collection_items_jsonreplace_collection_items_xml_property import (
    SectionReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: SectionReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
    *,
