...
from ...models.data_element_replace_translations_body import DataElementReplaceTranslationsBody
...
def _get_kwargs(
    uid: str,
    *,
    body: DataElementReplaceTranslationsBody,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": f"/dataElements/{uid}/translations",
    }
