...
from ...models.category_delete_collection_item_property import CategoryDeleteCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: CategoryDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/categories/{uid}/{property_}/{item_id}",
    }
