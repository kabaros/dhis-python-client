...
from ...models.category_option_combo_get_object_root_junction import CategoryOptionComboGetObjectRootJunction
...
def _get_kwargs(
    ...
    *,
    ...
    root_junction: Union[Unset, CategoryOptionComboGetObjectRootJunction] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
) -> Optional[Union[CategoryOptionCombo, WebMessage]]:
    if response.status_code == 200:
        response_200 = CategoryOptionCombo.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[CategoryOptionCombo, WebMessage]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, CategoryOptionComboGetObjectRootJunction]):
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[CategoryOptionCombo, WebMessage]
    """
