...
from ...models.category_option_group_delete_collection_items_jsondelete_collection_items_xml_property import (
    CategoryOptionGroupDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: CategoryOptionGroupDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
    *,
