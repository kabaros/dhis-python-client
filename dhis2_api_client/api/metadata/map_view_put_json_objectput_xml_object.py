...
from ...models.map_view_put_json_objectput_xml_object_atomic_mode import MapViewPutJsonObjectputXmlObjectAtomicMode
from ...models.map_view_put_json_objectput_xml_object_flush_mode import MapViewPutJsonObjectputXmlObjectFlushMode
from ...models.map_view_put_json_objectput_xml_object_identifier import MapViewPutJsonObjectputXmlObjectIdentifier
from ...models.map_view_put_json_objectput_xml_object_import_mode import MapViewPutJsonObjectputXmlObjectImportMode
from ...models.map_view_put_json_objectput_xml_object_import_report_mode import (
    MapViewPutJsonObjectputXmlObjectImportReportMode,
)
from ...models.map_view_put_json_objectput_xml_object_import_strategy import (
    MapViewPutJsonObjectputXmlObjectImportStrategy,
)
from ...models.map_view_put_json_objectput_xml_object_preheat_mode import MapViewPutJsonObjectputXmlObjectPreheatMode
from ...models.map_view_put_json_objectput_xml_object_user_override_mode import (
    MapViewPutJsonObjectputXmlObjectUserOverrideMode,
)
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[
        Unset, MapViewPutJsonObjectputXmlObjectAtomicMode
    ] = MapViewPutJsonObjectputXmlObjectAtomicMode.ALL,
    flush_mode: Union[
        Unset, MapViewPutJsonObjectputXmlObjectFlushMode
    ] = MapViewPutJsonObjectputXmlObjectFlushMode.AUTO,
    identifier: Union[
        Unset, MapViewPutJsonObjectputXmlObjectIdentifier
    ] = MapViewPutJsonObjectputXmlObjectIdentifier.UID,
    import_mode: Union[
        Unset, MapViewPutJsonObjectputXmlObjectImportMode
    ] = MapViewPutJsonObjectputXmlObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, MapViewPutJsonObjectputXmlObjectImportReportMode
    ] = MapViewPutJsonObjectputXmlObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, MapViewPutJsonObjectputXmlObjectImportStrategy
    ] = MapViewPutJsonObjectputXmlObjectImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    preheat_mode: Union[
        Unset, MapViewPutJsonObjectputXmlObjectPreheatMode
    ] = MapViewPutJsonObjectputXmlObjectPreheatMode.REFERENCE,
    ...
    user_override_mode: Union[
        Unset, MapViewPutJsonObjectputXmlObjectUserOverrideMode
    ] = MapViewPutJsonObjectputXmlObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        uid (str): A UID for an MapView object
            (Java name `org.hisp.dhis.mapping.MapView`) Example: mT38EN5Pm4B.
        async_ (Union[Unset, bool]):  Default: False.
        atomic_mode (Union[Unset, MapViewPutJsonObjectputXmlObjectAtomicMode]):  Default:
            MapViewPutJsonObjectputXmlObjectAtomicMode.ALL.
        flush_mode (Union[Unset, MapViewPutJsonObjectputXmlObjectFlushMode]):  Default:
            MapViewPutJsonObjectputXmlObjectFlushMode.AUTO.
        identifier (Union[Unset, MapViewPutJsonObjectputXmlObjectIdentifier]):  Default:
            MapViewPutJsonObjectputXmlObjectIdentifier.UID.
        import_mode (Union[Unset, MapViewPutJsonObjectputXmlObjectImportMode]):  Default:
            MapViewPutJsonObjectputXmlObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, MapViewPutJsonObjectputXmlObjectImportReportMode]):
            Default: MapViewPutJsonObjectputXmlObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, MapViewPutJsonObjectputXmlObjectImportStrategy]):  Default:
            MapViewPutJsonObjectputXmlObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, MapViewPutJsonObjectputXmlObjectPreheatMode]):  Default:
            MapViewPutJsonObjectputXmlObjectPreheatMode.REFERENCE.
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, MapViewPutJsonObjectputXmlObjectUserOverrideMode]):
            Default: MapViewPutJsonObjectputXmlObjectUserOverrideMode.NONE.
        body (MapView):
