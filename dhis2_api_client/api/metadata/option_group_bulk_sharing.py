...
from ...models.option_group_bulk_sharing_atomic_mode import OptionGroupBulkSharingAtomicMode
from ...models.option_group_bulk_sharing_flush_mode import OptionGroupBulkSharingFlushMode
from ...models.option_group_bulk_sharing_identifier import OptionGroupBulkSharingIdentifier
from ...models.option_group_bulk_sharing_import_mode import OptionGroupBulkSharingImportMode
from ...models.option_group_bulk_sharing_import_report_mode import OptionGroupBulkSharingImportReportMode
from ...models.option_group_bulk_sharing_import_strategy import OptionGroupBulkSharingImportStrategy
from ...models.option_group_bulk_sharing_preheat_mode import OptionGroupBulkSharingPreheatMode
from ...models.option_group_bulk_sharing_root_junction import OptionGroupBulkSharingRootJunction
from ...models.option_group_bulk_sharing_user_override_mode import OptionGroupBulkSharingUserOverrideMode
...
def _get_kwargs(
    *,
    ...
    atomic_mode: Union[Unset, OptionGroupBulkSharingAtomicMode] = OptionGroupBulkSharingAtomicMode.ALL,
    flush_mode: Union[Unset, OptionGroupBulkSharingFlushMode] = OptionGroupBulkSharingFlushMode.AUTO,
    identifier: Union[Unset, OptionGroupBulkSharingIdentifier] = OptionGroupBulkSharingIdentifier.UID,
    import_mode: Union[Unset, OptionGroupBulkSharingImportMode] = OptionGroupBulkSharingImportMode.COMMIT,
    import_report_mode: Union[
        Unset, OptionGroupBulkSharingImportReportMode
    ] = OptionGroupBulkSharingImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, OptionGroupBulkSharingImportStrategy
    ] = OptionGroupBulkSharingImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, OptionGroupBulkSharingPreheatMode] = OptionGroupBulkSharingPreheatMode.REFERENCE,
    root_junction: Union[Unset, OptionGroupBulkSharingRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, OptionGroupBulkSharingUserOverrideMode
    ] = OptionGroupBulkSharingUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, OptionGroupBulkSharingAtomicMode]):  Default:
            OptionGroupBulkSharingAtomicMode.ALL.
        flush_mode (Union[Unset, OptionGroupBulkSharingFlushMode]):  Default:
            OptionGroupBulkSharingFlushMode.AUTO.
        identifier (Union[Unset, OptionGroupBulkSharingIdentifier]):  Default:
            OptionGroupBulkSharingIdentifier.UID.
        import_mode (Union[Unset, OptionGroupBulkSharingImportMode]):  Default:
            OptionGroupBulkSharingImportMode.COMMIT.
        import_report_mode (Union[Unset, OptionGroupBulkSharingImportReportMode]):  Default:
            OptionGroupBulkSharingImportReportMode.ERRORS.
        import_strategy (Union[Unset, OptionGroupBulkSharingImportStrategy]):  Default:
            OptionGroupBulkSharingImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, OptionGroupBulkSharingPreheatMode]):  Default:
            OptionGroupBulkSharingPreheatMode.REFERENCE.
        root_junction (Union[Unset, OptionGroupBulkSharingRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, OptionGroupBulkSharingUserOverrideMode]):  Default:
            OptionGroupBulkSharingUserOverrideMode.NONE.
        body (BulkJsonPatch):
