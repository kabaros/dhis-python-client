...
from ...models.map_get_object_list_response_200 import MapGetObjectListResponse200
from ...models.map_get_object_list_root_junction import MapGetObjectListRootJunction
...
def _get_kwargs(
    *,
    ...
    root_junction: Union[Unset, MapGetObjectListRootJunction] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
) -> Optional[Union[MapGetObjectListResponse200, WebMessage]]:
    if response.status_code == 200:
        response_200 = MapGetObjectListResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[MapGetObjectListResponse200, WebMessage]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, MapGetObjectListRootJunction]):
...
def sync(
    *,
    ...
    Returns:
        Union[MapGetObjectListResponse200, WebMessage]
    """
