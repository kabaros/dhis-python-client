...
from ...models.data_approval_workflow_get_object_list_csv_root_junction import (
    DataApprovalWorkflowGetObjectListCsvRootJunction,
)
...
def _get_kwargs(
    *,
    ...
    root_junction: Union[Unset, DataApprovalWorkflowGetObjectListCsvRootJunction] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/dataApprovalWorkflows/#getObjectListCsv",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, DataApprovalWorkflowGetObjectListCsvRootJunction]):
