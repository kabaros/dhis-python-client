...
from ...models.predictor_replace_collection_items_jsonreplace_collection_items_xml_property import (
    PredictorReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: PredictorReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
    *,
