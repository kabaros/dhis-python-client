...
from ...models.category_bulk_sharing_atomic_mode import CategoryBulkSharingAtomicMode
from ...models.category_bulk_sharing_flush_mode import CategoryBulkSharingFlushMode
from ...models.category_bulk_sharing_identifier import CategoryBulkSharingIdentifier
from ...models.category_bulk_sharing_import_mode import CategoryBulkSharingImportMode
from ...models.category_bulk_sharing_import_report_mode import CategoryBulkSharingImportReportMode
from ...models.category_bulk_sharing_import_strategy import CategoryBulkSharingImportStrategy
from ...models.category_bulk_sharing_preheat_mode import CategoryBulkSharingPreheatMode
from ...models.category_bulk_sharing_root_junction import CategoryBulkSharingRootJunction
from ...models.category_bulk_sharing_user_override_mode import CategoryBulkSharingUserOverrideMode
...
def _get_kwargs(
    *,
    ...
    atomic_mode: Union[Unset, CategoryBulkSharingAtomicMode] = CategoryBulkSharingAtomicMode.ALL,
    flush_mode: Union[Unset, CategoryBulkSharingFlushMode] = CategoryBulkSharingFlushMode.AUTO,
    identifier: Union[Unset, CategoryBulkSharingIdentifier] = CategoryBulkSharingIdentifier.UID,
    import_mode: Union[Unset, CategoryBulkSharingImportMode] = CategoryBulkSharingImportMode.COMMIT,
    import_report_mode: Union[Unset, CategoryBulkSharingImportReportMode] = CategoryBulkSharingImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, CategoryBulkSharingImportStrategy
    ] = CategoryBulkSharingImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, CategoryBulkSharingPreheatMode] = CategoryBulkSharingPreheatMode.REFERENCE,
    root_junction: Union[Unset, CategoryBulkSharingRootJunction] = UNSET,
    skip_sharing: Union[Unset, bool] = False,
    skip_translation: Union[Unset, bool] = False,
    skip_validation: Union[Unset, bool] = False,
    user: Union[Unset, str] = UNSET,
    user_override_mode: Union[Unset, CategoryBulkSharingUserOverrideMode] = CategoryBulkSharingUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, CategoryBulkSharingAtomicMode]):  Default:
            CategoryBulkSharingAtomicMode.ALL.
        flush_mode (Union[Unset, CategoryBulkSharingFlushMode]):  Default:
            CategoryBulkSharingFlushMode.AUTO.
        identifier (Union[Unset, CategoryBulkSharingIdentifier]):  Default:
            CategoryBulkSharingIdentifier.UID.
        import_mode (Union[Unset, CategoryBulkSharingImportMode]):  Default:
            CategoryBulkSharingImportMode.COMMIT.
        import_report_mode (Union[Unset, CategoryBulkSharingImportReportMode]):  Default:
            CategoryBulkSharingImportReportMode.ERRORS.
        import_strategy (Union[Unset, CategoryBulkSharingImportStrategy]):  Default:
            CategoryBulkSharingImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, CategoryBulkSharingPreheatMode]):  Default:
            CategoryBulkSharingPreheatMode.REFERENCE.
        root_junction (Union[Unset, CategoryBulkSharingRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, CategoryBulkSharingUserOverrideMode]):  Default:
            CategoryBulkSharingUserOverrideMode.NONE.
        body (BulkJsonPatch):
