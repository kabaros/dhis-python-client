...
from ...models.category_option_get_object_root_junction import CategoryOptionGetObjectRootJunction
...
def _get_kwargs(
    ...
    *,
    ...
    root_junction: Union[Unset, CategoryOptionGetObjectRootJunction] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
) -> Optional[Union[CategoryOption, WebMessage]]:
    if response.status_code == 200:
        response_200 = CategoryOption.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[CategoryOption, WebMessage]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, CategoryOptionGetObjectRootJunction]):
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[CategoryOption, WebMessage]
    """
