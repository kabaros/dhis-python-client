...
from ...models.constant_replace_collection_items_jsonreplace_collection_items_xml_property import (
    ConstantReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: ConstantReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
    *,
