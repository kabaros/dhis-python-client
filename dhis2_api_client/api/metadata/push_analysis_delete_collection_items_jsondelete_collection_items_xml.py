...
from ...models.push_analysis_delete_collection_items_jsondelete_collection_items_xml_property import (
    PushAnalysisDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: PushAnalysisDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
    *,
