...
from ...models.category_get_object_property_gist_as_csv_auto import CategoryGetObjectPropertyGistAsCsvAuto
from ...models.category_get_object_property_gist_as_csv_property import CategoryGetObjectPropertyGistAsCsvProperty
from ...models.category_get_object_property_gist_as_csv_root_junction import (
    CategoryGetObjectPropertyGistAsCsvRootJunction,
)
...
def _get_kwargs(
    uid: str,
    property_: CategoryGetObjectPropertyGistAsCsvProperty,
    *,
    absolute_urls: Union[Unset, bool] = False,
    auto: Union[Unset, CategoryGetObjectPropertyGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, CategoryGetObjectPropertyGistAsCsvRootJunction
    ] = CategoryGetObjectPropertyGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/categories/{uid}/{property_}/gist.csv",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, CategoryGetObjectPropertyGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, CategoryGetObjectPropertyGistAsCsvRootJunction]):  Default:
            CategoryGetObjectPropertyGistAsCsvRootJunction.AND.
