...
from ...models.attribute_delete_collection_item_property import AttributeDeleteCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: AttributeDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/attributes/{uid}/{property_}/{item_id}",
    }
