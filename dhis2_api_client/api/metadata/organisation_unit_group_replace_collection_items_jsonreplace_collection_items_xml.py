...
from ...models.organisation_unit_group_replace_collection_items_jsonreplace_collection_items_xml_property import (
    OrganisationUnitGroupReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: OrganisationUnitGroupReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
    *,
