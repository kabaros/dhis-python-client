...
from ...models.data_entry_form_replace_collection_items_jsonreplace_collection_items_xml_property import (
    DataEntryFormReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: DataEntryFormReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
    *,
