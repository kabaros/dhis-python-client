...
from ...models.indicator_group_set_add_collection_items_jsonadd_collection_items_xml_property import (
    IndicatorGroupSetAddCollectionItemsJsonaddCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: IndicatorGroupSetAddCollectionItemsJsonaddCollectionItemsXmlProperty,
    *,
