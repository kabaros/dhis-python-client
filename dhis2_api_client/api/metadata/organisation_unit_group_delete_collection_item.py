...
from ...models.organisation_unit_group_delete_collection_item_property import (
    OrganisationUnitGroupDeleteCollectionItemProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: OrganisationUnitGroupDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/organisationUnitGroups/{uid}/{property_}/{item_id}",
    }
