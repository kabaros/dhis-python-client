...
from ...models.indicator_group_add_collection_items_jsonadd_collection_items_xml_property import (
    IndicatorGroupAddCollectionItemsJsonaddCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: IndicatorGroupAddCollectionItemsJsonaddCollectionItemsXmlProperty,
    *,
