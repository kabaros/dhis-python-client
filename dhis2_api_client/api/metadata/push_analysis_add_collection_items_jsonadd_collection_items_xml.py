...
from ...models.push_analysis_add_collection_items_jsonadd_collection_items_xml_property import (
    PushAnalysisAddCollectionItemsJsonaddCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: PushAnalysisAddCollectionItemsJsonaddCollectionItemsXmlProperty,
    *,
