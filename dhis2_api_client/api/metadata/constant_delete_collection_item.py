...
from ...models.constant_delete_collection_item_property import ConstantDeleteCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: ConstantDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/constants/{uid}/{property_}/{item_id}",
    }
