...
from ...models.report_get_object_gistget_object_gist_as_csv_auto import ReportGetObjectGistgetObjectGistAsCsvAuto
from ...models.report_get_object_gistget_object_gist_as_csv_response_200 import (
    ReportGetObjectGistgetObjectGistAsCsvResponse200,
)
from ...models.report_get_object_gistget_object_gist_as_csv_root_junction import (
    ReportGetObjectGistgetObjectGistAsCsvRootJunction,
)
...
def _get_kwargs(
    ...
    *,
    ...
    auto: Union[Unset, ReportGetObjectGistgetObjectGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, ReportGetObjectGistgetObjectGistAsCsvRootJunction
    ] = ReportGetObjectGistgetObjectGistAsCsvRootJunction.AND,
...
) -> Optional[Union[ReportGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]]:
    if response.status_code == 200:
        response_200 = ReportGetObjectGistgetObjectGistAsCsvResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ReportGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, ReportGetObjectGistgetObjectGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, ReportGetObjectGistgetObjectGistAsCsvRootJunction]):  Default:
            ReportGetObjectGistgetObjectGistAsCsvRootJunction.AND.
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ReportGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]
    """
