...
from ...models.data_element_group_patch_object_atomic_mode import DataElementGroupPatchObjectAtomicMode
from ...models.data_element_group_patch_object_flush_mode import DataElementGroupPatchObjectFlushMode
from ...models.data_element_group_patch_object_identifier import DataElementGroupPatchObjectIdentifier
from ...models.data_element_group_patch_object_import_mode import DataElementGroupPatchObjectImportMode
from ...models.data_element_group_patch_object_import_report_mode import DataElementGroupPatchObjectImportReportMode
from ...models.data_element_group_patch_object_import_strategy import DataElementGroupPatchObjectImportStrategy
from ...models.data_element_group_patch_object_preheat_mode import DataElementGroupPatchObjectPreheatMode
from ...models.data_element_group_patch_object_root_junction import DataElementGroupPatchObjectRootJunction
from ...models.data_element_group_patch_object_user_override_mode import DataElementGroupPatchObjectUserOverrideMode
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[Unset, DataElementGroupPatchObjectAtomicMode] = DataElementGroupPatchObjectAtomicMode.ALL,
    flush_mode: Union[Unset, DataElementGroupPatchObjectFlushMode] = DataElementGroupPatchObjectFlushMode.AUTO,
    identifier: Union[Unset, DataElementGroupPatchObjectIdentifier] = DataElementGroupPatchObjectIdentifier.UID,
    import_mode: Union[Unset, DataElementGroupPatchObjectImportMode] = DataElementGroupPatchObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, DataElementGroupPatchObjectImportReportMode
    ] = DataElementGroupPatchObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, DataElementGroupPatchObjectImportStrategy
    ] = DataElementGroupPatchObjectImportStrategy.CREATE_AND_UPDATE,
    ...
    preheat_mode: Union[
        Unset, DataElementGroupPatchObjectPreheatMode
    ] = DataElementGroupPatchObjectPreheatMode.REFERENCE,
    root_junction: Union[Unset, DataElementGroupPatchObjectRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, DataElementGroupPatchObjectUserOverrideMode
    ] = DataElementGroupPatchObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, DataElementGroupPatchObjectAtomicMode]):  Default:
            DataElementGroupPatchObjectAtomicMode.ALL.
        flush_mode (Union[Unset, DataElementGroupPatchObjectFlushMode]):  Default:
            DataElementGroupPatchObjectFlushMode.AUTO.
        identifier (Union[Unset, DataElementGroupPatchObjectIdentifier]):  Default:
            DataElementGroupPatchObjectIdentifier.UID.
        import_mode (Union[Unset, DataElementGroupPatchObjectImportMode]):  Default:
            DataElementGroupPatchObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, DataElementGroupPatchObjectImportReportMode]):  Default:
            DataElementGroupPatchObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, DataElementGroupPatchObjectImportStrategy]):  Default:
            DataElementGroupPatchObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, DataElementGroupPatchObjectPreheatMode]):  Default:
            DataElementGroupPatchObjectPreheatMode.REFERENCE.
        root_junction (Union[Unset, DataElementGroupPatchObjectRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, DataElementGroupPatchObjectUserOverrideMode]):  Default:
            DataElementGroupPatchObjectUserOverrideMode.NONE.
        body (JsonPatch):
