...
from ...models.category_option_combo_add_collection_item_property import CategoryOptionComboAddCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: CategoryOptionComboAddCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
