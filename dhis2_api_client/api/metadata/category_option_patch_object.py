...
from ...models.category_option_patch_object_atomic_mode import CategoryOptionPatchObjectAtomicMode
from ...models.category_option_patch_object_flush_mode import CategoryOptionPatchObjectFlushMode
from ...models.category_option_patch_object_identifier import CategoryOptionPatchObjectIdentifier
from ...models.category_option_patch_object_import_mode import CategoryOptionPatchObjectImportMode
from ...models.category_option_patch_object_import_report_mode import CategoryOptionPatchObjectImportReportMode
from ...models.category_option_patch_object_import_strategy import CategoryOptionPatchObjectImportStrategy
from ...models.category_option_patch_object_preheat_mode import CategoryOptionPatchObjectPreheatMode
from ...models.category_option_patch_object_root_junction import CategoryOptionPatchObjectRootJunction
from ...models.category_option_patch_object_user_override_mode import CategoryOptionPatchObjectUserOverrideMode
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[Unset, CategoryOptionPatchObjectAtomicMode] = CategoryOptionPatchObjectAtomicMode.ALL,
    flush_mode: Union[Unset, CategoryOptionPatchObjectFlushMode] = CategoryOptionPatchObjectFlushMode.AUTO,
    identifier: Union[Unset, CategoryOptionPatchObjectIdentifier] = CategoryOptionPatchObjectIdentifier.UID,
    import_mode: Union[Unset, CategoryOptionPatchObjectImportMode] = CategoryOptionPatchObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, CategoryOptionPatchObjectImportReportMode
    ] = CategoryOptionPatchObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, CategoryOptionPatchObjectImportStrategy
    ] = CategoryOptionPatchObjectImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, CategoryOptionPatchObjectPreheatMode] = CategoryOptionPatchObjectPreheatMode.REFERENCE,
    root_junction: Union[Unset, CategoryOptionPatchObjectRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, CategoryOptionPatchObjectUserOverrideMode
    ] = CategoryOptionPatchObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, CategoryOptionPatchObjectAtomicMode]):  Default:
            CategoryOptionPatchObjectAtomicMode.ALL.
        flush_mode (Union[Unset, CategoryOptionPatchObjectFlushMode]):  Default:
            CategoryOptionPatchObjectFlushMode.AUTO.
        identifier (Union[Unset, CategoryOptionPatchObjectIdentifier]):  Default:
            CategoryOptionPatchObjectIdentifier.UID.
        import_mode (Union[Unset, CategoryOptionPatchObjectImportMode]):  Default:
            CategoryOptionPatchObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, CategoryOptionPatchObjectImportReportMode]):  Default:
            CategoryOptionPatchObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, CategoryOptionPatchObjectImportStrategy]):  Default:
            CategoryOptionPatchObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, CategoryOptionPatchObjectPreheatMode]):  Default:
            CategoryOptionPatchObjectPreheatMode.REFERENCE.
        root_junction (Union[Unset, CategoryOptionPatchObjectRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, CategoryOptionPatchObjectUserOverrideMode]):  Default:
            CategoryOptionPatchObjectUserOverrideMode.NONE.
        body (JsonPatch):
