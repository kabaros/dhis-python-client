...
from ...models.visualization_delete_collection_items_jsondelete_collection_items_xml_property import (
    VisualizationDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: VisualizationDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
    *,
