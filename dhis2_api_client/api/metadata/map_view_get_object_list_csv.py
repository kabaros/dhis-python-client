...
from ...models.map_view_get_object_list_csv_root_junction import MapViewGetObjectListCsvRootJunction
...
def _get_kwargs(
    *,
    ...
    root_junction: Union[Unset, MapViewGetObjectListCsvRootJunction] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, MapViewGetObjectListCsvRootJunction]):
