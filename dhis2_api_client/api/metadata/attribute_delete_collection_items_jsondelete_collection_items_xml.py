...
from ...models.attribute_delete_collection_items_jsondelete_collection_items_xml_property import (
    AttributeDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: AttributeDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
    *,
