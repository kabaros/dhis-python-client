...
from ...models.option_group_set_patch_object_atomic_mode import OptionGroupSetPatchObjectAtomicMode
from ...models.option_group_set_patch_object_flush_mode import OptionGroupSetPatchObjectFlushMode
from ...models.option_group_set_patch_object_identifier import OptionGroupSetPatchObjectIdentifier
from ...models.option_group_set_patch_object_import_mode import OptionGroupSetPatchObjectImportMode
from ...models.option_group_set_patch_object_import_report_mode import OptionGroupSetPatchObjectImportReportMode
from ...models.option_group_set_patch_object_import_strategy import OptionGroupSetPatchObjectImportStrategy
from ...models.option_group_set_patch_object_preheat_mode import OptionGroupSetPatchObjectPreheatMode
from ...models.option_group_set_patch_object_root_junction import OptionGroupSetPatchObjectRootJunction
from ...models.option_group_set_patch_object_user_override_mode import OptionGroupSetPatchObjectUserOverrideMode
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[Unset, OptionGroupSetPatchObjectAtomicMode] = OptionGroupSetPatchObjectAtomicMode.ALL,
    flush_mode: Union[Unset, OptionGroupSetPatchObjectFlushMode] = OptionGroupSetPatchObjectFlushMode.AUTO,
    identifier: Union[Unset, OptionGroupSetPatchObjectIdentifier] = OptionGroupSetPatchObjectIdentifier.UID,
    import_mode: Union[Unset, OptionGroupSetPatchObjectImportMode] = OptionGroupSetPatchObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, OptionGroupSetPatchObjectImportReportMode
    ] = OptionGroupSetPatchObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, OptionGroupSetPatchObjectImportStrategy
    ] = OptionGroupSetPatchObjectImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, OptionGroupSetPatchObjectPreheatMode] = OptionGroupSetPatchObjectPreheatMode.REFERENCE,
    root_junction: Union[Unset, OptionGroupSetPatchObjectRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, OptionGroupSetPatchObjectUserOverrideMode
    ] = OptionGroupSetPatchObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, OptionGroupSetPatchObjectAtomicMode]):  Default:
            OptionGroupSetPatchObjectAtomicMode.ALL.
        flush_mode (Union[Unset, OptionGroupSetPatchObjectFlushMode]):  Default:
            OptionGroupSetPatchObjectFlushMode.AUTO.
        identifier (Union[Unset, OptionGroupSetPatchObjectIdentifier]):  Default:
            OptionGroupSetPatchObjectIdentifier.UID.
        import_mode (Union[Unset, OptionGroupSetPatchObjectImportMode]):  Default:
            OptionGroupSetPatchObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, OptionGroupSetPatchObjectImportReportMode]):  Default:
            OptionGroupSetPatchObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, OptionGroupSetPatchObjectImportStrategy]):  Default:
            OptionGroupSetPatchObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, OptionGroupSetPatchObjectPreheatMode]):  Default:
            OptionGroupSetPatchObjectPreheatMode.REFERENCE.
        root_junction (Union[Unset, OptionGroupSetPatchObjectRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, OptionGroupSetPatchObjectUserOverrideMode]):  Default:
            OptionGroupSetPatchObjectUserOverrideMode.NONE.
        body (JsonPatch):
