...
from ...models.category_option_put_json_objectput_xml_object_atomic_mode import (
    CategoryOptionPutJsonObjectputXmlObjectAtomicMode,
)
from ...models.category_option_put_json_objectput_xml_object_flush_mode import (
    CategoryOptionPutJsonObjectputXmlObjectFlushMode,
)
from ...models.category_option_put_json_objectput_xml_object_identifier import (
    CategoryOptionPutJsonObjectputXmlObjectIdentifier,
)
from ...models.category_option_put_json_objectput_xml_object_import_mode import (
    CategoryOptionPutJsonObjectputXmlObjectImportMode,
)
from ...models.category_option_put_json_objectput_xml_object_import_report_mode import (
    CategoryOptionPutJsonObjectputXmlObjectImportReportMode,
)
from ...models.category_option_put_json_objectput_xml_object_import_strategy import (
    CategoryOptionPutJsonObjectputXmlObjectImportStrategy,
)
from ...models.category_option_put_json_objectput_xml_object_preheat_mode import (
    CategoryOptionPutJsonObjectputXmlObjectPreheatMode,
)
from ...models.category_option_put_json_objectput_xml_object_user_override_mode import (
    CategoryOptionPutJsonObjectputXmlObjectUserOverrideMode,
)
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[
        Unset, CategoryOptionPutJsonObjectputXmlObjectAtomicMode
    ] = CategoryOptionPutJsonObjectputXmlObjectAtomicMode.ALL,
    flush_mode: Union[
        Unset, CategoryOptionPutJsonObjectputXmlObjectFlushMode
    ] = CategoryOptionPutJsonObjectputXmlObjectFlushMode.AUTO,
    identifier: Union[
        Unset, CategoryOptionPutJsonObjectputXmlObjectIdentifier
    ] = CategoryOptionPutJsonObjectputXmlObjectIdentifier.UID,
    import_mode: Union[
        Unset, CategoryOptionPutJsonObjectputXmlObjectImportMode
    ] = CategoryOptionPutJsonObjectputXmlObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, CategoryOptionPutJsonObjectputXmlObjectImportReportMode
    ] = CategoryOptionPutJsonObjectputXmlObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, CategoryOptionPutJsonObjectputXmlObjectImportStrategy
    ] = CategoryOptionPutJsonObjectputXmlObjectImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    preheat_mode: Union[
        Unset, CategoryOptionPutJsonObjectputXmlObjectPreheatMode
    ] = CategoryOptionPutJsonObjectputXmlObjectPreheatMode.REFERENCE,
    ...
    user_override_mode: Union[
        Unset, CategoryOptionPutJsonObjectputXmlObjectUserOverrideMode
    ] = CategoryOptionPutJsonObjectputXmlObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        uid (str): A UID for an CategoryOption object
            (Java name `org.hisp.dhis.category.CategoryOption`) Example: j0wu64kE8Vc.
        async_ (Union[Unset, bool]):  Default: False.
        atomic_mode (Union[Unset, CategoryOptionPutJsonObjectputXmlObjectAtomicMode]):  Default:
            CategoryOptionPutJsonObjectputXmlObjectAtomicMode.ALL.
        flush_mode (Union[Unset, CategoryOptionPutJsonObjectputXmlObjectFlushMode]):  Default:
            CategoryOptionPutJsonObjectputXmlObjectFlushMode.AUTO.
        identifier (Union[Unset, CategoryOptionPutJsonObjectputXmlObjectIdentifier]):  Default:
            CategoryOptionPutJsonObjectputXmlObjectIdentifier.UID.
        import_mode (Union[Unset, CategoryOptionPutJsonObjectputXmlObjectImportMode]):  Default:
            CategoryOptionPutJsonObjectputXmlObjectImportMode.COMMIT.
        import_report_mode (Union[Unset,
            CategoryOptionPutJsonObjectputXmlObjectImportReportMode]):  Default:
            CategoryOptionPutJsonObjectputXmlObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, CategoryOptionPutJsonObjectputXmlObjectImportStrategy]):
            Default: CategoryOptionPutJsonObjectputXmlObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, CategoryOptionPutJsonObjectputXmlObjectPreheatMode]):  Default:
            CategoryOptionPutJsonObjectputXmlObjectPreheatMode.REFERENCE.
        ...
        user_override_mode (Union[Unset,
            CategoryOptionPutJsonObjectputXmlObjectUserOverrideMode]):  Default:
            CategoryOptionPutJsonObjectputXmlObjectUserOverrideMode.NONE.
        body (CategoryOption):
