...
from ...models.external_map_layer_replace_collection_items_jsonreplace_collection_items_xml_property import (
    ExternalMapLayerReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: ExternalMapLayerReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
    *,
