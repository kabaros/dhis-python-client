...
from ...models.option_set_get_object_property_gist_as_csv_auto import OptionSetGetObjectPropertyGistAsCsvAuto
from ...models.option_set_get_object_property_gist_as_csv_property import OptionSetGetObjectPropertyGistAsCsvProperty
from ...models.option_set_get_object_property_gist_as_csv_root_junction import (
    OptionSetGetObjectPropertyGistAsCsvRootJunction,
)
...
def _get_kwargs(
    uid: str,
    property_: OptionSetGetObjectPropertyGistAsCsvProperty,
    *,
    absolute_urls: Union[Unset, bool] = False,
    auto: Union[Unset, OptionSetGetObjectPropertyGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, OptionSetGetObjectPropertyGistAsCsvRootJunction
    ] = OptionSetGetObjectPropertyGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/optionSets/{uid}/{property_}/gist.csv",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, OptionSetGetObjectPropertyGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, OptionSetGetObjectPropertyGistAsCsvRootJunction]):  Default:
            OptionSetGetObjectPropertyGistAsCsvRootJunction.AND.
