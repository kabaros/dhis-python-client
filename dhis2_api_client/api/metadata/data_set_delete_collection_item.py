...
from ...models.data_set_delete_collection_item_property import DataSetDeleteCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: DataSetDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/dataSets/{uid}/{property_}/{item_id}",
    }
