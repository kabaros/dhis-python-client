...
from ...models.data_approval_workflow_delete_collection_item_property import (
    DataApprovalWorkflowDeleteCollectionItemProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: DataApprovalWorkflowDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/dataApprovalWorkflows/{uid}/{property_}/{item_id}",
    }
