...
from ...models.attribute_get_object_root_junction import AttributeGetObjectRootJunction
...
def _get_kwargs(
    ...
    *,
    ...
    root_junction: Union[Unset, AttributeGetObjectRootJunction] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
) -> Optional[Union[Attribute, WebMessage]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Attribute, WebMessage]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, AttributeGetObjectRootJunction]):
