...
from ...models.attribute_replace_collection_items_jsonreplace_collection_items_xml_property import (
    AttributeReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: AttributeReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
    *,
