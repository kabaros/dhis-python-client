...
from ...models.option_replace_collection_items_jsonreplace_collection_items_xml_property import (
    OptionReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: OptionReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
    *,
