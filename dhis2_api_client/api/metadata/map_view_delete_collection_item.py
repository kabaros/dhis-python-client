...
from ...models.map_view_delete_collection_item_property import MapViewDeleteCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: MapViewDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/mapViews/{uid}/{property_}/{item_id}",
    }
