...
from ...models.category_option_combo_add_collection_items_jsonadd_collection_items_xml_property import (
    CategoryOptionComboAddCollectionItemsJsonaddCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: CategoryOptionComboAddCollectionItemsJsonaddCollectionItemsXmlProperty,
    *,
