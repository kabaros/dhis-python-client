...
from ...models.indicator_bulk_sharing_atomic_mode import IndicatorBulkSharingAtomicMode
from ...models.indicator_bulk_sharing_flush_mode import IndicatorBulkSharingFlushMode
from ...models.indicator_bulk_sharing_identifier import IndicatorBulkSharingIdentifier
from ...models.indicator_bulk_sharing_import_mode import IndicatorBulkSharingImportMode
from ...models.indicator_bulk_sharing_import_report_mode import IndicatorBulkSharingImportReportMode
from ...models.indicator_bulk_sharing_import_strategy import IndicatorBulkSharingImportStrategy
from ...models.indicator_bulk_sharing_preheat_mode import IndicatorBulkSharingPreheatMode
from ...models.indicator_bulk_sharing_root_junction import IndicatorBulkSharingRootJunction
from ...models.indicator_bulk_sharing_user_override_mode import IndicatorBulkSharingUserOverrideMode
...
def _get_kwargs(
    *,
    ...
    atomic_mode: Union[Unset, IndicatorBulkSharingAtomicMode] = IndicatorBulkSharingAtomicMode.ALL,
    flush_mode: Union[Unset, IndicatorBulkSharingFlushMode] = IndicatorBulkSharingFlushMode.AUTO,
    identifier: Union[Unset, IndicatorBulkSharingIdentifier] = IndicatorBulkSharingIdentifier.UID,
    import_mode: Union[Unset, IndicatorBulkSharingImportMode] = IndicatorBulkSharingImportMode.COMMIT,
    import_report_mode: Union[
        Unset, IndicatorBulkSharingImportReportMode
    ] = IndicatorBulkSharingImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, IndicatorBulkSharingImportStrategy
    ] = IndicatorBulkSharingImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, IndicatorBulkSharingPreheatMode] = IndicatorBulkSharingPreheatMode.REFERENCE,
    root_junction: Union[Unset, IndicatorBulkSharingRootJunction] = UNSET,
    skip_sharing: Union[Unset, bool] = False,
    skip_translation: Union[Unset, bool] = False,
    skip_validation: Union[Unset, bool] = False,
    user: Union[Unset, str] = UNSET,
    user_override_mode: Union[Unset, IndicatorBulkSharingUserOverrideMode] = IndicatorBulkSharingUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, IndicatorBulkSharingAtomicMode]):  Default:
            IndicatorBulkSharingAtomicMode.ALL.
        flush_mode (Union[Unset, IndicatorBulkSharingFlushMode]):  Default:
            IndicatorBulkSharingFlushMode.AUTO.
        identifier (Union[Unset, IndicatorBulkSharingIdentifier]):  Default:
            IndicatorBulkSharingIdentifier.UID.
        import_mode (Union[Unset, IndicatorBulkSharingImportMode]):  Default:
            IndicatorBulkSharingImportMode.COMMIT.
        import_report_mode (Union[Unset, IndicatorBulkSharingImportReportMode]):  Default:
            IndicatorBulkSharingImportReportMode.ERRORS.
        import_strategy (Union[Unset, IndicatorBulkSharingImportStrategy]):  Default:
            IndicatorBulkSharingImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, IndicatorBulkSharingPreheatMode]):  Default:
            IndicatorBulkSharingPreheatMode.REFERENCE.
        root_junction (Union[Unset, IndicatorBulkSharingRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, IndicatorBulkSharingUserOverrideMode]):  Default:
            IndicatorBulkSharingUserOverrideMode.NONE.
        body (BulkJsonPatch):
