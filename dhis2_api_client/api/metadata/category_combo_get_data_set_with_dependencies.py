...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/categoryCombos/{uid}/metadata",
        "params": params,
    }
...
) -> Optional[Union[MetadataExportParams, WebMessage]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[MetadataExportParams, WebMessage]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[MetadataExportParams, WebMessage]
    """
