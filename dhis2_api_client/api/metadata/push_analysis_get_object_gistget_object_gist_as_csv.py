...
from ...models.push_analysis_get_object_gistget_object_gist_as_csv_auto import (
    PushAnalysisGetObjectGistgetObjectGistAsCsvAuto,
)
from ...models.push_analysis_get_object_gistget_object_gist_as_csv_response_200 import (
    PushAnalysisGetObjectGistgetObjectGistAsCsvResponse200,
)
from ...models.push_analysis_get_object_gistget_object_gist_as_csv_root_junction import (
    PushAnalysisGetObjectGistgetObjectGistAsCsvRootJunction,
)
...
def _get_kwargs(
    ...
    *,
    ...
    auto: Union[Unset, PushAnalysisGetObjectGistgetObjectGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, PushAnalysisGetObjectGistgetObjectGistAsCsvRootJunction
    ] = PushAnalysisGetObjectGistgetObjectGistAsCsvRootJunction.AND,
...
) -> Optional[Union[PushAnalysisGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]]:
    if response.status_code == 200:
        response_200 = PushAnalysisGetObjectGistgetObjectGistAsCsvResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[PushAnalysisGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, PushAnalysisGetObjectGistgetObjectGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, PushAnalysisGetObjectGistgetObjectGistAsCsvRootJunction]):
            Default: PushAnalysisGetObjectGistgetObjectGistAsCsvRootJunction.AND.
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[PushAnalysisGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]
    """
