...
from ...models.organisation_unit_replace_collection_items_jsonreplace_collection_items_xml_property import (
    OrganisationUnitReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: OrganisationUnitReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
    *,
