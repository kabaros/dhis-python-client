...
from ...models.category_option_group_set_get_object_property_gist_as_csv_auto import (
    CategoryOptionGroupSetGetObjectPropertyGistAsCsvAuto,
)
from ...models.category_option_group_set_get_object_property_gist_as_csv_property import (
    CategoryOptionGroupSetGetObjectPropertyGistAsCsvProperty,
)
from ...models.category_option_group_set_get_object_property_gist_as_csv_root_junction import (
    CategoryOptionGroupSetGetObjectPropertyGistAsCsvRootJunction,
)
...
def _get_kwargs(
    uid: str,
    property_: CategoryOptionGroupSetGetObjectPropertyGistAsCsvProperty,
    *,
    absolute_urls: Union[Unset, bool] = False,
    auto: Union[Unset, CategoryOptionGroupSetGetObjectPropertyGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, CategoryOptionGroupSetGetObjectPropertyGistAsCsvRootJunction
    ] = CategoryOptionGroupSetGetObjectPropertyGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/categoryOptionGroupSets/{uid}/{property_}/gist.csv",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, CategoryOptionGroupSetGetObjectPropertyGistAsCsvAuto]):
        ...
        root_junction (Union[Unset,
            CategoryOptionGroupSetGetObjectPropertyGistAsCsvRootJunction]):  Default:
            CategoryOptionGroupSetGetObjectPropertyGistAsCsvRootJunction.AND.
