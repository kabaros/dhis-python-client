...
from ...models.data_element_group_bulk_sharing_atomic_mode import DataElementGroupBulkSharingAtomicMode
from ...models.data_element_group_bulk_sharing_flush_mode import DataElementGroupBulkSharingFlushMode
from ...models.data_element_group_bulk_sharing_identifier import DataElementGroupBulkSharingIdentifier
from ...models.data_element_group_bulk_sharing_import_mode import DataElementGroupBulkSharingImportMode
from ...models.data_element_group_bulk_sharing_import_report_mode import DataElementGroupBulkSharingImportReportMode
from ...models.data_element_group_bulk_sharing_import_strategy import DataElementGroupBulkSharingImportStrategy
from ...models.data_element_group_bulk_sharing_preheat_mode import DataElementGroupBulkSharingPreheatMode
from ...models.data_element_group_bulk_sharing_root_junction import DataElementGroupBulkSharingRootJunction
from ...models.data_element_group_bulk_sharing_user_override_mode import DataElementGroupBulkSharingUserOverrideMode
...
def _get_kwargs(
    *,
    ...
    atomic_mode: Union[Unset, DataElementGroupBulkSharingAtomicMode] = DataElementGroupBulkSharingAtomicMode.ALL,
    flush_mode: Union[Unset, DataElementGroupBulkSharingFlushMode] = DataElementGroupBulkSharingFlushMode.AUTO,
    identifier: Union[Unset, DataElementGroupBulkSharingIdentifier] = DataElementGroupBulkSharingIdentifier.UID,
    import_mode: Union[Unset, DataElementGroupBulkSharingImportMode] = DataElementGroupBulkSharingImportMode.COMMIT,
    import_report_mode: Union[
        Unset, DataElementGroupBulkSharingImportReportMode
    ] = DataElementGroupBulkSharingImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, DataElementGroupBulkSharingImportStrategy
    ] = DataElementGroupBulkSharingImportStrategy.CREATE_AND_UPDATE,
    ...
    preheat_mode: Union[
        Unset, DataElementGroupBulkSharingPreheatMode
    ] = DataElementGroupBulkSharingPreheatMode.REFERENCE,
    root_junction: Union[Unset, DataElementGroupBulkSharingRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, DataElementGroupBulkSharingUserOverrideMode
    ] = DataElementGroupBulkSharingUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, DataElementGroupBulkSharingAtomicMode]):  Default:
            DataElementGroupBulkSharingAtomicMode.ALL.
        flush_mode (Union[Unset, DataElementGroupBulkSharingFlushMode]):  Default:
            DataElementGroupBulkSharingFlushMode.AUTO.
        identifier (Union[Unset, DataElementGroupBulkSharingIdentifier]):  Default:
            DataElementGroupBulkSharingIdentifier.UID.
        import_mode (Union[Unset, DataElementGroupBulkSharingImportMode]):  Default:
            DataElementGroupBulkSharingImportMode.COMMIT.
        import_report_mode (Union[Unset, DataElementGroupBulkSharingImportReportMode]):  Default:
            DataElementGroupBulkSharingImportReportMode.ERRORS.
        import_strategy (Union[Unset, DataElementGroupBulkSharingImportStrategy]):  Default:
            DataElementGroupBulkSharingImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, DataElementGroupBulkSharingPreheatMode]):  Default:
            DataElementGroupBulkSharingPreheatMode.REFERENCE.
        root_junction (Union[Unset, DataElementGroupBulkSharingRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, DataElementGroupBulkSharingUserOverrideMode]):  Default:
            DataElementGroupBulkSharingUserOverrideMode.NONE.
        body (BulkJsonPatch):
