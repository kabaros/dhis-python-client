...
from ...models.organisation_unit_get_object_property_gist_as_csv_auto import (
    OrganisationUnitGetObjectPropertyGistAsCsvAuto,
)
from ...models.organisation_unit_get_object_property_gist_as_csv_property import (
    OrganisationUnitGetObjectPropertyGistAsCsvProperty,
)
from ...models.organisation_unit_get_object_property_gist_as_csv_root_junction import (
    OrganisationUnitGetObjectPropertyGistAsCsvRootJunction,
)
...
def _get_kwargs(
    uid: str,
    property_: OrganisationUnitGetObjectPropertyGistAsCsvProperty,
    *,
    absolute_urls: Union[Unset, bool] = False,
    auto: Union[Unset, OrganisationUnitGetObjectPropertyGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, OrganisationUnitGetObjectPropertyGistAsCsvRootJunction
    ] = OrganisationUnitGetObjectPropertyGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/organisationUnits/{uid}/{property_}/gist.csv",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, OrganisationUnitGetObjectPropertyGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, OrganisationUnitGetObjectPropertyGistAsCsvRootJunction]):
            Default: OrganisationUnitGetObjectPropertyGistAsCsvRootJunction.AND.
