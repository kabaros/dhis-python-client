...
from ...models.event_hook_bulk_sharing_atomic_mode import EventHookBulkSharingAtomicMode
from ...models.event_hook_bulk_sharing_flush_mode import EventHookBulkSharingFlushMode
from ...models.event_hook_bulk_sharing_identifier import EventHookBulkSharingIdentifier
from ...models.event_hook_bulk_sharing_import_mode import EventHookBulkSharingImportMode
from ...models.event_hook_bulk_sharing_import_report_mode import EventHookBulkSharingImportReportMode
from ...models.event_hook_bulk_sharing_import_strategy import EventHookBulkSharingImportStrategy
from ...models.event_hook_bulk_sharing_preheat_mode import EventHookBulkSharingPreheatMode
from ...models.event_hook_bulk_sharing_root_junction import EventHookBulkSharingRootJunction
from ...models.event_hook_bulk_sharing_user_override_mode import EventHookBulkSharingUserOverrideMode
...
def _get_kwargs(
    *,
    ...
    atomic_mode: Union[Unset, EventHookBulkSharingAtomicMode] = EventHookBulkSharingAtomicMode.ALL,
    flush_mode: Union[Unset, EventHookBulkSharingFlushMode] = EventHookBulkSharingFlushMode.AUTO,
    identifier: Union[Unset, EventHookBulkSharingIdentifier] = EventHookBulkSharingIdentifier.UID,
    import_mode: Union[Unset, EventHookBulkSharingImportMode] = EventHookBulkSharingImportMode.COMMIT,
    import_report_mode: Union[
        Unset, EventHookBulkSharingImportReportMode
    ] = EventHookBulkSharingImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, EventHookBulkSharingImportStrategy
    ] = EventHookBulkSharingImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, EventHookBulkSharingPreheatMode] = EventHookBulkSharingPreheatMode.REFERENCE,
    root_junction: Union[Unset, EventHookBulkSharingRootJunction] = UNSET,
    skip_sharing: Union[Unset, bool] = False,
    skip_translation: Union[Unset, bool] = False,
    skip_validation: Union[Unset, bool] = False,
    user: Union[Unset, str] = UNSET,
    user_override_mode: Union[Unset, EventHookBulkSharingUserOverrideMode] = EventHookBulkSharingUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, EventHookBulkSharingAtomicMode]):  Default:
            EventHookBulkSharingAtomicMode.ALL.
        flush_mode (Union[Unset, EventHookBulkSharingFlushMode]):  Default:
            EventHookBulkSharingFlushMode.AUTO.
        identifier (Union[Unset, EventHookBulkSharingIdentifier]):  Default:
            EventHookBulkSharingIdentifier.UID.
        import_mode (Union[Unset, EventHookBulkSharingImportMode]):  Default:
            EventHookBulkSharingImportMode.COMMIT.
        import_report_mode (Union[Unset, EventHookBulkSharingImportReportMode]):  Default:
            EventHookBulkSharingImportReportMode.ERRORS.
        import_strategy (Union[Unset, EventHookBulkSharingImportStrategy]):  Default:
            EventHookBulkSharingImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, EventHookBulkSharingPreheatMode]):  Default:
            EventHookBulkSharingPreheatMode.REFERENCE.
        root_junction (Union[Unset, EventHookBulkSharingRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, EventHookBulkSharingUserOverrideMode]):  Default:
            EventHookBulkSharingUserOverrideMode.NONE.
        body (BulkJsonPatch):
