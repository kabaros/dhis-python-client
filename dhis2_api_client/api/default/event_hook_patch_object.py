...
from ...models.event_hook_patch_object_atomic_mode import EventHookPatchObjectAtomicMode
from ...models.event_hook_patch_object_flush_mode import EventHookPatchObjectFlushMode
from ...models.event_hook_patch_object_identifier import EventHookPatchObjectIdentifier
from ...models.event_hook_patch_object_import_mode import EventHookPatchObjectImportMode
from ...models.event_hook_patch_object_import_report_mode import EventHookPatchObjectImportReportMode
from ...models.event_hook_patch_object_import_strategy import EventHookPatchObjectImportStrategy
from ...models.event_hook_patch_object_preheat_mode import EventHookPatchObjectPreheatMode
from ...models.event_hook_patch_object_root_junction import EventHookPatchObjectRootJunction
from ...models.event_hook_patch_object_user_override_mode import EventHookPatchObjectUserOverrideMode
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[Unset, EventHookPatchObjectAtomicMode] = EventHookPatchObjectAtomicMode.ALL,
    flush_mode: Union[Unset, EventHookPatchObjectFlushMode] = EventHookPatchObjectFlushMode.AUTO,
    identifier: Union[Unset, EventHookPatchObjectIdentifier] = EventHookPatchObjectIdentifier.UID,
    import_mode: Union[Unset, EventHookPatchObjectImportMode] = EventHookPatchObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, EventHookPatchObjectImportReportMode
    ] = EventHookPatchObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, EventHookPatchObjectImportStrategy
    ] = EventHookPatchObjectImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, EventHookPatchObjectPreheatMode] = EventHookPatchObjectPreheatMode.REFERENCE,
    root_junction: Union[Unset, EventHookPatchObjectRootJunction] = UNSET,
    skip_sharing: Union[Unset, bool] = False,
    skip_translation: Union[Unset, bool] = False,
    skip_validation: Union[Unset, bool] = False,
    user: Union[Unset, str] = UNSET,
    user_override_mode: Union[Unset, EventHookPatchObjectUserOverrideMode] = EventHookPatchObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, EventHookPatchObjectAtomicMode]):  Default:
            EventHookPatchObjectAtomicMode.ALL.
        flush_mode (Union[Unset, EventHookPatchObjectFlushMode]):  Default:
            EventHookPatchObjectFlushMode.AUTO.
        identifier (Union[Unset, EventHookPatchObjectIdentifier]):  Default:
            EventHookPatchObjectIdentifier.UID.
        import_mode (Union[Unset, EventHookPatchObjectImportMode]):  Default:
            EventHookPatchObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, EventHookPatchObjectImportReportMode]):  Default:
            EventHookPatchObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, EventHookPatchObjectImportStrategy]):  Default:
            EventHookPatchObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, EventHookPatchObjectPreheatMode]):  Default:
            EventHookPatchObjectPreheatMode.REFERENCE.
        root_junction (Union[Unset, EventHookPatchObjectRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, EventHookPatchObjectUserOverrideMode]):  Default:
            EventHookPatchObjectUserOverrideMode.NONE.
        body (JsonPatch):
