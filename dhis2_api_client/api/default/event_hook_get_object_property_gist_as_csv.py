...
from ...models.event_hook_get_object_property_gist_as_csv_auto import EventHookGetObjectPropertyGistAsCsvAuto
from ...models.event_hook_get_object_property_gist_as_csv_property import EventHookGetObjectPropertyGistAsCsvProperty
from ...models.event_hook_get_object_property_gist_as_csv_root_junction import (
    EventHookGetObjectPropertyGistAsCsvRootJunction,
)
...
def _get_kwargs(
    uid: str,
    property_: EventHookGetObjectPropertyGistAsCsvProperty,
    *,
    absolute_urls: Union[Unset, bool] = False,
    auto: Union[Unset, EventHookGetObjectPropertyGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, EventHookGetObjectPropertyGistAsCsvRootJunction
    ] = EventHookGetObjectPropertyGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/eventHooks/{uid}/{property_}/gist.csv",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, EventHookGetObjectPropertyGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, EventHookGetObjectPropertyGistAsCsvRootJunction]):  Default:
            EventHookGetObjectPropertyGistAsCsvRootJunction.AND.
