...
from ...models.event_hook_get_object_list_response_200 import EventHookGetObjectListResponse200
from ...models.event_hook_get_object_list_root_junction import EventHookGetObjectListRootJunction
...
def _get_kwargs(
    *,
    ...
    root_junction: Union[Unset, EventHookGetObjectListRootJunction] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
) -> Optional[Union[EventHookGetObjectListResponse200, WebMessage]]:
    if response.status_code == 200:
        response_200 = EventHookGetObjectListResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[EventHookGetObjectListResponse200, WebMessage]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, EventHookGetObjectListRootJunction]):
...
def sync(
    *,
    ...
    Returns:
        Union[EventHookGetObjectListResponse200, WebMessage]
    """
