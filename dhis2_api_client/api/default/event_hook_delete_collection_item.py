...
from ...models.event_hook_delete_collection_item_property import EventHookDeleteCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: EventHookDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/eventHooks/{uid}/{property_}/{item_id}",
    }
