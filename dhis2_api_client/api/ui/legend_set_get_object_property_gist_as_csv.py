...
from ...models.legend_set_get_object_property_gist_as_csv_auto import LegendSetGetObjectPropertyGistAsCsvAuto
from ...models.legend_set_get_object_property_gist_as_csv_property import LegendSetGetObjectPropertyGistAsCsvProperty
from ...models.legend_set_get_object_property_gist_as_csv_root_junction import (
    LegendSetGetObjectPropertyGistAsCsvRootJunction,
)
...
def _get_kwargs(
    uid: str,
    property_: LegendSetGetObjectPropertyGistAsCsvProperty,
    *,
    absolute_urls: Union[Unset, bool] = False,
    auto: Union[Unset, LegendSetGetObjectPropertyGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, LegendSetGetObjectPropertyGistAsCsvRootJunction
    ] = LegendSetGetObjectPropertyGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/legendSets/{uid}/{property_}/gist.csv",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, LegendSetGetObjectPropertyGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, LegendSetGetObjectPropertyGistAsCsvRootJunction]):  Default:
            LegendSetGetObjectPropertyGistAsCsvRootJunction.AND.
