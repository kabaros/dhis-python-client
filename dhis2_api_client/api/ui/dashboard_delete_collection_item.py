...
from ...models.dashboard_delete_collection_item_property import DashboardDeleteCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: DashboardDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/dashboards/{uid}/{property_}/{item_id}",
    }
