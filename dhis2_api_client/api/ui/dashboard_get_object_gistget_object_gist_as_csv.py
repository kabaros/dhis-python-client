...
from ...models.dashboard_get_object_gistget_object_gist_as_csv_auto import DashboardGetObjectGistgetObjectGistAsCsvAuto
from ...models.dashboard_get_object_gistget_object_gist_as_csv_response_200 import (
    DashboardGetObjectGistgetObjectGistAsCsvResponse200,
)
from ...models.dashboard_get_object_gistget_object_gist_as_csv_root_junction import (
    DashboardGetObjectGistgetObjectGistAsCsvRootJunction,
)
...
def _get_kwargs(
    ...
    *,
    ...
    auto: Union[Unset, DashboardGetObjectGistgetObjectGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, DashboardGetObjectGistgetObjectGistAsCsvRootJunction
    ] = DashboardGetObjectGistgetObjectGistAsCsvRootJunction.AND,
...
) -> Optional[Union[DashboardGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]]:
    if response.status_code == 200:
        response_200 = DashboardGetObjectGistgetObjectGistAsCsvResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DashboardGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, DashboardGetObjectGistgetObjectGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, DashboardGetObjectGistgetObjectGistAsCsvRootJunction]):
            Default: DashboardGetObjectGistgetObjectGistAsCsvRootJunction.AND.
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[DashboardGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]
    """
