...
from ...models.legend_set_add_collection_items_jsonadd_collection_items_xml_property import (
    LegendSetAddCollectionItemsJsonaddCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: LegendSetAddCollectionItemsJsonaddCollectionItemsXmlProperty,
    *,
