...
from ...models.dashboard_patch_object_atomic_mode import DashboardPatchObjectAtomicMode
from ...models.dashboard_patch_object_flush_mode import DashboardPatchObjectFlushMode
from ...models.dashboard_patch_object_identifier import DashboardPatchObjectIdentifier
from ...models.dashboard_patch_object_import_mode import DashboardPatchObjectImportMode
from ...models.dashboard_patch_object_import_report_mode import DashboardPatchObjectImportReportMode
from ...models.dashboard_patch_object_import_strategy import DashboardPatchObjectImportStrategy
from ...models.dashboard_patch_object_preheat_mode import DashboardPatchObjectPreheatMode
from ...models.dashboard_patch_object_root_junction import DashboardPatchObjectRootJunction
from ...models.dashboard_patch_object_user_override_mode import DashboardPatchObjectUserOverrideMode
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[Unset, DashboardPatchObjectAtomicMode] = DashboardPatchObjectAtomicMode.ALL,
    flush_mode: Union[Unset, DashboardPatchObjectFlushMode] = DashboardPatchObjectFlushMode.AUTO,
    identifier: Union[Unset, DashboardPatchObjectIdentifier] = DashboardPatchObjectIdentifier.UID,
    import_mode: Union[Unset, DashboardPatchObjectImportMode] = DashboardPatchObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, DashboardPatchObjectImportReportMode
    ] = DashboardPatchObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, DashboardPatchObjectImportStrategy
    ] = DashboardPatchObjectImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, DashboardPatchObjectPreheatMode] = DashboardPatchObjectPreheatMode.REFERENCE,
    root_junction: Union[Unset, DashboardPatchObjectRootJunction] = UNSET,
    skip_sharing: Union[Unset, bool] = False,
    skip_translation: Union[Unset, bool] = False,
    skip_validation: Union[Unset, bool] = False,
    user: Union[Unset, str] = UNSET,
    user_override_mode: Union[Unset, DashboardPatchObjectUserOverrideMode] = DashboardPatchObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, DashboardPatchObjectAtomicMode]):  Default:
            DashboardPatchObjectAtomicMode.ALL.
        flush_mode (Union[Unset, DashboardPatchObjectFlushMode]):  Default:
            DashboardPatchObjectFlushMode.AUTO.
        identifier (Union[Unset, DashboardPatchObjectIdentifier]):  Default:
            DashboardPatchObjectIdentifier.UID.
        import_mode (Union[Unset, DashboardPatchObjectImportMode]):  Default:
            DashboardPatchObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, DashboardPatchObjectImportReportMode]):  Default:
            DashboardPatchObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, DashboardPatchObjectImportStrategy]):  Default:
            DashboardPatchObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, DashboardPatchObjectPreheatMode]):  Default:
            DashboardPatchObjectPreheatMode.REFERENCE.
        root_junction (Union[Unset, DashboardPatchObjectRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, DashboardPatchObjectUserOverrideMode]):  Default:
            DashboardPatchObjectUserOverrideMode.NONE.
        body (JsonPatch):
