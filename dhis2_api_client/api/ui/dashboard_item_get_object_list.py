...
from ...models.dashboard_item_get_object_list_response_200 import DashboardItemGetObjectListResponse200
from ...models.dashboard_item_get_object_list_root_junction import DashboardItemGetObjectListRootJunction
...
def _get_kwargs(
    *,
    ...
    root_junction: Union[Unset, DashboardItemGetObjectListRootJunction] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
) -> Optional[Union[DashboardItemGetObjectListResponse200, WebMessage]]:
    if response.status_code == 200:
        response_200 = DashboardItemGetObjectListResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DashboardItemGetObjectListResponse200, WebMessage]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, DashboardItemGetObjectListRootJunction]):
...
def sync(
    *,
    ...
    Returns:
        Union[DashboardItemGetObjectListResponse200, WebMessage]
    """
