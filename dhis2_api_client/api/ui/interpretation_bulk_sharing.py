...
from ...models.interpretation_bulk_sharing_atomic_mode import InterpretationBulkSharingAtomicMode
from ...models.interpretation_bulk_sharing_flush_mode import InterpretationBulkSharingFlushMode
from ...models.interpretation_bulk_sharing_identifier import InterpretationBulkSharingIdentifier
from ...models.interpretation_bulk_sharing_import_mode import InterpretationBulkSharingImportMode
from ...models.interpretation_bulk_sharing_import_report_mode import InterpretationBulkSharingImportReportMode
from ...models.interpretation_bulk_sharing_import_strategy import InterpretationBulkSharingImportStrategy
from ...models.interpretation_bulk_sharing_preheat_mode import InterpretationBulkSharingPreheatMode
from ...models.interpretation_bulk_sharing_root_junction import InterpretationBulkSharingRootJunction
from ...models.interpretation_bulk_sharing_user_override_mode import InterpretationBulkSharingUserOverrideMode
...
def _get_kwargs(
    *,
    ...
    atomic_mode: Union[Unset, InterpretationBulkSharingAtomicMode] = InterpretationBulkSharingAtomicMode.ALL,
    flush_mode: Union[Unset, InterpretationBulkSharingFlushMode] = InterpretationBulkSharingFlushMode.AUTO,
    identifier: Union[Unset, InterpretationBulkSharingIdentifier] = InterpretationBulkSharingIdentifier.UID,
    import_mode: Union[Unset, InterpretationBulkSharingImportMode] = InterpretationBulkSharingImportMode.COMMIT,
    import_report_mode: Union[
        Unset, InterpretationBulkSharingImportReportMode
    ] = InterpretationBulkSharingImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, InterpretationBulkSharingImportStrategy
    ] = InterpretationBulkSharingImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, InterpretationBulkSharingPreheatMode] = InterpretationBulkSharingPreheatMode.REFERENCE,
    root_junction: Union[Unset, InterpretationBulkSharingRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, InterpretationBulkSharingUserOverrideMode
    ] = InterpretationBulkSharingUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, InterpretationBulkSharingAtomicMode]):  Default:
            InterpretationBulkSharingAtomicMode.ALL.
        flush_mode (Union[Unset, InterpretationBulkSharingFlushMode]):  Default:
            InterpretationBulkSharingFlushMode.AUTO.
        identifier (Union[Unset, InterpretationBulkSharingIdentifier]):  Default:
            InterpretationBulkSharingIdentifier.UID.
        import_mode (Union[Unset, InterpretationBulkSharingImportMode]):  Default:
            InterpretationBulkSharingImportMode.COMMIT.
        import_report_mode (Union[Unset, InterpretationBulkSharingImportReportMode]):  Default:
            InterpretationBulkSharingImportReportMode.ERRORS.
        import_strategy (Union[Unset, InterpretationBulkSharingImportStrategy]):  Default:
            InterpretationBulkSharingImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, InterpretationBulkSharingPreheatMode]):  Default:
            InterpretationBulkSharingPreheatMode.REFERENCE.
        root_junction (Union[Unset, InterpretationBulkSharingRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, InterpretationBulkSharingUserOverrideMode]):  Default:
            InterpretationBulkSharingUserOverrideMode.NONE.
        body (BulkJsonPatch):
