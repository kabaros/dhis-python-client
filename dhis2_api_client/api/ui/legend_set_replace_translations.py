...
from ...models.legend_set_replace_translations_body import LegendSetReplaceTranslationsBody
...
def _get_kwargs(
    uid: str,
    *,
    body: LegendSetReplaceTranslationsBody,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": f"/legendSets/{uid}/translations",
    }
