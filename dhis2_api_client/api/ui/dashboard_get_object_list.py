...
from ...models.dashboard_get_object_list_response_200 import DashboardGetObjectListResponse200
from ...models.dashboard_get_object_list_root_junction import DashboardGetObjectListRootJunction
...
def _get_kwargs(
    *,
    ...
    root_junction: Union[Unset, DashboardGetObjectListRootJunction] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
) -> Optional[Union[DashboardGetObjectListResponse200, WebMessage]]:
    if response.status_code == 200:
        response_200 = DashboardGetObjectListResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DashboardGetObjectListResponse200, WebMessage]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, DashboardGetObjectListRootJunction]):
...
def sync(
    *,
    ...
    Returns:
        Union[DashboardGetObjectListResponse200, WebMessage]
    """
