...
from ...models.dashboard_put_json_objectput_xml_object_atomic_mode import DashboardPutJsonObjectputXmlObjectAtomicMode
from ...models.dashboard_put_json_objectput_xml_object_flush_mode import DashboardPutJsonObjectputXmlObjectFlushMode
from ...models.dashboard_put_json_objectput_xml_object_identifier import DashboardPutJsonObjectputXmlObjectIdentifier
from ...models.dashboard_put_json_objectput_xml_object_import_mode import DashboardPutJsonObjectputXmlObjectImportMode
from ...models.dashboard_put_json_objectput_xml_object_import_report_mode import (
    DashboardPutJsonObjectputXmlObjectImportReportMode,
)
from ...models.dashboard_put_json_objectput_xml_object_import_strategy import (
    DashboardPutJsonObjectputXmlObjectImportStrategy,
)
from ...models.dashboard_put_json_objectput_xml_object_preheat_mode import DashboardPutJsonObjectputXmlObjectPreheatMode
from ...models.dashboard_put_json_objectput_xml_object_user_override_mode import (
    DashboardPutJsonObjectputXmlObjectUserOverrideMode,
)
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[
        Unset, DashboardPutJsonObjectputXmlObjectAtomicMode
    ] = DashboardPutJsonObjectputXmlObjectAtomicMode.ALL,
    flush_mode: Union[
        Unset, DashboardPutJsonObjectputXmlObjectFlushMode
    ] = DashboardPutJsonObjectputXmlObjectFlushMode.AUTO,
    identifier: Union[
        Unset, DashboardPutJsonObjectputXmlObjectIdentifier
    ] = DashboardPutJsonObjectputXmlObjectIdentifier.UID,
    import_mode: Union[
        Unset, DashboardPutJsonObjectputXmlObjectImportMode
    ] = DashboardPutJsonObjectputXmlObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, DashboardPutJsonObjectputXmlObjectImportReportMode
    ] = DashboardPutJsonObjectputXmlObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, DashboardPutJsonObjectputXmlObjectImportStrategy
    ] = DashboardPutJsonObjectputXmlObjectImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    preheat_mode: Union[
        Unset, DashboardPutJsonObjectputXmlObjectPreheatMode
    ] = DashboardPutJsonObjectputXmlObjectPreheatMode.REFERENCE,
    ...
    user_override_mode: Union[
        Unset, DashboardPutJsonObjectputXmlObjectUserOverrideMode
    ] = DashboardPutJsonObjectputXmlObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, DashboardPutJsonObjectputXmlObjectAtomicMode]):  Default:
            DashboardPutJsonObjectputXmlObjectAtomicMode.ALL.
        flush_mode (Union[Unset, DashboardPutJsonObjectputXmlObjectFlushMode]):  Default:
            DashboardPutJsonObjectputXmlObjectFlushMode.AUTO.
        identifier (Union[Unset, DashboardPutJsonObjectputXmlObjectIdentifier]):  Default:
            DashboardPutJsonObjectputXmlObjectIdentifier.UID.
        import_mode (Union[Unset, DashboardPutJsonObjectputXmlObjectImportMode]):  Default:
            DashboardPutJsonObjectputXmlObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, DashboardPutJsonObjectputXmlObjectImportReportMode]):
            Default: DashboardPutJsonObjectputXmlObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, DashboardPutJsonObjectputXmlObjectImportStrategy]):
            Default: DashboardPutJsonObjectputXmlObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, DashboardPutJsonObjectputXmlObjectPreheatMode]):  Default:
            DashboardPutJsonObjectputXmlObjectPreheatMode.REFERENCE.
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, DashboardPutJsonObjectputXmlObjectUserOverrideMode]):
            Default: DashboardPutJsonObjectputXmlObjectUserOverrideMode.NONE.
        body (Dashboard):
