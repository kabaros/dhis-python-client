...
from ...models.legend_set_delete_collection_item_property import LegendSetDeleteCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: LegendSetDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/legendSets/{uid}/{property_}/{item_id}",
    }
