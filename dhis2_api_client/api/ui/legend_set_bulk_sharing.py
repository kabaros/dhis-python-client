...
from ...models.legend_set_bulk_sharing_atomic_mode import LegendSetBulkSharingAtomicMode
from ...models.legend_set_bulk_sharing_flush_mode import LegendSetBulkSharingFlushMode
from ...models.legend_set_bulk_sharing_identifier import LegendSetBulkSharingIdentifier
from ...models.legend_set_bulk_sharing_import_mode import LegendSetBulkSharingImportMode
from ...models.legend_set_bulk_sharing_import_report_mode import LegendSetBulkSharingImportReportMode
from ...models.legend_set_bulk_sharing_import_strategy import LegendSetBulkSharingImportStrategy
from ...models.legend_set_bulk_sharing_preheat_mode import LegendSetBulkSharingPreheatMode
from ...models.legend_set_bulk_sharing_root_junction import LegendSetBulkSharingRootJunction
from ...models.legend_set_bulk_sharing_user_override_mode import LegendSetBulkSharingUserOverrideMode
...
def _get_kwargs(
    *,
    ...
    atomic_mode: Union[Unset, LegendSetBulkSharingAtomicMode] = LegendSetBulkSharingAtomicMode.ALL,
    flush_mode: Union[Unset, LegendSetBulkSharingFlushMode] = LegendSetBulkSharingFlushMode.AUTO,
    identifier: Union[Unset, LegendSetBulkSharingIdentifier] = LegendSetBulkSharingIdentifier.UID,
    import_mode: Union[Unset, LegendSetBulkSharingImportMode] = LegendSetBulkSharingImportMode.COMMIT,
    import_report_mode: Union[
        Unset, LegendSetBulkSharingImportReportMode
    ] = LegendSetBulkSharingImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, LegendSetBulkSharingImportStrategy
    ] = LegendSetBulkSharingImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, LegendSetBulkSharingPreheatMode] = LegendSetBulkSharingPreheatMode.REFERENCE,
    root_junction: Union[Unset, LegendSetBulkSharingRootJunction] = UNSET,
    skip_sharing: Union[Unset, bool] = False,
    skip_translation: Union[Unset, bool] = False,
    skip_validation: Union[Unset, bool] = False,
    user: Union[Unset, str] = UNSET,
    user_override_mode: Union[Unset, LegendSetBulkSharingUserOverrideMode] = LegendSetBulkSharingUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, LegendSetBulkSharingAtomicMode]):  Default:
            LegendSetBulkSharingAtomicMode.ALL.
        flush_mode (Union[Unset, LegendSetBulkSharingFlushMode]):  Default:
            LegendSetBulkSharingFlushMode.AUTO.
        identifier (Union[Unset, LegendSetBulkSharingIdentifier]):  Default:
            LegendSetBulkSharingIdentifier.UID.
        import_mode (Union[Unset, LegendSetBulkSharingImportMode]):  Default:
            LegendSetBulkSharingImportMode.COMMIT.
        import_report_mode (Union[Unset, LegendSetBulkSharingImportReportMode]):  Default:
            LegendSetBulkSharingImportReportMode.ERRORS.
        import_strategy (Union[Unset, LegendSetBulkSharingImportStrategy]):  Default:
            LegendSetBulkSharingImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, LegendSetBulkSharingPreheatMode]):  Default:
            LegendSetBulkSharingPreheatMode.REFERENCE.
        root_junction (Union[Unset, LegendSetBulkSharingRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, LegendSetBulkSharingUserOverrideMode]):  Default:
            LegendSetBulkSharingUserOverrideMode.NONE.
        body (BulkJsonPatch):
