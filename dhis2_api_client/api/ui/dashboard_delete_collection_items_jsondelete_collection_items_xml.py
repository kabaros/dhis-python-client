...
from ...models.dashboard_delete_collection_items_jsondelete_collection_items_xml_property import (
    DashboardDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: DashboardDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
    *,
