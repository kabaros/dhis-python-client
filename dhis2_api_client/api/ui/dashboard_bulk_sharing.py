...
from ...models.dashboard_bulk_sharing_atomic_mode import DashboardBulkSharingAtomicMode
from ...models.dashboard_bulk_sharing_flush_mode import DashboardBulkSharingFlushMode
from ...models.dashboard_bulk_sharing_identifier import DashboardBulkSharingIdentifier
from ...models.dashboard_bulk_sharing_import_mode import DashboardBulkSharingImportMode
from ...models.dashboard_bulk_sharing_import_report_mode import DashboardBulkSharingImportReportMode
from ...models.dashboard_bulk_sharing_import_strategy import DashboardBulkSharingImportStrategy
from ...models.dashboard_bulk_sharing_preheat_mode import DashboardBulkSharingPreheatMode
from ...models.dashboard_bulk_sharing_root_junction import DashboardBulkSharingRootJunction
from ...models.dashboard_bulk_sharing_user_override_mode import DashboardBulkSharingUserOverrideMode
...
def _get_kwargs(
    *,
    ...
    atomic_mode: Union[Unset, DashboardBulkSharingAtomicMode] = DashboardBulkSharingAtomicMode.ALL,
    flush_mode: Union[Unset, DashboardBulkSharingFlushMode] = DashboardBulkSharingFlushMode.AUTO,
    identifier: Union[Unset, DashboardBulkSharingIdentifier] = DashboardBulkSharingIdentifier.UID,
    import_mode: Union[Unset, DashboardBulkSharingImportMode] = DashboardBulkSharingImportMode.COMMIT,
    import_report_mode: Union[
        Unset, DashboardBulkSharingImportReportMode
    ] = DashboardBulkSharingImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, DashboardBulkSharingImportStrategy
    ] = DashboardBulkSharingImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, DashboardBulkSharingPreheatMode] = DashboardBulkSharingPreheatMode.REFERENCE,
    root_junction: Union[Unset, DashboardBulkSharingRootJunction] = UNSET,
    skip_sharing: Union[Unset, bool] = False,
    skip_translation: Union[Unset, bool] = False,
    skip_validation: Union[Unset, bool] = False,
    user: Union[Unset, str] = UNSET,
    user_override_mode: Union[Unset, DashboardBulkSharingUserOverrideMode] = DashboardBulkSharingUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, DashboardBulkSharingAtomicMode]):  Default:
            DashboardBulkSharingAtomicMode.ALL.
        flush_mode (Union[Unset, DashboardBulkSharingFlushMode]):  Default:
            DashboardBulkSharingFlushMode.AUTO.
        identifier (Union[Unset, DashboardBulkSharingIdentifier]):  Default:
            DashboardBulkSharingIdentifier.UID.
        import_mode (Union[Unset, DashboardBulkSharingImportMode]):  Default:
            DashboardBulkSharingImportMode.COMMIT.
        import_report_mode (Union[Unset, DashboardBulkSharingImportReportMode]):  Default:
            DashboardBulkSharingImportReportMode.ERRORS.
        import_strategy (Union[Unset, DashboardBulkSharingImportStrategy]):  Default:
            DashboardBulkSharingImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, DashboardBulkSharingPreheatMode]):  Default:
            DashboardBulkSharingPreheatMode.REFERENCE.
        root_junction (Union[Unset, DashboardBulkSharingRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, DashboardBulkSharingUserOverrideMode]):  Default:
            DashboardBulkSharingUserOverrideMode.NONE.
        body (BulkJsonPatch):
