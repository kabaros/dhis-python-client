...
from ...models.dashboard_replace_translations_body import DashboardReplaceTranslationsBody
...
def _get_kwargs(
    uid: str,
    *,
    body: DashboardReplaceTranslationsBody,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": f"/dashboards/{uid}/translations",
    }
