...
from ...models.dashboard_add_collection_items_jsonadd_collection_items_xml_property import (
    DashboardAddCollectionItemsJsonaddCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: DashboardAddCollectionItemsJsonaddCollectionItemsXmlProperty,
    *,
