...
from ...models.dashboard_item_patch_object_atomic_mode import DashboardItemPatchObjectAtomicMode
from ...models.dashboard_item_patch_object_flush_mode import DashboardItemPatchObjectFlushMode
from ...models.dashboard_item_patch_object_identifier import DashboardItemPatchObjectIdentifier
from ...models.dashboard_item_patch_object_import_mode import DashboardItemPatchObjectImportMode
from ...models.dashboard_item_patch_object_import_report_mode import DashboardItemPatchObjectImportReportMode
from ...models.dashboard_item_patch_object_import_strategy import DashboardItemPatchObjectImportStrategy
from ...models.dashboard_item_patch_object_preheat_mode import DashboardItemPatchObjectPreheatMode
from ...models.dashboard_item_patch_object_root_junction import DashboardItemPatchObjectRootJunction
from ...models.dashboard_item_patch_object_user_override_mode import DashboardItemPatchObjectUserOverrideMode
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[Unset, DashboardItemPatchObjectAtomicMode] = DashboardItemPatchObjectAtomicMode.ALL,
    flush_mode: Union[Unset, DashboardItemPatchObjectFlushMode] = DashboardItemPatchObjectFlushMode.AUTO,
    identifier: Union[Unset, DashboardItemPatchObjectIdentifier] = DashboardItemPatchObjectIdentifier.UID,
    import_mode: Union[Unset, DashboardItemPatchObjectImportMode] = DashboardItemPatchObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, DashboardItemPatchObjectImportReportMode
    ] = DashboardItemPatchObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, DashboardItemPatchObjectImportStrategy
    ] = DashboardItemPatchObjectImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, DashboardItemPatchObjectPreheatMode] = DashboardItemPatchObjectPreheatMode.REFERENCE,
    root_junction: Union[Unset, DashboardItemPatchObjectRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, DashboardItemPatchObjectUserOverrideMode
    ] = DashboardItemPatchObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, DashboardItemPatchObjectAtomicMode]):  Default:
            DashboardItemPatchObjectAtomicMode.ALL.
        flush_mode (Union[Unset, DashboardItemPatchObjectFlushMode]):  Default:
            DashboardItemPatchObjectFlushMode.AUTO.
        identifier (Union[Unset, DashboardItemPatchObjectIdentifier]):  Default:
            DashboardItemPatchObjectIdentifier.UID.
        import_mode (Union[Unset, DashboardItemPatchObjectImportMode]):  Default:
            DashboardItemPatchObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, DashboardItemPatchObjectImportReportMode]):  Default:
            DashboardItemPatchObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, DashboardItemPatchObjectImportStrategy]):  Default:
            DashboardItemPatchObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, DashboardItemPatchObjectPreheatMode]):  Default:
            DashboardItemPatchObjectPreheatMode.REFERENCE.
        root_junction (Union[Unset, DashboardItemPatchObjectRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, DashboardItemPatchObjectUserOverrideMode]):  Default:
            DashboardItemPatchObjectUserOverrideMode.NONE.
        body (JsonPatch):
