...
from ...models.legend_set_get_object_gistget_object_gist_as_csv_auto import LegendSetGetObjectGistgetObjectGistAsCsvAuto
from ...models.legend_set_get_object_gistget_object_gist_as_csv_response_200 import (
    LegendSetGetObjectGistgetObjectGistAsCsvResponse200,
)
from ...models.legend_set_get_object_gistget_object_gist_as_csv_root_junction import (
    LegendSetGetObjectGistgetObjectGistAsCsvRootJunction,
)
...
def _get_kwargs(
    ...
    *,
    ...
    auto: Union[Unset, LegendSetGetObjectGistgetObjectGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, LegendSetGetObjectGistgetObjectGistAsCsvRootJunction
    ] = LegendSetGetObjectGistgetObjectGistAsCsvRootJunction.AND,
...
) -> Optional[Union[LegendSetGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]]:
    if response.status_code == 200:
        response_200 = LegendSetGetObjectGistgetObjectGistAsCsvResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[LegendSetGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, LegendSetGetObjectGistgetObjectGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, LegendSetGetObjectGistgetObjectGistAsCsvRootJunction]):
            Default: LegendSetGetObjectGistgetObjectGistAsCsvRootJunction.AND.
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[LegendSetGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]
    """
