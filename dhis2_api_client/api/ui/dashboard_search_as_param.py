...
from ...models.dashboard_search_as_param_max_item import DashboardSearchAsParamMaxItem
...
def _get_kwargs(
    *,
    ...
    max_: Union[Unset, list[DashboardSearchAsParamMaxItem]] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        max_ (Union[Unset, list[DashboardSearchAsParamMaxItem]]):
