...
from ...models.dashboard_item_get_object_list_gist_as_csv_auto import DashboardItemGetObjectListGistAsCsvAuto
from ...models.dashboard_item_get_object_list_gist_as_csv_root_junction import (
    DashboardItemGetObjectListGistAsCsvRootJunction,
)
...
def _get_kwargs(
    *,
    ...
    auto: Union[Unset, DashboardItemGetObjectListGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, DashboardItemGetObjectListGistAsCsvRootJunction
    ] = DashboardItemGetObjectListGistAsCsvRootJunction.AND,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        auto (Union[Unset, DashboardItemGetObjectListGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, DashboardItemGetObjectListGistAsCsvRootJunction]):  Default:
            DashboardItemGetObjectListGistAsCsvRootJunction.AND.
