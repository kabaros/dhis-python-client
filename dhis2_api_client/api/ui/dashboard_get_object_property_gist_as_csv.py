...
from ...models.dashboard_get_object_property_gist_as_csv_auto import DashboardGetObjectPropertyGistAsCsvAuto
from ...models.dashboard_get_object_property_gist_as_csv_property import DashboardGetObjectPropertyGistAsCsvProperty
from ...models.dashboard_get_object_property_gist_as_csv_root_junction import (
    DashboardGetObjectPropertyGistAsCsvRootJunction,
)
...
def _get_kwargs(
    uid: str,
    property_: DashboardGetObjectPropertyGistAsCsvProperty,
    *,
    absolute_urls: Union[Unset, bool] = False,
    auto: Union[Unset, DashboardGetObjectPropertyGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, DashboardGetObjectPropertyGistAsCsvRootJunction
    ] = DashboardGetObjectPropertyGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/dashboards/{uid}/{property_}/gist.csv",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, DashboardGetObjectPropertyGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, DashboardGetObjectPropertyGistAsCsvRootJunction]):  Default:
            DashboardGetObjectPropertyGistAsCsvRootJunction.AND.
