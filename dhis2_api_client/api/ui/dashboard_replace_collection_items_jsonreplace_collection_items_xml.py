...
from ...models.dashboard_replace_collection_items_jsonreplace_collection_items_xml_property import (
    DashboardReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: DashboardReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
    *,
