...
from ...models.dashboard_item_replace_collection_items_jsonreplace_collection_items_xml_property import (
    DashboardItemReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: DashboardItemReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
    *,
