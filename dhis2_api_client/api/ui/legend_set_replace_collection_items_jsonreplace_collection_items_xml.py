...
from ...models.legend_set_replace_collection_items_jsonreplace_collection_items_xml_property import (
    LegendSetReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: LegendSetReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
    *,
