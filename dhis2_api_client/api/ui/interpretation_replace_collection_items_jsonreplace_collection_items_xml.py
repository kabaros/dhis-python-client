...
from ...models.interpretation_replace_collection_items_jsonreplace_collection_items_xml_property import (
    InterpretationReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: InterpretationReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
    *,
