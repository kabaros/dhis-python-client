...
from ...models.dashboard_item_bulk_sharing_atomic_mode import DashboardItemBulkSharingAtomicMode
from ...models.dashboard_item_bulk_sharing_flush_mode import DashboardItemBulkSharingFlushMode
from ...models.dashboard_item_bulk_sharing_identifier import DashboardItemBulkSharingIdentifier
from ...models.dashboard_item_bulk_sharing_import_mode import DashboardItemBulkSharingImportMode
from ...models.dashboard_item_bulk_sharing_import_report_mode import DashboardItemBulkSharingImportReportMode
from ...models.dashboard_item_bulk_sharing_import_strategy import DashboardItemBulkSharingImportStrategy
from ...models.dashboard_item_bulk_sharing_preheat_mode import DashboardItemBulkSharingPreheatMode
from ...models.dashboard_item_bulk_sharing_root_junction import DashboardItemBulkSharingRootJunction
from ...models.dashboard_item_bulk_sharing_user_override_mode import DashboardItemBulkSharingUserOverrideMode
...
def _get_kwargs(
    *,
    ...
    atomic_mode: Union[Unset, DashboardItemBulkSharingAtomicMode] = DashboardItemBulkSharingAtomicMode.ALL,
    flush_mode: Union[Unset, DashboardItemBulkSharingFlushMode] = DashboardItemBulkSharingFlushMode.AUTO,
    identifier: Union[Unset, DashboardItemBulkSharingIdentifier] = DashboardItemBulkSharingIdentifier.UID,
    import_mode: Union[Unset, DashboardItemBulkSharingImportMode] = DashboardItemBulkSharingImportMode.COMMIT,
    import_report_mode: Union[
        Unset, DashboardItemBulkSharingImportReportMode
    ] = DashboardItemBulkSharingImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, DashboardItemBulkSharingImportStrategy
    ] = DashboardItemBulkSharingImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, DashboardItemBulkSharingPreheatMode] = DashboardItemBulkSharingPreheatMode.REFERENCE,
    root_junction: Union[Unset, DashboardItemBulkSharingRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, DashboardItemBulkSharingUserOverrideMode
    ] = DashboardItemBulkSharingUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, DashboardItemBulkSharingAtomicMode]):  Default:
            DashboardItemBulkSharingAtomicMode.ALL.
        flush_mode (Union[Unset, DashboardItemBulkSharingFlushMode]):  Default:
            DashboardItemBulkSharingFlushMode.AUTO.
        identifier (Union[Unset, DashboardItemBulkSharingIdentifier]):  Default:
            DashboardItemBulkSharingIdentifier.UID.
        import_mode (Union[Unset, DashboardItemBulkSharingImportMode]):  Default:
            DashboardItemBulkSharingImportMode.COMMIT.
        import_report_mode (Union[Unset, DashboardItemBulkSharingImportReportMode]):  Default:
            DashboardItemBulkSharingImportReportMode.ERRORS.
        import_strategy (Union[Unset, DashboardItemBulkSharingImportStrategy]):  Default:
            DashboardItemBulkSharingImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, DashboardItemBulkSharingPreheatMode]):  Default:
            DashboardItemBulkSharingPreheatMode.REFERENCE.
        root_junction (Union[Unset, DashboardItemBulkSharingRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, DashboardItemBulkSharingUserOverrideMode]):  Default:
            DashboardItemBulkSharingUserOverrideMode.NONE.
        body (BulkJsonPatch):
