...
from ...models.dashboard_item_add_collection_items_jsonadd_collection_items_xml_property import (
    DashboardItemAddCollectionItemsJsonaddCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: DashboardItemAddCollectionItemsJsonaddCollectionItemsXmlProperty,
    *,
