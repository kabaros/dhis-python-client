...
from ...models.interpretation_delete_collection_items_jsondelete_collection_items_xml_property import (
    InterpretationDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: InterpretationDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
    *,
