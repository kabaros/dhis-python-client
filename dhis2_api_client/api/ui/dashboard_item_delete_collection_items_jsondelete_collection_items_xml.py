...
from ...models.dashboard_item_delete_collection_items_jsondelete_collection_items_xml_property import (
    DashboardItemDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: DashboardItemDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
    *,
