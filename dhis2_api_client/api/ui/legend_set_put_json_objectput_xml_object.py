...
from ...models.legend_set_put_json_objectput_xml_object_atomic_mode import LegendSetPutJsonObjectputXmlObjectAtomicMode
from ...models.legend_set_put_json_objectput_xml_object_flush_mode import LegendSetPutJsonObjectputXmlObjectFlushMode
from ...models.legend_set_put_json_objectput_xml_object_identifier import LegendSetPutJsonObjectputXmlObjectIdentifier
from ...models.legend_set_put_json_objectput_xml_object_import_mode import LegendSetPutJsonObjectputXmlObjectImportMode
from ...models.legend_set_put_json_objectput_xml_object_import_report_mode import (
    LegendSetPutJsonObjectputXmlObjectImportReportMode,
)
from ...models.legend_set_put_json_objectput_xml_object_import_strategy import (
    LegendSetPutJsonObjectputXmlObjectImportStrategy,
)
from ...models.legend_set_put_json_objectput_xml_object_preheat_mode import (
    LegendSetPutJsonObjectputXmlObjectPreheatMode,
)
from ...models.legend_set_put_json_objectput_xml_object_user_override_mode import (
    LegendSetPutJsonObjectputXmlObjectUserOverrideMode,
)
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[
        Unset, LegendSetPutJsonObjectputXmlObjectAtomicMode
    ] = LegendSetPutJsonObjectputXmlObjectAtomicMode.ALL,
    flush_mode: Union[
        Unset, LegendSetPutJsonObjectputXmlObjectFlushMode
    ] = LegendSetPutJsonObjectputXmlObjectFlushMode.AUTO,
    identifier: Union[
        Unset, LegendSetPutJsonObjectputXmlObjectIdentifier
    ] = LegendSetPutJsonObjectputXmlObjectIdentifier.UID,
    import_mode: Union[
        Unset, LegendSetPutJsonObjectputXmlObjectImportMode
    ] = LegendSetPutJsonObjectputXmlObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, LegendSetPutJsonObjectputXmlObjectImportReportMode
    ] = LegendSetPutJsonObjectputXmlObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, LegendSetPutJsonObjectputXmlObjectImportStrategy
    ] = LegendSetPutJsonObjectputXmlObjectImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    preheat_mode: Union[
        Unset, LegendSetPutJsonObjectputXmlObjectPreheatMode
    ] = LegendSetPutJsonObjectputXmlObjectPreheatMode.REFERENCE,
    ...
    user_override_mode: Union[
        Unset, LegendSetPutJsonObjectputXmlObjectUserOverrideMode
    ] = LegendSetPutJsonObjectputXmlObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, LegendSetPutJsonObjectputXmlObjectAtomicMode]):  Default:
            LegendSetPutJsonObjectputXmlObjectAtomicMode.ALL.
        flush_mode (Union[Unset, LegendSetPutJsonObjectputXmlObjectFlushMode]):  Default:
            LegendSetPutJsonObjectputXmlObjectFlushMode.AUTO.
        identifier (Union[Unset, LegendSetPutJsonObjectputXmlObjectIdentifier]):  Default:
            LegendSetPutJsonObjectputXmlObjectIdentifier.UID.
        import_mode (Union[Unset, LegendSetPutJsonObjectputXmlObjectImportMode]):  Default:
            LegendSetPutJsonObjectputXmlObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, LegendSetPutJsonObjectputXmlObjectImportReportMode]):
            Default: LegendSetPutJsonObjectputXmlObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, LegendSetPutJsonObjectputXmlObjectImportStrategy]):
            Default: LegendSetPutJsonObjectputXmlObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, LegendSetPutJsonObjectputXmlObjectPreheatMode]):  Default:
            LegendSetPutJsonObjectputXmlObjectPreheatMode.REFERENCE.
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, LegendSetPutJsonObjectputXmlObjectUserOverrideMode]):
            Default: LegendSetPutJsonObjectputXmlObjectUserOverrideMode.NONE.
        body (LegendSet):
