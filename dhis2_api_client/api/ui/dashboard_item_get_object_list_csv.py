...
from ...models.dashboard_item_get_object_list_csv_root_junction import DashboardItemGetObjectListCsvRootJunction
...
def _get_kwargs(
    *,
    ...
    root_junction: Union[Unset, DashboardItemGetObjectListCsvRootJunction] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/dashboardItems/#getObjectListCsv",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, DashboardItemGetObjectListCsvRootJunction]):
