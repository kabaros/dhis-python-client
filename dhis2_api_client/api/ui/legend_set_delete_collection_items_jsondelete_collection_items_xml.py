...
from ...models.legend_set_delete_collection_items_jsondelete_collection_items_xml_property import (
    LegendSetDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: LegendSetDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
    *,
