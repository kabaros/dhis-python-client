...
from ...models.interpretation_add_collection_items_jsonadd_collection_items_xml_property import (
    InterpretationAddCollectionItemsJsonaddCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: InterpretationAddCollectionItemsJsonaddCollectionItemsXmlProperty,
    *,
