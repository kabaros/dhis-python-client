...
from ...models.interpretation_delete_collection_item_property import InterpretationDeleteCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: InterpretationDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/interpretations/{uid}/{property_}/{item_id}",
    }
