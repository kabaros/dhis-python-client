...
from ...models.interpretation_patch_object_atomic_mode import InterpretationPatchObjectAtomicMode
from ...models.interpretation_patch_object_flush_mode import InterpretationPatchObjectFlushMode
from ...models.interpretation_patch_object_identifier import InterpretationPatchObjectIdentifier
from ...models.interpretation_patch_object_import_mode import InterpretationPatchObjectImportMode
from ...models.interpretation_patch_object_import_report_mode import InterpretationPatchObjectImportReportMode
from ...models.interpretation_patch_object_import_strategy import InterpretationPatchObjectImportStrategy
from ...models.interpretation_patch_object_preheat_mode import InterpretationPatchObjectPreheatMode
from ...models.interpretation_patch_object_root_junction import InterpretationPatchObjectRootJunction
from ...models.interpretation_patch_object_user_override_mode import InterpretationPatchObjectUserOverrideMode
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[Unset, InterpretationPatchObjectAtomicMode] = InterpretationPatchObjectAtomicMode.ALL,
    flush_mode: Union[Unset, InterpretationPatchObjectFlushMode] = InterpretationPatchObjectFlushMode.AUTO,
    identifier: Union[Unset, InterpretationPatchObjectIdentifier] = InterpretationPatchObjectIdentifier.UID,
    import_mode: Union[Unset, InterpretationPatchObjectImportMode] = InterpretationPatchObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, InterpretationPatchObjectImportReportMode
    ] = InterpretationPatchObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, InterpretationPatchObjectImportStrategy
    ] = InterpretationPatchObjectImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, InterpretationPatchObjectPreheatMode] = InterpretationPatchObjectPreheatMode.REFERENCE,
    root_junction: Union[Unset, InterpretationPatchObjectRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, InterpretationPatchObjectUserOverrideMode
    ] = InterpretationPatchObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        uid (str): A UID for an Interpretation object
            (Java name `org.hisp.dhis.interpretation.Interpretation`) Example: pd0uU9kk8Gc.
        async_ (Union[Unset, bool]):  Default: False.
        atomic_mode (Union[Unset, InterpretationPatchObjectAtomicMode]):  Default:
            InterpretationPatchObjectAtomicMode.ALL.
        flush_mode (Union[Unset, InterpretationPatchObjectFlushMode]):  Default:
            InterpretationPatchObjectFlushMode.AUTO.
        identifier (Union[Unset, InterpretationPatchObjectIdentifier]):  Default:
            InterpretationPatchObjectIdentifier.UID.
        import_mode (Union[Unset, InterpretationPatchObjectImportMode]):  Default:
            InterpretationPatchObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, InterpretationPatchObjectImportReportMode]):  Default:
            InterpretationPatchObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, InterpretationPatchObjectImportStrategy]):  Default:
            InterpretationPatchObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, InterpretationPatchObjectPreheatMode]):  Default:
            InterpretationPatchObjectPreheatMode.REFERENCE.
        root_junction (Union[Unset, InterpretationPatchObjectRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, InterpretationPatchObjectUserOverrideMode]):  Default:
            InterpretationPatchObjectUserOverrideMode.NONE.
        body (JsonPatch):
