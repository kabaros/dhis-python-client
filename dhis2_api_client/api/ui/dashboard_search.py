...
from ...models.dashboard_search_max_item import DashboardSearchMaxItem
...
def _get_kwargs(
    ...
    *,
    ...
    max_: Union[Unset, list[DashboardSearchMaxItem]] = UNSET,
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        max_ (Union[Unset, list[DashboardSearchMaxItem]]):
