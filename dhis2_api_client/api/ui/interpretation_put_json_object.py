...
from ...models.interpretation_put_json_object_atomic_mode import InterpretationPutJsonObjectAtomicMode
from ...models.interpretation_put_json_object_flush_mode import InterpretationPutJsonObjectFlushMode
from ...models.interpretation_put_json_object_identifier import InterpretationPutJsonObjectIdentifier
from ...models.interpretation_put_json_object_import_mode import InterpretationPutJsonObjectImportMode
from ...models.interpretation_put_json_object_import_report_mode import InterpretationPutJsonObjectImportReportMode
from ...models.interpretation_put_json_object_import_strategy import InterpretationPutJsonObjectImportStrategy
from ...models.interpretation_put_json_object_preheat_mode import InterpretationPutJsonObjectPreheatMode
from ...models.interpretation_put_json_object_user_override_mode import InterpretationPutJsonObjectUserOverrideMode
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[Unset, InterpretationPutJsonObjectAtomicMode] = InterpretationPutJsonObjectAtomicMode.ALL,
    flush_mode: Union[Unset, InterpretationPutJsonObjectFlushMode] = InterpretationPutJsonObjectFlushMode.AUTO,
    identifier: Union[Unset, InterpretationPutJsonObjectIdentifier] = InterpretationPutJsonObjectIdentifier.UID,
    import_mode: Union[Unset, InterpretationPutJsonObjectImportMode] = InterpretationPutJsonObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, InterpretationPutJsonObjectImportReportMode
    ] = InterpretationPutJsonObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, InterpretationPutJsonObjectImportStrategy
    ] = InterpretationPutJsonObjectImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    preheat_mode: Union[
        Unset, InterpretationPutJsonObjectPreheatMode
    ] = InterpretationPutJsonObjectPreheatMode.REFERENCE,
    ...
    user_override_mode: Union[
        Unset, InterpretationPutJsonObjectUserOverrideMode
    ] = InterpretationPutJsonObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": f"/interpretations/{uid}#putJsonObject",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, InterpretationPutJsonObjectAtomicMode]):  Default:
            InterpretationPutJsonObjectAtomicMode.ALL.
        flush_mode (Union[Unset, InterpretationPutJsonObjectFlushMode]):  Default:
            InterpretationPutJsonObjectFlushMode.AUTO.
        identifier (Union[Unset, InterpretationPutJsonObjectIdentifier]):  Default:
            InterpretationPutJsonObjectIdentifier.UID.
        import_mode (Union[Unset, InterpretationPutJsonObjectImportMode]):  Default:
            InterpretationPutJsonObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, InterpretationPutJsonObjectImportReportMode]):  Default:
            InterpretationPutJsonObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, InterpretationPutJsonObjectImportStrategy]):  Default:
            InterpretationPutJsonObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, InterpretationPutJsonObjectPreheatMode]):  Default:
            InterpretationPutJsonObjectPreheatMode.REFERENCE.
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, InterpretationPutJsonObjectUserOverrideMode]):  Default:
            InterpretationPutJsonObjectUserOverrideMode.NONE.
        body (Interpretation):
