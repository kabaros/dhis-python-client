...
from ...models.interpretation_add_collection_item_property import InterpretationAddCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: InterpretationAddCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
