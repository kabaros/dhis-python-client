...
from ...models.dashboard_item_delete_collection_item_property import DashboardItemDeleteCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: DashboardItemDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/dashboardItems/{uid}/{property_}/{item_id}",
    }
