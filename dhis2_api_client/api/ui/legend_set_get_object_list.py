...
from ...models.legend_set_get_object_list_response_200 import LegendSetGetObjectListResponse200
from ...models.legend_set_get_object_list_root_junction import LegendSetGetObjectListRootJunction
...
def _get_kwargs(
    *,
    ...
    root_junction: Union[Unset, LegendSetGetObjectListRootJunction] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
) -> Optional[Union[LegendSetGetObjectListResponse200, WebMessage]]:
    if response.status_code == 200:
        response_200 = LegendSetGetObjectListResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[LegendSetGetObjectListResponse200, WebMessage]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, LegendSetGetObjectListRootJunction]):
...
def sync(
    *,
    ...
    Returns:
        Union[LegendSetGetObjectListResponse200, WebMessage]
    """
