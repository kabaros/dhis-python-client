...
from ...models.user_group_delete_collection_item_property import UserGroupDeleteCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: UserGroupDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/userGroups/{uid}/{property_}/{item_id}",
    }
