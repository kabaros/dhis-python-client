...
from ...models.user_add_collection_items_jsonadd_collection_items_xml_property import (
    UserAddCollectionItemsJsonaddCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: UserAddCollectionItemsJsonaddCollectionItemsXmlProperty,
    *,
