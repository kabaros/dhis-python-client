...
from ...models.user_group_replace_collection_items_jsonreplace_collection_items_xml_property import (
    UserGroupReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: UserGroupReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
    *,
