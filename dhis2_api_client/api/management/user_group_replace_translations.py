...
from ...models.user_group_replace_translations_body import UserGroupReplaceTranslationsBody
...
def _get_kwargs(
    uid: str,
    *,
    body: UserGroupReplaceTranslationsBody,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": f"/userGroups/{uid}/translations",
    }
