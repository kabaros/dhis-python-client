...
from ...models.user_group_delete_collection_items_jsondelete_collection_items_xml_property import (
    UserGroupDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: UserGroupDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
    *,
