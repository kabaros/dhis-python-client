...
from ...models.user_role_add_collection_items_jsonadd_collection_items_xml_property import (
    UserRoleAddCollectionItemsJsonaddCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: UserRoleAddCollectionItemsJsonaddCollectionItemsXmlProperty,
    *,
