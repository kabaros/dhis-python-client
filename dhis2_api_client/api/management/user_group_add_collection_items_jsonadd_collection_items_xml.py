...
from ...models.user_group_add_collection_items_jsonadd_collection_items_xml_property import (
    UserGroupAddCollectionItemsJsonaddCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: UserGroupAddCollectionItemsJsonaddCollectionItemsXmlProperty,
    *,
