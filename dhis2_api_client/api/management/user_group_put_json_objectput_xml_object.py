...
from ...models.user_group_put_json_objectput_xml_object_atomic_mode import UserGroupPutJsonObjectputXmlObjectAtomicMode
from ...models.user_group_put_json_objectput_xml_object_flush_mode import UserGroupPutJsonObjectputXmlObjectFlushMode
from ...models.user_group_put_json_objectput_xml_object_identifier import UserGroupPutJsonObjectputXmlObjectIdentifier
from ...models.user_group_put_json_objectput_xml_object_import_mode import UserGroupPutJsonObjectputXmlObjectImportMode
from ...models.user_group_put_json_objectput_xml_object_import_report_mode import (
    UserGroupPutJsonObjectputXmlObjectImportReportMode,
)
from ...models.user_group_put_json_objectput_xml_object_import_strategy import (
    UserGroupPutJsonObjectputXmlObjectImportStrategy,
)
from ...models.user_group_put_json_objectput_xml_object_preheat_mode import (
    UserGroupPutJsonObjectputXmlObjectPreheatMode,
)
from ...models.user_group_put_json_objectput_xml_object_user_override_mode import (
    UserGroupPutJsonObjectputXmlObjectUserOverrideMode,
)
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[
        Unset, UserGroupPutJsonObjectputXmlObjectAtomicMode
    ] = UserGroupPutJsonObjectputXmlObjectAtomicMode.ALL,
    flush_mode: Union[
        Unset, UserGroupPutJsonObjectputXmlObjectFlushMode
    ] = UserGroupPutJsonObjectputXmlObjectFlushMode.AUTO,
    identifier: Union[
        Unset, UserGroupPutJsonObjectputXmlObjectIdentifier
    ] = UserGroupPutJsonObjectputXmlObjectIdentifier.UID,
    import_mode: Union[
        Unset, UserGroupPutJsonObjectputXmlObjectImportMode
    ] = UserGroupPutJsonObjectputXmlObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, UserGroupPutJsonObjectputXmlObjectImportReportMode
    ] = UserGroupPutJsonObjectputXmlObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, UserGroupPutJsonObjectputXmlObjectImportStrategy
    ] = UserGroupPutJsonObjectputXmlObjectImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    preheat_mode: Union[
        Unset, UserGroupPutJsonObjectputXmlObjectPreheatMode
    ] = UserGroupPutJsonObjectputXmlObjectPreheatMode.REFERENCE,
    ...
    user_override_mode: Union[
        Unset, UserGroupPutJsonObjectputXmlObjectUserOverrideMode
    ] = UserGroupPutJsonObjectputXmlObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        uid (str): A UID for an UserGroup object
            (Java name `org.hisp.dhis.user.UserGroup`) Example: wd5C82cv3p6.
        async_ (Union[Unset, bool]):  Default: False.
        atomic_mode (Union[Unset, UserGroupPutJsonObjectputXmlObjectAtomicMode]):  Default:
            UserGroupPutJsonObjectputXmlObjectAtomicMode.ALL.
        flush_mode (Union[Unset, UserGroupPutJsonObjectputXmlObjectFlushMode]):  Default:
            UserGroupPutJsonObjectputXmlObjectFlushMode.AUTO.
        identifier (Union[Unset, UserGroupPutJsonObjectputXmlObjectIdentifier]):  Default:
            UserGroupPutJsonObjectputXmlObjectIdentifier.UID.
        import_mode (Union[Unset, UserGroupPutJsonObjectputXmlObjectImportMode]):  Default:
            UserGroupPutJsonObjectputXmlObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, UserGroupPutJsonObjectputXmlObjectImportReportMode]):
            Default: UserGroupPutJsonObjectputXmlObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, UserGroupPutJsonObjectputXmlObjectImportStrategy]):
            Default: UserGroupPutJsonObjectputXmlObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, UserGroupPutJsonObjectputXmlObjectPreheatMode]):  Default:
            UserGroupPutJsonObjectputXmlObjectPreheatMode.REFERENCE.
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, UserGroupPutJsonObjectputXmlObjectUserOverrideMode]):
            Default: UserGroupPutJsonObjectputXmlObjectUserOverrideMode.NONE.
        body (UserGroup):
