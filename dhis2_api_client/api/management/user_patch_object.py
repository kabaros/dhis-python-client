...
from ...models.user_patch_object_atomic_mode import UserPatchObjectAtomicMode
from ...models.user_patch_object_flush_mode import UserPatchObjectFlushMode
from ...models.user_patch_object_identifier import UserPatchObjectIdentifier
from ...models.user_patch_object_import_mode import UserPatchObjectImportMode
from ...models.user_patch_object_import_report_mode import UserPatchObjectImportReportMode
from ...models.user_patch_object_import_strategy import UserPatchObjectImportStrategy
from ...models.user_patch_object_preheat_mode import UserPatchObjectPreheatMode
from ...models.user_patch_object_root_junction import UserPatchObjectRootJunction
from ...models.user_patch_object_user_override_mode import UserPatchObjectUserOverrideMode
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[Unset, UserPatchObjectAtomicMode] = UserPatchObjectAtomicMode.ALL,
    flush_mode: Union[Unset, UserPatchObjectFlushMode] = UserPatchObjectFlushMode.AUTO,
    identifier: Union[Unset, UserPatchObjectIdentifier] = UserPatchObjectIdentifier.UID,
    import_mode: Union[Unset, UserPatchObjectImportMode] = UserPatchObjectImportMode.COMMIT,
    import_report_mode: Union[Unset, UserPatchObjectImportReportMode] = UserPatchObjectImportReportMode.ERRORS,
    import_strategy: Union[Unset, UserPatchObjectImportStrategy] = UserPatchObjectImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, UserPatchObjectPreheatMode] = UserPatchObjectPreheatMode.REFERENCE,
    root_junction: Union[Unset, UserPatchObjectRootJunction] = UNSET,
    skip_sharing: Union[Unset, bool] = False,
    skip_translation: Union[Unset, bool] = False,
    skip_validation: Union[Unset, bool] = False,
    user: Union[Unset, str] = UNSET,
    user_override_mode: Union[Unset, UserPatchObjectUserOverrideMode] = UserPatchObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        uid (str): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        async_ (Union[Unset, bool]):  Default: False.
        atomic_mode (Union[Unset, UserPatchObjectAtomicMode]):  Default:
            UserPatchObjectAtomicMode.ALL.
        flush_mode (Union[Unset, UserPatchObjectFlushMode]):  Default:
            UserPatchObjectFlushMode.AUTO.
        identifier (Union[Unset, UserPatchObjectIdentifier]):  Default:
            UserPatchObjectIdentifier.UID.
        import_mode (Union[Unset, UserPatchObjectImportMode]):  Default:
            UserPatchObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, UserPatchObjectImportReportMode]):  Default:
            UserPatchObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, UserPatchObjectImportStrategy]):  Default:
            UserPatchObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, UserPatchObjectPreheatMode]):  Default:
            UserPatchObjectPreheatMode.REFERENCE.
        root_junction (Union[Unset, UserPatchObjectRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, UserPatchObjectUserOverrideMode]):  Default:
            UserPatchObjectUserOverrideMode.NONE.
        body (JsonPatch):
