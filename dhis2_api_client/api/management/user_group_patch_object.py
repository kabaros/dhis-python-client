...
from ...models.user_group_patch_object_atomic_mode import UserGroupPatchObjectAtomicMode
from ...models.user_group_patch_object_flush_mode import UserGroupPatchObjectFlushMode
from ...models.user_group_patch_object_identifier import UserGroupPatchObjectIdentifier
from ...models.user_group_patch_object_import_mode import UserGroupPatchObjectImportMode
from ...models.user_group_patch_object_import_report_mode import UserGroupPatchObjectImportReportMode
from ...models.user_group_patch_object_import_strategy import UserGroupPatchObjectImportStrategy
from ...models.user_group_patch_object_preheat_mode import UserGroupPatchObjectPreheatMode
from ...models.user_group_patch_object_root_junction import UserGroupPatchObjectRootJunction
from ...models.user_group_patch_object_user_override_mode import UserGroupPatchObjectUserOverrideMode
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[Unset, UserGroupPatchObjectAtomicMode] = UserGroupPatchObjectAtomicMode.ALL,
    flush_mode: Union[Unset, UserGroupPatchObjectFlushMode] = UserGroupPatchObjectFlushMode.AUTO,
    identifier: Union[Unset, UserGroupPatchObjectIdentifier] = UserGroupPatchObjectIdentifier.UID,
    import_mode: Union[Unset, UserGroupPatchObjectImportMode] = UserGroupPatchObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, UserGroupPatchObjectImportReportMode
    ] = UserGroupPatchObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, UserGroupPatchObjectImportStrategy
    ] = UserGroupPatchObjectImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, UserGroupPatchObjectPreheatMode] = UserGroupPatchObjectPreheatMode.REFERENCE,
    root_junction: Union[Unset, UserGroupPatchObjectRootJunction] = UNSET,
    skip_sharing: Union[Unset, bool] = False,
    skip_translation: Union[Unset, bool] = False,
    skip_validation: Union[Unset, bool] = False,
    user: Union[Unset, str] = UNSET,
    user_override_mode: Union[Unset, UserGroupPatchObjectUserOverrideMode] = UserGroupPatchObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, UserGroupPatchObjectAtomicMode]):  Default:
            UserGroupPatchObjectAtomicMode.ALL.
        flush_mode (Union[Unset, UserGroupPatchObjectFlushMode]):  Default:
            UserGroupPatchObjectFlushMode.AUTO.
        identifier (Union[Unset, UserGroupPatchObjectIdentifier]):  Default:
            UserGroupPatchObjectIdentifier.UID.
        import_mode (Union[Unset, UserGroupPatchObjectImportMode]):  Default:
            UserGroupPatchObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, UserGroupPatchObjectImportReportMode]):  Default:
            UserGroupPatchObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, UserGroupPatchObjectImportStrategy]):  Default:
            UserGroupPatchObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, UserGroupPatchObjectPreheatMode]):  Default:
            UserGroupPatchObjectPreheatMode.REFERENCE.
        root_junction (Union[Unset, UserGroupPatchObjectRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, UserGroupPatchObjectUserOverrideMode]):  Default:
            UserGroupPatchObjectUserOverrideMode.NONE.
        body (JsonPatch):
