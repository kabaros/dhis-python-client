...
from ...models.user_role_patch_object_atomic_mode import UserRolePatchObjectAtomicMode
from ...models.user_role_patch_object_flush_mode import UserRolePatchObjectFlushMode
from ...models.user_role_patch_object_identifier import UserRolePatchObjectIdentifier
from ...models.user_role_patch_object_import_mode import UserRolePatchObjectImportMode
from ...models.user_role_patch_object_import_report_mode import UserRolePatchObjectImportReportMode
from ...models.user_role_patch_object_import_strategy import UserRolePatchObjectImportStrategy
from ...models.user_role_patch_object_preheat_mode import UserRolePatchObjectPreheatMode
from ...models.user_role_patch_object_root_junction import UserRolePatchObjectRootJunction
from ...models.user_role_patch_object_user_override_mode import UserRolePatchObjectUserOverrideMode
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[Unset, UserRolePatchObjectAtomicMode] = UserRolePatchObjectAtomicMode.ALL,
    flush_mode: Union[Unset, UserRolePatchObjectFlushMode] = UserRolePatchObjectFlushMode.AUTO,
    identifier: Union[Unset, UserRolePatchObjectIdentifier] = UserRolePatchObjectIdentifier.UID,
    import_mode: Union[Unset, UserRolePatchObjectImportMode] = UserRolePatchObjectImportMode.COMMIT,
    import_report_mode: Union[Unset, UserRolePatchObjectImportReportMode] = UserRolePatchObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, UserRolePatchObjectImportStrategy
    ] = UserRolePatchObjectImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, UserRolePatchObjectPreheatMode] = UserRolePatchObjectPreheatMode.REFERENCE,
    root_junction: Union[Unset, UserRolePatchObjectRootJunction] = UNSET,
    skip_sharing: Union[Unset, bool] = False,
    skip_translation: Union[Unset, bool] = False,
    skip_validation: Union[Unset, bool] = False,
    user: Union[Unset, str] = UNSET,
    user_override_mode: Union[Unset, UserRolePatchObjectUserOverrideMode] = UserRolePatchObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, UserRolePatchObjectAtomicMode]):  Default:
            UserRolePatchObjectAtomicMode.ALL.
        flush_mode (Union[Unset, UserRolePatchObjectFlushMode]):  Default:
            UserRolePatchObjectFlushMode.AUTO.
        identifier (Union[Unset, UserRolePatchObjectIdentifier]):  Default:
            UserRolePatchObjectIdentifier.UID.
        import_mode (Union[Unset, UserRolePatchObjectImportMode]):  Default:
            UserRolePatchObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, UserRolePatchObjectImportReportMode]):  Default:
            UserRolePatchObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, UserRolePatchObjectImportStrategy]):  Default:
            UserRolePatchObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, UserRolePatchObjectPreheatMode]):  Default:
            UserRolePatchObjectPreheatMode.REFERENCE.
        root_junction (Union[Unset, UserRolePatchObjectRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, UserRolePatchObjectUserOverrideMode]):  Default:
            UserRolePatchObjectUserOverrideMode.NONE.
        body (JsonPatch):
