...
from ...models.user_delete_collection_item_property import UserDeleteCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: UserDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/users/{uid}/{property_}/{item_id}",
    }
