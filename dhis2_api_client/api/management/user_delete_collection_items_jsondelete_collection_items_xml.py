...
from ...models.user_delete_collection_items_jsondelete_collection_items_xml_property import (
    UserDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: UserDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
    *,
