...
from ...models.user_role_get_object_gistget_object_gist_as_csv_auto import UserRoleGetObjectGistgetObjectGistAsCsvAuto
from ...models.user_role_get_object_gistget_object_gist_as_csv_response_200 import (
    UserRoleGetObjectGistgetObjectGistAsCsvResponse200,
)
from ...models.user_role_get_object_gistget_object_gist_as_csv_root_junction import (
    UserRoleGetObjectGistgetObjectGistAsCsvRootJunction,
)
...
def _get_kwargs(
    ...
    *,
    ...
    auto: Union[Unset, UserRoleGetObjectGistgetObjectGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, UserRoleGetObjectGistgetObjectGistAsCsvRootJunction
    ] = UserRoleGetObjectGistgetObjectGistAsCsvRootJunction.AND,
...
) -> Optional[Union[UserRoleGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]]:
    if response.status_code == 200:
        response_200 = UserRoleGetObjectGistgetObjectGistAsCsvResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[UserRoleGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, UserRoleGetObjectGistgetObjectGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, UserRoleGetObjectGistgetObjectGistAsCsvRootJunction]):
            Default: UserRoleGetObjectGistgetObjectGistAsCsvRootJunction.AND.
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[UserRoleGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]
    """
