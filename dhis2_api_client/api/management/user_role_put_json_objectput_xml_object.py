...
from ...models.user_role_put_json_objectput_xml_object_atomic_mode import UserRolePutJsonObjectputXmlObjectAtomicMode
from ...models.user_role_put_json_objectput_xml_object_flush_mode import UserRolePutJsonObjectputXmlObjectFlushMode
from ...models.user_role_put_json_objectput_xml_object_identifier import UserRolePutJsonObjectputXmlObjectIdentifier
from ...models.user_role_put_json_objectput_xml_object_import_mode import UserRolePutJsonObjectputXmlObjectImportMode
from ...models.user_role_put_json_objectput_xml_object_import_report_mode import (
    UserRolePutJsonObjectputXmlObjectImportReportMode,
)
from ...models.user_role_put_json_objectput_xml_object_import_strategy import (
    UserRolePutJsonObjectputXmlObjectImportStrategy,
)
from ...models.user_role_put_json_objectput_xml_object_preheat_mode import UserRolePutJsonObjectputXmlObjectPreheatMode
from ...models.user_role_put_json_objectput_xml_object_user_override_mode import (
    UserRolePutJsonObjectputXmlObjectUserOverrideMode,
)
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[
        Unset, UserRolePutJsonObjectputXmlObjectAtomicMode
    ] = UserRolePutJsonObjectputXmlObjectAtomicMode.ALL,
    flush_mode: Union[
        Unset, UserRolePutJsonObjectputXmlObjectFlushMode
    ] = UserRolePutJsonObjectputXmlObjectFlushMode.AUTO,
    identifier: Union[
        Unset, UserRolePutJsonObjectputXmlObjectIdentifier
    ] = UserRolePutJsonObjectputXmlObjectIdentifier.UID,
    import_mode: Union[
        Unset, UserRolePutJsonObjectputXmlObjectImportMode
    ] = UserRolePutJsonObjectputXmlObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, UserRolePutJsonObjectputXmlObjectImportReportMode
    ] = UserRolePutJsonObjectputXmlObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, UserRolePutJsonObjectputXmlObjectImportStrategy
    ] = UserRolePutJsonObjectputXmlObjectImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    preheat_mode: Union[
        Unset, UserRolePutJsonObjectputXmlObjectPreheatMode
    ] = UserRolePutJsonObjectputXmlObjectPreheatMode.REFERENCE,
    ...
    user_override_mode: Union[
        Unset, UserRolePutJsonObjectputXmlObjectUserOverrideMode
    ] = UserRolePutJsonObjectputXmlObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, UserRolePutJsonObjectputXmlObjectAtomicMode]):  Default:
            UserRolePutJsonObjectputXmlObjectAtomicMode.ALL.
        flush_mode (Union[Unset, UserRolePutJsonObjectputXmlObjectFlushMode]):  Default:
            UserRolePutJsonObjectputXmlObjectFlushMode.AUTO.
        identifier (Union[Unset, UserRolePutJsonObjectputXmlObjectIdentifier]):  Default:
            UserRolePutJsonObjectputXmlObjectIdentifier.UID.
        import_mode (Union[Unset, UserRolePutJsonObjectputXmlObjectImportMode]):  Default:
            UserRolePutJsonObjectputXmlObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, UserRolePutJsonObjectputXmlObjectImportReportMode]):
            Default: UserRolePutJsonObjectputXmlObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, UserRolePutJsonObjectputXmlObjectImportStrategy]):  Default:
            UserRolePutJsonObjectputXmlObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, UserRolePutJsonObjectputXmlObjectPreheatMode]):  Default:
            UserRolePutJsonObjectputXmlObjectPreheatMode.REFERENCE.
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, UserRolePutJsonObjectputXmlObjectUserOverrideMode]):
            Default: UserRolePutJsonObjectputXmlObjectUserOverrideMode.NONE.
        body (UserRole):
