...
from ...models.user_role_replace_collection_items_jsonreplace_collection_items_xml_property import (
    UserRoleReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: UserRoleReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
    *,
