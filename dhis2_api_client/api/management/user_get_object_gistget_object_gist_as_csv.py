...
from ...models.user_get_object_gistget_object_gist_as_csv_auto import UserGetObjectGistgetObjectGistAsCsvAuto
from ...models.user_get_object_gistget_object_gist_as_csv_response_200 import (
    UserGetObjectGistgetObjectGistAsCsvResponse200,
)
from ...models.user_get_object_gistget_object_gist_as_csv_root_junction import (
    UserGetObjectGistgetObjectGistAsCsvRootJunction,
)
...
def _get_kwargs(
    ...
    *,
    ...
    auto: Union[Unset, UserGetObjectGistgetObjectGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, UserGetObjectGistgetObjectGistAsCsvRootJunction
    ] = UserGetObjectGistgetObjectGistAsCsvRootJunction.AND,
...
) -> Optional[Union[UserGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]]:
    if response.status_code == 200:
        response_200 = UserGetObjectGistgetObjectGistAsCsvResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[UserGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, UserGetObjectGistgetObjectGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, UserGetObjectGistgetObjectGistAsCsvRootJunction]):  Default:
            UserGetObjectGistgetObjectGistAsCsvRootJunction.AND.
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[UserGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]
    """
