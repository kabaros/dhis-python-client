...
from ...models.user_role_delete_collection_item_property import UserRoleDeleteCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: UserRoleDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/userRoles/{uid}/{property_}/{item_id}",
    }
