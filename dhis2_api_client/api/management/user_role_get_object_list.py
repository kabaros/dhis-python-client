...
from ...models.user_role_get_object_list_response_200 import UserRoleGetObjectListResponse200
from ...models.user_role_get_object_list_root_junction import UserRoleGetObjectListRootJunction
...
def _get_kwargs(
    *,
    ...
    root_junction: Union[Unset, UserRoleGetObjectListRootJunction] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
) -> Optional[Union[UserRoleGetObjectListResponse200, WebMessage]]:
    if response.status_code == 200:
        response_200 = UserRoleGetObjectListResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[UserRoleGetObjectListResponse200, WebMessage]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, UserRoleGetObjectListRootJunction]):
...
def sync(
    *,
    ...
    Returns:
        Union[UserRoleGetObjectListResponse200, WebMessage]
    """
