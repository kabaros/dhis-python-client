...
from ...models.user_get_object_property_gist_as_csv_auto import UserGetObjectPropertyGistAsCsvAuto
from ...models.user_get_object_property_gist_as_csv_property import UserGetObjectPropertyGistAsCsvProperty
from ...models.user_get_object_property_gist_as_csv_root_junction import UserGetObjectPropertyGistAsCsvRootJunction
...
def _get_kwargs(
    uid: str,
    property_: UserGetObjectPropertyGistAsCsvProperty,
    *,
    absolute_urls: Union[Unset, bool] = False,
    auto: Union[Unset, UserGetObjectPropertyGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, UserGetObjectPropertyGistAsCsvRootJunction
    ] = UserGetObjectPropertyGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/users/{uid}/{property_}/gist.csv",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, UserGetObjectPropertyGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, UserGetObjectPropertyGistAsCsvRootJunction]):  Default:
            UserGetObjectPropertyGistAsCsvRootJunction.AND.
