...
from ...models.user_group_get_object_list_response_200 import UserGroupGetObjectListResponse200
from ...models.user_group_get_object_list_root_junction import UserGroupGetObjectListRootJunction
...
def _get_kwargs(
    *,
    ...
    root_junction: Union[Unset, UserGroupGetObjectListRootJunction] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
) -> Optional[Union[UserGroupGetObjectListResponse200, WebMessage]]:
    if response.status_code == 200:
        response_200 = UserGroupGetObjectListResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[UserGroupGetObjectListResponse200, WebMessage]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, UserGroupGetObjectListRootJunction]):
...
def sync(
    *,
    ...
    Returns:
        Union[UserGroupGetObjectListResponse200, WebMessage]
    """
