...
from ...models.user_group_get_object_property_gist_as_csv_auto import UserGroupGetObjectPropertyGistAsCsvAuto
from ...models.user_group_get_object_property_gist_as_csv_property import UserGroupGetObjectPropertyGistAsCsvProperty
from ...models.user_group_get_object_property_gist_as_csv_root_junction import (
    UserGroupGetObjectPropertyGistAsCsvRootJunction,
)
...
def _get_kwargs(
    uid: str,
    property_: UserGroupGetObjectPropertyGistAsCsvProperty,
    *,
    absolute_urls: Union[Unset, bool] = False,
    auto: Union[Unset, UserGroupGetObjectPropertyGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, UserGroupGetObjectPropertyGistAsCsvRootJunction
    ] = UserGroupGetObjectPropertyGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/userGroups/{uid}/{property_}/gist.csv",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, UserGroupGetObjectPropertyGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, UserGroupGetObjectPropertyGistAsCsvRootJunction]):  Default:
            UserGroupGetObjectPropertyGistAsCsvRootJunction.AND.
