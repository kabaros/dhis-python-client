...
from ...models.user_role_get_object_property_gist_as_csv_auto import UserRoleGetObjectPropertyGistAsCsvAuto
from ...models.user_role_get_object_property_gist_as_csv_property import UserRoleGetObjectPropertyGistAsCsvProperty
from ...models.user_role_get_object_property_gist_as_csv_root_junction import (
    UserRoleGetObjectPropertyGistAsCsvRootJunction,
)
...
def _get_kwargs(
    uid: str,
    property_: UserRoleGetObjectPropertyGistAsCsvProperty,
    *,
    absolute_urls: Union[Unset, bool] = False,
    auto: Union[Unset, UserRoleGetObjectPropertyGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, UserRoleGetObjectPropertyGistAsCsvRootJunction
    ] = UserRoleGetObjectPropertyGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/userRoles/{uid}/{property_}/gist.csv",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, UserRoleGetObjectPropertyGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, UserRoleGetObjectPropertyGistAsCsvRootJunction]):  Default:
            UserRoleGetObjectPropertyGistAsCsvRootJunction.AND.
