...
from ...models.user_group_bulk_sharing_atomic_mode import UserGroupBulkSharingAtomicMode
from ...models.user_group_bulk_sharing_flush_mode import UserGroupBulkSharingFlushMode
from ...models.user_group_bulk_sharing_identifier import UserGroupBulkSharingIdentifier
from ...models.user_group_bulk_sharing_import_mode import UserGroupBulkSharingImportMode
from ...models.user_group_bulk_sharing_import_report_mode import UserGroupBulkSharingImportReportMode
from ...models.user_group_bulk_sharing_import_strategy import UserGroupBulkSharingImportStrategy
from ...models.user_group_bulk_sharing_preheat_mode import UserGroupBulkSharingPreheatMode
from ...models.user_group_bulk_sharing_root_junction import UserGroupBulkSharingRootJunction
from ...models.user_group_bulk_sharing_user_override_mode import UserGroupBulkSharingUserOverrideMode
...
def _get_kwargs(
    *,
    ...
    atomic_mode: Union[Unset, UserGroupBulkSharingAtomicMode] = UserGroupBulkSharingAtomicMode.ALL,
    flush_mode: Union[Unset, UserGroupBulkSharingFlushMode] = UserGroupBulkSharingFlushMode.AUTO,
    identifier: Union[Unset, UserGroupBulkSharingIdentifier] = UserGroupBulkSharingIdentifier.UID,
    import_mode: Union[Unset, UserGroupBulkSharingImportMode] = UserGroupBulkSharingImportMode.COMMIT,
    import_report_mode: Union[
        Unset, UserGroupBulkSharingImportReportMode
    ] = UserGroupBulkSharingImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, UserGroupBulkSharingImportStrategy
    ] = UserGroupBulkSharingImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, UserGroupBulkSharingPreheatMode] = UserGroupBulkSharingPreheatMode.REFERENCE,
    root_junction: Union[Unset, UserGroupBulkSharingRootJunction] = UNSET,
    skip_sharing: Union[Unset, bool] = False,
    skip_translation: Union[Unset, bool] = False,
    skip_validation: Union[Unset, bool] = False,
    user: Union[Unset, str] = UNSET,
    user_override_mode: Union[Unset, UserGroupBulkSharingUserOverrideMode] = UserGroupBulkSharingUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, UserGroupBulkSharingAtomicMode]):  Default:
            UserGroupBulkSharingAtomicMode.ALL.
        flush_mode (Union[Unset, UserGroupBulkSharingFlushMode]):  Default:
            UserGroupBulkSharingFlushMode.AUTO.
        identifier (Union[Unset, UserGroupBulkSharingIdentifier]):  Default:
            UserGroupBulkSharingIdentifier.UID.
        import_mode (Union[Unset, UserGroupBulkSharingImportMode]):  Default:
            UserGroupBulkSharingImportMode.COMMIT.
        import_report_mode (Union[Unset, UserGroupBulkSharingImportReportMode]):  Default:
            UserGroupBulkSharingImportReportMode.ERRORS.
        import_strategy (Union[Unset, UserGroupBulkSharingImportStrategy]):  Default:
            UserGroupBulkSharingImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, UserGroupBulkSharingPreheatMode]):  Default:
            UserGroupBulkSharingPreheatMode.REFERENCE.
        root_junction (Union[Unset, UserGroupBulkSharingRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, UserGroupBulkSharingUserOverrideMode]):  Default:
            UserGroupBulkSharingUserOverrideMode.NONE.
        body (BulkJsonPatch):
