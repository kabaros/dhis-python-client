...
from ...models.user_bulk_sharing_atomic_mode import UserBulkSharingAtomicMode
from ...models.user_bulk_sharing_flush_mode import UserBulkSharingFlushMode
from ...models.user_bulk_sharing_identifier import UserBulkSharingIdentifier
from ...models.user_bulk_sharing_import_mode import UserBulkSharingImportMode
from ...models.user_bulk_sharing_import_report_mode import UserBulkSharingImportReportMode
from ...models.user_bulk_sharing_import_strategy import UserBulkSharingImportStrategy
from ...models.user_bulk_sharing_preheat_mode import UserBulkSharingPreheatMode
from ...models.user_bulk_sharing_root_junction import UserBulkSharingRootJunction
from ...models.user_bulk_sharing_user_override_mode import UserBulkSharingUserOverrideMode
...
def _get_kwargs(
    *,
    ...
    atomic_mode: Union[Unset, UserBulkSharingAtomicMode] = UserBulkSharingAtomicMode.ALL,
    flush_mode: Union[Unset, UserBulkSharingFlushMode] = UserBulkSharingFlushMode.AUTO,
    identifier: Union[Unset, UserBulkSharingIdentifier] = UserBulkSharingIdentifier.UID,
    import_mode: Union[Unset, UserBulkSharingImportMode] = UserBulkSharingImportMode.COMMIT,
    import_report_mode: Union[Unset, UserBulkSharingImportReportMode] = UserBulkSharingImportReportMode.ERRORS,
    import_strategy: Union[Unset, UserBulkSharingImportStrategy] = UserBulkSharingImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, UserBulkSharingPreheatMode] = UserBulkSharingPreheatMode.REFERENCE,
    root_junction: Union[Unset, UserBulkSharingRootJunction] = UNSET,
    skip_sharing: Union[Unset, bool] = False,
    skip_translation: Union[Unset, bool] = False,
    skip_validation: Union[Unset, bool] = False,
    user: Union[Unset, str] = UNSET,
    user_override_mode: Union[Unset, UserBulkSharingUserOverrideMode] = UserBulkSharingUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, UserBulkSharingAtomicMode]):  Default:
            UserBulkSharingAtomicMode.ALL.
        flush_mode (Union[Unset, UserBulkSharingFlushMode]):  Default:
            UserBulkSharingFlushMode.AUTO.
        identifier (Union[Unset, UserBulkSharingIdentifier]):  Default:
            UserBulkSharingIdentifier.UID.
        import_mode (Union[Unset, UserBulkSharingImportMode]):  Default:
            UserBulkSharingImportMode.COMMIT.
        import_report_mode (Union[Unset, UserBulkSharingImportReportMode]):  Default:
            UserBulkSharingImportReportMode.ERRORS.
        import_strategy (Union[Unset, UserBulkSharingImportStrategy]):  Default:
            UserBulkSharingImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, UserBulkSharingPreheatMode]):  Default:
            UserBulkSharingPreheatMode.REFERENCE.
        root_junction (Union[Unset, UserBulkSharingRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, UserBulkSharingUserOverrideMode]):  Default:
            UserBulkSharingUserOverrideMode.NONE.
        body (BulkJsonPatch):
