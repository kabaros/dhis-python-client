...
from ...models.user_role_replace_translations_body import UserRoleReplaceTranslationsBody
...
def _get_kwargs(
    uid: str,
    *,
    body: UserRoleReplaceTranslationsBody,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": f"/userRoles/{uid}/translations",
    }
