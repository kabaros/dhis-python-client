...
from ...models.user_role_delete_collection_items_jsondelete_collection_items_xml_property import (
    UserRoleDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: UserRoleDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
    *,
