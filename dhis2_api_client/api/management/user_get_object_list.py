...
from ...models.user_get_object_list_response_200 import UserGetObjectListResponse200
from ...models.user_get_object_list_root_junction import UserGetObjectListRootJunction
...
def _get_kwargs(
    *,
    ...
    root_junction: Union[Unset, UserGetObjectListRootJunction] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
) -> Optional[Union[UserGetObjectListResponse200, WebMessage]]:
    if response.status_code == 200:
        response_200 = UserGetObjectListResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[UserGetObjectListResponse200, WebMessage]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, UserGetObjectListRootJunction]):
...
def sync(
    *,
    ...
    Returns:
        Union[UserGetObjectListResponse200, WebMessage]
    """
