...
from ...models.user_group_get_object_gistget_object_gist_as_csv_auto import UserGroupGetObjectGistgetObjectGistAsCsvAuto
from ...models.user_group_get_object_gistget_object_gist_as_csv_response_200 import (
    UserGroupGetObjectGistgetObjectGistAsCsvResponse200,
)
from ...models.user_group_get_object_gistget_object_gist_as_csv_root_junction import (
    UserGroupGetObjectGistgetObjectGistAsCsvRootJunction,
)
...
def _get_kwargs(
    ...
    *,
    ...
    auto: Union[Unset, UserGroupGetObjectGistgetObjectGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, UserGroupGetObjectGistgetObjectGistAsCsvRootJunction
    ] = UserGroupGetObjectGistgetObjectGistAsCsvRootJunction.AND,
...
) -> Optional[Union[UserGroupGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]]:
    if response.status_code == 200:
        response_200 = UserGroupGetObjectGistgetObjectGistAsCsvResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[UserGroupGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, UserGroupGetObjectGistgetObjectGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, UserGroupGetObjectGistgetObjectGistAsCsvRootJunction]):
            Default: UserGroupGetObjectGistgetObjectGistAsCsvRootJunction.AND.
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[UserGroupGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]
    """
