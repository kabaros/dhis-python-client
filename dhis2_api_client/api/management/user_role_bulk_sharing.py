...
from ...models.user_role_bulk_sharing_atomic_mode import UserRoleBulkSharingAtomicMode
from ...models.user_role_bulk_sharing_flush_mode import UserRoleBulkSharingFlushMode
from ...models.user_role_bulk_sharing_identifier import UserRoleBulkSharingIdentifier
from ...models.user_role_bulk_sharing_import_mode import UserRoleBulkSharingImportMode
from ...models.user_role_bulk_sharing_import_report_mode import UserRoleBulkSharingImportReportMode
from ...models.user_role_bulk_sharing_import_strategy import UserRoleBulkSharingImportStrategy
from ...models.user_role_bulk_sharing_preheat_mode import UserRoleBulkSharingPreheatMode
from ...models.user_role_bulk_sharing_root_junction import UserRoleBulkSharingRootJunction
from ...models.user_role_bulk_sharing_user_override_mode import UserRoleBulkSharingUserOverrideMode
...
def _get_kwargs(
    *,
    ...
    atomic_mode: Union[Unset, UserRoleBulkSharingAtomicMode] = UserRoleBulkSharingAtomicMode.ALL,
    flush_mode: Union[Unset, UserRoleBulkSharingFlushMode] = UserRoleBulkSharingFlushMode.AUTO,
    identifier: Union[Unset, UserRoleBulkSharingIdentifier] = UserRoleBulkSharingIdentifier.UID,
    import_mode: Union[Unset, UserRoleBulkSharingImportMode] = UserRoleBulkSharingImportMode.COMMIT,
    import_report_mode: Union[Unset, UserRoleBulkSharingImportReportMode] = UserRoleBulkSharingImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, UserRoleBulkSharingImportStrategy
    ] = UserRoleBulkSharingImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, UserRoleBulkSharingPreheatMode] = UserRoleBulkSharingPreheatMode.REFERENCE,
    root_junction: Union[Unset, UserRoleBulkSharingRootJunction] = UNSET,
    skip_sharing: Union[Unset, bool] = False,
    skip_translation: Union[Unset, bool] = False,
    skip_validation: Union[Unset, bool] = False,
    user: Union[Unset, str] = UNSET,
    user_override_mode: Union[Unset, UserRoleBulkSharingUserOverrideMode] = UserRoleBulkSharingUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, UserRoleBulkSharingAtomicMode]):  Default:
            UserRoleBulkSharingAtomicMode.ALL.
        flush_mode (Union[Unset, UserRoleBulkSharingFlushMode]):  Default:
            UserRoleBulkSharingFlushMode.AUTO.
        identifier (Union[Unset, UserRoleBulkSharingIdentifier]):  Default:
            UserRoleBulkSharingIdentifier.UID.
        import_mode (Union[Unset, UserRoleBulkSharingImportMode]):  Default:
            UserRoleBulkSharingImportMode.COMMIT.
        import_report_mode (Union[Unset, UserRoleBulkSharingImportReportMode]):  Default:
            UserRoleBulkSharingImportReportMode.ERRORS.
        import_strategy (Union[Unset, UserRoleBulkSharingImportStrategy]):  Default:
            UserRoleBulkSharingImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, UserRoleBulkSharingPreheatMode]):  Default:
            UserRoleBulkSharingPreheatMode.REFERENCE.
        root_junction (Union[Unset, UserRoleBulkSharingRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, UserRoleBulkSharingUserOverrideMode]):  Default:
            UserRoleBulkSharingUserOverrideMode.NONE.
        body (BulkJsonPatch):
