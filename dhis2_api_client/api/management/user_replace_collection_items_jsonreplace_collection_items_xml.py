...
from ...models.user_replace_collection_items_jsonreplace_collection_items_xml_property import (
    UserReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: UserReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
    *,
