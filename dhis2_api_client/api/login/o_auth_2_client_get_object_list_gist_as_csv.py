...
from ...models.o_auth_2_client_get_object_list_gist_as_csv_auto import OAuth2ClientGetObjectListGistAsCsvAuto
from ...models.o_auth_2_client_get_object_list_gist_as_csv_root_junction import (
    OAuth2ClientGetObjectListGistAsCsvRootJunction,
)
...
def _get_kwargs(
    *,
    ...
    auto: Union[Unset, OAuth2ClientGetObjectListGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, OAuth2ClientGetObjectListGistAsCsvRootJunction
    ] = OAuth2ClientGetObjectListGistAsCsvRootJunction.AND,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        auto (Union[Unset, OAuth2ClientGetObjectListGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, OAuth2ClientGetObjectListGistAsCsvRootJunction]):  Default:
            OAuth2ClientGetObjectListGistAsCsvRootJunction.AND.
