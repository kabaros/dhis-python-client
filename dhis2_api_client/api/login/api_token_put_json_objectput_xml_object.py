...
from ...models.api_token_put_json_objectput_xml_object_atomic_mode import ApiTokenPutJsonObjectputXmlObjectAtomicMode
from ...models.api_token_put_json_objectput_xml_object_flush_mode import ApiTokenPutJsonObjectputXmlObjectFlushMode
from ...models.api_token_put_json_objectput_xml_object_identifier import ApiTokenPutJsonObjectputXmlObjectIdentifier
from ...models.api_token_put_json_objectput_xml_object_import_mode import ApiTokenPutJsonObjectputXmlObjectImportMode
from ...models.api_token_put_json_objectput_xml_object_import_report_mode import (
    ApiTokenPutJsonObjectputXmlObjectImportReportMode,
)
from ...models.api_token_put_json_objectput_xml_object_import_strategy import (
    ApiTokenPutJsonObjectputXmlObjectImportStrategy,
)
from ...models.api_token_put_json_objectput_xml_object_preheat_mode import ApiTokenPutJsonObjectputXmlObjectPreheatMode
from ...models.api_token_put_json_objectput_xml_object_user_override_mode import (
    ApiTokenPutJsonObjectputXmlObjectUserOverrideMode,
)
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[
        Unset, ApiTokenPutJsonObjectputXmlObjectAtomicMode
    ] = ApiTokenPutJsonObjectputXmlObjectAtomicMode.ALL,
    flush_mode: Union[
        Unset, ApiTokenPutJsonObjectputXmlObjectFlushMode
    ] = ApiTokenPutJsonObjectputXmlObjectFlushMode.AUTO,
    identifier: Union[
        Unset, ApiTokenPutJsonObjectputXmlObjectIdentifier
    ] = ApiTokenPutJsonObjectputXmlObjectIdentifier.UID,
    import_mode: Union[
        Unset, ApiTokenPutJsonObjectputXmlObjectImportMode
    ] = ApiTokenPutJsonObjectputXmlObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, ApiTokenPutJsonObjectputXmlObjectImportReportMode
    ] = ApiTokenPutJsonObjectputXmlObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, ApiTokenPutJsonObjectputXmlObjectImportStrategy
    ] = ApiTokenPutJsonObjectputXmlObjectImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    preheat_mode: Union[
        Unset, ApiTokenPutJsonObjectputXmlObjectPreheatMode
    ] = ApiTokenPutJsonObjectputXmlObjectPreheatMode.REFERENCE,
    ...
    user_override_mode: Union[
        Unset, ApiTokenPutJsonObjectputXmlObjectUserOverrideMode
    ] = ApiTokenPutJsonObjectputXmlObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, ApiTokenPutJsonObjectputXmlObjectAtomicMode]):  Default:
            ApiTokenPutJsonObjectputXmlObjectAtomicMode.ALL.
        flush_mode (Union[Unset, ApiTokenPutJsonObjectputXmlObjectFlushMode]):  Default:
            ApiTokenPutJsonObjectputXmlObjectFlushMode.AUTO.
        identifier (Union[Unset, ApiTokenPutJsonObjectputXmlObjectIdentifier]):  Default:
            ApiTokenPutJsonObjectputXmlObjectIdentifier.UID.
        import_mode (Union[Unset, ApiTokenPutJsonObjectputXmlObjectImportMode]):  Default:
            ApiTokenPutJsonObjectputXmlObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, ApiTokenPutJsonObjectputXmlObjectImportReportMode]):
            Default: ApiTokenPutJsonObjectputXmlObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, ApiTokenPutJsonObjectputXmlObjectImportStrategy]):  Default:
            ApiTokenPutJsonObjectputXmlObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, ApiTokenPutJsonObjectputXmlObjectPreheatMode]):  Default:
            ApiTokenPutJsonObjectputXmlObjectPreheatMode.REFERENCE.
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, ApiTokenPutJsonObjectputXmlObjectUserOverrideMode]):
            Default: ApiTokenPutJsonObjectputXmlObjectUserOverrideMode.NONE.
        body (ApiToken):
