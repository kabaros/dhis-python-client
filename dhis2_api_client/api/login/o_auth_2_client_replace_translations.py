...
from ...models.o_auth_2_client_replace_translations_body import OAuth2ClientReplaceTranslationsBody
...
def _get_kwargs(
    uid: str,
    *,
    body: OAuth2ClientReplaceTranslationsBody,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": f"/oAuth2Clients/{uid}/translations",
    }
