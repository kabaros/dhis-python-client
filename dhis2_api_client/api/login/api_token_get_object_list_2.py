...
from ...models.api_token_get_object_list_2_response_200 import ApiTokenGetObjectList2Response200
from ...models.api_token_get_object_list_2_root_junction import ApiTokenGetObjectList2RootJunction
...
def _get_kwargs(
    *,
    ...
    root_junction: Union[Unset, ApiTokenGetObjectList2RootJunction] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
) -> Optional[Union[ApiTokenGetObjectList2Response200, WebMessage]]:
    if response.status_code == 200:
        response_200 = ApiTokenGetObjectList2Response200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ApiTokenGetObjectList2Response200, WebMessage]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, ApiTokenGetObjectList2RootJunction]):
...
def sync(
    *,
    ...
    Returns:
        Union[ApiTokenGetObjectList2Response200, WebMessage]
    """
