...
from ...models.api_token_get_object_property_gist_as_csv_auto import ApiTokenGetObjectPropertyGistAsCsvAuto
from ...models.api_token_get_object_property_gist_as_csv_property import ApiTokenGetObjectPropertyGistAsCsvProperty
from ...models.api_token_get_object_property_gist_as_csv_root_junction import (
    ApiTokenGetObjectPropertyGistAsCsvRootJunction,
)
...
def _get_kwargs(
    uid: str,
    property_: ApiTokenGetObjectPropertyGistAsCsvProperty,
    *,
    absolute_urls: Union[Unset, bool] = False,
    auto: Union[Unset, ApiTokenGetObjectPropertyGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, ApiTokenGetObjectPropertyGistAsCsvRootJunction
    ] = ApiTokenGetObjectPropertyGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/apiToken/{uid}/{property_}/gist.csv",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, ApiTokenGetObjectPropertyGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, ApiTokenGetObjectPropertyGistAsCsvRootJunction]):  Default:
            ApiTokenGetObjectPropertyGistAsCsvRootJunction.AND.
