...
from ...models.o_auth_2_client_get_object_list_csv_root_junction import OAuth2ClientGetObjectListCsvRootJunction
...
def _get_kwargs(
    *,
    ...
    root_junction: Union[Unset, OAuth2ClientGetObjectListCsvRootJunction] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/oAuth2Clients/#getObjectListCsv",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, OAuth2ClientGetObjectListCsvRootJunction]):
