...
from ...models.o_auth_2_client_get_object_list_response_200 import OAuth2ClientGetObjectListResponse200
from ...models.o_auth_2_client_get_object_list_root_junction import OAuth2ClientGetObjectListRootJunction
...
def _get_kwargs(
    *,
    ...
    root_junction: Union[Unset, OAuth2ClientGetObjectListRootJunction] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
) -> Optional[Union[OAuth2ClientGetObjectListResponse200, WebMessage]]:
    if response.status_code == 200:
        response_200 = OAuth2ClientGetObjectListResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[OAuth2ClientGetObjectListResponse200, WebMessage]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, OAuth2ClientGetObjectListRootJunction]):
...
def sync(
    *,
    ...
    Returns:
        Union[OAuth2ClientGetObjectListResponse200, WebMessage]
    """
