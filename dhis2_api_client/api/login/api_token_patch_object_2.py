...
from ...models.api_token_patch_object_2_atomic_mode import ApiTokenPatchObject2AtomicMode
from ...models.api_token_patch_object_2_flush_mode import ApiTokenPatchObject2FlushMode
from ...models.api_token_patch_object_2_identifier import ApiTokenPatchObject2Identifier
from ...models.api_token_patch_object_2_import_mode import ApiTokenPatchObject2ImportMode
from ...models.api_token_patch_object_2_import_report_mode import ApiTokenPatchObject2ImportReportMode
from ...models.api_token_patch_object_2_import_strategy import ApiTokenPatchObject2ImportStrategy
from ...models.api_token_patch_object_2_preheat_mode import ApiTokenPatchObject2PreheatMode
from ...models.api_token_patch_object_2_root_junction import ApiTokenPatchObject2RootJunction
from ...models.api_token_patch_object_2_user_override_mode import ApiTokenPatchObject2UserOverrideMode
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[Unset, ApiTokenPatchObject2AtomicMode] = ApiTokenPatchObject2AtomicMode.ALL,
    flush_mode: Union[Unset, ApiTokenPatchObject2FlushMode] = ApiTokenPatchObject2FlushMode.AUTO,
    identifier: Union[Unset, ApiTokenPatchObject2Identifier] = ApiTokenPatchObject2Identifier.UID,
    import_mode: Union[Unset, ApiTokenPatchObject2ImportMode] = ApiTokenPatchObject2ImportMode.COMMIT,
    import_report_mode: Union[
        Unset, ApiTokenPatchObject2ImportReportMode
    ] = ApiTokenPatchObject2ImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, ApiTokenPatchObject2ImportStrategy
    ] = ApiTokenPatchObject2ImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, ApiTokenPatchObject2PreheatMode] = ApiTokenPatchObject2PreheatMode.REFERENCE,
    root_junction: Union[Unset, ApiTokenPatchObject2RootJunction] = UNSET,
    skip_sharing: Union[Unset, bool] = False,
    skip_translation: Union[Unset, bool] = False,
    skip_validation: Union[Unset, bool] = False,
    user: Union[Unset, str] = UNSET,
    user_override_mode: Union[Unset, ApiTokenPatchObject2UserOverrideMode] = ApiTokenPatchObject2UserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, ApiTokenPatchObject2AtomicMode]):  Default:
            ApiTokenPatchObject2AtomicMode.ALL.
        flush_mode (Union[Unset, ApiTokenPatchObject2FlushMode]):  Default:
            ApiTokenPatchObject2FlushMode.AUTO.
        identifier (Union[Unset, ApiTokenPatchObject2Identifier]):  Default:
            ApiTokenPatchObject2Identifier.UID.
        import_mode (Union[Unset, ApiTokenPatchObject2ImportMode]):  Default:
            ApiTokenPatchObject2ImportMode.COMMIT.
        import_report_mode (Union[Unset, ApiTokenPatchObject2ImportReportMode]):  Default:
            ApiTokenPatchObject2ImportReportMode.ERRORS.
        import_strategy (Union[Unset, ApiTokenPatchObject2ImportStrategy]):  Default:
            ApiTokenPatchObject2ImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, ApiTokenPatchObject2PreheatMode]):  Default:
            ApiTokenPatchObject2PreheatMode.REFERENCE.
        root_junction (Union[Unset, ApiTokenPatchObject2RootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, ApiTokenPatchObject2UserOverrideMode]):  Default:
            ApiTokenPatchObject2UserOverrideMode.NONE.
        body (JsonPatch):
