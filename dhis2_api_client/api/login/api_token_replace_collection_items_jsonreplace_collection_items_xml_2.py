...
from ...models.api_token_replace_collection_items_jsonreplace_collection_items_xml_2_property import (
    ApiTokenReplaceCollectionItemsJsonreplaceCollectionItemsXml2Property,
)
...
def _get_kwargs(
    uid: str,
    property_: ApiTokenReplaceCollectionItemsJsonreplaceCollectionItemsXml2Property,
    *,
