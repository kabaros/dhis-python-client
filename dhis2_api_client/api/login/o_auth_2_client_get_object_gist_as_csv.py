...
from ...models.o_auth_2_client_get_object_gist_as_csv_auto import OAuth2ClientGetObjectGistAsCsvAuto
from ...models.o_auth_2_client_get_object_gist_as_csv_root_junction import OAuth2ClientGetObjectGistAsCsvRootJunction
...
def _get_kwargs(
    ...
    *,
    ...
    auto: Union[Unset, OAuth2ClientGetObjectGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, OAuth2ClientGetObjectGistAsCsvRootJunction
    ] = OAuth2ClientGetObjectGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/oAuth2Clients/{uid}/gist.csv",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, OAuth2ClientGetObjectGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, OAuth2ClientGetObjectGistAsCsvRootJunction]):  Default:
            OAuth2ClientGetObjectGistAsCsvRootJunction.AND.
