...
from ...models.o_auth_2_client_add_collection_items_jsonadd_collection_items_xml_property import (
    OAuth2ClientAddCollectionItemsJsonaddCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: OAuth2ClientAddCollectionItemsJsonaddCollectionItemsXmlProperty,
    *,
