...
from ...models.o_auth_2_client_delete_collection_item_property import OAuth2ClientDeleteCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: OAuth2ClientDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/oAuth2Clients/{uid}/{property_}/{item_id}",
    }
