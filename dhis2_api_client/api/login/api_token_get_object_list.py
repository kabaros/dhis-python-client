...
from ...models.api_token_get_object_list_response_200 import ApiTokenGetObjectListResponse200
from ...models.api_token_get_object_list_root_junction import ApiTokenGetObjectListRootJunction
...
def _get_kwargs(
    *,
    ...
    root_junction: Union[Unset, ApiTokenGetObjectListRootJunction] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
) -> Optional[Union[ApiTokenGetObjectListResponse200, WebMessage]]:
    if response.status_code == 200:
        response_200 = ApiTokenGetObjectListResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ApiTokenGetObjectListResponse200, WebMessage]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, ApiTokenGetObjectListRootJunction]):
...
def sync(
    *,
    ...
    Returns:
        Union[ApiTokenGetObjectListResponse200, WebMessage]
    """
