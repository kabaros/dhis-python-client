...
from ...models.api_token_add_collection_items_jsonadd_collection_items_xml_2_property import (
    ApiTokenAddCollectionItemsJsonaddCollectionItemsXml2Property,
)
...
def _get_kwargs(
    uid: str,
    property_: ApiTokenAddCollectionItemsJsonaddCollectionItemsXml2Property,
    *,
