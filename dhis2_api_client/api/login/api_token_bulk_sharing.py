...
from ...models.api_token_bulk_sharing_atomic_mode import ApiTokenBulkSharingAtomicMode
from ...models.api_token_bulk_sharing_flush_mode import ApiTokenBulkSharingFlushMode
from ...models.api_token_bulk_sharing_identifier import ApiTokenBulkSharingIdentifier
from ...models.api_token_bulk_sharing_import_mode import ApiTokenBulkSharingImportMode
from ...models.api_token_bulk_sharing_import_report_mode import ApiTokenBulkSharingImportReportMode
from ...models.api_token_bulk_sharing_import_strategy import ApiTokenBulkSharingImportStrategy
from ...models.api_token_bulk_sharing_preheat_mode import ApiTokenBulkSharingPreheatMode
from ...models.api_token_bulk_sharing_root_junction import ApiTokenBulkSharingRootJunction
from ...models.api_token_bulk_sharing_user_override_mode import ApiTokenBulkSharingUserOverrideMode
...
def _get_kwargs(
    *,
    ...
    atomic_mode: Union[Unset, ApiTokenBulkSharingAtomicMode] = ApiTokenBulkSharingAtomicMode.ALL,
    flush_mode: Union[Unset, ApiTokenBulkSharingFlushMode] = ApiTokenBulkSharingFlushMode.AUTO,
    identifier: Union[Unset, ApiTokenBulkSharingIdentifier] = ApiTokenBulkSharingIdentifier.UID,
    import_mode: Union[Unset, ApiTokenBulkSharingImportMode] = ApiTokenBulkSharingImportMode.COMMIT,
    import_report_mode: Union[Unset, ApiTokenBulkSharingImportReportMode] = ApiTokenBulkSharingImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, ApiTokenBulkSharingImportStrategy
    ] = ApiTokenBulkSharingImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, ApiTokenBulkSharingPreheatMode] = ApiTokenBulkSharingPreheatMode.REFERENCE,
    root_junction: Union[Unset, ApiTokenBulkSharingRootJunction] = UNSET,
    skip_sharing: Union[Unset, bool] = False,
    skip_translation: Union[Unset, bool] = False,
    skip_validation: Union[Unset, bool] = False,
    user: Union[Unset, str] = UNSET,
    user_override_mode: Union[Unset, ApiTokenBulkSharingUserOverrideMode] = ApiTokenBulkSharingUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, ApiTokenBulkSharingAtomicMode]):  Default:
            ApiTokenBulkSharingAtomicMode.ALL.
        flush_mode (Union[Unset, ApiTokenBulkSharingFlushMode]):  Default:
            ApiTokenBulkSharingFlushMode.AUTO.
        identifier (Union[Unset, ApiTokenBulkSharingIdentifier]):  Default:
            ApiTokenBulkSharingIdentifier.UID.
        import_mode (Union[Unset, ApiTokenBulkSharingImportMode]):  Default:
            ApiTokenBulkSharingImportMode.COMMIT.
        import_report_mode (Union[Unset, ApiTokenBulkSharingImportReportMode]):  Default:
            ApiTokenBulkSharingImportReportMode.ERRORS.
        import_strategy (Union[Unset, ApiTokenBulkSharingImportStrategy]):  Default:
            ApiTokenBulkSharingImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, ApiTokenBulkSharingPreheatMode]):  Default:
            ApiTokenBulkSharingPreheatMode.REFERENCE.
        root_junction (Union[Unset, ApiTokenBulkSharingRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, ApiTokenBulkSharingUserOverrideMode]):  Default:
            ApiTokenBulkSharingUserOverrideMode.NONE.
        body (BulkJsonPatch):
