...
from ...models.o_auth_2_client_replace_collection_items_jsonreplace_collection_items_xml_property import (
    OAuth2ClientReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: OAuth2ClientReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
    *,
