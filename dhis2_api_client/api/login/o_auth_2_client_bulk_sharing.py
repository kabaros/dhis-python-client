...
from ...models.o_auth_2_client_bulk_sharing_atomic_mode import OAuth2ClientBulkSharingAtomicMode
from ...models.o_auth_2_client_bulk_sharing_flush_mode import OAuth2ClientBulkSharingFlushMode
from ...models.o_auth_2_client_bulk_sharing_identifier import OAuth2ClientBulkSharingIdentifier
from ...models.o_auth_2_client_bulk_sharing_import_mode import OAuth2ClientBulkSharingImportMode
from ...models.o_auth_2_client_bulk_sharing_import_report_mode import OAuth2ClientBulkSharingImportReportMode
from ...models.o_auth_2_client_bulk_sharing_import_strategy import OAuth2ClientBulkSharingImportStrategy
from ...models.o_auth_2_client_bulk_sharing_preheat_mode import OAuth2ClientBulkSharingPreheatMode
from ...models.o_auth_2_client_bulk_sharing_root_junction import OAuth2ClientBulkSharingRootJunction
from ...models.o_auth_2_client_bulk_sharing_user_override_mode import OAuth2ClientBulkSharingUserOverrideMode
...
def _get_kwargs(
    *,
    ...
    atomic_mode: Union[Unset, OAuth2ClientBulkSharingAtomicMode] = OAuth2ClientBulkSharingAtomicMode.ALL,
    flush_mode: Union[Unset, OAuth2ClientBulkSharingFlushMode] = OAuth2ClientBulkSharingFlushMode.AUTO,
    identifier: Union[Unset, OAuth2ClientBulkSharingIdentifier] = OAuth2ClientBulkSharingIdentifier.UID,
    import_mode: Union[Unset, OAuth2ClientBulkSharingImportMode] = OAuth2ClientBulkSharingImportMode.COMMIT,
    import_report_mode: Union[
        Unset, OAuth2ClientBulkSharingImportReportMode
    ] = OAuth2ClientBulkSharingImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, OAuth2ClientBulkSharingImportStrategy
    ] = OAuth2ClientBulkSharingImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, OAuth2ClientBulkSharingPreheatMode] = OAuth2ClientBulkSharingPreheatMode.REFERENCE,
    root_junction: Union[Unset, OAuth2ClientBulkSharingRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, OAuth2ClientBulkSharingUserOverrideMode
    ] = OAuth2ClientBulkSharingUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, OAuth2ClientBulkSharingAtomicMode]):  Default:
            OAuth2ClientBulkSharingAtomicMode.ALL.
        flush_mode (Union[Unset, OAuth2ClientBulkSharingFlushMode]):  Default:
            OAuth2ClientBulkSharingFlushMode.AUTO.
        identifier (Union[Unset, OAuth2ClientBulkSharingIdentifier]):  Default:
            OAuth2ClientBulkSharingIdentifier.UID.
        import_mode (Union[Unset, OAuth2ClientBulkSharingImportMode]):  Default:
            OAuth2ClientBulkSharingImportMode.COMMIT.
        import_report_mode (Union[Unset, OAuth2ClientBulkSharingImportReportMode]):  Default:
            OAuth2ClientBulkSharingImportReportMode.ERRORS.
        import_strategy (Union[Unset, OAuth2ClientBulkSharingImportStrategy]):  Default:
            OAuth2ClientBulkSharingImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, OAuth2ClientBulkSharingPreheatMode]):  Default:
            OAuth2ClientBulkSharingPreheatMode.REFERENCE.
        root_junction (Union[Unset, OAuth2ClientBulkSharingRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, OAuth2ClientBulkSharingUserOverrideMode]):  Default:
            OAuth2ClientBulkSharingUserOverrideMode.NONE.
        body (BulkJsonPatch):
