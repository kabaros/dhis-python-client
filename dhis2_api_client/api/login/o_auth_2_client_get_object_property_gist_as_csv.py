...
from ...models.o_auth_2_client_get_object_property_gist_as_csv_auto import OAuth2ClientGetObjectPropertyGistAsCsvAuto
from ...models.o_auth_2_client_get_object_property_gist_as_csv_property import (
    OAuth2ClientGetObjectPropertyGistAsCsvProperty,
)
from ...models.o_auth_2_client_get_object_property_gist_as_csv_root_junction import (
    OAuth2ClientGetObjectPropertyGistAsCsvRootJunction,
)
...
def _get_kwargs(
    uid: str,
    property_: OAuth2ClientGetObjectPropertyGistAsCsvProperty,
    *,
    absolute_urls: Union[Unset, bool] = False,
    auto: Union[Unset, OAuth2ClientGetObjectPropertyGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, OAuth2ClientGetObjectPropertyGistAsCsvRootJunction
    ] = OAuth2ClientGetObjectPropertyGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/oAuth2Clients/{uid}/{property_}/gist.csv",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, OAuth2ClientGetObjectPropertyGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, OAuth2ClientGetObjectPropertyGistAsCsvRootJunction]):
            Default: OAuth2ClientGetObjectPropertyGistAsCsvRootJunction.AND.
