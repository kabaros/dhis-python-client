...
from ...models.o_auth_2_client_delete_collection_items_jsondelete_collection_items_xml_property import (
    OAuth2ClientDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: OAuth2ClientDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
    *,
