...
from ...models.o_auth_2_client_post_json_objectpost_xml_object_atomic_mode import (
    OAuth2ClientPostJsonObjectpostXmlObjectAtomicMode,
)
from ...models.o_auth_2_client_post_json_objectpost_xml_object_flush_mode import (
    OAuth2ClientPostJsonObjectpostXmlObjectFlushMode,
)
from ...models.o_auth_2_client_post_json_objectpost_xml_object_identifier import (
    OAuth2ClientPostJsonObjectpostXmlObjectIdentifier,
)
from ...models.o_auth_2_client_post_json_objectpost_xml_object_import_mode import (
    OAuth2ClientPostJsonObjectpostXmlObjectImportMode,
)
from ...models.o_auth_2_client_post_json_objectpost_xml_object_import_report_mode import (
    OAuth2ClientPostJsonObjectpostXmlObjectImportReportMode,
)
from ...models.o_auth_2_client_post_json_objectpost_xml_object_import_strategy import (
    OAuth2ClientPostJsonObjectpostXmlObjectImportStrategy,
)
from ...models.o_auth_2_client_post_json_objectpost_xml_object_preheat_mode import (
    OAuth2ClientPostJsonObjectpostXmlObjectPreheatMode,
)
from ...models.o_auth_2_client_post_json_objectpost_xml_object_user_override_mode import (
    OAuth2ClientPostJsonObjectpostXmlObjectUserOverrideMode,
)
...
def _get_kwargs(
    *,
    ...
    atomic_mode: Union[
        Unset, OAuth2ClientPostJsonObjectpostXmlObjectAtomicMode
    ] = OAuth2ClientPostJsonObjectpostXmlObjectAtomicMode.ALL,
    flush_mode: Union[
        Unset, OAuth2ClientPostJsonObjectpostXmlObjectFlushMode
    ] = OAuth2ClientPostJsonObjectpostXmlObjectFlushMode.AUTO,
    identifier: Union[
        Unset, OAuth2ClientPostJsonObjectpostXmlObjectIdentifier
    ] = OAuth2ClientPostJsonObjectpostXmlObjectIdentifier.UID,
    import_mode: Union[
        Unset, OAuth2ClientPostJsonObjectpostXmlObjectImportMode
    ] = OAuth2ClientPostJsonObjectpostXmlObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, OAuth2ClientPostJsonObjectpostXmlObjectImportReportMode
    ] = OAuth2ClientPostJsonObjectpostXmlObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, OAuth2ClientPostJsonObjectpostXmlObjectImportStrategy
    ] = OAuth2ClientPostJsonObjectpostXmlObjectImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    preheat_mode: Union[
        Unset, OAuth2ClientPostJsonObjectpostXmlObjectPreheatMode
    ] = OAuth2ClientPostJsonObjectpostXmlObjectPreheatMode.REFERENCE,
    ...
    user_override_mode: Union[
        Unset, OAuth2ClientPostJsonObjectpostXmlObjectUserOverrideMode
    ] = OAuth2ClientPostJsonObjectpostXmlObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, OAuth2ClientPostJsonObjectpostXmlObjectAtomicMode]):  Default:
            OAuth2ClientPostJsonObjectpostXmlObjectAtomicMode.ALL.
        flush_mode (Union[Unset, OAuth2ClientPostJsonObjectpostXmlObjectFlushMode]):  Default:
            OAuth2ClientPostJsonObjectpostXmlObjectFlushMode.AUTO.
        identifier (Union[Unset, OAuth2ClientPostJsonObjectpostXmlObjectIdentifier]):  Default:
            OAuth2ClientPostJsonObjectpostXmlObjectIdentifier.UID.
        import_mode (Union[Unset, OAuth2ClientPostJsonObjectpostXmlObjectImportMode]):  Default:
            OAuth2ClientPostJsonObjectpostXmlObjectImportMode.COMMIT.
        import_report_mode (Union[Unset,
            OAuth2ClientPostJsonObjectpostXmlObjectImportReportMode]):  Default:
            OAuth2ClientPostJsonObjectpostXmlObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, OAuth2ClientPostJsonObjectpostXmlObjectImportStrategy]):
            Default: OAuth2ClientPostJsonObjectpostXmlObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, OAuth2ClientPostJsonObjectpostXmlObjectPreheatMode]):  Default:
            OAuth2ClientPostJsonObjectpostXmlObjectPreheatMode.REFERENCE.
        ...
        user_override_mode (Union[Unset,
            OAuth2ClientPostJsonObjectpostXmlObjectUserOverrideMode]):  Default:
            OAuth2ClientPostJsonObjectpostXmlObjectUserOverrideMode.NONE.
        body (OAuth2Client):
