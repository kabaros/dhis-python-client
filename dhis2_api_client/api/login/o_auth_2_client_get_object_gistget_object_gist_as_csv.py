...
from ...models.o_auth_2_client_get_object_gistget_object_gist_as_csv_auto import (
    OAuth2ClientGetObjectGistgetObjectGistAsCsvAuto,
)
from ...models.o_auth_2_client_get_object_gistget_object_gist_as_csv_response_200 import (
    OAuth2ClientGetObjectGistgetObjectGistAsCsvResponse200,
)
from ...models.o_auth_2_client_get_object_gistget_object_gist_as_csv_root_junction import (
    OAuth2ClientGetObjectGistgetObjectGistAsCsvRootJunction,
)
...
def _get_kwargs(
    ...
    *,
    ...
    auto: Union[Unset, OAuth2ClientGetObjectGistgetObjectGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, OAuth2ClientGetObjectGistgetObjectGistAsCsvRootJunction
    ] = OAuth2ClientGetObjectGistgetObjectGistAsCsvRootJunction.AND,
...
) -> Optional[Union[OAuth2ClientGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]]:
    if response.status_code == 200:
        response_200 = OAuth2ClientGetObjectGistgetObjectGistAsCsvResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[OAuth2ClientGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, OAuth2ClientGetObjectGistgetObjectGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, OAuth2ClientGetObjectGistgetObjectGistAsCsvRootJunction]):
            Default: OAuth2ClientGetObjectGistgetObjectGistAsCsvRootJunction.AND.
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[OAuth2ClientGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]
    """
