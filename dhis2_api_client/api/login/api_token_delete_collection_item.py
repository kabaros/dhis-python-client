...
from ...models.api_token_delete_collection_item_property import ApiTokenDeleteCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: ApiTokenDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/apiToken/{uid}/{property_}/{item_id}",
    }
