...
from ...models.api_token_replace_collection_items_jsonreplace_collection_items_xml_property import (
    ApiTokenReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: ApiTokenReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
    *,
