...
from ...models.api_token_delete_collection_items_jsondelete_collection_items_xml_2_property import (
    ApiTokenDeleteCollectionItemsJsondeleteCollectionItemsXml2Property,
)
...
def _get_kwargs(
    uid: str,
    property_: ApiTokenDeleteCollectionItemsJsondeleteCollectionItemsXml2Property,
    *,
