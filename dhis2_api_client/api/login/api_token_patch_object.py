...
from ...models.api_token_patch_object_atomic_mode import ApiTokenPatchObjectAtomicMode
from ...models.api_token_patch_object_flush_mode import ApiTokenPatchObjectFlushMode
from ...models.api_token_patch_object_identifier import ApiTokenPatchObjectIdentifier
from ...models.api_token_patch_object_import_mode import ApiTokenPatchObjectImportMode
from ...models.api_token_patch_object_import_report_mode import ApiTokenPatchObjectImportReportMode
from ...models.api_token_patch_object_import_strategy import ApiTokenPatchObjectImportStrategy
from ...models.api_token_patch_object_preheat_mode import ApiTokenPatchObjectPreheatMode
from ...models.api_token_patch_object_root_junction import ApiTokenPatchObjectRootJunction
from ...models.api_token_patch_object_user_override_mode import ApiTokenPatchObjectUserOverrideMode
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[Unset, ApiTokenPatchObjectAtomicMode] = ApiTokenPatchObjectAtomicMode.ALL,
    flush_mode: Union[Unset, ApiTokenPatchObjectFlushMode] = ApiTokenPatchObjectFlushMode.AUTO,
    identifier: Union[Unset, ApiTokenPatchObjectIdentifier] = ApiTokenPatchObjectIdentifier.UID,
    import_mode: Union[Unset, ApiTokenPatchObjectImportMode] = ApiTokenPatchObjectImportMode.COMMIT,
    import_report_mode: Union[Unset, ApiTokenPatchObjectImportReportMode] = ApiTokenPatchObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, ApiTokenPatchObjectImportStrategy
    ] = ApiTokenPatchObjectImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, ApiTokenPatchObjectPreheatMode] = ApiTokenPatchObjectPreheatMode.REFERENCE,
    root_junction: Union[Unset, ApiTokenPatchObjectRootJunction] = UNSET,
    skip_sharing: Union[Unset, bool] = False,
    skip_translation: Union[Unset, bool] = False,
    skip_validation: Union[Unset, bool] = False,
    user: Union[Unset, str] = UNSET,
    user_override_mode: Union[Unset, ApiTokenPatchObjectUserOverrideMode] = ApiTokenPatchObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, ApiTokenPatchObjectAtomicMode]):  Default:
            ApiTokenPatchObjectAtomicMode.ALL.
        flush_mode (Union[Unset, ApiTokenPatchObjectFlushMode]):  Default:
            ApiTokenPatchObjectFlushMode.AUTO.
        identifier (Union[Unset, ApiTokenPatchObjectIdentifier]):  Default:
            ApiTokenPatchObjectIdentifier.UID.
        import_mode (Union[Unset, ApiTokenPatchObjectImportMode]):  Default:
            ApiTokenPatchObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, ApiTokenPatchObjectImportReportMode]):  Default:
            ApiTokenPatchObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, ApiTokenPatchObjectImportStrategy]):  Default:
            ApiTokenPatchObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, ApiTokenPatchObjectPreheatMode]):  Default:
            ApiTokenPatchObjectPreheatMode.REFERENCE.
        root_junction (Union[Unset, ApiTokenPatchObjectRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, ApiTokenPatchObjectUserOverrideMode]):  Default:
            ApiTokenPatchObjectUserOverrideMode.NONE.
        body (JsonPatch):
