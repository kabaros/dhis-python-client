...
from ...models.api_token_get_object_2_root_junction import ApiTokenGetObject2RootJunction
...
def _get_kwargs(
    ...
    *,
    ...
    root_junction: Union[Unset, ApiTokenGetObject2RootJunction] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
) -> Optional[Union[ApiToken, WebMessage]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ApiToken, WebMessage]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, ApiTokenGetObject2RootJunction]):
