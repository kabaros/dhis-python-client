...
from ...models.api_token_delete_collection_item_2_property import ApiTokenDeleteCollectionItem2Property
...
def _get_kwargs(
    uid: str,
    property_: ApiTokenDeleteCollectionItem2Property,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/apiTokens/{uid}/{property_}/{item_id}",
    }
