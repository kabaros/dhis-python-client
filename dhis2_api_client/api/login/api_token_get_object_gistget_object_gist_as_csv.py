...
from ...models.api_token_get_object_gistget_object_gist_as_csv_auto import ApiTokenGetObjectGistgetObjectGistAsCsvAuto
from ...models.api_token_get_object_gistget_object_gist_as_csv_response_200 import (
    ApiTokenGetObjectGistgetObjectGistAsCsvResponse200,
)
from ...models.api_token_get_object_gistget_object_gist_as_csv_root_junction import (
    ApiTokenGetObjectGistgetObjectGistAsCsvRootJunction,
)
...
def _get_kwargs(
    ...
    *,
    ...
    auto: Union[Unset, ApiTokenGetObjectGistgetObjectGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, ApiTokenGetObjectGistgetObjectGistAsCsvRootJunction
    ] = ApiTokenGetObjectGistgetObjectGistAsCsvRootJunction.AND,
...
) -> Optional[Union[ApiTokenGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]]:
    if response.status_code == 200:
        response_200 = ApiTokenGetObjectGistgetObjectGistAsCsvResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ApiTokenGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, ApiTokenGetObjectGistgetObjectGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, ApiTokenGetObjectGistgetObjectGistAsCsvRootJunction]):
            Default: ApiTokenGetObjectGistgetObjectGistAsCsvRootJunction.AND.
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ApiTokenGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]
    """
