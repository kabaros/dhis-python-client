...
from ...models.api_token_get_object_list_csv_root_junction import ApiTokenGetObjectListCsvRootJunction
...
def _get_kwargs(
    *,
    ...
    root_junction: Union[Unset, ApiTokenGetObjectListCsvRootJunction] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, ApiTokenGetObjectListCsvRootJunction]):
