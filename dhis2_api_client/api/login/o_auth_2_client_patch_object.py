...
from ...models.o_auth_2_client_patch_object_atomic_mode import OAuth2ClientPatchObjectAtomicMode
from ...models.o_auth_2_client_patch_object_flush_mode import OAuth2ClientPatchObjectFlushMode
from ...models.o_auth_2_client_patch_object_identifier import OAuth2ClientPatchObjectIdentifier
from ...models.o_auth_2_client_patch_object_import_mode import OAuth2ClientPatchObjectImportMode
from ...models.o_auth_2_client_patch_object_import_report_mode import OAuth2ClientPatchObjectImportReportMode
from ...models.o_auth_2_client_patch_object_import_strategy import OAuth2ClientPatchObjectImportStrategy
from ...models.o_auth_2_client_patch_object_preheat_mode import OAuth2ClientPatchObjectPreheatMode
from ...models.o_auth_2_client_patch_object_root_junction import OAuth2ClientPatchObjectRootJunction
from ...models.o_auth_2_client_patch_object_user_override_mode import OAuth2ClientPatchObjectUserOverrideMode
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[Unset, OAuth2ClientPatchObjectAtomicMode] = OAuth2ClientPatchObjectAtomicMode.ALL,
    flush_mode: Union[Unset, OAuth2ClientPatchObjectFlushMode] = OAuth2ClientPatchObjectFlushMode.AUTO,
    identifier: Union[Unset, OAuth2ClientPatchObjectIdentifier] = OAuth2ClientPatchObjectIdentifier.UID,
    import_mode: Union[Unset, OAuth2ClientPatchObjectImportMode] = OAuth2ClientPatchObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, OAuth2ClientPatchObjectImportReportMode
    ] = OAuth2ClientPatchObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, OAuth2ClientPatchObjectImportStrategy
    ] = OAuth2ClientPatchObjectImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, OAuth2ClientPatchObjectPreheatMode] = OAuth2ClientPatchObjectPreheatMode.REFERENCE,
    root_junction: Union[Unset, OAuth2ClientPatchObjectRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, OAuth2ClientPatchObjectUserOverrideMode
    ] = OAuth2ClientPatchObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, OAuth2ClientPatchObjectAtomicMode]):  Default:
            OAuth2ClientPatchObjectAtomicMode.ALL.
        flush_mode (Union[Unset, OAuth2ClientPatchObjectFlushMode]):  Default:
            OAuth2ClientPatchObjectFlushMode.AUTO.
        identifier (Union[Unset, OAuth2ClientPatchObjectIdentifier]):  Default:
            OAuth2ClientPatchObjectIdentifier.UID.
        import_mode (Union[Unset, OAuth2ClientPatchObjectImportMode]):  Default:
            OAuth2ClientPatchObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, OAuth2ClientPatchObjectImportReportMode]):  Default:
            OAuth2ClientPatchObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, OAuth2ClientPatchObjectImportStrategy]):  Default:
            OAuth2ClientPatchObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, OAuth2ClientPatchObjectPreheatMode]):  Default:
            OAuth2ClientPatchObjectPreheatMode.REFERENCE.
        root_junction (Union[Unset, OAuth2ClientPatchObjectRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, OAuth2ClientPatchObjectUserOverrideMode]):  Default:
            OAuth2ClientPatchObjectUserOverrideMode.NONE.
        body (JsonPatch):
