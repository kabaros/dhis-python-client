...
from ...models.api_token_delete_collection_items_jsondelete_collection_items_xml_property import (
    ApiTokenDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: ApiTokenDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
    *,
