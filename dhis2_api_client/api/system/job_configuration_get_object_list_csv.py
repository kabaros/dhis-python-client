...
from ...models.job_configuration_get_object_list_csv_root_junction import JobConfigurationGetObjectListCsvRootJunction
...
def _get_kwargs(
    *,
    ...
    root_junction: Union[Unset, JobConfigurationGetObjectListCsvRootJunction] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/jobConfigurations/#getObjectListCsv",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, JobConfigurationGetObjectListCsvRootJunction]):
