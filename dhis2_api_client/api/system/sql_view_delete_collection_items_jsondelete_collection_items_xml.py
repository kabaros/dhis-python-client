...
from ...models.sql_view_delete_collection_items_jsondelete_collection_items_xml_property import (
    SqlViewDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: SqlViewDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
    *,
