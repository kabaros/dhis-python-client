...
from ...models.sql_view_delete_collection_item_property import SqlViewDeleteCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: SqlViewDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/sqlViews/{uid}/{property_}/{item_id}",
    }
