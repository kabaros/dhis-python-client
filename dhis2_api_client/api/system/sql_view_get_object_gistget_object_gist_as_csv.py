...
from ...models.sql_view_get_object_gistget_object_gist_as_csv_auto import SqlViewGetObjectGistgetObjectGistAsCsvAuto
from ...models.sql_view_get_object_gistget_object_gist_as_csv_response_200 import (
    SqlViewGetObjectGistgetObjectGistAsCsvResponse200,
)
from ...models.sql_view_get_object_gistget_object_gist_as_csv_root_junction import (
    SqlViewGetObjectGistgetObjectGistAsCsvRootJunction,
)
...
def _get_kwargs(
    ...
    *,
    ...
    auto: Union[Unset, SqlViewGetObjectGistgetObjectGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, SqlViewGetObjectGistgetObjectGistAsCsvRootJunction
    ] = SqlViewGetObjectGistgetObjectGistAsCsvRootJunction.AND,
...
) -> Optional[Union[SqlViewGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]]:
    if response.status_code == 200:
        response_200 = SqlViewGetObjectGistgetObjectGistAsCsvResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[SqlViewGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, SqlViewGetObjectGistgetObjectGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, SqlViewGetObjectGistgetObjectGistAsCsvRootJunction]):
            Default: SqlViewGetObjectGistgetObjectGistAsCsvRootJunction.AND.
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[SqlViewGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]
    """
