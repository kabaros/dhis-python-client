...
from ...models.job_configuration_replace_collection_items_jsonreplace_collection_items_xml_property import (
    JobConfigurationReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: JobConfigurationReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
    *,
