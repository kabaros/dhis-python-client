...
from ...models.sql_view_patch_object_atomic_mode import SqlViewPatchObjectAtomicMode
from ...models.sql_view_patch_object_flush_mode import SqlViewPatchObjectFlushMode
from ...models.sql_view_patch_object_identifier import SqlViewPatchObjectIdentifier
from ...models.sql_view_patch_object_import_mode import SqlViewPatchObjectImportMode
from ...models.sql_view_patch_object_import_report_mode import SqlViewPatchObjectImportReportMode
from ...models.sql_view_patch_object_import_strategy import SqlViewPatchObjectImportStrategy
from ...models.sql_view_patch_object_preheat_mode import SqlViewPatchObjectPreheatMode
from ...models.sql_view_patch_object_root_junction import SqlViewPatchObjectRootJunction
from ...models.sql_view_patch_object_user_override_mode import SqlViewPatchObjectUserOverrideMode
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[Unset, SqlViewPatchObjectAtomicMode] = SqlViewPatchObjectAtomicMode.ALL,
    flush_mode: Union[Unset, SqlViewPatchObjectFlushMode] = SqlViewPatchObjectFlushMode.AUTO,
    identifier: Union[Unset, SqlViewPatchObjectIdentifier] = SqlViewPatchObjectIdentifier.UID,
    import_mode: Union[Unset, SqlViewPatchObjectImportMode] = SqlViewPatchObjectImportMode.COMMIT,
    import_report_mode: Union[Unset, SqlViewPatchObjectImportReportMode] = SqlViewPatchObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, SqlViewPatchObjectImportStrategy
    ] = SqlViewPatchObjectImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, SqlViewPatchObjectPreheatMode] = SqlViewPatchObjectPreheatMode.REFERENCE,
    root_junction: Union[Unset, SqlViewPatchObjectRootJunction] = UNSET,
    skip_sharing: Union[Unset, bool] = False,
    skip_translation: Union[Unset, bool] = False,
    skip_validation: Union[Unset, bool] = False,
    user: Union[Unset, str] = UNSET,
    user_override_mode: Union[Unset, SqlViewPatchObjectUserOverrideMode] = SqlViewPatchObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, SqlViewPatchObjectAtomicMode]):  Default:
            SqlViewPatchObjectAtomicMode.ALL.
        flush_mode (Union[Unset, SqlViewPatchObjectFlushMode]):  Default:
            SqlViewPatchObjectFlushMode.AUTO.
        identifier (Union[Unset, SqlViewPatchObjectIdentifier]):  Default:
            SqlViewPatchObjectIdentifier.UID.
        import_mode (Union[Unset, SqlViewPatchObjectImportMode]):  Default:
            SqlViewPatchObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, SqlViewPatchObjectImportReportMode]):  Default:
            SqlViewPatchObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, SqlViewPatchObjectImportStrategy]):  Default:
            SqlViewPatchObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, SqlViewPatchObjectPreheatMode]):  Default:
            SqlViewPatchObjectPreheatMode.REFERENCE.
        root_junction (Union[Unset, SqlViewPatchObjectRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, SqlViewPatchObjectUserOverrideMode]):  Default:
            SqlViewPatchObjectUserOverrideMode.NONE.
        body (JsonPatch):
