...
from ...models.job_configuration_delete_collection_item_property import JobConfigurationDeleteCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: JobConfigurationDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/jobConfigurations/{uid}/{property_}/{item_id}",
    }
