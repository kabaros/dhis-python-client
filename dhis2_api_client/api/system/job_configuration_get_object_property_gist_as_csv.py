...
from ...models.job_configuration_get_object_property_gist_as_csv_auto import (
    JobConfigurationGetObjectPropertyGistAsCsvAuto,
)
from ...models.job_configuration_get_object_property_gist_as_csv_property import (
    JobConfigurationGetObjectPropertyGistAsCsvProperty,
)
from ...models.job_configuration_get_object_property_gist_as_csv_root_junction import (
    JobConfigurationGetObjectPropertyGistAsCsvRootJunction,
)
...
def _get_kwargs(
    uid: str,
    property_: JobConfigurationGetObjectPropertyGistAsCsvProperty,
    *,
    absolute_urls: Union[Unset, bool] = False,
    auto: Union[Unset, JobConfigurationGetObjectPropertyGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, JobConfigurationGetObjectPropertyGistAsCsvRootJunction
    ] = JobConfigurationGetObjectPropertyGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/jobConfigurations/{uid}/{property_}/gist.csv",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, JobConfigurationGetObjectPropertyGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, JobConfigurationGetObjectPropertyGistAsCsvRootJunction]):
            Default: JobConfigurationGetObjectPropertyGistAsCsvRootJunction.AND.
