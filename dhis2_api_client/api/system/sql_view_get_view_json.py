...
from ...models.grid_response import GridResponse
...
) -> Optional[Union[GridResponse, WebMessage]]:
    if response.status_code == 200:
        response_200 = GridResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[GridResponse, WebMessage]]:
    return Response(
