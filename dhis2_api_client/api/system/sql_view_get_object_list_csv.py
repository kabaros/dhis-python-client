...
from ...models.sql_view_get_object_list_csv_root_junction import SqlViewGetObjectListCsvRootJunction
...
def _get_kwargs(
    *,
    ...
    root_junction: Union[Unset, SqlViewGetObjectListCsvRootJunction] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, SqlViewGetObjectListCsvRootJunction]):
