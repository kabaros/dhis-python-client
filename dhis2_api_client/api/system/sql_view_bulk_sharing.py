...
from ...models.sql_view_bulk_sharing_atomic_mode import SqlViewBulkSharingAtomicMode
from ...models.sql_view_bulk_sharing_flush_mode import SqlViewBulkSharingFlushMode
from ...models.sql_view_bulk_sharing_identifier import SqlViewBulkSharingIdentifier
from ...models.sql_view_bulk_sharing_import_mode import SqlViewBulkSharingImportMode
from ...models.sql_view_bulk_sharing_import_report_mode import SqlViewBulkSharingImportReportMode
from ...models.sql_view_bulk_sharing_import_strategy import SqlViewBulkSharingImportStrategy
from ...models.sql_view_bulk_sharing_preheat_mode import SqlViewBulkSharingPreheatMode
from ...models.sql_view_bulk_sharing_root_junction import SqlViewBulkSharingRootJunction
from ...models.sql_view_bulk_sharing_user_override_mode import SqlViewBulkSharingUserOverrideMode
...
def _get_kwargs(
    *,
    ...
    atomic_mode: Union[Unset, SqlViewBulkSharingAtomicMode] = SqlViewBulkSharingAtomicMode.ALL,
    flush_mode: Union[Unset, SqlViewBulkSharingFlushMode] = SqlViewBulkSharingFlushMode.AUTO,
    identifier: Union[Unset, SqlViewBulkSharingIdentifier] = SqlViewBulkSharingIdentifier.UID,
    import_mode: Union[Unset, SqlViewBulkSharingImportMode] = SqlViewBulkSharingImportMode.COMMIT,
    import_report_mode: Union[Unset, SqlViewBulkSharingImportReportMode] = SqlViewBulkSharingImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, SqlViewBulkSharingImportStrategy
    ] = SqlViewBulkSharingImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, SqlViewBulkSharingPreheatMode] = SqlViewBulkSharingPreheatMode.REFERENCE,
    root_junction: Union[Unset, SqlViewBulkSharingRootJunction] = UNSET,
    skip_sharing: Union[Unset, bool] = False,
    skip_translation: Union[Unset, bool] = False,
    skip_validation: Union[Unset, bool] = False,
    user: Union[Unset, str] = UNSET,
    user_override_mode: Union[Unset, SqlViewBulkSharingUserOverrideMode] = SqlViewBulkSharingUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, SqlViewBulkSharingAtomicMode]):  Default:
            SqlViewBulkSharingAtomicMode.ALL.
        flush_mode (Union[Unset, SqlViewBulkSharingFlushMode]):  Default:
            SqlViewBulkSharingFlushMode.AUTO.
        identifier (Union[Unset, SqlViewBulkSharingIdentifier]):  Default:
            SqlViewBulkSharingIdentifier.UID.
        import_mode (Union[Unset, SqlViewBulkSharingImportMode]):  Default:
            SqlViewBulkSharingImportMode.COMMIT.
        import_report_mode (Union[Unset, SqlViewBulkSharingImportReportMode]):  Default:
            SqlViewBulkSharingImportReportMode.ERRORS.
        import_strategy (Union[Unset, SqlViewBulkSharingImportStrategy]):  Default:
            SqlViewBulkSharingImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, SqlViewBulkSharingPreheatMode]):  Default:
            SqlViewBulkSharingPreheatMode.REFERENCE.
        root_junction (Union[Unset, SqlViewBulkSharingRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, SqlViewBulkSharingUserOverrideMode]):  Default:
            SqlViewBulkSharingUserOverrideMode.NONE.
        body (BulkJsonPatch):
