...
) -> Optional[Union[SchedulerQueue, WebMessage]]:
    if response.status_code == 200:
        response_200 = SchedulerQueue.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[SchedulerQueue, WebMessage]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[SchedulerQueue, WebMessage]
    """
