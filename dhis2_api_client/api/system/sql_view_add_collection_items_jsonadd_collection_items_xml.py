...
from ...models.sql_view_add_collection_items_jsonadd_collection_items_xml_property import (
    SqlViewAddCollectionItemsJsonaddCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: SqlViewAddCollectionItemsJsonaddCollectionItemsXmlProperty,
    *,
