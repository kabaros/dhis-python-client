...
from ...models.job_configuration_add_collection_items_jsonadd_collection_items_xml_property import (
    JobConfigurationAddCollectionItemsJsonaddCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: JobConfigurationAddCollectionItemsJsonaddCollectionItemsXmlProperty,
    *,
