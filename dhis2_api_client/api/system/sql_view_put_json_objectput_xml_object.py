...
from ...models.sql_view_put_json_objectput_xml_object_atomic_mode import SqlViewPutJsonObjectputXmlObjectAtomicMode
from ...models.sql_view_put_json_objectput_xml_object_flush_mode import SqlViewPutJsonObjectputXmlObjectFlushMode
from ...models.sql_view_put_json_objectput_xml_object_identifier import SqlViewPutJsonObjectputXmlObjectIdentifier
from ...models.sql_view_put_json_objectput_xml_object_import_mode import SqlViewPutJsonObjectputXmlObjectImportMode
from ...models.sql_view_put_json_objectput_xml_object_import_report_mode import (
    SqlViewPutJsonObjectputXmlObjectImportReportMode,
)
from ...models.sql_view_put_json_objectput_xml_object_import_strategy import (
    SqlViewPutJsonObjectputXmlObjectImportStrategy,
)
from ...models.sql_view_put_json_objectput_xml_object_preheat_mode import SqlViewPutJsonObjectputXmlObjectPreheatMode
from ...models.sql_view_put_json_objectput_xml_object_user_override_mode import (
    SqlViewPutJsonObjectputXmlObjectUserOverrideMode,
)
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[
        Unset, SqlViewPutJsonObjectputXmlObjectAtomicMode
    ] = SqlViewPutJsonObjectputXmlObjectAtomicMode.ALL,
    flush_mode: Union[
        Unset, SqlViewPutJsonObjectputXmlObjectFlushMode
    ] = SqlViewPutJsonObjectputXmlObjectFlushMode.AUTO,
    identifier: Union[
        Unset, SqlViewPutJsonObjectputXmlObjectIdentifier
    ] = SqlViewPutJsonObjectputXmlObjectIdentifier.UID,
    import_mode: Union[
        Unset, SqlViewPutJsonObjectputXmlObjectImportMode
    ] = SqlViewPutJsonObjectputXmlObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, SqlViewPutJsonObjectputXmlObjectImportReportMode
    ] = SqlViewPutJsonObjectputXmlObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, SqlViewPutJsonObjectputXmlObjectImportStrategy
    ] = SqlViewPutJsonObjectputXmlObjectImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    preheat_mode: Union[
        Unset, SqlViewPutJsonObjectputXmlObjectPreheatMode
    ] = SqlViewPutJsonObjectputXmlObjectPreheatMode.REFERENCE,
    ...
    user_override_mode: Union[
        Unset, SqlViewPutJsonObjectputXmlObjectUserOverrideMode
    ] = SqlViewPutJsonObjectputXmlObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        uid (str): A UID for an SqlView object
            (Java name `org.hisp.dhis.sqlview.SqlView`) Example: s9h8EN5VC4B.
        async_ (Union[Unset, bool]):  Default: False.
        atomic_mode (Union[Unset, SqlViewPutJsonObjectputXmlObjectAtomicMode]):  Default:
            SqlViewPutJsonObjectputXmlObjectAtomicMode.ALL.
        flush_mode (Union[Unset, SqlViewPutJsonObjectputXmlObjectFlushMode]):  Default:
            SqlViewPutJsonObjectputXmlObjectFlushMode.AUTO.
        identifier (Union[Unset, SqlViewPutJsonObjectputXmlObjectIdentifier]):  Default:
            SqlViewPutJsonObjectputXmlObjectIdentifier.UID.
        import_mode (Union[Unset, SqlViewPutJsonObjectputXmlObjectImportMode]):  Default:
            SqlViewPutJsonObjectputXmlObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, SqlViewPutJsonObjectputXmlObjectImportReportMode]):
            Default: SqlViewPutJsonObjectputXmlObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, SqlViewPutJsonObjectputXmlObjectImportStrategy]):  Default:
            SqlViewPutJsonObjectputXmlObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, SqlViewPutJsonObjectputXmlObjectPreheatMode]):  Default:
            SqlViewPutJsonObjectputXmlObjectPreheatMode.REFERENCE.
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, SqlViewPutJsonObjectputXmlObjectUserOverrideMode]):
            Default: SqlViewPutJsonObjectputXmlObjectUserOverrideMode.NONE.
        body (SqlView):
