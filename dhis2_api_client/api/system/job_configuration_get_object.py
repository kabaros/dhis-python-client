...
from ...models.job_configuration_get_object_root_junction import JobConfigurationGetObjectRootJunction
...
def _get_kwargs(
    ...
    *,
    ...
    root_junction: Union[Unset, JobConfigurationGetObjectRootJunction] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
) -> Optional[Union[JobConfiguration, WebMessage]]:
    if response.status_code == 200:
        response_200 = JobConfiguration.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[JobConfiguration, WebMessage]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, JobConfigurationGetObjectRootJunction]):
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[JobConfiguration, WebMessage]
    """
