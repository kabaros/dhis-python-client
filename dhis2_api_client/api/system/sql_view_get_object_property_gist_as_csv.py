...
from ...models.sql_view_get_object_property_gist_as_csv_auto import SqlViewGetObjectPropertyGistAsCsvAuto
from ...models.sql_view_get_object_property_gist_as_csv_property import SqlViewGetObjectPropertyGistAsCsvProperty
from ...models.sql_view_get_object_property_gist_as_csv_root_junction import (
    SqlViewGetObjectPropertyGistAsCsvRootJunction,
)
...
def _get_kwargs(
    uid: str,
    property_: SqlViewGetObjectPropertyGistAsCsvProperty,
    *,
    absolute_urls: Union[Unset, bool] = False,
    auto: Union[Unset, SqlViewGetObjectPropertyGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, SqlViewGetObjectPropertyGistAsCsvRootJunction
    ] = SqlViewGetObjectPropertyGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/sqlViews/{uid}/{property_}/gist.csv",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, SqlViewGetObjectPropertyGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, SqlViewGetObjectPropertyGistAsCsvRootJunction]):  Default:
            SqlViewGetObjectPropertyGistAsCsvRootJunction.AND.
