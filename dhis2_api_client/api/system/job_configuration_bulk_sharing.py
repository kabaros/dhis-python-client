...
from ...models.job_configuration_bulk_sharing_atomic_mode import JobConfigurationBulkSharingAtomicMode
from ...models.job_configuration_bulk_sharing_flush_mode import JobConfigurationBulkSharingFlushMode
from ...models.job_configuration_bulk_sharing_identifier import JobConfigurationBulkSharingIdentifier
from ...models.job_configuration_bulk_sharing_import_mode import JobConfigurationBulkSharingImportMode
from ...models.job_configuration_bulk_sharing_import_report_mode import JobConfigurationBulkSharingImportReportMode
from ...models.job_configuration_bulk_sharing_import_strategy import JobConfigurationBulkSharingImportStrategy
from ...models.job_configuration_bulk_sharing_preheat_mode import JobConfigurationBulkSharingPreheatMode
from ...models.job_configuration_bulk_sharing_root_junction import JobConfigurationBulkSharingRootJunction
from ...models.job_configuration_bulk_sharing_user_override_mode import JobConfigurationBulkSharingUserOverrideMode
...
def _get_kwargs(
    *,
    ...
    atomic_mode: Union[Unset, JobConfigurationBulkSharingAtomicMode] = JobConfigurationBulkSharingAtomicMode.ALL,
    flush_mode: Union[Unset, JobConfigurationBulkSharingFlushMode] = JobConfigurationBulkSharingFlushMode.AUTO,
    identifier: Union[Unset, JobConfigurationBulkSharingIdentifier] = JobConfigurationBulkSharingIdentifier.UID,
    import_mode: Union[Unset, JobConfigurationBulkSharingImportMode] = JobConfigurationBulkSharingImportMode.COMMIT,
    import_report_mode: Union[
        Unset, JobConfigurationBulkSharingImportReportMode
    ] = JobConfigurationBulkSharingImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, JobConfigurationBulkSharingImportStrategy
    ] = JobConfigurationBulkSharingImportStrategy.CREATE_AND_UPDATE,
    ...
    preheat_mode: Union[
        Unset, JobConfigurationBulkSharingPreheatMode
    ] = JobConfigurationBulkSharingPreheatMode.REFERENCE,
    root_junction: Union[Unset, JobConfigurationBulkSharingRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, JobConfigurationBulkSharingUserOverrideMode
    ] = JobConfigurationBulkSharingUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, JobConfigurationBulkSharingAtomicMode]):  Default:
            JobConfigurationBulkSharingAtomicMode.ALL.
        flush_mode (Union[Unset, JobConfigurationBulkSharingFlushMode]):  Default:
            JobConfigurationBulkSharingFlushMode.AUTO.
        identifier (Union[Unset, JobConfigurationBulkSharingIdentifier]):  Default:
            JobConfigurationBulkSharingIdentifier.UID.
        import_mode (Union[Unset, JobConfigurationBulkSharingImportMode]):  Default:
            JobConfigurationBulkSharingImportMode.COMMIT.
        import_report_mode (Union[Unset, JobConfigurationBulkSharingImportReportMode]):  Default:
            JobConfigurationBulkSharingImportReportMode.ERRORS.
        import_strategy (Union[Unset, JobConfigurationBulkSharingImportStrategy]):  Default:
            JobConfigurationBulkSharingImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, JobConfigurationBulkSharingPreheatMode]):  Default:
            JobConfigurationBulkSharingPreheatMode.REFERENCE.
        root_junction (Union[Unset, JobConfigurationBulkSharingRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, JobConfigurationBulkSharingUserOverrideMode]):  Default:
            JobConfigurationBulkSharingUserOverrideMode.NONE.
        body (BulkJsonPatch):
