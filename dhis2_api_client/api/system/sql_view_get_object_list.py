...
from ...models.sql_view_get_object_list_response_200 import SqlViewGetObjectListResponse200
from ...models.sql_view_get_object_list_root_junction import SqlViewGetObjectListRootJunction
...
def _get_kwargs(
    *,
    ...
    root_junction: Union[Unset, SqlViewGetObjectListRootJunction] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
) -> Optional[Union[SqlViewGetObjectListResponse200, WebMessage]]:
    if response.status_code == 200:
        response_200 = SqlViewGetObjectListResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[SqlViewGetObjectListResponse200, WebMessage]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, SqlViewGetObjectListRootJunction]):
...
def sync(
    *,
    ...
    Returns:
        Union[SqlViewGetObjectListResponse200, WebMessage]
    """
