...
from ...models.file_resource_get_object_list_csv_root_junction import FileResourceGetObjectListCsvRootJunction
...
def _get_kwargs(
    *,
    ...
    root_junction: Union[Unset, FileResourceGetObjectListCsvRootJunction] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/fileResources/#getObjectListCsv",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, FileResourceGetObjectListCsvRootJunction]):
