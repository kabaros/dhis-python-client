...
from ...models.sql_view_post_json_objectpost_xml_object_atomic_mode import SqlViewPostJsonObjectpostXmlObjectAtomicMode
from ...models.sql_view_post_json_objectpost_xml_object_flush_mode import SqlViewPostJsonObjectpostXmlObjectFlushMode
from ...models.sql_view_post_json_objectpost_xml_object_identifier import SqlViewPostJsonObjectpostXmlObjectIdentifier
from ...models.sql_view_post_json_objectpost_xml_object_import_mode import SqlViewPostJsonObjectpostXmlObjectImportMode
from ...models.sql_view_post_json_objectpost_xml_object_import_report_mode import (
    SqlViewPostJsonObjectpostXmlObjectImportReportMode,
)
from ...models.sql_view_post_json_objectpost_xml_object_import_strategy import (
    SqlViewPostJsonObjectpostXmlObjectImportStrategy,
)
from ...models.sql_view_post_json_objectpost_xml_object_preheat_mode import (
    SqlViewPostJsonObjectpostXmlObjectPreheatMode,
)
from ...models.sql_view_post_json_objectpost_xml_object_user_override_mode import (
    SqlViewPostJsonObjectpostXmlObjectUserOverrideMode,
)
...
def _get_kwargs(
    *,
    ...
    atomic_mode: Union[
        Unset, SqlViewPostJsonObjectpostXmlObjectAtomicMode
    ] = SqlViewPostJsonObjectpostXmlObjectAtomicMode.ALL,
    flush_mode: Union[
        Unset, SqlViewPostJsonObjectpostXmlObjectFlushMode
    ] = SqlViewPostJsonObjectpostXmlObjectFlushMode.AUTO,
    identifier: Union[
        Unset, SqlViewPostJsonObjectpostXmlObjectIdentifier
    ] = SqlViewPostJsonObjectpostXmlObjectIdentifier.UID,
    import_mode: Union[
        Unset, SqlViewPostJsonObjectpostXmlObjectImportMode
    ] = SqlViewPostJsonObjectpostXmlObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, SqlViewPostJsonObjectpostXmlObjectImportReportMode
    ] = SqlViewPostJsonObjectpostXmlObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, SqlViewPostJsonObjectpostXmlObjectImportStrategy
    ] = SqlViewPostJsonObjectpostXmlObjectImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    preheat_mode: Union[
        Unset, SqlViewPostJsonObjectpostXmlObjectPreheatMode
    ] = SqlViewPostJsonObjectpostXmlObjectPreheatMode.REFERENCE,
    ...
    user_override_mode: Union[
        Unset, SqlViewPostJsonObjectpostXmlObjectUserOverrideMode
    ] = SqlViewPostJsonObjectpostXmlObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, SqlViewPostJsonObjectpostXmlObjectAtomicMode]):  Default:
            SqlViewPostJsonObjectpostXmlObjectAtomicMode.ALL.
        flush_mode (Union[Unset, SqlViewPostJsonObjectpostXmlObjectFlushMode]):  Default:
            SqlViewPostJsonObjectpostXmlObjectFlushMode.AUTO.
        identifier (Union[Unset, SqlViewPostJsonObjectpostXmlObjectIdentifier]):  Default:
            SqlViewPostJsonObjectpostXmlObjectIdentifier.UID.
        import_mode (Union[Unset, SqlViewPostJsonObjectpostXmlObjectImportMode]):  Default:
            SqlViewPostJsonObjectpostXmlObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, SqlViewPostJsonObjectpostXmlObjectImportReportMode]):
            Default: SqlViewPostJsonObjectpostXmlObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, SqlViewPostJsonObjectpostXmlObjectImportStrategy]):
            Default: SqlViewPostJsonObjectpostXmlObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, SqlViewPostJsonObjectpostXmlObjectPreheatMode]):  Default:
            SqlViewPostJsonObjectpostXmlObjectPreheatMode.REFERENCE.
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, SqlViewPostJsonObjectpostXmlObjectUserOverrideMode]):
            Default: SqlViewPostJsonObjectpostXmlObjectUserOverrideMode.NONE.
        body (SqlView):
