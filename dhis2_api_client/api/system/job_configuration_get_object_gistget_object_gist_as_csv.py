...
from ...models.job_configuration_get_object_gistget_object_gist_as_csv_auto import (
    JobConfigurationGetObjectGistgetObjectGistAsCsvAuto,
)
from ...models.job_configuration_get_object_gistget_object_gist_as_csv_response_200 import (
    JobConfigurationGetObjectGistgetObjectGistAsCsvResponse200,
)
from ...models.job_configuration_get_object_gistget_object_gist_as_csv_root_junction import (
    JobConfigurationGetObjectGistgetObjectGistAsCsvRootJunction,
)
...
def _get_kwargs(
    ...
    *,
    ...
    auto: Union[Unset, JobConfigurationGetObjectGistgetObjectGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, JobConfigurationGetObjectGistgetObjectGistAsCsvRootJunction
    ] = JobConfigurationGetObjectGistgetObjectGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/jobConfigurations/{uid}/gist",
        "params": params,
    }
...
) -> Optional[Union[JobConfigurationGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]]:
    if response.status_code == 200:
        response_200 = JobConfigurationGetObjectGistgetObjectGistAsCsvResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[JobConfigurationGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, JobConfigurationGetObjectGistgetObjectGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, JobConfigurationGetObjectGistgetObjectGistAsCsvRootJunction]):
            Default: JobConfigurationGetObjectGistgetObjectGistAsCsvRootJunction.AND.
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[JobConfigurationGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]
    """
