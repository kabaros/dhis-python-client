...
from ...models.job_configuration_delete_collection_items_jsondelete_collection_items_xml_property import (
    JobConfigurationDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: JobConfigurationDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
    *,
