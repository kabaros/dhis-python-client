...
from ...models.job_configuration_add_collection_item_property import JobConfigurationAddCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: JobConfigurationAddCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
