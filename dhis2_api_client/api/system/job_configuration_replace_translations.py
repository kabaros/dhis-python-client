...
from ...models.job_configuration_replace_translations_body import JobConfigurationReplaceTranslationsBody
...
def _get_kwargs(
    uid: str,
    *,
    body: JobConfigurationReplaceTranslationsBody,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": f"/jobConfigurations/{uid}/translations",
    }
