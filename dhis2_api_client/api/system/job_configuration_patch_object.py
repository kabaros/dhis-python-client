...
from ...models.job_configuration_patch_object_atomic_mode import JobConfigurationPatchObjectAtomicMode
from ...models.job_configuration_patch_object_flush_mode import JobConfigurationPatchObjectFlushMode
from ...models.job_configuration_patch_object_identifier import JobConfigurationPatchObjectIdentifier
from ...models.job_configuration_patch_object_import_mode import JobConfigurationPatchObjectImportMode
from ...models.job_configuration_patch_object_import_report_mode import JobConfigurationPatchObjectImportReportMode
from ...models.job_configuration_patch_object_import_strategy import JobConfigurationPatchObjectImportStrategy
from ...models.job_configuration_patch_object_preheat_mode import JobConfigurationPatchObjectPreheatMode
from ...models.job_configuration_patch_object_root_junction import JobConfigurationPatchObjectRootJunction
from ...models.job_configuration_patch_object_user_override_mode import JobConfigurationPatchObjectUserOverrideMode
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[Unset, JobConfigurationPatchObjectAtomicMode] = JobConfigurationPatchObjectAtomicMode.ALL,
    flush_mode: Union[Unset, JobConfigurationPatchObjectFlushMode] = JobConfigurationPatchObjectFlushMode.AUTO,
    identifier: Union[Unset, JobConfigurationPatchObjectIdentifier] = JobConfigurationPatchObjectIdentifier.UID,
    import_mode: Union[Unset, JobConfigurationPatchObjectImportMode] = JobConfigurationPatchObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, JobConfigurationPatchObjectImportReportMode
    ] = JobConfigurationPatchObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, JobConfigurationPatchObjectImportStrategy
    ] = JobConfigurationPatchObjectImportStrategy.CREATE_AND_UPDATE,
    ...
    preheat_mode: Union[
        Unset, JobConfigurationPatchObjectPreheatMode
    ] = JobConfigurationPatchObjectPreheatMode.REFERENCE,
    root_junction: Union[Unset, JobConfigurationPatchObjectRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, JobConfigurationPatchObjectUserOverrideMode
    ] = JobConfigurationPatchObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, JobConfigurationPatchObjectAtomicMode]):  Default:
            JobConfigurationPatchObjectAtomicMode.ALL.
        flush_mode (Union[Unset, JobConfigurationPatchObjectFlushMode]):  Default:
            JobConfigurationPatchObjectFlushMode.AUTO.
        identifier (Union[Unset, JobConfigurationPatchObjectIdentifier]):  Default:
            JobConfigurationPatchObjectIdentifier.UID.
        import_mode (Union[Unset, JobConfigurationPatchObjectImportMode]):  Default:
            JobConfigurationPatchObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, JobConfigurationPatchObjectImportReportMode]):  Default:
            JobConfigurationPatchObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, JobConfigurationPatchObjectImportStrategy]):  Default:
            JobConfigurationPatchObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, JobConfigurationPatchObjectPreheatMode]):  Default:
            JobConfigurationPatchObjectPreheatMode.REFERENCE.
        root_junction (Union[Unset, JobConfigurationPatchObjectRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, JobConfigurationPatchObjectUserOverrideMode]):  Default:
            JobConfigurationPatchObjectUserOverrideMode.NONE.
        body (JsonPatch):
