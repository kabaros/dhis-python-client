...
from ...models.program_message_bulk_sharing_atomic_mode import ProgramMessageBulkSharingAtomicMode
from ...models.program_message_bulk_sharing_flush_mode import ProgramMessageBulkSharingFlushMode
from ...models.program_message_bulk_sharing_identifier import ProgramMessageBulkSharingIdentifier
from ...models.program_message_bulk_sharing_import_mode import ProgramMessageBulkSharingImportMode
from ...models.program_message_bulk_sharing_import_report_mode import ProgramMessageBulkSharingImportReportMode
from ...models.program_message_bulk_sharing_import_strategy import ProgramMessageBulkSharingImportStrategy
from ...models.program_message_bulk_sharing_preheat_mode import ProgramMessageBulkSharingPreheatMode
from ...models.program_message_bulk_sharing_root_junction import ProgramMessageBulkSharingRootJunction
from ...models.program_message_bulk_sharing_user_override_mode import ProgramMessageBulkSharingUserOverrideMode
...
def _get_kwargs(
    *,
    ...
    atomic_mode: Union[Unset, ProgramMessageBulkSharingAtomicMode] = ProgramMessageBulkSharingAtomicMode.ALL,
    flush_mode: Union[Unset, ProgramMessageBulkSharingFlushMode] = ProgramMessageBulkSharingFlushMode.AUTO,
    identifier: Union[Unset, ProgramMessageBulkSharingIdentifier] = ProgramMessageBulkSharingIdentifier.UID,
    import_mode: Union[Unset, ProgramMessageBulkSharingImportMode] = ProgramMessageBulkSharingImportMode.COMMIT,
    import_report_mode: Union[
        Unset, ProgramMessageBulkSharingImportReportMode
    ] = ProgramMessageBulkSharingImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, ProgramMessageBulkSharingImportStrategy
    ] = ProgramMessageBulkSharingImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, ProgramMessageBulkSharingPreheatMode] = ProgramMessageBulkSharingPreheatMode.REFERENCE,
    root_junction: Union[Unset, ProgramMessageBulkSharingRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, ProgramMessageBulkSharingUserOverrideMode
    ] = ProgramMessageBulkSharingUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, ProgramMessageBulkSharingAtomicMode]):  Default:
            ProgramMessageBulkSharingAtomicMode.ALL.
        flush_mode (Union[Unset, ProgramMessageBulkSharingFlushMode]):  Default:
            ProgramMessageBulkSharingFlushMode.AUTO.
        identifier (Union[Unset, ProgramMessageBulkSharingIdentifier]):  Default:
            ProgramMessageBulkSharingIdentifier.UID.
        import_mode (Union[Unset, ProgramMessageBulkSharingImportMode]):  Default:
            ProgramMessageBulkSharingImportMode.COMMIT.
        import_report_mode (Union[Unset, ProgramMessageBulkSharingImportReportMode]):  Default:
            ProgramMessageBulkSharingImportReportMode.ERRORS.
        import_strategy (Union[Unset, ProgramMessageBulkSharingImportStrategy]):  Default:
            ProgramMessageBulkSharingImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, ProgramMessageBulkSharingPreheatMode]):  Default:
            ProgramMessageBulkSharingPreheatMode.REFERENCE.
        root_junction (Union[Unset, ProgramMessageBulkSharingRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, ProgramMessageBulkSharingUserOverrideMode]):  Default:
            ProgramMessageBulkSharingUserOverrideMode.NONE.
        body (BulkJsonPatch):
