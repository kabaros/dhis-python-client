...
from ...models.data_set_notification_template_get_object_list_csv_root_junction import (
    DataSetNotificationTemplateGetObjectListCsvRootJunction,
)
...
def _get_kwargs(
    *,
    ...
    root_junction: Union[Unset, DataSetNotificationTemplateGetObjectListCsvRootJunction] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/dataSetNotificationTemplates/#getObjectListCsv",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, DataSetNotificationTemplateGetObjectListCsvRootJunction]):
