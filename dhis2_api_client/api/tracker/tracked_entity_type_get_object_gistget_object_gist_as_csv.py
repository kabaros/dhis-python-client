...
from ...models.tracked_entity_type_get_object_gistget_object_gist_as_csv_auto import (
    TrackedEntityTypeGetObjectGistgetObjectGistAsCsvAuto,
)
from ...models.tracked_entity_type_get_object_gistget_object_gist_as_csv_response_200 import (
    TrackedEntityTypeGetObjectGistgetObjectGistAsCsvResponse200,
)
from ...models.tracked_entity_type_get_object_gistget_object_gist_as_csv_root_junction import (
    TrackedEntityTypeGetObjectGistgetObjectGistAsCsvRootJunction,
)
...
def _get_kwargs(
    ...
    *,
    ...
    auto: Union[Unset, TrackedEntityTypeGetObjectGistgetObjectGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, TrackedEntityTypeGetObjectGistgetObjectGistAsCsvRootJunction
    ] = TrackedEntityTypeGetObjectGistgetObjectGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/trackedEntityTypes/{uid}/gist",
        "params": params,
    }
...
) -> Optional[Union[TrackedEntityTypeGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]]:
    if response.status_code == 200:
        response_200 = TrackedEntityTypeGetObjectGistgetObjectGistAsCsvResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[TrackedEntityTypeGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, TrackedEntityTypeGetObjectGistgetObjectGistAsCsvAuto]):
        ...
        root_junction (Union[Unset,
            TrackedEntityTypeGetObjectGistgetObjectGistAsCsvRootJunction]):  Default:
            TrackedEntityTypeGetObjectGistgetObjectGistAsCsvRootJunction.AND.
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[TrackedEntityTypeGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]
    """
