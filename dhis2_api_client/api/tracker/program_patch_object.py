...
from ...models.program_patch_object_atomic_mode import ProgramPatchObjectAtomicMode
from ...models.program_patch_object_flush_mode import ProgramPatchObjectFlushMode
from ...models.program_patch_object_identifier import ProgramPatchObjectIdentifier
from ...models.program_patch_object_import_mode import ProgramPatchObjectImportMode
from ...models.program_patch_object_import_report_mode import ProgramPatchObjectImportReportMode
from ...models.program_patch_object_import_strategy import ProgramPatchObjectImportStrategy
from ...models.program_patch_object_preheat_mode import ProgramPatchObjectPreheatMode
from ...models.program_patch_object_root_junction import ProgramPatchObjectRootJunction
from ...models.program_patch_object_user_override_mode import ProgramPatchObjectUserOverrideMode
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[Unset, ProgramPatchObjectAtomicMode] = ProgramPatchObjectAtomicMode.ALL,
    flush_mode: Union[Unset, ProgramPatchObjectFlushMode] = ProgramPatchObjectFlushMode.AUTO,
    identifier: Union[Unset, ProgramPatchObjectIdentifier] = ProgramPatchObjectIdentifier.UID,
    import_mode: Union[Unset, ProgramPatchObjectImportMode] = ProgramPatchObjectImportMode.COMMIT,
    import_report_mode: Union[Unset, ProgramPatchObjectImportReportMode] = ProgramPatchObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, ProgramPatchObjectImportStrategy
    ] = ProgramPatchObjectImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, ProgramPatchObjectPreheatMode] = ProgramPatchObjectPreheatMode.REFERENCE,
    root_junction: Union[Unset, ProgramPatchObjectRootJunction] = UNSET,
    skip_sharing: Union[Unset, bool] = False,
    skip_translation: Union[Unset, bool] = False,
    skip_validation: Union[Unset, bool] = False,
    user: Union[Unset, str] = UNSET,
    user_override_mode: Union[Unset, ProgramPatchObjectUserOverrideMode] = ProgramPatchObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, ProgramPatchObjectAtomicMode]):  Default:
            ProgramPatchObjectAtomicMode.ALL.
        flush_mode (Union[Unset, ProgramPatchObjectFlushMode]):  Default:
            ProgramPatchObjectFlushMode.AUTO.
        identifier (Union[Unset, ProgramPatchObjectIdentifier]):  Default:
            ProgramPatchObjectIdentifier.UID.
        import_mode (Union[Unset, ProgramPatchObjectImportMode]):  Default:
            ProgramPatchObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, ProgramPatchObjectImportReportMode]):  Default:
            ProgramPatchObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, ProgramPatchObjectImportStrategy]):  Default:
            ProgramPatchObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, ProgramPatchObjectPreheatMode]):  Default:
            ProgramPatchObjectPreheatMode.REFERENCE.
        root_junction (Union[Unset, ProgramPatchObjectRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, ProgramPatchObjectUserOverrideMode]):  Default:
            ProgramPatchObjectUserOverrideMode.NONE.
        body (JsonPatch):
