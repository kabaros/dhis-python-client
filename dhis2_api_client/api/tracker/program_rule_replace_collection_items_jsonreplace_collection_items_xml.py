...
from ...models.program_rule_replace_collection_items_jsonreplace_collection_items_xml_property import (
    ProgramRuleReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: ProgramRuleReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
    *,
