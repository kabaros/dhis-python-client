...
from ...models.program_rule_action_replace_translations_body import ProgramRuleActionReplaceTranslationsBody
...
def _get_kwargs(
    uid: str,
    *,
    body: ProgramRuleActionReplaceTranslationsBody,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": f"/programRuleActions/{uid}/translations",
    }
