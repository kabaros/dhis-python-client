...
from ...models.program_indicator_patch_object_atomic_mode import ProgramIndicatorPatchObjectAtomicMode
from ...models.program_indicator_patch_object_flush_mode import ProgramIndicatorPatchObjectFlushMode
from ...models.program_indicator_patch_object_identifier import ProgramIndicatorPatchObjectIdentifier
from ...models.program_indicator_patch_object_import_mode import ProgramIndicatorPatchObjectImportMode
from ...models.program_indicator_patch_object_import_report_mode import ProgramIndicatorPatchObjectImportReportMode
from ...models.program_indicator_patch_object_import_strategy import ProgramIndicatorPatchObjectImportStrategy
from ...models.program_indicator_patch_object_preheat_mode import ProgramIndicatorPatchObjectPreheatMode
from ...models.program_indicator_patch_object_root_junction import ProgramIndicatorPatchObjectRootJunction
from ...models.program_indicator_patch_object_user_override_mode import ProgramIndicatorPatchObjectUserOverrideMode
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[Unset, ProgramIndicatorPatchObjectAtomicMode] = ProgramIndicatorPatchObjectAtomicMode.ALL,
    flush_mode: Union[Unset, ProgramIndicatorPatchObjectFlushMode] = ProgramIndicatorPatchObjectFlushMode.AUTO,
    identifier: Union[Unset, ProgramIndicatorPatchObjectIdentifier] = ProgramIndicatorPatchObjectIdentifier.UID,
    import_mode: Union[Unset, ProgramIndicatorPatchObjectImportMode] = ProgramIndicatorPatchObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, ProgramIndicatorPatchObjectImportReportMode
    ] = ProgramIndicatorPatchObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, ProgramIndicatorPatchObjectImportStrategy
    ] = ProgramIndicatorPatchObjectImportStrategy.CREATE_AND_UPDATE,
    ...
    preheat_mode: Union[
        Unset, ProgramIndicatorPatchObjectPreheatMode
    ] = ProgramIndicatorPatchObjectPreheatMode.REFERENCE,
    root_junction: Union[Unset, ProgramIndicatorPatchObjectRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, ProgramIndicatorPatchObjectUserOverrideMode
    ] = ProgramIndicatorPatchObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, ProgramIndicatorPatchObjectAtomicMode]):  Default:
            ProgramIndicatorPatchObjectAtomicMode.ALL.
        flush_mode (Union[Unset, ProgramIndicatorPatchObjectFlushMode]):  Default:
            ProgramIndicatorPatchObjectFlushMode.AUTO.
        identifier (Union[Unset, ProgramIndicatorPatchObjectIdentifier]):  Default:
            ProgramIndicatorPatchObjectIdentifier.UID.
        import_mode (Union[Unset, ProgramIndicatorPatchObjectImportMode]):  Default:
            ProgramIndicatorPatchObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, ProgramIndicatorPatchObjectImportReportMode]):  Default:
            ProgramIndicatorPatchObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, ProgramIndicatorPatchObjectImportStrategy]):  Default:
            ProgramIndicatorPatchObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, ProgramIndicatorPatchObjectPreheatMode]):  Default:
            ProgramIndicatorPatchObjectPreheatMode.REFERENCE.
        root_junction (Union[Unset, ProgramIndicatorPatchObjectRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, ProgramIndicatorPatchObjectUserOverrideMode]):  Default:
            ProgramIndicatorPatchObjectUserOverrideMode.NONE.
        body (JsonPatch):
