...
from ...models.tracked_entity_type_add_collection_item_property import TrackedEntityTypeAddCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: TrackedEntityTypeAddCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
