...
from ...models.program_stage_working_list_add_collection_item_property import (
    ProgramStageWorkingListAddCollectionItemProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: ProgramStageWorkingListAddCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
