...
from ...models.tracked_entity_filter_delete_collection_items_jsondelete_collection_items_xml_property import (
    TrackedEntityFilterDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: TrackedEntityFilterDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
    *,
