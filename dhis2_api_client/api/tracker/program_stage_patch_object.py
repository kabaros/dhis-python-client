...
from ...models.program_stage_patch_object_atomic_mode import ProgramStagePatchObjectAtomicMode
from ...models.program_stage_patch_object_flush_mode import ProgramStagePatchObjectFlushMode
from ...models.program_stage_patch_object_identifier import ProgramStagePatchObjectIdentifier
from ...models.program_stage_patch_object_import_mode import ProgramStagePatchObjectImportMode
from ...models.program_stage_patch_object_import_report_mode import ProgramStagePatchObjectImportReportMode
from ...models.program_stage_patch_object_import_strategy import ProgramStagePatchObjectImportStrategy
from ...models.program_stage_patch_object_preheat_mode import ProgramStagePatchObjectPreheatMode
from ...models.program_stage_patch_object_root_junction import ProgramStagePatchObjectRootJunction
from ...models.program_stage_patch_object_user_override_mode import ProgramStagePatchObjectUserOverrideMode
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[Unset, ProgramStagePatchObjectAtomicMode] = ProgramStagePatchObjectAtomicMode.ALL,
    flush_mode: Union[Unset, ProgramStagePatchObjectFlushMode] = ProgramStagePatchObjectFlushMode.AUTO,
    identifier: Union[Unset, ProgramStagePatchObjectIdentifier] = ProgramStagePatchObjectIdentifier.UID,
    import_mode: Union[Unset, ProgramStagePatchObjectImportMode] = ProgramStagePatchObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, ProgramStagePatchObjectImportReportMode
    ] = ProgramStagePatchObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, ProgramStagePatchObjectImportStrategy
    ] = ProgramStagePatchObjectImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, ProgramStagePatchObjectPreheatMode] = ProgramStagePatchObjectPreheatMode.REFERENCE,
    root_junction: Union[Unset, ProgramStagePatchObjectRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, ProgramStagePatchObjectUserOverrideMode
    ] = ProgramStagePatchObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, ProgramStagePatchObjectAtomicMode]):  Default:
            ProgramStagePatchObjectAtomicMode.ALL.
        flush_mode (Union[Unset, ProgramStagePatchObjectFlushMode]):  Default:
            ProgramStagePatchObjectFlushMode.AUTO.
        identifier (Union[Unset, ProgramStagePatchObjectIdentifier]):  Default:
            ProgramStagePatchObjectIdentifier.UID.
        import_mode (Union[Unset, ProgramStagePatchObjectImportMode]):  Default:
            ProgramStagePatchObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, ProgramStagePatchObjectImportReportMode]):  Default:
            ProgramStagePatchObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, ProgramStagePatchObjectImportStrategy]):  Default:
            ProgramStagePatchObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, ProgramStagePatchObjectPreheatMode]):  Default:
            ProgramStagePatchObjectPreheatMode.REFERENCE.
        root_junction (Union[Unset, ProgramStagePatchObjectRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, ProgramStagePatchObjectUserOverrideMode]):  Default:
            ProgramStagePatchObjectUserOverrideMode.NONE.
        body (JsonPatch):
