...
from ...models.program_stage_replace_translations_body import ProgramStageReplaceTranslationsBody
...
def _get_kwargs(
    uid: str,
    *,
    body: ProgramStageReplaceTranslationsBody,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": f"/programStages/{uid}/translations",
    }
