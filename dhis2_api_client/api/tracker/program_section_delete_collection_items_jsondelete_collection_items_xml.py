...
from ...models.program_section_delete_collection_items_jsondelete_collection_items_xml_property import (
    ProgramSectionDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: ProgramSectionDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
    *,
