...
from ...models.relationship_type_get_object_list_response_200 import RelationshipTypeGetObjectListResponse200
from ...models.relationship_type_get_object_list_root_junction import RelationshipTypeGetObjectListRootJunction
...
def _get_kwargs(
    *,
    ...
    root_junction: Union[Unset, RelationshipTypeGetObjectListRootJunction] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
) -> Optional[Union[RelationshipTypeGetObjectListResponse200, WebMessage]]:
    if response.status_code == 200:
        response_200 = RelationshipTypeGetObjectListResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RelationshipTypeGetObjectListResponse200, WebMessage]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, RelationshipTypeGetObjectListRootJunction]):
...
def sync(
    *,
    ...
    Returns:
        Union[RelationshipTypeGetObjectListResponse200, WebMessage]
    """
