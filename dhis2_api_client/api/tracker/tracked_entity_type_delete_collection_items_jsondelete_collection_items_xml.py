...
from ...models.tracked_entity_type_delete_collection_items_jsondelete_collection_items_xml_property import (
    TrackedEntityTypeDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: TrackedEntityTypeDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
    *,
