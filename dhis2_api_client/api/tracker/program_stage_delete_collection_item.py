...
from ...models.program_stage_delete_collection_item_property import ProgramStageDeleteCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: ProgramStageDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/programStages/{uid}/{property_}/{item_id}",
    }
