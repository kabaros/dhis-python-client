...
from ...models.program_get_object_list_csv_root_junction import ProgramGetObjectListCsvRootJunction
...
def _get_kwargs(
    *,
    ...
    root_junction: Union[Unset, ProgramGetObjectListCsvRootJunction] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, ProgramGetObjectListCsvRootJunction]):
