...
from ...models.program_message_get_object_list_csv_root_junction import ProgramMessageGetObjectListCsvRootJunction
...
def _get_kwargs(
    *,
    ...
    root_junction: Union[Unset, ProgramMessageGetObjectListCsvRootJunction] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, ProgramMessageGetObjectListCsvRootJunction]):
