...
from ...models.data_set_notification_template_delete_collection_item_property import (
    DataSetNotificationTemplateDeleteCollectionItemProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: DataSetNotificationTemplateDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/dataSetNotificationTemplates/{uid}/{property_}/{item_id}",
    }
