...
) -> Optional[Union[TrackerEvent, WebMessage]]:
    if response.status_code == 200:
        response_200 = TrackerEvent.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[TrackerEvent, WebMessage]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        uid (str): A UID for an TrackerEvent object
