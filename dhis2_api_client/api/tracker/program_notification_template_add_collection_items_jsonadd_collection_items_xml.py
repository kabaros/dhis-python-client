...
from ...models.program_notification_template_add_collection_items_jsonadd_collection_items_xml_property import (
    ProgramNotificationTemplateAddCollectionItemsJsonaddCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: ProgramNotificationTemplateAddCollectionItemsJsonaddCollectionItemsXmlProperty,
    *,
