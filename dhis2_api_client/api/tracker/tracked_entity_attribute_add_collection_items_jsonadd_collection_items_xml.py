...
from ...models.tracked_entity_attribute_add_collection_items_jsonadd_collection_items_xml_property import (
    TrackedEntityAttributeAddCollectionItemsJsonaddCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: TrackedEntityAttributeAddCollectionItemsJsonaddCollectionItemsXmlProperty,
    *,
