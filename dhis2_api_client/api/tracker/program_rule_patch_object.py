...
from ...models.program_rule_patch_object_atomic_mode import ProgramRulePatchObjectAtomicMode
from ...models.program_rule_patch_object_flush_mode import ProgramRulePatchObjectFlushMode
from ...models.program_rule_patch_object_identifier import ProgramRulePatchObjectIdentifier
from ...models.program_rule_patch_object_import_mode import ProgramRulePatchObjectImportMode
from ...models.program_rule_patch_object_import_report_mode import ProgramRulePatchObjectImportReportMode
from ...models.program_rule_patch_object_import_strategy import ProgramRulePatchObjectImportStrategy
from ...models.program_rule_patch_object_preheat_mode import ProgramRulePatchObjectPreheatMode
from ...models.program_rule_patch_object_root_junction import ProgramRulePatchObjectRootJunction
from ...models.program_rule_patch_object_user_override_mode import ProgramRulePatchObjectUserOverrideMode
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[Unset, ProgramRulePatchObjectAtomicMode] = ProgramRulePatchObjectAtomicMode.ALL,
    flush_mode: Union[Unset, ProgramRulePatchObjectFlushMode] = ProgramRulePatchObjectFlushMode.AUTO,
    identifier: Union[Unset, ProgramRulePatchObjectIdentifier] = ProgramRulePatchObjectIdentifier.UID,
    import_mode: Union[Unset, ProgramRulePatchObjectImportMode] = ProgramRulePatchObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, ProgramRulePatchObjectImportReportMode
    ] = ProgramRulePatchObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, ProgramRulePatchObjectImportStrategy
    ] = ProgramRulePatchObjectImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, ProgramRulePatchObjectPreheatMode] = ProgramRulePatchObjectPreheatMode.REFERENCE,
    root_junction: Union[Unset, ProgramRulePatchObjectRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, ProgramRulePatchObjectUserOverrideMode
    ] = ProgramRulePatchObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, ProgramRulePatchObjectAtomicMode]):  Default:
            ProgramRulePatchObjectAtomicMode.ALL.
        flush_mode (Union[Unset, ProgramRulePatchObjectFlushMode]):  Default:
            ProgramRulePatchObjectFlushMode.AUTO.
        identifier (Union[Unset, ProgramRulePatchObjectIdentifier]):  Default:
            ProgramRulePatchObjectIdentifier.UID.
        import_mode (Union[Unset, ProgramRulePatchObjectImportMode]):  Default:
            ProgramRulePatchObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, ProgramRulePatchObjectImportReportMode]):  Default:
            ProgramRulePatchObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, ProgramRulePatchObjectImportStrategy]):  Default:
            ProgramRulePatchObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, ProgramRulePatchObjectPreheatMode]):  Default:
            ProgramRulePatchObjectPreheatMode.REFERENCE.
        root_junction (Union[Unset, ProgramRulePatchObjectRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, ProgramRulePatchObjectUserOverrideMode]):  Default:
            ProgramRulePatchObjectUserOverrideMode.NONE.
        body (JsonPatch):
