...
from ...models.program_indicator_group_add_collection_item_property import (
    ProgramIndicatorGroupAddCollectionItemProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: ProgramIndicatorGroupAddCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
