...
from ...models.relationship_update_relationship_jsonupdate_relationship_xml_import_strategy import (
    RelationshipUpdateRelationshipJsonupdateRelationshipXmlImportStrategy,
)
from ...models.relationship_update_relationship_jsonupdate_relationship_xml_merge_mode import (
    RelationshipUpdateRelationshipJsonupdateRelationshipXmlMergeMode,
)
from ...models.relationship_update_relationship_jsonupdate_relationship_xml_notification_level import (
    RelationshipUpdateRelationshipJsonupdateRelationshipXmlNotificationLevel,
)
from ...models.relationship_update_relationship_jsonupdate_relationship_xml_report_mode import (
    RelationshipUpdateRelationshipJsonupdateRelationshipXmlReportMode,
)
...
def _get_kwargs(
    ...
    *,
    ...
    import_strategy: Union[
        Unset, RelationshipUpdateRelationshipJsonupdateRelationshipXmlImportStrategy
    ] = RelationshipUpdateRelationshipJsonupdateRelationshipXmlImportStrategy.CREATE_AND_UPDATE,
    merge_data_values: Union[Unset, bool] = False,
    merge_mode: Union[
        Unset, RelationshipUpdateRelationshipJsonupdateRelationshipXmlMergeMode
    ] = RelationshipUpdateRelationshipJsonupdateRelationshipXmlMergeMode.REPLACE,
    notification_level: Union[Unset, RelationshipUpdateRelationshipJsonupdateRelationshipXmlNotificationLevel] = UNSET,
    ...
    report_mode: Union[
        Unset, RelationshipUpdateRelationshipJsonupdateRelationshipXmlReportMode
    ] = RelationshipUpdateRelationshipJsonupdateRelationshipXmlReportMode.FULL,
    ...
    *,
    ...
    Args:
        ...
        import_strategy (Union[Unset,
            RelationshipUpdateRelationshipJsonupdateRelationshipXmlImportStrategy]):  Default:
            RelationshipUpdateRelationshipJsonupdateRelationshipXmlImportStrategy.CREATE_AND_UPDATE.
        merge_data_values (Union[Unset, bool]):  Default: False.
        merge_mode (Union[Unset,
            RelationshipUpdateRelationshipJsonupdateRelationshipXmlMergeMode]):  Default:
            RelationshipUpdateRelationshipJsonupdateRelationshipXmlMergeMode.REPLACE.
        ...
        report_mode (Union[Unset,
            RelationshipUpdateRelationshipJsonupdateRelationshipXmlReportMode]):  Default:
            RelationshipUpdateRelationshipJsonupdateRelationshipXmlReportMode.FULL.
