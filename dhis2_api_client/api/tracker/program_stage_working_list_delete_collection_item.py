...
from ...models.program_stage_working_list_delete_collection_item_property import (
    ProgramStageWorkingListDeleteCollectionItemProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: ProgramStageWorkingListDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/programStageWorkingLists/{uid}/{property_}/{item_id}",
    }
