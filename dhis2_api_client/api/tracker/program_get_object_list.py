...
from ...models.program_get_object_list_response_200 import ProgramGetObjectListResponse200
from ...models.program_get_object_list_root_junction import ProgramGetObjectListRootJunction
...
def _get_kwargs(
    *,
    ...
    root_junction: Union[Unset, ProgramGetObjectListRootJunction] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
) -> Optional[Union[ProgramGetObjectListResponse200, WebMessage]]:
    if response.status_code == 200:
        response_200 = ProgramGetObjectListResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ProgramGetObjectListResponse200, WebMessage]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, ProgramGetObjectListRootJunction]):
...
def sync(
    *,
    ...
    Returns:
        Union[ProgramGetObjectListResponse200, WebMessage]
    """
