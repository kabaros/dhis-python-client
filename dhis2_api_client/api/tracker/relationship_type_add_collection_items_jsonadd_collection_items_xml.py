...
from ...models.relationship_type_add_collection_items_jsonadd_collection_items_xml_property import (
    RelationshipTypeAddCollectionItemsJsonaddCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: RelationshipTypeAddCollectionItemsJsonaddCollectionItemsXmlProperty,
    *,
