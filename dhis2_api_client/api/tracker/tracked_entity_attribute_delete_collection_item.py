...
from ...models.tracked_entity_attribute_delete_collection_item_property import (
    TrackedEntityAttributeDeleteCollectionItemProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: TrackedEntityAttributeDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/trackedEntityAttributes/{uid}/{property_}/{item_id}",
    }
