...
from ...models.program_rule_delete_collection_item_property import ProgramRuleDeleteCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: ProgramRuleDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/programRules/{uid}/{property_}/{item_id}",
    }
