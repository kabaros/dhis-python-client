...
from ...models.tracked_entity_filter_add_collection_item_property import TrackedEntityFilterAddCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: TrackedEntityFilterAddCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
