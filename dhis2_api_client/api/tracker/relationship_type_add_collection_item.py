...
from ...models.relationship_type_add_collection_item_property import RelationshipTypeAddCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: RelationshipTypeAddCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
