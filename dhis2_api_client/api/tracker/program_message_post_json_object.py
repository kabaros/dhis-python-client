...
from ...models.program_message_post_json_object_atomic_mode import ProgramMessagePostJsonObjectAtomicMode
from ...models.program_message_post_json_object_flush_mode import ProgramMessagePostJsonObjectFlushMode
from ...models.program_message_post_json_object_identifier import ProgramMessagePostJsonObjectIdentifier
from ...models.program_message_post_json_object_import_mode import ProgramMessagePostJsonObjectImportMode
from ...models.program_message_post_json_object_import_report_mode import ProgramMessagePostJsonObjectImportReportMode
from ...models.program_message_post_json_object_import_strategy import ProgramMessagePostJsonObjectImportStrategy
from ...models.program_message_post_json_object_preheat_mode import ProgramMessagePostJsonObjectPreheatMode
from ...models.program_message_post_json_object_user_override_mode import ProgramMessagePostJsonObjectUserOverrideMode
...
def _get_kwargs(
    *,
    ...
    atomic_mode: Union[Unset, ProgramMessagePostJsonObjectAtomicMode] = ProgramMessagePostJsonObjectAtomicMode.ALL,
    flush_mode: Union[Unset, ProgramMessagePostJsonObjectFlushMode] = ProgramMessagePostJsonObjectFlushMode.AUTO,
    identifier: Union[Unset, ProgramMessagePostJsonObjectIdentifier] = ProgramMessagePostJsonObjectIdentifier.UID,
    import_mode: Union[Unset, ProgramMessagePostJsonObjectImportMode] = ProgramMessagePostJsonObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, ProgramMessagePostJsonObjectImportReportMode
    ] = ProgramMessagePostJsonObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, ProgramMessagePostJsonObjectImportStrategy
    ] = ProgramMessagePostJsonObjectImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    preheat_mode: Union[
        Unset, ProgramMessagePostJsonObjectPreheatMode
    ] = ProgramMessagePostJsonObjectPreheatMode.REFERENCE,
    ...
    user_override_mode: Union[
        Unset, ProgramMessagePostJsonObjectUserOverrideMode
    ] = ProgramMessagePostJsonObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, ProgramMessagePostJsonObjectAtomicMode]):  Default:
            ProgramMessagePostJsonObjectAtomicMode.ALL.
        flush_mode (Union[Unset, ProgramMessagePostJsonObjectFlushMode]):  Default:
            ProgramMessagePostJsonObjectFlushMode.AUTO.
        identifier (Union[Unset, ProgramMessagePostJsonObjectIdentifier]):  Default:
            ProgramMessagePostJsonObjectIdentifier.UID.
        import_mode (Union[Unset, ProgramMessagePostJsonObjectImportMode]):  Default:
            ProgramMessagePostJsonObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, ProgramMessagePostJsonObjectImportReportMode]):  Default:
            ProgramMessagePostJsonObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, ProgramMessagePostJsonObjectImportStrategy]):  Default:
            ProgramMessagePostJsonObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, ProgramMessagePostJsonObjectPreheatMode]):  Default:
            ProgramMessagePostJsonObjectPreheatMode.REFERENCE.
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, ProgramMessagePostJsonObjectUserOverrideMode]):  Default:
            ProgramMessagePostJsonObjectUserOverrideMode.NONE.
        body (ProgramMessage):
