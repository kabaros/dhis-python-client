...
from ...models.tracked_entity_attribute_add_collection_item_property import (
    TrackedEntityAttributeAddCollectionItemProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: TrackedEntityAttributeAddCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
