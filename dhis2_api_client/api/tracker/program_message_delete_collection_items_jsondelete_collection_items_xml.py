...
from ...models.program_message_delete_collection_items_jsondelete_collection_items_xml_property import (
    ProgramMessageDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: ProgramMessageDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
    *,
