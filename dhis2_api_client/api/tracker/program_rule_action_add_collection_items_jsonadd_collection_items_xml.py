...
from ...models.program_rule_action_add_collection_items_jsonadd_collection_items_xml_property import (
    ProgramRuleActionAddCollectionItemsJsonaddCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: ProgramRuleActionAddCollectionItemsJsonaddCollectionItemsXmlProperty,
    *,
