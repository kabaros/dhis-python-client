...
from ...models.program_message_patch_object_atomic_mode import ProgramMessagePatchObjectAtomicMode
from ...models.program_message_patch_object_flush_mode import ProgramMessagePatchObjectFlushMode
from ...models.program_message_patch_object_identifier import ProgramMessagePatchObjectIdentifier
from ...models.program_message_patch_object_import_mode import ProgramMessagePatchObjectImportMode
from ...models.program_message_patch_object_import_report_mode import ProgramMessagePatchObjectImportReportMode
from ...models.program_message_patch_object_import_strategy import ProgramMessagePatchObjectImportStrategy
from ...models.program_message_patch_object_preheat_mode import ProgramMessagePatchObjectPreheatMode
from ...models.program_message_patch_object_root_junction import ProgramMessagePatchObjectRootJunction
from ...models.program_message_patch_object_user_override_mode import ProgramMessagePatchObjectUserOverrideMode
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[Unset, ProgramMessagePatchObjectAtomicMode] = ProgramMessagePatchObjectAtomicMode.ALL,
    flush_mode: Union[Unset, ProgramMessagePatchObjectFlushMode] = ProgramMessagePatchObjectFlushMode.AUTO,
    identifier: Union[Unset, ProgramMessagePatchObjectIdentifier] = ProgramMessagePatchObjectIdentifier.UID,
    import_mode: Union[Unset, ProgramMessagePatchObjectImportMode] = ProgramMessagePatchObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, ProgramMessagePatchObjectImportReportMode
    ] = ProgramMessagePatchObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, ProgramMessagePatchObjectImportStrategy
    ] = ProgramMessagePatchObjectImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, ProgramMessagePatchObjectPreheatMode] = ProgramMessagePatchObjectPreheatMode.REFERENCE,
    root_junction: Union[Unset, ProgramMessagePatchObjectRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, ProgramMessagePatchObjectUserOverrideMode
    ] = ProgramMessagePatchObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, ProgramMessagePatchObjectAtomicMode]):  Default:
            ProgramMessagePatchObjectAtomicMode.ALL.
        flush_mode (Union[Unset, ProgramMessagePatchObjectFlushMode]):  Default:
            ProgramMessagePatchObjectFlushMode.AUTO.
        identifier (Union[Unset, ProgramMessagePatchObjectIdentifier]):  Default:
            ProgramMessagePatchObjectIdentifier.UID.
        import_mode (Union[Unset, ProgramMessagePatchObjectImportMode]):  Default:
            ProgramMessagePatchObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, ProgramMessagePatchObjectImportReportMode]):  Default:
            ProgramMessagePatchObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, ProgramMessagePatchObjectImportStrategy]):  Default:
            ProgramMessagePatchObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, ProgramMessagePatchObjectPreheatMode]):  Default:
            ProgramMessagePatchObjectPreheatMode.REFERENCE.
        root_junction (Union[Unset, ProgramMessagePatchObjectRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, ProgramMessagePatchObjectUserOverrideMode]):  Default:
            ProgramMessagePatchObjectUserOverrideMode.NONE.
        body (JsonPatch):
