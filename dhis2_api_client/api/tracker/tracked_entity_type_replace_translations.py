...
from ...models.tracked_entity_type_replace_translations_body import TrackedEntityTypeReplaceTranslationsBody
...
def _get_kwargs(
    uid: str,
    *,
    body: TrackedEntityTypeReplaceTranslationsBody,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": f"/trackedEntityTypes/{uid}/translations",
    }
