...
from ...models.program_replace_collection_items_jsonreplace_collection_items_xml_property import (
    ProgramReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: ProgramReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
    *,
