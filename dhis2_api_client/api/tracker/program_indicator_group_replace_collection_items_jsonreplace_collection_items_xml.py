...
from ...models.program_indicator_group_replace_collection_items_jsonreplace_collection_items_xml_property import (
    ProgramIndicatorGroupReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: ProgramIndicatorGroupReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
    *,
