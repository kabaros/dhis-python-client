...
from ...models.program_section_replace_collection_items_jsonreplace_collection_items_xml_property import (
    ProgramSectionReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: ProgramSectionReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
    *,
