...
from ...models.program_put_json_objectput_xml_object_atomic_mode import ProgramPutJsonObjectputXmlObjectAtomicMode
from ...models.program_put_json_objectput_xml_object_flush_mode import ProgramPutJsonObjectputXmlObjectFlushMode
from ...models.program_put_json_objectput_xml_object_identifier import ProgramPutJsonObjectputXmlObjectIdentifier
from ...models.program_put_json_objectput_xml_object_import_mode import ProgramPutJsonObjectputXmlObjectImportMode
from ...models.program_put_json_objectput_xml_object_import_report_mode import (
    ProgramPutJsonObjectputXmlObjectImportReportMode,
)
from ...models.program_put_json_objectput_xml_object_import_strategy import (
    ProgramPutJsonObjectputXmlObjectImportStrategy,
)
from ...models.program_put_json_objectput_xml_object_preheat_mode import ProgramPutJsonObjectputXmlObjectPreheatMode
from ...models.program_put_json_objectput_xml_object_user_override_mode import (
    ProgramPutJsonObjectputXmlObjectUserOverrideMode,
)
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[
        Unset, ProgramPutJsonObjectputXmlObjectAtomicMode
    ] = ProgramPutJsonObjectputXmlObjectAtomicMode.ALL,
    flush_mode: Union[
        Unset, ProgramPutJsonObjectputXmlObjectFlushMode
    ] = ProgramPutJsonObjectputXmlObjectFlushMode.AUTO,
    identifier: Union[
        Unset, ProgramPutJsonObjectputXmlObjectIdentifier
    ] = ProgramPutJsonObjectputXmlObjectIdentifier.UID,
    import_mode: Union[
        Unset, ProgramPutJsonObjectputXmlObjectImportMode
    ] = ProgramPutJsonObjectputXmlObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, ProgramPutJsonObjectputXmlObjectImportReportMode
    ] = ProgramPutJsonObjectputXmlObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, ProgramPutJsonObjectputXmlObjectImportStrategy
    ] = ProgramPutJsonObjectputXmlObjectImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    preheat_mode: Union[
        Unset, ProgramPutJsonObjectputXmlObjectPreheatMode
    ] = ProgramPutJsonObjectputXmlObjectPreheatMode.REFERENCE,
    ...
    user_override_mode: Union[
        Unset, ProgramPutJsonObjectputXmlObjectUserOverrideMode
    ] = ProgramPutJsonObjectputXmlObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        uid (str): A UID for an Program object
            (Java name `org.hisp.dhis.program.Program`) Example: pa3pN28SD4S.
        async_ (Union[Unset, bool]):  Default: False.
        atomic_mode (Union[Unset, ProgramPutJsonObjectputXmlObjectAtomicMode]):  Default:
            ProgramPutJsonObjectputXmlObjectAtomicMode.ALL.
        flush_mode (Union[Unset, ProgramPutJsonObjectputXmlObjectFlushMode]):  Default:
            ProgramPutJsonObjectputXmlObjectFlushMode.AUTO.
        identifier (Union[Unset, ProgramPutJsonObjectputXmlObjectIdentifier]):  Default:
            ProgramPutJsonObjectputXmlObjectIdentifier.UID.
        import_mode (Union[Unset, ProgramPutJsonObjectputXmlObjectImportMode]):  Default:
            ProgramPutJsonObjectputXmlObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, ProgramPutJsonObjectputXmlObjectImportReportMode]):
            Default: ProgramPutJsonObjectputXmlObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, ProgramPutJsonObjectputXmlObjectImportStrategy]):  Default:
            ProgramPutJsonObjectputXmlObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, ProgramPutJsonObjectputXmlObjectPreheatMode]):  Default:
            ProgramPutJsonObjectputXmlObjectPreheatMode.REFERENCE.
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, ProgramPutJsonObjectputXmlObjectUserOverrideMode]):
            Default: ProgramPutJsonObjectputXmlObjectUserOverrideMode.NONE.
        body (Program):
