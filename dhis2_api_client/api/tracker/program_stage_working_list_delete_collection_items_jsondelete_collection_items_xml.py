...
from ...models.program_stage_working_list_delete_collection_items_jsondelete_collection_items_xml_property import (
    ProgramStageWorkingListDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: ProgramStageWorkingListDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
    *,
