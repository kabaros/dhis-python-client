...
from ...models.program_indicator_group_patch_object_atomic_mode import ProgramIndicatorGroupPatchObjectAtomicMode
from ...models.program_indicator_group_patch_object_flush_mode import ProgramIndicatorGroupPatchObjectFlushMode
from ...models.program_indicator_group_patch_object_identifier import ProgramIndicatorGroupPatchObjectIdentifier
from ...models.program_indicator_group_patch_object_import_mode import ProgramIndicatorGroupPatchObjectImportMode
from ...models.program_indicator_group_patch_object_import_report_mode import (
    ProgramIndicatorGroupPatchObjectImportReportMode,
)
from ...models.program_indicator_group_patch_object_import_strategy import (
    ProgramIndicatorGroupPatchObjectImportStrategy,
)
from ...models.program_indicator_group_patch_object_preheat_mode import ProgramIndicatorGroupPatchObjectPreheatMode
from ...models.program_indicator_group_patch_object_root_junction import ProgramIndicatorGroupPatchObjectRootJunction
from ...models.program_indicator_group_patch_object_user_override_mode import (
    ProgramIndicatorGroupPatchObjectUserOverrideMode,
)
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[
        Unset, ProgramIndicatorGroupPatchObjectAtomicMode
    ] = ProgramIndicatorGroupPatchObjectAtomicMode.ALL,
    flush_mode: Union[
        Unset, ProgramIndicatorGroupPatchObjectFlushMode
    ] = ProgramIndicatorGroupPatchObjectFlushMode.AUTO,
    identifier: Union[
        Unset, ProgramIndicatorGroupPatchObjectIdentifier
    ] = ProgramIndicatorGroupPatchObjectIdentifier.UID,
    import_mode: Union[
        Unset, ProgramIndicatorGroupPatchObjectImportMode
    ] = ProgramIndicatorGroupPatchObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, ProgramIndicatorGroupPatchObjectImportReportMode
    ] = ProgramIndicatorGroupPatchObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, ProgramIndicatorGroupPatchObjectImportStrategy
    ] = ProgramIndicatorGroupPatchObjectImportStrategy.CREATE_AND_UPDATE,
    ...
    preheat_mode: Union[
        Unset, ProgramIndicatorGroupPatchObjectPreheatMode
    ] = ProgramIndicatorGroupPatchObjectPreheatMode.REFERENCE,
    root_junction: Union[Unset, ProgramIndicatorGroupPatchObjectRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, ProgramIndicatorGroupPatchObjectUserOverrideMode
    ] = ProgramIndicatorGroupPatchObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, ProgramIndicatorGroupPatchObjectAtomicMode]):  Default:
            ProgramIndicatorGroupPatchObjectAtomicMode.ALL.
        flush_mode (Union[Unset, ProgramIndicatorGroupPatchObjectFlushMode]):  Default:
            ProgramIndicatorGroupPatchObjectFlushMode.AUTO.
        identifier (Union[Unset, ProgramIndicatorGroupPatchObjectIdentifier]):  Default:
            ProgramIndicatorGroupPatchObjectIdentifier.UID.
        import_mode (Union[Unset, ProgramIndicatorGroupPatchObjectImportMode]):  Default:
            ProgramIndicatorGroupPatchObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, ProgramIndicatorGroupPatchObjectImportReportMode]):
            Default: ProgramIndicatorGroupPatchObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, ProgramIndicatorGroupPatchObjectImportStrategy]):  Default:
            ProgramIndicatorGroupPatchObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, ProgramIndicatorGroupPatchObjectPreheatMode]):  Default:
            ProgramIndicatorGroupPatchObjectPreheatMode.REFERENCE.
        root_junction (Union[Unset, ProgramIndicatorGroupPatchObjectRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, ProgramIndicatorGroupPatchObjectUserOverrideMode]):
            Default: ProgramIndicatorGroupPatchObjectUserOverrideMode.NONE.
        body (JsonPatch):
