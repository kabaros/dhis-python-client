...
from ...models.program_indicator_group_get_object_list_csv_root_junction import (
    ProgramIndicatorGroupGetObjectListCsvRootJunction,
)
...
def _get_kwargs(
    *,
    ...
    root_junction: Union[Unset, ProgramIndicatorGroupGetObjectListCsvRootJunction] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/programIndicatorGroups/#getObjectListCsv",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, ProgramIndicatorGroupGetObjectListCsvRootJunction]):
