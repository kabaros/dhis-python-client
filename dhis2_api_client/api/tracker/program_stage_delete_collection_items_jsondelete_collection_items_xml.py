...
from ...models.program_stage_delete_collection_items_jsondelete_collection_items_xml_property import (
    ProgramStageDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: ProgramStageDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
    *,
