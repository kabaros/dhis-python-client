...
from ...models.tracked_entity_type_bulk_sharing_atomic_mode import TrackedEntityTypeBulkSharingAtomicMode
from ...models.tracked_entity_type_bulk_sharing_flush_mode import TrackedEntityTypeBulkSharingFlushMode
from ...models.tracked_entity_type_bulk_sharing_identifier import TrackedEntityTypeBulkSharingIdentifier
from ...models.tracked_entity_type_bulk_sharing_import_mode import TrackedEntityTypeBulkSharingImportMode
from ...models.tracked_entity_type_bulk_sharing_import_report_mode import TrackedEntityTypeBulkSharingImportReportMode
from ...models.tracked_entity_type_bulk_sharing_import_strategy import TrackedEntityTypeBulkSharingImportStrategy
from ...models.tracked_entity_type_bulk_sharing_preheat_mode import TrackedEntityTypeBulkSharingPreheatMode
from ...models.tracked_entity_type_bulk_sharing_root_junction import TrackedEntityTypeBulkSharingRootJunction
from ...models.tracked_entity_type_bulk_sharing_user_override_mode import TrackedEntityTypeBulkSharingUserOverrideMode
...
def _get_kwargs(
    *,
    ...
    atomic_mode: Union[Unset, TrackedEntityTypeBulkSharingAtomicMode] = TrackedEntityTypeBulkSharingAtomicMode.ALL,
    flush_mode: Union[Unset, TrackedEntityTypeBulkSharingFlushMode] = TrackedEntityTypeBulkSharingFlushMode.AUTO,
    identifier: Union[Unset, TrackedEntityTypeBulkSharingIdentifier] = TrackedEntityTypeBulkSharingIdentifier.UID,
    import_mode: Union[Unset, TrackedEntityTypeBulkSharingImportMode] = TrackedEntityTypeBulkSharingImportMode.COMMIT,
    import_report_mode: Union[
        Unset, TrackedEntityTypeBulkSharingImportReportMode
    ] = TrackedEntityTypeBulkSharingImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, TrackedEntityTypeBulkSharingImportStrategy
    ] = TrackedEntityTypeBulkSharingImportStrategy.CREATE_AND_UPDATE,
    ...
    preheat_mode: Union[
        Unset, TrackedEntityTypeBulkSharingPreheatMode
    ] = TrackedEntityTypeBulkSharingPreheatMode.REFERENCE,
    root_junction: Union[Unset, TrackedEntityTypeBulkSharingRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, TrackedEntityTypeBulkSharingUserOverrideMode
    ] = TrackedEntityTypeBulkSharingUserOverrideMode.NONE,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/trackedEntityTypes/sharing",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, TrackedEntityTypeBulkSharingAtomicMode]):  Default:
            TrackedEntityTypeBulkSharingAtomicMode.ALL.
        flush_mode (Union[Unset, TrackedEntityTypeBulkSharingFlushMode]):  Default:
            TrackedEntityTypeBulkSharingFlushMode.AUTO.
        identifier (Union[Unset, TrackedEntityTypeBulkSharingIdentifier]):  Default:
            TrackedEntityTypeBulkSharingIdentifier.UID.
        import_mode (Union[Unset, TrackedEntityTypeBulkSharingImportMode]):  Default:
            TrackedEntityTypeBulkSharingImportMode.COMMIT.
        import_report_mode (Union[Unset, TrackedEntityTypeBulkSharingImportReportMode]):  Default:
            TrackedEntityTypeBulkSharingImportReportMode.ERRORS.
        import_strategy (Union[Unset, TrackedEntityTypeBulkSharingImportStrategy]):  Default:
            TrackedEntityTypeBulkSharingImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, TrackedEntityTypeBulkSharingPreheatMode]):  Default:
            TrackedEntityTypeBulkSharingPreheatMode.REFERENCE.
        root_junction (Union[Unset, TrackedEntityTypeBulkSharingRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, TrackedEntityTypeBulkSharingUserOverrideMode]):  Default:
            TrackedEntityTypeBulkSharingUserOverrideMode.NONE.
        body (BulkJsonPatch):
