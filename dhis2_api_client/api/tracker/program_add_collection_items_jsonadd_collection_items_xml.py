...
from ...models.program_add_collection_items_jsonadd_collection_items_xml_property import (
    ProgramAddCollectionItemsJsonaddCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: ProgramAddCollectionItemsJsonaddCollectionItemsXmlProperty,
    *,
