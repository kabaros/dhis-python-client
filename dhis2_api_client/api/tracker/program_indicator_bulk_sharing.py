...
from ...models.program_indicator_bulk_sharing_atomic_mode import ProgramIndicatorBulkSharingAtomicMode
from ...models.program_indicator_bulk_sharing_flush_mode import ProgramIndicatorBulkSharingFlushMode
from ...models.program_indicator_bulk_sharing_identifier import ProgramIndicatorBulkSharingIdentifier
from ...models.program_indicator_bulk_sharing_import_mode import ProgramIndicatorBulkSharingImportMode
from ...models.program_indicator_bulk_sharing_import_report_mode import ProgramIndicatorBulkSharingImportReportMode
from ...models.program_indicator_bulk_sharing_import_strategy import ProgramIndicatorBulkSharingImportStrategy
from ...models.program_indicator_bulk_sharing_preheat_mode import ProgramIndicatorBulkSharingPreheatMode
from ...models.program_indicator_bulk_sharing_root_junction import ProgramIndicatorBulkSharingRootJunction
from ...models.program_indicator_bulk_sharing_user_override_mode import ProgramIndicatorBulkSharingUserOverrideMode
...
def _get_kwargs(
    *,
    ...
    atomic_mode: Union[Unset, ProgramIndicatorBulkSharingAtomicMode] = ProgramIndicatorBulkSharingAtomicMode.ALL,
    flush_mode: Union[Unset, ProgramIndicatorBulkSharingFlushMode] = ProgramIndicatorBulkSharingFlushMode.AUTO,
    identifier: Union[Unset, ProgramIndicatorBulkSharingIdentifier] = ProgramIndicatorBulkSharingIdentifier.UID,
    import_mode: Union[Unset, ProgramIndicatorBulkSharingImportMode] = ProgramIndicatorBulkSharingImportMode.COMMIT,
    import_report_mode: Union[
        Unset, ProgramIndicatorBulkSharingImportReportMode
    ] = ProgramIndicatorBulkSharingImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, ProgramIndicatorBulkSharingImportStrategy
    ] = ProgramIndicatorBulkSharingImportStrategy.CREATE_AND_UPDATE,
    ...
    preheat_mode: Union[
        Unset, ProgramIndicatorBulkSharingPreheatMode
    ] = ProgramIndicatorBulkSharingPreheatMode.REFERENCE,
    root_junction: Union[Unset, ProgramIndicatorBulkSharingRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, ProgramIndicatorBulkSharingUserOverrideMode
    ] = ProgramIndicatorBulkSharingUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, ProgramIndicatorBulkSharingAtomicMode]):  Default:
            ProgramIndicatorBulkSharingAtomicMode.ALL.
        flush_mode (Union[Unset, ProgramIndicatorBulkSharingFlushMode]):  Default:
            ProgramIndicatorBulkSharingFlushMode.AUTO.
        identifier (Union[Unset, ProgramIndicatorBulkSharingIdentifier]):  Default:
            ProgramIndicatorBulkSharingIdentifier.UID.
        import_mode (Union[Unset, ProgramIndicatorBulkSharingImportMode]):  Default:
            ProgramIndicatorBulkSharingImportMode.COMMIT.
        import_report_mode (Union[Unset, ProgramIndicatorBulkSharingImportReportMode]):  Default:
            ProgramIndicatorBulkSharingImportReportMode.ERRORS.
        import_strategy (Union[Unset, ProgramIndicatorBulkSharingImportStrategy]):  Default:
            ProgramIndicatorBulkSharingImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, ProgramIndicatorBulkSharingPreheatMode]):  Default:
            ProgramIndicatorBulkSharingPreheatMode.REFERENCE.
        root_junction (Union[Unset, ProgramIndicatorBulkSharingRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, ProgramIndicatorBulkSharingUserOverrideMode]):  Default:
            ProgramIndicatorBulkSharingUserOverrideMode.NONE.
        body (BulkJsonPatch):
