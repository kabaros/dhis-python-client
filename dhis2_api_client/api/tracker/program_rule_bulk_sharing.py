...
from ...models.program_rule_bulk_sharing_atomic_mode import ProgramRuleBulkSharingAtomicMode
from ...models.program_rule_bulk_sharing_flush_mode import ProgramRuleBulkSharingFlushMode
from ...models.program_rule_bulk_sharing_identifier import ProgramRuleBulkSharingIdentifier
from ...models.program_rule_bulk_sharing_import_mode import ProgramRuleBulkSharingImportMode
from ...models.program_rule_bulk_sharing_import_report_mode import ProgramRuleBulkSharingImportReportMode
from ...models.program_rule_bulk_sharing_import_strategy import ProgramRuleBulkSharingImportStrategy
from ...models.program_rule_bulk_sharing_preheat_mode import ProgramRuleBulkSharingPreheatMode
from ...models.program_rule_bulk_sharing_root_junction import ProgramRuleBulkSharingRootJunction
from ...models.program_rule_bulk_sharing_user_override_mode import ProgramRuleBulkSharingUserOverrideMode
...
def _get_kwargs(
    *,
    ...
    atomic_mode: Union[Unset, ProgramRuleBulkSharingAtomicMode] = ProgramRuleBulkSharingAtomicMode.ALL,
    flush_mode: Union[Unset, ProgramRuleBulkSharingFlushMode] = ProgramRuleBulkSharingFlushMode.AUTO,
    identifier: Union[Unset, ProgramRuleBulkSharingIdentifier] = ProgramRuleBulkSharingIdentifier.UID,
    import_mode: Union[Unset, ProgramRuleBulkSharingImportMode] = ProgramRuleBulkSharingImportMode.COMMIT,
    import_report_mode: Union[
        Unset, ProgramRuleBulkSharingImportReportMode
    ] = ProgramRuleBulkSharingImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, ProgramRuleBulkSharingImportStrategy
    ] = ProgramRuleBulkSharingImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, ProgramRuleBulkSharingPreheatMode] = ProgramRuleBulkSharingPreheatMode.REFERENCE,
    root_junction: Union[Unset, ProgramRuleBulkSharingRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, ProgramRuleBulkSharingUserOverrideMode
    ] = ProgramRuleBulkSharingUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, ProgramRuleBulkSharingAtomicMode]):  Default:
            ProgramRuleBulkSharingAtomicMode.ALL.
        flush_mode (Union[Unset, ProgramRuleBulkSharingFlushMode]):  Default:
            ProgramRuleBulkSharingFlushMode.AUTO.
        identifier (Union[Unset, ProgramRuleBulkSharingIdentifier]):  Default:
            ProgramRuleBulkSharingIdentifier.UID.
        import_mode (Union[Unset, ProgramRuleBulkSharingImportMode]):  Default:
            ProgramRuleBulkSharingImportMode.COMMIT.
        import_report_mode (Union[Unset, ProgramRuleBulkSharingImportReportMode]):  Default:
            ProgramRuleBulkSharingImportReportMode.ERRORS.
        import_strategy (Union[Unset, ProgramRuleBulkSharingImportStrategy]):  Default:
            ProgramRuleBulkSharingImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, ProgramRuleBulkSharingPreheatMode]):  Default:
            ProgramRuleBulkSharingPreheatMode.REFERENCE.
        root_junction (Union[Unset, ProgramRuleBulkSharingRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, ProgramRuleBulkSharingUserOverrideMode]):  Default:
            ProgramRuleBulkSharingUserOverrideMode.NONE.
        body (BulkJsonPatch):
