...
from ...models.tracked_entities_export_get_tracked_entities_as_csv_zip_assigned_user_mode import (
    TrackedEntitiesExportGetTrackedEntitiesAsCsvZipAssignedUserMode,
)
from ...models.tracked_entities_export_get_tracked_entities_as_csv_zip_event_status import (
    TrackedEntitiesExportGetTrackedEntitiesAsCsvZipEventStatus,
)
from ...models.tracked_entities_export_get_tracked_entities_as_csv_zip_org_unit_mode import (
    TrackedEntitiesExportGetTrackedEntitiesAsCsvZipOrgUnitMode,
)
from ...models.tracked_entities_export_get_tracked_entities_as_csv_zip_ou_mode import (
    TrackedEntitiesExportGetTrackedEntitiesAsCsvZipOuMode,
)
from ...models.tracked_entities_export_get_tracked_entities_as_csv_zip_program_status import (
    TrackedEntitiesExportGetTrackedEntitiesAsCsvZipProgramStatus,
)
...
def _get_kwargs(
    *,
    ...
    assigned_user_mode: Union[Unset, TrackedEntitiesExportGetTrackedEntitiesAsCsvZipAssignedUserMode] = UNSET,
    ...
    event_status: Union[Unset, TrackedEntitiesExportGetTrackedEntitiesAsCsvZipEventStatus] = UNSET,
    ...
    org_unit_mode: Union[Unset, TrackedEntitiesExportGetTrackedEntitiesAsCsvZipOrgUnitMode] = UNSET,
    org_units: Union[Unset, list[str]] = UNSET,
    ou_mode: Union[Unset, TrackedEntitiesExportGetTrackedEntitiesAsCsvZipOuMode] = UNSET,
    ...
    program_status: Union[Unset, TrackedEntitiesExportGetTrackedEntitiesAsCsvZipProgramStatus] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/tracker/trackedEntities/#getTrackedEntitiesAsCsvZip",
        "params": params,
    }
    ...
    *,
    ...
    Args:
        ...
        event_occurred_before (Union[Unset, EndDateTime]): The actual type is unknown.
            (Java type was: `class org.hisp.dhis.webapi.webdomain.EndDateTime`)
        event_status (Union[Unset, TrackedEntitiesExportGetTrackedEntitiesAsCsvZipEventStatus]):
        ...
        org_unit_mode (Union[Unset, TrackedEntitiesExportGetTrackedEntitiesAsCsvZipOrgUnitMode]):
        org_units (Union[Unset, list[str]]):
        ou_mode (Union[Unset, TrackedEntitiesExportGetTrackedEntitiesAsCsvZipOuMode]):
