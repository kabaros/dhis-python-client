...
from ...models.program_stage_section_add_collection_items_jsonadd_collection_items_xml_property import (
    ProgramStageSectionAddCollectionItemsJsonaddCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: ProgramStageSectionAddCollectionItemsJsonaddCollectionItemsXmlProperty,
    *,
