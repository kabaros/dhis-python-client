...
from ...models.program_stage_working_list_add_collection_items_jsonadd_collection_items_xml_property import (
    ProgramStageWorkingListAddCollectionItemsJsonaddCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: ProgramStageWorkingListAddCollectionItemsJsonaddCollectionItemsXmlProperty,
    *,
