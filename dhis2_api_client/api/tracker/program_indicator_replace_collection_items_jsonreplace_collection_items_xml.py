...
from ...models.program_indicator_replace_collection_items_jsonreplace_collection_items_xml_property import (
    ProgramIndicatorReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: ProgramIndicatorReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
    *,
