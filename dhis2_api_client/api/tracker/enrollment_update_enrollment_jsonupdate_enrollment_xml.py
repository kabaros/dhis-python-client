...
from ...models.enrollment_update_enrollment_jsonupdate_enrollment_xml_import_strategy import (
    EnrollmentUpdateEnrollmentJsonupdateEnrollmentXmlImportStrategy,
)
from ...models.enrollment_update_enrollment_jsonupdate_enrollment_xml_merge_mode import (
    EnrollmentUpdateEnrollmentJsonupdateEnrollmentXmlMergeMode,
)
from ...models.enrollment_update_enrollment_jsonupdate_enrollment_xml_notification_level import (
    EnrollmentUpdateEnrollmentJsonupdateEnrollmentXmlNotificationLevel,
)
from ...models.enrollment_update_enrollment_jsonupdate_enrollment_xml_report_mode import (
    EnrollmentUpdateEnrollmentJsonupdateEnrollmentXmlReportMode,
)
...
def _get_kwargs(
    ...
    *,
    ...
    import_strategy: Union[
        Unset, EnrollmentUpdateEnrollmentJsonupdateEnrollmentXmlImportStrategy
    ] = EnrollmentUpdateEnrollmentJsonupdateEnrollmentXmlImportStrategy.CREATE_AND_UPDATE,
    merge_data_values: Union[Unset, bool] = False,
    merge_mode: Union[
        Unset, EnrollmentUpdateEnrollmentJsonupdateEnrollmentXmlMergeMode
    ] = EnrollmentUpdateEnrollmentJsonupdateEnrollmentXmlMergeMode.REPLACE,
    notification_level: Union[Unset, EnrollmentUpdateEnrollmentJsonupdateEnrollmentXmlNotificationLevel] = UNSET,
    ...
    report_mode: Union[
        Unset, EnrollmentUpdateEnrollmentJsonupdateEnrollmentXmlReportMode
    ] = EnrollmentUpdateEnrollmentJsonupdateEnrollmentXmlReportMode.FULL,
    ...
    *,
    ...
    Args:
        ...
        import_strategy (Union[Unset,
            EnrollmentUpdateEnrollmentJsonupdateEnrollmentXmlImportStrategy]):  Default:
            EnrollmentUpdateEnrollmentJsonupdateEnrollmentXmlImportStrategy.CREATE_AND_UPDATE.
        merge_data_values (Union[Unset, bool]):  Default: False.
        merge_mode (Union[Unset, EnrollmentUpdateEnrollmentJsonupdateEnrollmentXmlMergeMode]):
            Default: EnrollmentUpdateEnrollmentJsonupdateEnrollmentXmlMergeMode.REPLACE.
        ...
        report_mode (Union[Unset, EnrollmentUpdateEnrollmentJsonupdateEnrollmentXmlReportMode]):
            Default: EnrollmentUpdateEnrollmentJsonupdateEnrollmentXmlReportMode.FULL.
