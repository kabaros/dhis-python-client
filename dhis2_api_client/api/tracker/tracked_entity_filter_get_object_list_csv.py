...
from ...models.tracked_entity_filter_get_object_list_csv_root_junction import (
    TrackedEntityFilterGetObjectListCsvRootJunction,
)
...
def _get_kwargs(
    *,
    ...
    root_junction: Union[Unset, TrackedEntityFilterGetObjectListCsvRootJunction] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/trackedEntityInstanceFilters/#getObjectListCsv",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, TrackedEntityFilterGetObjectListCsvRootJunction]):
