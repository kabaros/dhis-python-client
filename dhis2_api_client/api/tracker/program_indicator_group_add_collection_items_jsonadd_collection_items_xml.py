...
from ...models.program_indicator_group_add_collection_items_jsonadd_collection_items_xml_property import (
    ProgramIndicatorGroupAddCollectionItemsJsonaddCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: ProgramIndicatorGroupAddCollectionItemsJsonaddCollectionItemsXmlProperty,
    *,
