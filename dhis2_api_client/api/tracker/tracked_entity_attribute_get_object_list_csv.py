...
from ...models.tracked_entity_attribute_get_object_list_csv_root_junction import (
    TrackedEntityAttributeGetObjectListCsvRootJunction,
)
...
def _get_kwargs(
    *,
    ...
    root_junction: Union[Unset, TrackedEntityAttributeGetObjectListCsvRootJunction] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/trackedEntityAttributes/#getObjectListCsv",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, TrackedEntityAttributeGetObjectListCsvRootJunction]):
