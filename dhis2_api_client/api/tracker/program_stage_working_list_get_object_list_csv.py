...
from ...models.program_stage_working_list_get_object_list_csv_root_junction import (
    ProgramStageWorkingListGetObjectListCsvRootJunction,
)
...
def _get_kwargs(
    *,
    ...
    root_junction: Union[Unset, ProgramStageWorkingListGetObjectListCsvRootJunction] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/programStageWorkingLists/#getObjectListCsv",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, ProgramStageWorkingListGetObjectListCsvRootJunction]):
