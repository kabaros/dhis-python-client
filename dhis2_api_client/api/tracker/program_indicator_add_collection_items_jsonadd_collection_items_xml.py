...
from ...models.program_indicator_add_collection_items_jsonadd_collection_items_xml_property import (
    ProgramIndicatorAddCollectionItemsJsonaddCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: ProgramIndicatorAddCollectionItemsJsonaddCollectionItemsXmlProperty,
    *,
