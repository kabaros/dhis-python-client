...
from ...models.enrollment_post_enrollment_jsonpost_enrollment_xml_import_strategy import (
    EnrollmentPostEnrollmentJsonpostEnrollmentXmlImportStrategy,
)
from ...models.enrollment_post_enrollment_jsonpost_enrollment_xml_merge_mode import (
    EnrollmentPostEnrollmentJsonpostEnrollmentXmlMergeMode,
)
from ...models.enrollment_post_enrollment_jsonpost_enrollment_xml_notification_level import (
    EnrollmentPostEnrollmentJsonpostEnrollmentXmlNotificationLevel,
)
from ...models.enrollment_post_enrollment_jsonpost_enrollment_xml_report_mode import (
    EnrollmentPostEnrollmentJsonpostEnrollmentXmlReportMode,
)
from ...models.enrollment_post_enrollment_jsonpost_enrollment_xml_strategy import (
    EnrollmentPostEnrollmentJsonpostEnrollmentXmlStrategy,
)
...
def _get_kwargs(
    *,
    ...
    import_strategy: Union[
        Unset, EnrollmentPostEnrollmentJsonpostEnrollmentXmlImportStrategy
    ] = EnrollmentPostEnrollmentJsonpostEnrollmentXmlImportStrategy.CREATE_AND_UPDATE,
    merge_data_values: Union[Unset, bool] = False,
    merge_mode: Union[
        Unset, EnrollmentPostEnrollmentJsonpostEnrollmentXmlMergeMode
    ] = EnrollmentPostEnrollmentJsonpostEnrollmentXmlMergeMode.REPLACE,
    notification_level: Union[Unset, EnrollmentPostEnrollmentJsonpostEnrollmentXmlNotificationLevel] = UNSET,
    ...
    report_mode: Union[
        Unset, EnrollmentPostEnrollmentJsonpostEnrollmentXmlReportMode
    ] = EnrollmentPostEnrollmentJsonpostEnrollmentXmlReportMode.FULL,
    ...
    strategy: Union[
        Unset, EnrollmentPostEnrollmentJsonpostEnrollmentXmlStrategy
    ] = EnrollmentPostEnrollmentJsonpostEnrollmentXmlStrategy.CREATE_AND_UPDATE,
    ...
    *,
    ...
    Args:
        ...
        import_strategy (Union[Unset,
            EnrollmentPostEnrollmentJsonpostEnrollmentXmlImportStrategy]):  Default:
            EnrollmentPostEnrollmentJsonpostEnrollmentXmlImportStrategy.CREATE_AND_UPDATE.
        merge_data_values (Union[Unset, bool]):  Default: False.
        merge_mode (Union[Unset, EnrollmentPostEnrollmentJsonpostEnrollmentXmlMergeMode]):
            Default: EnrollmentPostEnrollmentJsonpostEnrollmentXmlMergeMode.REPLACE.
        ...
        report_mode (Union[Unset, EnrollmentPostEnrollmentJsonpostEnrollmentXmlReportMode]):
            Default: EnrollmentPostEnrollmentJsonpostEnrollmentXmlReportMode.FULL.
        ...
        strategy (Union[Unset, EnrollmentPostEnrollmentJsonpostEnrollmentXmlStrategy]):  Default:
            EnrollmentPostEnrollmentJsonpostEnrollmentXmlStrategy.CREATE_AND_UPDATE.
