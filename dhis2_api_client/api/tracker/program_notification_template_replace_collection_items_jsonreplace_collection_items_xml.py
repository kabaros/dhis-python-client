...
from ...models.program_notification_template_replace_collection_items_jsonreplace_collection_items_xml_property import (
    ProgramNotificationTemplateReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: ProgramNotificationTemplateReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
    *,
