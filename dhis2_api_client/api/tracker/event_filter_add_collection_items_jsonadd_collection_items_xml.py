...
from ...models.event_filter_add_collection_items_jsonadd_collection_items_xml_property import (
    EventFilterAddCollectionItemsJsonaddCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: EventFilterAddCollectionItemsJsonaddCollectionItemsXmlProperty,
    *,
