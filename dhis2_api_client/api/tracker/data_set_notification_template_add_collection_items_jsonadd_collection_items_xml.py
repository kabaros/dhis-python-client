...
from ...models.data_set_notification_template_add_collection_items_jsonadd_collection_items_xml_property import (
    DataSetNotificationTemplateAddCollectionItemsJsonaddCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: DataSetNotificationTemplateAddCollectionItemsJsonaddCollectionItemsXmlProperty,
    *,
