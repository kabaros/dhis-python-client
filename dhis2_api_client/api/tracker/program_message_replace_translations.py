...
from ...models.program_message_replace_translations_body import ProgramMessageReplaceTranslationsBody
...
def _get_kwargs(
    uid: str,
    *,
    body: ProgramMessageReplaceTranslationsBody,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": f"/messages/{uid}/translations",
    }
