...
from ...models.program_rule_get_object_property_gist_as_csv_auto import ProgramRuleGetObjectPropertyGistAsCsvAuto
from ...models.program_rule_get_object_property_gist_as_csv_property import (
    ProgramRuleGetObjectPropertyGistAsCsvProperty,
)
from ...models.program_rule_get_object_property_gist_as_csv_root_junction import (
    ProgramRuleGetObjectPropertyGistAsCsvRootJunction,
)
...
def _get_kwargs(
    uid: str,
    property_: ProgramRuleGetObjectPropertyGistAsCsvProperty,
    *,
    absolute_urls: Union[Unset, bool] = False,
    auto: Union[Unset, ProgramRuleGetObjectPropertyGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, ProgramRuleGetObjectPropertyGistAsCsvRootJunction
    ] = ProgramRuleGetObjectPropertyGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/programRules/{uid}/{property_}/gist.csv",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, ProgramRuleGetObjectPropertyGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, ProgramRuleGetObjectPropertyGistAsCsvRootJunction]):  Default:
            ProgramRuleGetObjectPropertyGistAsCsvRootJunction.AND.
