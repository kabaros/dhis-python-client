...
from ...models.relationship_type_replace_collection_items_jsonreplace_collection_items_xml_property import (
    RelationshipTypeReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: RelationshipTypeReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
    *,
