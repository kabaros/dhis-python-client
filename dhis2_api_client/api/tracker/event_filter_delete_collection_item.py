...
from ...models.event_filter_delete_collection_item_property import EventFilterDeleteCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: EventFilterDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/eventFilters/{uid}/{property_}/{item_id}",
    }
