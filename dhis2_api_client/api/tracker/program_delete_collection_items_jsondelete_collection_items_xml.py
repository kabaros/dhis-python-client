...
from ...models.program_delete_collection_items_jsondelete_collection_items_xml_property import (
    ProgramDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: ProgramDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
    *,
