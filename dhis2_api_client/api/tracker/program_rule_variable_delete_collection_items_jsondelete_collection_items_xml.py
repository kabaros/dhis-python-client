...
from ...models.program_rule_variable_delete_collection_items_jsondelete_collection_items_xml_property import (
    ProgramRuleVariableDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: ProgramRuleVariableDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
    *,
