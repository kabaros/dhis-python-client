...
from ...models.tracked_entity_attribute_replace_collection_items_jsonreplace_collection_items_xml_property import (
    TrackedEntityAttributeReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: TrackedEntityAttributeReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
    *,
