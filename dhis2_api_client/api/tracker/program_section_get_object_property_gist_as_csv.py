...
from ...models.program_section_get_object_property_gist_as_csv_auto import ProgramSectionGetObjectPropertyGistAsCsvAuto
from ...models.program_section_get_object_property_gist_as_csv_property import (
    ProgramSectionGetObjectPropertyGistAsCsvProperty,
)
from ...models.program_section_get_object_property_gist_as_csv_root_junction import (
    ProgramSectionGetObjectPropertyGistAsCsvRootJunction,
)
...
def _get_kwargs(
    uid: str,
    property_: ProgramSectionGetObjectPropertyGistAsCsvProperty,
    *,
    absolute_urls: Union[Unset, bool] = False,
    auto: Union[Unset, ProgramSectionGetObjectPropertyGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, ProgramSectionGetObjectPropertyGistAsCsvRootJunction
    ] = ProgramSectionGetObjectPropertyGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/programSections/{uid}/{property_}/gist.csv",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, ProgramSectionGetObjectPropertyGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, ProgramSectionGetObjectPropertyGistAsCsvRootJunction]):
            Default: ProgramSectionGetObjectPropertyGistAsCsvRootJunction.AND.
