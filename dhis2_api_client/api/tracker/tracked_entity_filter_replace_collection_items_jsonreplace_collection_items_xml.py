...
from ...models.tracked_entity_filter_replace_collection_items_jsonreplace_collection_items_xml_property import (
    TrackedEntityFilterReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: TrackedEntityFilterReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
    *,
