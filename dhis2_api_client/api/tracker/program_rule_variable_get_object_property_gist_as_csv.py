...
from ...models.program_rule_variable_get_object_property_gist_as_csv_auto import (
    ProgramRuleVariableGetObjectPropertyGistAsCsvAuto,
)
from ...models.program_rule_variable_get_object_property_gist_as_csv_property import (
    ProgramRuleVariableGetObjectPropertyGistAsCsvProperty,
)
from ...models.program_rule_variable_get_object_property_gist_as_csv_root_junction import (
    ProgramRuleVariableGetObjectPropertyGistAsCsvRootJunction,
)
...
def _get_kwargs(
    uid: str,
    property_: ProgramRuleVariableGetObjectPropertyGistAsCsvProperty,
    *,
    absolute_urls: Union[Unset, bool] = False,
    auto: Union[Unset, ProgramRuleVariableGetObjectPropertyGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, ProgramRuleVariableGetObjectPropertyGistAsCsvRootJunction
    ] = ProgramRuleVariableGetObjectPropertyGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/programRuleVariables/{uid}/{property_}/gist.csv",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, ProgramRuleVariableGetObjectPropertyGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, ProgramRuleVariableGetObjectPropertyGistAsCsvRootJunction]):
            Default: ProgramRuleVariableGetObjectPropertyGistAsCsvRootJunction.AND.
