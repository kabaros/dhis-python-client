...
from ...models.program_rule_action_add_collection_item_property import ProgramRuleActionAddCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: ProgramRuleActionAddCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
