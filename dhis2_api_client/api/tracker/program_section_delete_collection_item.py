...
from ...models.program_section_delete_collection_item_property import ProgramSectionDeleteCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: ProgramSectionDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/programSections/{uid}/{property_}/{item_id}",
    }
