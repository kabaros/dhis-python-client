...
from ...models.data_set_notification_template_delete_collection_items_jsondelete_collection_items_xml_property import (
    DataSetNotificationTemplateDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: DataSetNotificationTemplateDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
    *,
