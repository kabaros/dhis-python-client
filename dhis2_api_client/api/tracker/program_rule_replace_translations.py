...
from ...models.program_rule_replace_translations_body import ProgramRuleReplaceTranslationsBody
...
def _get_kwargs(
    uid: str,
    *,
    body: ProgramRuleReplaceTranslationsBody,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": f"/programRules/{uid}/translations",
    }
