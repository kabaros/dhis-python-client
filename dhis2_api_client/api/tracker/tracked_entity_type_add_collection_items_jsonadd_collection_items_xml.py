...
from ...models.tracked_entity_type_add_collection_items_jsonadd_collection_items_xml_property import (
    TrackedEntityTypeAddCollectionItemsJsonaddCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: TrackedEntityTypeAddCollectionItemsJsonaddCollectionItemsXmlProperty,
    *,
