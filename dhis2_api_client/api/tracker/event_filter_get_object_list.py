...
from ...models.event_filter_get_object_list_response_200 import EventFilterGetObjectListResponse200
from ...models.event_filter_get_object_list_root_junction import EventFilterGetObjectListRootJunction
...
def _get_kwargs(
    *,
    ...
    root_junction: Union[Unset, EventFilterGetObjectListRootJunction] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
) -> Optional[Union[EventFilterGetObjectListResponse200, WebMessage]]:
    if response.status_code == 200:
        response_200 = EventFilterGetObjectListResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[EventFilterGetObjectListResponse200, WebMessage]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, EventFilterGetObjectListRootJunction]):
...
def sync(
    *,
    ...
    Returns:
        Union[EventFilterGetObjectListResponse200, WebMessage]
    """
