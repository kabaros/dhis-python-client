...
from ...models.program_indicator_group_bulk_sharing_atomic_mode import ProgramIndicatorGroupBulkSharingAtomicMode
from ...models.program_indicator_group_bulk_sharing_flush_mode import ProgramIndicatorGroupBulkSharingFlushMode
from ...models.program_indicator_group_bulk_sharing_identifier import ProgramIndicatorGroupBulkSharingIdentifier
from ...models.program_indicator_group_bulk_sharing_import_mode import ProgramIndicatorGroupBulkSharingImportMode
from ...models.program_indicator_group_bulk_sharing_import_report_mode import (
    ProgramIndicatorGroupBulkSharingImportReportMode,
)
from ...models.program_indicator_group_bulk_sharing_import_strategy import (
    ProgramIndicatorGroupBulkSharingImportStrategy,
)
from ...models.program_indicator_group_bulk_sharing_preheat_mode import ProgramIndicatorGroupBulkSharingPreheatMode
from ...models.program_indicator_group_bulk_sharing_root_junction import ProgramIndicatorGroupBulkSharingRootJunction
from ...models.program_indicator_group_bulk_sharing_user_override_mode import (
    ProgramIndicatorGroupBulkSharingUserOverrideMode,
)
...
def _get_kwargs(
    *,
    ...
    atomic_mode: Union[
        Unset, ProgramIndicatorGroupBulkSharingAtomicMode
    ] = ProgramIndicatorGroupBulkSharingAtomicMode.ALL,
    flush_mode: Union[
        Unset, ProgramIndicatorGroupBulkSharingFlushMode
    ] = ProgramIndicatorGroupBulkSharingFlushMode.AUTO,
    identifier: Union[
        Unset, ProgramIndicatorGroupBulkSharingIdentifier
    ] = ProgramIndicatorGroupBulkSharingIdentifier.UID,
    import_mode: Union[
        Unset, ProgramIndicatorGroupBulkSharingImportMode
    ] = ProgramIndicatorGroupBulkSharingImportMode.COMMIT,
    import_report_mode: Union[
        Unset, ProgramIndicatorGroupBulkSharingImportReportMode
    ] = ProgramIndicatorGroupBulkSharingImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, ProgramIndicatorGroupBulkSharingImportStrategy
    ] = ProgramIndicatorGroupBulkSharingImportStrategy.CREATE_AND_UPDATE,
    ...
    preheat_mode: Union[
        Unset, ProgramIndicatorGroupBulkSharingPreheatMode
    ] = ProgramIndicatorGroupBulkSharingPreheatMode.REFERENCE,
    root_junction: Union[Unset, ProgramIndicatorGroupBulkSharingRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, ProgramIndicatorGroupBulkSharingUserOverrideMode
    ] = ProgramIndicatorGroupBulkSharingUserOverrideMode.NONE,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/programIndicatorGroups/sharing",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, ProgramIndicatorGroupBulkSharingAtomicMode]):  Default:
            ProgramIndicatorGroupBulkSharingAtomicMode.ALL.
        flush_mode (Union[Unset, ProgramIndicatorGroupBulkSharingFlushMode]):  Default:
            ProgramIndicatorGroupBulkSharingFlushMode.AUTO.
        identifier (Union[Unset, ProgramIndicatorGroupBulkSharingIdentifier]):  Default:
            ProgramIndicatorGroupBulkSharingIdentifier.UID.
        import_mode (Union[Unset, ProgramIndicatorGroupBulkSharingImportMode]):  Default:
            ProgramIndicatorGroupBulkSharingImportMode.COMMIT.
        import_report_mode (Union[Unset, ProgramIndicatorGroupBulkSharingImportReportMode]):
            Default: ProgramIndicatorGroupBulkSharingImportReportMode.ERRORS.
        import_strategy (Union[Unset, ProgramIndicatorGroupBulkSharingImportStrategy]):  Default:
            ProgramIndicatorGroupBulkSharingImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, ProgramIndicatorGroupBulkSharingPreheatMode]):  Default:
            ProgramIndicatorGroupBulkSharingPreheatMode.REFERENCE.
        root_junction (Union[Unset, ProgramIndicatorGroupBulkSharingRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, ProgramIndicatorGroupBulkSharingUserOverrideMode]):
            Default: ProgramIndicatorGroupBulkSharingUserOverrideMode.NONE.
        body (BulkJsonPatch):
