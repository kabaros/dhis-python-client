...
from ...models.relationship_type_delete_collection_item_property import RelationshipTypeDeleteCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: RelationshipTypeDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/relationshipTypes/{uid}/{property_}/{item_id}",
    }
