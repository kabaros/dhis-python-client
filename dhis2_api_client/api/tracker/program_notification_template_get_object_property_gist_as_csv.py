...
from ...models.program_notification_template_get_object_property_gist_as_csv_auto import (
    ProgramNotificationTemplateGetObjectPropertyGistAsCsvAuto,
)
from ...models.program_notification_template_get_object_property_gist_as_csv_property import (
    ProgramNotificationTemplateGetObjectPropertyGistAsCsvProperty,
)
from ...models.program_notification_template_get_object_property_gist_as_csv_root_junction import (
    ProgramNotificationTemplateGetObjectPropertyGistAsCsvRootJunction,
)
...
def _get_kwargs(
    uid: str,
    property_: ProgramNotificationTemplateGetObjectPropertyGistAsCsvProperty,
    *,
    absolute_urls: Union[Unset, bool] = False,
    auto: Union[Unset, ProgramNotificationTemplateGetObjectPropertyGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, ProgramNotificationTemplateGetObjectPropertyGistAsCsvRootJunction
    ] = ProgramNotificationTemplateGetObjectPropertyGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/programNotificationTemplates/{uid}/{property_}/gist.csv",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, ProgramNotificationTemplateGetObjectPropertyGistAsCsvAuto]):
        ...
        root_junction (Union[Unset,
            ProgramNotificationTemplateGetObjectPropertyGistAsCsvRootJunction]):  Default:
            ProgramNotificationTemplateGetObjectPropertyGistAsCsvRootJunction.AND.
