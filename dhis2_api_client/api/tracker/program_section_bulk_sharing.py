...
from ...models.program_section_bulk_sharing_atomic_mode import ProgramSectionBulkSharingAtomicMode
from ...models.program_section_bulk_sharing_flush_mode import ProgramSectionBulkSharingFlushMode
from ...models.program_section_bulk_sharing_identifier import ProgramSectionBulkSharingIdentifier
from ...models.program_section_bulk_sharing_import_mode import ProgramSectionBulkSharingImportMode
from ...models.program_section_bulk_sharing_import_report_mode import ProgramSectionBulkSharingImportReportMode
from ...models.program_section_bulk_sharing_import_strategy import ProgramSectionBulkSharingImportStrategy
from ...models.program_section_bulk_sharing_preheat_mode import ProgramSectionBulkSharingPreheatMode
from ...models.program_section_bulk_sharing_root_junction import ProgramSectionBulkSharingRootJunction
from ...models.program_section_bulk_sharing_user_override_mode import ProgramSectionBulkSharingUserOverrideMode
...
def _get_kwargs(
    *,
    ...
    atomic_mode: Union[Unset, ProgramSectionBulkSharingAtomicMode] = ProgramSectionBulkSharingAtomicMode.ALL,
    flush_mode: Union[Unset, ProgramSectionBulkSharingFlushMode] = ProgramSectionBulkSharingFlushMode.AUTO,
    identifier: Union[Unset, ProgramSectionBulkSharingIdentifier] = ProgramSectionBulkSharingIdentifier.UID,
    import_mode: Union[Unset, ProgramSectionBulkSharingImportMode] = ProgramSectionBulkSharingImportMode.COMMIT,
    import_report_mode: Union[
        Unset, ProgramSectionBulkSharingImportReportMode
    ] = ProgramSectionBulkSharingImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, ProgramSectionBulkSharingImportStrategy
    ] = ProgramSectionBulkSharingImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, ProgramSectionBulkSharingPreheatMode] = ProgramSectionBulkSharingPreheatMode.REFERENCE,
    root_junction: Union[Unset, ProgramSectionBulkSharingRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, ProgramSectionBulkSharingUserOverrideMode
    ] = ProgramSectionBulkSharingUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, ProgramSectionBulkSharingAtomicMode]):  Default:
            ProgramSectionBulkSharingAtomicMode.ALL.
        flush_mode (Union[Unset, ProgramSectionBulkSharingFlushMode]):  Default:
            ProgramSectionBulkSharingFlushMode.AUTO.
        identifier (Union[Unset, ProgramSectionBulkSharingIdentifier]):  Default:
            ProgramSectionBulkSharingIdentifier.UID.
        import_mode (Union[Unset, ProgramSectionBulkSharingImportMode]):  Default:
            ProgramSectionBulkSharingImportMode.COMMIT.
        import_report_mode (Union[Unset, ProgramSectionBulkSharingImportReportMode]):  Default:
            ProgramSectionBulkSharingImportReportMode.ERRORS.
        import_strategy (Union[Unset, ProgramSectionBulkSharingImportStrategy]):  Default:
            ProgramSectionBulkSharingImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, ProgramSectionBulkSharingPreheatMode]):  Default:
            ProgramSectionBulkSharingPreheatMode.REFERENCE.
        root_junction (Union[Unset, ProgramSectionBulkSharingRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, ProgramSectionBulkSharingUserOverrideMode]):  Default:
            ProgramSectionBulkSharingUserOverrideMode.NONE.
        body (BulkJsonPatch):
