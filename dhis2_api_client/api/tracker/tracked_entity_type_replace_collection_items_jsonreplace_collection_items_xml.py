...
from ...models.tracked_entity_type_replace_collection_items_jsonreplace_collection_items_xml_property import (
    TrackedEntityTypeReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: TrackedEntityTypeReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
    *,
