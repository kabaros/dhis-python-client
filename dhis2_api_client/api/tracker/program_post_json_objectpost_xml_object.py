...
from ...models.program_post_json_objectpost_xml_object_atomic_mode import ProgramPostJsonObjectpostXmlObjectAtomicMode
from ...models.program_post_json_objectpost_xml_object_flush_mode import ProgramPostJsonObjectpostXmlObjectFlushMode
from ...models.program_post_json_objectpost_xml_object_identifier import ProgramPostJsonObjectpostXmlObjectIdentifier
from ...models.program_post_json_objectpost_xml_object_import_mode import ProgramPostJsonObjectpostXmlObjectImportMode
from ...models.program_post_json_objectpost_xml_object_import_report_mode import (
    ProgramPostJsonObjectpostXmlObjectImportReportMode,
)
from ...models.program_post_json_objectpost_xml_object_import_strategy import (
    ProgramPostJsonObjectpostXmlObjectImportStrategy,
)
from ...models.program_post_json_objectpost_xml_object_preheat_mode import ProgramPostJsonObjectpostXmlObjectPreheatMode
from ...models.program_post_json_objectpost_xml_object_user_override_mode import (
    ProgramPostJsonObjectpostXmlObjectUserOverrideMode,
)
...
def _get_kwargs(
    *,
    ...
    atomic_mode: Union[
        Unset, ProgramPostJsonObjectpostXmlObjectAtomicMode
    ] = ProgramPostJsonObjectpostXmlObjectAtomicMode.ALL,
    flush_mode: Union[
        Unset, ProgramPostJsonObjectpostXmlObjectFlushMode
    ] = ProgramPostJsonObjectpostXmlObjectFlushMode.AUTO,
    identifier: Union[
        Unset, ProgramPostJsonObjectpostXmlObjectIdentifier
    ] = ProgramPostJsonObjectpostXmlObjectIdentifier.UID,
    import_mode: Union[
        Unset, ProgramPostJsonObjectpostXmlObjectImportMode
    ] = ProgramPostJsonObjectpostXmlObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, ProgramPostJsonObjectpostXmlObjectImportReportMode
    ] = ProgramPostJsonObjectpostXmlObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, ProgramPostJsonObjectpostXmlObjectImportStrategy
    ] = ProgramPostJsonObjectpostXmlObjectImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    preheat_mode: Union[
        Unset, ProgramPostJsonObjectpostXmlObjectPreheatMode
    ] = ProgramPostJsonObjectpostXmlObjectPreheatMode.REFERENCE,
    ...
    user_override_mode: Union[
        Unset, ProgramPostJsonObjectpostXmlObjectUserOverrideMode
    ] = ProgramPostJsonObjectpostXmlObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, ProgramPostJsonObjectpostXmlObjectAtomicMode]):  Default:
            ProgramPostJsonObjectpostXmlObjectAtomicMode.ALL.
        flush_mode (Union[Unset, ProgramPostJsonObjectpostXmlObjectFlushMode]):  Default:
            ProgramPostJsonObjectpostXmlObjectFlushMode.AUTO.
        identifier (Union[Unset, ProgramPostJsonObjectpostXmlObjectIdentifier]):  Default:
            ProgramPostJsonObjectpostXmlObjectIdentifier.UID.
        import_mode (Union[Unset, ProgramPostJsonObjectpostXmlObjectImportMode]):  Default:
            ProgramPostJsonObjectpostXmlObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, ProgramPostJsonObjectpostXmlObjectImportReportMode]):
            Default: ProgramPostJsonObjectpostXmlObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, ProgramPostJsonObjectpostXmlObjectImportStrategy]):
            Default: ProgramPostJsonObjectpostXmlObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, ProgramPostJsonObjectpostXmlObjectPreheatMode]):  Default:
            ProgramPostJsonObjectpostXmlObjectPreheatMode.REFERENCE.
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, ProgramPostJsonObjectpostXmlObjectUserOverrideMode]):
            Default: ProgramPostJsonObjectpostXmlObjectUserOverrideMode.NONE.
        body (Program):
