...
from ...models.program_message_get_object_root_junction import ProgramMessageGetObjectRootJunction
...
def _get_kwargs(
    ...
    *,
    ...
    root_junction: Union[Unset, ProgramMessageGetObjectRootJunction] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
) -> Optional[Union[ProgramMessage, WebMessage]]:
    if response.status_code == 200:
        response_200 = ProgramMessage.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ProgramMessage, WebMessage]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, ProgramMessageGetObjectRootJunction]):
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ProgramMessage, WebMessage]
    """
