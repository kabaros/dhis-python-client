...
from ...models.program_rule_variable_delete_collection_item_property import (
    ProgramRuleVariableDeleteCollectionItemProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: ProgramRuleVariableDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/programRuleVariables/{uid}/{property_}/{item_id}",
    }
