...
from ...models.program_rule_variable_add_collection_items_jsonadd_collection_items_xml_property import (
    ProgramRuleVariableAddCollectionItemsJsonaddCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: ProgramRuleVariableAddCollectionItemsJsonaddCollectionItemsXmlProperty,
    *,
