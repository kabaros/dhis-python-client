...
from ...models.relationship_type_get_object_list_csv_root_junction import RelationshipTypeGetObjectListCsvRootJunction
...
def _get_kwargs(
    *,
    ...
    root_junction: Union[Unset, RelationshipTypeGetObjectListCsvRootJunction] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/relationshipTypes/#getObjectListCsv",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, RelationshipTypeGetObjectListCsvRootJunction]):
