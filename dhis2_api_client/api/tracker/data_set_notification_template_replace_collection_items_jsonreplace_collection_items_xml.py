...
from ...models.data_set_notification_template_replace_collection_items_jsonreplace_collection_items_xml_property import (
    DataSetNotificationTemplateReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: DataSetNotificationTemplateReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
    *,
