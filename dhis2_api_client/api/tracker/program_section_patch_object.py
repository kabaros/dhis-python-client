...
from ...models.program_section_patch_object_atomic_mode import ProgramSectionPatchObjectAtomicMode
from ...models.program_section_patch_object_flush_mode import ProgramSectionPatchObjectFlushMode
from ...models.program_section_patch_object_identifier import ProgramSectionPatchObjectIdentifier
from ...models.program_section_patch_object_import_mode import ProgramSectionPatchObjectImportMode
from ...models.program_section_patch_object_import_report_mode import ProgramSectionPatchObjectImportReportMode
from ...models.program_section_patch_object_import_strategy import ProgramSectionPatchObjectImportStrategy
from ...models.program_section_patch_object_preheat_mode import ProgramSectionPatchObjectPreheatMode
from ...models.program_section_patch_object_root_junction import ProgramSectionPatchObjectRootJunction
from ...models.program_section_patch_object_user_override_mode import ProgramSectionPatchObjectUserOverrideMode
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[Unset, ProgramSectionPatchObjectAtomicMode] = ProgramSectionPatchObjectAtomicMode.ALL,
    flush_mode: Union[Unset, ProgramSectionPatchObjectFlushMode] = ProgramSectionPatchObjectFlushMode.AUTO,
    identifier: Union[Unset, ProgramSectionPatchObjectIdentifier] = ProgramSectionPatchObjectIdentifier.UID,
    import_mode: Union[Unset, ProgramSectionPatchObjectImportMode] = ProgramSectionPatchObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, ProgramSectionPatchObjectImportReportMode
    ] = ProgramSectionPatchObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, ProgramSectionPatchObjectImportStrategy
    ] = ProgramSectionPatchObjectImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, ProgramSectionPatchObjectPreheatMode] = ProgramSectionPatchObjectPreheatMode.REFERENCE,
    root_junction: Union[Unset, ProgramSectionPatchObjectRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, ProgramSectionPatchObjectUserOverrideMode
    ] = ProgramSectionPatchObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, ProgramSectionPatchObjectAtomicMode]):  Default:
            ProgramSectionPatchObjectAtomicMode.ALL.
        flush_mode (Union[Unset, ProgramSectionPatchObjectFlushMode]):  Default:
            ProgramSectionPatchObjectFlushMode.AUTO.
        identifier (Union[Unset, ProgramSectionPatchObjectIdentifier]):  Default:
            ProgramSectionPatchObjectIdentifier.UID.
        import_mode (Union[Unset, ProgramSectionPatchObjectImportMode]):  Default:
            ProgramSectionPatchObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, ProgramSectionPatchObjectImportReportMode]):  Default:
            ProgramSectionPatchObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, ProgramSectionPatchObjectImportStrategy]):  Default:
            ProgramSectionPatchObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, ProgramSectionPatchObjectPreheatMode]):  Default:
            ProgramSectionPatchObjectPreheatMode.REFERENCE.
        root_junction (Union[Unset, ProgramSectionPatchObjectRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, ProgramSectionPatchObjectUserOverrideMode]):  Default:
            ProgramSectionPatchObjectUserOverrideMode.NONE.
        body (JsonPatch):
