...
from ...models.program_rule_variable_get_object_list_csv_root_junction import (
    ProgramRuleVariableGetObjectListCsvRootJunction,
)
...
def _get_kwargs(
    *,
    ...
    root_junction: Union[Unset, ProgramRuleVariableGetObjectListCsvRootJunction] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/programRuleVariables/#getObjectListCsv",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, ProgramRuleVariableGetObjectListCsvRootJunction]):
