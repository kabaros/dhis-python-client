...
from ...models.event_filter_patch_object_atomic_mode import EventFilterPatchObjectAtomicMode
from ...models.event_filter_patch_object_flush_mode import EventFilterPatchObjectFlushMode
from ...models.event_filter_patch_object_identifier import EventFilterPatchObjectIdentifier
from ...models.event_filter_patch_object_import_mode import EventFilterPatchObjectImportMode
from ...models.event_filter_patch_object_import_report_mode import EventFilterPatchObjectImportReportMode
from ...models.event_filter_patch_object_import_strategy import EventFilterPatchObjectImportStrategy
from ...models.event_filter_patch_object_preheat_mode import EventFilterPatchObjectPreheatMode
from ...models.event_filter_patch_object_root_junction import EventFilterPatchObjectRootJunction
from ...models.event_filter_patch_object_user_override_mode import EventFilterPatchObjectUserOverrideMode
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[Unset, EventFilterPatchObjectAtomicMode] = EventFilterPatchObjectAtomicMode.ALL,
    flush_mode: Union[Unset, EventFilterPatchObjectFlushMode] = EventFilterPatchObjectFlushMode.AUTO,
    identifier: Union[Unset, EventFilterPatchObjectIdentifier] = EventFilterPatchObjectIdentifier.UID,
    import_mode: Union[Unset, EventFilterPatchObjectImportMode] = EventFilterPatchObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, EventFilterPatchObjectImportReportMode
    ] = EventFilterPatchObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, EventFilterPatchObjectImportStrategy
    ] = EventFilterPatchObjectImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, EventFilterPatchObjectPreheatMode] = EventFilterPatchObjectPreheatMode.REFERENCE,
    root_junction: Union[Unset, EventFilterPatchObjectRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, EventFilterPatchObjectUserOverrideMode
    ] = EventFilterPatchObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, EventFilterPatchObjectAtomicMode]):  Default:
            EventFilterPatchObjectAtomicMode.ALL.
        flush_mode (Union[Unset, EventFilterPatchObjectFlushMode]):  Default:
            EventFilterPatchObjectFlushMode.AUTO.
        identifier (Union[Unset, EventFilterPatchObjectIdentifier]):  Default:
            EventFilterPatchObjectIdentifier.UID.
        import_mode (Union[Unset, EventFilterPatchObjectImportMode]):  Default:
            EventFilterPatchObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, EventFilterPatchObjectImportReportMode]):  Default:
            EventFilterPatchObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, EventFilterPatchObjectImportStrategy]):  Default:
            EventFilterPatchObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, EventFilterPatchObjectPreheatMode]):  Default:
            EventFilterPatchObjectPreheatMode.REFERENCE.
        root_junction (Union[Unset, EventFilterPatchObjectRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, EventFilterPatchObjectUserOverrideMode]):  Default:
            EventFilterPatchObjectUserOverrideMode.NONE.
        body (JsonPatch):
