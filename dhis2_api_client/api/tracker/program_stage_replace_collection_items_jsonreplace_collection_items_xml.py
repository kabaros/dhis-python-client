...
from ...models.program_stage_replace_collection_items_jsonreplace_collection_items_xml_property import (
    ProgramStageReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: ProgramStageReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
    *,
