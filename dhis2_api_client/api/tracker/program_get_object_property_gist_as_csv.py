...
from ...models.program_get_object_property_gist_as_csv_auto import ProgramGetObjectPropertyGistAsCsvAuto
from ...models.program_get_object_property_gist_as_csv_property import ProgramGetObjectPropertyGistAsCsvProperty
from ...models.program_get_object_property_gist_as_csv_root_junction import (
    ProgramGetObjectPropertyGistAsCsvRootJunction,
)
...
def _get_kwargs(
    uid: str,
    property_: ProgramGetObjectPropertyGistAsCsvProperty,
    *,
    absolute_urls: Union[Unset, bool] = False,
    auto: Union[Unset, ProgramGetObjectPropertyGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, ProgramGetObjectPropertyGistAsCsvRootJunction
    ] = ProgramGetObjectPropertyGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/programs/{uid}/{property_}/gist.csv",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, ProgramGetObjectPropertyGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, ProgramGetObjectPropertyGistAsCsvRootJunction]):  Default:
            ProgramGetObjectPropertyGistAsCsvRootJunction.AND.
