...
from ...models.relationship_type_get_object_root_junction import RelationshipTypeGetObjectRootJunction
...
def _get_kwargs(
    ...
    *,
    ...
    root_junction: Union[Unset, RelationshipTypeGetObjectRootJunction] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
) -> Optional[Union[RelationshipType, WebMessage]]:
    if response.status_code == 200:
        response_200 = RelationshipType.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RelationshipType, WebMessage]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, RelationshipTypeGetObjectRootJunction]):
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[RelationshipType, WebMessage]
    """
