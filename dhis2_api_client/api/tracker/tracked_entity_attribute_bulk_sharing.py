...
from ...models.tracked_entity_attribute_bulk_sharing_atomic_mode import TrackedEntityAttributeBulkSharingAtomicMode
from ...models.tracked_entity_attribute_bulk_sharing_flush_mode import TrackedEntityAttributeBulkSharingFlushMode
from ...models.tracked_entity_attribute_bulk_sharing_identifier import TrackedEntityAttributeBulkSharingIdentifier
from ...models.tracked_entity_attribute_bulk_sharing_import_mode import TrackedEntityAttributeBulkSharingImportMode
from ...models.tracked_entity_attribute_bulk_sharing_import_report_mode import (
    TrackedEntityAttributeBulkSharingImportReportMode,
)
from ...models.tracked_entity_attribute_bulk_sharing_import_strategy import (
    TrackedEntityAttributeBulkSharingImportStrategy,
)
from ...models.tracked_entity_attribute_bulk_sharing_preheat_mode import TrackedEntityAttributeBulkSharingPreheatMode
from ...models.tracked_entity_attribute_bulk_sharing_root_junction import TrackedEntityAttributeBulkSharingRootJunction
from ...models.tracked_entity_attribute_bulk_sharing_user_override_mode import (
    TrackedEntityAttributeBulkSharingUserOverrideMode,
)
...
def _get_kwargs(
    *,
    ...
    atomic_mode: Union[
        Unset, TrackedEntityAttributeBulkSharingAtomicMode
    ] = TrackedEntityAttributeBulkSharingAtomicMode.ALL,
    flush_mode: Union[
        Unset, TrackedEntityAttributeBulkSharingFlushMode
    ] = TrackedEntityAttributeBulkSharingFlushMode.AUTO,
    identifier: Union[
        Unset, TrackedEntityAttributeBulkSharingIdentifier
    ] = TrackedEntityAttributeBulkSharingIdentifier.UID,
    import_mode: Union[
        Unset, TrackedEntityAttributeBulkSharingImportMode
    ] = TrackedEntityAttributeBulkSharingImportMode.COMMIT,
    import_report_mode: Union[
        Unset, TrackedEntityAttributeBulkSharingImportReportMode
    ] = TrackedEntityAttributeBulkSharingImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, TrackedEntityAttributeBulkSharingImportStrategy
    ] = TrackedEntityAttributeBulkSharingImportStrategy.CREATE_AND_UPDATE,
    ...
    preheat_mode: Union[
        Unset, TrackedEntityAttributeBulkSharingPreheatMode
    ] = TrackedEntityAttributeBulkSharingPreheatMode.REFERENCE,
    root_junction: Union[Unset, TrackedEntityAttributeBulkSharingRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, TrackedEntityAttributeBulkSharingUserOverrideMode
    ] = TrackedEntityAttributeBulkSharingUserOverrideMode.NONE,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/trackedEntityAttributes/sharing",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, TrackedEntityAttributeBulkSharingAtomicMode]):  Default:
            TrackedEntityAttributeBulkSharingAtomicMode.ALL.
        flush_mode (Union[Unset, TrackedEntityAttributeBulkSharingFlushMode]):  Default:
            TrackedEntityAttributeBulkSharingFlushMode.AUTO.
        identifier (Union[Unset, TrackedEntityAttributeBulkSharingIdentifier]):  Default:
            TrackedEntityAttributeBulkSharingIdentifier.UID.
        import_mode (Union[Unset, TrackedEntityAttributeBulkSharingImportMode]):  Default:
            TrackedEntityAttributeBulkSharingImportMode.COMMIT.
        import_report_mode (Union[Unset, TrackedEntityAttributeBulkSharingImportReportMode]):
            Default: TrackedEntityAttributeBulkSharingImportReportMode.ERRORS.
        import_strategy (Union[Unset, TrackedEntityAttributeBulkSharingImportStrategy]):  Default:
            TrackedEntityAttributeBulkSharingImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, TrackedEntityAttributeBulkSharingPreheatMode]):  Default:
            TrackedEntityAttributeBulkSharingPreheatMode.REFERENCE.
        root_junction (Union[Unset, TrackedEntityAttributeBulkSharingRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, TrackedEntityAttributeBulkSharingUserOverrideMode]):
            Default: TrackedEntityAttributeBulkSharingUserOverrideMode.NONE.
        body (BulkJsonPatch):
