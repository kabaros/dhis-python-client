...
from ...models.program_rule_variable_replace_collection_items_jsonreplace_collection_items_xml_property import (
    ProgramRuleVariableReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: ProgramRuleVariableReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
    *,
