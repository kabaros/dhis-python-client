...
from ...models.tracked_entity_type_get_object_list_csv_root_junction import (
    TrackedEntityTypeGetObjectListCsvRootJunction,
)
...
def _get_kwargs(
    *,
    ...
    root_junction: Union[Unset, TrackedEntityTypeGetObjectListCsvRootJunction] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/trackedEntityTypes/#getObjectListCsv",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, TrackedEntityTypeGetObjectListCsvRootJunction]):
