...
from ...models.tracked_entities_export_get_tracked_entities_as_csv_g_zip_assigned_user_mode import (
    TrackedEntitiesExportGetTrackedEntitiesAsCsvGZipAssignedUserMode,
)
from ...models.tracked_entities_export_get_tracked_entities_as_csv_g_zip_event_status import (
    TrackedEntitiesExportGetTrackedEntitiesAsCsvGZipEventStatus,
)
from ...models.tracked_entities_export_get_tracked_entities_as_csv_g_zip_org_unit_mode import (
    TrackedEntitiesExportGetTrackedEntitiesAsCsvGZipOrgUnitMode,
)
from ...models.tracked_entities_export_get_tracked_entities_as_csv_g_zip_ou_mode import (
    TrackedEntitiesExportGetTrackedEntitiesAsCsvGZipOuMode,
)
from ...models.tracked_entities_export_get_tracked_entities_as_csv_g_zip_program_status import (
    TrackedEntitiesExportGetTrackedEntitiesAsCsvGZipProgramStatus,
)
...
def _get_kwargs(
    *,
    ...
    assigned_user_mode: Union[Unset, TrackedEntitiesExportGetTrackedEntitiesAsCsvGZipAssignedUserMode] = UNSET,
    ...
    event_status: Union[Unset, TrackedEntitiesExportGetTrackedEntitiesAsCsvGZipEventStatus] = UNSET,
    ...
    org_unit_mode: Union[Unset, TrackedEntitiesExportGetTrackedEntitiesAsCsvGZipOrgUnitMode] = UNSET,
    org_units: Union[Unset, list[str]] = UNSET,
    ou_mode: Union[Unset, TrackedEntitiesExportGetTrackedEntitiesAsCsvGZipOuMode] = UNSET,
    ...
    program_status: Union[Unset, TrackedEntitiesExportGetTrackedEntitiesAsCsvGZipProgramStatus] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/tracker/trackedEntities/#getTrackedEntitiesAsCsvGZip",
        "params": params,
    }
    ...
    *,
    ...
    Args:
        ...
        event_occurred_before (Union[Unset, EndDateTime]): The actual type is unknown.
            (Java type was: `class org.hisp.dhis.webapi.webdomain.EndDateTime`)
        event_status (Union[Unset, TrackedEntitiesExportGetTrackedEntitiesAsCsvGZipEventStatus]):
        ...
        org_unit_mode (Union[Unset, TrackedEntitiesExportGetTrackedEntitiesAsCsvGZipOrgUnitMode]):
        org_units (Union[Unset, list[str]]):
        ou_mode (Union[Unset, TrackedEntitiesExportGetTrackedEntitiesAsCsvGZipOuMode]):
