...
from ...models.program_rule_action_delete_collection_items_jsondelete_collection_items_xml_property import (
    ProgramRuleActionDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: ProgramRuleActionDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
    *,
