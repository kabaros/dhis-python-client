...
from ...models.program_stage_section_delete_collection_item_property import (
    ProgramStageSectionDeleteCollectionItemProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: ProgramStageSectionDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/programStageSections/{uid}/{property_}/{item_id}",
    }
