...
from ...models.program_get_object_gistget_object_gist_as_csv_auto import ProgramGetObjectGistgetObjectGistAsCsvAuto
from ...models.program_get_object_gistget_object_gist_as_csv_response_200 import (
    ProgramGetObjectGistgetObjectGistAsCsvResponse200,
)
from ...models.program_get_object_gistget_object_gist_as_csv_root_junction import (
    ProgramGetObjectGistgetObjectGistAsCsvRootJunction,
)
...
def _get_kwargs(
    ...
    *,
    ...
    auto: Union[Unset, ProgramGetObjectGistgetObjectGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, ProgramGetObjectGistgetObjectGistAsCsvRootJunction
    ] = ProgramGetObjectGistgetObjectGistAsCsvRootJunction.AND,
...
) -> Optional[Union[ProgramGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]]:
    if response.status_code == 200:
        response_200 = ProgramGetObjectGistgetObjectGistAsCsvResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ProgramGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, ProgramGetObjectGistgetObjectGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, ProgramGetObjectGistgetObjectGistAsCsvRootJunction]):
            Default: ProgramGetObjectGistgetObjectGistAsCsvRootJunction.AND.
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ProgramGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]
    """
