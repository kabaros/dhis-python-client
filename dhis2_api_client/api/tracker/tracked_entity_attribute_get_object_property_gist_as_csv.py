...
from ...models.tracked_entity_attribute_get_object_property_gist_as_csv_auto import (
    TrackedEntityAttributeGetObjectPropertyGistAsCsvAuto,
)
from ...models.tracked_entity_attribute_get_object_property_gist_as_csv_property import (
    TrackedEntityAttributeGetObjectPropertyGistAsCsvProperty,
)
from ...models.tracked_entity_attribute_get_object_property_gist_as_csv_root_junction import (
    TrackedEntityAttributeGetObjectPropertyGistAsCsvRootJunction,
)
...
def _get_kwargs(
    uid: str,
    property_: TrackedEntityAttributeGetObjectPropertyGistAsCsvProperty,
    *,
    absolute_urls: Union[Unset, bool] = False,
    auto: Union[Unset, TrackedEntityAttributeGetObjectPropertyGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, TrackedEntityAttributeGetObjectPropertyGistAsCsvRootJunction
    ] = TrackedEntityAttributeGetObjectPropertyGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/trackedEntityAttributes/{uid}/{property_}/gist.csv",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, TrackedEntityAttributeGetObjectPropertyGistAsCsvAuto]):
        ...
        root_junction (Union[Unset,
            TrackedEntityAttributeGetObjectPropertyGistAsCsvRootJunction]):  Default:
            TrackedEntityAttributeGetObjectPropertyGistAsCsvRootJunction.AND.
