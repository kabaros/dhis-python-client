...
from ...models.relationship_type_patch_object_atomic_mode import RelationshipTypePatchObjectAtomicMode
from ...models.relationship_type_patch_object_flush_mode import RelationshipTypePatchObjectFlushMode
from ...models.relationship_type_patch_object_identifier import RelationshipTypePatchObjectIdentifier
from ...models.relationship_type_patch_object_import_mode import RelationshipTypePatchObjectImportMode
from ...models.relationship_type_patch_object_import_report_mode import RelationshipTypePatchObjectImportReportMode
from ...models.relationship_type_patch_object_import_strategy import RelationshipTypePatchObjectImportStrategy
from ...models.relationship_type_patch_object_preheat_mode import RelationshipTypePatchObjectPreheatMode
from ...models.relationship_type_patch_object_root_junction import RelationshipTypePatchObjectRootJunction
from ...models.relationship_type_patch_object_user_override_mode import RelationshipTypePatchObjectUserOverrideMode
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[Unset, RelationshipTypePatchObjectAtomicMode] = RelationshipTypePatchObjectAtomicMode.ALL,
    flush_mode: Union[Unset, RelationshipTypePatchObjectFlushMode] = RelationshipTypePatchObjectFlushMode.AUTO,
    identifier: Union[Unset, RelationshipTypePatchObjectIdentifier] = RelationshipTypePatchObjectIdentifier.UID,
    import_mode: Union[Unset, RelationshipTypePatchObjectImportMode] = RelationshipTypePatchObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, RelationshipTypePatchObjectImportReportMode
    ] = RelationshipTypePatchObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, RelationshipTypePatchObjectImportStrategy
    ] = RelationshipTypePatchObjectImportStrategy.CREATE_AND_UPDATE,
    ...
    preheat_mode: Union[
        Unset, RelationshipTypePatchObjectPreheatMode
    ] = RelationshipTypePatchObjectPreheatMode.REFERENCE,
    root_junction: Union[Unset, RelationshipTypePatchObjectRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, RelationshipTypePatchObjectUserOverrideMode
    ] = RelationshipTypePatchObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, RelationshipTypePatchObjectAtomicMode]):  Default:
            RelationshipTypePatchObjectAtomicMode.ALL.
        flush_mode (Union[Unset, RelationshipTypePatchObjectFlushMode]):  Default:
            RelationshipTypePatchObjectFlushMode.AUTO.
        identifier (Union[Unset, RelationshipTypePatchObjectIdentifier]):  Default:
            RelationshipTypePatchObjectIdentifier.UID.
        import_mode (Union[Unset, RelationshipTypePatchObjectImportMode]):  Default:
            RelationshipTypePatchObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, RelationshipTypePatchObjectImportReportMode]):  Default:
            RelationshipTypePatchObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, RelationshipTypePatchObjectImportStrategy]):  Default:
            RelationshipTypePatchObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, RelationshipTypePatchObjectPreheatMode]):  Default:
            RelationshipTypePatchObjectPreheatMode.REFERENCE.
        root_junction (Union[Unset, RelationshipTypePatchObjectRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, RelationshipTypePatchObjectUserOverrideMode]):  Default:
            RelationshipTypePatchObjectUserOverrideMode.NONE.
        body (JsonPatch):
