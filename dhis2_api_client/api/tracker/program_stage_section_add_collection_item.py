...
from ...models.program_stage_section_add_collection_item_property import ProgramStageSectionAddCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: ProgramStageSectionAddCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
