...
from ...models.program_rule_get_object_list_gist_as_csv_auto import ProgramRuleGetObjectListGistAsCsvAuto
from ...models.program_rule_get_object_list_gist_as_csv_root_junction import (
    ProgramRuleGetObjectListGistAsCsvRootJunction,
)
...
def _get_kwargs(
    *,
    ...
    auto: Union[Unset, ProgramRuleGetObjectListGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, ProgramRuleGetObjectListGistAsCsvRootJunction
    ] = ProgramRuleGetObjectListGistAsCsvRootJunction.AND,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        auto (Union[Unset, ProgramRuleGetObjectListGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, ProgramRuleGetObjectListGistAsCsvRootJunction]):  Default:
            ProgramRuleGetObjectListGistAsCsvRootJunction.AND.
