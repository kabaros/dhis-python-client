...
from ...models.tracked_entity_type_get_object_root_junction import TrackedEntityTypeGetObjectRootJunction
...
def _get_kwargs(
    ...
    *,
    ...
    root_junction: Union[Unset, TrackedEntityTypeGetObjectRootJunction] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
) -> Optional[Union[TrackedEntityType, WebMessage]]:
    if response.status_code == 200:
        response_200 = TrackedEntityType.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[TrackedEntityType, WebMessage]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, TrackedEntityTypeGetObjectRootJunction]):
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[TrackedEntityType, WebMessage]
    """
