...
from ...models.program_rule_get_object_gistget_object_gist_as_csv_auto import (
    ProgramRuleGetObjectGistgetObjectGistAsCsvAuto,
)
from ...models.program_rule_get_object_gistget_object_gist_as_csv_response_200 import (
    ProgramRuleGetObjectGistgetObjectGistAsCsvResponse200,
)
from ...models.program_rule_get_object_gistget_object_gist_as_csv_root_junction import (
    ProgramRuleGetObjectGistgetObjectGistAsCsvRootJunction,
)
...
def _get_kwargs(
    ...
    *,
    ...
    auto: Union[Unset, ProgramRuleGetObjectGistgetObjectGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, ProgramRuleGetObjectGistgetObjectGistAsCsvRootJunction
    ] = ProgramRuleGetObjectGistgetObjectGistAsCsvRootJunction.AND,
...
) -> Optional[Union[ProgramRuleGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]]:
    if response.status_code == 200:
        response_200 = ProgramRuleGetObjectGistgetObjectGistAsCsvResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ProgramRuleGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, ProgramRuleGetObjectGistgetObjectGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, ProgramRuleGetObjectGistgetObjectGistAsCsvRootJunction]):
            Default: ProgramRuleGetObjectGistgetObjectGistAsCsvRootJunction.AND.
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ProgramRuleGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]
    """
