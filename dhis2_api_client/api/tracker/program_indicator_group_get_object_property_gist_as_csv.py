...
from ...models.program_indicator_group_get_object_property_gist_as_csv_auto import (
    ProgramIndicatorGroupGetObjectPropertyGistAsCsvAuto,
)
from ...models.program_indicator_group_get_object_property_gist_as_csv_property import (
    ProgramIndicatorGroupGetObjectPropertyGistAsCsvProperty,
)
from ...models.program_indicator_group_get_object_property_gist_as_csv_root_junction import (
    ProgramIndicatorGroupGetObjectPropertyGistAsCsvRootJunction,
)
...
def _get_kwargs(
    uid: str,
    property_: ProgramIndicatorGroupGetObjectPropertyGistAsCsvProperty,
    *,
    absolute_urls: Union[Unset, bool] = False,
    auto: Union[Unset, ProgramIndicatorGroupGetObjectPropertyGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, ProgramIndicatorGroupGetObjectPropertyGistAsCsvRootJunction
    ] = ProgramIndicatorGroupGetObjectPropertyGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/programIndicatorGroups/{uid}/{property_}/gist.csv",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, ProgramIndicatorGroupGetObjectPropertyGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, ProgramIndicatorGroupGetObjectPropertyGistAsCsvRootJunction]):
            Default: ProgramIndicatorGroupGetObjectPropertyGistAsCsvRootJunction.AND.
