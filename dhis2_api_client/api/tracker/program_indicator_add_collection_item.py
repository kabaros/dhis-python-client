...
from ...models.program_indicator_add_collection_item_property import ProgramIndicatorAddCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: ProgramIndicatorAddCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
