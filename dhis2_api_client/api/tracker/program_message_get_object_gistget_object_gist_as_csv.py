...
from ...models.program_message_get_object_gistget_object_gist_as_csv_auto import (
    ProgramMessageGetObjectGistgetObjectGistAsCsvAuto,
)
from ...models.program_message_get_object_gistget_object_gist_as_csv_response_200 import (
    ProgramMessageGetObjectGistgetObjectGistAsCsvResponse200,
)
from ...models.program_message_get_object_gistget_object_gist_as_csv_root_junction import (
    ProgramMessageGetObjectGistgetObjectGistAsCsvRootJunction,
)
...
def _get_kwargs(
    ...
    *,
    ...
    auto: Union[Unset, ProgramMessageGetObjectGistgetObjectGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, ProgramMessageGetObjectGistgetObjectGistAsCsvRootJunction
    ] = ProgramMessageGetObjectGistgetObjectGistAsCsvRootJunction.AND,
...
) -> Optional[Union[ProgramMessageGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]]:
    if response.status_code == 200:
        response_200 = ProgramMessageGetObjectGistgetObjectGistAsCsvResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ProgramMessageGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, ProgramMessageGetObjectGistgetObjectGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, ProgramMessageGetObjectGistgetObjectGistAsCsvRootJunction]):
            Default: ProgramMessageGetObjectGistgetObjectGistAsCsvRootJunction.AND.
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ProgramMessageGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]
    """
