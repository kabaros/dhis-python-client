...
from ...models.tracked_entity_attribute_patch_object_atomic_mode import TrackedEntityAttributePatchObjectAtomicMode
from ...models.tracked_entity_attribute_patch_object_flush_mode import TrackedEntityAttributePatchObjectFlushMode
from ...models.tracked_entity_attribute_patch_object_identifier import TrackedEntityAttributePatchObjectIdentifier
from ...models.tracked_entity_attribute_patch_object_import_mode import TrackedEntityAttributePatchObjectImportMode
from ...models.tracked_entity_attribute_patch_object_import_report_mode import (
    TrackedEntityAttributePatchObjectImportReportMode,
)
from ...models.tracked_entity_attribute_patch_object_import_strategy import (
    TrackedEntityAttributePatchObjectImportStrategy,
)
from ...models.tracked_entity_attribute_patch_object_preheat_mode import TrackedEntityAttributePatchObjectPreheatMode
from ...models.tracked_entity_attribute_patch_object_root_junction import TrackedEntityAttributePatchObjectRootJunction
from ...models.tracked_entity_attribute_patch_object_user_override_mode import (
    TrackedEntityAttributePatchObjectUserOverrideMode,
)
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[
        Unset, TrackedEntityAttributePatchObjectAtomicMode
    ] = TrackedEntityAttributePatchObjectAtomicMode.ALL,
    flush_mode: Union[
        Unset, TrackedEntityAttributePatchObjectFlushMode
    ] = TrackedEntityAttributePatchObjectFlushMode.AUTO,
    identifier: Union[
        Unset, TrackedEntityAttributePatchObjectIdentifier
    ] = TrackedEntityAttributePatchObjectIdentifier.UID,
    import_mode: Union[
        Unset, TrackedEntityAttributePatchObjectImportMode
    ] = TrackedEntityAttributePatchObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, TrackedEntityAttributePatchObjectImportReportMode
    ] = TrackedEntityAttributePatchObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, TrackedEntityAttributePatchObjectImportStrategy
    ] = TrackedEntityAttributePatchObjectImportStrategy.CREATE_AND_UPDATE,
    ...
    preheat_mode: Union[
        Unset, TrackedEntityAttributePatchObjectPreheatMode
    ] = TrackedEntityAttributePatchObjectPreheatMode.REFERENCE,
    root_junction: Union[Unset, TrackedEntityAttributePatchObjectRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, TrackedEntityAttributePatchObjectUserOverrideMode
    ] = TrackedEntityAttributePatchObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, TrackedEntityAttributePatchObjectAtomicMode]):  Default:
            TrackedEntityAttributePatchObjectAtomicMode.ALL.
        flush_mode (Union[Unset, TrackedEntityAttributePatchObjectFlushMode]):  Default:
            TrackedEntityAttributePatchObjectFlushMode.AUTO.
        identifier (Union[Unset, TrackedEntityAttributePatchObjectIdentifier]):  Default:
            TrackedEntityAttributePatchObjectIdentifier.UID.
        import_mode (Union[Unset, TrackedEntityAttributePatchObjectImportMode]):  Default:
            TrackedEntityAttributePatchObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, TrackedEntityAttributePatchObjectImportReportMode]):
            Default: TrackedEntityAttributePatchObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, TrackedEntityAttributePatchObjectImportStrategy]):  Default:
            TrackedEntityAttributePatchObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, TrackedEntityAttributePatchObjectPreheatMode]):  Default:
            TrackedEntityAttributePatchObjectPreheatMode.REFERENCE.
        root_junction (Union[Unset, TrackedEntityAttributePatchObjectRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, TrackedEntityAttributePatchObjectUserOverrideMode]):
            Default: TrackedEntityAttributePatchObjectUserOverrideMode.NONE.
        body (JsonPatch):
