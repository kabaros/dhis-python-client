...
from ...models.relationship_type_get_object_property_gist_as_csv_auto import (
    RelationshipTypeGetObjectPropertyGistAsCsvAuto,
)
from ...models.relationship_type_get_object_property_gist_as_csv_property import (
    RelationshipTypeGetObjectPropertyGistAsCsvProperty,
)
from ...models.relationship_type_get_object_property_gist_as_csv_root_junction import (
    RelationshipTypeGetObjectPropertyGistAsCsvRootJunction,
)
...
def _get_kwargs(
    uid: str,
    property_: RelationshipTypeGetObjectPropertyGistAsCsvProperty,
    *,
    absolute_urls: Union[Unset, bool] = False,
    auto: Union[Unset, RelationshipTypeGetObjectPropertyGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, RelationshipTypeGetObjectPropertyGistAsCsvRootJunction
    ] = RelationshipTypeGetObjectPropertyGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/relationshipTypes/{uid}/{property_}/gist.csv",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, RelationshipTypeGetObjectPropertyGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, RelationshipTypeGetObjectPropertyGistAsCsvRootJunction]):
            Default: RelationshipTypeGetObjectPropertyGistAsCsvRootJunction.AND.
