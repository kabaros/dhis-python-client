...
from ...models.program_rule_action_bulk_sharing_atomic_mode import ProgramRuleActionBulkSharingAtomicMode
from ...models.program_rule_action_bulk_sharing_flush_mode import ProgramRuleActionBulkSharingFlushMode
from ...models.program_rule_action_bulk_sharing_identifier import ProgramRuleActionBulkSharingIdentifier
from ...models.program_rule_action_bulk_sharing_import_mode import ProgramRuleActionBulkSharingImportMode
from ...models.program_rule_action_bulk_sharing_import_report_mode import ProgramRuleActionBulkSharingImportReportMode
from ...models.program_rule_action_bulk_sharing_import_strategy import ProgramRuleActionBulkSharingImportStrategy
from ...models.program_rule_action_bulk_sharing_preheat_mode import ProgramRuleActionBulkSharingPreheatMode
from ...models.program_rule_action_bulk_sharing_root_junction import ProgramRuleActionBulkSharingRootJunction
from ...models.program_rule_action_bulk_sharing_user_override_mode import ProgramRuleActionBulkSharingUserOverrideMode
...
def _get_kwargs(
    *,
    ...
    atomic_mode: Union[Unset, ProgramRuleActionBulkSharingAtomicMode] = ProgramRuleActionBulkSharingAtomicMode.ALL,
    flush_mode: Union[Unset, ProgramRuleActionBulkSharingFlushMode] = ProgramRuleActionBulkSharingFlushMode.AUTO,
    identifier: Union[Unset, ProgramRuleActionBulkSharingIdentifier] = ProgramRuleActionBulkSharingIdentifier.UID,
    import_mode: Union[Unset, ProgramRuleActionBulkSharingImportMode] = ProgramRuleActionBulkSharingImportMode.COMMIT,
    import_report_mode: Union[
        Unset, ProgramRuleActionBulkSharingImportReportMode
    ] = ProgramRuleActionBulkSharingImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, ProgramRuleActionBulkSharingImportStrategy
    ] = ProgramRuleActionBulkSharingImportStrategy.CREATE_AND_UPDATE,
    ...
    preheat_mode: Union[
        Unset, ProgramRuleActionBulkSharingPreheatMode
    ] = ProgramRuleActionBulkSharingPreheatMode.REFERENCE,
    root_junction: Union[Unset, ProgramRuleActionBulkSharingRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, ProgramRuleActionBulkSharingUserOverrideMode
    ] = ProgramRuleActionBulkSharingUserOverrideMode.NONE,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/programRuleActions/sharing",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, ProgramRuleActionBulkSharingAtomicMode]):  Default:
            ProgramRuleActionBulkSharingAtomicMode.ALL.
        flush_mode (Union[Unset, ProgramRuleActionBulkSharingFlushMode]):  Default:
            ProgramRuleActionBulkSharingFlushMode.AUTO.
        identifier (Union[Unset, ProgramRuleActionBulkSharingIdentifier]):  Default:
            ProgramRuleActionBulkSharingIdentifier.UID.
        import_mode (Union[Unset, ProgramRuleActionBulkSharingImportMode]):  Default:
            ProgramRuleActionBulkSharingImportMode.COMMIT.
        import_report_mode (Union[Unset, ProgramRuleActionBulkSharingImportReportMode]):  Default:
            ProgramRuleActionBulkSharingImportReportMode.ERRORS.
        import_strategy (Union[Unset, ProgramRuleActionBulkSharingImportStrategy]):  Default:
            ProgramRuleActionBulkSharingImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, ProgramRuleActionBulkSharingPreheatMode]):  Default:
            ProgramRuleActionBulkSharingPreheatMode.REFERENCE.
        root_junction (Union[Unset, ProgramRuleActionBulkSharingRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, ProgramRuleActionBulkSharingUserOverrideMode]):  Default:
            ProgramRuleActionBulkSharingUserOverrideMode.NONE.
        body (BulkJsonPatch):
