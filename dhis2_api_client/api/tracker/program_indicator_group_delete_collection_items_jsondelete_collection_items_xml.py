...
from ...models.program_indicator_group_delete_collection_items_jsondelete_collection_items_xml_property import (
    ProgramIndicatorGroupDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: ProgramIndicatorGroupDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
    *,
