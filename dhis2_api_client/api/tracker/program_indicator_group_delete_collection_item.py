...
from ...models.program_indicator_group_delete_collection_item_property import (
    ProgramIndicatorGroupDeleteCollectionItemProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: ProgramIndicatorGroupDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/programIndicatorGroups/{uid}/{property_}/{item_id}",
    }
