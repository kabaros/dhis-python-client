...
from ...models.program_section_add_collection_item_property import ProgramSectionAddCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: ProgramSectionAddCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
