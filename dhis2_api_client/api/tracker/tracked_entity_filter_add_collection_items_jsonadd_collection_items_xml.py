...
from ...models.tracked_entity_filter_add_collection_items_jsonadd_collection_items_xml_property import (
    TrackedEntityFilterAddCollectionItemsJsonaddCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: TrackedEntityFilterAddCollectionItemsJsonaddCollectionItemsXmlProperty,
    *,
