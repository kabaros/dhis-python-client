...
from ...models.program_stage_get_object_property_gist_as_csv_auto import ProgramStageGetObjectPropertyGistAsCsvAuto
from ...models.program_stage_get_object_property_gist_as_csv_property import (
    ProgramStageGetObjectPropertyGistAsCsvProperty,
)
from ...models.program_stage_get_object_property_gist_as_csv_root_junction import (
    ProgramStageGetObjectPropertyGistAsCsvRootJunction,
)
...
def _get_kwargs(
    uid: str,
    property_: ProgramStageGetObjectPropertyGistAsCsvProperty,
    *,
    absolute_urls: Union[Unset, bool] = False,
    auto: Union[Unset, ProgramStageGetObjectPropertyGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, ProgramStageGetObjectPropertyGistAsCsvRootJunction
    ] = ProgramStageGetObjectPropertyGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/programStages/{uid}/{property_}/gist.csv",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, ProgramStageGetObjectPropertyGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, ProgramStageGetObjectPropertyGistAsCsvRootJunction]):
            Default: ProgramStageGetObjectPropertyGistAsCsvRootJunction.AND.
