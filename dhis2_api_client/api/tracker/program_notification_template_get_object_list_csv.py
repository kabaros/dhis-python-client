...
from ...models.program_notification_template_get_object_list_csv_root_junction import (
    ProgramNotificationTemplateGetObjectListCsvRootJunction,
)
...
def _get_kwargs(
    *,
    ...
    root_junction: Union[Unset, ProgramNotificationTemplateGetObjectListCsvRootJunction] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/programNotificationTemplates/#getObjectListCsv",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, ProgramNotificationTemplateGetObjectListCsvRootJunction]):
