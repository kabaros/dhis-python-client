...
from ...models.tracked_entity_type_delete_collection_item_property import TrackedEntityTypeDeleteCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: TrackedEntityTypeDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/trackedEntityTypes/{uid}/{property_}/{item_id}",
    }
