...
from ...models.program_section_add_collection_items_jsonadd_collection_items_xml_property import (
    ProgramSectionAddCollectionItemsJsonaddCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: ProgramSectionAddCollectionItemsJsonaddCollectionItemsXmlProperty,
    *,
