...
from ...models.event_filter_bulk_sharing_atomic_mode import EventFilterBulkSharingAtomicMode
from ...models.event_filter_bulk_sharing_flush_mode import EventFilterBulkSharingFlushMode
from ...models.event_filter_bulk_sharing_identifier import EventFilterBulkSharingIdentifier
from ...models.event_filter_bulk_sharing_import_mode import EventFilterBulkSharingImportMode
from ...models.event_filter_bulk_sharing_import_report_mode import EventFilterBulkSharingImportReportMode
from ...models.event_filter_bulk_sharing_import_strategy import EventFilterBulkSharingImportStrategy
from ...models.event_filter_bulk_sharing_preheat_mode import EventFilterBulkSharingPreheatMode
from ...models.event_filter_bulk_sharing_root_junction import EventFilterBulkSharingRootJunction
from ...models.event_filter_bulk_sharing_user_override_mode import EventFilterBulkSharingUserOverrideMode
...
def _get_kwargs(
    *,
    ...
    atomic_mode: Union[Unset, EventFilterBulkSharingAtomicMode] = EventFilterBulkSharingAtomicMode.ALL,
    flush_mode: Union[Unset, EventFilterBulkSharingFlushMode] = EventFilterBulkSharingFlushMode.AUTO,
    identifier: Union[Unset, EventFilterBulkSharingIdentifier] = EventFilterBulkSharingIdentifier.UID,
    import_mode: Union[Unset, EventFilterBulkSharingImportMode] = EventFilterBulkSharingImportMode.COMMIT,
    import_report_mode: Union[
        Unset, EventFilterBulkSharingImportReportMode
    ] = EventFilterBulkSharingImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, EventFilterBulkSharingImportStrategy
    ] = EventFilterBulkSharingImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, EventFilterBulkSharingPreheatMode] = EventFilterBulkSharingPreheatMode.REFERENCE,
    root_junction: Union[Unset, EventFilterBulkSharingRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, EventFilterBulkSharingUserOverrideMode
    ] = EventFilterBulkSharingUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, EventFilterBulkSharingAtomicMode]):  Default:
            EventFilterBulkSharingAtomicMode.ALL.
        flush_mode (Union[Unset, EventFilterBulkSharingFlushMode]):  Default:
            EventFilterBulkSharingFlushMode.AUTO.
        identifier (Union[Unset, EventFilterBulkSharingIdentifier]):  Default:
            EventFilterBulkSharingIdentifier.UID.
        import_mode (Union[Unset, EventFilterBulkSharingImportMode]):  Default:
            EventFilterBulkSharingImportMode.COMMIT.
        import_report_mode (Union[Unset, EventFilterBulkSharingImportReportMode]):  Default:
            EventFilterBulkSharingImportReportMode.ERRORS.
        import_strategy (Union[Unset, EventFilterBulkSharingImportStrategy]):  Default:
            EventFilterBulkSharingImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, EventFilterBulkSharingPreheatMode]):  Default:
            EventFilterBulkSharingPreheatMode.REFERENCE.
        root_junction (Union[Unset, EventFilterBulkSharingRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, EventFilterBulkSharingUserOverrideMode]):  Default:
            EventFilterBulkSharingUserOverrideMode.NONE.
        body (BulkJsonPatch):
