...
from ...models.events_export_get_event_data_value_image_dimension import EventsExportGetEventDataValueImageDimension
...
def _get_kwargs(
    ...
    data_element: str,
    *,
    dimension: Union[Unset, EventsExportGetEventDataValueImageDimension] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/tracker/events/{event}/dataValues/{data_element}/image",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        dimension (Union[Unset, EventsExportGetEventDataValueImageDimension]):
