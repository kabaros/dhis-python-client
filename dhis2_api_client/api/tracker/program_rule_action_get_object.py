...
from ...models.program_rule_action_get_object_root_junction import ProgramRuleActionGetObjectRootJunction
...
def _get_kwargs(
    ...
    *,
    ...
    root_junction: Union[Unset, ProgramRuleActionGetObjectRootJunction] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
) -> Optional[Union[ProgramRuleAction, WebMessage]]:
    if response.status_code == 200:
        response_200 = ProgramRuleAction.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ProgramRuleAction, WebMessage]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, ProgramRuleActionGetObjectRootJunction]):
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ProgramRuleAction, WebMessage]
    """
