...
from ...models.program_stage_get_object_list_csv_root_junction import ProgramStageGetObjectListCsvRootJunction
...
def _get_kwargs(
    *,
    ...
    root_junction: Union[Unset, ProgramStageGetObjectListCsvRootJunction] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/programStages/#getObjectListCsv",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, ProgramStageGetObjectListCsvRootJunction]):
