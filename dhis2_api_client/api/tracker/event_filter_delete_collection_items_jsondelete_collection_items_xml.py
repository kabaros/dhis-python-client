...
from ...models.event_filter_delete_collection_items_jsondelete_collection_items_xml_property import (
    EventFilterDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: EventFilterDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
    *,
