...
from ...models.data_set_notification_template_get_object_property_gist_as_csv_auto import (
    DataSetNotificationTemplateGetObjectPropertyGistAsCsvAuto,
)
from ...models.data_set_notification_template_get_object_property_gist_as_csv_property import (
    DataSetNotificationTemplateGetObjectPropertyGistAsCsvProperty,
)
from ...models.data_set_notification_template_get_object_property_gist_as_csv_root_junction import (
    DataSetNotificationTemplateGetObjectPropertyGistAsCsvRootJunction,
)
...
def _get_kwargs(
    uid: str,
    property_: DataSetNotificationTemplateGetObjectPropertyGistAsCsvProperty,
    *,
    absolute_urls: Union[Unset, bool] = False,
    auto: Union[Unset, DataSetNotificationTemplateGetObjectPropertyGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, DataSetNotificationTemplateGetObjectPropertyGistAsCsvRootJunction
    ] = DataSetNotificationTemplateGetObjectPropertyGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/dataSetNotificationTemplates/{uid}/{property_}/gist.csv",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, DataSetNotificationTemplateGetObjectPropertyGistAsCsvAuto]):
        ...
        root_junction (Union[Unset,
            DataSetNotificationTemplateGetObjectPropertyGistAsCsvRootJunction]):  Default:
            DataSetNotificationTemplateGetObjectPropertyGistAsCsvRootJunction.AND.
