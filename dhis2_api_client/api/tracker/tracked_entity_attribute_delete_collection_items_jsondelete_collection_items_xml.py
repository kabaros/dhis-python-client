...
from ...models.tracked_entity_attribute_delete_collection_items_jsondelete_collection_items_xml_property import (
    TrackedEntityAttributeDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: TrackedEntityAttributeDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
    *,
