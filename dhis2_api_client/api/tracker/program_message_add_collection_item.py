...
from ...models.program_message_add_collection_item_property import ProgramMessageAddCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: ProgramMessageAddCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
