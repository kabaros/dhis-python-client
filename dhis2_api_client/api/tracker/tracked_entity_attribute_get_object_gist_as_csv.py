...
from ...models.tracked_entity_attribute_get_object_gist_as_csv_auto import TrackedEntityAttributeGetObjectGistAsCsvAuto
from ...models.tracked_entity_attribute_get_object_gist_as_csv_root_junction import (
    TrackedEntityAttributeGetObjectGistAsCsvRootJunction,
)
...
def _get_kwargs(
    ...
    *,
    ...
    auto: Union[Unset, TrackedEntityAttributeGetObjectGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, TrackedEntityAttributeGetObjectGistAsCsvRootJunction
    ] = TrackedEntityAttributeGetObjectGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/trackedEntityAttributes/{uid}/gist.csv",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, TrackedEntityAttributeGetObjectGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, TrackedEntityAttributeGetObjectGistAsCsvRootJunction]):
            Default: TrackedEntityAttributeGetObjectGistAsCsvRootJunction.AND.
