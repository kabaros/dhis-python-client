...
from ...models.program_rule_delete_collection_items_jsondelete_collection_items_xml_property import (
    ProgramRuleDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: ProgramRuleDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
    *,
