...
from ...models.relationship_type_replace_translations_body import RelationshipTypeReplaceTranslationsBody
...
def _get_kwargs(
    uid: str,
    *,
    body: RelationshipTypeReplaceTranslationsBody,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": f"/relationshipTypes/{uid}/translations",
    }
