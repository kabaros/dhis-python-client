...
from ...models.program_stage_bulk_sharing_atomic_mode import ProgramStageBulkSharingAtomicMode
from ...models.program_stage_bulk_sharing_flush_mode import ProgramStageBulkSharingFlushMode
from ...models.program_stage_bulk_sharing_identifier import ProgramStageBulkSharingIdentifier
from ...models.program_stage_bulk_sharing_import_mode import ProgramStageBulkSharingImportMode
from ...models.program_stage_bulk_sharing_import_report_mode import ProgramStageBulkSharingImportReportMode
from ...models.program_stage_bulk_sharing_import_strategy import ProgramStageBulkSharingImportStrategy
from ...models.program_stage_bulk_sharing_preheat_mode import ProgramStageBulkSharingPreheatMode
from ...models.program_stage_bulk_sharing_root_junction import ProgramStageBulkSharingRootJunction
from ...models.program_stage_bulk_sharing_user_override_mode import ProgramStageBulkSharingUserOverrideMode
...
def _get_kwargs(
    *,
    ...
    atomic_mode: Union[Unset, ProgramStageBulkSharingAtomicMode] = ProgramStageBulkSharingAtomicMode.ALL,
    flush_mode: Union[Unset, ProgramStageBulkSharingFlushMode] = ProgramStageBulkSharingFlushMode.AUTO,
    identifier: Union[Unset, ProgramStageBulkSharingIdentifier] = ProgramStageBulkSharingIdentifier.UID,
    import_mode: Union[Unset, ProgramStageBulkSharingImportMode] = ProgramStageBulkSharingImportMode.COMMIT,
    import_report_mode: Union[
        Unset, ProgramStageBulkSharingImportReportMode
    ] = ProgramStageBulkSharingImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, ProgramStageBulkSharingImportStrategy
    ] = ProgramStageBulkSharingImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, ProgramStageBulkSharingPreheatMode] = ProgramStageBulkSharingPreheatMode.REFERENCE,
    root_junction: Union[Unset, ProgramStageBulkSharingRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, ProgramStageBulkSharingUserOverrideMode
    ] = ProgramStageBulkSharingUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, ProgramStageBulkSharingAtomicMode]):  Default:
            ProgramStageBulkSharingAtomicMode.ALL.
        flush_mode (Union[Unset, ProgramStageBulkSharingFlushMode]):  Default:
            ProgramStageBulkSharingFlushMode.AUTO.
        identifier (Union[Unset, ProgramStageBulkSharingIdentifier]):  Default:
            ProgramStageBulkSharingIdentifier.UID.
        import_mode (Union[Unset, ProgramStageBulkSharingImportMode]):  Default:
            ProgramStageBulkSharingImportMode.COMMIT.
        import_report_mode (Union[Unset, ProgramStageBulkSharingImportReportMode]):  Default:
            ProgramStageBulkSharingImportReportMode.ERRORS.
        import_strategy (Union[Unset, ProgramStageBulkSharingImportStrategy]):  Default:
            ProgramStageBulkSharingImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, ProgramStageBulkSharingPreheatMode]):  Default:
            ProgramStageBulkSharingPreheatMode.REFERENCE.
        root_junction (Union[Unset, ProgramStageBulkSharingRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, ProgramStageBulkSharingUserOverrideMode]):  Default:
            ProgramStageBulkSharingUserOverrideMode.NONE.
        body (BulkJsonPatch):
