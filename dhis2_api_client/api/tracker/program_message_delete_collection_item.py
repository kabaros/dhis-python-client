...
from ...models.program_message_delete_collection_item_property import ProgramMessageDeleteCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: ProgramMessageDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/messages/{uid}/{property_}/{item_id}",
    }
