...
from ...models.relationship_type_bulk_sharing_atomic_mode import RelationshipTypeBulkSharingAtomicMode
from ...models.relationship_type_bulk_sharing_flush_mode import RelationshipTypeBulkSharingFlushMode
from ...models.relationship_type_bulk_sharing_identifier import RelationshipTypeBulkSharingIdentifier
from ...models.relationship_type_bulk_sharing_import_mode import RelationshipTypeBulkSharingImportMode
from ...models.relationship_type_bulk_sharing_import_report_mode import RelationshipTypeBulkSharingImportReportMode
from ...models.relationship_type_bulk_sharing_import_strategy import RelationshipTypeBulkSharingImportStrategy
from ...models.relationship_type_bulk_sharing_preheat_mode import RelationshipTypeBulkSharingPreheatMode
from ...models.relationship_type_bulk_sharing_root_junction import RelationshipTypeBulkSharingRootJunction
from ...models.relationship_type_bulk_sharing_user_override_mode import RelationshipTypeBulkSharingUserOverrideMode
...
def _get_kwargs(
    *,
    ...
    atomic_mode: Union[Unset, RelationshipTypeBulkSharingAtomicMode] = RelationshipTypeBulkSharingAtomicMode.ALL,
    flush_mode: Union[Unset, RelationshipTypeBulkSharingFlushMode] = RelationshipTypeBulkSharingFlushMode.AUTO,
    identifier: Union[Unset, RelationshipTypeBulkSharingIdentifier] = RelationshipTypeBulkSharingIdentifier.UID,
    import_mode: Union[Unset, RelationshipTypeBulkSharingImportMode] = RelationshipTypeBulkSharingImportMode.COMMIT,
    import_report_mode: Union[
        Unset, RelationshipTypeBulkSharingImportReportMode
    ] = RelationshipTypeBulkSharingImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, RelationshipTypeBulkSharingImportStrategy
    ] = RelationshipTypeBulkSharingImportStrategy.CREATE_AND_UPDATE,
    ...
    preheat_mode: Union[
        Unset, RelationshipTypeBulkSharingPreheatMode
    ] = RelationshipTypeBulkSharingPreheatMode.REFERENCE,
    root_junction: Union[Unset, RelationshipTypeBulkSharingRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, RelationshipTypeBulkSharingUserOverrideMode
    ] = RelationshipTypeBulkSharingUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, RelationshipTypeBulkSharingAtomicMode]):  Default:
            RelationshipTypeBulkSharingAtomicMode.ALL.
        flush_mode (Union[Unset, RelationshipTypeBulkSharingFlushMode]):  Default:
            RelationshipTypeBulkSharingFlushMode.AUTO.
        identifier (Union[Unset, RelationshipTypeBulkSharingIdentifier]):  Default:
            RelationshipTypeBulkSharingIdentifier.UID.
        import_mode (Union[Unset, RelationshipTypeBulkSharingImportMode]):  Default:
            RelationshipTypeBulkSharingImportMode.COMMIT.
        import_report_mode (Union[Unset, RelationshipTypeBulkSharingImportReportMode]):  Default:
            RelationshipTypeBulkSharingImportReportMode.ERRORS.
        import_strategy (Union[Unset, RelationshipTypeBulkSharingImportStrategy]):  Default:
            RelationshipTypeBulkSharingImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, RelationshipTypeBulkSharingPreheatMode]):  Default:
            RelationshipTypeBulkSharingPreheatMode.REFERENCE.
        root_junction (Union[Unset, RelationshipTypeBulkSharingRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, RelationshipTypeBulkSharingUserOverrideMode]):  Default:
            RelationshipTypeBulkSharingUserOverrideMode.NONE.
        body (BulkJsonPatch):
