...
from ...models.relationship_type_delete_collection_items_jsondelete_collection_items_xml_property import (
    RelationshipTypeDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: RelationshipTypeDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
    *,
