...
from ...models.program_delete_collection_item_property import ProgramDeleteCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: ProgramDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/programs/{uid}/{property_}/{item_id}",
    }
