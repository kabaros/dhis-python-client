...
from ...models.program_rule_action_delete_collection_item_property import ProgramRuleActionDeleteCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: ProgramRuleActionDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/programRuleActions/{uid}/{property_}/{item_id}",
    }
