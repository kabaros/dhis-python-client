...
from ...models.program_stage_section_replace_collection_items_jsonreplace_collection_items_xml_property import (
    ProgramStageSectionReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: ProgramStageSectionReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
    *,
