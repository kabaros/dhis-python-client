...
from ...models.program_bulk_sharing_atomic_mode import ProgramBulkSharingAtomicMode
from ...models.program_bulk_sharing_flush_mode import ProgramBulkSharingFlushMode
from ...models.program_bulk_sharing_identifier import ProgramBulkSharingIdentifier
from ...models.program_bulk_sharing_import_mode import ProgramBulkSharingImportMode
from ...models.program_bulk_sharing_import_report_mode import ProgramBulkSharingImportReportMode
from ...models.program_bulk_sharing_import_strategy import ProgramBulkSharingImportStrategy
from ...models.program_bulk_sharing_preheat_mode import ProgramBulkSharingPreheatMode
from ...models.program_bulk_sharing_root_junction import ProgramBulkSharingRootJunction
from ...models.program_bulk_sharing_user_override_mode import ProgramBulkSharingUserOverrideMode
...
def _get_kwargs(
    *,
    ...
    atomic_mode: Union[Unset, ProgramBulkSharingAtomicMode] = ProgramBulkSharingAtomicMode.ALL,
    flush_mode: Union[Unset, ProgramBulkSharingFlushMode] = ProgramBulkSharingFlushMode.AUTO,
    identifier: Union[Unset, ProgramBulkSharingIdentifier] = ProgramBulkSharingIdentifier.UID,
    import_mode: Union[Unset, ProgramBulkSharingImportMode] = ProgramBulkSharingImportMode.COMMIT,
    import_report_mode: Union[Unset, ProgramBulkSharingImportReportMode] = ProgramBulkSharingImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, ProgramBulkSharingImportStrategy
    ] = ProgramBulkSharingImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, ProgramBulkSharingPreheatMode] = ProgramBulkSharingPreheatMode.REFERENCE,
    root_junction: Union[Unset, ProgramBulkSharingRootJunction] = UNSET,
    skip_sharing: Union[Unset, bool] = False,
    skip_translation: Union[Unset, bool] = False,
    skip_validation: Union[Unset, bool] = False,
    user: Union[Unset, str] = UNSET,
    user_override_mode: Union[Unset, ProgramBulkSharingUserOverrideMode] = ProgramBulkSharingUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, ProgramBulkSharingAtomicMode]):  Default:
            ProgramBulkSharingAtomicMode.ALL.
        flush_mode (Union[Unset, ProgramBulkSharingFlushMode]):  Default:
            ProgramBulkSharingFlushMode.AUTO.
        identifier (Union[Unset, ProgramBulkSharingIdentifier]):  Default:
            ProgramBulkSharingIdentifier.UID.
        import_mode (Union[Unset, ProgramBulkSharingImportMode]):  Default:
            ProgramBulkSharingImportMode.COMMIT.
        import_report_mode (Union[Unset, ProgramBulkSharingImportReportMode]):  Default:
            ProgramBulkSharingImportReportMode.ERRORS.
        import_strategy (Union[Unset, ProgramBulkSharingImportStrategy]):  Default:
            ProgramBulkSharingImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, ProgramBulkSharingPreheatMode]):  Default:
            ProgramBulkSharingPreheatMode.REFERENCE.
        root_junction (Union[Unset, ProgramBulkSharingRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, ProgramBulkSharingUserOverrideMode]):  Default:
            ProgramBulkSharingUserOverrideMode.NONE.
        body (BulkJsonPatch):
