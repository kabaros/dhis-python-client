...
from ...models.tracked_entity_type_get_object_property_gist_as_csv_auto import (
    TrackedEntityTypeGetObjectPropertyGistAsCsvAuto,
)
from ...models.tracked_entity_type_get_object_property_gist_as_csv_property import (
    TrackedEntityTypeGetObjectPropertyGistAsCsvProperty,
)
from ...models.tracked_entity_type_get_object_property_gist_as_csv_root_junction import (
    TrackedEntityTypeGetObjectPropertyGistAsCsvRootJunction,
)
...
def _get_kwargs(
    uid: str,
    property_: TrackedEntityTypeGetObjectPropertyGistAsCsvProperty,
    *,
    absolute_urls: Union[Unset, bool] = False,
    auto: Union[Unset, TrackedEntityTypeGetObjectPropertyGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, TrackedEntityTypeGetObjectPropertyGistAsCsvRootJunction
    ] = TrackedEntityTypeGetObjectPropertyGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/trackedEntityTypes/{uid}/{property_}/gist.csv",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, TrackedEntityTypeGetObjectPropertyGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, TrackedEntityTypeGetObjectPropertyGistAsCsvRootJunction]):
            Default: TrackedEntityTypeGetObjectPropertyGistAsCsvRootJunction.AND.
