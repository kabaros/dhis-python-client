...
from ...models.relationship_type_get_object_gistget_object_gist_as_csv_auto import (
    RelationshipTypeGetObjectGistgetObjectGistAsCsvAuto,
)
from ...models.relationship_type_get_object_gistget_object_gist_as_csv_response_200 import (
    RelationshipTypeGetObjectGistgetObjectGistAsCsvResponse200,
)
from ...models.relationship_type_get_object_gistget_object_gist_as_csv_root_junction import (
    RelationshipTypeGetObjectGistgetObjectGistAsCsvRootJunction,
)
...
def _get_kwargs(
    ...
    *,
    ...
    auto: Union[Unset, RelationshipTypeGetObjectGistgetObjectGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, RelationshipTypeGetObjectGistgetObjectGistAsCsvRootJunction
    ] = RelationshipTypeGetObjectGistgetObjectGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/relationshipTypes/{uid}/gist",
        "params": params,
    }
...
) -> Optional[Union[RelationshipTypeGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]]:
    if response.status_code == 200:
        response_200 = RelationshipTypeGetObjectGistgetObjectGistAsCsvResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RelationshipTypeGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, RelationshipTypeGetObjectGistgetObjectGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, RelationshipTypeGetObjectGistgetObjectGistAsCsvRootJunction]):
            Default: RelationshipTypeGetObjectGistgetObjectGistAsCsvRootJunction.AND.
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[RelationshipTypeGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]
    """
