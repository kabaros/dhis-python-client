...
from ...models.tracked_entity_filter_delete_collection_item_property import (
    TrackedEntityFilterDeleteCollectionItemProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: TrackedEntityFilterDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/trackedEntityInstanceFilters/{uid}/{property_}/{item_id}",
    }
