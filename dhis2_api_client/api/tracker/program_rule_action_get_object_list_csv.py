...
from ...models.program_rule_action_get_object_list_csv_root_junction import (
    ProgramRuleActionGetObjectListCsvRootJunction,
)
...
def _get_kwargs(
    *,
    ...
    root_junction: Union[Unset, ProgramRuleActionGetObjectListCsvRootJunction] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/programRuleActions/#getObjectListCsv",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, ProgramRuleActionGetObjectListCsvRootJunction]):
