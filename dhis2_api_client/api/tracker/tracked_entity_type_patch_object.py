...
from ...models.tracked_entity_type_patch_object_atomic_mode import TrackedEntityTypePatchObjectAtomicMode
from ...models.tracked_entity_type_patch_object_flush_mode import TrackedEntityTypePatchObjectFlushMode
from ...models.tracked_entity_type_patch_object_identifier import TrackedEntityTypePatchObjectIdentifier
from ...models.tracked_entity_type_patch_object_import_mode import TrackedEntityTypePatchObjectImportMode
from ...models.tracked_entity_type_patch_object_import_report_mode import TrackedEntityTypePatchObjectImportReportMode
from ...models.tracked_entity_type_patch_object_import_strategy import TrackedEntityTypePatchObjectImportStrategy
from ...models.tracked_entity_type_patch_object_preheat_mode import TrackedEntityTypePatchObjectPreheatMode
from ...models.tracked_entity_type_patch_object_root_junction import TrackedEntityTypePatchObjectRootJunction
from ...models.tracked_entity_type_patch_object_user_override_mode import TrackedEntityTypePatchObjectUserOverrideMode
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[Unset, TrackedEntityTypePatchObjectAtomicMode] = TrackedEntityTypePatchObjectAtomicMode.ALL,
    flush_mode: Union[Unset, TrackedEntityTypePatchObjectFlushMode] = TrackedEntityTypePatchObjectFlushMode.AUTO,
    identifier: Union[Unset, TrackedEntityTypePatchObjectIdentifier] = TrackedEntityTypePatchObjectIdentifier.UID,
    import_mode: Union[Unset, TrackedEntityTypePatchObjectImportMode] = TrackedEntityTypePatchObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, TrackedEntityTypePatchObjectImportReportMode
    ] = TrackedEntityTypePatchObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, TrackedEntityTypePatchObjectImportStrategy
    ] = TrackedEntityTypePatchObjectImportStrategy.CREATE_AND_UPDATE,
    ...
    preheat_mode: Union[
        Unset, TrackedEntityTypePatchObjectPreheatMode
    ] = TrackedEntityTypePatchObjectPreheatMode.REFERENCE,
    root_junction: Union[Unset, TrackedEntityTypePatchObjectRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, TrackedEntityTypePatchObjectUserOverrideMode
    ] = TrackedEntityTypePatchObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, TrackedEntityTypePatchObjectAtomicMode]):  Default:
            TrackedEntityTypePatchObjectAtomicMode.ALL.
        flush_mode (Union[Unset, TrackedEntityTypePatchObjectFlushMode]):  Default:
            TrackedEntityTypePatchObjectFlushMode.AUTO.
        identifier (Union[Unset, TrackedEntityTypePatchObjectIdentifier]):  Default:
            TrackedEntityTypePatchObjectIdentifier.UID.
        import_mode (Union[Unset, TrackedEntityTypePatchObjectImportMode]):  Default:
            TrackedEntityTypePatchObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, TrackedEntityTypePatchObjectImportReportMode]):  Default:
            TrackedEntityTypePatchObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, TrackedEntityTypePatchObjectImportStrategy]):  Default:
            TrackedEntityTypePatchObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, TrackedEntityTypePatchObjectPreheatMode]):  Default:
            TrackedEntityTypePatchObjectPreheatMode.REFERENCE.
        root_junction (Union[Unset, TrackedEntityTypePatchObjectRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, TrackedEntityTypePatchObjectUserOverrideMode]):  Default:
            TrackedEntityTypePatchObjectUserOverrideMode.NONE.
        body (JsonPatch):
