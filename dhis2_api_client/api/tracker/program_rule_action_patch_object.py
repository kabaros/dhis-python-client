...
from ...models.program_rule_action_patch_object_atomic_mode import ProgramRuleActionPatchObjectAtomicMode
from ...models.program_rule_action_patch_object_flush_mode import ProgramRuleActionPatchObjectFlushMode
from ...models.program_rule_action_patch_object_identifier import ProgramRuleActionPatchObjectIdentifier
from ...models.program_rule_action_patch_object_import_mode import ProgramRuleActionPatchObjectImportMode
from ...models.program_rule_action_patch_object_import_report_mode import ProgramRuleActionPatchObjectImportReportMode
from ...models.program_rule_action_patch_object_import_strategy import ProgramRuleActionPatchObjectImportStrategy
from ...models.program_rule_action_patch_object_preheat_mode import ProgramRuleActionPatchObjectPreheatMode
from ...models.program_rule_action_patch_object_root_junction import ProgramRuleActionPatchObjectRootJunction
from ...models.program_rule_action_patch_object_user_override_mode import ProgramRuleActionPatchObjectUserOverrideMode
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[Unset, ProgramRuleActionPatchObjectAtomicMode] = ProgramRuleActionPatchObjectAtomicMode.ALL,
    flush_mode: Union[Unset, ProgramRuleActionPatchObjectFlushMode] = ProgramRuleActionPatchObjectFlushMode.AUTO,
    identifier: Union[Unset, ProgramRuleActionPatchObjectIdentifier] = ProgramRuleActionPatchObjectIdentifier.UID,
    import_mode: Union[Unset, ProgramRuleActionPatchObjectImportMode] = ProgramRuleActionPatchObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, ProgramRuleActionPatchObjectImportReportMode
    ] = ProgramRuleActionPatchObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, ProgramRuleActionPatchObjectImportStrategy
    ] = ProgramRuleActionPatchObjectImportStrategy.CREATE_AND_UPDATE,
    ...
    preheat_mode: Union[
        Unset, ProgramRuleActionPatchObjectPreheatMode
    ] = ProgramRuleActionPatchObjectPreheatMode.REFERENCE,
    root_junction: Union[Unset, ProgramRuleActionPatchObjectRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, ProgramRuleActionPatchObjectUserOverrideMode
    ] = ProgramRuleActionPatchObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, ProgramRuleActionPatchObjectAtomicMode]):  Default:
            ProgramRuleActionPatchObjectAtomicMode.ALL.
        flush_mode (Union[Unset, ProgramRuleActionPatchObjectFlushMode]):  Default:
            ProgramRuleActionPatchObjectFlushMode.AUTO.
        identifier (Union[Unset, ProgramRuleActionPatchObjectIdentifier]):  Default:
            ProgramRuleActionPatchObjectIdentifier.UID.
        import_mode (Union[Unset, ProgramRuleActionPatchObjectImportMode]):  Default:
            ProgramRuleActionPatchObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, ProgramRuleActionPatchObjectImportReportMode]):  Default:
            ProgramRuleActionPatchObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, ProgramRuleActionPatchObjectImportStrategy]):  Default:
            ProgramRuleActionPatchObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, ProgramRuleActionPatchObjectPreheatMode]):  Default:
            ProgramRuleActionPatchObjectPreheatMode.REFERENCE.
        root_junction (Union[Unset, ProgramRuleActionPatchObjectRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, ProgramRuleActionPatchObjectUserOverrideMode]):  Default:
            ProgramRuleActionPatchObjectUserOverrideMode.NONE.
        body (JsonPatch):
