...
from ...models.program_rule_action_replace_collection_items_jsonreplace_collection_items_xml_property import (
    ProgramRuleActionReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: ProgramRuleActionReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
    *,
