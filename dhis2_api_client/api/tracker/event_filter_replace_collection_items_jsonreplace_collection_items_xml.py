...
from ...models.event_filter_replace_collection_items_jsonreplace_collection_items_xml_property import (
    EventFilterReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: EventFilterReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
    *,
