...
from ...models.events_export_get_eventsget_events_as_json_gzipget_events_as_json_zip_assigned_user_mode import (
    EventsExportGetEventsgetEventsAsJsonGzipgetEventsAsJsonZipAssignedUserMode,
)
from ...models.events_export_get_eventsget_events_as_json_gzipget_events_as_json_zip_org_unit_mode import (
    EventsExportGetEventsgetEventsAsJsonGzipgetEventsAsJsonZipOrgUnitMode,
)
from ...models.events_export_get_eventsget_events_as_json_gzipget_events_as_json_zip_ou_mode import (
    EventsExportGetEventsgetEventsAsJsonGzipgetEventsAsJsonZipOuMode,
)
from ...models.events_export_get_eventsget_events_as_json_gzipget_events_as_json_zip_program_status import (
    EventsExportGetEventsgetEventsAsJsonGzipgetEventsAsJsonZipProgramStatus,
)
from ...models.events_export_get_eventsget_events_as_json_gzipget_events_as_json_zip_status import (
    EventsExportGetEventsgetEventsAsJsonGzipgetEventsAsJsonZipStatus,
)
...
def _get_kwargs(
    *,
    ...
    assigned_user_mode: Union[
        Unset, EventsExportGetEventsgetEventsAsJsonGzipgetEventsAsJsonZipAssignedUserMode
    ] = UNSET,
    ...
    org_unit_mode: Union[Unset, EventsExportGetEventsgetEventsAsJsonGzipgetEventsAsJsonZipOrgUnitMode] = UNSET,
    ou_mode: Union[Unset, EventsExportGetEventsgetEventsAsJsonGzipgetEventsAsJsonZipOuMode] = UNSET,
    page: Union[Unset, int] = 1,
    page_size: Union[Unset, int] = 50,
    paging: Union[Unset, bool] = True,
    program: Union[Unset, str] = UNSET,
    program_stage: Union[Unset, str] = UNSET,
    program_status: Union[Unset, EventsExportGetEventsgetEventsAsJsonGzipgetEventsAsJsonZipProgramStatus] = UNSET,
    ...
    status: Union[Unset, EventsExportGetEventsgetEventsAsJsonGzipgetEventsAsJsonZipStatus] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        org_unit_mode (Union[Unset,
            EventsExportGetEventsgetEventsAsJsonGzipgetEventsAsJsonZipOrgUnitMode]):
        ou_mode (Union[Unset, EventsExportGetEventsgetEventsAsJsonGzipgetEventsAsJsonZipOuMode]):
        ...
        status (Union[Unset, EventsExportGetEventsgetEventsAsJsonGzipgetEventsAsJsonZipStatus]):
