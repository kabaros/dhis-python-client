...
from ...models.data_set_notification_template_add_collection_item_property import (
    DataSetNotificationTemplateAddCollectionItemProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: DataSetNotificationTemplateAddCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
