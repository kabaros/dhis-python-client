...
from ...models.program_message_replace_collection_items_jsonreplace_collection_items_xml_property import (
    ProgramMessageReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: ProgramMessageReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
    *,
