...
from ...models.event_filter_get_object_list_gist_as_csv_auto import EventFilterGetObjectListGistAsCsvAuto
from ...models.event_filter_get_object_list_gist_as_csv_root_junction import (
    EventFilterGetObjectListGistAsCsvRootJunction,
)
...
def _get_kwargs(
    *,
    ...
    auto: Union[Unset, EventFilterGetObjectListGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, EventFilterGetObjectListGistAsCsvRootJunction
    ] = EventFilterGetObjectListGistAsCsvRootJunction.AND,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        auto (Union[Unset, EventFilterGetObjectListGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, EventFilterGetObjectListGistAsCsvRootJunction]):  Default:
            EventFilterGetObjectListGistAsCsvRootJunction.AND.
