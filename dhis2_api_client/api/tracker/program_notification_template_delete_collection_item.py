...
from ...models.program_notification_template_delete_collection_item_property import (
    ProgramNotificationTemplateDeleteCollectionItemProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: ProgramNotificationTemplateDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/programNotificationTemplates/{uid}/{property_}/{item_id}",
    }
