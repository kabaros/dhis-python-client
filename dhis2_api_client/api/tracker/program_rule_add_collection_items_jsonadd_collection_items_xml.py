...
from ...models.program_rule_add_collection_items_jsonadd_collection_items_xml_property import (
    ProgramRuleAddCollectionItemsJsonaddCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: ProgramRuleAddCollectionItemsJsonaddCollectionItemsXmlProperty,
    *,
