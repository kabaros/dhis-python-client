...
from ...models.program_rule_action_get_object_gistget_object_gist_as_csv_auto import (
    ProgramRuleActionGetObjectGistgetObjectGistAsCsvAuto,
)
from ...models.program_rule_action_get_object_gistget_object_gist_as_csv_response_200 import (
    ProgramRuleActionGetObjectGistgetObjectGistAsCsvResponse200,
)
from ...models.program_rule_action_get_object_gistget_object_gist_as_csv_root_junction import (
    ProgramRuleActionGetObjectGistgetObjectGistAsCsvRootJunction,
)
...
def _get_kwargs(
    ...
    *,
    ...
    auto: Union[Unset, ProgramRuleActionGetObjectGistgetObjectGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, ProgramRuleActionGetObjectGistgetObjectGistAsCsvRootJunction
    ] = ProgramRuleActionGetObjectGistgetObjectGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/programRuleActions/{uid}/gist",
        "params": params,
    }
...
) -> Optional[Union[ProgramRuleActionGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]]:
    if response.status_code == 200:
        response_200 = ProgramRuleActionGetObjectGistgetObjectGistAsCsvResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ProgramRuleActionGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, ProgramRuleActionGetObjectGistgetObjectGistAsCsvAuto]):
        ...
        root_junction (Union[Unset,
            ProgramRuleActionGetObjectGistgetObjectGistAsCsvRootJunction]):  Default:
            ProgramRuleActionGetObjectGistgetObjectGistAsCsvRootJunction.AND.
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ProgramRuleActionGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]
    """
