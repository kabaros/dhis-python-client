...
from ...models.program_notification_template_delete_collection_items_jsondelete_collection_items_xml_property import (
    ProgramNotificationTemplateDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: ProgramNotificationTemplateDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
    *,
