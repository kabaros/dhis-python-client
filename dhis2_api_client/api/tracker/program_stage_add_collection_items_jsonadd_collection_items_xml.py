...
from ...models.program_stage_add_collection_items_jsonadd_collection_items_xml_property import (
    ProgramStageAddCollectionItemsJsonaddCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: ProgramStageAddCollectionItemsJsonaddCollectionItemsXmlProperty,
    *,
