...
from ...models.program_rule_variable_add_collection_item_property import ProgramRuleVariableAddCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: ProgramRuleVariableAddCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
