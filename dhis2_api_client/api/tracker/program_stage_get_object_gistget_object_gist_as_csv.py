...
from ...models.program_stage_get_object_gistget_object_gist_as_csv_auto import (
    ProgramStageGetObjectGistgetObjectGistAsCsvAuto,
)
from ...models.program_stage_get_object_gistget_object_gist_as_csv_response_200 import (
    ProgramStageGetObjectGistgetObjectGistAsCsvResponse200,
)
from ...models.program_stage_get_object_gistget_object_gist_as_csv_root_junction import (
    ProgramStageGetObjectGistgetObjectGistAsCsvRootJunction,
)
...
def _get_kwargs(
    ...
    *,
    ...
    auto: Union[Unset, ProgramStageGetObjectGistgetObjectGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, ProgramStageGetObjectGistgetObjectGistAsCsvRootJunction
    ] = ProgramStageGetObjectGistgetObjectGistAsCsvRootJunction.AND,
...
) -> Optional[Union[ProgramStageGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]]:
    if response.status_code == 200:
        response_200 = ProgramStageGetObjectGistgetObjectGistAsCsvResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ProgramStageGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, ProgramStageGetObjectGistgetObjectGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, ProgramStageGetObjectGistgetObjectGistAsCsvRootJunction]):
            Default: ProgramStageGetObjectGistgetObjectGistAsCsvRootJunction.AND.
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ProgramStageGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]
    """
