...
from ...models.tracked_entity_filter_get_object_property_gist_as_csv_auto import (
    TrackedEntityFilterGetObjectPropertyGistAsCsvAuto,
)
from ...models.tracked_entity_filter_get_object_property_gist_as_csv_property import (
    TrackedEntityFilterGetObjectPropertyGistAsCsvProperty,
)
from ...models.tracked_entity_filter_get_object_property_gist_as_csv_root_junction import (
    TrackedEntityFilterGetObjectPropertyGistAsCsvRootJunction,
)
...
def _get_kwargs(
    uid: str,
    property_: TrackedEntityFilterGetObjectPropertyGistAsCsvProperty,
    *,
    absolute_urls: Union[Unset, bool] = False,
    auto: Union[Unset, TrackedEntityFilterGetObjectPropertyGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, TrackedEntityFilterGetObjectPropertyGistAsCsvRootJunction
    ] = TrackedEntityFilterGetObjectPropertyGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/trackedEntityInstanceFilters/{uid}/{property_}/gist.csv",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, TrackedEntityFilterGetObjectPropertyGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, TrackedEntityFilterGetObjectPropertyGistAsCsvRootJunction]):
            Default: TrackedEntityFilterGetObjectPropertyGistAsCsvRootJunction.AND.
