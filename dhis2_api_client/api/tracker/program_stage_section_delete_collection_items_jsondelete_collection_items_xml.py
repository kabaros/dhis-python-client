...
from ...models.program_stage_section_delete_collection_items_jsondelete_collection_items_xml_property import (
    ProgramStageSectionDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: ProgramStageSectionDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
    *,
