...
from ...models.program_stage_section_get_object_property_gist_as_csv_auto import (
    ProgramStageSectionGetObjectPropertyGistAsCsvAuto,
)
from ...models.program_stage_section_get_object_property_gist_as_csv_property import (
    ProgramStageSectionGetObjectPropertyGistAsCsvProperty,
)
from ...models.program_stage_section_get_object_property_gist_as_csv_root_junction import (
    ProgramStageSectionGetObjectPropertyGistAsCsvRootJunction,
)
...
def _get_kwargs(
    uid: str,
    property_: ProgramStageSectionGetObjectPropertyGistAsCsvProperty,
    *,
    absolute_urls: Union[Unset, bool] = False,
    auto: Union[Unset, ProgramStageSectionGetObjectPropertyGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, ProgramStageSectionGetObjectPropertyGistAsCsvRootJunction
    ] = ProgramStageSectionGetObjectPropertyGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/programStageSections/{uid}/{property_}/gist.csv",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, ProgramStageSectionGetObjectPropertyGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, ProgramStageSectionGetObjectPropertyGistAsCsvRootJunction]):
            Default: ProgramStageSectionGetObjectPropertyGistAsCsvRootJunction.AND.
