...
from ...models.program_indicator_delete_collection_items_jsondelete_collection_items_xml_property import (
    ProgramIndicatorDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: ProgramIndicatorDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
    *,
