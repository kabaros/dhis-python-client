...
from ...models.program_stage_working_list_replace_collection_items_jsonreplace_collection_items_xml_property import (
    ProgramStageWorkingListReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: ProgramStageWorkingListReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
    *,
