...
from ...models.program_stage_working_list_get_object_property_gist_as_csv_auto import (
    ProgramStageWorkingListGetObjectPropertyGistAsCsvAuto,
)
from ...models.program_stage_working_list_get_object_property_gist_as_csv_property import (
    ProgramStageWorkingListGetObjectPropertyGistAsCsvProperty,
)
from ...models.program_stage_working_list_get_object_property_gist_as_csv_root_junction import (
    ProgramStageWorkingListGetObjectPropertyGistAsCsvRootJunction,
)
...
def _get_kwargs(
    uid: str,
    property_: ProgramStageWorkingListGetObjectPropertyGistAsCsvProperty,
    *,
    absolute_urls: Union[Unset, bool] = False,
    auto: Union[Unset, ProgramStageWorkingListGetObjectPropertyGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, ProgramStageWorkingListGetObjectPropertyGistAsCsvRootJunction
    ] = ProgramStageWorkingListGetObjectPropertyGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/programStageWorkingLists/{uid}/{property_}/gist.csv",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, ProgramStageWorkingListGetObjectPropertyGistAsCsvAuto]):
        ...
        root_junction (Union[Unset,
            ProgramStageWorkingListGetObjectPropertyGistAsCsvRootJunction]):  Default:
            ProgramStageWorkingListGetObjectPropertyGistAsCsvRootJunction.AND.
