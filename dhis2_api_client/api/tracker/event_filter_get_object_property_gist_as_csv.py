...
from ...models.event_filter_get_object_property_gist_as_csv_auto import EventFilterGetObjectPropertyGistAsCsvAuto
from ...models.event_filter_get_object_property_gist_as_csv_property import (
    EventFilterGetObjectPropertyGistAsCsvProperty,
)
from ...models.event_filter_get_object_property_gist_as_csv_root_junction import (
    EventFilterGetObjectPropertyGistAsCsvRootJunction,
)
...
def _get_kwargs(
    uid: str,
    property_: EventFilterGetObjectPropertyGistAsCsvProperty,
    *,
    absolute_urls: Union[Unset, bool] = False,
    auto: Union[Unset, EventFilterGetObjectPropertyGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, EventFilterGetObjectPropertyGistAsCsvRootJunction
    ] = EventFilterGetObjectPropertyGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/eventFilters/{uid}/{property_}/gist.csv",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, EventFilterGetObjectPropertyGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, EventFilterGetObjectPropertyGistAsCsvRootJunction]):  Default:
            EventFilterGetObjectPropertyGistAsCsvRootJunction.AND.
