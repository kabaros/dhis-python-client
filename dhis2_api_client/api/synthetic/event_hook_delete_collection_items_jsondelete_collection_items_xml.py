...
from ...models.event_hook_delete_collection_items_jsondelete_collection_items_xml_property import (
    EventHookDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: EventHookDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
    *,
