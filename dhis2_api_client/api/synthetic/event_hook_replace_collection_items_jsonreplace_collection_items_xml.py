...
from ...models.event_hook_replace_collection_items_jsonreplace_collection_items_xml_property import (
    EventHookReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: EventHookReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
    *,
