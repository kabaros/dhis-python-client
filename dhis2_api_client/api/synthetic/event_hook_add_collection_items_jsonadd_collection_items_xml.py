...
from ...models.event_hook_add_collection_items_jsonadd_collection_items_xml_property import (
    EventHookAddCollectionItemsJsonaddCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: EventHookAddCollectionItemsJsonaddCollectionItemsXmlProperty,
    *,
