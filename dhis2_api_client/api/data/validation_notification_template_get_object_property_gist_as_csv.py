...
from ...models.validation_notification_template_get_object_property_gist_as_csv_auto import (
    ValidationNotificationTemplateGetObjectPropertyGistAsCsvAuto,
)
from ...models.validation_notification_template_get_object_property_gist_as_csv_property import (
    ValidationNotificationTemplateGetObjectPropertyGistAsCsvProperty,
)
from ...models.validation_notification_template_get_object_property_gist_as_csv_root_junction import (
    ValidationNotificationTemplateGetObjectPropertyGistAsCsvRootJunction,
)
...
def _get_kwargs(
    uid: str,
    property_: ValidationNotificationTemplateGetObjectPropertyGistAsCsvProperty,
    *,
    absolute_urls: Union[Unset, bool] = False,
    auto: Union[Unset, ValidationNotificationTemplateGetObjectPropertyGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, ValidationNotificationTemplateGetObjectPropertyGistAsCsvRootJunction
    ] = ValidationNotificationTemplateGetObjectPropertyGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/validationNotificationTemplates/{uid}/{property_}/gist.csv",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, ValidationNotificationTemplateGetObjectPropertyGistAsCsvAuto]):
        ...
        root_junction (Union[Unset,
            ValidationNotificationTemplateGetObjectPropertyGistAsCsvRootJunction]):  Default:
            ValidationNotificationTemplateGetObjectPropertyGistAsCsvRootJunction.AND.
