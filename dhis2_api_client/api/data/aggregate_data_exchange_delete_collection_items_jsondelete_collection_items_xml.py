...
from ...models.aggregate_data_exchange_delete_collection_items_jsondelete_collection_items_xml_property import (
    AggregateDataExchangeDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: AggregateDataExchangeDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
    *,
