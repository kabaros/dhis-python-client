...
from ...models.validation_rule_get_object_gistget_object_gist_as_csv_auto import (
    ValidationRuleGetObjectGistgetObjectGistAsCsvAuto,
)
from ...models.validation_rule_get_object_gistget_object_gist_as_csv_response_200 import (
    ValidationRuleGetObjectGistgetObjectGistAsCsvResponse200,
)
from ...models.validation_rule_get_object_gistget_object_gist_as_csv_root_junction import (
    ValidationRuleGetObjectGistgetObjectGistAsCsvRootJunction,
)
...
def _get_kwargs(
    ...
    *,
    ...
    auto: Union[Unset, ValidationRuleGetObjectGistgetObjectGistAsCsvAuto] = UNSET,
    ...
    root_junction: Union[
        Unset, ValidationRuleGetObjectGistgetObjectGistAsCsvRootJunction
    ] = ValidationRuleGetObjectGistgetObjectGistAsCsvRootJunction.AND,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/validationRules/{uid}/gist",
        "params": params,
    }
...
) -> Optional[Union[ValidationRuleGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]]:
    if response.status_code == 200:
        response_200 = ValidationRuleGetObjectGistgetObjectGistAsCsvResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ValidationRuleGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        auto (Union[Unset, ValidationRuleGetObjectGistgetObjectGistAsCsvAuto]):
        ...
        root_junction (Union[Unset, ValidationRuleGetObjectGistgetObjectGistAsCsvRootJunction]):
            Default: ValidationRuleGetObjectGistgetObjectGistAsCsvRootJunction.AND.
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ValidationRuleGetObjectGistgetObjectGistAsCsvResponse200, WebMessage]
    """
