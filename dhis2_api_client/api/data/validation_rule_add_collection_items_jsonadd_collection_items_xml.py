...
from ...models.validation_rule_add_collection_items_jsonadd_collection_items_xml_property import (
    ValidationRuleAddCollectionItemsJsonaddCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: ValidationRuleAddCollectionItemsJsonaddCollectionItemsXmlProperty,
    *,
