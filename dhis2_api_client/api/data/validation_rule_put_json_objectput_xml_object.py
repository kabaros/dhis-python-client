...
from ...models.validation_rule_put_json_objectput_xml_object_atomic_mode import (
    ValidationRulePutJsonObjectputXmlObjectAtomicMode,
)
from ...models.validation_rule_put_json_objectput_xml_object_flush_mode import (
    ValidationRulePutJsonObjectputXmlObjectFlushMode,
)
from ...models.validation_rule_put_json_objectput_xml_object_identifier import (
    ValidationRulePutJsonObjectputXmlObjectIdentifier,
)
from ...models.validation_rule_put_json_objectput_xml_object_import_mode import (
    ValidationRulePutJsonObjectputXmlObjectImportMode,
)
from ...models.validation_rule_put_json_objectput_xml_object_import_report_mode import (
    ValidationRulePutJsonObjectputXmlObjectImportReportMode,
)
from ...models.validation_rule_put_json_objectput_xml_object_import_strategy import (
    ValidationRulePutJsonObjectputXmlObjectImportStrategy,
)
from ...models.validation_rule_put_json_objectput_xml_object_preheat_mode import (
    ValidationRulePutJsonObjectputXmlObjectPreheatMode,
)
from ...models.validation_rule_put_json_objectput_xml_object_user_override_mode import (
    ValidationRulePutJsonObjectputXmlObjectUserOverrideMode,
)
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[
        Unset, ValidationRulePutJsonObjectputXmlObjectAtomicMode
    ] = ValidationRulePutJsonObjectputXmlObjectAtomicMode.ALL,
    flush_mode: Union[
        Unset, ValidationRulePutJsonObjectputXmlObjectFlushMode
    ] = ValidationRulePutJsonObjectputXmlObjectFlushMode.AUTO,
    identifier: Union[
        Unset, ValidationRulePutJsonObjectputXmlObjectIdentifier
    ] = ValidationRulePutJsonObjectputXmlObjectIdentifier.UID,
    import_mode: Union[
        Unset, ValidationRulePutJsonObjectputXmlObjectImportMode
    ] = ValidationRulePutJsonObjectputXmlObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, ValidationRulePutJsonObjectputXmlObjectImportReportMode
    ] = ValidationRulePutJsonObjectputXmlObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, ValidationRulePutJsonObjectputXmlObjectImportStrategy
    ] = ValidationRulePutJsonObjectputXmlObjectImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    preheat_mode: Union[
        Unset, ValidationRulePutJsonObjectputXmlObjectPreheatMode
    ] = ValidationRulePutJsonObjectputXmlObjectPreheatMode.REFERENCE,
    ...
    user_override_mode: Union[
        Unset, ValidationRulePutJsonObjectputXmlObjectUserOverrideMode
    ] = ValidationRulePutJsonObjectputXmlObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        uid (str): A UID for an ValidationRule object
            (Java name `org.hisp.dhis.validation.ValidationRule`) Example: C0oy6Qm5HT4.
        async_ (Union[Unset, bool]):  Default: False.
        atomic_mode (Union[Unset, ValidationRulePutJsonObjectputXmlObjectAtomicMode]):  Default:
            ValidationRulePutJsonObjectputXmlObjectAtomicMode.ALL.
        flush_mode (Union[Unset, ValidationRulePutJsonObjectputXmlObjectFlushMode]):  Default:
            ValidationRulePutJsonObjectputXmlObjectFlushMode.AUTO.
        identifier (Union[Unset, ValidationRulePutJsonObjectputXmlObjectIdentifier]):  Default:
            ValidationRulePutJsonObjectputXmlObjectIdentifier.UID.
        import_mode (Union[Unset, ValidationRulePutJsonObjectputXmlObjectImportMode]):  Default:
            ValidationRulePutJsonObjectputXmlObjectImportMode.COMMIT.
        import_report_mode (Union[Unset,
            ValidationRulePutJsonObjectputXmlObjectImportReportMode]):  Default:
            ValidationRulePutJsonObjectputXmlObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, ValidationRulePutJsonObjectputXmlObjectImportStrategy]):
            Default: ValidationRulePutJsonObjectputXmlObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, ValidationRulePutJsonObjectputXmlObjectPreheatMode]):  Default:
            ValidationRulePutJsonObjectputXmlObjectPreheatMode.REFERENCE.
        ...
        user_override_mode (Union[Unset,
            ValidationRulePutJsonObjectputXmlObjectUserOverrideMode]):  Default:
            ValidationRulePutJsonObjectputXmlObjectUserOverrideMode.NONE.
        body (ValidationRule):
