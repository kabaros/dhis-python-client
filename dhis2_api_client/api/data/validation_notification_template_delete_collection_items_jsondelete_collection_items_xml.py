...
from ...models.validation_notification_template_delete_collection_items_jsondelete_collection_items_xml_property import (
    ValidationNotificationTemplateDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: ValidationNotificationTemplateDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
    *,
