...
from ...models.validation_rule_group_add_collection_item_property import ValidationRuleGroupAddCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: ValidationRuleGroupAddCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
