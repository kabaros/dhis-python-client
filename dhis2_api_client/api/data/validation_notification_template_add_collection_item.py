...
from ...models.validation_notification_template_add_collection_item_property import (
    ValidationNotificationTemplateAddCollectionItemProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: ValidationNotificationTemplateAddCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
