...
from ...models.validation_rule_patch_object_atomic_mode import ValidationRulePatchObjectAtomicMode
from ...models.validation_rule_patch_object_flush_mode import ValidationRulePatchObjectFlushMode
from ...models.validation_rule_patch_object_identifier import ValidationRulePatchObjectIdentifier
from ...models.validation_rule_patch_object_import_mode import ValidationRulePatchObjectImportMode
from ...models.validation_rule_patch_object_import_report_mode import ValidationRulePatchObjectImportReportMode
from ...models.validation_rule_patch_object_import_strategy import ValidationRulePatchObjectImportStrategy
from ...models.validation_rule_patch_object_preheat_mode import ValidationRulePatchObjectPreheatMode
from ...models.validation_rule_patch_object_root_junction import ValidationRulePatchObjectRootJunction
from ...models.validation_rule_patch_object_user_override_mode import ValidationRulePatchObjectUserOverrideMode
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[Unset, ValidationRulePatchObjectAtomicMode] = ValidationRulePatchObjectAtomicMode.ALL,
    flush_mode: Union[Unset, ValidationRulePatchObjectFlushMode] = ValidationRulePatchObjectFlushMode.AUTO,
    identifier: Union[Unset, ValidationRulePatchObjectIdentifier] = ValidationRulePatchObjectIdentifier.UID,
    import_mode: Union[Unset, ValidationRulePatchObjectImportMode] = ValidationRulePatchObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, ValidationRulePatchObjectImportReportMode
    ] = ValidationRulePatchObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, ValidationRulePatchObjectImportStrategy
    ] = ValidationRulePatchObjectImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, ValidationRulePatchObjectPreheatMode] = ValidationRulePatchObjectPreheatMode.REFERENCE,
    root_junction: Union[Unset, ValidationRulePatchObjectRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, ValidationRulePatchObjectUserOverrideMode
    ] = ValidationRulePatchObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, ValidationRulePatchObjectAtomicMode]):  Default:
            ValidationRulePatchObjectAtomicMode.ALL.
        flush_mode (Union[Unset, ValidationRulePatchObjectFlushMode]):  Default:
            ValidationRulePatchObjectFlushMode.AUTO.
        identifier (Union[Unset, ValidationRulePatchObjectIdentifier]):  Default:
            ValidationRulePatchObjectIdentifier.UID.
        import_mode (Union[Unset, ValidationRulePatchObjectImportMode]):  Default:
            ValidationRulePatchObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, ValidationRulePatchObjectImportReportMode]):  Default:
            ValidationRulePatchObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, ValidationRulePatchObjectImportStrategy]):  Default:
            ValidationRulePatchObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, ValidationRulePatchObjectPreheatMode]):  Default:
            ValidationRulePatchObjectPreheatMode.REFERENCE.
        root_junction (Union[Unset, ValidationRulePatchObjectRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, ValidationRulePatchObjectUserOverrideMode]):  Default:
            ValidationRulePatchObjectUserOverrideMode.NONE.
        body (JsonPatch):
