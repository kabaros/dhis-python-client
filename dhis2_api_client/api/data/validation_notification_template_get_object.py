...
from ...models.validation_notification_template_get_object_root_junction import (
    ValidationNotificationTemplateGetObjectRootJunction,
)
...
def _get_kwargs(
    ...
    *,
    ...
    root_junction: Union[Unset, ValidationNotificationTemplateGetObjectRootJunction] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
) -> Optional[Union[ValidationNotificationTemplate, WebMessage]]:
    if response.status_code == 200:
        response_200 = ValidationNotificationTemplate.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ValidationNotificationTemplate, WebMessage]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, ValidationNotificationTemplateGetObjectRootJunction]):
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ValidationNotificationTemplate, WebMessage]
    """
