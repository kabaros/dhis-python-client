...
from ...models.aggregate_data_exchange_add_collection_item_property import (
    AggregateDataExchangeAddCollectionItemProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: AggregateDataExchangeAddCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
