...
from ...models.validation_notification_template_delete_collection_item_property import (
    ValidationNotificationTemplateDeleteCollectionItemProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: ValidationNotificationTemplateDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/validationNotificationTemplates/{uid}/{property_}/{item_id}",
    }
