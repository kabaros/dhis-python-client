...
from ...models.aggregate_data_exchange_replace_collection_items_jsonreplace_collection_items_xml_property import (
    AggregateDataExchangeReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: AggregateDataExchangeReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
    *,
