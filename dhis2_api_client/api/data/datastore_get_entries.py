...
from ...models.datastore_get_entries_root_junction import DatastoreGetEntriesRootJunction
...
def _get_kwargs(
    ...
    *,
    ...
    root_junction: Union[Unset, DatastoreGetEntriesRootJunction] = DatastoreGetEntriesRootJunction.AND,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, DatastoreGetEntriesRootJunction]):  Default:
            DatastoreGetEntriesRootJunction.AND.
