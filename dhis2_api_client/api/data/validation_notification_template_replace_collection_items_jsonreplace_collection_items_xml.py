...
from ...models.validation_notification_template_replace_collection_items_jsonreplace_collection_items_xml_property import (
    ValidationNotificationTemplateReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: ValidationNotificationTemplateReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
    *,
    ...
    *,
    ...
    Args:
        uid (str): A UID for an ValidationNotificationTemplate object
            ...
            Example: Sg6OW5CE49Q.
        property_ (ValidationNotificationTemplateReplaceCollectionItemsJsonreplaceCollectionItemsX
            mlProperty):
        body (IdentifiableObjects):
