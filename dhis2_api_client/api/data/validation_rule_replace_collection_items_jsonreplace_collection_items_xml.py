...
from ...models.validation_rule_replace_collection_items_jsonreplace_collection_items_xml_property import (
    ValidationRuleReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: ValidationRuleReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
    *,
