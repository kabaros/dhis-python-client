...
from ...models.change_log_get_tracked_entity_attribute_value_change_log_audit_type_item import (
    ChangeLogGetTrackedEntityAttributeValueChangeLogAuditTypeItem,
)
from ...models.change_log_get_tracked_entity_attribute_value_change_log_response_200 import (
    ChangeLogGetTrackedEntityAttributeValueChangeLogResponse200,
)
...
def _get_kwargs(
    *,
    audit_type: Union[Unset, list[ChangeLogGetTrackedEntityAttributeValueChangeLogAuditTypeItem]] = UNSET,
    page: Union[Unset, int] = 1,
    page_size: Union[Unset, int] = 50,
    paging: Union[Unset, bool] = UNSET,
    skip_paging: Union[Unset, bool] = UNSET,
    tea: Union["TrackedEntityAttribute", Unset, list[str]] = UNSET,
    ...
    json_tea: Union[Unset, dict[str, Any], list[str]]
    if isinstance(tea, Unset):
        json_tea = UNSET
    elif isinstance(tea, list):
        json_tea = tea

    else:
        json_tea = tea.to_dict()
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/audits/trackedEntityAttributeValue",
        "params": params,
    }
...
) -> Optional[Union[ChangeLogGetTrackedEntityAttributeValueChangeLogResponse200, WebMessage]]:
    if response.status_code == 200:
        response_200 = ChangeLogGetTrackedEntityAttributeValueChangeLogResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ChangeLogGetTrackedEntityAttributeValueChangeLogResponse200, WebMessage]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        audit_type (Union[Unset,
            list[ChangeLogGetTrackedEntityAttributeValueChangeLogAuditTypeItem]]):
        page (Union[Unset, int]):  Default: 1.
        page_size (Union[Unset, int]):  Default: 50.
        paging (Union[Unset, bool]):
        skip_paging (Union[Unset, bool]):
        tea (Union['TrackedEntityAttribute', Unset, list[str]]):
...
def sync(
    *,
    ...
    Returns:
        Union[ChangeLogGetTrackedEntityAttributeValueChangeLogResponse200, WebMessage]
    """
