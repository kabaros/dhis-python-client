...
from ...models.aggregate_data_exchange_delete_collection_item_property import (
    AggregateDataExchangeDeleteCollectionItemProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: AggregateDataExchangeDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/aggregateDataExchanges/{uid}/{property_}/{item_id}",
    }
