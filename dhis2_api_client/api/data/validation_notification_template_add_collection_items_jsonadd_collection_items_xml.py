...
from ...models.validation_notification_template_add_collection_items_jsonadd_collection_items_xml_property import (
    ValidationNotificationTemplateAddCollectionItemsJsonaddCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: ValidationNotificationTemplateAddCollectionItemsJsonaddCollectionItemsXmlProperty,
    *,
