...
from ...models.validation_rule_group_delete_collection_items_jsondelete_collection_items_xml_property import (
    ValidationRuleGroupDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: ValidationRuleGroupDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
    *,
