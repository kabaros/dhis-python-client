...
from ...models.aggregate_data_exchange_add_collection_items_jsonadd_collection_items_xml_property import (
    AggregateDataExchangeAddCollectionItemsJsonaddCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: AggregateDataExchangeAddCollectionItemsJsonaddCollectionItemsXmlProperty,
    *,
