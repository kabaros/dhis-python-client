...
from ...models.validation_rule_group_replace_collection_items_jsonreplace_collection_items_xml_property import (
    ValidationRuleGroupReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: ValidationRuleGroupReplaceCollectionItemsJsonreplaceCollectionItemsXmlProperty,
    *,
