...
from ...models.validation_rule_delete_collection_item_property import ValidationRuleDeleteCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: ValidationRuleDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/validationRules/{uid}/{property_}/{item_id}",
    }
