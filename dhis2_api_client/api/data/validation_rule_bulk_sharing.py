...
from ...models.validation_rule_bulk_sharing_atomic_mode import ValidationRuleBulkSharingAtomicMode
from ...models.validation_rule_bulk_sharing_flush_mode import ValidationRuleBulkSharingFlushMode
from ...models.validation_rule_bulk_sharing_identifier import ValidationRuleBulkSharingIdentifier
from ...models.validation_rule_bulk_sharing_import_mode import ValidationRuleBulkSharingImportMode
from ...models.validation_rule_bulk_sharing_import_report_mode import ValidationRuleBulkSharingImportReportMode
from ...models.validation_rule_bulk_sharing_import_strategy import ValidationRuleBulkSharingImportStrategy
from ...models.validation_rule_bulk_sharing_preheat_mode import ValidationRuleBulkSharingPreheatMode
from ...models.validation_rule_bulk_sharing_root_junction import ValidationRuleBulkSharingRootJunction
from ...models.validation_rule_bulk_sharing_user_override_mode import ValidationRuleBulkSharingUserOverrideMode
...
def _get_kwargs(
    *,
    ...
    atomic_mode: Union[Unset, ValidationRuleBulkSharingAtomicMode] = ValidationRuleBulkSharingAtomicMode.ALL,
    flush_mode: Union[Unset, ValidationRuleBulkSharingFlushMode] = ValidationRuleBulkSharingFlushMode.AUTO,
    identifier: Union[Unset, ValidationRuleBulkSharingIdentifier] = ValidationRuleBulkSharingIdentifier.UID,
    import_mode: Union[Unset, ValidationRuleBulkSharingImportMode] = ValidationRuleBulkSharingImportMode.COMMIT,
    import_report_mode: Union[
        Unset, ValidationRuleBulkSharingImportReportMode
    ] = ValidationRuleBulkSharingImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, ValidationRuleBulkSharingImportStrategy
    ] = ValidationRuleBulkSharingImportStrategy.CREATE_AND_UPDATE,
    metadata_sync_import: Union[Unset, bool] = False,
    override_user: Union[Unset, str] = UNSET,
    page: Union[Unset, int] = UNSET,
    page_size: Union[Unset, int] = UNSET,
    paging: Union[Unset, bool] = UNSET,
    preheat_mode: Union[Unset, ValidationRuleBulkSharingPreheatMode] = ValidationRuleBulkSharingPreheatMode.REFERENCE,
    root_junction: Union[Unset, ValidationRuleBulkSharingRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, ValidationRuleBulkSharingUserOverrideMode
    ] = ValidationRuleBulkSharingUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, ValidationRuleBulkSharingAtomicMode]):  Default:
            ValidationRuleBulkSharingAtomicMode.ALL.
        flush_mode (Union[Unset, ValidationRuleBulkSharingFlushMode]):  Default:
            ValidationRuleBulkSharingFlushMode.AUTO.
        identifier (Union[Unset, ValidationRuleBulkSharingIdentifier]):  Default:
            ValidationRuleBulkSharingIdentifier.UID.
        import_mode (Union[Unset, ValidationRuleBulkSharingImportMode]):  Default:
            ValidationRuleBulkSharingImportMode.COMMIT.
        import_report_mode (Union[Unset, ValidationRuleBulkSharingImportReportMode]):  Default:
            ValidationRuleBulkSharingImportReportMode.ERRORS.
        import_strategy (Union[Unset, ValidationRuleBulkSharingImportStrategy]):  Default:
            ValidationRuleBulkSharingImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, ValidationRuleBulkSharingPreheatMode]):  Default:
            ValidationRuleBulkSharingPreheatMode.REFERENCE.
        root_junction (Union[Unset, ValidationRuleBulkSharingRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, ValidationRuleBulkSharingUserOverrideMode]):  Default:
            ValidationRuleBulkSharingUserOverrideMode.NONE.
        body (BulkJsonPatch):
