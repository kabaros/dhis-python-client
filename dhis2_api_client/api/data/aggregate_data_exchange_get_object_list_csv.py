...
from ...models.aggregate_data_exchange_get_object_list_csv_root_junction import (
    AggregateDataExchangeGetObjectListCsvRootJunction,
)
...
def _get_kwargs(
    *,
    ...
    root_junction: Union[Unset, AggregateDataExchangeGetObjectListCsvRootJunction] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/aggregateDataExchanges/#getObjectListCsv",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, AggregateDataExchangeGetObjectListCsvRootJunction]):
