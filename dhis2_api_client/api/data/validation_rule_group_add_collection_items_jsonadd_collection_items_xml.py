...
from ...models.validation_rule_group_add_collection_items_jsonadd_collection_items_xml_property import (
    ValidationRuleGroupAddCollectionItemsJsonaddCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: ValidationRuleGroupAddCollectionItemsJsonaddCollectionItemsXmlProperty,
    *,
