...
from ...models.validation_rule_replace_translations_body import ValidationRuleReplaceTranslationsBody
...
def _get_kwargs(
    uid: str,
    *,
    body: ValidationRuleReplaceTranslationsBody,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": f"/validationRules/{uid}/translations",
    }
