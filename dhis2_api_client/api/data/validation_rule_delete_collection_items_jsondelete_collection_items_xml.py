...
from ...models.validation_rule_delete_collection_items_jsondelete_collection_items_xml_property import (
    ValidationRuleDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: ValidationRuleDeleteCollectionItemsJsondeleteCollectionItemsXmlProperty,
    *,
