...
from ...models.validation_rule_group_get_object_list_csv_root_junction import (
    ValidationRuleGroupGetObjectListCsvRootJunction,
)
...
def _get_kwargs(
    *,
    ...
    root_junction: Union[Unset, ValidationRuleGroupGetObjectListCsvRootJunction] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/validationRuleGroups/#getObjectListCsv",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, ValidationRuleGroupGetObjectListCsvRootJunction]):
