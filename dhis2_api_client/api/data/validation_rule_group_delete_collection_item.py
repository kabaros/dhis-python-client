...
from ...models.validation_rule_group_delete_collection_item_property import (
    ValidationRuleGroupDeleteCollectionItemProperty,
)
...
def _get_kwargs(
    uid: str,
    property_: ValidationRuleGroupDeleteCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/validationRuleGroups/{uid}/{property_}/{item_id}",
    }
