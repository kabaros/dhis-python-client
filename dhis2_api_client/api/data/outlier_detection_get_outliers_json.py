...
from ...models.outlier_detection_get_outliers_json_algorithm import OutlierDetectionGetOutliersJsonAlgorithm
from ...models.outlier_detection_get_outliers_json_order_by import OutlierDetectionGetOutliersJsonOrderBy
from ...models.outlier_detection_response import OutlierDetectionResponse
...
def _get_kwargs(
    *,
    algorithm: Union[
        Unset, OutlierDetectionGetOutliersJsonAlgorithm
    ] = OutlierDetectionGetOutliersJsonAlgorithm.Z_SCORE,
    ...
    order_by: Union[Unset, OutlierDetectionGetOutliersJsonOrderBy] = UNSET,
...
) -> Optional[OutlierDetectionResponse]:
    if response.status_code == 200:
        response_200 = OutlierDetectionResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[OutlierDetectionResponse]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        algorithm (Union[Unset, OutlierDetectionGetOutliersJsonAlgorithm]):  Default:
            OutlierDetectionGetOutliersJsonAlgorithm.Z_SCORE.
        ...
        order_by (Union[Unset, OutlierDetectionGetOutliersJsonOrderBy]):
