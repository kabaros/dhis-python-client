...
from ...models.aggregate_data_exchange_bulk_sharing_atomic_mode import AggregateDataExchangeBulkSharingAtomicMode
from ...models.aggregate_data_exchange_bulk_sharing_flush_mode import AggregateDataExchangeBulkSharingFlushMode
from ...models.aggregate_data_exchange_bulk_sharing_identifier import AggregateDataExchangeBulkSharingIdentifier
from ...models.aggregate_data_exchange_bulk_sharing_import_mode import AggregateDataExchangeBulkSharingImportMode
from ...models.aggregate_data_exchange_bulk_sharing_import_report_mode import (
    AggregateDataExchangeBulkSharingImportReportMode,
)
from ...models.aggregate_data_exchange_bulk_sharing_import_strategy import (
    AggregateDataExchangeBulkSharingImportStrategy,
)
from ...models.aggregate_data_exchange_bulk_sharing_preheat_mode import AggregateDataExchangeBulkSharingPreheatMode
from ...models.aggregate_data_exchange_bulk_sharing_root_junction import AggregateDataExchangeBulkSharingRootJunction
from ...models.aggregate_data_exchange_bulk_sharing_user_override_mode import (
    AggregateDataExchangeBulkSharingUserOverrideMode,
)
...
def _get_kwargs(
    *,
    ...
    atomic_mode: Union[
        Unset, AggregateDataExchangeBulkSharingAtomicMode
    ] = AggregateDataExchangeBulkSharingAtomicMode.ALL,
    flush_mode: Union[
        Unset, AggregateDataExchangeBulkSharingFlushMode
    ] = AggregateDataExchangeBulkSharingFlushMode.AUTO,
    identifier: Union[
        Unset, AggregateDataExchangeBulkSharingIdentifier
    ] = AggregateDataExchangeBulkSharingIdentifier.UID,
    import_mode: Union[
        Unset, AggregateDataExchangeBulkSharingImportMode
    ] = AggregateDataExchangeBulkSharingImportMode.COMMIT,
    import_report_mode: Union[
        Unset, AggregateDataExchangeBulkSharingImportReportMode
    ] = AggregateDataExchangeBulkSharingImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, AggregateDataExchangeBulkSharingImportStrategy
    ] = AggregateDataExchangeBulkSharingImportStrategy.CREATE_AND_UPDATE,
    ...
    preheat_mode: Union[
        Unset, AggregateDataExchangeBulkSharingPreheatMode
    ] = AggregateDataExchangeBulkSharingPreheatMode.REFERENCE,
    root_junction: Union[Unset, AggregateDataExchangeBulkSharingRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, AggregateDataExchangeBulkSharingUserOverrideMode
    ] = AggregateDataExchangeBulkSharingUserOverrideMode.NONE,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/aggregateDataExchanges/sharing",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, AggregateDataExchangeBulkSharingAtomicMode]):  Default:
            AggregateDataExchangeBulkSharingAtomicMode.ALL.
        flush_mode (Union[Unset, AggregateDataExchangeBulkSharingFlushMode]):  Default:
            AggregateDataExchangeBulkSharingFlushMode.AUTO.
        identifier (Union[Unset, AggregateDataExchangeBulkSharingIdentifier]):  Default:
            AggregateDataExchangeBulkSharingIdentifier.UID.
        import_mode (Union[Unset, AggregateDataExchangeBulkSharingImportMode]):  Default:
            AggregateDataExchangeBulkSharingImportMode.COMMIT.
        import_report_mode (Union[Unset, AggregateDataExchangeBulkSharingImportReportMode]):
            Default: AggregateDataExchangeBulkSharingImportReportMode.ERRORS.
        import_strategy (Union[Unset, AggregateDataExchangeBulkSharingImportStrategy]):  Default:
            AggregateDataExchangeBulkSharingImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, AggregateDataExchangeBulkSharingPreheatMode]):  Default:
            AggregateDataExchangeBulkSharingPreheatMode.REFERENCE.
        root_junction (Union[Unset, AggregateDataExchangeBulkSharingRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, AggregateDataExchangeBulkSharingUserOverrideMode]):
            Default: AggregateDataExchangeBulkSharingUserOverrideMode.NONE.
        body (BulkJsonPatch):
