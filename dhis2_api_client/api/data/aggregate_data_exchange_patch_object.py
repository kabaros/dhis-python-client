...
from ...models.aggregate_data_exchange_patch_object_atomic_mode import AggregateDataExchangePatchObjectAtomicMode
from ...models.aggregate_data_exchange_patch_object_flush_mode import AggregateDataExchangePatchObjectFlushMode
from ...models.aggregate_data_exchange_patch_object_identifier import AggregateDataExchangePatchObjectIdentifier
from ...models.aggregate_data_exchange_patch_object_import_mode import AggregateDataExchangePatchObjectImportMode
from ...models.aggregate_data_exchange_patch_object_import_report_mode import (
    AggregateDataExchangePatchObjectImportReportMode,
)
from ...models.aggregate_data_exchange_patch_object_import_strategy import (
    AggregateDataExchangePatchObjectImportStrategy,
)
from ...models.aggregate_data_exchange_patch_object_preheat_mode import AggregateDataExchangePatchObjectPreheatMode
from ...models.aggregate_data_exchange_patch_object_root_junction import AggregateDataExchangePatchObjectRootJunction
from ...models.aggregate_data_exchange_patch_object_user_override_mode import (
    AggregateDataExchangePatchObjectUserOverrideMode,
)
...
def _get_kwargs(
    ...
    *,
    ...
    atomic_mode: Union[
        Unset, AggregateDataExchangePatchObjectAtomicMode
    ] = AggregateDataExchangePatchObjectAtomicMode.ALL,
    flush_mode: Union[
        Unset, AggregateDataExchangePatchObjectFlushMode
    ] = AggregateDataExchangePatchObjectFlushMode.AUTO,
    identifier: Union[
        Unset, AggregateDataExchangePatchObjectIdentifier
    ] = AggregateDataExchangePatchObjectIdentifier.UID,
    import_mode: Union[
        Unset, AggregateDataExchangePatchObjectImportMode
    ] = AggregateDataExchangePatchObjectImportMode.COMMIT,
    import_report_mode: Union[
        Unset, AggregateDataExchangePatchObjectImportReportMode
    ] = AggregateDataExchangePatchObjectImportReportMode.ERRORS,
    import_strategy: Union[
        Unset, AggregateDataExchangePatchObjectImportStrategy
    ] = AggregateDataExchangePatchObjectImportStrategy.CREATE_AND_UPDATE,
    ...
    preheat_mode: Union[
        Unset, AggregateDataExchangePatchObjectPreheatMode
    ] = AggregateDataExchangePatchObjectPreheatMode.REFERENCE,
    root_junction: Union[Unset, AggregateDataExchangePatchObjectRootJunction] = UNSET,
    ...
    user_override_mode: Union[
        Unset, AggregateDataExchangePatchObjectUserOverrideMode
    ] = AggregateDataExchangePatchObjectUserOverrideMode.NONE,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        atomic_mode (Union[Unset, AggregateDataExchangePatchObjectAtomicMode]):  Default:
            AggregateDataExchangePatchObjectAtomicMode.ALL.
        flush_mode (Union[Unset, AggregateDataExchangePatchObjectFlushMode]):  Default:
            AggregateDataExchangePatchObjectFlushMode.AUTO.
        identifier (Union[Unset, AggregateDataExchangePatchObjectIdentifier]):  Default:
            AggregateDataExchangePatchObjectIdentifier.UID.
        import_mode (Union[Unset, AggregateDataExchangePatchObjectImportMode]):  Default:
            AggregateDataExchangePatchObjectImportMode.COMMIT.
        import_report_mode (Union[Unset, AggregateDataExchangePatchObjectImportReportMode]):
            Default: AggregateDataExchangePatchObjectImportReportMode.ERRORS.
        import_strategy (Union[Unset, AggregateDataExchangePatchObjectImportStrategy]):  Default:
            AggregateDataExchangePatchObjectImportStrategy.CREATE_AND_UPDATE.
        ...
        preheat_mode (Union[Unset, AggregateDataExchangePatchObjectPreheatMode]):  Default:
            AggregateDataExchangePatchObjectPreheatMode.REFERENCE.
        root_junction (Union[Unset, AggregateDataExchangePatchObjectRootJunction]):
        ...
        user (Union[Unset, str]): A UID for an User object
            (Java name `org.hisp.dhis.user.User`) Example: r87xh9Xn8ON.
        user_override_mode (Union[Unset, AggregateDataExchangePatchObjectUserOverrideMode]):
            Default: AggregateDataExchangePatchObjectUserOverrideMode.NONE.
        body (JsonPatch):
