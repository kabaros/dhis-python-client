...
from ...models.validation_rule_get_object_root_junction import ValidationRuleGetObjectRootJunction
...
def _get_kwargs(
    ...
    *,
    ...
    root_junction: Union[Unset, ValidationRuleGetObjectRootJunction] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
) -> Optional[Union[ValidationRule, WebMessage]]:
    if response.status_code == 200:
        response_200 = ValidationRule.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ValidationRule, WebMessage]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        root_junction (Union[Unset, ValidationRuleGetObjectRootJunction]):
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ValidationRule, WebMessage]
    """
