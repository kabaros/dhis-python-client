...
from ...models.validation_rule_add_collection_item_property import ValidationRuleAddCollectionItemProperty
...
def _get_kwargs(
    uid: str,
    property_: ValidationRuleAddCollectionItemProperty,
    item_id: str,
) -> dict[str, Any]:
