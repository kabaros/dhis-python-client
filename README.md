...
```python
from dhis2_api_client import Client
...
```python
from dhis2_api_client import AuthenticatedClient
...
```python
from dhis2_api_client.models import MyDataModel
from dhis2_api_client.api.my_tag import get_my_data_model
...
1. Any endpoint which did not have a tag will be in `dhis2_api_client.api.default`
